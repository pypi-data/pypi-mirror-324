...
async def generate_google_search_queries(
    ...
    system_message = (
        ...
        "6. Primry domain of organiztion is: {primary_domain}.\n\n"
    ...
    few_shot_example_queries = (
        'Examples:\n'
        ' - site:linkedin.com/in "{organization_name}" "software engineer" intitle:"{organization_name}"\n'
        ' - site:linkedin.com/jobs/view/ "{organization_name}" "hiring" "angular developer"\n'
        ...
        ' - site:{primary_domain} Job Openings \n'
        ' - site:{primary_domain} Case Studies \n'
