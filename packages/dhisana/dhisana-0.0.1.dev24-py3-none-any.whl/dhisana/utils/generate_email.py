...
from dhisana.schemas.sales import EmailContentContext, Lead, PromptEngineeringGuidance
...
def cleanup_email_context(email_context: EmailContentContext) -> EmailContentContext:
