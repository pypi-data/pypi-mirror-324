...
class LucidicAPI:
    ...
    def analyzeAgentActions(self, task, screenshots, context):
        ...
        3. If the screen **does not change**, assume a previous step was incorrect and provide the **specific action needed** to fix it.  
        4. If the **same advice has been given multiple times with no progress**, identify the **underlying issue from an earlier step** and specify the exact corrective action.  
