...
class LucidicAPI:
    ...
    def analyzeAgentActions(self, task, screenshots, context):
        ...
        prompt = f'This is an agent workflow for this task: {task}. The context for the current step is: {context}. I have attached a screenshot of our current step. Tell me if this step worked, and if we are on the right track for the whole task. Make sure all prerequisites are met, like a human, before moving on. If this task did not work tell me what the error was and give detailed, actionable steps to fix it. Assume the website works'
        content = [    
            {
                "type": "text",
                "text": prompt
