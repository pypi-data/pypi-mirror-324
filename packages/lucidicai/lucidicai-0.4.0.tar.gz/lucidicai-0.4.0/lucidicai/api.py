...
class LucidicAPI:
    ...
    def analyzeAgentActions(self, task, screenshots, context):
        ...
        prompt = f'This is an agent workflow for this task: {task}. The context for the current step is: {context}. I have attached a screenshot. Tell me if this task worked. If this task did not work tell me what the error was and what the actionable steps are to fix it. Assume the website works'
        content = [    
            {
                "type": "text",
                "text": prompt
