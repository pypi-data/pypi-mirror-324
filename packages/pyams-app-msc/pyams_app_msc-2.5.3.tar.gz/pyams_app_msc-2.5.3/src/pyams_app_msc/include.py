...
def include_package(config):
    ...
    config.add_route(TMDB_SEARCH_ROUTE,
                     config.registry.settings.get(f'{TMDB_SEARCH_ROUTE}_route.path',
                                                  TMDB_SEARCH_PATH))

    config.add_route(MSC_PRICE_API_ROUTE,
                     config.registry.settings.get(f'{MSC_PRICE_API_ROUTE}_route.path',
                                                  MSC_PRICE_API_PATH))

    config.add_route(MSC_ROOM_API_ROUTE,
                     config.registry.settings.get(f'{MSC_ROOM_API_ROUTE}_route.path',
                                                  MSC_ROOM_API_PATH))
