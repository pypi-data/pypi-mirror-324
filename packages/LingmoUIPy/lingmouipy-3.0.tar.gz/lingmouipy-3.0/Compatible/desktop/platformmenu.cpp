...
{
    return QQmlListProperty<QObject>(this, nullptr, data_append, data_count,
        data_at, data_clear);
}

QQmlListProperty<PlatformMenuItem> PlatformMenu::items()
{
    return QQmlListProperty<PlatformMenuItem>(this, nullptr, items_append,
        items_count, items_at, items_clear);
}
...
void PlatformMenu::insertItem(int index, PlatformMenuItem* item)
{
    ...
    //        m_handle->insertMenuItem(item->handle(), before ? before->create() :
    //        nullptr);
    //    }
    //    sync();
    emit itemsChanged();
...
void PlatformMenu::componentComplete() { m_complete = true; }

void PlatformMenu::data_append(QQmlListProperty<QObject>* property,
    QObject* object)
{
...
QObject* PlatformMenu::data_at(QQmlListProperty<QObject>* property,
    qsizetype index)
{
    PlatformMenu* menu = static_cast<PlatformMenu*>(property->object);
...
void PlatformMenu::items_append(QQmlListProperty<PlatformMenu>* property,
...
PlatformMenuItem*
PlatformMenu::items_at(QQmlListProperty<PlatformMenuItem>* property,
    qsizetype index)
{
    PlatformMenu* menu = static_cast<PlatformMenu*>(property->object);
