...
const CompositeShadowParams s_shadowParams[] = {
    ...
    // Very Large
    CompositeShadowParams(QPoint(0, 6), ShadowParams(QPoint(0, 0), 36, 0.12),
...
WindowShadow::~WindowShadow() { m_shadow->destroy(); }
...
void WindowShadow::classBegin()
{
    ...
    QVector<KWindowShadowTile::Ptr> tiles = {
        createTile(m_shadowTiles.pixmap(1)), createTile(m_shadowTiles.pixmap(2)),
        createTile(m_shadowTiles.pixmap(5)), createTile(m_shadowTiles.pixmap(8)),
        createTile(m_shadowTiles.pixmap(7)), createTile(m_shadowTiles.pixmap(6)),
        createTile(m_shadowTiles.pixmap(3)), createTile(m_shadowTiles.pixmap(0))
    };
