#include "LingmoRectangle.h"

LingmoRectangle::LingmoRectangle(QQuickItem* parent)
    : QQuickPaintedItem(parent)
{
    color(QColor(255, 255, 255, 255));
    radius({ 0, 0, 0, 0 });
    connect(this, &LingmoRectangle::colorChanged, this, [=] { update(); });
    connect(this, &LingmoRectangle::radiusChanged, this, [=] { update(); });
}

void LingmoRectangle::paint(QPainter* painter)
{
    painter->save();
