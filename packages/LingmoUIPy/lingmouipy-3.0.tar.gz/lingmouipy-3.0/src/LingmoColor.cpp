...
LingmoColor::LingmoColor(QObject* parent)
    : QObject { parent }
{
    ...
    auto yellow = new LingmoAccentColor(this);
    ...
    auto orange = new LingmoAccentColor(this);
    ...
    auto red = new LingmoAccentColor(this);
    ...
    auto magenta = new LingmoAccentColor(this);
    ...
    auto purple = new LingmoAccentColor(this);
    ...
    auto blue = new LingmoAccentColor(this);
    ...
    auto teal = new LingmoAccentColor(this);
    ...
    auto green = new LingmoAccentColor(this);
...
[[maybe_unused]] LingmoAccentColor* LingmoColor::createAccentColor(const QColor& primaryColor)
{
    auto accentColor = new LingmoAccentColor(this);
    accentColor->normal(primaryColor);
    accentColor->dark(LingmoTools::getInstance()->withOpacity(primaryColor, 0.9));
    accentColor->light(LingmoTools::getInstance()->withOpacity(primaryColor, 0.9));
    accentColor->darker(LingmoTools::getInstance()->withOpacity(accentColor->dark(), 0.8));
    accentColor->lighter(LingmoTools::getInstance()->withOpacity(accentColor->light(), 0.8));
    accentColor->darkest(LingmoTools::getInstance()->withOpacity(accentColor->darker(), 0.7));
    accentColor->lightest(LingmoTools::getInstance()->withOpacity(accentColor->lighter(), 0.7));
    return accentColor;
}
