...
class ImportConfigurations:
    def __init__(self, threads=1, batch=1000, skip_first_rows=1, table_lock=False,
                 no_type_check=False, record_delimiter="\n", field_delimiter=";",
                 optionally_enclosed_by="\"", escape_character="\\",
                 date_format="YYYY-MM-DD", time_format="HH24:MI:SS",
                 timestamp_format="YYYY-MM-DD HH24:MI:SS.FF7", fail_on_invalid_data=False):
