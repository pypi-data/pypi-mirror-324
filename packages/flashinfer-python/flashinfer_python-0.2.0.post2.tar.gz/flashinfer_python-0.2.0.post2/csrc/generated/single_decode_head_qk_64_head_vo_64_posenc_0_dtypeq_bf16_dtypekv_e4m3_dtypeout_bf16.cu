...
using Params = SingleDecodeParams<nv_bfloat16, __nv_fp8_e4m3, nv_bfloat16>;

template cudaError_t SingleDecodeWithKVCacheDispatched<64, PosEncodingMode::kNone, DefaultAttention<
