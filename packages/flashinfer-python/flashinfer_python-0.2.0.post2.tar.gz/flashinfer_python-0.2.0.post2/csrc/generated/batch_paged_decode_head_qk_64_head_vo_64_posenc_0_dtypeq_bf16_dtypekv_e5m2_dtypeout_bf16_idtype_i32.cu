...
using Params = BatchDecodeParams<nv_bfloat16, __nv_fp8_e5m2, nv_bfloat16, int32_t>;
...
using ParamsMlaT = BatchDecodeParamsMLA<nv_bfloat16, __nv_fp8_e5m2, nv_bfloat16, int32_t>;
