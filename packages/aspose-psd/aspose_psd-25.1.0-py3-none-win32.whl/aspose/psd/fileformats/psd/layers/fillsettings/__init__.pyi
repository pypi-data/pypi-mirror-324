...
class BaseGradientFillSettings(BaseFillSettings):
    ...
    def dither(self) -> bool:
        '''Gets a value indicating whether this :py:class:`aspose.psd.fileformats.psd.layers.fillsettings.BaseGradientFillSettings` is dither.'''
        ...
    
    @dither.setter
    def dither(self, value : bool):
        '''Sets a value indicating whether this :py:class:`aspose.psd.fileformats.psd.layers.fillsettings.BaseGradientFillSettings` is dither.'''
        ...
    
    @property
    def reverse(self) -> bool:
        '''Gets a value indicating whether this :py:class:`aspose.psd.fileformats.psd.layers.fillsettings.BaseGradientFillSettings` is reverse.'''
        ...
    
    @reverse.setter
    def reverse(self, value : bool):
        '''Sets a value indicating whether this :py:class:`aspose.psd.fileformats.psd.layers.fillsettings.BaseGradientFillSettings` is reverse.'''
        ...
...
class GradientFillSettings(BaseGradientFillSettings):
...
class NoiseGradientFillSettings(BaseGradientFillSettings):
...
class PatternFillSettings(BaseFillSettings):
    ...
    @staticmethod
    def generate_lfx_2_resource_nodes(point_type : strcolor : aspose.psd.Color, pattern_name : str, identifier : str, scale : float, linked : bool, offset : aspose.psd.PointF) -> Iterable[aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure]:
        '''Generates the LFX2 resource nodes.
...
class GradientType:
    ...
    @classmethod
    @property
    def LINEAR(cls) -> GradientType:
        '''The linear gradient type'''
        ...
    
    @classmethod
    @property
    def RADIAL(cls) -> GradientType:
        '''The radial gradient type'''
        ...
    
    @classmethod
    @property
    def ANGLE(cls) -> GradientType:
        '''The angle gradient type'''
        ...
    
    @classmethod
    @property
    def REFLECTED(cls) -> GradientType:
        '''The reflected gradient type'''
        ...
    
    @classmethod
    @property
    def DIAMOND(cls) -> GradientType:
        '''The diamond gradient type'''
        ...
    
    @classmethod
    @property
    def SHAPE_BURST(cls) -> GradientType:
