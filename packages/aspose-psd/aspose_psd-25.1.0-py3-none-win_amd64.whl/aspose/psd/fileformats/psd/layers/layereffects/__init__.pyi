...
class ColorOverlayEffect(ILayerEffect):
    ...
    @property
    def effect_type(self) -> aspose.psd.fileformats.psd.layers.layerresources.lfx2resources.LayerEffectsTypes:
        ...
