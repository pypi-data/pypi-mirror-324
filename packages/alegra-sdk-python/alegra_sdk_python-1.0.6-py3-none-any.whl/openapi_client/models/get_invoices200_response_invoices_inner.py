...
class GetInvoices200ResponseInvoicesInner(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Id de factura electrónica")
    var_date: Optional[datetime] = Field(default=None, description="Fecha de emisión de factura electrónica", alias="date")
    status: Optional[StrictStr] = Field(default=None, description="Estado de la factura electrónica")
    legal_status: Optional[StrictStr] = Field(default=None, description="Estado legal de la factura electrónica ante la DIAN", alias="legalStatus")
    ...
    customer_identification: Optional[StrictStr] = Field(default=None, description="Identificación del empleado", alias="customerIdentification")
    cufe: Optional[StrictStr] = Field(default=None, description="Código único de factura electrónica asignado para el documento")
    prefix: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=4)]] = Field(default=None, description="Prefijo de factura electrónica")
    number: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Número de factura electrónica")
    full_number: Optional[StrictStr] = Field(default=None, description="Número de factura electrónica (Incluye prefijo y número)", alias="fullNumber")
    ...
    zip: Optional[StrictStr] = Field(default=None, description="Link de descarga a el archivo Zip que contiene el PDF de la factura y el AttachedDocument (XML). Este campo solo se añade cuando la factura no esta rechazada. Este enlace solo dura por 60 minutos, para renovar el link solicite nuevamente el documento.")
    qr_code_content: Optional[StrictStr] = Field(default=None, description="Contenido para la construcción del Código QR", alias="qrCodeContent")
    ...
    __properties: ClassVar[List[str]] = ["id", "date", "status", "legalStatus", "companyIdentification", "customerIdentification", "cufe", "prefix", "number", "fullNumber", "governmentResponse", "xmlFileName", "zipFileName", "zip", "qrCodeContent", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "zip": obj.get("zip"),
            "qrCodeContent": obj.get("qrCodeContent"),
