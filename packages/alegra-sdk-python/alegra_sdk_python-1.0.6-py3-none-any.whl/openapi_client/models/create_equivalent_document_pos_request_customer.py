...
class CreateEquivalentDocumentPosRequestCustomer(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "organizationType", "identificationType", "identificationNumber", "dv", "regimeCode", "taxCode", "tradeName", "email", "phone", "address", "contact"]
