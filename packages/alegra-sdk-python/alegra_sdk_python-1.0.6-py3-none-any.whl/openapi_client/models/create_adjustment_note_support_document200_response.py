...
class CreateAdjustmentNoteSupportDocument200Response(BaseModel):
    """
    CreateAdjustmentNoteSupportDocument200Response
    """ # noqa: E501
    invoice: Optional[CreateAdjustmentNoteSupportDocument200ResponseInvoice] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoice": CreateAdjustmentNoteSupportDocument200ResponseInvoice.from_dict(obj["invoice"]) if obj.get("invoice") is not None else None
        })
        return _obj
