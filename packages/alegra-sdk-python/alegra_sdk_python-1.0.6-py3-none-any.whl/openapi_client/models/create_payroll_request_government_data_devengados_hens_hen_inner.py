...
class CreatePayrollRequestGovernmentDataDevengadosHENsHENInner(BaseModel):
    """
    Objeto con información sobre devengados por concepto de horas extras nocturnas
    """ # noqa: E501
    hora_inicio: Optional[datetime] = Field(default=None, description="Hora de inicio de Hora Extra Nocturna", alias="HoraInicio")
    hora_fin: Optional[datetime] = Field(default=None, description="Hora de fin de Hora Extra Nocturna", alias="HoraFin")
    cantidad: Union[StrictFloat, StrictInt] = Field(description="Cantidad de Horas Extra Nocturna", alias="Cantidad")
    porcentaje: StrictStr = Field(description="Porcentaje al cual corresponde el calculo de 1 hora Extra Nocturna. Se debe colocar el Porcentaje que corresponda de la tabla de la DIAN para tipos de horas extra", alias="Porcentaje")
