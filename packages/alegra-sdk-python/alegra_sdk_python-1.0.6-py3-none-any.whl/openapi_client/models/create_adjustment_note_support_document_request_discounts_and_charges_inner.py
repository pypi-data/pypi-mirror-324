...
class CreateAdjustmentNoteSupportDocumentRequestDiscountsAndChargesInner(BaseModel):
    """
    Información de un cargo o descuento
    """ # noqa: E501
    is_charge: StrictBool = Field(description="Cargo es true, aumenta el valor del DSE; Descuento es false, disminuye el valor del NADSE. <br><i>Campo oficial DIAN &lt;ChargeIndicator&gt;</i>", alias="isCharge")
    reason: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Texto libre para informar la razón del cargo o descuento aplicado al documento. <br><i>Campo oficial DIAN &lt;AllowanceChargeReason&gt;</i>")
    ...
    __properties: ClassVar[List[str]] = ["isCharge", "reason", "percentageAmount", "amount", "baseAmount"]
