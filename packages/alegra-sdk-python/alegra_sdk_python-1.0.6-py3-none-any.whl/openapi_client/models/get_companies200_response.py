...
class GetCompanies200Response(BaseModel):
    """
    GetCompanies200Response
    """ # noqa: E501
    count: Optional[Union[StrictFloat, StrictInt]] = None
    companies: Optional[List[GetCompanies200ResponseCompaniesInner]] = Field(default=None, description="Array con empresas")
    __properties: ClassVar[List[str]] = ["count", "companies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "companies": [GetCompanies200ResponseCompaniesInner.from_dict(_item) for _item in obj["companies"]] if obj.get("companies") is not None else None
        })
        return _obj
