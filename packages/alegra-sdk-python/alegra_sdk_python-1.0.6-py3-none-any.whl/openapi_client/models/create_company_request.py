...
class CreateCompanyRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(min_length=5, strict=True, max_length=450)] = Field(description="Nombre/Razón Social de la empresa")
    ...
    identification: Annotated[str, Field(min_length=3, strict=True, max_length=30)] = Field(description="Identificación de la empresa")
    dv: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Dígito verificador de la identificación de la empresa")
    type: Optional[StrictStr] = Field(default=None, description="Tipo de empresa")
    use_alegra_certificate: StrictBool = Field(description="Indica si se desea usar el certificado de Alegra o no", alias="useAlegraCertificate")
