...
class CreatePayrollRequestGovernmentDataDeduccionesFondoPension(BaseModel):
    """
    Objeto con información sobre deducciones por conceptos de fondos de pensión
    """ # noqa: E501
    porcentaje: Union[StrictFloat, StrictInt] = Field(description="Debe corresponder al porcentaje de deducción de fondo de pensión que paga el trabajador", alias="Porcentaje")
    deduccion: Union[StrictFloat, StrictInt] = Field(description="El trabajador también debe estar afiliado al sistema de pensiones. La cotización por pensión está a cargo tanto de la empresa como del empleado. Del total del aporte (16%), la empresa aporta el 75% (12%) y el trabajador aporta el restante 25% (4%). Como el trabajador debe aportar un 4% por concepto de pensión, este valor se le descuenta (deduce) del valor devengado en el respectivo periodo (mes o quincena).", alias="Deduccion")
