...
class CreateSupportDocumentRequestDiscountsAndChargesInner(BaseModel):
    """
    Información de un cargo o descuento
    """ # noqa: E501
    is_charge: StrictBool = Field(description="Cargo es true, aumenta el valor del DSE; Descuento es false, disminuye el valor del DSE. <br><i>Campo oficial DIAN &lt;ChargeIndicator&gt;</i>", alias="isCharge")
