...
class CreateEquivalentDocumentPosRequestItemsInnerAdditionalItemPropertiesInner(BaseModel):
    """
    CreateEquivalentDocumentPosRequestItemsInnerAdditionalItemPropertiesInner
    """ # noqa: E501
    name: StrictStr = Field(description="Característica que quiere informar del ítem, por ejemplo (Talla, Color)")
    value: StrictStr = Field(description="Valor de la característica que se quiere informar, por ejemplo (M, Negro)")
