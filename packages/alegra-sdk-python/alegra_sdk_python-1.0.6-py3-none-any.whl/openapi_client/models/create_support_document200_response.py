...
class CreateSupportDocument200Response(BaseModel):
    """
    CreateSupportDocument200Response
    """ # noqa: E501
    invoice: Optional[GetSupportDocuments200ResponseSupportDocumentsInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoice": GetSupportDocuments200ResponseSupportDocumentsInner.from_dict(obj["invoice"]) if obj.get("invoice") is not None else None
        })
        return _obj
