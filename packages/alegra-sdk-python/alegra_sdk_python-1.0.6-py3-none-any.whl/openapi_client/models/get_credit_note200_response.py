...
class GetCreditNote200Response(BaseModel):
    """
    GetCreditNote200Response
    """ # noqa: E501
    credit_note: Optional[GetCreditNotes200ResponseInvoicesInner] = Field(default=None, alias="creditNote")
    __properties: ClassVar[List[str]] = ["creditNote"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "creditNote": GetCreditNotes200ResponseInvoicesInner.from_dict(obj["creditNote"]) if obj.get("creditNote") is not None else None
        })
        return _obj
