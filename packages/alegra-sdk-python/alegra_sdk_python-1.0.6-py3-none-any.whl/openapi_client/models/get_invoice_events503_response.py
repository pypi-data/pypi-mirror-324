...
class GetInvoiceEvents503Response(BaseModel):
    """
    Objeto de la respuesta de error de comunicación
    """ # noqa: E501
    errors: Optional[List[GetDailyDocumentReport400ResponseInner]] = Field(default=None, description="Array que contiene N errores generados en el sistema")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [GetDailyDocumentReport400ResponseInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
