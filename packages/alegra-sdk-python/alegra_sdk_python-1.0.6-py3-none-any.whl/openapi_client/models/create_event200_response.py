...
class CreateEvent200Response(BaseModel):
    """
    CreateEvent200Response
    """ # noqa: E501
    event: Optional[CreateEvent200ResponseEvent] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "event": CreateEvent200ResponseEvent.from_dict(obj["event"]) if obj.get("event") is not None else None
        })
        return _obj
