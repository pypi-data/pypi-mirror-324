...
class CreateAdjustmentNoteEquivalentDocument200ResponseAdjustmentNoteEquivalentdocument(BaseModel):
    """
    CreateAdjustmentNoteEquivalentDocument200ResponseAdjustmentNoteEquivalentdocument
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Id de la nota de ajuste al documento equivlanete electrónico")
    associated_document_id: Optional[StrictStr] = Field(default=None, description="Identificador único del documento de equivalente afectado por la nota de ajuste", alias="associatedDocumentId")
    var_date: Optional[datetime] = Field(default=None, description="Fecha de emisión de una una nota de ajuste al documento equivalente electrónico", alias="date")
    status: Optional[StrictStr] = Field(default=None, description="Estado de una una nota de ajuste al documento equivalente electrónico")
    legal_status: Optional[StrictStr] = Field(default=None, description="Estado legal del documento equivalente electrónico ante la DIAN", alias="legalStatus")
    ...
    cude: Optional[StrictStr] = Field(default=None, description="Código único de la una nota de ajuste al documento equivalente electrónico asignado para el documento")
    prefix: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Prefijo de la una nota de ajuste al documento equivalente electrónico")
    number: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Número de la una nota de ajuste al documento equivalente electrónico")
    full_number: Optional[StrictStr] = Field(default=None, description="Número de la una nota de ajuste al documento equivalente electrónico (Incluye prefijo y número)", alias="fullNumber")
    ...
    __properties: ClassVar[List[str]] = ["id", "associatedDocumentId", "date", "status", "legalStatus", "companyIdentification", "cude", "prefix", "number", "fullNumber", "governmentResponse", "xmlFileName", "zipFileName", "errors"]
