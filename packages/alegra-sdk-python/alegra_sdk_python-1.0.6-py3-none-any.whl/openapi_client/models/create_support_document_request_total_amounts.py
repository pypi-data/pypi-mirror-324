...
class CreateSupportDocumentRequestTotalAmounts(BaseModel):
    """
    ...
    discount_total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total valor descuentos. Suma de todos los descuentos aplicados al total de la factura. <br><i>Campo oficial DIAN &lt;AllowanceTotalAmount&gt;</i>", alias="discountTotal")
    charge_total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total valor cargos. Suma de todos los cargos aplicados al total de la factura. <br><i>Campo oficial DIAN &lt;ChargeTotalAmount&gt;</i>", alias="chargeTotal")
    ...
    __properties: ClassVar[List[str]] = ["grossTotal", "taxableTotal", "taxTotal", "discountTotal", "chargeTotal", "payableTotal"]
