...
class GetDebitNotes200ResponseInvoicesInner(BaseModel):
    """
    GetDebitNotes200ResponseInvoicesInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Id de nota débito electrónica")
    var_date: Optional[datetime] = Field(default=None, description="Fecha de emisión de nota débito electrónica", alias="date")
    status: Optional[StrictStr] = Field(default=None, description="Estado de la nota débito electrónica")
    legal_status: Optional[StrictStr] = Field(default=None, description="Estado legal de la nota débito electrónica ante la DIAN", alias="legalStatus")
    ...
    cude: Optional[StrictStr] = Field(default=None, description="Código único de nota débito electrónica asignado para el documento")
    prefix: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Prefijo de nota débito electrónica")
    number: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Número de nota débito electrónica")
