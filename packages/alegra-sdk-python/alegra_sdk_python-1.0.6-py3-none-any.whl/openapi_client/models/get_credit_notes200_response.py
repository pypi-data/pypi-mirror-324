...
class GetCreditNotes200Response(BaseModel):
    """
    GetCreditNotes200Response
    """ # noqa: E501
    metadata: Optional[GetPayrolls200ResponseMetadata] = None
    invoices: Optional[List[GetCreditNotes200ResponseInvoicesInner]] = Field(default=None, description="Array con Notas Crédito / Documentos")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoices": [GetCreditNotes200ResponseInvoicesInner.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None
        })
        return _obj
