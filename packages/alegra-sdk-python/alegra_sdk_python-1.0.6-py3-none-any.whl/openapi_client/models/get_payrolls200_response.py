...
class GetPayrolls200Response(BaseModel):
    """
    GetPayrolls200Response
    """ # noqa: E501
    metadata: Optional[GetPayrolls200ResponseMetadata] = None
    payrolls: Optional[List[GetTestSetByGovernmentId200ResponseEmission]] = Field(default=None, description="Array con nóminas")
    __properties: ClassVar[List[str]] = ["metadata", "payrolls"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in payrolls (list)
        _items = []
        if self.payrolls:
            for _item_payrolls in self.payrolls:
                if _item_payrolls:
                    _items.append(_item_payrolls.to_dict())
            _dict['payrolls'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payrolls": [GetTestSetByGovernmentId200ResponseEmission.from_dict(_item) for _item in obj["payrolls"]] if obj.get("payrolls") is not None else None
        })
        return _obj
