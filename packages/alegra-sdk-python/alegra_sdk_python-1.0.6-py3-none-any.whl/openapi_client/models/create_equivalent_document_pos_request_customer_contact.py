...
class CreateEquivalentDocumentPosRequestCustomerContact(BaseModel):
    """
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Nombre del contacto del adquiriente. <br><i>Campo oficial DIAN &lt;Name&gt;</i>")
