...
class CorreosRecepcinApi:
    ...
    @validate_call
    def get_reception_emails(
        self,
        nit: Annotated[StrictStr, Field(description="Nit de la empresa")],
        ...
        :param nit: Nit de la empresa (required)
        :type nit: str
        ...
        _param = self._get_reception_emails_serialize(
            nit=nit,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetReceptionEmails200Response",
    ...
    @validate_call
    def get_reception_emails_with_http_info(
        self,
        nit: Annotated[StrictStr, Field(description="Nit de la empresa")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetReceptionEmails200Response]:
        """Endpoint para la consulta del correo electrónico registrado por el facturador para la recepción de facturas electrónicas
    ...
    @validate_call
    def get_reception_emails_without_preload_content(
        self,
        nit: Annotated[StrictStr, Field(description="Nit de la empresa")],
        _request_timeout: Union[
            None,
    ...
    def _get_reception_emails_serialize(
        self,
        nit,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/reception-emails/{nit}',
