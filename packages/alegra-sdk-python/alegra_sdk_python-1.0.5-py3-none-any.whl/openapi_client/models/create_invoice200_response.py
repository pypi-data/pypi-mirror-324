...
class CreateInvoice200Response(BaseModel):
    """
    CreateInvoice200Response
    """ # noqa: E501
    invoice: Optional[GetInvoices200ResponseInvoicesInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoice": GetInvoices200ResponseInvoicesInner.from_dict(obj["invoice"]) if obj.get("invoice") is not None else None
        })
        return _obj
