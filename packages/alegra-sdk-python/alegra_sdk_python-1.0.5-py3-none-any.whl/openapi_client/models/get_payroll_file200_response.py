...
class GetPayrollFile200Response(BaseModel):
    """
    GetPayrollFile200Response
    """ # noqa: E501
    file: Optional[GetPayrollFile200ResponseFile] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "file": GetPayrollFile200ResponseFile.from_dict(obj["file"]) if obj.get("file") is not None else None
        })
        return _obj
