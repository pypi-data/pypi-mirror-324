...
class CreatePayrollRequestGovernmentDataFechasPagos(BaseModel):
    """
    Objeto con la información de fechas de pago del documento
    """ # noqa: E501
    fecha_pago: List[date] = Field(description="Array con fechas de Pago de la Nómina", alias="FechaPago")
    __properties: ClassVar[List[str]] = ["FechaPago"]
