...
class Item(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "standardCode", "description", "price", "priceReference", "discount", "discountAmount", "quantity", "unitCode", "note", "subtotal", "taxAmount", "taxes", "thirdPartyInformation", "withholdings", "packSize", "brandName", "modelName"]
