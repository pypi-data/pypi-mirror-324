...
class GetCreditNotes200ResponseInvoicesInner(BaseModel):
    """
    GetCreditNotes200ResponseInvoicesInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Id de nota crédito electrónica")
    var_date: Optional[datetime] = Field(default=None, description="Fecha de emisión de nota crédito electrónica", alias="date")
    status: Optional[StrictStr] = Field(default=None, description="Estado de la nota crédito electrónica")
    legal_status: Optional[StrictStr] = Field(default=None, description="Estado legal de la nota crédito electrónica ante la DIAN", alias="legalStatus")
    ...
    cude: Optional[StrictStr] = Field(default=None, description="Código único de nota crédito electrónica asignado para el documento")
    prefix: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Prefijo de nota crédito electrónica")
    number: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Número de nota crédito electrónica")
    full_number: Optional[StrictStr] = Field(default=None, description="Número de nota crédito electrónica (Incluye prefijo y número)", alias="fullNumber")
    ...
    __properties: ClassVar[List[str]] = ["id", "date", "status", "legalStatus", "companyIdentification", "customerIdentification", "cude", "prefix", "number", "fullNumber", "governmentResponse", "xmlFileName", "zipFileName", "qrCodeContent", "errors"]
