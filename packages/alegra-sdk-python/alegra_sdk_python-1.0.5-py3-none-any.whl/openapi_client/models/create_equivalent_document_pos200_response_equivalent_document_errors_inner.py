...
class CreateEquivalentDocumentPos200ResponseEquivalentDocumentErrorsInner(BaseModel):
    """
    Elemento de error con un código y un mensaje
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="Código de error")
    message: Optional[StrictStr] = Field(default=None, description="Mensaje de error")
