...
class CreateAdjustmentNoteSupportDocumentRequestCompanyTaxCode(BaseModel):
    """
    Objeto que contiene el grupo de detalles tributarios del Emisor. <br><i>Campo oficial DIAN &lt;TaxScheme&gt;</i>
    """ # noqa: E501
    id: Annotated[str, Field(strict=True, max_length=2)] = Field(description="Identificador del tributo. Se debe colocar el Código que corresponda de la tabla de tipos de tributos de la DIAN. <br><i>Campo oficial DIAN &lt;ID&gt;</i>")
