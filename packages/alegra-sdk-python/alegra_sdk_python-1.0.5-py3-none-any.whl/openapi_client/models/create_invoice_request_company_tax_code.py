...
class CreateInvoiceRequestCompanyTaxCode(BaseModel):
    """
    Objeto que contiene el grupo de detalles tributarios del Emisor. <br><i>Campo oficial DIAN &lt;TaxScheme&gt;</i>
    """ # noqa: E501
    id: StrictStr = Field(description="Identificador del tributo. Este elemento acepta una de las siguientes opciones: `01` IVA; `04` INC; `ZA` IVA e INC; `ZZ` No aplica. <br><i>Campo oficial DIAN &lt;ID&gt;</i>")
