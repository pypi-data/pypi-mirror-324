...
class GetCompanies200ResponseCompaniesInnerWebhooksEquivalentDocumentsEmissionFinished(BaseModel):
    """
    ...
    """ # noqa: E501
    url: StrictStr = Field(description="Url a la cual notificará el webhook")
    headers: Optional[Dict[str, Any]] = Field(default=None, description="Objeto con headers personalizados que serán enviados en el request al webhook configurado")
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["url", "headers", "status"]
