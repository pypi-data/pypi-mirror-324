...
class GetInvoices200Response(BaseModel):
    """
    GetInvoices200Response
    """ # noqa: E501
    metadata: Optional[GetPayrolls200ResponseMetadata] = None
    invoices: Optional[List[GetInvoices200ResponseInvoicesInner]] = Field(default=None, description="Array con facturas")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoices": [GetInvoices200ResponseInvoicesInner.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None
        })
        return _obj
