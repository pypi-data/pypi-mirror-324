...
class CreateCompany200Response(BaseModel):
    """
    CreateCompany200Response
    """ # noqa: E501
    company: Optional[CreateCompany200ResponseCompany] = None
    __properties: ClassVar[List[str]] = ["company"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "company": CreateCompany200ResponseCompany.from_dict(obj["company"]) if obj.get("company") is not None else None
        })
        return _obj
