...
class GetSupportDocuments200ResponseSupportDocumentsInner(BaseModel):
    """
    GetSupportDocuments200ResponseSupportDocumentsInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Id del documento soporte electrónico")
    var_date: Optional[datetime] = Field(default=None, description="Fecha de emisión del documento soporte electrónico", alias="date")
    status: Optional[StrictStr] = Field(default=None, description="Estado del documento soporte electrónico")
    ...
    cuds: Optional[StrictStr] = Field(default=None, description="Código único del documento soporte electrónico asignado para el documento")
    prefix: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=4)]] = Field(default=None, description="Prefijo del documento soporte electrónico")
    number: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Número del documento soporte electrónico")
    full_number: Optional[StrictStr] = Field(default=None, description="Número del documento soporte electrónico (Incluye prefijo y número)", alias="fullNumber")
    ...
    __properties: ClassVar[List[str]] = ["id", "date", "status", "legalStatus", "companyIdentification", "supplierIdentification", "cuds", "prefix", "number", "fullNumber", "xml", "applicationResponse", "governmentResponse", "xmlFileName", "zipFileName", "errors"]
