...
class CreateEquivalentDocumentPosRequestCustomerTaxCode(BaseModel):
    """
    Objeto que contiene el grupo de detalles tributarios del adquiriente. <br><i>Campo oficial DIAN &lt;TaxScheme&gt;</i>
    """ # noqa: E501
    id: StrictStr = Field(description="Identificador del tributo. Se debe colocar el Código que corresponda de la tabla de tipos de tributos para un Adquiriente de la DIAN. En caso de que no se envíe el tipo de tributo, se especificará por defecto el valor 01 (IVA) si el tipo de identifación es '31', de lo contrario se especificará el valor 'ZZ' <br><i>Campo oficial DIAN &lt;ID&gt;</i>")
    name: Optional[StrictStr] = Field(default=None, description="Nombre del tributo o nombre de la figura tributaria. <br><i>Campo oficial DIAN &lt;Name&gt;</i>")
