...
class CreateInvoiceRequestOrderReference(BaseModel):
    """
    ...
    """ # noqa: E501
    number: StrictStr = Field(description="Prefijo y Número del documento Orden referenciado")
    issue_date: Optional[date] = Field(default=None, description="Fecha de emisión: Fecha de emisión de la Orden", alias="issueDate")
    __properties: ClassVar[List[str]] = ["number", "issueDate"]
