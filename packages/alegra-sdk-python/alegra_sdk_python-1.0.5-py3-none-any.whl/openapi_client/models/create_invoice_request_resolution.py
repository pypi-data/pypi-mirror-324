...
class CreateInvoiceRequestResolution(BaseModel):
    """
    ...
    technical_key: StrictStr = Field(description="Clave técnica del rango de facturación. Es un campo opcional para Factura electrónica de Contingencia. <br><i>ClTec: Obligatorio para la generación del CUFE (Código Único de Factura Electrónica)</i>", alias="technicalKey")
