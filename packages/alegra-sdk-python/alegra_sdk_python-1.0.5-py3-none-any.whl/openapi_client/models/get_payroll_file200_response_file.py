...
class GetPayrollFile200ResponseFile(BaseModel):
    """
    GetPayrollFile200ResponseFile
    """ # noqa: E501
    content: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="Archivo codificado en base 64")
