...
def bbone_resize(
    ...
    *,
    ...
    :type orient_matrix: list[list[float]] | tuple[tuple[float, float, float], tuple[float, float, float], tuple[float, float, float]] | None
...
def bend(
    ...
    *,
    ...
    use_snap_selectable_only: bool | None = False,
    use_snap_to_same_target: bool | None = False,
    snap_face_nearest_steps: int | None = 1,
    ...
    :type use_snap_selectable_only: bool | None
    :param use_snap_to_same_target: Snap to Same Target
    :type use_snap_to_same_target: bool | None
    :param snap_face_nearest_steps: Face Nearest Steps
    :type snap_face_nearest_steps: int | None
...
def resize(
    ...
    *,
    value: collections.abc.Iterable[float] | None = (1.0, 1.0, 1.0),
    mouse_dir_constraint: collections.abc.Iterable[float] | None = (0.0, 0.0, 0.0),
    orient_type: str | None = "GLOBAL",
    orient_matrix: list[list[float]]
    | tuple[
        tuple[float, float, float],
    ...
    :type mouse_dir_constraint: collections.abc.Iterable[float] | None
    :param orient_type: Orientation, Transformation orientation
    :type orient_type: str | None
    :param orient_matrix: Matrix
    :type orient_matrix: list[list[float]] | tuple[tuple[float, float, float], tuple[float, float, float], tuple[float, float, float]] | None
...
def transform(
    ...
    /,
    *,
    mode: bpy._typing.rna_enums.TransformModeTypes | None = "TRANSLATION",
    ...
    :type undo: bool | None
    :param mode: Mode
    :type mode: bpy._typing.rna_enums.TransformModeTypes | None
    :param value: Values
    :type value: collections.abc.Iterable[float] | None
    :param orient_axis: Axis
    :type orient_axis: bpy._typing.rna_enums.AxisXyzItems | None
