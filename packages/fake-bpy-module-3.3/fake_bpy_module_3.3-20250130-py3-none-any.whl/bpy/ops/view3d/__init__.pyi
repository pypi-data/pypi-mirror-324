...
def interactive_add(
    ...
    *,
    ...
    | None = "CUBE",
    plane_axis: bpy._typing.rna_enums.AxisXyzItems | None = "Z",
    plane_axis_auto: bool | None = False,
    plane_depth: typing.Literal["SURFACE", "CURSOR_PLANE", "CURSOR_VIEW"]
    | None = "SURFACE",
    plane_orientation: typing.Literal["SURFACE", "DEFAULT"] | None = "SURFACE",
    snap_target: typing.Literal["GEOMETRY", "DEFAULT"] | None = "GEOMETRY",
    ...
    Cursor View -- Start placement using a point projected onto the view plane at the 3D cursor position.
        :type plane_depth: typing.Literal['SURFACE','CURSOR_PLANE','CURSOR_VIEW'] | None
    ...
    Default -- Use the current transform orientation.
        :type plane_orientation: typing.Literal['SURFACE','DEFAULT'] | None
    ...
    Default -- Use the current snap settings.
        :type snap_target: typing.Literal['GEOMETRY','DEFAULT'] | None
...
def select(
    ...
    *,
    ...
    vert_without_handles: bool | None = False,
    ...
    :type vert_without_handles: bool | None
