# Changelog
## 2.6.0 [2025-01-XX]
**The following update contains breaking changes to the config file. If you are using one, please update your config file accordingly.**
...
### Changes:
* Console output has been overhauled and improved into interactive and colorful output.
* Config file is now parsed and validated in a more efficient and reliable way. Configuration errors will now be more readable and descriptive.
