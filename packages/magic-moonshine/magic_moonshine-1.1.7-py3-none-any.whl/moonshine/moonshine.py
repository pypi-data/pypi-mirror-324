...
class Stream:
    ...
    def destination(self, index):
        ...
        base_url = "https://www.moonshine-edge-compute.com/add-stream"
        ...
        try:
            if device_type == 'camera':
                ...
                def process_frame():
                    ...
                    api_url = 'https://moonshine-edge-compute.com/stream'
                    try:
                    ...
                    # Print the elapsed time and overwrite the last printed line
                    print(f"{' ' * 100}", end='\r')
...
def create(index: str, performance: bool = False) -> Dict:
    ...
    base_url = "https://www.moonshine-edge-compute.com/create-index"
