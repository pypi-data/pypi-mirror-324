...
class NEWOIC:
    def __init__(self, data):
        ...
        self.ivx1080chg = [i.get('ivx1080chg') for i in data]
        self.ivx1080chgopen = [i.get('ivx1080chgopen') for i in data]
        self.ivx1080chgpercent = [i.get('ivx1080chgpercent') for i in data]
        self.ivx1080chgpercentopen = [i.get('ivx1080chgpercentopen') for i in data]
        self.ivx120 = [i.get('ivx120') for i in data]
        self.ivx120chg = [i.get('ivx120chg') for i in data]
        self.ivx120chgopen = [i.get('ivx120chgopen') for i in data]
        self.ivx120chgpercent = [i.get('ivx120chgpercent') for i in data]
        self.ivx120chgpercentopen = [i.get('ivx120chgpercentopen') for i in data]
        self.ivx14 = [i.get('ivx14') for i in data]
        self.ivx14chg = [i.get('ivx14chg') for i in data]
        self.ivx14chgopen = [i.get('ivx14chgopen') for i in data]
        self.ivx14chgpercent = [i.get('ivx14chgpercent') for i in data]
        self.ivx14chgpercentopen = [i.get('ivx14chgpercentopen') for i in data]
        self.ivx150 = [i.get('ivx150') for i in data]
        self.ivx150chg = [i.get('ivx150chg') for i in data]
        self.ivx150chgopen = [i.get('ivx150chgopen') for i in data]
        self.ivx150chgpercent = [i.get('ivx150chgpercent') for i in data]
        self.ivx150chgpercentopen = [i.get('ivx150chgpercentopen') for i in data]
        self.ivx180 = [i.get('ivx180') for i in data]
        self.ivx180chg = [i.get('ivx180chg') for i in data]
        self.ivx180chgopen = [i.get('ivx180chgopen') for i in data]
        self.ivx180chgpercent = [i.get('ivx180chgpercent') for i in data]
        self.ivx180chgpercentopen = [i.get('ivx180chgpercentopen') for i in data]
        self.ivx21 = [i.get('ivx21') for i in data]
        self.ivx21chg = [i.get('ivx21chg') for i in data]
        self.ivx21chgopen = [i.get('ivx21chgopen') for i in data]
        self.ivx21chgpercent = [i.get('ivx21chgpercent') for i in data]
        self.ivx21chgpercentopen = [i.get('ivx21chgpercentopen') for i in data]
        self.ivx270 = [i.get('ivx270') for i in data]
        self.ivx270chg = [i.get('ivx270chg') for i in data]
        self.ivx270chgopen = [i.get('ivx270chgopen') for i in data]
        self.ivx270chgpercent = [i.get('ivx270chgpercent') for i in data]
        self.ivx270chgpercentopen = [i.get('ivx270chgpercentopen') for i in data]
        self.ivx30 = [i.get('ivx30') for i in data]
        self.ivx30chg = [i.get('ivx30chg') for i in data]
        self.ivx30chgopen = [i.get('ivx30chgopen') for i in data]
        self.ivx30chgpercent = [i.get('ivx30chgpercent') for i in data]
        self.ivx30chgpercentopen = [i.get('ivx30chgpercentopen') for i in data]
        self.ivx30hv20 = [i.get('ivx30hv20') for i in data]
        self.ivx360 = [i.get('ivx360') for i in data]
        self.ivx360chg = [i.get('ivx360chg') for i in data]
        self.ivx360chgopen = [i.get('ivx360chgopen') for i in data]
        self.ivx360chgpercent = [i.get('ivx360chgpercent') for i in data]
        self.ivx360chgpercentopen = [i.get('ivx360chgpercentopen') for i in data]
        self.ivx60 = [i.get('ivx60') for i in data]
        self.ivx60chg = [i.get('ivx60chg') for i in data]
        self.ivx60chgopen = [i.get('ivx60chgopen') for i in data]
        self.ivx60chgpercent = [i.get('ivx60chgpercent') for i in data]
        self.ivx60chgpercentopen = [i.get('ivx60chgpercentopen') for i in data]
        self.ivx7 = [i.get('ivx7') for i in data]
        self.ivx720 = [i.get('ivx720') for i in data]
        self.ivx720chg = [i.get('ivx720chg') for i in data]
        self.ivx720chgopen = [i.get('ivx720chgopen') for i in data]
        self.ivx720chgpercent = [i.get('ivx720chgpercent') for i in data]
        self.ivx720chgpercentopen = [i.get('ivx720chgpercentopen') for i in data]
        self.ivx7chg = [i.get('ivx7chg') for i in data]
        self.ivx7chgopen = [i.get('ivx7chgopen') for i in data]
        self.ivx7chgpercent = [i.get('ivx7chgpercent') for i in data]
        self.ivx7chgpercentopen = [i.get('ivx7chgpercentopen') for i in data]
        self.ivx90 = [i.get('ivx90') for i in data]
        self.ivx90chg = [i.get('ivx90chg') for i in data]
        self.ivx90chgopen = [i.get('ivx90chgopen') for i in data]
        self.ivx90chgpercent = [i.get('ivx90chgpercent') for i in data]
        self.ivx90chgpercentopen = [i.get('ivx90chgpercentopen') for i in data]
        ...
        self.avg_iv_30 = []
        for ivp, ivr, ivx in zip(self.ivp30, self.ivr30, self.ivx30):
            vols = [v for v in (ivp, ivr, ivx) if v is not None]
            self.avg_iv_30.append(sum(vols) / len(vols) if vols else None)
        ...
        self.data_dict = {
            ...
            'ivr30': self.ivr30,
            'ivx1080': self.ivx1080,
            'ivx1080chg': self.ivx1080chg,
            'ivx1080chgopen': self.ivx1080chgopen,
            'ivx1080chgpercent': self.ivx1080chgpercent,
            'ivx1080chgpercentopen': self.ivx1080chgpercentopen,
            'ivx120': self.ivx120,
            'ivx120chg': self.ivx120chg,
            'ivx120chgopen': self.ivx120chgopen,
            'ivx120chgpercent': self.ivx120chgpercent,
            'ivx120chgpercentopen': self.ivx120chgpercentopen,
            'ivx14': self.ivx14,
            'ivx14chg': self.ivx14chg,
            'ivx14chgopen': self.ivx14chgopen,
            'ivx14chgpercent': self.ivx14chgpercent,
            'ivx14chgpercentopen': self.ivx14chgpercentopen,
            'ivx150': self.ivx150,
            'ivx150chg': self.ivx150chg,
            'ivx150chgopen': self.ivx150chgopen,
            'ivx150chgpercent': self.ivx150chgpercent,
            'ivx150chgpercentopen': self.ivx150chgpercentopen,
            'ivx180': self.ivx180,
            'ivx180chg': self.ivx180chg,
            'ivx180chgopen': self.ivx180chgopen,
            'ivx180chgpercent': self.ivx180chgpercent,
            'ivx180chgpercentopen': self.ivx180chgpercentopen,
            'ivx21': self.ivx21,
            'ivx21chg': self.ivx21chg,
            'ivx21chgopen': self.ivx21chgopen,
            'ivx21chgpercent': self.ivx21chgpercent,
            'ivx21chgpercentopen': self.ivx21chgpercentopen,
            'ivx270': self.ivx270,
            'ivx270chg': self.ivx270chg,
            'ivx270chgopen': self.ivx270chgopen,
            'ivx270chgpercent': self.ivx270chgpercent,
            'ivx270chgpercentopen': self.ivx270chgpercentopen,
            'ivx30': self.ivx30,
            'ivx30chg': self.ivx30chg,
            'ivx30chgopen': self.ivx30chgopen,
            'ivx30chgpercent': self.ivx30chgpercent,
            'ivx30chgpercentopen': self.ivx30chgpercentopen,
            'ivx30hv20': self.ivx30hv20,
            'ivx360': self.ivx360,
            'ivx360chg': self.ivx360chg,
            'ivx360chgopen': self.ivx360chgopen,
            'ivx360chgpercent': self.ivx360chgpercent,
            'ivx360chgpercentopen': self.ivx360chgpercentopen,
            'ivx60': self.ivx60,
            'ivx60chg': self.ivx60chg,
            'ivx60chgopen': self.ivx60chgopen,
            'ivx60chgpercent': self.ivx60chgpercent,
            'ivx60chgpercentopen': self.ivx60chgpercentopen,
            'ivx7': self.ivx7,
            'ivx720': self.ivx720,
            'ivx720chg': self.ivx720chg,
            'ivx720chgopen': self.ivx720chgopen,
            'ivx720chgpercent': self.ivx720chgpercent,
            'ivx720chgpercentopen': self.ivx720chgpercentopen,
            'ivx7chg': self.ivx7chg,
            'ivx7chgopen': self.ivx7chgopen,
            'ivx7chgpercent': self.ivx7chgpercent,
            'ivx7chgpercentopen': self.ivx7chgpercentopen,
            'ivx90': self.ivx90,
            'ivx90chg': self.ivx90chg,
            'ivx90chgopen': self.ivx90chgopen,
            'ivx90chgpercent': self.ivx90chgpercent,
            'ivx90chgpercentopen': self.ivx90chgpercentopen,
