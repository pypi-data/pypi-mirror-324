...
class occSDK:
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                response = await client.get(
                    ...
                    "columns=days_eod&columns=iv&columns=iv_eod&rtMode=RT&userId=9999999&uuid=null",
                    headers=await self.get_headers(),
                )
                data = response.json()
    ...
    async def new_occ(self):
        ...
        async with aiohttp.ClientSession() as session:
            async with session.get("https://private-authorization.ivolatility.com/favorites/instruments?rtMode=RT&&groupId=14&columns=bid,bid_eod,ask,ask_eod,close_eod,last,change,changepercent,changeopen,changepercentopen,change_eod,changepercent_eod,highprice52wk_eod,lowprice52wk_eod,dividenddate_eod,dividendamount_eod,dividendfrequency_eod,dividendyield_eod,optvol_eod,optvol,optvolcall_eod,optvolcall,optvolput_eod,optvolput,openinterest_eod,openinterest,openinterestcall_eod,openinterestput_eod,stockvolume_eod,stockvolume,avgoptvol1wk_eod,avgoptoi1wk_eod,avgoptvol1mo_eod,avgoptoi1mo_eod,callputvolumeratio,callputvolumeratio_eod,putcallvolumeratio,putcallvolumeratio_eod,hv10_eod,hv20_eod,hv20,hv30_eod,hv60_eod,hv90_eod,hv120_eod,hv150_eod,hv180_eod,hv30hl_eod,hv60hl_eod,hv90hl_eod,hv120hl_eod,hv150hl_eod,hv180hl_eod,ivx7,ivx7chg,ivx7chgpercent,ivx7chgopen,ivx7chgpercentopen,ivx14,ivx14chg,ivx14chgpercent,ivx14chgopen,ivx14chgpercentopen,ivx21,ivx21chg,ivx21chgpercent,ivx21chgopen,ivx21chgpercentopen,ivx30,ivx30chg,ivx30chgpercent,ivx30chgopen,ivx30chgpercentopen,ivx60,ivx60chg,ivx60chgpercent,ivx60chgopen,ivx60chgpercentopen,ivx90,ivx90chg,ivx90chgpercent,ivx90chgopen,ivx90chgpercentopen,ivx120,ivx120chg,ivx120chgpercent,ivx120chgopen,ivx120chgpercentopen,ivx150,ivx150chg,ivx150chgpercent,ivx150chgopen,ivx150chgpercentopen,ivx180,ivx180chg,ivx180chgpercent,ivx180chgopen,ivx180chgpercentopen,ivx270,ivx270chg,ivx270chgpercent,ivx270chgopen,ivx270chgpercentopen,ivx360,ivx360chg,ivx360chgpercent,ivx360chgopen,ivx360chgpercentopen,ivx720,ivx720chg,ivx720chgpercent,ivx720chgopen,ivx720chgpercentopen,ivx1080,ivx1080chg,ivx1080chgpercent,ivx1080chgopen,ivx1080chgpercentopen,ivx30hv20_eod,ivx30hv20,correlation10d_eod,correlation20d_eod,correlation30d_eod,correlation60d_eod,correlation90d_eod,correlation120d_eod,correlation150d_eod,correlation180d_eod,beta10d_eod,beta20d_eod,beta30d_eod,beta60d_eod,beta90d_eod,beta120d_eod,beta150d_eod,beta180d_eod,bidsize,asksize,outstandingshares_eod,marketcap_eod,eps_eod,pe_eod,industry,cumulativeprice_eod,cumulativevalue_eod,pcbsize_eod,pcasize_eod,vwap_eod,vwap,ivp30_eod,ivp30,ivp60_eod,ivp90_eod,ivp120_eod,ivp150_eod,ivp180_eod,ivr30_eod,ivr30,ivr60_eod,ivr90_eod,ivr120_eod,ivr150_eod,ivr180_eod,highdate52wk_eod,lowdate52wk_eod,hvp10_eod,hvp20_eod,hvp30_eod,hvp60_eod,hvp90_eod,hvp120_eod,hvp150_eod,hvp180_eod,open,high,low,ivxhigh30,ivxlow30,ivx30highlow,ivx60highlow,ivx90highlow,ivx120highlow,ivx150highlow,ivx180highlow,ivx30highlowdate,ivx60highlowdate,ivx90highlowdate,ivx120highlowdate,ivx150highlowdate,ivx180highlowdate,callputivxratio,d10_eod,d10,d25_eod,d25&userId=OIC_test&uuid=null",headers=x) as resp:
                ...
                # Apply sanitization
                df = data.as_dataframe.apply(lambda col: col.map(self.sanitize_data) if col.dtype == "O" else col)
