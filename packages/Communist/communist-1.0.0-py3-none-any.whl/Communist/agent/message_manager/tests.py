...
from Communist.agent.prompts import SystemPrompt
from Communist.agent.views import ActionResult
from Communist.browser.views import BrowserState, TabInfo
from Communist.dom.views import DOMElementNode, DOMTextNode
...
def test_token_overflow_handling_with_real_flow(message_manager: MessageManager, max_tokens):
	...
	for i in range(200):  # Simulate 40 steps of interaction
		...
		from Communist.agent.views import AgentBrain, AgentOutput
