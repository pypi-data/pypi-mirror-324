...
from Communist.browser.views import BrowserStateHistory
...
from Communist.dom.views import SelectorMap
...
class FireflinkNLP():
    """For mapping the NLP"""
    def __init__(self):
        self.steps = []  # Properly initialize the list

    def add_step(self, step):
        self.steps.append(step)  # Append step to the same instance
