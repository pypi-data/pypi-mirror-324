...
from Communist.agent.message_manager.service import MessageManager
from Communist.agent.prompts import AgentMessagePrompt, SystemPrompt
from Communist.agent.views import (
	ActionResult,
	AgentError,
	AgentHistory,
	AgentHistoryList,
...
from Communist.browser.views import BrowserState, BrowserStateHistory
from Communist.controller.registry.views import ActionModel
from Communist.controller.service import Controller
from Communist.dom.history_tree_processor.service import (
	DOMHistoryElement,
	HistoryTreeProcessor,
)
from Communist.utils import time_execution_async
...
class Agent:
	def __init__(
		...
		# Controller setup
		self.resultstep=self.controller.result.get_steps()
		self.agent_id = str(uuid.uuid4())  # unique identifier for the agent
