...
class Parameter:
    ...
    @staticmethod
    def baseParameterNames(context: str) -> List[str]:
        """
        Returns a list of valid base parameter names for the specified context

        Args:
            context (str): The context for the base parameter names. Currently only "CWMS" is supported.
...
class ParameterType:
    ...
    def parameterTypeNames(context: str) -> List[str]:
        ...
        Args:
            context (str): The context for the parameter type names. Currently only "RAW", "CWMS" and "DSS" are supported.
