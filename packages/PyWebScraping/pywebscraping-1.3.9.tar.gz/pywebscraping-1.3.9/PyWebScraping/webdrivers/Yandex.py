...
class YandexOptionsManager(BrowserOptionsManager):
	...
	def __init__(
        ...
        Args:
            ...
            user_agent (typing.Optional[list[str]]): User agent string or list of strings. Defaults to None.
            proxy (typing.Optional[typing.Union[str, list[str]]]): Proxy server address or list of addresses. Defaults to None.
...
class YandexStartArgs(BrowserStartArgs):
    ...
    :Usage:
        start_args = YandexStartArgs(webdriver_dir="/path/to/webdriver", debugging_port=9222, headless_mode=True, mute_audio=True)
    """
	...
	def __init__(
        ...
        :Usage:
            start_args = YandexStartArgs(webdriver_dir="/path/to/webdriver", debugging_port=9222)
        """
		super().__init__(
				"browser.exe",
...
class YandexRemoteWebDriver(EmptyWebDriver):
	...
	def create_driver(
			self,
			command_executor: typing.Optional[str] = None,
        ...
        Args:
            command_executor (typing.Optional[str]): The address of the remote webdriver server. Defaults to None.
            session_id (typing.Optional[str]): The ID of the existing webdriver session. Defaults to None.
