...
class EdgeRemoteWebDriver(EmptyWebDriver):
	...
	def create_driver(
        ...
        Args:
            command_executor (typing.Optional[str]): URL of the remote webdriver server. If provided will overwrite server URL during initialization. Defaults to None.
            session_id (typing.Optional[str]): ID of an existing session to connect to. If provided, will overwrite session ID specified during initialization. Defaults to None.
