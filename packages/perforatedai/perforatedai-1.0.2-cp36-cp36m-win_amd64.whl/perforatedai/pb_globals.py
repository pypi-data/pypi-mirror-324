...
modulesToConvert = [nn.Conv1d, nn.Conv2d, nn.Conv3d, nn.Linear, PBSequential]
...
#constants
improvementThreshold = 0.0001 #percentage Improvement increase needed to call a new best validation score
improvementThresholdRaw = 1e-8# raw increase needed, if its lower than this its not really learning anyway
