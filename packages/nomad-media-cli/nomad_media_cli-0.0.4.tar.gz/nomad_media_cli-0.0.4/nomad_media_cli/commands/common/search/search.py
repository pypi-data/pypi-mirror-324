...
def search_cli(query, offset, size, filters, sort_fields, search_result_fields, full_url_field_names, distinct_on_field_name, include_video_clips, similar_asset_id, min_score, exclude_total_record_count, filter_binder, use_llm_search, include_internal_fields_in_results):
