---
title: "Telemetry"
description: "Understanding OpenOperator's telemetry and privacy settings"
icon: "chart-mixed"
---

## Overview

OpenOperator collects anonymous usage data to help us understand how the library is being used and to improve the user experience. It also helps us fix bugs faster and prioritize feature development.
...
<Note>
  ...
  Service](https://github.com/j0yk1ll/openoperator/tree/main/openoperator/telemetry).
</Note>
