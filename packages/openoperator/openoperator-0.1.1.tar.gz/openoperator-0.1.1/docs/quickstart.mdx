---
title: "Quickstart"
description: "Start using OpenOperator with this quickstart guide"
icon: "rocket"
---

{/* You can install OpenOperator from PyPI or clone it from Github. */}

## Prepare the environment

OpenOperator requires Python 3.11 or higher.
