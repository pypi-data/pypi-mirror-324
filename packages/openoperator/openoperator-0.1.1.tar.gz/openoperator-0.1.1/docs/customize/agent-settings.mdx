...
<Note>
  ...
  code](https://github.com/j0yk1ll/openoperator/blob/main/openoperator/agent/views.py#L111).
</Note>



## Run initial actions
With [this example](https://github.com/j0yk1ll/openoperator/blob/main/examples/features/initial_actions.py) you can run initial actions without the LLM.
Specify the action as a dictionary where the key is the action name and the value is the action parameters. You can find all our actions in the [Controller](https://github.com/j0yk1ll/openoperator/blob/main/openoperator/controller/service.py) source code.
```python
initial_actions = [
