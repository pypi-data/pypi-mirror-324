...
[Documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ecr/paginators/)
...
class DescribeImageScanFindingsPaginator(_DescribeImageScanFindingsPaginatorBase):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ecr/paginators/#describeimagescanfindingspaginator)
    """
...
class DescribeImagesPaginator(_DescribeImagesPaginatorBase):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ecr/paginators/#describeimagespaginator)
    """
    def paginate(  # type: ignore[override]
...
class DescribePullThroughCacheRulesPaginator(_DescribePullThroughCacheRulesPaginatorBase):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ecr/paginators/#describepullthroughcacherulespaginator)
    """
    def paginate(  # type: ignore[override]
...
class DescribeRepositoriesPaginator(_DescribeRepositoriesPaginatorBase):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ecr/paginators/#describerepositoriespaginator)
    """
    def paginate(  # type: ignore[override]
...
class DescribeRepositoryCreationTemplatesPaginator(
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ecr/paginators/#describerepositorycreationtemplatespaginator)
    """
    def paginate(  # type: ignore[override]
...
class GetLifecyclePolicyPreviewPaginator(_GetLifecyclePolicyPreviewPaginatorBase):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ecr/paginators/#getlifecyclepolicypreviewpaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListImagesPaginator(_ListImagesPaginatorBase):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ecr/paginators/#listimagespaginator)
    """
    def paginate(  # type: ignore[override]
