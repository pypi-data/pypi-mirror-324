...
def id_operation(
    ...
    *,
    ...
    SELECT_LINKED
    Select Linked.
        :type type: typing.Literal['UNLINK','LOCAL','SINGLE','DELETE','REMAP','OVERRIDE_LIBRARY_CREATE','OVERRIDE_LIBRARY_CREATE_HIERARCHY','OVERRIDE_LIBRARY_MAKE_EDITABLE','OVERRIDE_LIBRARY_RESET','OVERRIDE_LIBRARY_RESET_HIERARCHY','OVERRIDE_LIBRARY_RESYNC_HIERARCHY','OVERRIDE_LIBRARY_RESYNC_HIERARCHY_ENFORCE','OVERRIDE_LIBRARY_CLEAR_SINGLE','OVERRIDE_LIBRARY_CLEAR_HIERARCHY','COPY','PASTE','ADD_FAKE','CLEAR_FAKE','RENAME','SELECT_LINKED'] | None
    """
...
def id_remap(
    ...
    *,
    ...
    :type id_type: typing.Literal['ACTION','ARMATURE','BRUSH','CAMERA','CACHEFILE','CURVE','FONT','GREASEPENCIL','COLLECTION','IMAGE','KEY','LIGHT','LIBRARY','LINESTYLE','LATTICE','MASK','MATERIAL','META','MESH','MOVIECLIP','NODETREE','OBJECT','PAINTCURVE','PALETTE','PARTICLE','LIGHT_PROBE','SCENE','SIMULATION','SOUND','SPEAKER','TEXT','TEXTURE','CURVES','POINTCLOUD','VOLUME','WINDOWMANAGER','WORLD','WORKSPACE'] | None
