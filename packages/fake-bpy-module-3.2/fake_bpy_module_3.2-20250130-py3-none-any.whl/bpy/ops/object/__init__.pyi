...
def add(
    ...
    *,
    ...
    scale: collections.abc.Iterable[float] | None = (0.0, 0.0, 0.0),
):
    """Add an object to the scene
        ...
        :param type: Type
        :type type: typing.Literal['MESH','CURVE','SURFACE','META','FONT','CURVES','POINTCLOUD','VOLUME','GPENCIL','ARMATURE','LATTICE','EMPTY','LIGHT','LIGHT_PROBE','CAMERA','SPEAKER'] | None
...
def data_instance_add(
    ...
    *,
    ...
    """Add an object data instance
        ...
        :type name: str
        :param type: Type
        :type type: typing.Literal['ACTION','ARMATURE','BRUSH','CAMERA','CACHEFILE','CURVE','FONT','GREASEPENCIL','COLLECTION','IMAGE','KEY','LIGHT','LIBRARY','LINESTYLE','LATTICE','MASK','MATERIAL','META','MESH','MOVIECLIP','NODETREE','OBJECT','PAINTCURVE','PALETTE','PARTICLE','LIGHT_PROBE','SCENE','SIMULATION','SOUND','SPEAKER','TEXT','TEXTURE','CURVES','POINTCLOUD','VOLUME','WINDOWMANAGER','WORLD','WORKSPACE'] | None
        :param align: Align, The alignment of the new object
...
def gpencil_add(
    ...
    *,
    ...
    scale: collections.abc.Iterable[float] | None = (0.0, 0.0, 0.0),
    type: typing.Literal[
        "EMPTY", "STROKE", "MONKEY", "LRT_SCENE", "LRT_COLLECTION", "LRT_OBJECT"
    ]
    | None = "EMPTY",
    ...
    Object Line Art -- Quickly set up line art for the active object.
        :type type: typing.Literal['EMPTY','STROKE','MONKEY','LRT_SCENE','LRT_COLLECTION','LRT_OBJECT'] | None
...
def gpencil_modifier_add(
    ...
    *,
    ...
    Tint -- Tint strokes with new color.
        :type type: typing.Literal['GP_TEXTURE','GP_TIME','GP_WEIGHT_ANGLE','GP_WEIGHT_PROXIMITY','GP_ARRAY','GP_BUILD','GP_DASH','GP_ENVELOPE','GP_LENGTH','GP_LINEART','GP_MIRROR','GP_MULTIPLY','GP_SIMPLIFY','GP_SUBDIV','GP_ARMATURE','GP_HOOK','GP_LATTICE','GP_NOISE','GP_OFFSET','SHRINKWRAP','GP_SMOOTH','GP_THICK','GP_COLOR','GP_OPACITY','GP_TINT'] | None
    """
...
def modifier_add(
    ...
    *,
    ...
    SURFACE
    Surface.
        :type type: typing.Literal['DATA_TRANSFER','MESH_CACHE','MESH_SEQUENCE_CACHE','NORMAL_EDIT','WEIGHTED_NORMAL','UV_PROJECT','UV_WARP','VERTEX_WEIGHT_EDIT','VERTEX_WEIGHT_MIX','VERTEX_WEIGHT_PROXIMITY','ARRAY','BEVEL','BOOLEAN','BUILD','DECIMATE','EDGE_SPLIT','NODES','MASK','MIRROR','MESH_TO_VOLUME','MULTIRES','REMESH','SCREW','SKIN','SOLIDIFY','SUBSURF','TRIANGULATE','VOLUME_TO_MESH','WELD','WIREFRAME','ARMATURE','CAST','CURVE','DISPLACE','HOOK','LAPLACIANDEFORM','LATTICE','MESH_DEFORM','SHRINKWRAP','SIMPLE_DEFORM','SMOOTH','CORRECTIVE_SMOOTH','LAPLACIANSMOOTH','SURFACE_DEFORM','WARP','WAVE','VOLUME_DISPLACE','CLOTH','COLLISION','DYNAMIC_PAINT','EXPLODE','FLUID','OCEAN','PARTICLE_INSTANCE','PARTICLE_SYSTEM','SOFT_BODY','SURFACE'] | None
    """
...
def paths_calculate(
    ...
    *,
    ...
    range: typing.Literal["KEYS_ALL", "KEYS_SELECTED", "SCENE"] | None = "SCENE",
):
    ...
    Scene Frame Range -- The entire Scene / Preview range.
        :type range: typing.Literal['KEYS_ALL','KEYS_SELECTED','SCENE'] | None
    """
