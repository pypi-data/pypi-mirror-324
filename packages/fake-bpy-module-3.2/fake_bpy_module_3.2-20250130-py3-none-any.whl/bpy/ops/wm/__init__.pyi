...
def batch_rename(
    ...
    *,
    ...
    :type data_type: typing.Literal['OBJECT','COLLECTION','MATERIAL','MESH','CURVE','META','VOLUME','GPENCIL','ARMATURE','LATTICE','LIGHT','LIGHT_PROBE','CAMERA','SPEAKER','BONE','NODE','SEQUENCE_STRIP'] | None
...
def obj_export(
    ...
    *,
    ...
    | None = "NEGATIVE_Z_FORWARD",
    up_axis: typing.Literal[
        "X_UP", "Y_UP", "Z_UP", "NEGATIVE_X_UP", "NEGATIVE_Y_UP", "NEGATIVE_Z_UP"
    ]
    | None = "Y_UP",
    ...
    NEGATIVE_Z_FORWARD
    -Z -- Negative Z axis.
        :type forward_axis: typing.Literal['X_FORWARD','Y_FORWARD','Z_FORWARD','NEGATIVE_X_FORWARD','NEGATIVE_Y_FORWARD','NEGATIVE_Z_FORWARD'] | None
    ...
    NEGATIVE_Z_UP
    -Z -- Negative Z axis.
        :type up_axis: typing.Literal['X_UP','Y_UP','Z_UP','NEGATIVE_X_UP','NEGATIVE_Y_UP','NEGATIVE_Z_UP'] | None
...
def properties_edit(
    ...
    *,
    ...
    subtype: typing.Literal["NONE", "COLOR", "COLOR_GAMMA", "EULER", "QUATERNION"]
    | None = "NONE",
    default_string: str = "",
    eval_string: str = "",
):
    ...
    Quaternion Rotation -- Quaternion rotation (affects NLA blending).
        :type subtype: typing.Literal['NONE','COLOR','COLOR_GAMMA','EULER','QUATERNION'] | None
...
def usd_export(
    ...
    *,
    ...
    relative_texture_paths: bool | None = True,
):
    ...
    Viewport -- Use Viewport settings for object visibility, modifier settings, etc.
        ...
        :type relative_texture_paths: bool | None
    """
...
def xr_navigation_teleport(
    ...
    *,
    ...
    axis: collections.abc.Iterable[float] | None = (0.0, 0.0, -1.0),
