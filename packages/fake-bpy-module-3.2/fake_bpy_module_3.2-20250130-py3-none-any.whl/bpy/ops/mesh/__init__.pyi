...
def select_similar(
    ...
    *,
    ...
    :type undo: bool | None
    :param type: Type
    :type type: typing.Literal['NORMAL','FACE','VGROUP','EDGE','VCREASE','LENGTH','DIR','FACE','FACE_ANGLE','CREASE','BEVEL','SEAM','SHARP','FREESTYLE_EDGE','MATERIAL','AREA','SIDES','PERIMETER','NORMAL','COPLANAR','SMOOTH','FACE_MAP','FREESTYLE_FACE'] | None
