...
private:
	// non-ideal sources
	void f_CreateDataSet(double thetamax, int acclevel, FluxDensity *fluxdens, vector<vector<int>> *secidx,
		PrintCalculationStatus *status, int targetlayer, int rank = 0, int mpiprocesses = 1);
