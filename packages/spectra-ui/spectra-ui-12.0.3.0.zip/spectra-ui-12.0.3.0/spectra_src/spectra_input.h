...
enum ConfIndex {
	...
	autoe_ = 0, autot_, aprofile_, wigner_, csd_, degcoh_, normenergy_, powlimit_,
		optDx_, fouriep_, wiggapprox_, wundscheme_, esmooth_, CMD_, GSModel_, CMDint_,
		CMDcmp_, CMDcmpint_, exportInt_, R56Bunch_, exportEt_, NumConfBool,
...
const map<string, tuple<int, string>> Conf {
	...
	{"Hybrid Scheme", tuple<int, string> (wundscheme_, "boolean")},
...
const map<string, tuple<int, string>> ConfSimple {
	...
	{"wundscheme", tuple<int, string> (wundscheme_, "boolean")},
