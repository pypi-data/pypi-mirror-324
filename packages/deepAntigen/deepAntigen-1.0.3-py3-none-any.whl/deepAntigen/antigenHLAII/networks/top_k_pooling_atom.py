...
class TopKPooling(torch.nn.Module):
    def __init__(self, in_channels: int, ratio: int = 1, nonlinearity: Callable = torch.tanh):
        ...
        self.layer_atom2 = pyg_linear.Linear(256, 512, weight_initializer='kaiming_uniform')
        self.layer_atom3 = pyg_linear.Linear(512, 128, weight_initializer='kaiming_uniform')
        self.weight_atom = nn.Parameter(torch.Tensor(1, 128))
