...
class pMHC_DataSet(DATA.InMemoryDataset):
    def __init__(self, path):
        ...
        for pdbid in self.pdbids:
            pdbid = pdbid.lower()
            pep_file = data_dir+'pdb_Extracted_relative/'+pdbid+'_peptide.pdb'
            pep_con = data_dir+'pdb_Extracted_relative/'+pdbid+'_pep.pkl'
            ...
            mhc_file = data_dir+'pdb_Extracted_relative/'+pdbid+'_mhc.pdb'
            mhc_con = data_dir+'pdb_Extracted_relative/'+pdbid+'_mhc.pkl'
