...
class PricingModel(BaseModel):
    ...
    o3_mini_2025_01_31: ModelPricing = ModelPricing(input_cost=0.0011, output_cost=0.0044)
...
async def a_call_openai_api(
    ...
    async def task():
        __openai_call_stat__["total_calls"] = __openai_call_stat__.get("total_calls", 0) + 1
        ...
        __openai_call_stat__["total_cost_usd"] = __openai_call_stat__.get("total_cost_usd", 0) + cost.total_cost_usd
...
async def a_vision_llm__openai(
    ...
    chat_completion:ChatCompletionWithCost = await a_call_openai_api(api_object=API, api_kwargs=api_kwargs)
