...
def attribute_add(
    ...
    *,
    ...
    data_type: typing.Literal[
        "FLOAT", "INT", "FLOAT_VECTOR", "FLOAT_COLOR", "BYTE_COLOR", "STRING", "BOOLEAN"
    ]
    | None = "FLOAT",
    domain: typing.Literal["POINT", "EDGE", "CORNER", "POLYGON", "CURVE"]
    | None = "POINT",
):
    ...
    Boolean, True or false.
        :type data_type: typing.Literal['FLOAT','INT','FLOAT_VECTOR','FLOAT_COLOR','BYTE_COLOR','STRING','BOOLEAN'] | None
    ...
    Curve, Attribute on hair curve.
        :type domain: typing.Literal['POINT','EDGE','CORNER','POLYGON','CURVE'] | None
    """
