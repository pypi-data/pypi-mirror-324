...
class ConstraintButtonsSubPanel(bpy.types.Panel):
    bl_label: typing.Any
    bl_options: typing.Any
    bl_region_type: typing.Any
    bl_rna: typing.Any
...
class ObjectConstraintPanel(bpy.types.Panel):
    bl_context: typing.Any
    bl_rna: typing.Any
    id_data: typing.Any
...
class OBJECT_PT_bTransformCacheConstraint(
    ObjectConstraintPanel, ConstraintButtonsPanel
):
    bl_context: typing.Any
    bl_label: typing.Any
    bl_options: typing.Any
...
class BONE_PT_bSplineIKConstraint_chain_scaling(
    BoneConstraintPanel, ConstraintButtonsSubPanel
):
    bl_context: typing.Any
    bl_label: typing.Any
    bl_options: typing.Any
...
class OBJECT_PT_bActionConstraint_action(
    ObjectConstraintPanel, ConstraintButtonsSubPanel
):
    bl_context: typing.Any
    bl_label: typing.Any
    bl_options: typing.Any
