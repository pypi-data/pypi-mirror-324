...
def object_operation(
    ...
    *,
    ...
    OBJECT_PROXY_TO_OVERRIDE
    Convert Proxy to Override, Convert a Proxy object to a full library override, including all its dependencies.
        :type type: typing.Literal['SELECT','DESELECT','SELECT_HIERARCHY','REMAP','RENAME','OBJECT_MODE_ENTER','OBJECT_MODE_EXIT','OBJECT_PROXY_TO_OVERRIDE'] | None
    """
