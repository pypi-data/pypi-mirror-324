...
class DeepchecksLLMClient:
    ...
    def log_batch_interactions(
        ...
        interactions : list of LogInteraction or LogInteractionType
        ...
        for interaction in interactions:
            ...
            if isinstance(interaction, LogInteractionType):
                logger.warning(
                    "LogInteractionType is deprecated and is going to be deleted in the upcoming version, "
                    "use LogInteraction instead"
                )
