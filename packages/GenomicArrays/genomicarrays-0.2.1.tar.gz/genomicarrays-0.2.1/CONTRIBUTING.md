...
Welcome to `GenomicArrays` contributor's guide.
...
If you experience bugs or general issues with `GenomicArrays`, please have a look
...
You can help improve `GenomicArrays` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`GenomicArrays` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `GenomicArrays`'s files. While this mechanism can
...
```
conda create -n GenomicArrays python=3 six virtualenv pytest pytest-cov
conda activate GenomicArrays
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/GenomicArrays.git
   cd GenomicArrays
   ```
...
5. Install [pre-commit]:
   ...
   `GenomicArrays` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/GenomicArrays
[issue tracker]: https://github.com/<USERNAME>/GenomicArrays/issues
