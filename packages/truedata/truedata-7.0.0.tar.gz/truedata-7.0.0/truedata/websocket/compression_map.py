...
msg_map = { "A" : [ ( "msg_code" ,   "str_var" ,  0 , 1 ) , ( "success" ,   "bool_var" ,  1 , 1 ) , ( "message" , "str_var" , 2  , 31) , ( "segments" ,   "list_var" ,  33 , 60 ) ,
           ...
           "S"  : [ ( "msg_code",   "str_var",  0, 1 ), ( "success",   "bool_var", 1 , 1 ) , ( "symbolsadded",   "int_var",  2, 4 ), ( "symbollist",   "add_symbol",  6, 114 ) ,
                     ( "message" ,   "symbols added" ,  0 , 0 ) ],
           "L"  : [ ( "msg_code",   "str_var",  0, 1 ), ( "success",   "bool_var", 1 , 1 ) , ( "symbolsadded",   "int_var",  2, 4 ), ( "symbollist",   "add_symbol",  6, 114 ) ,
                     ( "message" ,   "touchline" ,  0 , 0 ) ],
           ...
           "add_symbol" : [ ( "symbol",   "str_var",  0, 30 ), ( "symbol_id",   "int_var", 30 , 4 ) , ( "timestamp",   "epoch_var",  34, 4 ),( "ltp",   "float_var",  38, 4 ),
            ...
            "U"  : [ ( "msg_code",   "str_var",  0, 1 ), ( "success",   "bool_var", 1 , 1 ) , ( "symbolsremoved",   "int_var",  2, 4 ),( "totalsymbolsubscribed", "int_var",  2, 4 ) ,
