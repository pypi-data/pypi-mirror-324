...
class capsolverGoogleReCaptcha(BasePage):
        ...
        while self.captcha and tries_count < constants.RECURSION_COUNT_SIX:
            ...
            try:
                ...
                if iframe_unusual_recaptcha_checkbox_locator:
                    ...
                    iframe_popup = self.find_element_in_iframe(iframe_recaptcha_checkbox, GoogleReCaptchaLocator.iframe_popup_recaptcha)  
                else:    
    ...
    def get_recaptcha_text_instructions(self, iframe):
        ...
        try:
            instructions_text_locator = self.find_element_in_iframe(iframe, GoogleReCaptchaLocator.instruction_text1).inner_text()
        except:            
            try:
                instructions_text_locator = self.find_element_in_iframe(iframe, GoogleReCaptchaLocator.instruction_text2).inner_text()
            except:
                pass
