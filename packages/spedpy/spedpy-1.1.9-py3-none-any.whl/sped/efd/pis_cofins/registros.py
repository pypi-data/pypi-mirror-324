...
class RegistroC100(Registro):
    ...
    campos = [
        ...
        Campo(9, 'CHV_NFE'),
        CampoData(10, 'DT_DOC'),
        CampoData(11, 'DT_E_S', obrigatorio=True),
...
class RegistroM210(Registro):
    ...
    campos = [
        ...
        CampoNumerico(5, 'VL_AJUS_ACRES_BC_PIS', obrigatorio=True),
        CampoNumerico(6, 'VL_AJUS_REDUC_BC_PIS ', obrigatorio=True),
        CampoNumerico(7, 'VL_BC_CONT_AJUS ', obrigatorio=True),
        CampoNumerico(8, 'ALIQ_PIS'),
        Campo(9, 'QUANT_BC_PIS'),
        CampoNumerico(10, 'ALIQ_PIS_QUANT'),
        CampoNumerico(11, 'VL_CONT_APUR', obrigatorio=True),
        CampoNumerico(12, 'VL_AJUS_ACRES', obrigatorio=True),
        CampoNumerico(13, 'VL_AJUS_REDUC', obrigatorio=True),
        CampoNumerico(14, 'VL_CONT_DIFER'),
        CampoNumerico(15, 'VL_CONT_DIFER_ANT'),
        CampoNumerico(16, 'VL_CONT_PER', obrigatorio=True),
    ]
...
class RegistroM610(Registro):
    ...
    campos = [
        ...
        CampoNumerico(3, 'VL_REC_BRT', obrigatorio=True),
        CampoNumerico(4, 'VL_BC_CONT', obrigatorio=True),
        CampoNumerico(5, 'VL_AJUS_ACRES_BC_COFINS', obrigatorio=True),
        CampoNumerico(6, 'VL_AJUS_REDUC_BC_COFINS', obrigatorio=True),
        CampoNumerico(7, 'VL_BC_CONT_AJUS', obrigatorio=True),        
        CampoNumerico(8, 'ALIQ_COFINS'),
        Campo(9, 'QUANT_BC_COFINS'),
        CampoNumerico(10, 'ALIQ_COFINS_QUANT'),
