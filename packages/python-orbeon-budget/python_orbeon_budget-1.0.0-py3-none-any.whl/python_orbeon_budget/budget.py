...
class Budget(canvas.Canvas):
    ...
    def draw(self):
        self.setStrokeColor(colors.HexColor("#c9c9c9"))
        self.header()
        self.title()
        self.seller()
        self.valid()
    ...
    def header(self):
        ...
        self.drawImage(logo, x_logo, y_logo, width=largura_desejada, height=nova_altura)
        y_linha = y_logo - 10
    ...
    def title(self):
        ...
        self.setFont("Helvetica", 25)
        self.drawString(50, self.current_height, "Orçamento")
        self.setFont("Helvetica", 12)
        self.setFillColor(colors.HexColor("#444544"))
    ...
    def product_total(self):
        ...
        self.setFillColor(colors.HexColor("#000"))
