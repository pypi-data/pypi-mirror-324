<div align="center">
<h1>This project was moved to "zeus"</h1>
</div>

You're looking at the old `zeus-ml` PyPI package. The project moved to `zeus` ([https://pypi.org/project/zeus/](https://pypi.org/project/zeus/)), and v0.11.0 will be the last version mirrored to `zeus-ml`. Please use `zeus` for future versions:
