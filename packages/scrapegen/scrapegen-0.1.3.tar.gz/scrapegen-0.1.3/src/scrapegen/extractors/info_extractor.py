...
class InfoExtractorAi(Extractor):
    ...
    Attributes:
        ...
        verbose (bool): Displays detailed logs
    """
    
    def __init__(self, basemodel: Type, llm_manager: LlmManager , verbose = False):
        super().__init__()
    ...
    def extract(self, content: str, prompt: str = None):
        ...
        and in the company_fields section make sure to choose from given list of fileds : 
        : If any field is uncertain, replace it with None instead of providing an example or leaving it blank.
