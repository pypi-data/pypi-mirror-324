...
{Style.RESET_ALL}
        ...
        # Phone Numbers & Password Leaks (solo si es email; para username se puede usar el mismo término)
        if is_email:
        ...
        # Social Profiles (ya se mostraron arriba, pero se pueden reiterar)
