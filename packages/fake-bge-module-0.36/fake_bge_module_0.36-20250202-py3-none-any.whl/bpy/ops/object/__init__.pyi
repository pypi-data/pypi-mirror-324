...
def gpencil_modifier_add(
    ...
    /,
    *,
    type: bpy._typing.rna_enums.ObjectGreasepencilModifierTypeItems | None = "GP_THICK",
):
...
def lightprobe_cache_bake(
    ...
    *,
    delay: int | None = 0,
    subset: typing.Literal["ALL", "DIRTY", "SELECTED", "ACTIVE"] | None = "ALL",
):
    ...
    Active Only -- Only bake the active light probe.
        :type subset: typing.Literal['ALL','DIRTY','SELECTED','ACTIVE'] | None
    """
...
def select_grouped(
    ...
    *,
    ...
    Light Type -- Matching light types.
        :type type: typing.Literal['CHILDREN_RECURSIVE','CHILDREN','PARENT','SIBLINGS','TYPE','COLLECTION','HOOK','PASS','COLOR','PROPERTIES','KEYINGSET','LIGHT_TYPE'] | None
    """
...
def shade_smooth(
    ...
    /,
    *,
    use_auto_smooth: bool | None = False,
    auto_smooth_angle: float | None = 0.523599,
):
    ...
    :type auto_smooth_angle: float | None
    """
