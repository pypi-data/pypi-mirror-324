...
class Engine(ABC):
    ...
    def process_logits(self, scores: Array_Type) -> Array_Type: ...
    """Process logits for a given input and scores"""

    def sample(
        self,
        log_probs: Array_Type,
        sampler: Callable[[Array_Type], Array_Type] | None = None,
    ) -> list[int]: ...
    """
    ...
    def break_into_tokens(self, text: str) -> list[int]: ...
    """Break a string into a list of token ids."""
...
class TrieMap:
    ...
    def find(self, key: str) -> list[int] | None: ...
