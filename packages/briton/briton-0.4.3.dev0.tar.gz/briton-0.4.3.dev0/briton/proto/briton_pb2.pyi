...
class InferenceRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_batch", b"_batch", "_beam_width", b"_beam_width", "_end_id", b"_end_id", "_force_tools", b"_force_tools", "_frequency_penalty", b"_frequency_penalty", "_fsm_state", b"_fsm_state", "_input_text", b"_input_text", "_len_penalty", b"_len_penalty", "_logprobs", b"_logprobs", "_lora_config", b"_lora_config", "_lora_task_id", b"_lora_task_id", "_lora_weights", b"_lora_weights", "_output_schema_hash", b"_output_schema_hash", "_pad_id", b"_pad_id", "_presence_penalty", b"_presence_penalty", "_random_seed", b"_random_seed", "_repetition_penalty", b"_repetition_penalty", "_request_output_len", b"_request_output_len", "_runtime_top_k", b"_runtime_top_k", "_runtime_top_p", b"_runtime_top_p", "_temperature", b"_temperature", "_top_logprobs", b"_top_logprobs", "_write_output_states", b"_write_output_states", "batch", b"batch", "beam_width", b"beam_width", "end_id", b"end_id", "force_tools", b"force_tools", "frequency_penalty", b"frequency_penalty", "fsm_state", b"fsm_state", "input_text", b"input_text", "len_penalty", b"len_penalty", "logprobs", b"logprobs", "lora_config", b"lora_config", "lora_task_id", b"lora_task_id", "lora_weights", b"lora_weights", "output_schema_hash", b"output_schema_hash", "pad_id", b"pad_id", "presence_penalty", b"presence_penalty", "random_seed", b"random_seed", "repetition_penalty", b"repetition_penalty", "request_output_len", b"request_output_len", "runtime_top_k", b"runtime_top_k", "runtime_top_p", b"runtime_top_p", "temperature", b"temperature", "top_logprobs", b"top_logprobs", "write_output_states", b"write_output_states"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_batch", b"_batch", "_beam_width", b"_beam_width", "_end_id", b"_end_id", "_force_tools", b"_force_tools", "_frequency_penalty", b"_frequency_penalty", "_fsm_state", b"_fsm_state", "_input_text", b"_input_text", "_len_penalty", b"_len_penalty", "_logprobs", b"_logprobs", "_lora_config", b"_lora_config", "_lora_task_id", b"_lora_task_id", "_lora_weights", b"_lora_weights", "_output_schema_hash", b"_output_schema_hash", "_pad_id", b"_pad_id", "_presence_penalty", b"_presence_penalty", "_random_seed", b"_random_seed", "_repetition_penalty", b"_repetition_penalty", "_request_output_len", b"_request_output_len", "_runtime_top_k", b"_runtime_top_k", "_runtime_top_p", b"_runtime_top_p", "_temperature", b"_temperature", "_top_logprobs", b"_top_logprobs", "_write_output_states", b"_write_output_states", "bad_words", b"bad_words", "batch", b"batch", "beam_width", b"beam_width", "draft_input_ids", b"draft_input_ids", "end_id", b"end_id", "force_tools", b"force_tools", "frequency_penalty", b"frequency_penalty", "fsm_state", b"fsm_state", "input_ids", b"input_ids", "input_text", b"input_text", "len_penalty", b"len_penalty", "logprobs", b"logprobs", "lora_config", b"lora_config", "lora_task_id", b"lora_task_id", "lora_weights", b"lora_weights", "output_schema_hash", b"output_schema_hash", "pad_id", b"pad_id", "presence_penalty", b"presence_penalty", "random_seed", b"random_seed", "repetition_penalty", b"repetition_penalty", "request_id", b"request_id", "request_output_len", b"request_output_len", "runtime_top_k", b"runtime_top_k", "runtime_top_p", b"runtime_top_p", "stop_words", b"stop_words", "temperature", b"temperature", "top_logprobs", b"top_logprobs", "write_output_states", b"write_output_states"]) -> None: ...
    @typing.overload
...
class InferenceAnswerPart(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_finish_reason", b"_finish_reason", "finish_reason", b"finish_reason", "output_ids", b"output_ids", "output_states", b"output_states", "output_text", b"output_text", "request_id", b"request_id", "top_logprobs", b"top_logprobs"]) -> None: ...
