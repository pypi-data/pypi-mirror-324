...
class InferenceAnswerPart(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_finish_reason", b"_finish_reason", "finish_reason", b"finish_reason", "output_ids", b"output_ids", "output_states", b"output_states", "output_text", b"output_text", "request_id", b"request_id"]) -> None: ...
