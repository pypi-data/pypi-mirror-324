...
class Timeseries(pd.Series):
    ...
    def truncate(self, date_one: str = "", date_two: str = ""):
        ...
        # Format dates
        date_one = date_one.strftime('%d-%b-%Y')
        date_two = date_two.strftime('%d-%b-%Y')
    ...
    def dropna(self):
        ...
        """
        return self._update(super().dropna())
    ...
    def hp_filter(self, date_one: str = "", date_two: str = "", lamb: int = None):
        ...
        cycle_series = pd.Series(cycle, index=self.index).dropna()
        return self._update(cycle_series, f'hp_filter_{date_one}_{date_two}_{lamb}')
...
class TimeseriesTable(dict):
    ...
    def __setitem__(self, key, value):
        ...
        if not isinstance(value, Timeseries):
            raise ValueError('Value must be a Timeseries object')
