...
class NODE_OT_enum_definition_item_add(bpy.types.Operator):
...
class NODE_OT_enum_definition_item_move(bpy.types.Operator):
...
class NODE_OT_enum_definition_item_remove(bpy.types.Operator):
    """Remove the selected enum item from the definition"""
