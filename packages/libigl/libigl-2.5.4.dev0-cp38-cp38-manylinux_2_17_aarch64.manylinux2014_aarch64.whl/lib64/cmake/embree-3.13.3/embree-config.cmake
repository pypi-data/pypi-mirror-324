...
SET(EMBREE_LIBRARY "${EMBREE_ROOT_DIR}/lib64/libembree3.a")
...
IF (EMBREE_STATIC_LIB)
  INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-3.13.3/sys-targets.cmake")
  INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-3.13.3/math-targets.cmake")
  INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-3.13.3/simd-targets.cmake")
  INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-3.13.3/lexers-targets.cmake")
  INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-3.13.3/tasking-targets.cmake")

  IF (EMBREE_ISA_SSE42)
    INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-3.13.3/embree_sse42-targets.cmake")
  ENDIF()

  IF (EMBREE_ISA_AVX)
    INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-3.13.3/embree_avx-targets.cmake")
  ENDIF()

  IF (EMBREE_ISA_AVX2)
    INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-3.13.3/embree_avx2-targets.cmake")
  ENDIF()

  IF (EMBREE_ISA_AVX512)
    INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-3.13.3/embree_avx512-targets.cmake")
  ENDIF()

ENDIF()

INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-3.13.3/embree-targets.cmake")
