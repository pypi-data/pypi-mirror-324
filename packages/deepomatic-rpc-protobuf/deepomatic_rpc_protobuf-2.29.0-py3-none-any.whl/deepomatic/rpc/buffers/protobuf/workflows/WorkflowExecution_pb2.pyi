...
class WorkflowResponse(_message.Message):
    __slots__ = ("error", "outcomes", "flow_container")
    ...
    def __init__(self, error: _Optional[_Union[_Error_pb2.Error, _Mapping]] = ..., outcomes: _Optional[_Mapping[str, _Workflow_pb2.Outcome]] = ..., flow_container: _Optional[_Union[_Workflow_pb2.FlowContainer, _Mapping]] = ...) -> None: ...
