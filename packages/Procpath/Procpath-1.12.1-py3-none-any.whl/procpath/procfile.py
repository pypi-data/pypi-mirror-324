...
class Status(NamedTuple, metaclass=StatusMeta):
    ...
    def _whitespace_separated_list(s) -> List[int]:  # @NoSelf
        return [int(v) for v in s.split()]  # type: ignore[attribute-error]

    def _comma_separated_hex_list(s) -> List[int]:  # @NoSelf
        return [int(h, 16) for h in s.split(',')]  # type: ignore[attribute-error]
    ...
    uid: Annotated[List[int], _whitespace_separated_list]
    """Real, effective, saved set, and filesystem UIDs."""

    gid: Annotated[List[int], _whitespace_separated_list]
    """Real, effective, saved set, and filesystem GIDs."""

    fdsize: Annotated[int, int]
    """Number of file descriptor slots currently allocated."""

    groups: Annotated[List[int], _whitespace_separated_list]
    """Supplementary group list."""

    nstgid: Annotated[Optional[List[int]], _whitespace_separated_list]
    """
    ...
    nspid: Annotated[Optional[List[int]], _whitespace_separated_list]
    """
    Thread ID in each of the PID namespaces of which [pid] is a member.
    The fields are ordered as for NStgid (since Linux 4.1).
    """

    nspgid: Annotated[Optional[List[int]], _whitespace_separated_list]
    """
    ...
    nssid: Annotated[Optional[List[int]], _whitespace_separated_list]
    """
    ...
    sigq: Annotated[List[int], _slashed_pair]
    """
    ...
    mems_allowed: Annotated[Optional[List[int]], _comma_separated_hex_list]
    """
