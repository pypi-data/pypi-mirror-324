...
from .. import cli, playbook, plotting, procfile, procrec, procret, proctree, sqliteviz, utility
from . import ChromiumTree, get_chromium_node_list
...
class TestUtility(unittest.TestCase):
    ...
    def test_get_meta(self):
        self.assertEqual(
            ...
            utility.get_meta(['stat'], '/proc').keys(),
        )
...
class TestProcrecSqliteStorage(unittest.TestCase):
    ...
    def test_create_schema_all(self):
        ...
        self.assertEqual(utility.get_meta(['stat'], '/proc'), actual)
...
class TestProcret(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        storage = procrec.SqliteStorage(
            cls.database_file.name, procfile_list, utility.get_meta(procfile_list, '/proc')
        )
    ...
    def test_rss_filter_pid_short_and_long(self):
        with tempfile.NamedTemporaryFile() as f:
            testee = procrec.SqliteStorage(f.name, ['stat'], utility.get_meta(['stat'], '/proc'))
    ...
    def test_query_procfile_required(self):
        ...
        with tempfile.NamedTemporaryFile() as f:
            ...
            storage = procrec.SqliteStorage(
                f.name, procfile_list, utility.get_meta(procfile_list, '/proc')
            )
            with storage:
                pass
    ...
    def test_query_procfile_required_missing_old_db(self):
        ...
        with tempfile.NamedTemporaryFile() as f:
            storage = procrec.SqliteStorage(f.name, ['stat'], utility.get_meta(['stat'], '/proc'))
...
class TestSqlitevizQuery(unittest.TestCase):
    ...
    def test_process_tree_sankey_indices(self):
        ...
        procfile_list = ['stat', 'cmdline']
        storage = procrec.SqliteStorage(
            database_file.name, procfile_list, utility.get_meta(procfile_list, '/proc')
        )
        data = proctree.flatten(get_chromium_node_list(), storage._procfile_list)
        with storage:
            # Parent PID as is
    ...
    def test_total_memory_consumption(self):
        ...
        expected = [
            (1567504800000.0, '18467 chromium-browse', 208.2265625, 'total: 1590.3 MiB'),
            (1567504815000.0, '18467 chromium-browse', 208.2265625, 'total: 1591.3 MiB'),
            (1567504800000.0, '18482 chromium-browse', 53.76953125, 'total: 1590.3 MiB'),
            (1567504815000.0, '18482 chromium-browse', 53.76953125, 'total: 1591.3 MiB'),
            (1567504800000.0, '18484 chromium-browse', 14.26171875, 'total: 1590.3 MiB'),
            (1567504815000.0, '18484 chromium-browse', 14.26171875, 'total: 1591.3 MiB'),
            (1567504800000.0, '18503 chromium-browse', 106.32421875, 'total: 1590.3 MiB'),
            (1567504815000.0, '18503 chromium-browse', 106.32421875, 'total: 1591.3 MiB'),
            (1567504800000.0, '18508 chromium-browse', 78.35546875, 'total: 1590.3 MiB'),
            (1567504815000.0, '18508 chromium-browse', 78.35546875, 'total: 1591.3 MiB'),
            (1567504800000.0, '18517 chromium-browse', 17.0625, 'total: 1590.3 MiB'),
            (1567504815000.0, '18517 chromium-browse', 18.0625, 'total: 1591.3 MiB'),  # growth
            (1567504800000.0, '18529 chromium-browse', 77.53515625, 'total: 1590.3 MiB'),
            (1567504815000.0, '18529 chromium-browse', 77.53515625, 'total: 1591.3 MiB'),
            (1567504800000.0, '18531 chromium-browse', 102.01953125, 'total: 1590.3 MiB'),
            (1567504815000.0, '18531 chromium-browse', 102.01953125, 'total: 1591.3 MiB'),
            (1567504800000.0, '18555 chromium-browse', 247.01171875, 'total: 1590.3 MiB'),
            (1567504815000.0, '18555 chromium-browse', 247.01171875, 'total: 1591.3 MiB'),
            (1567504800000.0, '18569 chromium-browse', 74.13671875, 'total: 1590.3 MiB'),
            (1567504815000.0, '18569 chromium-browse', 74.13671875, 'total: 1591.3 MiB'),
            (1567504800000.0, '18571 chromium-browse', 34.47265625, 'total: 1590.3 MiB'),
            (1567504815000.0, '18571 chromium-browse', 34.47265625, 'total: 1591.3 MiB'),
            (1567504800000.0, '18593 chromium-browse', 87.03125, 'total: 1590.3 MiB'),
            (1567504815000.0, '18593 chromium-browse', 87.03125, 'total: 1591.3 MiB'),
            (1567504800000.0, '18757 chromium-browse', 50.3203125, 'total: 1590.3 MiB'),
            (1567504815000.0, '18757 chromium-browse', 50.3203125, 'total: 1591.3 MiB'),
            (1567504800000.0, '18769 chromium-browse', 212.40625, 'total: 1590.3 MiB'),
            (1567504815000.0, '18769 chromium-browse', 212.40625, 'total: 1591.3 MiB'),
            (1567504800000.0, '18770 chromium-browse', 121.5078125, 'total: 1590.3 MiB'),
            (1567504815000.0, '18770 chromium-browse', 121.5078125, 'total: 1591.3 MiB'),
            (1567504800000.0, '18942 chromium-browse', 105.8828125, 'total: 1590.3 MiB'),
            (1567504815000.0, '18942 chromium-browse', 105.8828125, 'total: 1591.3 MiB'),
        ]
        self.assertEqual(expected, actual)
