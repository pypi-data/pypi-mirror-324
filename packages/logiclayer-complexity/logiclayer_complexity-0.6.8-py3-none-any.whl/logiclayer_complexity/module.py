...
class EconomicComplexityModule(ll.LogicLayerModule):
    ...
    def route_relatedness(
        ...
        # If there are filters other than location/activity, assume and activate parents
        if set(filters.keys()) - {params.rca_params.location, params.rca_params.activity} or params.rca_params.parents:
    ...
    def route_relatedness_subnational(
        ...
        if set(filters.keys()) - {
            params.rca_params.subnat_params.location,
            params.rca_params.subnat_params.activity,
        } or params.rca_params.subnat_params.parents:
    ...
    def route_relative_relatedness_subnational(
        ...
        # These were applied inside the calculation, so remove from final filters
        _ = filters.pop(params.rca_params.subnat_params.activity, None)
        _ = filters.pop(params.rca_params.subnat_params.location, None)
