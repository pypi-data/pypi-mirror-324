...
class AiRunner:
    ...
    def run(self, query: AiQuery) -> Operation[T]:
        ...
        try:
            ...
            result_handler = AiResult(self.pyliz_dir, query, str_result)
...
class AiPoolRunner:
    ...
    class SettingChannel:
        ...
        def add_result(self, str_result: str,  path_used: str, seconds: float = 0.0,):
            result = AiPoolResult(str_result, None, seconds, path_used, self.setting)
        ...
        while not pool_runner.paths_queue.empty() and channel.fails < channel.max_try:
            try:
                ...
                try:
                    ...
                    channel.add_result(result, path, elapsed_time)
                except AiRunnerException as e:
