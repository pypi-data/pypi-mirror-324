...
public:
    ...
    virtual bool getHas_range() const = 0;
    
    virtual void setHas_range(bool v) = 0;
    
    virtual const std::vector<std::string> &getIn_range() const = 0;
    
    virtual std::vector<std::string> &getIn_range() = 0;
};
