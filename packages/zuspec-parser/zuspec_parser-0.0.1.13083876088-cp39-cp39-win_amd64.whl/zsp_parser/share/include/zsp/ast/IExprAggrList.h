...
class IExprAggrList;
using IExprAggrListUP=UP<IExprAggrList>;
class IExprAggrList : public virtual IExprAggrLiteral {
public:
    
    virtual ~IExprAggrList() { }
    
    
    virtual const std::vector<IExprUP> &getElems() const = 0;
    
    virtual std::vector<IExprUP> &getElems() = 0;
};
