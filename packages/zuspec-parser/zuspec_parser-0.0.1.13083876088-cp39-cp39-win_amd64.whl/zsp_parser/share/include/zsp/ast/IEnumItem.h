...
using ISymbolEnumScopeUP=UP<ISymbolEnumScope>;
typedef std::shared_ptr<ISymbolEnumScope> ISymbolEnumScopeSP;
class IEnumItem;
using IEnumItemUP=UP<IEnumItem>;
class IEnumItem : public virtual INamedScopeChild {
public:
    ...
    virtual ISymbolEnumScope *getUpper() = 0;
    
    virtual void setUpper(ISymbolEnumScope *v) = 0;
};
