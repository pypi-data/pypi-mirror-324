...
public:
    ...
    virtual ~IExecTargetTemplateParam() { }
    ...
    virtual int32_t getStart() const = 0;
    
    virtual void setStart(int32_t v) = 0;
    
    virtual int32_t getEnd() const = 0;
    
    virtual void setEnd(int32_t v) = 0;
