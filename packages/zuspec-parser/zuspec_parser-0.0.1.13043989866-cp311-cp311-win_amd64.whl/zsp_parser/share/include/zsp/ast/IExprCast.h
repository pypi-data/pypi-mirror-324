...
class IExprCast;
using IExprCastUP=UP<IExprCast>;
class IExprCast : public virtual IExpr {
public:
    
    virtual ~IExprCast() { }
    
    
    virtual IDataType *getCasting_type() const = 0;
    
    virtual void setCasting_type(IDataType *v, bool own=true) = 0;
