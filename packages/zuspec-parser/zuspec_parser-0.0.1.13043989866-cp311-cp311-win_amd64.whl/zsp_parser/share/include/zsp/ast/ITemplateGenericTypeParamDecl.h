/****************************************************************************
 * ITemplateGenericTypeParamDecl.h
 *
...
using ITemplateGenericTypeParamDeclUP=UP<ITemplateGenericTypeParamDecl>;
class ITemplateGenericTypeParamDecl : public virtual ITemplateParamDecl {
public:
    
    virtual ~ITemplateGenericTypeParamDecl() { }
