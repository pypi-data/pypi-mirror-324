/****************************************************************************
 * IConstraintStmtDefaultDisable.h
 *
...
using IConstraintStmtDefaultDisableUP=UP<IConstraintStmtDefaultDisable>;
class IConstraintStmtDefaultDisable : public virtual IConstraintStmt {
public:
    
    virtual ~IConstraintStmtDefaultDisable() { }
