...
typedef std::shared_ptr<IEnumItem> IEnumItemSP;
class IExtendEnum;
using IExtendEnumUP=UP<IExtendEnum>;
class IExtendEnum : public virtual IScopeChild {
public:
    ...
    virtual const std::vector<IEnumItemUP> &getItems() const = 0;
    
    virtual std::vector<IEnumItemUP> &getItems() = 0;
};
