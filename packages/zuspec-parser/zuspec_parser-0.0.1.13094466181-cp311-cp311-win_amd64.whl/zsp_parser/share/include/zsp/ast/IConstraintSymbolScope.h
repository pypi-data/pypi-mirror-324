...
class IConstraintSymbolScope : public virtual ISymbolScope {
public:
    
    virtual ~IConstraintSymbolScope() { }
    
    
    virtual IConstraintStmt *getConstraint() = 0;
    
    virtual void setConstraint(IConstraintStmt *v) = 0;
};
