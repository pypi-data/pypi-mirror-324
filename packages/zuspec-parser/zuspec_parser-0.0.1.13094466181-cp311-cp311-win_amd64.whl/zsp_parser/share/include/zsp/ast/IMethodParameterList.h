...
class IMethodParameterList : public virtual IExpr {
public:
    
    virtual ~IMethodParameterList() { }
    
    
    virtual const std::vector<IExprUP> &getParameters() const = 0;
    
    virtual std::vector<IExprUP> &getParameters() = 0;
};
