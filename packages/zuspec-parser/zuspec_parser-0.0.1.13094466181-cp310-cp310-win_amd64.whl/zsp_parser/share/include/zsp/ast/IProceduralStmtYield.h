...
using IProceduralStmtYieldUP=UP<IProceduralStmtYield>;
class IProceduralStmtYield : public virtual IExecStmt {
public:
    
    virtual ~IProceduralStmtYield() { }
