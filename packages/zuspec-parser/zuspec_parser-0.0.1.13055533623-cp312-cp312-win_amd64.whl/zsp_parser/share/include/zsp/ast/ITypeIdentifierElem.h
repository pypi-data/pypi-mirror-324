...
typedef std::shared_ptr<ITemplateParamValueList> ITemplateParamValueListSP;
class ITypeIdentifierElem;
using ITypeIdentifierElemUP=UP<ITypeIdentifierElem>;
class ITypeIdentifierElem : public virtual IExpr {
public:
    
    virtual ~ITypeIdentifierElem() { }
    ...
    virtual ITemplateParamValueList *getParams() const = 0;
    
    virtual void setParams(ITemplateParamValueList *v, bool own=true) = 0;
};
