...
typedef std::shared_ptr<IExprMemberPathElem> IExprMemberPathElemSP;
class IExprStaticRefPath;
using IExprStaticRefPathUP=UP<IExprStaticRefPath>;
class IExprStaticRefPath : public virtual IExpr {
public:
    
    virtual ~IExprStaticRefPath() { }
    ...
    virtual IExprMemberPathElem *getLeaf() const = 0;
    
    virtual void setLeaf(IExprMemberPathElem *v, bool own=true) = 0;
};
