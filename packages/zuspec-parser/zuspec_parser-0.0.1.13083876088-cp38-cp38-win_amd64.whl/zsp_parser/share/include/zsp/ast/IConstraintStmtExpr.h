...
using IConstraintStmtExprUP=UP<IConstraintStmtExpr>;
class IConstraintStmtExpr : public virtual IConstraintStmt {
public:
    
    virtual ~IConstraintStmtExpr() { }
