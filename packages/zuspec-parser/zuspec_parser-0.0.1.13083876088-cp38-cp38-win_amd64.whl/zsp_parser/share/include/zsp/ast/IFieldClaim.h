...
class IFieldClaim;
using IFieldClaimUP=UP<IFieldClaim>;
class IFieldClaim : public virtual INamedScopeChild {
public:
    
    virtual ~IFieldClaim() { }
    
    
    virtual IDataTypeUserDefined *getType() const = 0;
    
    virtual void setType(IDataTypeUserDefined *v, bool own=true) = 0;
    
    virtual bool getIs_lock() const = 0;
    
    virtual void setIs_lock(bool v) = 0;
};
