...
class IActivityLabeledScope : public virtual ISymbolScope {
public:
    
    virtual ~IActivityLabeledScope() { }
    
    
    virtual IExprId *getLabel() const = 0;
    
    virtual void setLabel(IExprId *v, bool own=true) = 0;
};
