...
using IConstraintStmtUniqueUP=UP<IConstraintStmtUnique>;
class IConstraintStmtUnique : public virtual IConstraintStmt {
public:
    
    virtual ~IConstraintStmtUnique() { }
    
    
    virtual const std::vector<IExprHierarchicalIdUP> &getList() const = 0;
    
    virtual std::vector<IExprHierarchicalIdUP> &getList() = 0;
};
