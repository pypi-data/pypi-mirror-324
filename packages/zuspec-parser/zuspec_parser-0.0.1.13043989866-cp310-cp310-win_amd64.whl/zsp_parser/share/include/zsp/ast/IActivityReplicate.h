...
using IActivityReplicateUP=UP<IActivityReplicate>;
class IActivityReplicate : public virtual IActivityLabeledStmt {
public:
    
    virtual ~IActivityReplicate() { }
    ...
    virtual IExprId *getIt_label() const = 0;
    
    virtual void setIt_label(IExprId *v, bool own=true) = 0;
