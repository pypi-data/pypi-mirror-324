...
using IProceduralStmtWhileUP=UP<IProceduralStmtWhile>;
class IProceduralStmtWhile : public virtual IProceduralStmtBody {
public:
    
    virtual ~IProceduralStmtWhile() { }
