...
typedef std::shared_ptr<ISymbolChildrenScope> ISymbolChildrenScopeSP;
...
class ISymbolScope : public virtual ISymbolChildrenScope {
public:
    ...
    virtual void setSynthetic(bool v) = 0;
