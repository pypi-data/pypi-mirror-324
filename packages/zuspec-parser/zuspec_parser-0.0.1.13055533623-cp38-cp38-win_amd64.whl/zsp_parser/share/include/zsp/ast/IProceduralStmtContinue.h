...
using IProceduralStmtContinueUP=UP<IProceduralStmtContinue>;
class IProceduralStmtContinue : public virtual IExecStmt {
public:
    
    virtual ~IProceduralStmtContinue() { }
