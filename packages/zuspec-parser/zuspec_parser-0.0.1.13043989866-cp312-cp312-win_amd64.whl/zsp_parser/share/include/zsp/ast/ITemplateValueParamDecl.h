...
using ITemplateValueParamDeclUP=UP<ITemplateValueParamDecl>;
class ITemplateValueParamDecl : public virtual ITemplateParamDecl {
public:
    
    virtual ~ITemplateValueParamDecl() { }
