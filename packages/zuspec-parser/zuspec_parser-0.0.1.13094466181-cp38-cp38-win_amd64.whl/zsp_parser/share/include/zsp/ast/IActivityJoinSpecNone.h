...
using IActivityJoinSpecNoneUP=UP<IActivityJoinSpecNone>;
class IActivityJoinSpecNone : public virtual IActivityJoinSpec {
public:
    
    virtual ~IActivityJoinSpecNone() { }
