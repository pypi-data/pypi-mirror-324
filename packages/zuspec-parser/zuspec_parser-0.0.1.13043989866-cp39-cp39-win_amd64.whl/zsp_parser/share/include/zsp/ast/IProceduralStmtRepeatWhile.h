...
typedef std::shared_ptr<IProceduralStmtBody> IProceduralStmtBodySP;
class IExpr;
using IExprUP=UP<IExpr>;
typedef std::shared_ptr<IExpr> IExprSP;
class IProceduralStmtRepeatWhile;
using IProceduralStmtRepeatWhileUP=UP<IProceduralStmtRepeatWhile>;
class IProceduralStmtRepeatWhile : public virtual IProceduralStmtBody {
public:
    
    virtual ~IProceduralStmtRepeatWhile() { }
