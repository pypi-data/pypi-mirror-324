...
class IExprHierarchicalId : public virtual IExpr {
public:
    
    virtual ~IExprHierarchicalId() { }
    
    
    virtual const std::vector<IExprMemberPathElemUP> &getElems() const = 0;
    
    virtual std::vector<IExprMemberPathElemUP> &getElems() = 0;
};
