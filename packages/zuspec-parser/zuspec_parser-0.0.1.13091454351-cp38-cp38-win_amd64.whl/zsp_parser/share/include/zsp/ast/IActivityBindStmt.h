...
using IActivityBindStmtUP=UP<IActivityBindStmt>;
class IActivityBindStmt : public virtual IActivityStmt {
public:
    
    virtual ~IActivityBindStmt() { }
    
    
    virtual IExprHierarchicalId *getLhs() const = 0;
    
    virtual void setLhs(IExprHierarchicalId *v, bool own=true) = 0;
    
    virtual const std::vector<IExprHierarchicalIdUP> &getRhs() const = 0;
    
    virtual std::vector<IExprHierarchicalIdUP> &getRhs() = 0;
};
