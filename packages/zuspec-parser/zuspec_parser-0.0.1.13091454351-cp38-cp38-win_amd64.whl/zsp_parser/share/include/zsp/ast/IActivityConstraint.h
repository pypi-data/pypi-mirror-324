...
using IActivityConstraintUP=UP<IActivityConstraint>;
class IActivityConstraint : public virtual IActivityStmt {
public:
    
    virtual ~IActivityConstraint() { }
    
    
    virtual IConstraintStmt *getConstraint() const = 0;
    
    virtual void setConstraint(IConstraintStmt *v, bool own=true) = 0;
};
