...
using IActivityJoinSpecFirstUP=UP<IActivityJoinSpecFirst>;
class IActivityJoinSpecFirst : public virtual IActivityJoinSpec {
public:
    
    virtual ~IActivityJoinSpecFirst() { }
