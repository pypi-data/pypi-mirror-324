...
using IActivityRepeatCountUP=UP<IActivityRepeatCount>;
class IActivityRepeatCount : public virtual IActivityLabeledStmt {
public:
    
    virtual ~IActivityRepeatCount() { }
    
    
    virtual IExprId *getLoop_var() const = 0;
    
    virtual void setLoop_var(IExprId *v, bool own=true) = 0;
