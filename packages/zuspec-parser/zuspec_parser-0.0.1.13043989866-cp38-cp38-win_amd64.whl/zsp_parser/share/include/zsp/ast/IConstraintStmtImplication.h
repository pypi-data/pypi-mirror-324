...
using IConstraintStmtImplicationUP=UP<IConstraintStmtImplication>;
class IConstraintStmtImplication : public virtual IConstraintScope {
public:
    
    virtual ~IConstraintStmtImplication() { }
