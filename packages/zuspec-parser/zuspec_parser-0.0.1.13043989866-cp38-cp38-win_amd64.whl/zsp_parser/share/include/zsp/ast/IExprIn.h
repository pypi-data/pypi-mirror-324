...
class IExprIn;
using IExprInUP=UP<IExprIn>;
class IExprIn : public virtual IExpr {
public:
    ...
    virtual IExprOpenRangeList *getRhs() const = 0;
    
    virtual void setRhs(IExprOpenRangeList *v, bool own=true) = 0;
};
