...
using IExprSubscriptUP=UP<IExprSubscript>;
class IExprSubscript : public virtual IExpr {
public:
    
    virtual ~IExprSubscript() { }
    ...
    virtual IExpr *getSubscript() const = 0;
    
    virtual void setSubscript(IExpr *v, bool own=true) = 0;
};
