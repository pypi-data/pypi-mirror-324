...
using IActivityJoinSpecSelectUP=UP<IActivityJoinSpecSelect>;
class IActivityJoinSpecSelect : public virtual IActivityJoinSpec {
public:
    
    virtual ~IActivityJoinSpecSelect() { }
