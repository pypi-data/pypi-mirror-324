...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in vizier_service_pb2_grpc.py depends on'
...
class VizierServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeleteStudy = channel.unary_unary(
                ...
                _registered_method=True)
        self.SetStudyState = channel.unary_unary(
                '/vizier.VizierService/SetStudyState',
                request_serializer=vizier__service__pb2.SetStudyStateRequest.SerializeToString,
                response_deserializer=study__pb2.Study.FromString,
                _registered_method=True)
...
class VizierServiceServicer(object):
    ...
    def SetStudyState(self, request, context):
...
def add_VizierServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SetStudyState': grpc.unary_unary_rpc_method_handler(
                    servicer.SetStudyState,
                    request_deserializer=vizier__service__pb2.SetStudyStateRequest.FromString,
                    response_serializer=study__pb2.Study.SerializeToString,
            ),
    ...
    server.add_registered_method_handlers('vizier.VizierService', rpc_method_handlers)
...
class VizierService(object):
    ...
    def SetStudyState(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/vizier.VizierService/SetStudyState',
            vizier__service__pb2.SetStudyStateRequest.SerializeToString,
            study__pb2.Study.FromString,
            options,
            channel_credentials,
            insecure,
