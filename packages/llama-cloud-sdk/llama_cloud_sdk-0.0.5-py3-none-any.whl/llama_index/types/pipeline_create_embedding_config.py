...
class PipelineCreateEmbeddingConfig_AzureEmbedding(UniversalBaseModel):
...
class PipelineCreateEmbeddingConfig_BedrockEmbedding(UniversalBaseModel):
...
class PipelineCreateEmbeddingConfig_CohereEmbedding(UniversalBaseModel):
...
class PipelineCreateEmbeddingConfig_GeminiEmbedding(UniversalBaseModel):
...
class PipelineCreateEmbeddingConfig_HuggingfaceApiEmbedding(UniversalBaseModel):
...
class PipelineCreateEmbeddingConfig_OpenaiEmbedding(UniversalBaseModel):
...
class PipelineCreateEmbeddingConfig_VertexaiEmbedding(UniversalBaseModel):
