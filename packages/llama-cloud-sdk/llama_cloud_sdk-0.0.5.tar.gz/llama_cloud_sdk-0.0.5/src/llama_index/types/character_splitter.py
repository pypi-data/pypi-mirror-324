...
class CharacterSplitter(UniversalBaseModel):
    """
    ...
    paragraph_separator: typing.Optional[str] = pydantic.Field(default=None)
    """
    Separator between paragraphs.
    """

    secondary_chunking_regex: typing.Optional[str] = pydantic.Field(default=None)
    """
