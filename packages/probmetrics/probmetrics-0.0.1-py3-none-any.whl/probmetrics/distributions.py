...
class ContinuousDistribution:
    def get_quantiles(self, quantiles: torch.Tensor):
        pass

    def get_expectiles(self):
        pass
    ...
    def int_sq_cdf_up_to(self, x):
        pass

    def int_sq_cdf_from(self, x):
        pass

    # CDF, PDF, log-likelihood, integral over (squared) CDF / 1-CDF
    # maybe a way to indicate which quantities are available?
    # maybe a way to indicate which metrics should be evaluated?
