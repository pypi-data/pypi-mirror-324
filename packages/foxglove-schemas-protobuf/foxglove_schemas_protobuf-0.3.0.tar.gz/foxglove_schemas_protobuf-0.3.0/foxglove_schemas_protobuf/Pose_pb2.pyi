...
class Pose(google.protobuf.message.Message):
    ...
    @property
    def position(self) -> foxglove_Vector3_pb2.Vector3:
        """Point denoting position in 3D space"""

    @property
    def orientation(self) -> foxglove_Quaternion_pb2.Quaternion:
        """Quaternion denoting orientation in 3D space"""

    def __init__(
        self,
        *,
        position: foxglove_Vector3_pb2.Vector3 | None = ...,
        orientation: foxglove_Quaternion_pb2.Quaternion | None = ...,
    ) -> None: ...
