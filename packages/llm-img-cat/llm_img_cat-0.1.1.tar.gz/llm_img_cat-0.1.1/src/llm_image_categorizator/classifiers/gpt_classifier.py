"""GPT-4 Vision model for image classification."""
import base64
import json
import logging
...
class GPTClassifier(BaseClassifier):
    """Image classifier using GPT-4 Vision model."""
    
    def __init__(self, model_name: str = None, confidence_threshold: float = 0.9):
...
Respond in JSON format with category and confidence level (0-1):
{
    ...
    async def classify(self, image_path: Path) -> CategoryResult:
        """Classify a book cover image using GPT-4 Vision."""
