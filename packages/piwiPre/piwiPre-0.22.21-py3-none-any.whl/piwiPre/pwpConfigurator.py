    ...
    def __display_multilevel(self, start_row):
        ...
        for stage in my_range:
            ...
            for name in self.configurator.current_constraints:
                ...
                # Stage 1: constraint.how != FORCED, VALUE, CMDLINE & location = args or both
                if stage == 1:
                    if constraint.how in (ConstraintHow.FORCED, ConstraintHow.CMDLINE, ConstraintHow.VALUE):
                        continue
                ...
                # Stage 3: constraint.how == FORCED
                if stage == 3:
                    if constraint.how != ConstraintHow.FORCED and constraint.how != ConstraintHow.VALUE:
                        continue
