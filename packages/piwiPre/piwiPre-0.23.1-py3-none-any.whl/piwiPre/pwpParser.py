...
Other useful flags with their typical value when verifying albums::
        ...
        --enable-auto-configuration-delete true    # remove useless auto-config files
...
Autres options avec leurs valeur lorsque on utilise --verify-album::
     ...
     --enable-auto-configuration-delete         # enlève les fichiers d'auto-config inutiles
...
""")
        self.add_item('enable-auto-configuration-delete',
