...
class TradeManager(metaclass=SingletonMeta):
	...
	def __init__(self):
		...
		self._backgroundScheduler.add_job(self._performEODSettlement, 'cron', hour=16, minute=30, timezone=pytz.timezone('US/Eastern'), id='EODSettlement', misfire_grace_time = None)
