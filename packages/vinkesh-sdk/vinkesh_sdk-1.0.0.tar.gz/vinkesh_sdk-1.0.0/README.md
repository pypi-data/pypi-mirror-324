...
with vinkesh_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = vinkesh_sdk.PetApi(api_client)
    pet = vinkesh_sdk.Pet() # Pet | Create a new pet in the store
