...
import numpy as np
from .data import get_constituents_and_concat, get_ohlc
...
def calculate_portfolios(lookback, total_portfolio):
    ...
    df = get_ohlc(universe, start, end)
...
def get_weights_and_allocation(st1, st2, mom1, mom2, total_portfolio, lookback, ls_ratio):
    ...
    st1['Dollar Allocation'] = st1['Weight']*total_portfolio*ls_ratio
    
    st2["Weight"] = st2["HVOL"]/st2["HVOL"].sum()
    st2['Dollar Allocation'] = st2['Weight']*total_portfolio*(1-ls_ratio)
    ...
    mom1['Dollar Allocation'] = mom1['Weight']*total_portfolio*ls_ratio
    ...
    mom2['Dollar Allocation'] = mom2['Weight']*total_portfolio*(1-ls_ratio)
