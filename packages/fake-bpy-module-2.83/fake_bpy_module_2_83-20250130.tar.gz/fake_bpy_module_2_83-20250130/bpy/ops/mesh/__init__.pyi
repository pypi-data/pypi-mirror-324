...
def bevel(
    ...
    *,
    ...
    use_custom_profile: bool | None = False,
    ...
    ARC Arc, Inside of miter is arc.
        ...
        :type use_custom_profile: bool | None
...
def extrude_repeat(
    ...
    *,
    steps: int | None = 10,
    offset: collections.abc.Iterable[float] | None = (0.0, 0.0, 0.0),
...
def point_normals(
    ...
    *,
    ...
    target_location: collections.abc.Iterable[float] | None = (0.0, 0.0, 0.0),
    ...
    MOUSE Mouse, Follow mouse cursor.
        ...
        :type target_location: collections.abc.Iterable[float] | None
...
def select_axis(
    ...
    /,
    *,
    orientation: typing.Literal["GLOBAL", "LOCAL", "NORMAL", "GIMBAL", "VIEW", "CURSOR"]
    | None = "LOCAL",
    ...
    CURSOR Cursor, Align the transformation axes to the 3D cursor.
        :type orientation: typing.Literal['GLOBAL','LOCAL','NORMAL','GIMBAL','VIEW','CURSOR'] | None
...
def select_similar(
    ...
    *,
    ...
    :type undo: bool | None
    :param type: Type
    :type type: typing.Literal['NORMAL','FACE','VGROUP','EDGE','LENGTH','DIR','FACE','FACE_ANGLE','CREASE','BEVEL','SEAM','SHARP','FREESTYLE_EDGE','MATERIAL','AREA','SIDES','PERIMETER','NORMAL','COPLANAR','SMOOTH','FACE_MAP','FREESTYLE_FACE'] | None
