...
setuptools.setup(
    name='licomp_dwheeler',
    version=licomp_dwheeler_version,
    ...
    url="https://github.com/hesa/licomp-dwheeler",
    packages=['licomp_dwheeler'],
    entry_points={
        "console_scripts": [
            "licomp-dwheeler = licomp_dwheeler.__main__:main",
        ],
    },
    package_data={
