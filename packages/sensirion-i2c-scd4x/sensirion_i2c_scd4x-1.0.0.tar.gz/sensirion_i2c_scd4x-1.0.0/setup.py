...
version_line = open("sensirion_i2c_scd4x/version.py", "rt").read()
...
setup(
    name='sensirion_i2c_scd4x',
    version=version_string,
    author='Sensirion',
    author_email='info@sensirion.com',
    description='I2C driver for the Sensirion SCD4X sensor family',
    license='BSD',
    keywords="""Sensirion SCD4X
        I2C
        SCD40
        SCD41""",
    project_urls={
        "Documentation": "https://sensirion.github.io/python-i2c-scd4x",
        "Repository": "https://github.com/Sensirion/python-i2c-scd4x",
        "Changelog": "https://github.com/Sensirion/python-i2c-scd4x/blob/master/CHANGELOG.md",
    },
