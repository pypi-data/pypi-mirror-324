class Editor {
    ...
    constructor() {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            this.#htmlSaveButton = document.getElementById("editor-save");
            this.#htmlAutoButton = document.getElementById("editor-auto");
            this.#htmlAutoResult = document.getElementById("editor-auto-result")
            this.#htmlAutoResult = document.getElementById("editor-auto-result-body")

            this.#htmlSaveButton.addEventListener('click', () => this.#save());
            this.#htmlAutoButton.addEventListener('click', () => this.#auto());
        });
    };
    ...
    async #auto() {
        this.#htmlAutoButton.hidden = true;
        ...
        try {
            ...
            this.#htmlAutoResultBody.replaceChildren(...rows);
            this.#htmlAutoResult.hidden = false;
        } catch (ex) {
