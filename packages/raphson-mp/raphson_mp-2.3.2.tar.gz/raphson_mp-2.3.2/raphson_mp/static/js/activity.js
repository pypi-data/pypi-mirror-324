...
function getFileChangeRowHtml(data) {
    return createTableRow([timestampToString(data.change_time), data.username, document.getElementById(`trans-${data.action}`).textContent, data.track]);
}
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    setInterval(quickUpdate, 1000); /* interval must match progress transition in css */
