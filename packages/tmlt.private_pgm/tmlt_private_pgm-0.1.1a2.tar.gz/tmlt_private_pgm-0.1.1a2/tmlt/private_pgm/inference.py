import numpy as np
from tmlt.private_pgm import Domain, GraphicalModel, callbacks, CliqueVector
...
class FactoredInference:
    def __init__(
        ...
        if backend == "torch":
            from tmlt.private_pgm.torch_factor import Factor

            self.Factor = Factor
        else:
            from tmlt.private_pgm import Factor
