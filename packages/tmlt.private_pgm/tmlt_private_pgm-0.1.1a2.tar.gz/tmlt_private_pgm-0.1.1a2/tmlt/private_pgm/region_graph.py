...
from tmlt.private_pgm import Domain, Factor, CliqueVector
...
from tmlt.private_pgm import CliqueVector, Domain, Factor
from tmlt.private_pgm.junction_tree import JunctionTree
...
class RegionGraph:
    def __init__(
        ...
        tree = JunctionTree(domain, cliques, None)
