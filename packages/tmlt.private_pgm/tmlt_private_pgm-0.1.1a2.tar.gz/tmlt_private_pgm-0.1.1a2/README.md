...
FORKED FROM: https://github.com/ryan112358/private-pgm/tree/master/src/mbi
...
This allows you to import modules from this package like ``` from tmlt.private_pgm import FactoredInference ``` no matter what directory you are working in.  Once this is done, check to make sure the tests are passing
