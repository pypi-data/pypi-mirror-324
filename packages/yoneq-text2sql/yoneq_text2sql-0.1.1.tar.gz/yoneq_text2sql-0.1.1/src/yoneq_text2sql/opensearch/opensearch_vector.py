...
class OpenSearch_VectorStore(Text2SqlBase):
  def __init__(self, config=None):
    Text2SqlBase.__init__(self, config=config)
    document_index = "text2sql_document_index"
    ddl_index = "text2sql_ddl_index"
    question_sql_index = "text2sql_questions_sql_index"
  ...
  def add_ddl(self, ddl: str, engine: str = None,
    ...
    table_metadata = Text2SqlBase.extract_table_metadata(ddl)
