...
class AzureAISearch_VectorStore(Text2SqlBase):
    """
    ...
    Args:
        config (dict): Configuration dictionary. Defaults to {}. You must provide an API key in the config.
            ...
            - index_name (str, optional): Name of the index. Defaults to "text2sql-index".
    ...
    def __init__(self, config=None):
        ...
        self.index_name = config.get("index_name", "text2sql-index")
