...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/notification/v1/notification_usage_pb2_grpc.py depends on'
...
def add_NotificationUsageServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.notification.v1.NotificationUsage', rpc_method_handlers)
