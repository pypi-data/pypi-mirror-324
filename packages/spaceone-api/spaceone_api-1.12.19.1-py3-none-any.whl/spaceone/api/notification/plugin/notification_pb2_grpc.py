...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/notification/plugin/notification_pb2_grpc.py depends on'
...
def add_NotificationServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.notification.plugin.Notification', rpc_method_handlers)
