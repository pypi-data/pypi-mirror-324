...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/cost_analysis/v1/budget_pb2_grpc.py depends on'
...
def add_BudgetServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.cost_analysis.v1.Budget', rpc_method_handlers)
