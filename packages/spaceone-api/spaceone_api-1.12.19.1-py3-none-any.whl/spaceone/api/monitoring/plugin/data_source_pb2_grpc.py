...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/monitoring/plugin/data_source_pb2_grpc.py depends on'
...
def add_DataSourceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.monitoring.plugin.DataSource', rpc_method_handlers)
