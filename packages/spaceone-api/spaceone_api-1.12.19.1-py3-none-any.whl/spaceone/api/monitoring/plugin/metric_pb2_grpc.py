...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/monitoring/plugin/metric_pb2_grpc.py depends on'
...
def add_MetricServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.monitoring.plugin.Metric', rpc_method_handlers)
