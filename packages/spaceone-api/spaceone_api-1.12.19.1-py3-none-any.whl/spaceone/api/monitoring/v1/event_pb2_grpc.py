...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/monitoring/v1/event_pb2_grpc.py depends on'
...
def add_EventServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.monitoring.v1.Event', rpc_method_handlers)
