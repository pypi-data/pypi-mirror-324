...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/repository/v1/policy_pb2_grpc.py depends on'
...
def add_PolicyServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.repository.v1.Policy', rpc_method_handlers)
