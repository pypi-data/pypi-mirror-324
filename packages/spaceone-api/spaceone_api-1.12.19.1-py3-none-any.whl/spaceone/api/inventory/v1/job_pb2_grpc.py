...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/inventory/v1/job_pb2_grpc.py depends on'
...
def add_JobServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.inventory.v1.Job', rpc_method_handlers)
