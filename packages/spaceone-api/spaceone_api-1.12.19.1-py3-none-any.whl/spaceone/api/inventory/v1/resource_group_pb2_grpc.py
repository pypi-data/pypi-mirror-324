...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/inventory/v1/resource_group_pb2_grpc.py depends on'
...
def add_ResourceGroupServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.inventory.v1.ResourceGroup', rpc_method_handlers)
