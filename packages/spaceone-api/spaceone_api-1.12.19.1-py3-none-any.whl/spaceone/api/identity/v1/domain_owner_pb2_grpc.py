...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/identity/v1/domain_owner_pb2_grpc.py depends on'
...
def add_DomainOwnerServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.identity.v1.DomainOwner', rpc_method_handlers)
