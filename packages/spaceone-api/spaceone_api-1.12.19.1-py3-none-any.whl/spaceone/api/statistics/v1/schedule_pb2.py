...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'spaceone/api/statistics/v1/schedule.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SCHEDULE'].methods_by_name['add']._loaded_options = None
  _globals['_SCHEDULE'].methods_by_name['add']._serialized_options = b'\202\323\344\223\002 \"\033/statistics/v1/schedule/add:\001*'
  _globals['_SCHEDULE'].methods_by_name['update']._loaded_options = None
  _globals['_SCHEDULE'].methods_by_name['update']._serialized_options = b'\202\323\344\223\002 \"\033/statistics/schedule/update:\001*'
  _globals['_SCHEDULE'].methods_by_name['enable']._loaded_options = None
  _globals['_SCHEDULE'].methods_by_name['enable']._serialized_options = b'\202\323\344\223\002#\"\036/statistics/v1/schedule/enable:\001*'
  _globals['_SCHEDULE'].methods_by_name['disable']._loaded_options = None
  _globals['_SCHEDULE'].methods_by_name['disable']._serialized_options = b'\202\323\344\223\002$\"\037/statistics/v1/schedule/disable:\001*'
  _globals['_SCHEDULE'].methods_by_name['delete']._loaded_options = None
  _globals['_SCHEDULE'].methods_by_name['delete']._serialized_options = b'\202\323\344\223\002#\"\036/statistics/v1/schedule/delete:\001*'
  _globals['_SCHEDULE'].methods_by_name['get']._loaded_options = None
  _globals['_SCHEDULE'].methods_by_name['get']._serialized_options = b'\202\323\344\223\002 \"\033/statistics/v1/schedule/get:\001*'
  _globals['_SCHEDULE'].methods_by_name['list']._loaded_options = None
  _globals['_SCHEDULE'].methods_by_name['list']._serialized_options = b'\202\323\344\223\002!\"\034/statistics/v1/schedule/list:\001*'
  _globals['_SCHEDULE'].methods_by_name['stat']._loaded_options = None
  _globals['_SCHEDULE'].methods_by_name['stat']._serialized_options = b'\202\323\344\223\002!\"\034/statistics/v1/schedule/stat:\001*'
