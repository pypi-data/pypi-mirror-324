...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/statistics/v1/history_pb2_grpc.py depends on'
...
def add_HistoryServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.statistics.v1.History', rpc_method_handlers)
