...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'spaceone/api/inventory/v1/change_history.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CHANGEHISTORY'].methods_by_name['list']._loaded_options = None
  ...
  _globals['_CHANGEHISTORY'].methods_by_name['stat']._loaded_options = None
