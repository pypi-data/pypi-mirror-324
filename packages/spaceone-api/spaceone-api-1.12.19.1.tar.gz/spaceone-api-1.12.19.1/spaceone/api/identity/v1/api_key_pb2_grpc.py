...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/identity/v1/api_key_pb2_grpc.py depends on'
...
def add_APIKeyServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.identity.v1.APIKey', rpc_method_handlers)
