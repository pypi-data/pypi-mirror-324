...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'spaceone/api/plugin/v1/supervisor.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SUPERVISOR'].methods_by_name['publish']._loaded_options = None
  _globals['_SUPERVISOR'].methods_by_name['publish']._serialized_options = b'\202\323\344\223\002\"\"\035/plugin/v1/supervisor/publish:\001*'
  _globals['_SUPERVISOR'].methods_by_name['register']._loaded_options = None
  _globals['_SUPERVISOR'].methods_by_name['register']._serialized_options = b'\202\323\344\223\002#\"\036/plugin/v1/supervisor/register:\001*'
  _globals['_SUPERVISOR'].methods_by_name['update']._loaded_options = None
  _globals['_SUPERVISOR'].methods_by_name['update']._serialized_options = b'\202\323\344\223\002!\"\034/plugin/v1/supervisor/update:\001*'
  _globals['_SUPERVISOR'].methods_by_name['deregister']._loaded_options = None
  _globals['_SUPERVISOR'].methods_by_name['deregister']._serialized_options = b'\202\323\344\223\002%\" /plugin/v1/supervisor/deregister:\001*'
  _globals['_SUPERVISOR'].methods_by_name['enable']._loaded_options = None
  _globals['_SUPERVISOR'].methods_by_name['enable']._serialized_options = b'\202\323\344\223\002!\"\034/plugin/v1/supervisor/enable:\001*'
  _globals['_SUPERVISOR'].methods_by_name['disable']._loaded_options = None
  _globals['_SUPERVISOR'].methods_by_name['disable']._serialized_options = b'\202\323\344\223\002\"\"\035/plugin/v1/supervisor/disable:\001*'
  _globals['_SUPERVISOR'].methods_by_name['recover_plugin']._loaded_options = None
  _globals['_SUPERVISOR'].methods_by_name['recover_plugin']._serialized_options = b'\202\323\344\223\002)\"$/plugin/v1/supervisor/recover-plugin:\001*'
  _globals['_SUPERVISOR'].methods_by_name['get']._loaded_options = None
  _globals['_SUPERVISOR'].methods_by_name['get']._serialized_options = b'\202\323\344\223\002\036\"\031/plugin/v1/supervisor/get:\001*'
  _globals['_SUPERVISOR'].methods_by_name['list']._loaded_options = None
  _globals['_SUPERVISOR'].methods_by_name['list']._serialized_options = b'\202\323\344\223\002\037\"\032/plugin/v1/supervisor/list:\001*'
  _globals['_SUPERVISOR'].methods_by_name['stat']._loaded_options = None
  _globals['_SUPERVISOR'].methods_by_name['stat']._serialized_options = b'\202\323\344\223\002\037\"\032/plugin/v1/supervisor/stat:\001*'
  _globals['_SUPERVISOR'].methods_by_name['list_plugins']._loaded_options = None
  _globals['_SUPERVISOR'].methods_by_name['list_plugins']._serialized_options = b'\202\323\344\223\002\'\"\"/plugin/v1/supervisor/list-plugins:\001*'
