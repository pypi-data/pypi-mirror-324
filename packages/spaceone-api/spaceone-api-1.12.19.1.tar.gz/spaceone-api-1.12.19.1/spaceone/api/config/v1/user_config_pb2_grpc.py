...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/config/v1/user_config_pb2_grpc.py depends on'
...
def add_UserConfigServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.config.v1.UserConfig', rpc_method_handlers)
