...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/notification/v1/project_channel_pb2_grpc.py depends on'
...
def add_ProjectChannelServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.notification.v1.ProjectChannel', rpc_method_handlers)
