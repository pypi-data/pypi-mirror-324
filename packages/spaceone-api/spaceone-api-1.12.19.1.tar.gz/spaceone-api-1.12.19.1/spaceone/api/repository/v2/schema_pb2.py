...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'spaceone/api/repository/v2/schema.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'Z?github.com/cloudforet-io/api/dist/go/spaceone/api/repository/v2'
  _globals['_SCHEMA'].methods_by_name['create']._loaded_options = None
  _globals['_SCHEMA'].methods_by_name['create']._serialized_options = b'\202\323\344\223\002!\"\034/repository/v2/schema/create:\001*'
  _globals['_SCHEMA'].methods_by_name['update']._loaded_options = None
  _globals['_SCHEMA'].methods_by_name['update']._serialized_options = b'\202\323\344\223\002!\"\034/repository/v2/schema/update:\001*'
  _globals['_SCHEMA'].methods_by_name['sync']._loaded_options = None
  _globals['_SCHEMA'].methods_by_name['sync']._serialized_options = b'\202\323\344\223\002\037\"\032/repository/v2/schema/sync:\001*'
  _globals['_SCHEMA'].methods_by_name['delete']._loaded_options = None
  _globals['_SCHEMA'].methods_by_name['delete']._serialized_options = b'\202\323\344\223\002!\"\034/repository/v2/schema/delete:\001*'
  _globals['_SCHEMA'].methods_by_name['get']._loaded_options = None
  _globals['_SCHEMA'].methods_by_name['get']._serialized_options = b'\202\323\344\223\002\036\"\031/repository/v2/schema/get:\001*'
  _globals['_SCHEMA'].methods_by_name['list']._loaded_options = None
  _globals['_SCHEMA'].methods_by_name['list']._serialized_options = b'\202\323\344\223\002\037\"\032/repository/v2/schema/list:\001*'
  _globals['_SCHEMA'].methods_by_name['stat']._loaded_options = None
  _globals['_SCHEMA'].methods_by_name['stat']._serialized_options = b'\202\323\344\223\002\037\"\032/repository/v2/schema/stat:\001*'
