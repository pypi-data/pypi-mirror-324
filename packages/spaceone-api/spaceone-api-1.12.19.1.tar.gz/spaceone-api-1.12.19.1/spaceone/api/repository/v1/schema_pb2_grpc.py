...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/repository/v1/schema_pb2_grpc.py depends on'
...
def add_SchemaServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.repository.v1.Schema', rpc_method_handlers)
