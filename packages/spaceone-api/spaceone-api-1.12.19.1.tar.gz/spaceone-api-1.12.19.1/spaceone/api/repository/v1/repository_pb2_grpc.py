...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/repository/v1/repository_pb2_grpc.py depends on'
...
def add_RepositoryServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.repository.v1.Repository', rpc_method_handlers)
