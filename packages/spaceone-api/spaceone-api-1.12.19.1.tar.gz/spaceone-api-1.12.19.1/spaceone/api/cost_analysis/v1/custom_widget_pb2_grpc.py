...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in spaceone/api/cost_analysis/v1/custom_widget_pb2_grpc.py depends on'
...
def add_CustomWidgetServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('spaceone.api.cost_analysis.v1.CustomWidget', rpc_method_handlers)
