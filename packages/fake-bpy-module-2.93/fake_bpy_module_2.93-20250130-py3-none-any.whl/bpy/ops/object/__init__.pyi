...
def add(
    ...
    *,
    ...
    """Add an object to the scene
        ...
        :param type: Type
        :type type: typing.Literal['MESH','CURVE','SURFACE','META','FONT','HAIR','POINTCLOUD','VOLUME','GPENCIL','ARMATURE','LATTICE','EMPTY','LIGHT','LIGHT_PROBE','CAMERA','SPEAKER'] | None
...
def bake(
    ...
    *,
    ...
    """Bake image textures of selected objects
        ...
        :type type: typing.Literal['COMBINED','AO','SHADOW','NORMAL','UV','ROUGHNESS','EMIT','ENVIRONMENT','DIFFUSE','GLOSSY','TRANSMISSION'] | None
        :param pass_filter: Pass Filter, Filter to combined, diffuse, glossy, transmission and subsurface passes
        :type pass_filter: set[typing.Literal['NONE','AO','EMIT','DIRECT','INDIRECT','COLOR','DIFFUSE','GLOSSY','TRANSMISSION']] | None
...
def mode_set(
    ...
    *,
    ...
    Vertex Paint, Grease Pencil Vertex Paint Strokes.
        :type mode: typing.Literal['OBJECT','EDIT','POSE','SCULPT','VERTEX_PAINT','WEIGHT_PAINT','TEXTURE_PAINT','PARTICLE_EDIT','EDIT_GPENCIL','SCULPT_GPENCIL','PAINT_GPENCIL','WEIGHT_GPENCIL','VERTEX_GPENCIL'] | None
        :param toggle: Toggle
        :type toggle: bool | None
    """
...
def transfer_mode(
    ...
    /,
    *,
    use_eyedropper: bool | None = False,
):
