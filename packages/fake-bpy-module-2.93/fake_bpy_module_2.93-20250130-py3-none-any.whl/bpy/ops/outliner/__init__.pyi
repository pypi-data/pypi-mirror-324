...
def id_operation(
    ...
    *,
    ...
    SELECT_LINKED
    Select Linked.
        :type type: typing.Literal['UNLINK','MARK_ASSET','CLEAR_ASSET','LOCAL','SINGLE','DELETE','REMAP','OVERRIDE_LIBRARY_CREATE','OVERRIDE_LIBRARY_CREATE_HIERARCHY','OVERRIDE_LIBRARY_PROXY_CONVERT','OVERRIDE_LIBRARY_RESET','OVERRIDE_LIBRARY_RESET_HIERARCHY','OVERRIDE_LIBRARY_RESYNC_HIERARCHY','OVERRIDE_LIBRARY_RESYNC_HIERARCHY_ENFORCE','OVERRIDE_LIBRARY_DELETE_HIERARCHY','COPY','PASTE','ADD_FAKE','CLEAR_FAKE','RENAME','SELECT_LINKED'] | None
    """
...
def object_operation(
    ...
    *,
    ...
    OBJECT_PROXY_TO_OVERRIDE
    Convert Proxy to Override, Convert a Proxy object to a full library override, including all its dependencies.
        :type type: typing.Literal['SELECT','DESELECT','SELECT_HIERARCHY','REMAP','RENAME','OBJECT_PROXY_TO_OVERRIDE'] | None
    """
