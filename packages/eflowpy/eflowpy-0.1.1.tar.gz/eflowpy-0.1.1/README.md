...
### **2️⃣ Calculate Flow Duration Curve (FDC)**
```python
...
### **3️⃣ Get Specific Q-Values from FDC**
```python
...
### **4️⃣ Plot FDC with Optional Q-Values**
```python
...
## 🏗️ Contributing
We welcome contributions! If you’d like to add new methods, improve documentation, or fix bugs, please:
