...
class JobConfig:
    def __init__(
        ...
        self.num_replicas = 1  # self.cluster_config.num_gpus // self.num_workers
    ...
    def generate_unique_model_job_configs(cls, config: dict, num_requests: int = 32):
        ...
        # pp_dimensions = [2]
        pp_dimensions = config["pp_dimensions"]
        slo_scale = config["slo_scale"]
    ...
    def to_config_dict(self):
        return {
            **self.job_config.to_config_dict(),
            ...
            "random_forrest_execution_time_predictor_config_cache_dir": self.cache_dir,
