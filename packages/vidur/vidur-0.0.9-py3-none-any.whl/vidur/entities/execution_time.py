...
class ExecutionTime(BaseEntity):
    def __init__(
        ...
        # TODO(Amey): Need to add accounting for kvp group communication time
        self._kvp_group_communication_time = 0
    ...
    def _get_attention_layer_execution_time(self) -> float:
        return (
            ...
            # + self._attention_kv_cache_save_execution_time  # removed to simulate a faster append kernel
    ...
    @property
    def kvp_group_communication_time(self) -> float:
        return self._kvp_group_communication_time
    ...
    def model_time(self) -> float:
        ...
        return (
            ...
            + self.kvp_group_communication_time
        ) * 1e-3
    ...
    def to_dict(self) -> Dict[str, float]:
        return {
            ...
            "pipeline_parallel_communication_time": self._pipeline_parallel_communication_time,
