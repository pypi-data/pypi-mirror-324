...
from vidur.entities import Batch, BatchStage, ExecutionTime, KVParallelBatch
...
class ReplicaStageScheduler:
    ...
    def add_batch(self, batch: Union[Batch, KVParallelBatch]) -> None:
    ...
    def on_schedule(
        self,
    ) -> Tuple[Union[Batch, KVParallelBatch], BatchStage, ExecutionTime]:
        ...
        batch_stage = batch.to_batch_stage(self._stage_id, execution_time)
