...
class SklearnExecutionTimePredictor(BaseExecutionTimePredictor):
    ...
    def _get_compute_predication_repo_id(self) -> str:
    ...
    def _get_network_predication_repo_id(self) -> str:
    ...
    def _load_predictions_from_hf(self) -> bool:
        compute_repo_id = self._get_compute_predication_repo_id()
        network_repo_id = self._get_network_predication_repo_id()
