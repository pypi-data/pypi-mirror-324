...
def main():
    ...
    helper = argparse.ArgumentParser(prog="test_cover", description="The Capablanca Testing Application.")
    ...
    helper.add_argument('--version', action='version', version='%(prog)s 2.3')
