...
class EnsureOp(_ods_ir.OpView):
  ...
  def __init__(self, property, *, clock=None, enable=None, label=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def ensure(property, *, clock=None, enable=None, label=None, loc=None, ip=None) -> _ods_ir.Operation:
  return EnsureOp(property=property, clock=clock, enable=enable, label=label, loc=loc, ip=ip)
...
def lec(are_equivalent, *, loc=None, ip=None) -> _ods_ir.Value:
  return LogicEquivalenceCheckingOp(areEquivalent=are_equivalent, loc=loc, ip=ip).result
...
def require(property, *, clock=None, enable=None, label=None, loc=None, ip=None) -> _ods_ir.Operation:
  return RequireOp(property=property, clock=clock, enable=enable, label=label, loc=loc, ip=ip)
