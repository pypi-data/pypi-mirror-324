...
class ConnectionConfig:
    ...
    error_handler: ErrorHandlerProtocol | None = field(default=None)
    ...
    def prefix_schema(self) -> str:
        ...
        qs = self.db.statements
        if qs and qs.prefix_schema:
            return f"{qs.prefix_schema}."
        return ""
        ...
        **kwargs,
        ...
        if isinstance(config, EngineManager):
            ...
            # If there is only one configuration, then load it.
                ...
                msg = ("An engine_key was not provided and no 'default' "
                       "key was found in any configuration. ")
    ...
    def set_handlers(self, handlers: HandlerMapping) -> None:
        ...
        for handler_name, _handler in handlers.items():
            ...
            if current_handler is not None:
                # Get the current value of the handler
                ...
                # Raise error if handler name is invalid
