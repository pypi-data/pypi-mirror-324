...
@dataclass(eq=False, repr=False)
class MsgClaimDepositsRequest(betterproto.Message):
    creator: str = betterproto.string_field(1)
    deposit_ids: List[int] = betterproto.uint64_field(2)
    timestamps: List[int] = betterproto.uint64_field(3)
    """list of timestamps in milliseconds"""


@dataclass(eq=False, repr=False)
class MsgClaimDepositsResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class MsgUpdateSnapshotLimit(betterproto.Message):
    authority: str = betterproto.string_field(1)
    limit: int = betterproto.uint64_field(2)


@dataclass(eq=False, repr=False)
class MsgUpdateSnapshotLimitResponse(betterproto.Message):
    pass
...
class BridgeValidatorSetParams(betterproto.Message):
    ...
    validator_timestamp: int = betterproto.uint64_field(2)
    validator_power_threshold: int = betterproto.uint64_field(3)
...
class BridgeValidatorSetCheckpointParams(betterproto.Message):
    validator_timestamp: int = betterproto.uint64_field(1)
    validator_power_threshold: int = betterproto.uint64_field(2)
...
class QueryGetValidatorCheckpointParamsResponse(betterproto.Message):
    ...
    power_threshold: int = betterproto.uint64_field(4)
...
@dataclass(eq=False, repr=False)
class QueryGetSnapshotLimitRequest(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class QueryGetSnapshotLimitResponse(betterproto.Message):
...
class GenesisState(betterproto.Message):
    ...
    params: "Params" = betterproto.message_field(1)
    snapshot_limit: int = betterproto.uint64_field(2)
...
class MsgStub(betterproto.ServiceStub):
    ...
    async def claim_deposits(
        self,
        msg_claim_deposits_request: "MsgClaimDepositsRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
    ) -> "MsgClaimDepositsResponse":
        return await self._unary_unary(
            "/layer.bridge.Msg/ClaimDeposits",
            msg_claim_deposits_request,
            MsgClaimDepositsResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def update_snapshot_limit(
        self,
        msg_update_snapshot_limit: "MsgUpdateSnapshotLimit",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
    ) -> "MsgUpdateSnapshotLimitResponse":
        return await self._unary_unary(
            "/layer.bridge.Msg/UpdateSnapshotLimit",
            msg_update_snapshot_limit,
            MsgUpdateSnapshotLimitResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class QueryStub(betterproto.ServiceStub):
    ...
    async def get_snapshot_limit(
        self,
        query_get_snapshot_limit_request: "QueryGetSnapshotLimitRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
    ) -> "QueryGetSnapshotLimitResponse":
        return await self._unary_unary(
            "/layer.bridge.Query/GetSnapshotLimit",
            query_get_snapshot_limit_request,
            QueryGetSnapshotLimitResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class MsgBase(ServiceBase):
    ...
    async def claim_deposits(
        self, msg_claim_deposits_request: "MsgClaimDepositsRequest"
    ) -> "MsgClaimDepositsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def update_snapshot_limit(
        self, msg_update_snapshot_limit: "MsgUpdateSnapshotLimit"
    ) -> "MsgUpdateSnapshotLimitResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_claim_deposits(
        self,
        stream: "grpclib.server.Stream[MsgClaimDepositsRequest, MsgClaimDepositsResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.claim_deposits(request)
        await stream.send_message(response)

    async def __rpc_update_snapshot_limit(
        self,
        stream: "grpclib.server.Stream[MsgUpdateSnapshotLimit, MsgUpdateSnapshotLimitResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.update_snapshot_limit(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/layer.bridge.Msg/ClaimDeposits": grpclib.const.Handler(
                self.__rpc_claim_deposits,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgClaimDepositsRequest,
                MsgClaimDepositsResponse,
            ),
            "/layer.bridge.Msg/UpdateSnapshotLimit": grpclib.const.Handler(
                self.__rpc_update_snapshot_limit,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgUpdateSnapshotLimit,
                MsgUpdateSnapshotLimitResponse,
            ),
        }
...
class QueryBase(ServiceBase):
    ...
    async def get_snapshot_limit(
        self, query_get_snapshot_limit_request: "QueryGetSnapshotLimitRequest"
    ) -> "QueryGetSnapshotLimitResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_get_snapshot_limit(
        self,
        stream: "grpclib.server.Stream[QueryGetSnapshotLimitRequest, QueryGetSnapshotLimitResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_snapshot_limit(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/layer.bridge.Query/GetSnapshotLimit": grpclib.const.Handler(
                self.__rpc_get_snapshot_limit,
                grpclib.const.Cardinality.UNARY_UNARY,
                QueryGetSnapshotLimitRequest,
                QueryGetSnapshotLimitResponse,
            ),
        }
