...
class SessionAsync:
    ...
    def __init__(
        ...
        self._chat_connection_id = str(uuid.uuid4())
    ...
    async def query(
        ...
        *,
        ...
        request = ChatRequest(
            chat_connection_id=self._chat_connection_id,
            t="cq",
            mode="s",
    ...
    async def connect(self):
        ...
        headers["x-h2ogpte-chat-session-id"] = self._chat_connection_id
