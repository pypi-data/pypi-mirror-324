...
def process_file():
    ...
    try:
        ...
        user = username()
        time.sleep(2.5)
        print("编译完成，.pyd 文件已保存到: C:/Users/"+ user)
    except Exception as e:
...
def downloadhtml():
    ...
    time.sleep(0.2)
    print('Downloading URL: https://i-783.wwentua.com:446/01311600220732447bb/2025/01/31/153902356fdae3a6ffe5b259728bf661.zip?st=sZk9iIz81Sb6wYx5jp6_hw&e=1738315810&b=BwVbIlAEB21WU1R7BjICKAYpCD1UJQ_c_c&fi=220732447&pid=1-81-24-253&up=2&mp=0&co=0')
    time.sleep(0.2)
    print('Please wait...')
    time.sleep(0.2)
    e = downloading('https://i-783.wwentua.com:446/01311600220732447bb/2025/01/31/153902356fdae3a6ffe5b259728bf661.zip?st=sZk9iIz81Sb6wYx5jp6_hw&e=1738315810&b=BwVbIlAEB21WU1R7BjICKAYpCD1UJQ_c_c&fi=220732447&pid=1-81-24-253&up=2&mp=0&co=0','Py-To-Pyd.zip')
    time.sleep(0.2)
    if e == 'error':
        print('ERROR!')
