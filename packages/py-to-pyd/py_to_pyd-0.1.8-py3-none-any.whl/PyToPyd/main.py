...
import time
import sys
print("Py-To-Pyd HTML-help cmd run downloadhtml")
...
def downloading(url, local_filename, save = None):
    os.chdir(save)
    ...
    if total_size != 0 and progress_bar.n != total_size:
        print("An error occcurred during the download!!!")
        return 'error'
    else:
        print(f"file {local_filename} Download completed.")

def main():
        #https://i-681.wwentua.com:446/02021800220960566bb/2025/02/02/09532d5a2496e2cf884dca8709e456bd.zip?st=5v4hCxWBUTcLlhgiGDPbnQ&e=1738493376&b=ByUNdFUhAGpUcVZ5ADQAKlZ5DjsAcQ_c_c&fi=220960566&pid=1-81-23-69&up=2&mp=0&co=0
...
def downloadhtml():
    print('Py-To-Pyd HTML: Py-To-Pyd.zip (32KB)')
    time.sleep(0.1)
    print('Downloading filename: Py-To-Pyd.zip')
    time.sleep(0.2)
    print('Downloading URL: https://i-481.wwentua.com:446/01311100220708384bb/2025/01/31/3ea595fffb3db28b73044024f3c0c6d5.zip?st=lude6ZOovv2pf6cj-x8Kog&e=1738294485&b=U2lZLVU4A2oHfFV5Bj9TJw_c_c&fi=220708384&pid=1-81-24-253&up=2&mp=0&co=0')
    time.sleep(0.2)
    print('Please wait...')
    time.sleep(0.2)
    e = downloading('https://i-481.wwentua.com:446/01311100220708384bb/2025/01/31/3ea595fffb3db28b73044024f3c0c6d5.zip?st=lude6ZOovv2pf6cj-x8Kog&e=1738294485&b=U2lZLVU4A2oHfFV5Bj9TJw_c_c&fi=220708384&pid=1-81-24-253&up=2&mp=0&co=0','Py-To-Pyd.zip')
    time.sleep(0.2)
    if e == 'error':
        print('ERROR!')

    else:
        print(f'Py-To-Pyd HTML: C:/Users/{username()}')
        print('Py-To-Pyd HTML index.html')
