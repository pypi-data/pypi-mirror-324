...
def copy_data( output_directory, name_appendage_1, name_appendage_2 ):
    ...
    shutil.copy( output_directory + "Colour/Condensed_Data/colour_data" + name_appendage_1 + ".csv", output_directory + "Colour/Condensed_Data/colour_data" + name_appendage_2 + ".csv" )

    shutil.copy( output_directory + "ColourCondensed_Data/file_data" + name_appendage_1 + ".csv", output_directory + "Colour/Condensed_Data/file_data" + name_appendage_2 + ".csv" )
