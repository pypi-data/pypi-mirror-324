...
import epho_sdk_testing_sdk
from epho_sdk_testing_sdk.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to https://api.giphy.com/v1
# See configuration.py for a list of all supported configuration parameters.
configuration = epho_sdk_testing_sdk.Configuration(
...
with epho_sdk_testing_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = epho_sdk_testing_sdk.GifsApi(api_client)
