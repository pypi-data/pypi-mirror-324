    ...
    def make_instance(self, include_optional) -> GetGifsById200Response:
        ...
        if include_optional:
            return GetGifsById200Response(
                data = [
                    epho_sdk_testing_sdk.models.gif.Gif(
                        ...
                        id = 'YsTs5ltWtEhnq', 
                        images = epho_sdk_testing_sdk.models.gif_images.Gif_images(
                            downsized = null, 
                        ...
                        user = epho_sdk_testing_sdk.models.user.User(
                ...
                meta = epho_sdk_testing_sdk.models.meta.Meta(
                    msg = 'OK', 
                    response_id = '57eea03c72381f86e05c35d2', 
                    status = 200, ),
                pagination = epho_sdk_testing_sdk.models.pagination.Pagination(
                    count = 25, 
                    offset = 75, 
                    total_count = 250, )
            )
