...
def gltf(
    ...
    /,
    *,
    export_format: typing.Literal["GLB", "GLTF_EMBEDDED", "GLTF_SEPARATE"]
    | None = "GLB",
    ui_tab: typing.Literal["GENERAL", "MESHES", "OBJECTS", "ANIMATION"]
    | None = "GENERAL",
    export_copyright: str = "",
    export_image_format: typing.Literal["NAME", "JPEG", "PNG"] | None = "NAME",
    ...
    export_selected: bool | None = False,
    ...
    export_force_sampling: bool | None = False,
    ...
    GLTF_SEPARATE glTF Separate (.gltf + .bin + textures), Exports multiple files, with separate JSON, binary and texture data. Easiest to edit later.
        :type export_format: typing.Literal['GLB','GLTF_EMBEDDED','GLTF_SEPARATE'] | None
    ...
    PNG PNG Format (.png), Encode and save textures as .png files.
        :type export_image_format: typing.Literal['NAME','JPEG','PNG'] | None
        ...
        :type export_selected: bool | None
