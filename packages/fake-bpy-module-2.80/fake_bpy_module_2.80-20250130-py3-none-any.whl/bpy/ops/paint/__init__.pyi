...
def brush_select(
    ...
    *,
    ...
    """Select a paint mode's brush by tool type
        ...
        :type sculpt_tool: typing.Literal['DRAW','CLAY','CLAY_STRIPS','LAYER','INFLATE','BLOB','CREASE','SMOOTH','FLATTEN','FILL','SCRAPE','PINCH','GRAB','SNAKE_HOOK','THUMB','NUDGE','ROTATE','SIMPLIFY','MASK'] | None
