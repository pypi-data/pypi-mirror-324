...
class CurrentTransactionResponse(_message.Message):
...
class PositionHistoryRequest(_message.Message):
    ...
    start_time: str
    end_time: str
    def __init__(self, db_auth: _Optional[str] = ..., start_time: _Optional[str] = ..., end_time: _Optional[str] = ...) -> None: ...

class PositionHistoryResponse(_message.Message):
    __slots__ = ("history",)
    HISTORY_FIELD_NUMBER: _ClassVar[int]
    history: _containers.RepeatedCompositeFieldContainer[Transaction]
    def __init__(self, history: _Optional[_Iterable[_Union[Transaction, _Mapping]]] = ...) -> None: ...
