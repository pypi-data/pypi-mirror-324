...
class TransactionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPastTransactions = channel.unary_unary(
                ...
                request_serializer=transaction__pb2.ScopedTransactionRequest.SerializeToString,
                response_deserializer=transaction__pb2.TransactionsResponse.FromString,
                _registered_method=True)
...
def add_TransactionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetPastTransactions': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=transaction__pb2.ScopedTransactionRequest.FromString,
                    response_serializer=transaction__pb2.TransactionsResponse.SerializeToString,
            ),
...
class TransactionService(object):
    ...
    def GetPastTransactions(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tetherhelix_grpc.TransactionService/GetPastTransactions',
            transaction__pb2.ScopedTransactionRequest.SerializeToString,
            transaction__pb2.TransactionsResponse.FromString,
            options,
            channel_credentials,
            insecure,
