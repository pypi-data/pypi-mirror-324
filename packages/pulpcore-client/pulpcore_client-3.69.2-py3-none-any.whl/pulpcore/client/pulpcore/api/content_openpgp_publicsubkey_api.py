...
class ContentOpenpgpPublicsubkeyApi(object):
    ...
    def list_with_http_info(self,  **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginatedOpenPGPPublicSubkeyResponseList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/core/openpgp_publicsubkey/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='PaginatedOpenPGPPublicSubkeyResponseList',  # noqa: E501
    ...
    def read(self, open_p_g_p_public_subkey_href,  **kwargs):  # noqa: E501
        """Inspect an open pgp public subkey  # noqa: E501

        Content viewset that supports only GET by default.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(open_p_g_p_public_subkey_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str open_p_g_p_public_subkey_href: (required)
        :param list[str] fields: A list of fields to include in the response.
        :param list[str] exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(open_p_g_p_public_subkey_href,  **kwargs)  # noqa: E501

    def read_with_http_info(self, open_p_g_p_public_subkey_href,  **kwargs):  # noqa: E501
        """Inspect an open pgp public subkey  # noqa: E501

        Content viewset that supports only GET by default.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(open_p_g_p_public_subkey_href, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(OpenPGPPublicSubkeyResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('open_p_g_p_public_subkey_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['open_p_g_p_public_subkey_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `open_p_g_p_public_subkey_href` when calling `read`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'open_p_g_p_public_subkey_href' in local_var_params:
            path_params['open_p_g_p_public_subkey_href'] = local_var_params['open_p_g_p_public_subkey_href']  # noqa: E501
        ...
        return self.api_client.call_api(
            '{open_p_g_p_public_subkey_href}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='OpenPGPPublicSubkeyResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
