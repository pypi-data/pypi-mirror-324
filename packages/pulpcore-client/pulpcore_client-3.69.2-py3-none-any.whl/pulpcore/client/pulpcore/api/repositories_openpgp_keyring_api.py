...
class RepositoriesOpenpgpKeyringApi(object):
    ...
    def add_role(self, open_p_g_p_keyring_href, nested_role,  **kwargs):  # noqa: E501
        """Add a role  # noqa: E501

        Add a role for this object to users/groups.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_role(open_p_g_p_keyring_href, nested_role, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str open_p_g_p_keyring_href: (required)
        ...
        return self.add_role_with_http_info(open_p_g_p_keyring_href, nested_role,  **kwargs)  # noqa: E501

    def add_role_with_http_info(self, open_p_g_p_keyring_href, nested_role,  **kwargs):  # noqa: E501
        """Add a role  # noqa: E501

        Add a role for this object to users/groups.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_role_with_http_info(open_p_g_p_keyring_href, nested_role, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('open_p_g_p_keyring_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['open_p_g_p_keyring_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `open_p_g_p_keyring_href` when calling `add_role`")  # noqa: E501
        ...
        path_params = {}
        if 'open_p_g_p_keyring_href' in local_var_params:
            path_params['open_p_g_p_keyring_href'] = local_var_params['open_p_g_p_keyring_href']  # noqa: E501
        ...
        return self.api_client.call_api(
            '{open_p_g_p_keyring_href}add_role/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create(self, open_pgp_keyring,  **kwargs):  # noqa: E501
        """Create an open pgp keyring  # noqa: E501

        A ViewSet for an ordinary repository.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create(open_pgp_keyring, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param OpenPGPKeyring open_pgp_keyring: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.create_with_http_info(open_pgp_keyring,  **kwargs)  # noqa: E501

    def create_with_http_info(self, open_pgp_keyring,  **kwargs):  # noqa: E501
        """Create an open pgp keyring  # noqa: E501

        A ViewSet for an ordinary repository.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(open_pgp_keyring, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(OpenPGPKeyringResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('open_pgp_keyring' not in local_var_params or  # noqa: E501
                                                        local_var_params['open_pgp_keyring'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `open_pgp_keyring` when calling `create`")  # noqa: E501
        ...
        body_params = None
        if 'open_pgp_keyring' in local_var_params:
            body_params = local_var_params['open_pgp_keyring']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/repositories/core/openpgp_keyring/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='OpenPGPKeyringResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def delete(self, open_p_g_p_keyring_href,  **kwargs):  # noqa: E501
        """Delete an open pgp keyring  # noqa: E501

        Trigger an asynchronous delete task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(open_p_g_p_keyring_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_with_http_info(open_p_g_p_keyring_href,  **kwargs)  # noqa: E501

    def delete_with_http_info(self, open_p_g_p_keyring_href,  **kwargs):  # noqa: E501
        """Delete an open pgp keyring  # noqa: E501

        Trigger an asynchronous delete task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(open_p_g_p_keyring_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('open_p_g_p_keyring_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['open_p_g_p_keyring_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `open_p_g_p_keyring_href` when calling `delete`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '{open_p_g_p_keyring_href}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_with_http_info(self,  **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginatedOpenPGPKeyringResponseList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/repositories/core/openpgp_keyring/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PaginatedOpenPGPKeyringResponseList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def list_roles(self, open_p_g_p_keyring_href,  **kwargs):  # noqa: E501
        """List roles  # noqa: E501

        List roles assigned to this object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_roles(open_p_g_p_keyring_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_roles_with_http_info(open_p_g_p_keyring_href,  **kwargs)  # noqa: E501

    def list_roles_with_http_info(self, open_p_g_p_keyring_href,  **kwargs):  # noqa: E501
        """List roles  # noqa: E501

        List roles assigned to this object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_roles_with_http_info(open_p_g_p_keyring_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('open_p_g_p_keyring_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['open_p_g_p_keyring_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `open_p_g_p_keyring_href` when calling `list_roles`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '{open_p_g_p_keyring_href}list_roles/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def modify(self, open_p_g_p_keyring_href, repository_add_remove_content,  **kwargs):  # noqa: E501
        """Modify Repository Content  # noqa: E501

        Trigger an asynchronous task to create a new repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.modify(open_p_g_p_keyring_href, repository_add_remove_content, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.modify_with_http_info(open_p_g_p_keyring_href, repository_add_remove_content,  **kwargs)  # noqa: E501

    def modify_with_http_info(self, open_p_g_p_keyring_href, repository_add_remove_content,  **kwargs):  # noqa: E501
        """Modify Repository Content  # noqa: E501

        Trigger an asynchronous task to create a new repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.modify_with_http_info(open_p_g_p_keyring_href, repository_add_remove_content, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('open_p_g_p_keyring_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['open_p_g_p_keyring_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `open_p_g_p_keyring_href` when calling `modify`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '{open_p_g_p_keyring_href}modify/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def my_permissions(self, open_p_g_p_keyring_href,  **kwargs):  # noqa: E501
        """List user permissions  # noqa: E501

        List permissions available to the current user on this object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.my_permissions(open_p_g_p_keyring_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.my_permissions_with_http_info(open_p_g_p_keyring_href,  **kwargs)  # noqa: E501

    def my_permissions_with_http_info(self, open_p_g_p_keyring_href,  **kwargs):  # noqa: E501
        """List user permissions  # noqa: E501

        List permissions available to the current user on this object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.my_permissions_with_http_info(open_p_g_p_keyring_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('open_p_g_p_keyring_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['open_p_g_p_keyring_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `open_p_g_p_keyring_href` when calling `my_permissions`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '{open_p_g_p_keyring_href}my_permissions/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def partial_update(self, open_p_g_p_keyring_href, patched_open_pgp_keyring,  **kwargs):  # noqa: E501
        """Update an open pgp keyring  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update(open_p_g_p_keyring_href, patched_open_pgp_keyring, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str open_p_g_p_keyring_href: (required)
        :param PatchedOpenPGPKeyring patched_open_pgp_keyring: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.partial_update_with_http_info(open_p_g_p_keyring_href, patched_open_pgp_keyring,  **kwargs)  # noqa: E501

    def partial_update_with_http_info(self, open_p_g_p_keyring_href, patched_open_pgp_keyring,  **kwargs):  # noqa: E501
        """Update an open pgp keyring  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update_with_http_info(open_p_g_p_keyring_href, patched_open_pgp_keyring, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('open_p_g_p_keyring_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['open_p_g_p_keyring_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `open_p_g_p_keyring_href` when calling `partial_update`")  # noqa: E501
        # verify the required parameter 'patched_open_pgp_keyring' is set
        if self.api_client.client_side_validation and ('patched_open_pgp_keyring' not in local_var_params or  # noqa: E501
                                                        local_var_params['patched_open_pgp_keyring'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `patched_open_pgp_keyring` when calling `partial_update`")  # noqa: E501
        ...
        body_params = None
        if 'patched_open_pgp_keyring' in local_var_params:
            body_params = local_var_params['patched_open_pgp_keyring']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def read(self, open_p_g_p_keyring_href,  **kwargs):  # noqa: E501
        """Inspect an open pgp keyring  # noqa: E501

        A ViewSet for an ordinary repository.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(open_p_g_p_keyring_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(open_p_g_p_keyring_href,  **kwargs)  # noqa: E501

    def read_with_http_info(self, open_p_g_p_keyring_href,  **kwargs):  # noqa: E501
        """Inspect an open pgp keyring  # noqa: E501

        A ViewSet for an ordinary repository.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(open_p_g_p_keyring_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('open_p_g_p_keyring_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['open_p_g_p_keyring_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `open_p_g_p_keyring_href` when calling `read`")  # noqa: E501
    ...
    def remove_role(self, open_p_g_p_keyring_href, nested_role,  **kwargs):  # noqa: E501
        """Remove a role  # noqa: E501

        Remove a role for this object from users/groups.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_role(open_p_g_p_keyring_href, nested_role, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.remove_role_with_http_info(open_p_g_p_keyring_href, nested_role,  **kwargs)  # noqa: E501

    def remove_role_with_http_info(self, open_p_g_p_keyring_href, nested_role,  **kwargs):  # noqa: E501
        """Remove a role  # noqa: E501

        Remove a role for this object from users/groups.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_role_with_http_info(open_p_g_p_keyring_href, nested_role, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('open_p_g_p_keyring_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['open_p_g_p_keyring_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `open_p_g_p_keyring_href` when calling `remove_role`")  # noqa: E501
        # verify the required parameter 'nested_role' is set
        if self.api_client.client_side_validation and ('nested_role' not in local_var_params or  # noqa: E501
                                                        local_var_params['nested_role'] is None):  # noqa: E501
        ...
        return self.api_client.call_api(
            '{open_p_g_p_keyring_href}remove_role/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def set_label(self, open_p_g_p_keyring_href, set_label,  **kwargs):  # noqa: E501
        """Set a label  # noqa: E501

        Set a single pulp_label on the object to a specific value or null.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_label(open_p_g_p_keyring_href, set_label, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.set_label_with_http_info(open_p_g_p_keyring_href, set_label,  **kwargs)  # noqa: E501

    def set_label_with_http_info(self, open_p_g_p_keyring_href, set_label,  **kwargs):  # noqa: E501
        """Set a label  # noqa: E501

        Set a single pulp_label on the object to a specific value or null.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_label_with_http_info(open_p_g_p_keyring_href, set_label, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('open_p_g_p_keyring_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['open_p_g_p_keyring_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `open_p_g_p_keyring_href` when calling `set_label`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '{open_p_g_p_keyring_href}set_label/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def unset_label(self, open_p_g_p_keyring_href, unset_label,  **kwargs):  # noqa: E501
        """Unset a label  # noqa: E501

        Unset a single pulp_label on the object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unset_label(open_p_g_p_keyring_href, unset_label, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.unset_label_with_http_info(open_p_g_p_keyring_href, unset_label,  **kwargs)  # noqa: E501

    def unset_label_with_http_info(self, open_p_g_p_keyring_href, unset_label,  **kwargs):  # noqa: E501
        """Unset a label  # noqa: E501

        Unset a single pulp_label on the object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unset_label_with_http_info(open_p_g_p_keyring_href, unset_label, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('open_p_g_p_keyring_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['open_p_g_p_keyring_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `open_p_g_p_keyring_href` when calling `unset_label`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '{open_p_g_p_keyring_href}unset_label/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update(self, open_p_g_p_keyring_href, open_pgp_keyring,  **kwargs):  # noqa: E501
        """Update an open pgp keyring  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update(open_p_g_p_keyring_href, open_pgp_keyring, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_with_http_info(open_p_g_p_keyring_href, open_pgp_keyring,  **kwargs)  # noqa: E501

    def update_with_http_info(self, open_p_g_p_keyring_href, open_pgp_keyring,  **kwargs):  # noqa: E501
        """Update an open pgp keyring  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_with_http_info(open_p_g_p_keyring_href, open_pgp_keyring, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('open_p_g_p_keyring_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['open_p_g_p_keyring_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `open_p_g_p_keyring_href` when calling `update`")  # noqa: E501
        # verify the required parameter 'open_pgp_keyring' is set
        if self.api_client.client_side_validation and ('open_pgp_keyring' not in local_var_params or  # noqa: E501
                                                        local_var_params['open_pgp_keyring'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `open_pgp_keyring` when calling `update`")  # noqa: E501
