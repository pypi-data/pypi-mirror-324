...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, pulp_href=None, content_guard=None, base_url=None, hidden=False, no_content_change_since=None, pulp_labels=None, pulp_created=None, pulp_last_updated=None, name=None, prn=None, local_vars_configuration=None):  # noqa: E501
