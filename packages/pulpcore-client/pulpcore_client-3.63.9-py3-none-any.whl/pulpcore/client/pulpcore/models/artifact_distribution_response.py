...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, base_url=None, prn=None, pulp_last_updated=None, name=None, pulp_href=None, no_content_change_since=None, hidden=False, content_guard=None, pulp_labels=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
