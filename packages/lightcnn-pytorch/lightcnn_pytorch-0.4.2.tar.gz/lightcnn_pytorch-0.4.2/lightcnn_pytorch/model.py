...
class LightCNN:
    ...
    def _load_model(self):
        ...
        weights_file = (
            "LightCNN-V4_checkpoint.pth.tar" 
            if self.model_name == "LightCNN-V4" 
            else "LightCNN_29Layers_V2_checkpoint.pth.tar"
        )
        ...
        try:
            ...
            print("Attempting to re-download weights...")
            ...
            try:
                ...
                raise RuntimeError(f"Failed to load model weights after re-downloading: {e}")
        
        if "state_dict" not in checkpoint:
            raise ValueError("Invalid checkpoint file: missing state_dict")
