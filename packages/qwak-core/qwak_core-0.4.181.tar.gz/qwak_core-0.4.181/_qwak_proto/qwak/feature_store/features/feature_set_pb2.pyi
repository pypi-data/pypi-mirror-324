...
import qwak.feature_store.features.feature_set_attribute_pb2
...
class _FeatureStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_FeatureStatus.ValueType], builtins.type):  # noqa: F821
...
class _FeaturesetSchedulingStateEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_FeaturesetSchedulingState.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class FeatureSet(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["feature_set_definition", b"feature_set_definition", "metadata", b"metadata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["deployed_models_in_use_link", b"deployed_models_in_use_link", "feature_set_definition", b"feature_set_definition", "metadata", b"metadata"]) -> None: ...
...
class FeaturesetInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["featureset_definition", b"featureset_definition", "metadata", b"metadata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["featureset_definition", b"featureset_definition", "metadata", b"metadata"]) -> None: ...
...
class FeaturesetSummary(google.protobuf.message.Message):
    ...
    name: builtins.str
    """Name of feature set"""
    feature_set_type: qwak.feature_store.features.feature_set_types_pb2.FeatureSetTypeView.ValueType
    """Type of feature set"""
    def __init__(
        self,
        *,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["feature_set_type", b"feature_set_type", "id", b"id", "name", b"name"]) -> None: ...
...
class FeatureSetDefinition(google.protobuf.message.Message):
    ...
    """Feature Status"""
    feature_set_last_execution_state: qwak.feature_store.features.feature_set_state_pb2.FeatureSetLastExecutionState.ValueType
    """Feature set airflow state"""
    feature_health: qwak.feature_store.features.feature_set_state_pb2.FeatureSetLastExecutionState.ValueType
    """Feature set Health"""
    @property
    ...
    def ClearField(self, field_name: typing_extensions.Literal["feature_health", b"feature_health", "feature_set_id", b"feature_set_id", "feature_set_last_execution_state", b"feature_set_last_execution_state", "feature_set_spec", b"feature_set_spec", "feature_set_state", b"feature_set_state", "featureset_version_number", b"featureset_version_number", "qwak_internal_protocol_version", b"qwak_internal_protocol_version", "status", b"status"]) -> None: ...
...
class FeatureSetSpec(google.protobuf.message.Message):
    ...
    @property
    def feature_set_type(self) -> qwak.feature_store.features.feature_set_types_pb2.FeatureSetType:
    ...
    @property
    def featureset_attributes(self) -> qwak.feature_store.features.feature_set_attribute_pb2.FeaturesetAttributes:
    ...
    def __init__(
        ...
        *,
        ...
        feature_set_type: qwak.feature_store.features.feature_set_types_pb2.FeatureSetType | None = ...,
...
class FeatureSetUserMetadata(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["featureset_version_user_metadata", b"featureset_version_user_metadata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["description", b"description", "display_name", b"display_name", "featureset_version_user_metadata", b"featureset_version_user_metadata", "owner", b"owner"]) -> None: ...
...
class FeaturesetVersionUserMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["comment", b"comment"]) -> None: ...
...
class DeployedModelInUseLink(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["model_id", b"model_id", "model_name", b"model_name"]) -> None: ...
...
class Feature(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["feature_name", b"feature_name", "feature_type", b"feature_type"]) -> None: ...
...
class DeployedFeatureSetSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["feature_set_spec", b"feature_set_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["account_id", b"account_id", "feature_set_id", b"feature_set_id", "feature_set_spec", b"feature_set_spec", "featureset_version", b"featureset_version"]) -> None: ...
...
class FeatureSetList(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["feature_sets", b"feature_sets"]) -> None: ...
