...
Installation
============
The Thermochemistry step is probably already installed in your SEAMM
...
check for `thermochemistry-step`. If it is not installed, or
...
The non-graphical installer is also straightforward::
  ...
  seamm-installer install --update thermochemistry-step
