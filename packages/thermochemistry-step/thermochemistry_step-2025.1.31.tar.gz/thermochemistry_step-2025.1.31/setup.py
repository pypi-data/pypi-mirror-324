...
setup(
    ...
    url='https://github.com/molssi-seamm/thermochemistry_step',
    ...
    packages=find_packages(include=['thermochemistry_step']),
    ...
    entry_points={
        'org.molssi.seamm': [
            'Thermochemistry = thermochemistry_step:ThermochemistryStep',
        ],
        'org.molssi.seamm.tk': [
            'Thermochemistry = thermochemistry_step:ThermochemistryStep',
        ],
