...
CREATE TABLE IF NOT EXISTS "County_Skims" (
    ...
    "gcd_miles"   REAL             DEFAULT 0, --@ The great circle distance (in miles) between the two counties
    "hwy_miles"   REAL             DEFAULT 0  --@ The shortest routable highway distance (in miles) between the two counties
);
