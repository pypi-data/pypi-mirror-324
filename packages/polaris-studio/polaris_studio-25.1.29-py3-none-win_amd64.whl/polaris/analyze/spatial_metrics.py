...
class SpatialMetrics:
    ...
    def transit_demand_metrics(self) -> TransitDemandMetrics:
        ...
        return TransitDemandMetrics(self.__supply_file__, self.__demand_file__)
    ...
    def set_demand_file(self, demand_file: Path):
        self.__check_file(demand_file)
        self.__demand_file__ = demand_file

    def set_supply_file(self, supply_file: Path):
        self.__check_file(supply_file)
        self.__supply_file__ = supply_file

    def set_result_file(self, result_file: Path):
        self.__check_file(result_file)
