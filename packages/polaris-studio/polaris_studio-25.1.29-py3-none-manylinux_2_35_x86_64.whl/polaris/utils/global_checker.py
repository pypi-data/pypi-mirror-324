...
class GlobalChecker:
    ...
    def __init__(self, config):
        ...
        self.config: ConvergenceConfig = config
        self._fldr_path = config.data_dir
        self._supply_file = self._fldr_path / config.supply_file()
        self._demand_file = self._fldr_path / config.demand_file()
    ...
    def _load_links_with_shockwave_speed(self, network_config=None):
        ...
        json = self.config.load_scenario_json()
        ...
        network_config = network_config or json["Network simulation controls"]
