...
class ResultKPIs:
    ...
    def _get_simulated_and_target_dict(self, target_type: str, **kwargs):
        ...
        if target_type == "activity_generation":
            ...
            simulated = destination_choice.load_simulated(self.inputs.demand_db, data_type=data_type)
    ...
    def metric_rmse_vs_observed(self):
        ...
        rmse_activity = calculate_normalized_rmse(simulated, target)
