...
def precache_kpis(current_iteration: ConvergenceIteration, skip_cache: bool = False):
    ...
    # We skip skim metrics as the HDF5 used in h5py can sometimes cause catestrophic python failures (thanks C)
    metrics_to_cache = {m for m in kpi.available_metrics() if "skim" not in m}
