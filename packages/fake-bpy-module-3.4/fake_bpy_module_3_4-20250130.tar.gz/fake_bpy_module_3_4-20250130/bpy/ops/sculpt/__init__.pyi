...
def face_set_change_visibility(
    ...
    /,
    *,
    mode: typing.Literal["TOGGLE", "SHOW_ACTIVE", "HIDE_ACTIVE", "INVERT"]
    | None = "TOGGLE",
):
    ...
    Invert Face Set Visibility -- Invert Face Set Visibility.
        :type mode: typing.Literal['TOGGLE','SHOW_ACTIVE','HIDE_ACTIVE','INVERT'] | None
    """
...
def face_sets_init(
    ...
    *,
    ...
    Face Sets from Face Set Boundaries -- Create a Face Set per isolated Face Set.
        :type mode: typing.Literal['LOOSE_PARTS','MATERIALS','NORMALS','UV_SEAMS','CREASES','BEVEL_WEIGHT','SHARP_EDGES','FACE_MAPS','FACE_SET_BOUNDARIES'] | None
