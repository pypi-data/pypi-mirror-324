...
def gltf(
    ...
    *,
    filepath: str = "",
    check_existing: bool | None = True,
    convert_lighting_mode: typing.Literal["SPEC", "COMPAT", "RAW"] | None = "SPEC",
    ...
    export_optimize_animation_size: bool | None = False,
    ...
    Raw (Deprecated) -- Blender lighting strengths with no conversion.
        :type convert_lighting_mode: typing.Literal['SPEC','COMPAT','RAW'] | None
