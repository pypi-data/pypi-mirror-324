...
type BrushCurvesSculptToolItems = typing.Literal[
    "COMB",  # Comb Curves.
    "DELETE",  # Delete Curves.
    "SNAKE_HOOK",  # Curves Snake Hook.
    "ADD",  # Add Curves.
    "GROW_SHRINK",  # Grow / Shrink Curves.
...
type BrushUvSculptToolItems = typing.Literal[
    "GRAB",  # Grab.Grab UVs.
...
type CurveNormalModes = typing.Literal[
    "MINIMUM_TWIST",  # Minimum Twist.
    "Z_UP",  # Z Up.
]
type CurvesTypes = typing.Literal[
...
type KeyingFlagItemsApi = typing.Literal[
    "INSERTKEY_NEEDED",  # Only Needed.Only insert keyframes where they're needed in the relevant F-Curves.
    "INSERTKEY_VISUAL",  # Visual Keying.Insert keyframes based on 'visual transforms'.
    "INSERTKEY_XYZ_TO_RGB",  # XYZ=RGB Colors.Color for newly added transformation F-Curves (Location, Rotation, Scale) and also Color is based on the transform axis.
...
type ObjectGreasepencilModifierTypeItems = typing.Literal[
    ...
    "GP_WEIGHT_ANGLE",  # Vertex Weight Angle.Generate Vertex Weights base on stroke angle.
    "GP_WEIGHT_PROXIMITY",  # Vertex Weight Proximity.Generate Vertex Weights base on distance to object.
...
type OperatorPropertyTags = typing.Literal[
...
type SnapElementItems = typing.Literal[
    ...
    "FACE",  # Face Project.Snap by projecting onto faces.
...
type TransformModeTypes = typing.Literal[
    "INIT",  # Init.
    "DUMMY",  # Dummy.
    "TRANSLATION",  # Translation.
    "ROTATION",  # Rotation.
...
type TransformPivotItemsFull = typing.Literal[
