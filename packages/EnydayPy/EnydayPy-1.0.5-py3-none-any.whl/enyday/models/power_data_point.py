...
class PowerDataPoint(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["period_begin", "period_end", "power_internal", "power_external"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PowerDataPoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PowerDataPoint from a dict"""
        if obj is None:
            return None
