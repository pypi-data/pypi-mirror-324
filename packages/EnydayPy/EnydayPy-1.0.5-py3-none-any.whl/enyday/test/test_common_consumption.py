...
class TestCommonConsumption(unittest.TestCase):
    """CommonConsumption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommonConsumption:
        """Test CommonConsumption
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommonConsumption`
        """
        model = CommonConsumption()
        if include_optional:
    ...
    def testCommonConsumption(self):
        """Test CommonConsumption"""
