...
class UserDetails(BaseModel):
    ...
    last_changed_password: Optional[datetime] = None
    complete_profile: Optional[StrictBool] = Field(default=None, alias="completeProfile")
    ...
    user_btms: Optional[List[UserBtm]] = None
    admin_btms: Optional[List[AdminBtm]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in admin_btms (list)
        _items = []
        if self.admin_btms:
            for _item_admin_btms in self.admin_btms:
                if _item_admin_btms:
                    _items.append(_item_admin_btms.to_dict())
            _dict['admin_btms'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user_btms": [UserBtm.from_dict(_item) for _item in obj["user_btms"]] if obj.get("user_btms") is not None else None,
            "admin_btms": [AdminBtm.from_dict(_item) for _item in obj["admin_btms"]] if obj.get("admin_btms") is not None else None,
