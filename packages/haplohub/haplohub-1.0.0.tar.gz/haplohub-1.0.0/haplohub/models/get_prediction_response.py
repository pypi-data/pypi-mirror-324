...
class GetPredictionResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPredictionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPredictionResponse:
        """Create an instance of GetPredictionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPredictionResponse.parse_obj(obj)

        _obj = GetPredictionResponse.parse_obj({
