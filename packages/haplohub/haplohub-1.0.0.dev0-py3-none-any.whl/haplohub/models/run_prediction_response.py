...
class RunPredictionResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RunPredictionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RunPredictionResponse:
        """Create an instance of RunPredictionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RunPredictionResponse.parse_obj(obj)

        _obj = RunPredictionResponse.parse_obj({
            "status": obj.get("status"),
            "result": PredictionSchema.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
