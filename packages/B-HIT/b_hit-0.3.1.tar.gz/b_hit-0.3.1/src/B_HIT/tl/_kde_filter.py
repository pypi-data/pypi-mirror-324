...
def kde_filter(adata_tmp,
    ...
    binary_mask_flat = binary_mask.ravel()
    mask_flat = mask.ravel()
    assert binary_mask_flat.shape[0] == adata_tmp.shape[0], "Shape mismatch between binary_mask and AnnData dimensions!"
    adata_tmp.obs["binary_mask"] = binary_mask_flat
    adata_tmp.obs["mask"] = mask_flat
