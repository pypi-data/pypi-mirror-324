...
def trams_in_service(vehicledata_df: pd.DataFrame) -> pd.DataFrame:
    ...
    trams_in_service_df = trams.reset_index().pivot(index=vehicledata_index_timestamp,columns=vehicledata_index_vehicleid)['lineid']
...
def buses_in_service(vehicledata_df: pd.DataFrame) -> pd.DataFrame:
    ...
    buses_in_service_df = buses.reset_index().pivot(index=vehicledata_index_timestamp,columns=vehicledata_index_vehicleid)['lineid']
