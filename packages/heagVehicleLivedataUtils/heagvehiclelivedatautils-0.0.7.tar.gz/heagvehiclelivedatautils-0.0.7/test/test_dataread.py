...
from heagVehicleLivedataUtils.vehicleDataUtils.read import vehicledata_columns, verify_vehicledata_format

class TestRead(unittest.TestCase):
    def test_regular_read_and_plot(self):
        da = DataAnalysis(vehicledata_path="../test/vehicleInfo_test/")
