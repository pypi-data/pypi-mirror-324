...
class StoreOnceIncludingEnvvarsAction(StoreOnceAction):
    ...
    def _error(self) -> str:
        return (
            super()._error() + " or in the environment variable" +
            ("s" if len(self._envvar_names) > 1 else "") + " '" +
            "' or '".join(self._envvar_names) + "'"
        )
