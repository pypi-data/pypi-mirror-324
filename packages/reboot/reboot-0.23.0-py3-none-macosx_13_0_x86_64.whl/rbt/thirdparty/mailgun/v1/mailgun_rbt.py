...
class MessageServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (MessageWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.thirdparty.mailgun.v1.mailgun_pb2.SendTaskRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=IMPORT_reboot_aio_idempotency.Idempotency(
                                alias=f'Task {task.task_id.task_uuid}',
                            ),
    ...
    async def _schedule_SendTask(
        ...
        *,
        ...
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.thirdparty.mailgun.v1.mailgun_pb2.SendTaskResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.thirdparty.mailgun.v1.Message'),
            context_type=IMPORT_reboot_aio_contexts.WriterContext,
        ...
        *,
        ...
        if method_name == 'rbt.thirdparty.mailgun.v1.MessageMethods.Send':
            ...
            return await self.SendTask(
                ...
                IMPORT_typing.cast(rbt.thirdparty.mailgun.v1.mailgun_pb2.SendTaskRequest, request),
            )
        else:
    ...
    class SendTaskEffects(Effects):
        def __init__(
            ...
            *,
            ...
            IMPORT_reboot_aio_types.assert_type(state, [rbt.thirdparty.mailgun.v1.mailgun_pb2.Message])
            IMPORT_reboot_aio_types.assert_type(response, [rbt.thirdparty.mailgun.v1.mailgun_pb2.SendTaskResponse])
...
class Message:
    ...
    class SendTaskFuture:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.thirdparty.mailgun.v1.mailgun_pb2.SendTaskResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    SendTaskEffects: IMPORT_typing.TypeAlias = Servicer.SendTaskEffects

    class SendTaskAborted(IMPORT_reboot.aio.aborted.Aborted):
    ...
    class WeakReference(IMPORT_typing.Generic[Message_ScheduleTypeVar]):
        ...
        class _Idempotently(IMPORT_typing.Generic[Message_IdempotentlyScheduleTypeVar]):
            ...
            async def SendTask(
                ...
                *,
                ...
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.thirdparty.mailgun.v1.mailgun_pb2.SendTaskRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.thirdparty.mailgun.v1.mailgun_pb2.SendTaskRequest)
                ...
                return await __this__._weak_reference.SendTask(
                    __context__,
                    __options__,
        ...
        class _Schedule:
            ...
            async def SendTask(
                ...
                *,
                send_request: IMPORT_typing.Optional[rbt.thirdparty.mailgun.v1.mailgun_pb2.SendRequest] = None,
            ) -> IMPORT_reboot_aio_tasks.TaskEffect | Message.SendTaskFuture:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.thirdparty.mailgun.v1.mailgun_pb2.SendTaskRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.thirdparty.mailgun.v1.mailgun_pb2.SendTaskRequest)
                ...
                __request__ = rbt.thirdparty.mailgun.v1.mailgun_pb2.SendTaskRequest(
        ...
        async def SendTask(
            ...
            *,
            ...
            return await __this__._writer(__context__).SendTask(
                __request__,
                idempotency=__idempotency__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
    ...
    class _Construct:
        ...
        @IMPORT_typing.overload
        def idempotently(self, alias: IMPORT_typing.Optional[str] = None, *, each_iteration: bool = False) -> Message._ConstructIdempotently:
            ...

        @IMPORT_typing.overload
        def idempotently(self, *, key: IMPORT_uuid.UUID) -> Message._ConstructIdempotently:
            ...
