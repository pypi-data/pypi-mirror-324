...
class SecretMethodsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.WriteTask = channel.unary_unary(
                '/rbt.cloud.v1alpha1.secrets.SecretMethods/WriteTask',
                request_serializer=rbt_dot_cloud_dot_v1alpha1_dot_secrets_dot_secrets__pb2.WriteRequest.SerializeToString,
                response_deserializer=rbt_dot_cloud_dot_v1alpha1_dot_secrets_dot_secrets__pb2.WriteTaskResponse.FromString,
                )
        ...
        self.DeleteTask = channel.unary_unary(
                '/rbt.cloud.v1alpha1.secrets.SecretMethods/DeleteTask',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=rbt_dot_cloud_dot_v1alpha1_dot_secrets_dot_secrets__pb2.DeleteTaskResponse.FromString,
                )
...
class SecretMethodsServicer(object):
    ...
    def WriteTask(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_SecretMethodsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'WriteTask': grpc.unary_unary_rpc_method_handler(
                    servicer.WriteTask,
                    request_deserializer=rbt_dot_cloud_dot_v1alpha1_dot_secrets_dot_secrets__pb2.WriteRequest.FromString,
                    response_serializer=rbt_dot_cloud_dot_v1alpha1_dot_secrets_dot_secrets__pb2.WriteTaskResponse.SerializeToString,
            ),
            ...
            'DeleteTask': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteTask,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=rbt_dot_cloud_dot_v1alpha1_dot_secrets_dot_secrets__pb2.DeleteTaskResponse.SerializeToString,
            ),
    }
...
class SecretMethods(object):
    ...
    def WriteTask(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/rbt.cloud.v1alpha1.secrets.SecretMethods/WriteTask',
            rbt_dot_cloud_dot_v1alpha1_dot_secrets_dot_secrets__pb2.WriteRequest.SerializeToString,
            rbt_dot_cloud_dot_v1alpha1_dot_secrets_dot_secrets__pb2.WriteTaskResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeleteTask(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/rbt.cloud.v1alpha1.secrets.SecretMethods/DeleteTask',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            rbt_dot_cloud_dot_v1alpha1_dot_secrets_dot_secrets__pb2.DeleteTaskResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
