...
from wbcore.pandas import fields
...
from .filters import PandasDjangoFilterBackend, PandasOrderingFilter, PandasSearchFilter
        ...
        for field in pd_fields.fields:
            if field.key in df.columns:
                ...
                if isinstance(field, fields.IntegerField):
                    df[field.key] = df[field.key].astype("int", errors="ignore")
