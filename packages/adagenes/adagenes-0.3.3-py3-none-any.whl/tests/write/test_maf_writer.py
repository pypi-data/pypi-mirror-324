...
class TestMAFWriter(unittest.TestCase):
    ...
    def test_maf_writer(self):
        ...
        self.assertEqual(
            ...
            '.\t.\t.\t.\t7\t21784210\t21784210\t.\tIn_Frame_Ins\tINS\t.\t.\t.\t.\t.\t.\t\n'
    ...
    def test_maf_writer_file_object(self):
        ...
        #self.assertEqual(contents[800:1200], 'otein_position\tAmino_acids\tCodons\tExisting_variation\n'
        # '\t\t\t\t12\t25245350\t25245350\n'
        # '\t\t\t\t12\t47236180\t47236180\n'
        # '\t\t\t\t12\t77056106\t77056106\n'
        # '\t\t\t\t1\t158627717\t158627717\n'
        # '\t\t\t\t1\t156879126\t156879126\n', "")
