...
sample_protein_file = "/hg38_sample_protein.csv"
...
def load_file(qid, data_dir, start_row=None, end_row=None):
    ...
    if qid == "sample-vcf":
        ...
        infile = data_dir + sample_protein_file
...
def transform_data(qid, transform_output_format, transform_model, genome_version=None, data_dir=None):
    ...
    if transform_output_format == 'vcf':
        ...
        if contains_substring is False:
            ...
            magic_obj = get_magic_obj(key, genome_version, transform_model=transform_model)
