...
class CSVWriter(writer.Writer):
    ...
    def write_line_to_file(self, outfile, var, vcf_lines, magic_obj, save_headers=False, variants_written=False,
        ...
        print(self.to_single_tsv_line_stream(var, vcf_lines[var], srv_prefix, extract_keys, labels, first_chunk=first_chunk),
              file=outfile)
    ...
    def to_single_tsv_line_stream(self, qid, vcf_obj, srv_prefix, extract_keys, labels,sep=",", first_chunk=False) -> list:
        """
