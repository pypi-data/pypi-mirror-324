...
extern long long gotdf_python_DecryptFilesGlobNPE(char* pattern, long long config);
extern char* gotdf_python_EncryptFilePE(char* inputFilePath, char* outputFilePath, long long config, long long token, long long dataAttributes);
extern char* gotdf_python_EncryptString(char* inputText, long long config, long long dataAttributes);
...
extern char* gotdf_python_EncryptFile(char* inputFilePath, char* outputFilePath, long long config, long long dataAttributes);
extern long long gotdf_python_EncryptFilesGlobNPE(char* pattern, long long config, long long dataAttributes);
extern long long gotdf_python_EncryptFilesInDirNPE(char* dirPath, long long config, long long dataAttributes);
extern char* gotdf_python_Hello();
extern long long gotdf_python_DecryptFilesInDirNPE(char* dirPath, long long config);
