...
extern long long int gotdf_python_DecryptFilesGlobNPE(char* pattern, long long int config);
extern long long int gotdf_python_DecryptFilesInDirNPE(char* dirPath, long long int config);
extern char* gotdf_python_EncryptFile(char* inputFilePath, char* outputFilePath, long long int config, long long int dataAttributes);
extern char* gotdf_python_EncryptString(char* inputText, long long int config, long long int dataAttributes);
extern long long int gotdf_python_EncryptFilesGlobNPE(char* pattern, long long int config, long long int dataAttributes);
extern long long int gotdf_python_EncryptFilesInDirNPE(char* dirPath, long long int config, long long int dataAttributes);
...
extern char* gotdf_python_EncryptFilePE(char* inputFilePath, char* outputFilePath, long long int config, long long int token, long long int dataAttributes);
