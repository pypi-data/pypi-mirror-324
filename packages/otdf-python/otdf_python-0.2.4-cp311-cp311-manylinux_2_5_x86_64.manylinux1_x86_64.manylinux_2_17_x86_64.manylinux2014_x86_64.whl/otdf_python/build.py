...
add_checked_function(mod, 'gotdf_python_DecryptFilesGlobNPE', retval('int64_t'), [param('char*', 'pattern'), param('int64_t', 'config')])
add_checked_string_function(mod, 'gotdf_python_EncryptFile', retval('char*'), [param('char*', 'inputFilePath'), param('char*', 'outputFilePath'), param('int64_t', 'config'), param('int64_t', 'dataAttributes')])
add_checked_string_function(mod, 'gotdf_python_EncryptFilePE', retval('char*'), [param('char*', 'inputFilePath'), param('char*', 'outputFilePath'), param('int64_t', 'config'), param('int64_t', 'token'), param('int64_t', 'dataAttributes')])
add_checked_function(mod, 'gotdf_python_EncryptFilesInDirNPE', retval('int64_t'), [param('char*', 'dirPath'), param('int64_t', 'config'), param('int64_t', 'dataAttributes')])
...
add_checked_function(mod, 'gotdf_python_DecryptFilesInDirNPE', retval('int64_t'), [param('char*', 'dirPath'), param('int64_t', 'config')])
...
add_checked_function(mod, 'gotdf_python_EncryptFilesGlobNPE', retval('int64_t'), [param('char*', 'pattern'), param('int64_t', 'config'), param('int64_t', 'dataAttributes')])
add_checked_string_function(mod, 'gotdf_python_EncryptString', retval('char*'), [param('char*', 'inputText'), param('int64_t', 'config'), param('int64_t', 'dataAttributes')])
