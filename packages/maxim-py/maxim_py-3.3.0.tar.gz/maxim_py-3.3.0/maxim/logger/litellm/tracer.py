...
class MaximLiteLLMTracer(CustomLogger):
    ...
    def log_pre_api_call(self, model, messages, kwargs):
        ...
        try:
            ...
            if litellm_metadata:
                metadata = (
                    litellm_metadata["maxim"] if litellm_metadata["maxim"] else None
                )
            ...
            logging.error("[MaximSDK] Error while handling pre_api_call for litellm")
    ...
    def log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            logging.error(
                "[MaximSDK] Error while handling log_success_event for litellm"
            )
    ...
    def log_failure_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            logging.error(
                f"[MaximSDK] Error while handling log_failure_event for litellm {e}"
            )
    ...
    async def async_log_pre_api_call(self, model, messages, kwargs):
        ...
        try:
            ...
            logging.error(
                "[MaximSDK] Error while handling async_log_pre_api_call for litellm"
            )
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            logging.error(
                "[MaximSDK] Error while handling async_log_success_event for litellm"
            )
    ...
    async def async_log_failure_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            logging.error(
                "[MaximSDK] Error while handling async_log_failure_event for litellm"
            )
