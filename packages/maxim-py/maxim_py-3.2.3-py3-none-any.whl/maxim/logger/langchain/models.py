...
class Container:
    ...
    _parent: Optional["Container"] = None
    _created: bool = False
    ...
    def add_event(self, event_id: str, name: str, tags: Dict[str, str]) -> None:
        """
...
class TraceContainer(Container):
    ...
    def __init__(
        ...
        super().__init__(logger=logger,container_id= trace_id, container_type="trace", name=trace_name,parent= parent,mark_created=mark_created)

    def create(self, tags: Optional[Dict[str, str]] = None) -> None:
        config = TraceConfig(id=self._id, name=self._name, tags=tags)
        if self.parent is not None:
            config.session_id = self.parent
    ...
    def add_event(self, event_id: str, name: str, tags: Dict[str, str]) -> None:
        self._logger.trace_event(self._id, event_id, name, tags)
...
class SpanContainer(Container):
    ...
    def __init__(
        ...
        super().__init__(logger=logger, container_id=span_id, container_type="span", name=span_name,parent= parent,mark_created=mark_created)

    def create(self, tags: Optional[Dict[str, str]] = None) -> None:
        config = SpanConfig(id=self._id, name=self._name, tags=tags)
        if self.parent is None:
            raise ValueError("[MaximSDK] Span without a parent is invalid")
        self._logger.trace_add_span(self.parent,config)
        self._created = True
    ...
    def add_event(self, event_id: str, name: str, tags: Dict[str, str]) -> None:
        self._logger.span_event(self._id, event_id, name, tags)
