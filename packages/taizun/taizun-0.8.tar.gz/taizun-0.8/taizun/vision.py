...
def generate_image_caption(image_path, model_name="Salesforce/blip-image-captioning-base"):
...
def detect_objects(image_path, model_name="facebook/detr-resnet-50"):
