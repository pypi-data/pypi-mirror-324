...
def test_time_to_abs_date_tai(start_orekit_jvm):
...
def test_time_to_abs_date_utc(start_orekit_jvm):
    _jvm = start_orekit_jvm
...
def test_abs_date_to_time_tai(start_orekit_jvm):
    _jvm = start_orekit_jvm
    time_tai_str = "2016-05-30T12:30:17.123456"
...
def test_abs_date_to_time_tai_before_j2000(start_orekit_jvm):
    _jvm = start_orekit_jvm
...
def test_abs_date_to_time_utc(start_orekit_jvm):
    _jvm = start_orekit_jvm
    time_utc_str = "2016-05-30T12:30:17.123456"
...
def test_abs_date_to_time_to_abs_date_tai(start_orekit_jvm):
    _jvm = start_orekit_jvm
    time_tai_str = "2016-05-30T12:30:17.123456"
...
def test_abs_date_to_time_to_abs_date_utc(start_orekit_jvm):
    _jvm = start_orekit_jvm
    time_utc_str = "2016-05-30T12:30:17.123456"
...
def test_time_to_abs_date_to_time_tai(start_orekit_jvm):
    _jvm = start_orekit_jvm
    time_tai_str = "2016-05-30T12:30:17.123456"
    time_tai = Time.from_iso("TAI", time_tai_str)
    abs_date = time_to_abs_date(time_tai)
...
def test_time_to_abs_date_to_time_utc(start_orekit_jvm):
    _jvm = start_orekit_jvm
    time_utc_str = "2016-05-30T12:30:17.123456"
    time_utc = Time.from_utc(time_utc_str)
    abs_date = time_to_abs_date(time_utc)
...
def test_cartesian_to_tpv_to_cartesian(start_orekit_jvm):
    _jvm = start_orekit_jvm
    time_tai_str = "2016-05-30T12:30:17.123456"
    time_tai = Time.from_iso("TAI", time_tai_str)
