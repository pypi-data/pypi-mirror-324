...
def test_oem_read(resources, maven_package, start_orekit_jvm):
    _jvm = maven_package
...
def test_oem_read_write_read(resources, maven_package, start_orekit_jvm, file_format):
    _jvm = maven_package
    _jvm = start_orekit_jvm
    oem_ex = resources / "ccsds" / "odm" / "oem" / "OEMExample5.txt"
...
def test_omm_read(resources, maven_package, start_orekit_jvm):
    _jvm = maven_package
    _jvm = start_orekit_jvm
...
@pytest.mark.parametrize("file_format", [CcsdsFileFormat.KVN, CcsdsFileFormat.XML])
def test_omm_read_write_read(resources, maven_package, start_orekit_jvm, file_format):
    _jvm = maven_package
    _jvm = start_orekit_jvm
...
def test_opm_read(resources, maven_package, start_orekit_jvm):
    _jvm = maven_package
    _jvm = start_orekit_jvm
...
@pytest.mark.parametrize("file_format", [CcsdsFileFormat.KVN, CcsdsFileFormat.XML])
def test_opm_read_write_read(resources, maven_package, start_orekit_jvm, file_format):
    _jvm = maven_package
    _jvm = start_orekit_jvm
