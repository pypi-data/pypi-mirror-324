...
class MatriceTritonPredictor:
    ...
    def __init__(self, actionTracker):
        ...
        self.download_docker_image()

    def download_docker_image(self):
        """Download the Triton server docker image"""
        try:
            logging.info(f"Starting download of docker image: {TRITON_DOCKER_IMAGE}")
    ...
    def check_docker_download(self):
