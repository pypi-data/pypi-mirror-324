...
def deploy_cluster(storage_nodes,test,ha_type,distr_ndcs,distr_npcs,enable_qos,ifname,blk_size, page_size_in_blocks, cli_pass,
    ...
    if test:
        pool_max = utils.parse_size("0")
        lvol_max = utils.parse_size("0")
        ...
        lvol_uuid=lvol_controller.add_lvol_ha("test1",lvol_size,"",ha_type,pool_id,False,False,None,None,None,None,None,None,None,None,None,None,None,None)
        ...
        mkfs_command = f"sudo mkfs.xfs {device_name}"
