...
# Parameters
a_values=torch.linspace(1.0,10.0,10000, device=device_name,dtype=data_type) 
b_values=torch.linspace(2.0,20.0,10000, device=device_name,dtype=data_type)
c_values=torch.linspace(0.5,5,10000, device=device_name,dtype=data_type) 
