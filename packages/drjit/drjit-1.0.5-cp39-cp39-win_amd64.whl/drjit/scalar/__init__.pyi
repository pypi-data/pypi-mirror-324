...
class Texture1f:
    ...
    @overload
    def eval(self, pos: Array1f, active: Optional[bool] = Bool(True)) -> list[float]:
        """Evaluate the linear interpolant represented by this texture."""

    @overload
    def eval(self, pos: Array1f16, active: Optional[bool] = Bool(True)) -> list[float]: ...

    @overload
    def eval(self, pos: Array1f64, active: Optional[bool] = Bool(True)) -> list[float]: ...

    @overload
    def eval_fetch(self, pos: Array1f, active: Optional[bool] = Bool(True)) -> list[list[float]]:
        """
    ...
    @overload
    def eval_fetch(self, pos: Array1f16, active: Optional[bool] = Bool(True)) -> list[list[float]]: ...

    @overload
    def eval_fetch(self, pos: Array1f64, active: Optional[bool] = Bool(True)) -> list[list[float]]: ...

    @overload
    def eval_cubic(self, pos: Array1f, active: Optional[bool] = Bool(True), force_nonaccel: bool = False) -> list[float]:
        """
    ...
    @overload
    def eval_cubic(self, pos: Array1f16, active: Optional[bool] = Bool(True), force_nonaccel: bool = False) -> list[float]: ...

    @overload
    def eval_cubic(self, pos: Array1f64, active: Optional[bool] = Bool(True), force_nonaccel: bool = False) -> list[float]: ...

    @overload
    def eval_cubic_grad(self, pos: Array1f, active: Optional[bool] = Bool(True)) -> tuple:
        """
    ...
    @overload
    def eval_cubic_grad(self, pos: Array1f16, active: Optional[bool] = Bool(True)) -> tuple: ...

    @overload
    def eval_cubic_grad(self, pos: Array1f64, active: Optional[bool] = Bool(True)) -> tuple: ...

    @overload
    def eval_cubic_hessian(self, pos: Array1f, active: Optional[bool] = Bool(True)) -> tuple:
        """
    ...
    @overload
    def eval_cubic_hessian(self, pos: Array1f16, active: Optional[bool] = Bool(True)) -> tuple: ...

    @overload
    def eval_cubic_hessian(self, pos: Array1f64, active: Optional[bool] = Bool(True)) -> tuple: ...

    @overload
    def eval_cubic_helper(self, pos: Array1f, active: Optional[bool] = Bool(True)) -> list[float]:
        """
    ...
    @overload
    def eval_cubic_helper(self, pos: Array1f16, active: Optional[bool] = Bool(True)) -> list[float]: ...

    @overload
    def eval_cubic_helper(self, pos: Array1f64, active: Optional[bool] = Bool(True)) -> list[float]: ...
...
class Texture2f:
    ...
    @overload
    def eval(self, pos: Array2f, active: Optional[bool] = Bool(True)) -> list[float]:
        """Evaluate the linear interpolant represented by this texture."""

    @overload
    def eval(self, pos: Array2f16, active: Optional[bool] = Bool(True)) -> list[float]: ...

    @overload
    def eval(self, pos: Array2f64, active: Optional[bool] = Bool(True)) -> list[float]: ...

    @overload
    def eval_fetch(self, pos: Array2f, active: Optional[bool] = Bool(True)) -> list[list[float]]:
        """
        Fetch the texels that would be referenced in a texture lookup with
        linear interpolation without actually performing this interpolation.
        """
    ...
    @overload
    def eval_fetch(self, pos: Array2f16, active: Optional[bool] = Bool(True)) -> list[list[float]]: ...

    @overload
    def eval_fetch(self, pos: Array2f64, active: Optional[bool] = Bool(True)) -> list[list[float]]: ...

    @overload
    def eval_cubic(self, pos: Array2f, active: Optional[bool] = Bool(True), force_nonaccel: bool = False) -> list[float]:
        """
        Evaluate a clamped cubic B-Spline interpolant represented by this
        texture
    ...
    @overload
    def eval_cubic(self, pos: Array2f16, active: Optional[bool] = Bool(True), force_nonaccel: bool = False) -> list[float]: ...

    @overload
    def eval_cubic(self, pos: Array2f64, active: Optional[bool] = Bool(True), force_nonaccel: bool = False) -> list[float]: ...

    @overload
    def eval_cubic_grad(self, pos: Array2f, active: Optional[bool] = Bool(True)) -> tuple:
        """
        Evaluate the positional gradient of a cubic B-Spline
    ...
    @overload
    def eval_cubic_grad(self, pos: Array2f16, active: Optional[bool] = Bool(True)) -> tuple: ...

    @overload
    def eval_cubic_grad(self, pos: Array2f64, active: Optional[bool] = Bool(True)) -> tuple: ...

    @overload
    def eval_cubic_hessian(self, pos: Array2f, active: Optional[bool] = Bool(True)) -> tuple:
        """
        Evaluate the positional gradient and hessian matrix of a cubic B-Spline
    ...
    @overload
    def eval_cubic_hessian(self, pos: Array2f16, active: Optional[bool] = Bool(True)) -> tuple: ...

    @overload
    def eval_cubic_hessian(self, pos: Array2f64, active: Optional[bool] = Bool(True)) -> tuple: ...

    @overload
    def eval_cubic_helper(self, pos: Array2f, active: Optional[bool] = Bool(True)) -> list[float]:
        """
        Helper function to evaluate a clamped cubic B-Spline interpolant
    ...
    @overload
    def eval_cubic_helper(self, pos: Array2f16, active: Optional[bool] = Bool(True)) -> list[float]: ...

    @overload
    def eval_cubic_helper(self, pos: Array2f64, active: Optional[bool] = Bool(True)) -> list[float]: ...
...
class Texture3f:
    ...
    @overload
    def eval(self, pos: Array3f, active: Optional[bool] = Bool(True)) -> list[float]:
        """Evaluate the linear interpolant represented by this texture."""

    @overload
    def eval(self, pos: Array3f16, active: Optional[bool] = Bool(True)) -> list[float]: ...

    @overload
    def eval(self, pos: Array3f64, active: Optional[bool] = Bool(True)) -> list[float]: ...

    @overload
    def eval_fetch(self, pos: Array3f, active: Optional[bool] = Bool(True)) -> list[list[float]]:
        """
        Fetch the texels that would be referenced in a texture lookup with
        linear interpolation without actually performing this interpolation.
        """
    ...
    @overload
    def eval_fetch(self, pos: Array3f16, active: Optional[bool] = Bool(True)) -> list[list[float]]: ...

    @overload
    def eval_fetch(self, pos: Array3f64, active: Optional[bool] = Bool(True)) -> list[list[float]]: ...

    @overload
    def eval_cubic(self, pos: Array3f, active: Optional[bool] = Bool(True), force_nonaccel: bool = False) -> list[float]:
        """
        Evaluate a clamped cubic B-Spline interpolant represented by this
        texture
    ...
    @overload
    def eval_cubic(self, pos: Array3f16, active: Optional[bool] = Bool(True), force_nonaccel: bool = False) -> list[float]: ...

    @overload
    def eval_cubic(self, pos: Array3f64, active: Optional[bool] = Bool(True), force_nonaccel: bool = False) -> list[float]: ...

    @overload
    def eval_cubic_grad(self, pos: Array3f, active: Optional[bool] = Bool(True)) -> tuple:
        """
        Evaluate the positional gradient of a cubic B-Spline
    ...
    @overload
    def eval_cubic_grad(self, pos: Array3f16, active: Optional[bool] = Bool(True)) -> tuple: ...

    @overload
    def eval_cubic_grad(self, pos: Array3f64, active: Optional[bool] = Bool(True)) -> tuple: ...

    @overload
    def eval_cubic_hessian(self, pos: Array3f, active: Optional[bool] = Bool(True)) -> tuple:
        """
        Evaluate the positional gradient and hessian matrix of a cubic B-Spline
    ...
    @overload
    def eval_cubic_hessian(self, pos: Array3f16, active: Optional[bool] = Bool(True)) -> tuple: ...

    @overload
    def eval_cubic_hessian(self, pos: Array3f64, active: Optional[bool] = Bool(True)) -> tuple: ...

    @overload
    def eval_cubic_helper(self, pos: Array3f, active: Optional[bool] = Bool(True)) -> list[float]:
        """
        Helper function to evaluate a clamped cubic B-Spline interpolant
    ...
    @overload
    def eval_cubic_helper(self, pos: Array3f16, active: Optional[bool] = Bool(True)) -> list[float]: ...

    @overload
    def eval_cubic_helper(self, pos: Array3f64, active: Optional[bool] = Bool(True)) -> list[float]: ...
