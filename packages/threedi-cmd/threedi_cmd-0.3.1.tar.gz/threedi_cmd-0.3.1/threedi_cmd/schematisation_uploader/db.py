...
RASTERS_MAP = [
    ...
    # Vegetation
    ("vegetation_height_file", models.VegetationDrag),
    ("vegetation_drag_coefficient_file", models.VegetationDrag),
    ("vegetation_stem_count_file", models.VegetationDrag),
    ("vegetation_stem_diameter_file", models.VegetationDrag),
]
