...
class InstrumentApi:
    ...
    @overload
    async def enrich_instrument(self, vendor_product_key : StrictStr, identifiers : Identifiers, **kwargs) -> EnrichmentResponse:  # noqa: E501
        ...

    @overload
    def enrich_instrument(self, vendor_product_key : StrictStr, identifiers : Identifiers, async_req: Optional[bool]=True, **kwargs) -> EnrichmentResponse:  # noqa: E501
        ...

    @validate_arguments
    def enrich_instrument(self, vendor_product_key : StrictStr, identifiers : Identifiers, async_req: Optional[bool]=None, **kwargs) -> Union[EnrichmentResponse, Awaitable[EnrichmentResponse]]:  # noqa: E501
    ...
    @validate_arguments
    def enrich_instrument_with_http_info(self, vendor_product_key : StrictStr, identifiers : Identifiers, **kwargs) -> ApiResponse:  # noqa: E501
        """[EARLY ACCESS] EnrichInstrument: Enriches an existing LUSID instrument using vendor data. Enrichment included identifiers, properties and market data.  # noqa: E501
    ...
    def get_open_figi_parameter_option_with_http_info(self, parameter_name : OpenFigiParameterOptionName, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        if _params.get('parameter_name') is not None:  # noqa: E501
            _query_params.append(('parameterName', _params['parameter_name'].value))
