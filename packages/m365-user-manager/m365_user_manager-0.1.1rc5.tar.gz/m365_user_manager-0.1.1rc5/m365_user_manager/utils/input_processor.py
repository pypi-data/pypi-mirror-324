...
class InputProcessor:
    ...
    """
    def __init__(self, discord_webhook_url: Optional[str] = None, logger: Optional[Logger] = None):
    ...
    @classmethod
    async def create(cls, discord_webhook_url: Optional[str] = None, logger: Optional[Logger] = None) -> 'InputProcessor':
        """Factory method for creating fully initialized instances."""
        instance = cls(discord_webhook_url, logger)
