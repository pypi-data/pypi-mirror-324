...
LOGGING = {
    ...
    "loggers": {
        "django.request": {  # for production requests logging and exceptions
            "handlers": ["console", "djangofile"],
            "level": "DEBUG",
            "propagate": False,
        },
        "django.server": {  # for runserver requests logging
            "handlers": ["console", "djangofile"],
            "level": "DEBUG",
            "propagate": False,
        },
...
SOCIALACCOUNT_PROVIDERS = {
    "openid_connect": {
        "APPS": [
            {
                "provider_id": os.getenv("DJANGO_ALLAUTH_PROVIDER_ID", "keycloak"),
                "name": os.getenv("DJANGO_ALLAUTH_NAME", "keyclKeycloakoak"),
                "client_id": os.getenv("DJANGO_ALLAUTH_CLIENT_ID", "master"),
                "secret": os.getenv("DJANGO_ALLAUTH_SECRET", ""),
                "settings": {
                    "server_url": os.getenv(
                        "DJANGO_ALLAUTH_SERVER_URL",
                        "https://keycloak.jfk-enterprise.com/realms/JFK-Enterprise/.well-known/openid-configuration",
                    ),
                },
            },
        ],
...
# Allauth UI
ALLAUTH_UI_THEME = os.getenv("DJANGO_ALLAUTH_UI_THEME", "ligth")
