...
class LidarHeader(): 
	...
	@point_format.setter
	def point_format(self, value: int) -> None: ...
...
class Raster():
	...
	def new_from_other_with_data(other: Raster, data_type: Optional[RasterDataType]) -> Raster: ...
	...
	def clamp(min: float, max: float) -> Raster: ... 
	...
	def is_cell_nodata(self, row: int, col: int) -> bool: ...
...
class VectorGeometryTypeDimension(Enum):
    XY: int
    Measure: int
    Z: int
...
class WbEnvironment():
	...
	def downslope_flowpath_length(self, d8_pointer: Raster, watersheds: Optional[Raster], weights: Optional[Raster], esri_pntr: bool = False) -> Raster: ...
	...
	def find_parallel_flow(self, d8_pntr: Raster, streams: Optional[Raster]) -> Raster: ...
	...
	def multiscale_elevated_index(self, dem: Raster, min_scale: int = 2, step_size: int = 1, num_steps: int = 100, step_nonlinearity: float = 1.0) -> Tuple[Raster, Raster]: ...
	...
	def multiscale_low_lying_index(self, dem: Raster, min_scale: int = 2, step_size: int = 1, num_steps: int = 100, step_nonlinearity: float = 1.0) -> Tuple[Raster, Raster]: ...
