...
from pywechat.Uielements import Login_window,Main_window,ToolBar,Independent_window,Buttons
...
class Tools():
    ...
    def open_wechat(wechat_path:str=None,is_maximize:bool=True):
        ...
        if Tools.is_wechat_running():#微信如果已经打开无需登录可以直接连接
            try:
                ...
                main_window_handle=win32gui.FindWindow(Main_window.MainWindow['class_name'],Main_window.MainWindow['title'])
            ...
            login_window_handle=FindWindow(Login_window.LoginWindow['class_name'],Login_window.LoginWindow['title'])
            login_window=Tools.move_window_to_center(Login_window.LoginWindow,Window_handle=login_window_handle)
            try:
                login_button=login_window.child_window(**Login_window.LoginButton).wait(wait_for='visible',retry_interval=0.1,timeout=3)
                login_button.set_focus()
                login_button.click_input()
    ...
    def open_settings(wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ...
        setting=Toolbar.descendants(**Buttons.SettingsAndOthersButton)[0]
        setting.click_input()
    ...
    @staticmethod
    def open_friend_settings(friend:str,wechat_path:str=None,is_maximize:bool=True,search_pages:int=10):
        '''
        该方法用于打开好友设置界面\n
        Args:
    ...
    @staticmethod
    def open_friend_settings_menu(friend:str,wechat_path:str=None,is_maximize:bool=True,search_pages:int=10):
        '''
        该方法用于打开好友设置界面\n
        Args:
            friend:\t好友备注名称,需提供完整名称\n
    ...
    @staticmethod
    def open_group_settings(group_name:str,wechat_path:str=None,is_maximize:bool=True,search_pages:int=10):
        '''
        该方法用来打开群聊设置界面\n
        Args:
            ...
            search_pages:\t在会话列表中查询查找好友时滚动列表的次数,默认为10,一次可查询5-12人,当search_pages为0时,直接从顶部搜索栏搜索好友信息打开聊天界面\n
        '''
        main_window=Tools.open_dialog_window(friend=group_name,wechat_path=wechat_path,is_maximize=False,search_pages=search_pages)[1]
        if is_maximize:
            main_window.maximize()
        ChatMessage=main_window.child_window(**Buttons.ChatMessageButton)
        ChatMessage.click_input()
    ...
    @staticmethod
    def open_friend_profile(friend:str,wechat_path:str=None,is_maximize:bool=True,search_pages:int=10):
        '''
        该方法用于打开好友个人简介界面\n
        Args:
            friend:\t好友备注名称,需提供完整名称\n
    ...
    @staticmethod
    def open_chat_history(friend:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用于打开好友聊天记录界面\n
        Args:
            friend:\t好友备注名称,需提供完整名称\n
        ...
        '''
        main_window=Tools.open_dialog_window(friend=friend,wechat_path=wechat_path,is_maximize=is_maximize,search_pages=search_pages)[1]
        toolbar=main_window.child_window(**Main_window.ChatToolBar)
        chat_history_button=toolbar.child_window(**Buttons.ChatHistoryButton)
    ...
    def open_program_pane(wechat_path:str=None,is_maximize:bool=True,wechat_maximize:bool=True,close_wechat:bool=True):
        ...
        Toolbar=main_window.child_window(**Main_window.Toolbar)
        program_button=Toolbar.descendants(**ToolBar.Miniprogram_pane)[0]
...
class API():
    ...
    '''
    @staticmethod
    def open_wechat_miniprogram(name:str,load_delay:float=3.5,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True,close_program_pane:bool=True):
        '''
        该方法用于打开指定小程序\n
        Args:
            name:\t微信小程序名字\n
        ...
        try:
            ...
            if win32gui.IsWindowVisible(main_window_handle):#主界面可见包含最小化
                if IsIconic(main_window_handle):#主界面最小化
                    ...
                    win32gui.SetForegroundWindow(main_window_handle)
                    main_window=Tools.move_window_to_center()
                    if is_maximize:
                        main_window.maximize()
                    return main_window
            else:#主界面不可见
...
def open_group_settings(group_name,wechat_path:str=None,is_maximize:bool=True):
    '''
    该函数用来打开群聊设置界面\n
    Args:
        group_name:\t群聊备注名称,需提供完整名称\n
