...
from pywechat.Warnings import LongTextWarning,ChatHistoryNotEnough
from pywechat.WechatTools import Tools,mouse,Desktop,FindWindow,IsIconic
...
from pywechat.Errors import PrivacyNotCorrectError
...
from pywechat.Errors import CantSendEmptyMessageError
from pywechat.Errors import WrongParameterError
from pywechat.Errors import TickleError
from pywinauto.findwindows import ElementNotFoundError
from pywechat.Uielements import Main_window,ToolBar,Independent_window,Buttons
...
class Messages():
    @staticmethod
    def send_message_to_friend(friend:str,message:str,delay:float=1,tickle:bool=False,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用于给单个好友或群聊发送单条信息\n
        Args:
    ...
    @staticmethod
    def send_messages_to_friend(friend:str,messages:list[str],tickle:bool=False,delay:float=1,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用于给单个好友或群聊发送多条信息\n
        Args:
            friend:\t好友或群聊备注。格式:friend="好友或群聊备注"\n
    ...
    @staticmethod
    def forward_message(friends:list[str],message:str,delay:float=0.2,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用于给好友转发消息\n
        Args:
...
class Files():
    @staticmethod
    def send_file_to_friend(friend:str,file_path:str,with_messages:bool=False,messages:list=[],messages_first:bool=False,delay:float=1,tickle:bool=False,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用于给单个好友或群聊发送单个文件\n
        Args:
            friend:\t好友或群聊备注。格式:friend="好友或群聊备注"\n
    ...
    def send_file_to_friends(friends:list[str],file_paths:list[str],with_messages:bool=False,messages:list[list[str]]=[],messages_first:bool=False,delay:float=1,tickle:list[bool]=[],wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ...
        file_paths=[re.sub(r'(?<!\\)\\(?!\\)',r'\\\\',file_path) for file_path in file_paths]
    ...
    @staticmethod
    def forward_file(friends:list[str],file_path:str,delay:float=0.2,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        ...
        if close_wechat:
            main_window.close()
    @staticmethod
    def get_chat_files(friend:str,folder_path:str,number:int=10,search_pages:int=10,wechat_path:str=None,is_maximize:bool=False,close_wechat:bool=True):
        '''
        该方法用来保存与某个好友的聊天文件。\n
        Args:
            friend:\t好友或群聊的备注\n
...
class WechatSettings():
    ...
    @staticmethod
    def Auto_uopdate_wechat(state:str='open',wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True,close_settings_window:bool=True):
        '''
...
class Call():
    ...
    @staticmethod
    def voice_call(friend:str,search_pages:int=10,wechat_path=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来给好友拨打语音电话\n
        Args:
            friend:好友备注\n
    ...
    @staticmethod
    def video_call(friend:str,search_pages:int=10,wechat_path=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来给好友拨打视频电话\n
        Args:
            friend:\t好友备注.\n
    ...
    @staticmethod
    def voice_call_in_group(group_name:str,friends:list[str],search_pages:int=10,wechat_path=None,is_maximize:bool=True,close_wechat:bool=True,):
        '''
        该方法用来在群聊中发起语音电话\n
        Args:
            group_name:\t群聊备注.\n
...
class FriendSettings():
    ...
    @staticmethod
    def pin_friend(friend:str,search_pages:int=10,wechat_path=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来将好友或群聊置顶\n
        Args:
            friend:\t好友备注。\n
        ...
        Top_button=Tool_bar.children(**Buttons.PinButton)[0]
    ...
    @staticmethod
    def cancel_pin_friend(friend:str,search_pages:int=10,wechat_path=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来取消将好友或群聊置顶\n
        Args:
            friend:好友备注\n
        ...
        '''
        main_window,chat_window=Tools.open_dialog_window(friend,wechat_path,is_maximize=is_maximize,search_pages=search_pages)
        Tool_bar=chat_window.child_window(found_index=1,title='',control_type='ToolBar')
        Top_button=Tool_bar.children(**Buttons.CancelPinButton)[0]
        if Top_button[0].exists():
            Top_button[0].click_input()
            time.sleep(1)
            if close_wechat:
    ...
    @staticmethod   
    def mute_friend_notifications(friend:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来开启好友的消息免打扰\n
        Args:
            friend:好友备注\n
    ...
    @staticmethod
    def sticky_friend_on_top(friend:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来将好友的聊天置顶\n
        Args:
            friend:\t好友备注\n 
    ...
    @staticmethod
    def cancel_mute_friend_notifications(friend:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来取消好友的消息免打扰\n
        Args:
            friend:好友备注。\n
    ...
    @staticmethod
    def cancel_sticky_friend_on_top(friend:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ''' 
        该方法用来取消好友聊天置顶\n
        Args:
            :friend:好友备注\n
    ...
    @staticmethod
    def clear_friend_chat_history(friend:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ''' 
        该方法用来清空与好友的聊天记录\n
        Args:
            friend:\t好友备注\n
    ...
    @staticmethod
    def delete_friend(friend:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ''' 
        该方法用来删除好友\n
        Args:
            friend:好友备注\n
    ...
    @staticmethod
    def change_friend_remark_and_tag(friend:str,remark:str,tag:str=None,description:str=None,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来修改好友备注和标签\n
        Args:
            friend:\t好友备注\n
    ...
    @staticmethod
    def add_friend_to_blacklist(friend:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来将好友添加至黑名单\n
        Args:
            friend:\t好友备注\n
            ...
            close_wechat:\t任务结束后是否关闭微信,默认关闭\n
        '''
        menu,friend_settings_window,main_window=Tools.open_friend_settings_menu(friend=friend,wechat_path=wechat_path,is_maximize=is_maximize,search_paegs=search_pages)
    ...
    @staticmethod
    def move_friend_out_of_blacklist(friend:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来将好友移出黑名单\n
        Args:
            friend:\t好友备注。\n
    ...
    @staticmethod
    def set_friend_as_star_friend(friend:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来将好友设置为星标朋友\n
        Args:
            friend:好友备注。\n
    ...
    @staticmethod
    def cancel_set_friend_as_star_friend(friend:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来取消好友星标朋友身份\n
        Args:
            friend:\t好友备注。\n
    ...
    @staticmethod
    def change_friend_privacy(friend:str,privacy:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来修改好友权限\n
        Args:
            friend:好友备注。\n
    ...
    @staticmethod
    def share_contact(friend:str,others:list[str],search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来推荐好友给其他人\n
            friend:\t被推荐好友备注\n
            others:\t推荐人备注列表\n
    ...
    @staticmethod
    def get_friend_wechat_number(friend:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法根据微信备注获取单个好友的微信号\n
        Args:
            friend:\t好友备注。\n
    ...
    @staticmethod
    def tickle_friend(friend:str,times:int=1,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来拍一拍好友\n
        Args:
            friend:\t好友备注或昵称\n
        ...
        if times==1:
            ...
            if close_wechat:
                chat.close()
    @staticmethod
    def get_chat_history(friend:str,number:int=10,capture_screen:bool=False,folder_path:str=None,search_pages:int=10,wechat_path:str=None,is_maximize:bool=False,close_wechat:bool=True):
        '''
        该函数用来获取好友或群聊的聊天记录\n
        Args:
            friend:\t好友或群聊备注或昵称\n
...
class GroupSettings():
    ...
    @staticmethod
    def change_group_name(group_name:str,change_name:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来修改群聊名称\n
        Args:
            group_name:群聊名称\n
    ...
    @staticmethod
    def change_my_nickname_in_group(group_name:str,my_nickname:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来修改我在本群的昵称\n
        Args:
            group_name:\t群聊名称\n
    ...
    @staticmethod
    def change_group_remark(group_name:str,group_remark:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来修改群聊备注\n
        Args:
            group_name:\t群聊名称\n
    ...
    @staticmethod
    def show_group_members_nickname(group_name:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来开启显示群聊成员名称\n
        Args:
            group_name:\t群聊名称\n
    ...
    @staticmethod
    def dont_show_group_members_nickname(group_name:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来关闭显示群聊成员名称\n
        Args:
            group_name:\t群聊名称\n
    ...
    @staticmethod
    def mute_group_notifications(group_name:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来开启群聊消息免打扰\n
        Args:
            group_name:\t群聊名称\n
    ...
    @staticmethod
    def cancel_mute_group_notifications(group_name:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来关闭群聊消息免打扰\n
        Args:
            group_name:\t群聊名称\n
            ...
            swechat_path:微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
                这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数\n
                若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
            sis_maximize:\t微信界面是否全屏,默认全屏。
            sclose_wechat:\t任务结束后是否关闭微信,默认关闭\n
        '''
        group_chat_settings_window,main_window=Tools.open_group_settings(group_name=group_name,wechat_path=wechat_path,is_maximize=is_maximize,search_pages=search_pages)
        mute_checkbox=group_chat_settings_window.child_window(title="消息免打扰",control_type="CheckBox")
        if not mute_checkbox.get_toggle_state():
    ...
    @staticmethod
    def sticky_group_on_top(group_name:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来将微信群聊聊天置顶\n
        Args:
            group_name:\t群聊名称\n
    ...
    @staticmethod
    def cancel_sticky_group_on_top(group_name:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来取消微信群聊聊天置顶\n
        Args:
            group_name:群聊名称\n
    ...
    @staticmethod           
    def save_group_to_contacts(group_name:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来将群聊保存到通讯录\n
        Args:
            group_name:\t群聊名称\n
    ...
    @staticmethod    
    def cancel_save_group_to_contacts(group_name:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来不再将群聊保存至通讯录\n
        Args:
            group_name:\t群聊名称\n
    ...
    @staticmethod
    def clear_group_chat_history(group_name:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来清空群聊聊天记录\n
        Args:
            group_name:群聊名称\n
    ...
    @staticmethod
    def quit_group_chat(group_name:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来退出微信群聊\n
        Args:
            group_name:\t群聊名称\n
    ...
    @staticmethod
    def invite_others_to_group(group_name:str,friends:list[str],search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来邀请他人至群聊\n
        Args:
            group_name:\t群聊名称\n
    ...
    @staticmethod
    def remove_friend_from_group(group_name:str,friends:list[str],search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来将群成员移出群聊\n
        Args:
            group_name:\t群聊名称\n
    ...
    @staticmethod
    def add_friend_from_group(group_name:str,friend:str,request_content:str=None,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来添加群成员为好友\n
        Args:
            group_name:\t群聊名称\n
    ...
    @staticmethod
    def edit_group_notice(group_name:str,content:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来编辑群公告\n
        Args:
            group_name:\t群聊名称\n
...
class Contacts():
    ...
    def get_friends_names(wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来获取通讯录中所有好友的名称与昵称。速率大约为1秒获取20个好友的信息\n
        结果以json格式返回\n
        Args:
            wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
                这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
    ...
    @staticmethod
    def get_groupmembers_info(group_name:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        ...
        try:
            GroupSettings.save_group_to_contacts(group_name=group_name,wechat_path=wechat_path,is_maximize=is_maximize,close_wechat=False,search_pages=search_pages)
            main_window=Tools.open_contacts(wechat_path=wechat_path,is_maximize=is_maximize)
...
class AutoReply():
    ...
    def auto_answer_call(duration:str,broadcast_content:str,message:str=None,times:int=2,wechat_path:str=None,close_wechat:bool=True):
        ...
        while True:
            if time.time()-start_time<duration:
                ...
                break
        Systemsettings.close_listening_mode()
        print(f'自动接听微信电话结束,在{duration}秒内内共计接听{len(caller_names)}人电话\n接听对象:{caller_names}\n电话类型{flags}')
    ...
    @staticmethod
    def auto_reply_to_friend(friend:str,duration:str,content:str,save_chat_history:bool=False,capture_screen:bool=False,folder_path:str=None,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        ...
        if count:
            if save_chat_history:
                chat_history=get_chat_history(friend=friend,number=count+5,capture_screen=capture_screen,folder_path=folder_path,wechat_path=wechat_path,is_maximize=is_maximize,close_wechat=False)  
        if close_wechat:
            main_window.close()
        return chat_history

    @staticmethod
    def AI_auto_reply_to_friend(friend:str,duration:str,AI_engine,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
...
def remove_friend_from_group(group_name:str,friends:list[str],search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
    ...
    if not delete.exists():
        ...
        for member in friends:
            ...
            button=delete_member_window.child_window(title=member,control_type='Button')
            button.click_input()
        confirm=delete_member_window.child_window()
        confirm.click_input()
        confirm_dialog_window=delete_member_window.child_window(class_name='ConfirmDialog',framework_id='Win32')
        delete=confirm_dialog_window.child_window(**Buttons.DeleteButton)
        delete.click_input()
