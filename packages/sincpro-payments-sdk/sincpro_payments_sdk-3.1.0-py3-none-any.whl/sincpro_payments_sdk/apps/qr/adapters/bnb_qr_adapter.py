...
from sincpro_payments_sdk.apps.qr.infrastructure.bnb.http_bnb_auth import BNBQRAuth
...
class QRBNBApiAdapter(ClientAPI):
    ...
    def __init__(self):
        ...
        super().__init__(self.base_url, auth=BNBQRAuth(bnb_qr_credential_provider))
    ...
    def list_generated_qr(self, generation_date: date) -> list[QRInfo]:
        ...
        payload = {"generationDate": generation_date.strftime("%Y-%m-%d")}
        response = self.execute_request(
