...
from absfuyu.general.data_extension import (
    DictAnalyzeResult,
    DictExt,
    IntNumber,
    ListExt,
...
class TestDictExt:
    """absfuyu.general.data_extension.DictExt"""
...
@pytest.mark.data_extension
class TestIntNumber:
    """absfuyu.general.data_extension.IntNumber"""

    # operation
    def test_operation(self, num_a: IntNumber, num_b: IntNumber) -> None:
    ...
    def test_to_binary(self, number: int, output: str) -> None:
        instance: IntNumber = IntNumber(number)
    ...
    # degree
    def test_convert_degree(self, num_a: IntNumber) -> None:
    ...
    # lcm
    def test_lcm(self, num_a: IntNumber) -> None:
        assert num_a.lcm(6) == 30

    # gcd
    def test_gcd(self, num_a: IntNumber) -> None:
        assert num_a.gcd(25) == 5

    # add_to_one_digit
    def test_add_to_one_digit(self, num_prime: IntNumber) -> None:
    ...
    def test_divisible_list(self) -> None:
        assert IntNumber(884652).divisible_list(short_form=False) == [
            1,
            2,
            3,
            4,
...
@pytest.mark.data_extension
class TestListExt:
    """absfuyu.general.data_extension.ListExt"""
...
@pytest.mark.data_extension
class TestText:
    """absfuyu.general.data_extension.Text"""
    ...
    # palindrome
    @pytest.mark.parametrize(["value", "output"], [("madam", True), ("racecar", True)])
