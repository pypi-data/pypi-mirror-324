...
class OpenaiCompatibleAI:
    ...
    def getChatCompletion(
        ...
        **kwargs,
        ...
        return OpenAI(api_key=api_key if api_key else OpenaiCompatibleAI.DEFAULT_API_KEY, base_url=api_endpoint if api_endpoint else OpenaiCompatibleAI.DEFAULT_API_ENDPOINT).chat.completions.create(
