...
setup(
    ...
    version="0.1", # версия модуля.при каждом обновлении(новой отправке) надо увеличивать версию 
    ...
    # install_reguires=[] ,список название модулей которые нужны для корректной работы этого модуля 
