...
and can be optionally overridden as below:
    ...
    def setCcdSweptSphereRadius(self, ccd_swept_sphere_radius):
        """Sets `ccdSweptSphereRadius` that is the radius of the sphere that is used to check for possible collisions when ccd is actived.
