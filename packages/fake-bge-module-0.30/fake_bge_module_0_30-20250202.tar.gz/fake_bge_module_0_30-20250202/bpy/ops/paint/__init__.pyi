...
def brush_select(
    ...
    *,
    ...
    | None = "DRAW",
    vertex_tool: typing.Literal["DRAW", "BLUR", "AVERAGE", "SMEAR"] | None = "DRAW",
    weight_tool: typing.Literal["DRAW", "BLUR", "AVERAGE", "SMEAR"] | None = "DRAW",
    image_tool: typing.Literal["DRAW", "SOFTEN", "SMEAR", "CLONE", "FILL", "MASK"]
    | None = "DRAW",
    gpencil_tool: typing.Literal["DRAW", "FILL", "ERASE", "TINT"] | None = "DRAW",
    gpencil_vertex_tool: typing.Literal["DRAW", "BLUR", "AVERAGE", "SMEAR", "REPLACE"]
    | None = "DRAW",
    gpencil_sculpt_tool: typing.Literal[
        "SMOOTH",
        "THICKNESS",
        "STRENGTH",
        "RANDOMIZE",
    ...
    | None = "SMOOTH",
    gpencil_weight_tool: typing.Literal["WEIGHT"] | None = "WEIGHT",
    ...
    """Select a paint mode's brush by tool type
        ...
        :type sculpt_tool: typing.Literal['DRAW','DRAW_SHARP','CLAY','CLAY_STRIPS','CLAY_THUMB','LAYER','INFLATE','BLOB','CREASE','SMOOTH','FLATTEN','FILL','SCRAPE','MULTIPLANE_SCRAPE','PINCH','GRAB','ELASTIC_DEFORM','SNAKE_HOOK','THUMB','POSE','NUDGE','ROTATE','TOPOLOGY','BOUNDARY','CLOTH','SIMPLIFY','MASK','DISPLACEMENT_ERASER','DISPLACEMENT_SMEAR','PAINT','SMEAR','DRAW_FACE_SETS'] | None
        :param vertex_tool: vertex_tool
        :type vertex_tool: typing.Literal['DRAW','BLUR','AVERAGE','SMEAR'] | None
        :param weight_tool: weight_tool
        :type weight_tool: typing.Literal['DRAW','BLUR','AVERAGE','SMEAR'] | None
        :param image_tool: image_tool
        :type image_tool: typing.Literal['DRAW','SOFTEN','SMEAR','CLONE','FILL','MASK'] | None
    ...
    Tint -- The brush is of type used for tinting strokes.
        :type gpencil_tool: typing.Literal['DRAW','FILL','ERASE','TINT'] | None
        :param gpencil_vertex_tool: gpencil_vertex_tool
        :type gpencil_vertex_tool: typing.Literal['DRAW','BLUR','AVERAGE','SMEAR','REPLACE'] | None
    ...
    Clone -- Paste copies of the strokes stored on the clipboard.
        :type gpencil_sculpt_tool: typing.Literal['SMOOTH','THICKNESS','STRENGTH','RANDOMIZE','GRAB','PUSH','TWIST','PINCH','CLONE'] | None
        :param gpencil_weight_tool: gpencil_weight_tool

    WEIGHT
    Weight -- Weight Paint for Vertex Groups.
        :type gpencil_weight_tool: typing.Literal['WEIGHT'] | None
