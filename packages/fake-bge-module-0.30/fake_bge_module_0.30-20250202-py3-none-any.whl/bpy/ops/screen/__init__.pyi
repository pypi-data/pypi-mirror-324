...
def region_toggle(
    ...
    *,
    ...
    :type region_type: typing.Literal['WINDOW','HEADER','CHANNELS','TEMPORARY','UI','TOOLS','TOOL_PROPS','PREVIEW','HUD','NAVIGATION_BAR','EXECUTE','FOOTER','TOOL_HEADER','XR'] | None
    """
...
def space_type_set_or_cycle(
    ...
    *,
    ...
    LOGIC_EDITOR
    Logic Bricks Editor -- Logic Bricks Editor tools.
...
def userpref_show(
    ...
    *,
    ...
    :type section: typing.Literal['INTERFACE','THEMES','VIEWPORT','LIGHTS','EDITING','ANIMATION','ADDONS','INPUT','NAVIGATION','KEYMAP','SYSTEM','SAVE_LOAD','FILE_PATHS','EXPERIMENTAL'] | None
    """
