...
__all__ = ["PaymentCreatePayeeResponse", "ContactDetails"]
...
class PaymentCreatePayeeResponse(BaseModel):
    name: str
    ...
    contact_details: Optional[ContactDetails] = FieldInfo(alias="contactDetails", default=None)
