...
class TestBalances:
    ...
    @parametrize
    def test_method_get_customer_balance(self, client: Paymanai) -> None:
        balance = client.balances.get_customer_balance(
            currency="currency",
            customer_id="customerId",
        )
        assert_matches_type(BalanceGetCustomerBalanceResponse, balance, path=["response"])

    @parametrize
    def test_raw_response_get_customer_balance(self, client: Paymanai) -> None:
        response = client.balances.with_raw_response.get_customer_balance(
            currency="currency",
            customer_id="customerId",
        )
    ...
    @parametrize
    def test_streaming_response_get_customer_balance(self, client: Paymanai) -> None:
        with client.balances.with_streaming_response.get_customer_balance(
            currency="currency",
            customer_id="customerId",
        ) as response:
    ...
    @parametrize
    def test_path_params_get_customer_balance(self, client: Paymanai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `customer_id` but received ''"):
            client.balances.with_raw_response.get_customer_balance(
                currency="currency",
                customer_id="",
            )
...
class TestAsyncBalances:
    ...
    @parametrize
    async def test_method_get_customer_balance(self, async_client: AsyncPaymanai) -> None:
        balance = await async_client.balances.get_customer_balance(
            currency="currency",
            customer_id="customerId",
        )
        assert_matches_type(BalanceGetCustomerBalanceResponse, balance, path=["response"])
    ...
    @parametrize
    async def test_raw_response_get_customer_balance(self, async_client: AsyncPaymanai) -> None:
        response = await async_client.balances.with_raw_response.get_customer_balance(
            currency="currency",
            customer_id="customerId",
        )
    ...
    @parametrize
    async def test_streaming_response_get_customer_balance(self, async_client: AsyncPaymanai) -> None:
        async with async_client.balances.with_streaming_response.get_customer_balance(
            currency="currency",
            customer_id="customerId",
        ) as response:
            assert not response.is_closed
    ...
    @parametrize
    async def test_path_params_get_customer_balance(self, async_client: AsyncPaymanai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `customer_id` but received ''"):
            await async_client.balances.with_raw_response.get_customer_balance(
                currency="currency",
                customer_id="",
            )
