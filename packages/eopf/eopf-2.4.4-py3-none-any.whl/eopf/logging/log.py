...
EOConfiguration().register_requested_parameter("logging__folder", param_is_optional=True)
EOConfiguration().register_requested_parameter("logging__level", param_is_optional=True)
...
class EOLogging(object):
    ...
    def config_dict(self) -> dict[str, Path]:
        ...
        Returns the dictionary of loaded files
        -------
    ...
    def get_default_cfg_dir(self) -> Path:
        if self.default_cfg_dir is None:
            ...
            if conf.has_value("logging__folder"):
                ...
                self.default_cfg_dir = self.DEFAULT_CFG_DIR
