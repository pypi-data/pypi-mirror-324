...
from eopf.common.constants import EOPF_CPM_PATH, ROOT_PATH_DATATREE, SHORT_NAME
...
class EOProduct(EOGroup):
    ...
    def get_default_file_name_no_extension(self, mission_specific: Optional[str] = None) -> str:
        ...
        if self.product_type is None or self.product_type == "":
            ...
            if "processing:version" not in attributes_dict["stac_discovery"]:
                raise StoreMissingAttr("Missing product type and processing:version attributes")
    ...
    def _declare_as_product(self) -> None:
        self._attrs.setdefault("other_metadata", dict()).setdefault("eopf_category", "eoproduct")
