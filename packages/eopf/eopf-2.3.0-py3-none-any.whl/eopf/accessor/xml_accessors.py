...
from eopf.exceptions import XmlManifestNetCDFError, XmlParsingError
...
from eopf.formatting.xml_formatters import ToProcessingHistory, ToProcessingSoftware
...
class XMLAnglesAccessor(EOAccessor):
    """
    Acessor use to extract arrays from an xml file to an EOVariable.
    ...
    def __getitem__(self, key: str) -> "EOObject":
        """
        This method is used to return the eo_variables containing the xml data at xpat
    ...
    def create_eo_variable(
        ...
        <Sun_Angles_Grid>
         <Zenith>
          ...
          <Values_List>
            <VALUES>30.9922 30.9691 30.9461 30.9232 30.9003 30.8774 30.8546 30.809 30.7863 30.7637 30.741</VALUES>
            ...
    ...
    def stac_mapper(self, path: str) -> Any:
        ...
        if formatter_name is not None and formatter is not None:
            ...
            if formatter_name in [ToProcessingHistory.name]:
                ...
                try:
                    data = self._get_single_xml_raw_data(xpath).attrib
                except Exception as e:
                        ...
                        if nested_data is not None:
                            ...
                            if isinstance(wf, EOListValuesFormatter):
                                ...
                                if len(nested_data) > 0:
                                    return wf.format(nested_data[0])  # type: ignore
                    except Exception as e:
            ...
            try:
                ...
                if xml_data:
                    if isinstance(formatter, EOAbstractXMLFormatter):
...
class PatternWriter:
    ...
    def sync_writer(
        ...
        Parameters
        ----------
        url : url of the written file
        templates_path : path to the pattenr folder
        template_name : name of the pattern file used (in the pattern folder)
