...
class EOAccessor(MutableMapping[str, Any]):
    ...
    def trim_params(cls, params: dict[str, Any]) -> tuple[dict[str, Any], dict[str, Any]]:
        ...
        tuple[dict[str, Any], dict[str, Any]]
            ...
            - The first dictionary includes the remaining parameters after removing the dynamic parameters.
            - The second dictionary includes only the dynamic parameters specified in `_dynamic_params`
              that were found in the input.
