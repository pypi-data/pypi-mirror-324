...
from eopf.exceptions.errors import MappingConfigurationError, MappingMissingError
...
class EOPFMappingManager(EOPFAbstractMappingManager):
    ...
    def _get_short_names(self, map: dict[str, Any]) -> dict[str, str]:
            ...
            for eo_obj_description in map["data_mapping"]:
                if "target_path" in eo_obj_description:
                    if eo_obj_description["target_path"].startswith(("attrs:", "coords:")):
                        ...
                        short_names[short_name] = eo_obj_description["target_path"]
    ...
    def parse_mapping(
        ...
        **kwargs: Any,
        ...
        if product_url is not None:
            ...
            product_name = self._url.basename
        ...
        if unparsed_map is not None:
            ...
            short_names: dict[str, str] = self._get_short_names(parsed_map)
    ...
    def parse_shortnames(
        ...
        **kwargs: Any,
        ...
        try:
            unparsed_map: dict[str, Any] | None = self._mapping_factory.get_mapping(product_type=self._type)
        except MappingMissingError:
            unparsed_map = None
