...
from eopf.common.constants import DIMENSIONS_NAME, EOPF_CPM_PATH
...
class EOGroup(EOObjectWithDims, MutableMapping[str, "EOObject"]):
    ...
    def __init__(
        ...
        # Need to init the EOObject after attr sets
    ...
    def _print_tree_structure(
        ...
        for v in group.variables:
            ...
            v[1]._print_tree_structure(v[1], level + 1, detailed)

        for g in group.groups:
            print(f"{indent}├───Group {g[0]}")
            self._print_tree_structure(g[1], level + 2, detailed)
