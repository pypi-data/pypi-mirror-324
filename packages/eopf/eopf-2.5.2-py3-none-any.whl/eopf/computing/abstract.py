...
from typing import Any, List, Mapping, Optional, TypeAlias, Union
...
DataType: TypeAlias = Union[EOProduct, EOContainer, DataTree[Any]]
MappingDataType: TypeAlias = Mapping[str, DataType]
