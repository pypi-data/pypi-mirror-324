...
class Ins(Collection[FilePins]):
    ...
    .. py:attribute:: loader
       :type: wreck.pep518_venvs.VenvMapLoader
    ...
    .. py:attribute:: _file_pins
       :type: list[wreck.lock_filepins.FilePins]

       Collection of PinDatum

    .. py:attribute:: _iter
       :type: collections.abc.Iterator[wreck.lock_filepins.FilePins]
    ...
    def __next__(self):
        ...
        :rtype: wreck.lock_filepins.FilePins
    ...
    def __iter__(self):
        ...
        :returns: Iterator
        :rtype: collections.abc.Iterator[typing_extensions.Self[wreck.lock_filepins.FilePins]]
        """
        return self
    ...
    def files(self, val):
        ...
        :param val:
           ...
           :py:class:`~wreck.lock_filepins.FilePins` or absolute path
    ...
    def get_by_abspath(self, abspath_f, set_name=InFileType.FILES):
        """Get the index and :py:class:`~wreck.lock_filepins.FilePins`
        ...
        :returns:
           ...
           :py:class:`~wreck.lock_filepins.FilePins`

        :rtype: wreck.lock_filepins.FilePins | None
        :raises:
