...
# api_key = '72461C50B1CEAD3135BA6BDA53B203D3'
# deviceid = 'E7CDD293-9C3A-5AB9-9181-58E1B572DD44'
# currency = 'USDZAR'

# class_retuers = Reuters(api_key, deviceid)
# json_token = class_retuers.token()
# print(class_retuers.quotes(currency))
