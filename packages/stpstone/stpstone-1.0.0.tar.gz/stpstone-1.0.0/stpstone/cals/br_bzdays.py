...
class BrazilSaoPauloState(Brazil):
    ...
    include_constitutionalist_revolution = False
    if include_constitutionalist_revolution == True:
        FIXED_HOLIDAYS = Brazil.FIXED_HOLIDAYS + (
...
class BrazilSaoPauloCity(BrazilSaoPauloState):
    ...
    include_sao_paulo_anniversary = False
    if include_sao_paulo_anniversary == True:
...
class BrazilBankCalendar(BrazilSaoPauloCity):
    """
    ...
    def find_last_working_day(self, day):
        """
