...
class OperatorQuota(BaseModel):
    ...
    __properties = ["count", "operatorName", "operatorPath"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OperatorQuota:
        """Create an instance of OperatorQuota from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OperatorQuota:
        """Create an instance of OperatorQuota from a dict"""
        if obj is None:
            return None
