...
class TypedVectorResultDescriptor(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TypedVectorResultDescriptor:
        """Create an instance of TypedVectorResultDescriptor from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TypedVectorResultDescriptor:
        """Create an instance of TypedVectorResultDescriptor from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TypedVectorResultDescriptor.parse_obj(obj)

        _obj = TypedVectorResultDescriptor.parse_obj({
