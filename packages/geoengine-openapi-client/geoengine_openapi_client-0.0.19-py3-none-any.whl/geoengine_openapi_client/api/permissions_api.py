...
class PermissionsApi:
    ...
    def add_permission_handler(self, permission_request : PermissionRequest, **kwargs) -> None:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the add_permission_handler_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    def get_resource_permissions_handler(self, resource_type : Annotated[StrictStr, Field(..., description="Resource Type")], resource_id : Annotated[StrictStr, Field(..., description="Resource Id")], limit : conint(strict=True, ge=0), offset : conint(strict=True, ge=0), **kwargs) -> List[PermissionListing]:  # noqa: E501
        ...
        >>> thread = api.get_resource_permissions_handler(resource_type, resource_id, limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_resource_permissions_handler_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_resource_permissions_handler_with_http_info(resource_type, resource_id, limit, offset, **kwargs)  # noqa: E501
    ...
    def get_resource_permissions_handler_with_http_info(self, resource_type : Annotated[StrictStr, Field(..., description="Resource Type")], resource_id : Annotated[StrictStr, Field(..., description="Resource Id")], limit : conint(strict=True, ge=0), offset : conint(strict=True, ge=0), **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_resource_permissions_handler_with_http_info(resource_type, resource_id, limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_resource_permissions_handler" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def remove_permission_handler(self, permission_request : PermissionRequest, **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the remove_permission_handler_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
