...
class TypedPlotResultDescriptor(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TypedPlotResultDescriptor:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TypedPlotResultDescriptor:
        """Create an instance of TypedPlotResultDescriptor from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TypedPlotResultDescriptor.parse_obj(obj)

        _obj = TypedPlotResultDescriptor.parse_obj({
