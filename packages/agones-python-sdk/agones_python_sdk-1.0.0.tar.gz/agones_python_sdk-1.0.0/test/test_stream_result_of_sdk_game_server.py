...
class TestStreamResultOfSdkGameServer(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StreamResultOfSdkGameServer:
        """Test StreamResultOfSdkGameServer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamResultOfSdkGameServer`
        """
        model = StreamResultOfSdkGameServer()
        if include_optional:
            return StreamResultOfSdkGameServer(
                result = agones_python_sdk.models.sdk_game_server.sdkGameServer(
