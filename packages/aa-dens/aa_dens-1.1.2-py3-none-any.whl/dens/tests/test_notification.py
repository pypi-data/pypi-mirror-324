...
class TestNotification(TestCase):
    ...
    def test_bad_notification(self):
        ...
        self.assertRaises(
            ValueError,
            MercenaryDenReinforcedNotification.create_from_notification,
            reinforce_notification,
        )
    ...
    def test_correctly_parses_when_aggressor_not_in_alliance(self):
        self.assertIsNotNone(
            MercenaryDenReinforcedNotification.parse_information_from_notification(
                NO_ALLIANCE_REINFORCE_NOTIFICATION
            )
        )

    def test_failing_notification(self):
        """
        ...
        MercenaryDenReinforcedNotification.create_from_notification(notification)
