...
class Config:
    ...
    def __str__(self):
        return "Config(liquid_electrum_url={}, bitcoin_electrum_url={}, mempoolspace_url={}, working_dir={}, network={}, payment_timeout_sec={}, zero_conf_min_fee_rate_msat={}, sync_service_url={}, breez_api_key={}, cache_dir={}, zero_conf_max_amount_sat={}, use_default_external_input_parsers={}, external_input_parsers={}, onchain_fee_rate_leeway_sat_per_vbyte={})".format(self.liquid_electrum_url, self.bitcoin_electrum_url, self.mempoolspace_url, self.working_dir, self.network, self.payment_timeout_sec, self.zero_conf_min_fee_rate_msat, self.sync_service_url, self.breez_api_key, self.cache_dir, self.zero_conf_max_amount_sat, self.use_default_external_input_parsers, self.external_input_parsers, self.onchain_fee_rate_leeway_sat_per_vbyte)
...
class _UniffiConverterTypeConfig(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return Config(
            ...
            sync_service_url=_UniffiConverterString.read(buf),
    ...
    def write(value, buf):
        ...
        _UniffiConverterString.write(value.sync_service_url, buf)
...
class ListPaymentsRequest:
    filters: "typing.Optional[typing.List[PaymentType]]";states: "typing.Optional[typing.List[PaymentState]]";from_timestamp: "typing.Optional[int]";to_timestamp: "typing.Optional[int]";offset: "typing.Optional[int]";limit: "typing.Optional[int]";details: "typing.Optional[ListPaymentDetails]";

    @typing.no_type_check
    def __init__(self, filters: "typing.Optional[typing.List[PaymentType]]" = _DEFAULT, states: "typing.Optional[typing.List[PaymentState]]" = _DEFAULT, from_timestamp: "typing.Optional[int]" = _DEFAULT, to_timestamp: "typing.Optional[int]" = _DEFAULT, offset: "typing.Optional[int]" = _DEFAULT, limit: "typing.Optional[int]" = _DEFAULT, details: "typing.Optional[ListPaymentDetails]" = _DEFAULT):
    ...
    def __str__(self):
        return "ListPaymentsRequest(filters={}, states={}, from_timestamp={}, to_timestamp={}, offset={}, limit={}, details={})".format(self.filters, self.states, self.from_timestamp, self.to_timestamp, self.offset, self.limit, self.details)
...
class PrepareLnUrlPayRequest:
    data: "LnUrlPayRequestData";amount_msat: "int";comment: "typing.Optional[str]";validate_success_action_url: "typing.Optional[bool]";

    @typing.no_type_check
    def __init__(self, data: "LnUrlPayRequestData", amount_msat: "int", comment: "typing.Optional[str]" = _DEFAULT, validate_success_action_url: "typing.Optional[bool]" = _DEFAULT):
        self.data = data
        self.amount_msat = amount_msat
    ...
    def __str__(self):
        return "PrepareLnUrlPayRequest(data={}, amount_msat={}, comment={}, validate_success_action_url={})".format(self.data, self.amount_msat, self.comment, self.validate_success_action_url)
...
class PrepareReceiveResponse:
    payment_method: "PaymentMethod";fees_sat: "int";payer_amount_sat: "typing.Optional[int]";min_payer_amount_sat: "typing.Optional[int]";max_payer_amount_sat: "typing.Optional[int]";swapper_feerate: "typing.Optional[float]";

    @typing.no_type_check
    def __init__(self, payment_method: "PaymentMethod", fees_sat: "int", payer_amount_sat: "typing.Optional[int]", min_payer_amount_sat: "typing.Optional[int]", max_payer_amount_sat: "typing.Optional[int]", swapper_feerate: "typing.Optional[float]"):
        self.payment_method = payment_method
        self.fees_sat = fees_sat
        self.payer_amount_sat = payer_amount_sat
    ...
    def __str__(self):
        return "PrepareReceiveResponse(payment_method={}, fees_sat={}, payer_amount_sat={}, min_payer_amount_sat={}, max_payer_amount_sat={}, swapper_feerate={})".format(self.payment_method, self.fees_sat, self.payer_amount_sat, self.min_payer_amount_sat, self.max_payer_amount_sat, self.swapper_feerate)
...
class WalletInfo:
    balance_sat: "int";pending_send_sat: "int";pending_receive_sat: "int";fingerprint: "str";pubkey: "str";

    @typing.no_type_check
    def __init__(self, balance_sat: "int", pending_send_sat: "int", pending_receive_sat: "int", fingerprint: "str", pubkey: "str"):
    ...
    def __str__(self):
        return "WalletInfo(balance_sat={}, pending_send_sat={}, pending_receive_sat={}, fingerprint={}, pubkey={})".format(self.balance_sat, self.pending_send_sat, self.pending_receive_sat, self.fingerprint, self.pubkey)
...
class InputType:
    ...
    class BOLT12_OFFER:
        ...
        @typing.no_type_check
        def __init__(self,offer: "LnOffer"):
            
            self.offer = offer
            

        def __str__(self):
            return "InputType.BOLT12_OFFER(offer={})".format(self.offer)
...
class PayAmount:
    ...
    class RECEIVER:
        ...
        def __str__(self):
            return "PayAmount.RECEIVER(amount_sat={})".format(self.amount_sat)
    ...
    def is_receiver(self) -> bool:
        return isinstance(self, PayAmount.RECEIVER)
...
# enum class, so that method calls and instance checks etc will work intuitively.
# We might be able to do this a little more neatly with a metaclass, but this'll do.
PayAmount.RECEIVER = type("PayAmount.RECEIVER", (PayAmount.RECEIVER, PayAmount,), {})  # type: ignore
...
class PaymentDetails:
    ...
    # Each enum variant is a nested class of the enum itself.
    class LIGHTNING:
        swap_id: "str";description: "str";liquid_expiration_blockheight: "int";preimage: "typing.Optional[str]";bolt11: "typing.Optional[str]";bolt12_offer: "typing.Optional[str]";payment_hash: "typing.Optional[str]";lnurl_info: "typing.Optional[LnUrlInfo]";refund_tx_id: "typing.Optional[str]";refund_tx_amount_sat: "typing.Optional[int]";

        @typing.no_type_check
        def __init__(self,swap_id: "str", description: "str", liquid_expiration_blockheight: "int", preimage: "typing.Optional[str]", bolt11: "typing.Optional[str]", bolt12_offer: "typing.Optional[str]", payment_hash: "typing.Optional[str]", lnurl_info: "typing.Optional[LnUrlInfo]", refund_tx_id: "typing.Optional[str]", refund_tx_amount_sat: "typing.Optional[int]"):
        ...
        def __str__(self):
            return "PaymentDetails.LIGHTNING(swap_id={}, description={}, liquid_expiration_blockheight={}, preimage={}, bolt11={}, bolt12_offer={}, payment_hash={}, lnurl_info={}, refund_tx_id={}, refund_tx_amount_sat={})".format(self.swap_id, self.description, self.liquid_expiration_blockheight, self.preimage, self.bolt11, self.bolt12_offer, self.payment_hash, self.lnurl_info, self.refund_tx_id, self.refund_tx_amount_sat)
    ...
    class LIQUID:
        ...
        def __eq__(self, other):
            ...
            return True
    class BITCOIN:
        swap_id: "str";description: "str";bitcoin_expiration_blockheight: "typing.Optional[int]";liquid_expiration_blockheight: "typing.Optional[int]";refund_tx_id: "typing.Optional[str]";refund_tx_amount_sat: "typing.Optional[int]";

        @typing.no_type_check
        def __init__(self,swap_id: "str", description: "str", bitcoin_expiration_blockheight: "typing.Optional[int]", liquid_expiration_blockheight: "typing.Optional[int]", refund_tx_id: "typing.Optional[str]", refund_tx_amount_sat: "typing.Optional[int]"):
        ...
        def __str__(self):
            return "PaymentDetails.BITCOIN(swap_id={}, description={}, bitcoin_expiration_blockheight={}, liquid_expiration_blockheight={}, refund_tx_id={}, refund_tx_amount_sat={})".format(self.swap_id, self.description, self.bitcoin_expiration_blockheight, self.liquid_expiration_blockheight, self.refund_tx_id, self.refund_tx_amount_sat)
...
class SendDestination:
    ...
    class BOLT11:
        ...
        def __eq__(self, other):
            ...
            return True
    class BOLT12:
        offer: "LnOffer";receiver_amount_sat: "int";

        @typing.no_type_check
        def __init__(self,offer: "LnOffer", receiver_amount_sat: "int"):
        ...
        def __str__(self):
            return "SendDestination.BOLT12(offer={}, receiver_amount_sat={})".format(self.offer, self.receiver_amount_sat)
