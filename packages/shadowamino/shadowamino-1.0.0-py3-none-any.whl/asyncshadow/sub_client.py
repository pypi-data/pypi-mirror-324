...
class SubClient(client.Client):
    ...
    def parse_headers(self, data: str = None, type: str = None):
        return headers.ApisHeaders(deviceId=deviceId() if self.autoDevice else self.device_id,  type=type).headers
    ...
    async def generate_invite_code(self, duration: int = 0, force: bool = True):
        ...
        async with self.session.post(f"{self.api}/g/s-x{self.comId}/community/invitation", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
    ...
    async def post_blog(self, title: str, content: str, imageList: list = None, captionList: list = None, categoriesList: list = None, backgroundColor: str = None, fansOnly: bool = False, extensions: dict = None):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/blog", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def post_wiki(self, title: str, content: str, icon: str = None, imageList: list = None, keywords: str = None, backgroundColor: str = None, fansOnly: bool = False):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/item", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def edit_blog(self, blogId: str, title: str = None, content: str = None, imageList: list = None, categoriesList: list = None, backgroundColor: str = None, fansOnly: bool = False):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/blog/{blogId}", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def check_in(self, tz: int = -timezone // 1000):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/check-in", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def repair_check_in(self, method: int = 0):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/check-in/repair", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def edit_profile(self, nickname: str = None, content: str = None, icon: BinaryIO = None, chatRequestPrivilege: str = None, imageList: list = None, captionList: list = None, backgroundImage: str = None, backgroundColor: str = None, titles: list = None, colors: list = None, defaultBubbleId: str = None, fileType: str = "image"):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/user-profile/{self.profile.userId}", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def vote_poll(self, blogId: str, optionId: str):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/blog/{blogId}/poll/option/{optionId}/vote", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def comment(self, message: str, userId: str = None, blogId: str = None, wikiId: str = None, replyTo: str = None, isGuest: bool = False):
        ...
        async with self.session.post(url, headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def upvote_comment(self, blogId: str, commentId: str):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/blog/{blogId}/comment/{commentId}/vote?cv=1.2&value=1", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def reply_wall(self, userId: str, commentId: str, message: str):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/user-profile/{userId}/comment", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def lottery(self, tz: int = -timezone // 1000):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/check-in/lottery", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
    ...
    async def activity_status(self, status: str):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/user-profile/{self.profile.userId}/online-status", headers=self.parse_headers()) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def start_chat(self, userId: Union[str, list], message: str, title: str = None, content: str = None, isGlobal: bool = False, publishToGlobal: bool = False):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def invite_to_chat(self, userId: Union[str, list], chatId: str):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}/member/invite", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def follow(self, userId: Union[str, list]):
        ...
        **Returns**
        ...
        if isinstance(userId, str):
            ...
            async with self.session.post(f"{self.api}/x{self.comId}/s/user-profile/{self.profile.userId}/joined", headers=self.parse_headers(), ) as response:
                if response.status != 200: return exceptions.CheckException(await response.text())
                else: return response.status
    ...
    async def flag(self, reason: str, flagType: int, userId: str = None, blogId: str = None, wikiId: str = None, asGuest: bool = False):
        ...
        **Returns**
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/{flg}", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def send_message(self, chatId: str, message: str = None, messageType: int = 0, file: BinaryIO = None, fileType: str = None, replyTo: str = None, mentionUserIds: list = None, stickerId: str = None, embedId: str = None, embedType: int = None, embedLink: str = None, embedTitle: str = None, embedContent: str = None, embedImage: BinaryIO = None, linkSnippet: str = None, linkSnippetImage: BinaryIO = None):
        ...
        **Returns**
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}/message", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def delete_message(self, chatId: str, messageId: str, asStaff: bool = False, reason: str = None):
        ...
        **Returns**
        ...
        if not asStaff:
            ...
            async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}/message/{messageId}/admin", headers=self.parse_headers(), ) as response:
                if response.status != 200: return exceptions.CheckException(await response.text())
                else: return response.status
    ...
    async def mark_as_read(self, chatId: str, messageId: str):
        ...
        **Returns**
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}/mark-as-read", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
        ...
        **Returns**
        ...
        if doNotDisturb is not None:
            if doNotDisturb:
                ...
                async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}/member/{self.profile.userId}/alert", headers=self.parse_headers(), ) as response:
        ...
        if backgroundImage is not None:
            ...
            async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}/member/{self.profile.userId}/background", headers=self.parse_headers(), ) as response:
                if response.status != 200: res.append(exceptions.CheckException(await response.text()))
                else: res.append(response.status)

        if coHosts is not None:
            data = json.dumps({"uidList": coHosts, "timestamp": int(timestamp() * 1000)})
            async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}/co-host", headers=self.parse_headers(), ) as response:
                if response.status != 200: res.append(exceptions.CheckException(await response.text()))
                else: res.append(response.status)
        ...
        if canInvite is not None:
            if canInvite:
                async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}/members-can-invite/enable", headers=self.parse_headers(), ) as response:
                    if response.status != 200: res.append(exceptions.CheckException(await response.text()))
                    else: res.append(response.status)

            if not canInvite:
                async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}/members-can-invite/disable", headers=self.parse_headers(), ) as response:
                    if response.status != 200: res.append(exceptions.CheckException(await response.text()))
                    else: res.append(response.status)

        if canTip is not None:
            if canTip:
                async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}/tipping-perm-status/enable", headers=self.parse_headers(), ) as response:
                    if response.status != 200: res.append(exceptions.CheckException(await response.text()))
                    else: res.append(response.status)

            if not canTip:
                async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}/tipping-perm-status/disable", headers=self.parse_headers(), ) as response:
                    if response.status != 200: res.append(exceptions.CheckException(await response.text()))
                    else: res.append(response.status)

        data = json.dumps(data)
        async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}", headers=self.parse_headers(), ) as response:
            if response.status != 200: res.append(exceptions.CheckException(await response.text()))
            else: res.append(response.status)
    ...
    async def transfer_host(self, chatId: str, userIds: list):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}/transfer-organizer", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def send_active_obj(self, startTime: int = None, endTime: int = None, optInAdsFlags: int = 2147483647, tz: int = -timezone // 1000, timers: list = None, timestamp: int = int(timestamp() * 1000)): 
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/community/stats/user-active-time", headers=self.parse_headers()) as response: 
          if response.status != 200: 
    ...
    async def subscribe(self, userId: str, autoRenew: str = False, transactionId: str = None):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/influencer/{userId}/subscribe", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def play_quiz_raw(self, quizId: str, quizAnswerList: list, quizMode: int = 0):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/blog/{quizId}/quiz/result", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def vc_permission(self, chatId: str, permission: int):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}/vvchat-permission", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def edit_titles(self, userId: str, titles: list, colors: list):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/user-profile/{userId}/admin", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def warn(self, userId: str, reason: str = None):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/notice", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def ban(self, userId: str, reason: str, banType: int = None):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/user-profile/{userId}/ban", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def unban(self, userId: str, reason: str):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/user-profile/{userId}/unban", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def reorder_featured_users(self, userIds: list):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/user-profile/featured/reorder", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def purchase(self, objectId: str, objectType: int, aminoPlus: bool = True, autoRenew: bool = False):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/store/purchase", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def apply_avatar_frame(self, avatarId: str, applyToAll: bool = True):
        ...
        **Returns**
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/avatar-frame/apply", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def invite_to_vc(self, chatId: str, userId: str):
        ...
        **Returns**
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/{chatId}/vvchat-presenter/invite", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def add_poll_option(self, blogId: str, question: str):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/blog/{blogId}/poll/option", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def create_wiki_category(self, title: str, parentCategoryId: str, content: str = None):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/item-category", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def create_shared_folder(self, title: str):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/shared-folder/folders", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def submit_to_wiki(self, wikiId: str, message: str):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/knowledge-base-request", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def accept_wiki_request(self, requestId: str, destinationCategoryIdList: list):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/knowledge-base-request/{requestId}/approve", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
    ...
    async def apply_bubble(self, bubbleId: str, chatId: str, applyToAll: bool = False):
        ...
        async with self.session.post(f"{self.api}/x{self.comId}/s/chat/thread/apply-bubble", headers=self.parse_headers(), ) as response:
            if response.status != 200: return exceptions.CheckException(await response.text())
            else: return response.status
