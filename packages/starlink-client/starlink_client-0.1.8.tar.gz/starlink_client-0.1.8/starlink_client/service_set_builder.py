from starlink_client.spacex.api.device.device_pb2 import Request
from starlink_client.spacex.api.device.wifi_config_pb2 import WifiConfig, AuthWpa2
from starlink_client.spacex.api.device.wifi_pb2 import WifiSetConfigRequest, WifiGetStatusResponse
