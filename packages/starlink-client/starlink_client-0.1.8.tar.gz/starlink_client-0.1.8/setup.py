...
setup(
    ...
    version="0.1.8",
    packages=find_namespace_packages(include=["starlink_client", "starlink_client.*"]),
    include_package_data=True,  # Esto es clave
    package_data={
        "starlink_client": ["spacex/**"],  # Incluye el directorio spacex y sus archivos
    },
    install_requires=[
        "grpcio",
        "grpcio-status",
