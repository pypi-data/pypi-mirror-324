from starlink_client.spacex.api.device.device_pb2 import Request, GetStatusRequest
from starlink_client.spacex.api.device.wifi_config_pb2 import WifiConfig
from starlink_client.spacex.api.device.wifi_pb2 import WifiGetStatusResponse
