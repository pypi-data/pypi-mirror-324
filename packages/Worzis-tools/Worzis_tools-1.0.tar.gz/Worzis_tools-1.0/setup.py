...
setup(
    ...
    version="1.0", # версия модуля при каждом обновлении (новой отправке надо версию увеличивать)
    ...
    install_requires=['colorama'], # список названий модулей которые нужны для корректной работы вашего модуля
) 