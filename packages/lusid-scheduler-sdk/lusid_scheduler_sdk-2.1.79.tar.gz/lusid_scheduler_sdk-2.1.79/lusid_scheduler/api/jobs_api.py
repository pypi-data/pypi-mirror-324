...
class JobsApi:
    ...
    @overload
    async def get_history(self, page : Annotated[Optional[constr(strict=True, max_length=500, min_length=1)], Field(description="The pagination token to use to continue listing instruments from a previous call to list instruments.              This value is returned from the previous call. If a pagination token is provided the sortBy and filter fields              must not have changed since the original request. Also, if set, a start value cannot be provided.")] = None, sort_by : Annotated[Optional[conlist(StrictStr)], Field(description="Order the results by these fields. Use use the '-' sign to denote descending order e.g. -MyFieldName.")] = None, start : Annotated[Optional[StrictInt], Field(description="This field is obsolete, the value of this field would not be considered.")] = None, limit : Annotated[Optional[conint(strict=True, le=5000, ge=1)], Field(description="When paginating, limit the number of returned results to this many. Defaults to 2000 if not specified. Maximum is 5000.")] = None, filter : Annotated[Optional[constr(strict=True, max_length=16384, min_length=0)], Field(description="Expression to filter the result set.")] = None, **kwargs) -> ResourceListOfJobHistory:  # noqa: E501
        ...

    @overload
    def get_history(self, page : Annotated[Optional[constr(strict=True, max_length=500, min_length=1)], Field(description="The pagination token to use to continue listing instruments from a previous call to list instruments.              This value is returned from the previous call. If a pagination token is provided the sortBy and filter fields              must not have changed since the original request. Also, if set, a start value cannot be provided.")] = None, sort_by : Annotated[Optional[conlist(StrictStr)], Field(description="Order the results by these fields. Use use the '-' sign to denote descending order e.g. -MyFieldName.")] = None, start : Annotated[Optional[StrictInt], Field(description="This field is obsolete, the value of this field would not be considered.")] = None, limit : Annotated[Optional[conint(strict=True, le=5000, ge=1)], Field(description="When paginating, limit the number of returned results to this many. Defaults to 2000 if not specified. Maximum is 5000.")] = None, filter : Annotated[Optional[constr(strict=True, max_length=16384, min_length=0)], Field(description="Expression to filter the result set.")] = None, async_req: Optional[bool]=True, **kwargs) -> ResourceListOfJobHistory:  # noqa: E501
        ...
    ...
    @overload
    async def get_job_console_output(self, run_id : Annotated[constr(strict=True, max_length=36, min_length=0), Field(..., description="The RunId of the job run")], **kwargs) -> str:  # noqa: E501
        ...

    @overload
    def get_job_console_output(self, run_id : Annotated[constr(strict=True, max_length=36, min_length=0), Field(..., description="The RunId of the job run")], async_req: Optional[bool]=True, **kwargs) -> str:  # noqa: E501
        ...

    @validate_arguments
    def get_job_console_output(self, run_id : Annotated[constr(strict=True, max_length=36, min_length=0), Field(..., description="The RunId of the job run")], async_req: Optional[bool]=None, **kwargs) -> Union[str, Awaitable[str]]:  # noqa: E501
    ...
    @validate_arguments
    def get_job_console_output_with_http_info(self, run_id : Annotated[constr(strict=True, max_length=36, min_length=0), Field(..., description="The RunId of the job run")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] GetJobConsoleOutput: Gets the console output of a specific job run  # noqa: E501
    ...
    @overload
    async def get_run_history(self, run_id : Annotated[constr(strict=True, max_length=36, min_length=0), Field(..., description="The unique ID of the run")], **kwargs) -> JobRunResult:  # noqa: E501
        ...

    @overload
    def get_run_history(self, run_id : Annotated[constr(strict=True, max_length=36, min_length=0), Field(..., description="The unique ID of the run")], async_req: Optional[bool]=True, **kwargs) -> JobRunResult:  # noqa: E501
        ...

    @validate_arguments
    def get_run_history(self, run_id : Annotated[constr(strict=True, max_length=36, min_length=0), Field(..., description="The unique ID of the run")], async_req: Optional[bool]=None, **kwargs) -> Union[JobRunResult, Awaitable[JobRunResult]]:  # noqa: E501
    ...
    @validate_arguments
    def get_run_history_with_http_info(self, run_id : Annotated[constr(strict=True, max_length=36, min_length=0), Field(..., description="The unique ID of the run")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] GetRunHistory: Get the history for a single job run  # noqa: E501
    ...
    @validate_arguments
    def list_jobs_with_http_info(self, page : Annotated[Optional[constr(strict=True, max_length=500, min_length=1)], Field(description="The pagination token to use to continue listing instruments from a previous call to list instruments.              This value is returned from the previous call. If a pagination token is provided the sortBy and filter fields              must not have changed since the original request. Also, if set, a start value cannot be provided.")] = None, sort_by : Annotated[Optional[conlist(StrictStr)], Field(description="Order the results by these fields. Use use the '-' sign to denote descending order e.g. -MyFieldName.")] = None, start : Annotated[Optional[conint(strict=True, le=5000, ge=0)], Field(description="When paginating, skip this number of results.")] = None, limit : Annotated[Optional[conint(strict=True, le=5000, ge=1)], Field(description="When paginating, limit the number of returned results to this many. Defaults to 2000 if not specified. Maximum is 5000.")] = None, filter : Annotated[Optional[constr(strict=True, max_length=1024, min_length=0)], Field(description="Expression to filter the result set.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] ListJobs: List the available jobs  # noqa: E501
    ...
    @overload
    async def update_job(self, scope : StrictStr, code : StrictStr, update_job_request : UpdateJobRequest, **kwargs) -> JobDefinition:  # noqa: E501
        ...

    @overload
    def update_job(self, scope : StrictStr, code : StrictStr, update_job_request : UpdateJobRequest, async_req: Optional[bool]=True, **kwargs) -> JobDefinition:  # noqa: E501
        ...

    @validate_arguments
    def update_job(self, scope : StrictStr, code : StrictStr, update_job_request : UpdateJobRequest, async_req: Optional[bool]=None, **kwargs) -> Union[JobDefinition, Awaitable[JobDefinition]]:  # noqa: E501
    ...
    @validate_arguments
    def update_job_with_http_info(self, scope : StrictStr, code : StrictStr, update_job_request : UpdateJobRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] UpdateJob: Update a JobDefinition  # noqa: E501
