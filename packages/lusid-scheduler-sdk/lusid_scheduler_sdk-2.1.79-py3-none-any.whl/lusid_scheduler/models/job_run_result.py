...
class JobRunResult(BaseModel):
    ...
    description: Optional[StrictStr] = Field(None, description="Description of the job")
    ...
    message: Optional[StrictStr] = Field(None, description="Output message generated by the job runner  Value will be null when the job is in a `Running` or `Pending` status")
