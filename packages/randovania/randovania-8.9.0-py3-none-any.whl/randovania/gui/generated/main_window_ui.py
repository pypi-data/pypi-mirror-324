...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.games_supported_label.sizePolicy().hasHeightForWidth())
        self.games_supported_label.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.games_experimental_label.sizePolicy().hasHeightForWidth())
        self.games_experimental_label.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.intro_welcome_label.sizePolicy().hasHeightForWidth())
        self.intro_welcome_label.setSizePolicy(sizePolicy1)
        ...
        self.game_list_contents.setGeometry(QRect(0, 0, 664, 411))
        ...
        self.menu_bar.setGeometry(QRect(0, 0, 688, 21))
