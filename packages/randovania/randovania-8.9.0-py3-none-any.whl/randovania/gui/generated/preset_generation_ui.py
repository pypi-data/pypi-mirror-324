...
class Ui_PresetGeneration(object):
    def setupUi(self, PresetGeneration):
        ...
        self.scroll_contents.setGeometry(QRect(0, 0, 539, 900))
    ...
    def retranslateUi(self, PresetGeneration):
        ...
        self.major_minor_label.setText(QCoreApplication.translate("PresetGeneration", u"<html><head/><body><p>If this setting is enabled, major items (e.g., major upgrades and keys to new areas) and minor items (i.e, ammo expansions) will be shuffled separately.<br/>Major items in excess of the number of major locations will be placed in minor locations, and vice versa.</p></body></html>", None))
