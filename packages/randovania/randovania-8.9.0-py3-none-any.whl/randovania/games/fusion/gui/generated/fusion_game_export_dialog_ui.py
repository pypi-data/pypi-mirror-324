...
class Ui_FusionGameExportDialog(object):
    def setupUi(self, FusionGameExportDialog):
        ...
        FusionGameExportDialog.resize(508, 295)
    ...
    def retranslateUi(self, FusionGameExportDialog):
        ...
        self.description_label.setText(QCoreApplication.translate("FusionGameExportDialog", u"<html><head/><body><p>Exporting is currently not supported for Fusion! Please be patient, as we are still very early in development :)</p><p>In order to create the randomized game, a copy of the US version of Fusion.gba is necessary.</p></body></html>", None))
