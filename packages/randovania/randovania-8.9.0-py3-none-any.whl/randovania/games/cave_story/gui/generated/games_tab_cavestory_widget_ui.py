...
class Ui_CaveStoryGameTabWidget(object):
    def setupUi(self, CaveStoryGameTabWidget):
        ...
        self.faq_scroll_area_contents.setGeometry(QRect(0, 0, 120, 1696))
        ...
        self.differences_scroll_contents.setGeometry(QRect(0, 0, 193, 2650))
        ...
        self.hints_scroll_area_contents.setGeometry(QRect(0, 0, 100, 978))
        ...
        self.hint_item_names_scroll_contents.setGeometry(QRect(0, 0, 100, 462))
        ...
        self.hint_locations_scroll_contents.setGeometry(QRect(0, 0, 100, 408))
