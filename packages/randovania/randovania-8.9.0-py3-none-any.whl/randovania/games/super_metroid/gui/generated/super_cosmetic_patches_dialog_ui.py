...
class Ui_SuperCosmeticPatchesDialog(object):
    def setupUi(self, SuperCosmeticPatchesDialog):
        ...
        self.scroll_area_contents.setGeometry(QRect(0, 0, 468, 632))
        ...
        self.colorblind_label.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.colorblind_label.setLineWidth(1)
        self.colorblind_label.setScaledContents(False)
        self.colorblind_label.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
