...
class Ui_PresetPrimeQol(object):
    def setupUi(self, PresetPrimeQol):
        ...
        self.scroll_contents.setGeometry(QRect(0, -358, 487, 1200))
        ...
        self.logical_label.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignTop)
