...
class Ui_DreadGameTabWidget(object):
    def setupUi(self, DreadGameTabWidget):
        ...
        self.intro_layout.setSizeConstraint(QLayout.SizeConstraint.SetDefaultConstraint)
        ...
        self.faq_scroll_area_contents.setGeometry(QRect(0, 0, 635, 465))
        ...
        sizePolicy2.setHeightForWidth(self.differences_tab.sizePolicy().hasHeightForWidth())
        self.differences_tab.setSizePolicy(sizePolicy2)
        ...
        self.differences_contents.setGeometry(QRect(0, 0, 635, 465))
        ...
        self.known_crashes_contents.setGeometry(QRect(0, 0, 621, 758))
        ...
        self.known_crashes_label.setTextFormat(Qt.TextFormat.MarkdownText)
        ...
        self.hints_scroll_area_contents.setGeometry(QRect(0, 0, 635, 465))
        ...
        self.hint_item_names_scroll_area.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignTop)
        ...
        self.hint_item_names_scroll_contents.setGeometry(QRect(0, 0, 635, 465))
        ...
        self.hint_item_names_tree_widget.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        ...
        self.hint_locations_scroll_contents.setGeometry(QRect(0, 0, 635, 465))
