...
class Ui_FactorioGameTabWidget(object):
    ...
    def retranslateUi(self, FactorioGameTabWidget):
        ...
        self.intro_label.setText(QCoreApplication.translate("FactorioGameTabWidget", u"<html><head/><body><p>Build a factory, research new technologies and automate the whole process in order to launch a rocket.</p><p>What each technology you unlock gives is shuffled, but which science packs you'll need and how many is still the same. However, the recipes for each pack plus the rocket is random!</p></body></html>", None))
