...
@when('I try to partial update the project principal investigator', target_fixture='request_result')
def partial_update_project_principal_investigator(client, project, coordinator):
    return client.patch(
        reverse('project-detail', kwargs=dict(pk=project.pk)),
