...
class ArrayParam(Param):
    ...
    :value: Contain a list of sub widgets
    :component: 

        * ``auto``: default, list all contained widgets top-down
        * ``panel``: show a dropdown menu to select from contained widgets
...
class ParamsManager:
    ...
    def modify_object(self, object):
        """
        Write parameter values to object

        :param object: 
        :return:
        """
        for param in self.params:
            param.modify_object(object)
