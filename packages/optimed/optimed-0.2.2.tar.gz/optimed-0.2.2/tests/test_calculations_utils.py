...
class TestArrayFunctions(unittest.TestCase):
    ...
    @unittest.skipUnless(cupy_available, "cupy not installed. Skipping GPU test for scipy_binary_closing.")
    ...
    @unittest.skipUnless(cupy_available, "cupy not installed. Skipping GPU test for scipy_binary_erosion.")
