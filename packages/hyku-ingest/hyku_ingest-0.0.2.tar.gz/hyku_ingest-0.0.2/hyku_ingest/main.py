...
def main(input_file, output_file, attachments_given, verbose, audio_visual):
...
# attachments_given, verbose, and audio_visual are by default false, if the flag is present they are set to true
...
if __name__ == "__main__":
  ...
  if args.input_file == args.output_file:
    ...
    exit(1)
  main(args.input_file, args.output_file, args.attachments_given, args.verbose, args.audio_visual)
