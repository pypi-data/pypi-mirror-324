...
cdef extern from "libft4222.h":
    ...
    FT4222_STATUS FT4222_GetChipMode(FT_HANDLE ftHandle, uint8 *pChipMode)
    ...
    FT4222_STATUS FT4222_GPIO_Read(FT_HANDLE ftHandle, GPIO_Port portNum, BOOL* value) nogil
