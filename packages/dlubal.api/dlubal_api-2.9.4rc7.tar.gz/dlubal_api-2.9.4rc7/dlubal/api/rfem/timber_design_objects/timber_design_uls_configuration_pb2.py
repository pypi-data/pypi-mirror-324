...
# source: dlubal/api/rfem/timber_design_objects/timber_design_uls_configuration.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'dlubal/api/rfem/timber_design_objects/timber_design_uls_configuration.proto'
)
