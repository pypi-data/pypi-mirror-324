...
class TimeSeriesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["aggregations", b"aggregations", "expressions", b"expressions", "filter", b"filter", "granularity_secs", b"granularity_secs", "group_by", b"group_by", "meta", b"meta"]) -> None: ...
...
class Expression(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["aggregation", b"aggregation", "expression", b"expression", "formula", b"formula"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["aggregation", b"aggregation", "expression", b"expression", "formula", b"formula"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["expression", b"expression"]) -> typing.Literal["aggregation", "formula"] | None: ...
