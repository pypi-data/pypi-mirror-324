...
class SQLTemplates:
    def __init__(self):
        self.template_dir = impresources.files(sql_templates) 
    ...
    def get_template(self, name):
        try:
            with self.template_dir.joinpath(name).open("r") as f:
                return f.read()
        except FileNotFoundError as e:
            logging.error(e)
...
class DirectoryHandler:
    def __init__(self):
        ...
        self.sql_templates_path = impresources.files(sql_templates)
