...
def cdk_adder(
    ...
    if n == 2:
        return _cdk_adder_for_n2(qc, ar, br, cr, is_unsigned, opt_ctrl_bit, opt_ctrl_state)
    if n == 3:
        return _cdk_adder_for_n3(qc, ar, br, cr, is_unsigned, opt_ctrl_bit, opt_ctrl_state)
    for i in range(1, n):
        qc.cx(ar[i], br[i])
    qc.cx(ar[1], cr[0])
...
def cdk_adder_gate(n: int, label: str="add", is_unsigned:bool=False, opt_ctrl_state:str|None=None) -> Gate:
    ...
    cdk_adder(qc, ar, br, cr, is_unsigned, opt_ctrl_bit, opt_ctrl_state)
