...
logger.disable(LOGGER_PYLIZ_MEDIA_NAME)


def pyblizmedia_log_test():
    logger.info("This is a test log message from PylizMedia.")
    logger.debug("This is a debug message from PylizMedia.")
    logger.error("This is an error message from PylizMedia.")
    logger.warning("This is a warning message from PylizMedia.")
    logger.critical("This is a critical message from PylizMedia.")
    logger.trace("This is a trace message from PylizMedia.")
