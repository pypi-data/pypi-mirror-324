...
class Units_QtsSequence(OCP.NCollection.NCollection_BaseSequence):
    ...
    def __call__(self,theIndex : int) -> Units_Quantity: 
        """
        Constant operator()
    ...
    @overload
    def __init__(self) -> None: ...
    def __iter__(self) -> Iterator[Units_Quantity]: ...
...
class Units_TksSequence(OCP.NCollection.NCollection_BaseSequence):
    ...
    def Value(self,theIndex : int) -> Units_Token: 
        ...
        """
    def __bool__(self) -> bool: ...
    def __call__(self,theIndex : int) -> Units_Token: 
        """
        Constant operator()
    ...
    @overload
    def __init__(self,theAllocator : OCP.NCollection.NCollection_BaseAllocator) -> None: ...
    def __iter__(self) -> Iterator[Units_Token]: ...
    def __len__(self) -> int: ...
    @staticmethod
    def delNode_s(theNode : NCollection_SeqNode,theAl : OCP.NCollection.NCollection_BaseAllocator) -> None: 
        """
...
class Units_UtsSequence(OCP.NCollection.NCollection_BaseSequence):
    ...
    def Value(self,theIndex : int) -> Units_Unit: 
        ...
        """
    def __bool__(self) -> bool: ...
    def __call__(self,theIndex : int) -> Units_Unit: 
        """
        Constant operator()
    ...
    @overload
    def __init__(self) -> None: ...
    def __iter__(self) -> Iterator[Units_Unit]: ...
    def __len__(self) -> int: ...
    @staticmethod
    def delNode_s(theNode : NCollection_SeqNode,theAl : OCP.NCollection.NCollection_BaseAllocator) -> None: 
        """
