...
#AudioSampleValues.list_to_wav(Methylphenethylamine.MFast([AudioSampleValues.wav_to_list('C:/Audio/Embryo.wav')]), 'D:/Audio/Embryo.wav')
#Methylphenethylamine.BatchMSlow('D:/5th Generation (When Desktop Is Full)/Audio/Stems and Mixes for Future Edits/Normalized Stems', 'D:/5th Generation (When Desktop Is Full)/Audio/Stems and Mixes for Future Edits/MSlow')
Methylphenethylamine.BatchMFast('D:/5th Generation (When Desktop Is Full)/Audio/Stems and Mixes for Future Edits/Normalized Stems', 'D:/5th Generation (When Desktop Is Full)/Audio/Stems and Mixes for Future Edits/MFast')
