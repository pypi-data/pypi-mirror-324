...
class MailerHelper:
    ...
    def send_failure_notification(self, missing_mappings, posting_period_val, business_unit):
        ...
        body += """\
                  ...
                  <p>We kindly request you to update the missing fields in the records as soon as possible.</p>
        ...
        try:
            self.send_email_daakiya(None, None, "veeksha.vadlakonda@theporter.in", subject, body)
