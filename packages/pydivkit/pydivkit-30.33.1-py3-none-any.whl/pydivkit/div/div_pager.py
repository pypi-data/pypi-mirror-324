...
class DivPager(BaseDiv):
    ...
    def __init__(
        ...
        scroll_axis_alignment: typing.Optional[typing.Union[Expr, DivPagerScrollAxisAlignment]] = None,
    ...
    scroll_axis_alignment: typing.Optional[typing.Union[Expr, DivPagerScrollAxisAlignment]] = Field(
        description=(
...
class DivPagerScrollAxisAlignment(str, enum.Enum):
    START = "start"
    CENTER = "center"
    END = "end"
