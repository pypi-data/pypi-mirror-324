...
from finn.plugins import hook_specifications
from finn.settings import get_settings
from finn.types import AugmentedWidget, LayerData, SampleDict, WidgetCallable
from finn.utils.events import EmitterGroup, EventedSet
from finn.utils.misc import camel_to_spaces
from finn.utils.theme import Theme, register_theme, unregister_theme
    ...
    * disabled (value: str)
    ...
    def available_samples(self) -> tuple[tuple[str, str], ...]:
        ...
        sample_keys : Tuple[Tuple[str, str], ...]
            ...
            use :meth:`finn.Viewer.open_sample`.
        ...
        .. code-block:: python
            ...
            from finn.plugins import available_samples
    ...
    def unregister_theme_colors(self, plugin_name: str):
        """Unregister theme data from finn."""
        if plugin_name not in self._theme_data:
            return
