...
from finn._app_model.context import create_context, get_context
from finn._qt._qapp_model import build_qmodel_menu
from finn._qt._qapp_model.qactions import add_dummy_actions, init_qactions
from finn._qt._qapp_model.qactions._debug import _is_set_trace_active
from finn._qt._qplugins import (
    _rebuild_npe1_plugins_menu,
    _rebuild_npe1_samples_menu,
)
from finn._qt.dialogs.confirm_close_dialog import ConfirmCloseDialog
from finn._qt.dialogs.preferences_dialog import PreferencesDialog
from finn._qt.dialogs.qt_activity_dialog import QtActivityDialog
from finn._qt.dialogs.qt_notification import NapariQtNotification
from finn._qt.qt_event_loop import (
    NAPARI_ICON_PATH,
    get_qapp,
    quit_app as quit_app_,
)
from finn._qt.qt_resources import get_stylesheet
from finn._qt.qt_viewer import QtViewer
from finn._qt.threads.status_checker import StatusChecker
from finn._qt.utils import QImg2array, qbytearray_to_str, str_to_qbytearray
from finn._qt.widgets.qt_viewer_dock_widget import (
    _SHORTCUT_DEPRECATION_STRING,
    QtViewerDockWidget,
)
from finn._qt.widgets.qt_viewer_status_bar import ViewerStatusBar
from finn.plugins import (
...
from finn.utils.misc import (
    in_ipython,
    in_jupyter,
    in_python_repl,
    running_as_constructor_app,
)
from finn.utils.notifications import Notification
from finn.utils.theme import _themes, get_system_theme
...
class _QtMainWindow(QMainWindow):
    ...
    # `finn._qt.qt_main_window._QtMainWindow._window_icon`
...
class Window:
    ...
    def _handle_trace_file_on_start(self):
        ...
        from finn._qt._qapp_model.qactions._debug import _start_trace
