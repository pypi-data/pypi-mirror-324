...
from finn.utils.notifications import Notification, NotificationSeverity
...
class NapariQtNotification(QDialog):
    ...
    def from_notification(
        ...
        from finn.utils.notifications import ErrorNotification
...
def _debug_tb(tb):
    ...
    from finn._qt.utils import event_hook_removed
