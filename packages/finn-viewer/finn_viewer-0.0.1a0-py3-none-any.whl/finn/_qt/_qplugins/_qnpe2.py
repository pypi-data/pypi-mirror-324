...
from finn._qt._qapp_model.injection._qproviders import (
    _provide_viewer_or_raise,
    _provide_window,
    _provide_window_or_raise,
)
from finn.errors.reader_errors import MultipleReaderError
from finn.plugins import menu_item_template, plugin_manager
from finn.plugins._npe2 import _when_group_order, get_widget_contribution
...
def _build_samples_submenu_actions(
    ...
    from finn._app_model.constants import MenuGroup, MenuId
    from finn.plugins import menu_item_template
