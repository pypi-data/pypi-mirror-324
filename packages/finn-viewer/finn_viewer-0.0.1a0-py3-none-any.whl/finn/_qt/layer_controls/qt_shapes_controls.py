...
from finn._qt.widgets.qt_color_swatch import QColorSwatchEdit
from finn._qt.widgets.qt_mode_buttons import QtModePushButton
from finn.layers.shapes._shapes_constants import Mode
...
class QtShapesControls(QtLayerControls):
    ...
    direct_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
    ...
    ellipse_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
        Button to add ellipses to shapes layer.
    faceColorEdit : QColorSwatchEdit
        Widget allowing user to set face color of points.
    line_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
        Button to add lines to shapes layer.
    polyline_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
    ...
    path_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
        Button to add paths to shapes layer.
    polygon_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
        Button to add polygons to shapes layer.
    polygon_lasso_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
        Button to add polygons to shapes layer with a lasso tool.
    rectangle_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
        Button to add rectangles to shapes layer.
    select_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
        Button to select shapes.
    textDispCheckBox : qtpy.QtWidgets.QCheckBox
        Checkbox to control if text should be displayed
    vertex_insert_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
        Button to insert vertex into shape.
    vertex_remove_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
