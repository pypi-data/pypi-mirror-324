...
from finn._qt.dialogs.qt_notification import (
    NapariQtNotification,
    TracebackDialog,
)
from finn._tests.utils import DEFAULT_TIMEOUT_SECS, skip_on_win_ci
...
def test_notification_display(count_show, severity, monkeypatch):
    ...
    NOTE: in finn.utils._tests.test_notification_manager, we already test
    ...
    of finn.utils.notifications.Notification.
