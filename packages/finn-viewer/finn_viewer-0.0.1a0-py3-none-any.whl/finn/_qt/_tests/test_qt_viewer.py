...
from finn._vispy._tests.utils import vispy_image_scene_size
from finn.components.viewer_model import ViewerModel
from finn.layers import Labels, Points
from finn.settings import get_settings
from finn.utils.colormaps import DirectLabelColormap, label_colormap
from finn.utils.interactions import mouse_press_callbacks
from finn.utils.theme import available_themes
...
def test_screenshot_dialog(make_napari_viewer, tmpdir):
    ...
    with (
        mock.patch('finn._qt._qt_viewer.QFileDialog') as mocker,
        mock.patch('finn._qt._qt_viewer.QMessageBox') as mocker2,
    ):
