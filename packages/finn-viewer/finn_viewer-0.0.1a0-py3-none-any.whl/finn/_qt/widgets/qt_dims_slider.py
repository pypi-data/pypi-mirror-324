...
from finn._qt.widgets.qt_scrollbar import ModifiedScrollBar
from finn.settings import get_settings
from finn.settings._constants import LoopMode
from finn.utils.events.event_utils import connect_setattr_value
...
class QtDimSliderWidget(QWidget):
    ...
    def loop_mode(self):
        ...
        Loop mode enumeration finn._qt._constants.LoopMode
    ...
    def loop_mode(self, value):
        ...
        Parameters
        ----------
        value : finn._qt._constants.LoopMode
            Loop mode for animation.
            Available options for the loop mode string enumeration are:
            - LoopMode.ONCE
                Animation will stop once movie reaches the max frame
    ...
    def _update_play_settings(self, fps, loop_mode, frame_range):
        ...
        loop_mode : finn._qt._constants.LoopMode
            Loop mode for animation.
            Available options for the loop mode string enumeration are:
            - LoopMode.ONCE
                Animation will stop once movie reaches the max frame
