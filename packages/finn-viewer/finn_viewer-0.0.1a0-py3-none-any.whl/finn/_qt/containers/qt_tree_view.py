...
from finn._qt.containers._base_item_view import _BaseEventedItemView
...
class QtNodeTreeView(_BaseEventedItemView[NodeType], QTreeView):
    """A QListView for a :class:`~finn.utils.tree.Group`.

    Designed to work with :class:`~finn._qt.containers.QtNodeTreeModel`.

    This class is an adapter between :class:`~finn.utils.tree.Group` and Qt's
