...
from finn._app_model.context import get_context
from finn._qt._qapp_model import build_qmodel_menu
from finn._qt.containers._base_item_model import ItemRole
from finn._qt.containers.qt_layer_model import LoadedRole, ThumbnailRole
from finn._qt.qt_resources import QColoredSVGIcon
from finn.resources import LOADING_GIF_PATH
...
class LayerDelegate(QStyledItemDelegate):
    ...
    :class:`finn._qt.containers.QtLayerList`.  The `QStyledItemDelegate`
