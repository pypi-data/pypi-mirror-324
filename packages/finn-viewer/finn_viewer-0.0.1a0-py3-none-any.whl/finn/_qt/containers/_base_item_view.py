...
class _BaseEventedItemView(Generic[ItemType]):
    ...
    :class:`finn._qt.containers.QtListView` subclass.
    For a nested list-of-lists using the Group/Node classes, use the
    :class:`finn._qt.containers.QtNodeTreeView` subclass.

    For convenience, the :func:`finn._qt.containers.create_view` factory
