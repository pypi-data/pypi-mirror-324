...
class QtNodeTreeModel(_BaseEventedItemModel[NodeType]):
    ...
    Designed to work with :class:`finn.utils.tree.Group` and
    :class:`~finn._qt.containers.QtNodeTreeView`.

    See docstring of :class:`_BaseEventedItemModel` and
    :class:`~finn._qt.containers.QtNodeTreeView` for additional background.
    """
