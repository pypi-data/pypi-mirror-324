...
def mock_app_model():
    ...
    This fixture must be used whenever `finn._app_model.get_app_model()` is called to
...
def make_napari_viewer(
    ...
    To use this fixture as a function in your tests:
        ...
        def test_something_with_a_viewer(make_napari_viewer):
            # `make_napari_viewer` takes any keyword arguments that finn.Viewer() takes
            viewer = make_napari_viewer()

    It accepts all the same arguments as `finn.Viewer`, notably `show`
    ...
    ViewerClass : Type[finn.Viewer], optional
        Override the viewer class being used.  By default, will
        use finn.viewer.Viewer
    ...
    from finn._qt._qapp_model.qactions import init_qactions
