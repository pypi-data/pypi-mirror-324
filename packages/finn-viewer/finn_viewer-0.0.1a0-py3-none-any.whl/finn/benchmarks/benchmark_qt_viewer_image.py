...
class QtViewerViewImageSuite:
    ...
    def time_view_image(self, n):
        ...
        self.viewer = finn.view_image(self.data)
...
class QtViewerSingleInvisbleImageSuite:
    ...
    def setup(self):
        ...
        self.data = np.random.random((128, 128, 128))
        self.new_data = np.random.random((128, 128, 128))
        self.viewer = finn.view_image(self.data, visible=False)
...
class QtImageRenderingSuite:
    ...
    def setup(self, n):
        ...
        self.viewer = finn.view_image(self.data, ndisplay=2)
...
class QtVolumeRenderingSuite:
    ...
    def setup(self, n):
        ...
        self.viewer = finn.view_image(self.data, ndisplay=3)
