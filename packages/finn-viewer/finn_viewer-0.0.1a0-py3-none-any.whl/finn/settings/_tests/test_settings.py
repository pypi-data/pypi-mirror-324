...
from finn.settings import CURRENT_SCHEMA_VERSION, NapariSettings
from finn.utils.theme import get_theme, register_theme


@pytest.fixture
def test_settings(tmp_path):
    """A fixture that can be used to test and save settings"""
    from finn.settings import NapariSettings
