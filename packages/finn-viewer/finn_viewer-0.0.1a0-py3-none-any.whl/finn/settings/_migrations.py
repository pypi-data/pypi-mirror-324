...
def v040_050(model: NapariSettings):
    ...
    e.g. '.csv' becomes '*.csv'
    """
    from finn.settings._utils import _coerce_extensions_to_globs
...
def _swap_ctrl_cmd(keybinding):
    ...
    """
    from finn.utils.key_bindings import KeyBinding
...
def v050_060(model: NapariSettings):
    ...
    The alias problem is solved in `finn.utils.keybindings.coerce_keybinding`
