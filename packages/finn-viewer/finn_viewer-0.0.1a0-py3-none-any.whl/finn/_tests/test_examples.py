...
from finn.utils.notifications import notification_manager
...
EXAMPLE_DIR = Path(finn.__file__).parent.parent / 'examples/'
DEV_EXAMPLE_DIR = Path(finn.__file__).parent.parent / 'examples/dev'
