...
from finn.layers.shapes._shapes_constants import Box, Mode
from finn.layers.shapes._shapes_models import (
    Ellipse,
    Line,
    Path,
    Polygon,
...
from finn.layers.shapes._shapes_utils import point_to_lines
...
if TYPE_CHECKING:
    ...
    from finn.layers.shapes.shapes import Shapes
