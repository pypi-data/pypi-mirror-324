...
from finn.layers.shapes._shape_list import ShapeList
from finn.layers.shapes._shapes_constants import (
    Box,
    ColorMode,
    Mode,
    ShapeType,
...
from finn.layers.shapes._shapes_mouse_bindings import (
    _set_highlight,
    add_ellipse,
    add_line,
    add_path_polygon,
...
from finn.layers.shapes._shapes_utils import (
    create_box,
    extract_shape_type,
...
from finn.layers.utils.color_manager_utils import (
    guess_continuous,
    map_property,
)
from finn.layers.utils.color_transformations import (
...
from finn.layers.utils.layer_utils import _FeatureTable, _unique_element
from finn.layers.utils.text_manager import TextManager
from finn.settings import get_settings
from finn.utils.colormaps import Colormap, ValidColormapArg, ensure_colormap
from finn.utils.colormaps.colormap_utils import ColorType
from finn.utils.colormaps.standardize_color import (
    hex_to_name,
    rgb_to_hex,
    transform_color,
)
...
from finn.utils.misc import ensure_iterable
...
class Shapes(Layer):
    ...
    edge_colormap : str, finn.utils.Colormap
