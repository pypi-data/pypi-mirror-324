...
from finn.layers._scalar_field.scalar_field import ScalarFieldBase
...
from finn.layers.image._slice import _ImageSliceResponse
...
from finn.layers.labels._labels_mouse_bindings import (
...
from finn.utils._dtype import normalize_dtype, vispy_texture_dtype
from finn.utils._indexing import elements_in_slice, index_in_slice
from finn.utils.colormaps import (
    direct_colormap,
    label_colormap,
)
...
from finn.utils.colormaps.colormap_utils import shuffle_and_extend_colormap
from finn.utils.events import EmitterGroup, Event
from finn.utils.events.custom_types import Array
from finn.utils.misc import StringEnum, _is_array_type
...
class Labels(ScalarFieldBase):
    ...
    num_colors : int
        ...
        ``colormap`` directly, using `finn.utils.colormaps.label_colormap`.
    ...
    color : dict of int to str or array
        ...
        `finn.utils.colormaps.DirectLabelColormap`.
    seed : float
        Seed for colormap random generator. DEPRECATED: set ``colormap``
        directly, using `finn.utils.colormaps.label_colormap`.
    opacity : float
    ...
    def __init__(
        ...
        *,
        ...
        from finn.components.overlays.labels_polygon import (
