...
from finn.layers.base._base_constants import (
    BaseProjectionMode,
    Blending,
    Mode,
)
...
from finn.layers.utils.plane import ClippingPlane, ClippingPlaneList
from finn.settings import get_settings
from finn.utils._dask_utils import configure_dask
from finn.utils._magicgui import (
    add_layer_to_viewer,
    add_layers_to_viewer,
    get_layers,
)
from finn.utils.events import EmitterGroup, Event, EventedDict
...
from finn.utils.transforms import Affine, CompositeAffine, TransformChain
...
if TYPE_CHECKING:
    ...
    from finn.components.overlays.base import Overlay
    from finn.layers._source import Source


logger = logging.getLogger('finn.layers.base.base')
    ...
    * `_basename()`: base/default name of the layer
    ...
    def __init__(
        ...
        *,
        ...
        from finn.layers._source import current_source
        ...
        from finn.components.overlays.interaction_box import (
            SelectionBoxOverlay,
            TransformBoxOverlay,
        )
    ...
    def affine(self) -> Affine:
        """finn.utils.transforms.Affine: Extra affine transform to go from physical to world coordinates."""
