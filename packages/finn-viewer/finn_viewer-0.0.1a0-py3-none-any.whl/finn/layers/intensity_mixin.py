...
from finn.utils.status_messages import format_float
from finn.utils.validators import _validate_increasing, validate_n_seq
...
class IntensityVisualizationMixin:
    ...
    @property
    def colormap(self):
        """finn.utils.Colormap: colormap for luminance images."""
