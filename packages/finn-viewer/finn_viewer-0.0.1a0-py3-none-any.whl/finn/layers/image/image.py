...
from finn.layers.image._image_utils import guess_rgb
from finn.layers.image._slice import _ImageSliceResponse
from finn.layers.intensity_mixin import IntensityVisualizationMixin
from finn.layers.utils.layer_utils import calc_data_range
from finn.utils._dtype import get_dtype_limits, normalize_dtype
from finn.utils.colormaps import ensure_colormap
from finn.utils.colormaps.colormap_utils import _coerce_contrast_limits
...
class Image(IntensityVisualizationMixin, ScalarFieldBase):
    ...
    colormap : 2-tuple of str, finn.utils.Colormap
