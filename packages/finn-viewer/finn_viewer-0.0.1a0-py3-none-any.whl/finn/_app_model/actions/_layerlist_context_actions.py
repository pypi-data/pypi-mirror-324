...
from finn._app_model.context import LayerListSelectionContextKeys as LLSCK
from finn.layers import _layer_actions
...
LAYERLIST_CONTEXT_ACTIONS: list[Action] = [
    ...
    Action(
        id='finn.layer.convert_to_labels',
    ...
    Action(
        id='finn.layer.convert_to_image',
    ...
    Action(
        id='finn.layer.toggle_visibility',
    ...
    Action(
        id='finn.layer.unlink_selected_layers',
    ...
    Action(
        id='finn.layer.select_linked_layers',
...
for _dtype in (
    ...
    LAYERLIST_CONTEXT_ACTIONS.append(
        Action(
            id=f'finn.layer.convert_to_{_dtype}',
