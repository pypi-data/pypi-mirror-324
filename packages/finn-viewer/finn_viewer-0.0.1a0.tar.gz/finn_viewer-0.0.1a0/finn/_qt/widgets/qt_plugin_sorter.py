...
from finn._qt.utils import drag_with_pixmap
from finn._qt.widgets.qt_tooltip import QtToolTipLabel
from finn.plugins import plugin_manager as napari_plugin_manager
...
class QtHookImplementationListWidget(QListWidget):
    ...
    :class:`~finn._qt.qt_plugin_sorter.QtPluginSorter`.  Each item in the list
...
class QtPluginSorter(QWidget):
    ...
    plugin_manager : PluginManager, optional
        ...
        ``finn.plugins.plugin_manager`` instance
    parent : QWidget, optional
        Optional parent widget, by default None
