...
from finn._qt.containers.qt_axis_model import AxisList, AxisModel
...
def set_dims_order(dims: Dims, order: tuple[int, ...]):
    ...
    Parameters
    ----------
    dims : finn.components.dims.Dims
        Dims object.
    order : tuple of int
        New dimension order.
    """
...
class QtDimsSorter(QWidget):
    ...
    Attributes
    ----------
    dims : finn.components.Dims
        Dimensions object of the current viewer, modeling slicing and displaying.
    axis_list : finn._qt.containers.qt_axis_model.AxisList
