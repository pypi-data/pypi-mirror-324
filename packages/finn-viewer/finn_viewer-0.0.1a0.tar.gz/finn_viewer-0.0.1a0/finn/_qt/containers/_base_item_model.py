...
class _BaseEventedItemModel(QAbstractItemModel, Generic[ItemType]):
    ...
    :class:`~finn.utils.events.SelectableEventedList` is our pure python
    ...
    :class:`finn._qt.containers.QtListModel` subclass.
    For a nested list-of-lists using the Group/Node classes, use the
    :class:`finn._qt.containers.QtNodeTreeModel` subclass.

    For convenience, the :func:`finn._qt.containers.create_model` factory
    ...
    .. note::
        ...
        :class:`finn._qt.containers.QtListView` or
        :class:`finn._qt.containers.QtNodeTreeView` views, or the
        :func:`finn._qt.containers.create_view` factory function.
