...
class QtListView(_BaseEventedItemView[ItemType], QListView):
    """A QListView for a :class:`~finn.utils.events.SelectableEventedList`.

    Designed to work with :class:`~finn._qt.containers.QtListModel`.

    This class is an adapter between
    :class:`~finn.utils.events.SelectableEventedList` and Qt's
