...
class QtListModel(_BaseEventedItemModel[ItemType]):
    """A QItemModel for a :class:`~finn.utils.events.SelectableEventedList`.

    Designed to work with :class:`~finn._qt.containers.QtListView`.

    See docstring of :class:`_BaseEventedItemModel` and
    :class:`~finn._qt.containers.QtListView` for additional background.
    """
