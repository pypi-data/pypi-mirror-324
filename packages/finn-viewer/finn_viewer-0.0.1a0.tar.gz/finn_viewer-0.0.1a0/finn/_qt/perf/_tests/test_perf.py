...
from finn._qt.perf import qt_performance
from finn._tests.utils import skip_local_popups, skip_on_win_ci
...
v = finn.view_points()
QTimer.singleShot(100, finn._qt.qt_event_loop.quit_app)
finn.run()
"""
...
CONFIG = {
    ...
    'callable_lists': {
        'chunk_loader': [
            'finn.components.experimental.chunk._loader.ChunkLoader.load_request',
            'finn.components.experimental.chunk._loader.ChunkLoader._on_done',
        ]
    },
}
