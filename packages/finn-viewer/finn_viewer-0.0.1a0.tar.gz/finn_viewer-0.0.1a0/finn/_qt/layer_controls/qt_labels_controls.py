...
from finn.layers.labels._labels_utils import get_dtype
from finn.utils import CyclicLabelColormap
from finn.utils._dtype import get_dtype_limits
...
class QtLabelsControls(QtLayerControls):
    ...
    fill_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
    ...
    paint_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
    ...
    pick_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
    ...
    erase_button : finn._qt.widgets.qt_mode_button.QtModeRadioButton
