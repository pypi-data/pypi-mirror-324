...
from finn._qt.layer_controls.qt_colormap_combobox import QtColormapComboBox
from finn._qt.layer_controls.qt_layer_controls_base import QtLayerControls
from finn._qt.utils import qt_signals_blocked
from finn._qt.widgets.qt_range_slider_popup import QRangeSliderPopup
from finn.utils._dtype import normalize_dtype
from finn.utils.colormaps import AVAILABLE_COLORMAPS
from finn.utils.events.event_utils import connect_no_arg, connect_setattr
...
class QtBaseImageControls(QtLayerControls):
    ...
    clim_popup : finn._qt.qt_range_slider_popup.QRangeSliderPopup
