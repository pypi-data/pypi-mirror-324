...
from finn._qt.widgets.qt_mode_buttons import QtModeRadioButton
    ...
    def _radio_button(
        ...
        **kwargs,
        ...
        extra_tooltip_text : str
            ...
            action manager
        **kwargs:
            Passed to finn._qt.widgets.qt_mode_button.QtModeRadioButton

        Returns
        -------
        button: finn._qt.widgets.qt_mode_button.QtModeRadioButton
