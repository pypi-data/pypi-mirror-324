...
from finn._app_model.context import (
...
from finn._qt.widgets.qt_viewer_buttons import add_new_points, add_new_shapes
...
Q_FILE_ACTIONS: list[Action] = [
    Action(
        id='finn.window.file.new_layer.new_labels',
        title=trans._('Labels'),
        callback=new_labels,
        menus=[{'id': MenuId.FILE_NEW_LAYER, 'group': MenuGroup.NAVIGATION}],
    ),
    Action(
        id='finn.window.file.new_layer.new_points',
        title=trans._('Points'),
        callback=new_points,
        menus=[{'id': MenuId.FILE_NEW_LAYER, 'group': MenuGroup.NAVIGATION}],
    ),
    Action(
        id='finn.window.file.new_layer.new_shapes',
        title=trans._('Shapes'),
        callback=new_shapes,
        menus=[{'id': MenuId.FILE_NEW_LAYER, 'group': MenuGroup.NAVIGATION}],
    ),
    Action(
        id='finn.window.file._image_from_clipboard',
    ...
    Action(
        id='finn.window.file.open_files_dialog',
    ...
    Action(
        id='finn.window.file.open_files_as_stack_dialog',
    ...
    Action(
        id='finn.window.file.open_folder_dialog',
    ...
    Action(
        id='finn.window.file._open_files_as_stack_with_plugin',
        title=trans._('Open Files as Stack...'),
        callback=_open_files_as_stack_with_plugin,
        menus=[{'id': MenuId.FILE_OPEN_WITH_PLUGIN, 'group': MenuGroup.OPEN}],
    ),
    Action(
        id='finn.window.file._open_folder_with_plugin',
        title=trans._('Open Folder...'),
        callback=_open_folder_with_plugin,
        menus=[{'id': MenuId.FILE_OPEN_WITH_PLUGIN, 'group': MenuGroup.OPEN}],
    ),
    Action(
        id='finn.window.file.show_preferences_dialog',
    ...
    Action(
        id='finn.window.file.save_layers_dialog.selected',
    ...
    Action(
        id='finn.window.file.save_layers_dialog',
    ...
    Action(
        id='finn.window.file.save_canvas_screenshot_dialog',
    ...
    Action(
        id='finn.window.file.close_dialog',
    ...
    Action(
        id='finn.window.file.quit_dialog',
        title=trans._('Exit'),
        callback=_close_app,
        menus=[{'id': MenuId.MENUBAR_FILE, 'group': MenuGroup.CLOSE}],
