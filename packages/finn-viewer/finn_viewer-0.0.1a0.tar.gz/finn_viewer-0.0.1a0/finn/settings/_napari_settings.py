...
from finn.settings._application import ApplicationSettings
from finn.settings._base import (
    _NOT_SET,
...
from finn.settings._plugins import PluginsSettings
...
class NapariSettings(EventedConfigFileSettings):
    ...
    def _maybe_migrate(self):
        if self.schema_version < CURRENT_SCHEMA_VERSION:
            from finn.settings._migrations import do_migrations
