...
from finn.components.overlays import LabelsPolygonOverlay
from finn.layers import Labels
from finn.layers.labels._labels_constants import Mode
from finn.layers.labels._labels_utils import mouse_event_to_labels_coordinate
