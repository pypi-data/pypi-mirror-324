...
from finn._vispy.layers.image import VispyImageLayer
from finn._vispy.layers.labels import VispyLabelsLayer
from finn._vispy.layers.points import VispyPointsLayer
from finn._vispy.layers.shapes import VispyShapesLayer
from finn._vispy.layers.surface import VispySurfaceLayer
from finn._vispy.layers.tracks import VispyTracksLayer
from finn._vispy.layers.vectors import VispyVectorsLayer
from finn._vispy.overlays.axes import VispyAxesOverlay
from finn._vispy.overlays.base import VispyBaseOverlay
from finn._vispy.overlays.bounding_box import VispyBoundingBoxOverlay
from finn._vispy.overlays.brush_circle import VispyBrushCircleOverlay
...
def create_vispy_layer(layer: Layer) -> VispyBaseLayer:
    ...
    Parameters
    ----------
    layer : finn.layers._base_layer.Layer
...
def create_vispy_overlay(overlay: Overlay, **kwargs) -> VispyBaseOverlay:
    ...
    Parameters
    ----------
    overlay : finn.components.overlays.VispyBaseOverlay
