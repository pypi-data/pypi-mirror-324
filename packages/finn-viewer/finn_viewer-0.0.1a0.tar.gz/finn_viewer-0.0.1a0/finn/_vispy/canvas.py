...
from finn._vispy import VispyCamera
from finn._vispy.utils.cursor import QtCursorVisual
from finn._vispy.utils.gl import get_max_texture_sizes
from finn._vispy.utils.visual import create_vispy_overlay
from finn.components.overlays import CanvasOverlay, SceneOverlay
from finn.utils._proxies import ReadOnlyWrapper
from finn.utils.colormaps.standardize_color import transform_color
from finn.utils.interactions import (
...
if TYPE_CHECKING:
    ...
    from finn._vispy.overlays.base import VispyBaseOverlay
    from finn.components import ViewerModel
    from finn.components.overlays import Overlay
    from finn.layers import Layer
    from finn.utils.events.event import Event
...
class VispyCanvas:
    ...
    Attributes
    ----------
    layer_to_visual : dict(finn.layers, finn._vispy.layers)
    ...
    camera : finn._vispy.VispyCamera
    ...
    _last_theme_color : Optional[npt.NDArray[np.float]]
        ...
        was applied.
    _overlay_to_visual : dict(finn.components.overlays, finn._vispy.overlays)
        A mapping of the napari overlays that are part of the viewer and their corresponding Vispy counterparts.
    _scene_canvas : finn._vispy.canvas.NapariSceneCanvas
    ...
    def _remove_layer(self, event: Event) -> None:
        ...
        Parameters
        ----------
        event : finn.utils.events.event.Event
