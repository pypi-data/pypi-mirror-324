...
def _import_module(
    ...
    Try importing successively longer segments of the target_str. For example:
       finn.components.experimental.chunk._loader.ChunkLoader.load_chunk
    will import:
        napari (success)
        finn.components (success)
        finn.components.experimental (success)
        finn.components.experimental.chunk (success)
        finn.components.experimental.chunk._loader (success)
        finn.components.experimental.chunk._loader.ChunkLoader (failure, not a module)
