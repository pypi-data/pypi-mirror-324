...
from finn.utils.colormaps._accelerated_cmap import minimum_dtype_for_labels
from finn.utils.colormaps.bop_colors import bopd
...
from finn.utils.colormaps.inverse_colormaps import inverse_cmaps
from finn.utils.colormaps.standardize_color import transform_color
from finn.utils.colormaps.vendored import cm
    ...
    with AVAILABLE_COLORMAPS_LOCK:
        if isinstance(colormap, str):
            ...
            if colormap is not None:
                ...
                warnings.warn(
                    trans._(
                        'invalid type for colormap: {cm_type}. Must be a {{str, tuple, dict, finn.utils.Colormap, vispy.colors.Colormap}}. Reverting to default',
                        deferred=True,
