...
def _setup_logging(config: dict) -> None:
    """Log "finn.monitor" messages to the configured file.
...
class Monitor:
    ...
    def start(self) -> bool:
        ...
        from finn.components.experimental.monitor._api import MonitorApi
        from finn.components.experimental.monitor._service import (
            MonitorService,
        )
