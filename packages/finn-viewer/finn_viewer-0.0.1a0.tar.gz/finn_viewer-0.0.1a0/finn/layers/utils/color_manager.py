...
from finn._pydantic_compat import Field, root_validator, validator
...
from finn.utils.colormaps.categorical_colormap import CategoricalColormap
from finn.utils.colormaps.colormap_utils import ColorType, ensure_colormap
...
class ColorManager(EventedModel):
    """A class for controlling the display colors for annotations in finn.
