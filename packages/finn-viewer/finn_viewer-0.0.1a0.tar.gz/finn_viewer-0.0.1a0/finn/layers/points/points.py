...
from finn.layers.base._base_mouse_bindings import (
    highlight_box_handles,
    transform_with_box,
)
from finn.layers.points._points_constants import (
    Mode,
    PointsProjectionMode,
    Shading,
)
from finn.layers.points._points_mouse_bindings import add, highlight, select
from finn.layers.points._points_utils import (
...
from finn.layers.points._slice import _PointSliceRequest, _PointSliceResponse
from finn.layers.utils._color_manager_constants import ColorMode
from finn.layers.utils._slice_input import _SliceInput, _ThickNDSlice
from finn.layers.utils.color_manager import ColorManager
from finn.layers.utils.color_transformations import ColorType
...
from finn.layers.utils.text_manager import TextManager
from finn.utils.colormaps import Colormap, ValidColormapArg
from finn.utils.colormaps.standardize_color import hex_to_name, rgb_to_hex
from finn.utils.events import Event
from finn.utils.events.custom_types import Array
from finn.utils.events.migrations import deprecation_warning_event
from finn.utils.geometry import project_points_onto_plane, rotate_points
from finn.utils.migrations import add_deprecated_property, rename_argument
from finn.utils.status_messages import generate_layer_coords_status
...
class Points(Layer):
    ...
    border_colormap : str, finn.utils.Colormap
    ...
    face_color_cycle : np.ndarray, list
        ...
        categorical attribute is used color the vectors.
    face_colormap : str, finn.utils.Colormap
