...
if TYPE_CHECKING:
    ...
    from finn.types import SampleDict
...
def _safe_register_qt_actions(mf: PluginManifest) -> None:
    ...
    try:
        from finn._qt._qplugins import _register_qt_actions
...
def _npe2_manifest_to_actions(
    ...
    from finn._app_model.constants._menus import is_menu_contributable
