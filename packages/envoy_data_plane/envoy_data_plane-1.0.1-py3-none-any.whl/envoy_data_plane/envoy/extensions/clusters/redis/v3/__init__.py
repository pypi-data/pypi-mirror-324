...
# sources: envoy/extensions/clusters/redis/v3/redis_cluster.proto
...
class RedisClusterConfig(betterproto2.Message):
    ...
    redirect_refresh_threshold: "int | None | None" = betterproto2.field(
    ...
    failure_refresh_threshold: "int" = betterproto2.field(5, betterproto2.TYPE_UINT32)
    """
    ...
    host_degraded_refresh_threshold: "int" = betterproto2.field(
...
default_message_pool.register_message(
    "envoy.extensions.clusters.redis.v3", "RedisClusterConfig", RedisClusterConfig
)
