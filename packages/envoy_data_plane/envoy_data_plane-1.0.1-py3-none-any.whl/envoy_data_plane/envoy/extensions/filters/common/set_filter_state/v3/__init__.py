...
__all__ = (
    "FilterStateValueSharedWithUpstream",
    "FilterStateValue",
)
...
class FilterStateValue(betterproto2.Message):
    ...
    object_key: "str | None" = betterproto2.field(
    ...
    factory_key: "str" = betterproto2.field(6, betterproto2.TYPE_STRING)
    """
    ...
    shared_with_upstream: "FilterStateValueSharedWithUpstream" = betterproto2.field(
        ...
        default_factory=lambda: FilterStateValueSharedWithUpstream.try_value(0),
    )
    """
