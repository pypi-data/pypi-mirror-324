...
class UdpProxyConfigUdpTunnelingConfig(betterproto2.Message):
    ...
    proxy_host: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    ...
    proxy_port: "int | None | None" = betterproto2.field(
    ...
    target_host: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)
    """
    ...
    default_target_port: "int" = betterproto2.field(4, betterproto2.TYPE_UINT32)
    """
    ...
    post_path: "str" = betterproto2.field(6, betterproto2.TYPE_STRING)
    """
...
class UdpProxyConfigUdpTunnelingConfigBufferOptions(betterproto2.Message):
    ...
    max_buffered_datagrams: "int | None | None" = betterproto2.field(
    ...
    max_buffered_bytes: "int | None | None" = betterproto2.field(
...
class UdpProxyConfigUdpTunnelingConfigRetryOptions(betterproto2.Message):
    max_connect_attempts: "int | None | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
