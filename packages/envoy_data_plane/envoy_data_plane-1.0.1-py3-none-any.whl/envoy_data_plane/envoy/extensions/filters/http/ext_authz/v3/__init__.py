...
class ExtAuthz(betterproto2.Message):
    ...
    transport_api_version: "_____config__core__v3__.ApiVersion" = betterproto2.field(
        ...
        default_factory=lambda: _____config__core__v3__.ApiVersion.try_value(0),
    )
    """
    ...
    charge_cluster_response_stats: "bool | None | None" = betterproto2.field(
        20, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
    ...
    enable_dynamic_metadata_ingestion: "bool | None | None" = betterproto2.field(
        27, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
