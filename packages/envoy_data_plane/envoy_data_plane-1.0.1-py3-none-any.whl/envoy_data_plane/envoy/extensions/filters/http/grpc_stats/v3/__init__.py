...
class FilterConfig(betterproto2.Message):
    ...
    individual_method_stats_allowlist: "_____config__core__v3__.GrpcMethodList | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, optional=True, group="per_method_stat_specifier"
    )
    """
    ...
    stats_for_all_methods: "bool | None | None" = betterproto2.field(
        3,
    ...
    enable_upstream_stats: "bool" = betterproto2.field(4, betterproto2.TYPE_BOOL)
    """
    ...
    replace_dots_in_grpc_service_name: "bool" = betterproto2.field(
...
default_message_pool.register_message(
    "envoy.extensions.filters.http.grpc_stats.v3", "FilterConfig", FilterConfig
)
...
default_message_pool.register_message(
    "envoy.extensions.filters.http.grpc_stats.v3", "FilterObject", FilterObject
)
