...
class Gzip(betterproto2.Message):
    ...
    memory_level: "int | None | None" = betterproto2.field(
    ...
    compression_level: "GzipCompressionLevelEnum" = betterproto2.field(
        ...
        default_factory=lambda: GzipCompressionLevelEnum.try_value(0),
    )
    """
    ...
    compression_strategy: "GzipCompressionStrategy" = betterproto2.field(
        4,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: GzipCompressionStrategy.try_value(0),
    )
    """
    ...
    window_bits: "int | None | None" = betterproto2.field(
    ...
    chunk_size: "int | None | None" = betterproto2.field(
