...
class OAuth2Config(betterproto2.Message):
    ...
    authorization_endpoint: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
    ...
    redirect_uri: "str" = betterproto2.field(4, betterproto2.TYPE_STRING)
    """
    ...
    auth_scopes: "list[str]" = betterproto2.field(
    ...
    resources: "list[str]" = betterproto2.field(
    ...
    auth_type: "OAuth2ConfigAuthType" = betterproto2.field(
        ...
        default_factory=lambda: OAuth2ConfigAuthType.try_value(0),
    )
    """
    ...
    use_refresh_token: "bool | None | None" = betterproto2.field(
...
class OAuth2Credentials(betterproto2.Message):
    ...
    cookie_domain: "str" = betterproto2.field(5, betterproto2.TYPE_STRING)
    """
...
class OAuth2CredentialsCookieNames(betterproto2.Message):
    ...
    bearer_token: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    ...
    oauth_hmac: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
    Cookie name to hold OAuth HMAC value. Defaults to ``OauthHMAC``.
    """

    oauth_expires: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)
    """
    Cookie name to hold OAuth expiry value. Defaults to ``OauthExpires``.
    """

    id_token: "str" = betterproto2.field(4, betterproto2.TYPE_STRING)
    """
    Cookie name to hold the id token. Defaults to ``IdToken``.
    """

    refresh_token: "str" = betterproto2.field(5, betterproto2.TYPE_STRING)
    """
    Cookie name to hold the refresh token. Defaults to ``RefreshToken``.
    """

    oauth_nonce: "str" = betterproto2.field(6, betterproto2.TYPE_STRING)
    """
