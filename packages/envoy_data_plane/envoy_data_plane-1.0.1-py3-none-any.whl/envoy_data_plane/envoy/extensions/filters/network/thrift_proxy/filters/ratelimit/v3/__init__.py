...
class RateLimit(betterproto2.Message):
    ...
    rate_limit_service: "_______config__ratelimit__v3__.RateLimitServiceConfig | None" = betterproto2.field(
...
from ........config.ratelimit import v3 as _______config__ratelimit__v3__
