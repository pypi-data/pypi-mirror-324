...
class RedisProxyConnectionRateLimit(betterproto2.Message):
    ...
    connection_rate_limit_per_sec: "int" = betterproto2.field(
...
class RedisProxyConnPoolSettings(betterproto2.Message):
    ...
    * '{user1000}.following' and '{user1001}.following' **might** be sent to the same upstream
    ...
    max_buffer_size_before_flush: "int" = betterproto2.field(
    ...
    max_upstream_unknown_connections: "int | None | None" = betterproto2.field(
    ...
    read_policy: "RedisProxyConnPoolSettingsReadPolicy" = betterproto2.field(
        ...
        default_factory=lambda: RedisProxyConnPoolSettingsReadPolicy.try_value(0),
    )
    """
...
class RedisProxyPrefixRoutesRoute(betterproto2.Message):
    ...
    prefix: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    ...
    cluster: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)
    """
    ...
    key_formatter: "str" = betterproto2.field(5, betterproto2.TYPE_STRING)
    """
...
class RedisProxyRedisFault(betterproto2.Message):
    ...
    fault_type: "RedisProxyRedisFaultRedisFaultType" = betterproto2.field(
        1,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: RedisProxyRedisFaultRedisFaultType.try_value(0),
    )
    """
    Fault type.
    """
    ...
    commands: "list[str]" = betterproto2.field(
