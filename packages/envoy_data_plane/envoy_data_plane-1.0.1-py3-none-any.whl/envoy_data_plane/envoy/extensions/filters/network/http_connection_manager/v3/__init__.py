...
class HttpConnectionManager(betterproto2.Message):
    ...
    codec_type: "HttpConnectionManagerCodecType" = betterproto2.field(
        ...
        default_factory=lambda: HttpConnectionManagerCodecType.try_value(0),
    )
    """
    ...
    add_user_agent: "bool | None | None" = betterproto2.field(
    ...
    server_name: "str" = betterproto2.field(10, betterproto2.TYPE_STRING)
    """
    An optional override that the connection manager will write to the server
    header in responses. If not set, the default is ``envoy``.
    """

    server_header_transformation: "HttpConnectionManagerServerHeaderTransformation" = betterproto2.field(
        34,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: HttpConnectionManagerServerHeaderTransformation.try_value(
            0
        ),
    )
    """
    ...
    max_request_headers_kb: "int | None | None" = betterproto2.field(
        29, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    use_remote_address: "bool | None | None" = betterproto2.field(
    ...
    xff_num_trusted_hops: "int" = betterproto2.field(19, betterproto2.TYPE_UINT32)
    """
    ...
    via: "str" = betterproto2.field(22, betterproto2.TYPE_STRING)
    """
    Via header value to append to request and response headers. If this is
    empty, no via header will be appended.
    """

    generate_request_id: "bool | None | None" = betterproto2.field(
        15, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
    ...
    forward_client_cert_details: "HttpConnectionManagerForwardClientCertDetails" = betterproto2.field(
        16,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: HttpConnectionManagerForwardClientCertDetails.try_value(
            0
        ),
    )
    """
    ...
    normalize_path: "bool | None | None" = betterproto2.field(
        30, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
    ...
    path_with_escaped_slashes_action: "HttpConnectionManagerPathWithEscapedSlashesAction" = betterproto2.field(
        45,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: HttpConnectionManagerPathWithEscapedSlashesAction.try_value(
            0
        ),
    )
    """
    ...
    stream_error_on_invalid_http_message: "bool | None | None" = betterproto2.field(
        40, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
    ...
    add_proxy_protocol_connection_state: "bool | None | None" = betterproto2.field(
        53, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
...
class HttpConnectionManagerProxyStatusConfig(betterproto2.Message):
    ...
    literal_proxy_name: "str | None" = betterproto2.field(
...
class HttpConnectionManagerSetCurrentClientCertDetails(betterproto2.Message):
    ...
    subject: "bool | None | None" = betterproto2.field(
...
class HttpConnectionManagerTracing(betterproto2.Message):
    ...
    max_path_tag_length: "int | None | None" = betterproto2.field(
    ...
    spawn_upstream_span: "bool | None | None" = betterproto2.field(
        10, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
...
class HttpConnectionManagerUpgradeConfig(betterproto2.Message):
    ...
    enabled: "bool | None | None" = betterproto2.field(
        3, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
...
class ResponseMapper(betterproto2.Message):
    ...
    status_code: "int | None | None" = betterproto2.field(
...
class ScopedRds(betterproto2.Message):
    ...
    srds_resources_locator: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
...
class ScopedRoutesScopeKeyBuilderFragmentBuilderHeaderValueExtractor(
    ...
    element_separator: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
...
class ScopedRoutesScopeKeyBuilderFragmentBuilderHeaderValueExtractorKvElement(
    ...
    separator: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
