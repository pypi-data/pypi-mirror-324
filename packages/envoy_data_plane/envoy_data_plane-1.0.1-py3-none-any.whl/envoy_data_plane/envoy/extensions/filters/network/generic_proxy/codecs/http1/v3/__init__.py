...
# sources: envoy/extensions/filters/network/generic_proxy/codecs/http1/v3/http1.proto
# plugin: python-betterproto2
# This file has been @generated

__all__ = ("Http1CodecConfig",)
...
class Http1CodecConfig(betterproto2.Message):
    """
    ...
    single_frame_mode: "bool | None | None" = betterproto2.field(
    ...
    max_buffer_size: "int | None | None" = betterproto2.field(
