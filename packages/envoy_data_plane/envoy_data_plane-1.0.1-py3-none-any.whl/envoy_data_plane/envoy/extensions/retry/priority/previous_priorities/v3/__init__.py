...
# sources: envoy/extensions/retry/priority/previous_priorities/v3/previous_priorities_config.proto
...
class PreviousPrioritiesConfig(betterproto2.Message):
    ...
    update_frequency: "int" = betterproto2.field(1, betterproto2.TYPE_INT32)
    """
