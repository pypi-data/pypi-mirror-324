...
# sources: envoy/extensions/load_balancing_policies/subset/v3/subset.proto
# plugin: python-betterproto2
# This file has been @generated

__all__ = (
    "SubsetLbSubsetFallbackPolicy",
    "SubsetLbSubsetMetadataFallbackPolicy",
    "SubsetLbSubsetSelectorLbSubsetSelectorFallbackPolicy",
    "Subset",
    "SubsetLbSubsetSelector",
)
...
class SubsetLbSubsetFallbackPolicy(betterproto2.Enum):
    """
...
class SubsetLbSubsetMetadataFallbackPolicy(betterproto2.Enum):
...
class SubsetLbSubsetSelectorLbSubsetSelectorFallbackPolicy(betterproto2.Enum):
    """
...
class Subset(betterproto2.Message):
    """
    ...
    fallback_policy: "SubsetLbSubsetFallbackPolicy" = betterproto2.field(
        1,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: SubsetLbSubsetFallbackPolicy.try_value(0),
    )
    """
    ...
    default_subset: "_____google__protobuf__.Struct | None" = betterproto2.field(
    ...
    subset_selectors: "list[SubsetLbSubsetSelector]" = betterproto2.field(
    ...
    allow_redundant_keys: "bool" = betterproto2.field(10, betterproto2.TYPE_BOOL)
    """
    ...
    metadata_fallback_policy: "SubsetLbSubsetMetadataFallbackPolicy" = (
        betterproto2.field(
            8,
            betterproto2.TYPE_ENUM,
            default_factory=lambda: SubsetLbSubsetMetadataFallbackPolicy.try_value(0),
        )
    )
    """
    ...
    subset_lb_policy: "____config__cluster__v3__.LoadBalancingPolicy | None" = (
...
default_message_pool.register_message(
    "envoy.extensions.load_balancing_policies.subset.v3", "Subset", Subset
)


@dataclass(eq=False, repr=False)
class SubsetLbSubsetSelector(betterproto2.Message):
    """
    ...
    fallback_policy: "SubsetLbSubsetSelectorLbSubsetSelectorFallbackPolicy" = betterproto2.field(
        2,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: SubsetLbSubsetSelectorLbSubsetSelectorFallbackPolicy.try_value(
            0
        ),
    )
    """
