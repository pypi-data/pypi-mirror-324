...
class FileSystemHttpCacheConfig(betterproto2.Message):
    ...
    cache_path: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
    ...
    max_cache_size_bytes: "int | None | None" = betterproto2.field(
    ...
    max_individual_cache_entry_size_bytes: "int | None | None" = betterproto2.field(
    ...
    max_cache_entry_count: "int | None | None" = betterproto2.field(
        5, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT64, optional=True
    )
    """
    ...
    cache_subdivisions: "int" = betterproto2.field(6, betterproto2.TYPE_UINT32)
    """
    ...
    evict_fraction: "float" = betterproto2.field(7, betterproto2.TYPE_FLOAT)
    """
