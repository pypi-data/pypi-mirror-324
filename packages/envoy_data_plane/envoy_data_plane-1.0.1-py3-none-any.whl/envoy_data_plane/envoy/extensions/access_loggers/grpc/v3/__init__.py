...
class CommonGrpcAccessLogConfig(betterproto2.Message):
    ...
    log_name: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    ...
    transport_api_version: "____config__core__v3__.ApiVersion" = betterproto2.field(
        ...
        default_factory=lambda: ____config__core__v3__.ApiVersion.try_value(0),
    )
    """
    ...
    buffer_size_bytes: "int | None | None" = betterproto2.field(
    ...
    filter_state_objects_to_log: "list[str]" = betterproto2.field(
...
class HttpGrpcAccessLogConfig(betterproto2.Message):
    ...
    additional_request_headers_to_log: "list[str]" = betterproto2.field(
    ...
    additional_response_headers_to_log: "list[str]" = betterproto2.field(
    ...
    additional_response_trailers_to_log: "list[str]" = betterproto2.field(
