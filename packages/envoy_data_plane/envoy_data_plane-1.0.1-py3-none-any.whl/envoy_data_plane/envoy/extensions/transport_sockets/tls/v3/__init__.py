...
class CertificateValidationContext(betterproto2.Message):
    ...
    require_signed_certificate_timestamp: "bool | None | None" = betterproto2.field(
    ...
    trust_chain_verification: "CertificateValidationContextTrustChainVerification" = betterproto2.field(
        10,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: CertificateValidationContextTrustChainVerification.try_value(
            0
        ),
    )
    """
    ...
    max_verify_depth: "int | None | None" = betterproto2.field(
...
class DownstreamTlsContext(betterproto2.Message):
    ...
    require_client_certificate: "bool | None | None" = betterproto2.field(
    ...
    require_sni: "bool | None | None" = betterproto2.field(
    ...
    ocsp_staple_policy: "DownstreamTlsContextOcspStaplePolicy" = betterproto2.field(
        8,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: DownstreamTlsContextOcspStaplePolicy.try_value(0),
    )
    """
    ...
    full_scan_certs_on_sni_mismatch: "bool | None | None" = betterproto2.field(
...
class SubjectAltNameMatcher(betterproto2.Message):
    ...
    san_type: "SubjectAltNameMatcherSanType" = betterproto2.field(
        1,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: SubjectAltNameMatcherSanType.try_value(0),
    )
    """
...
class TlsParameters(betterproto2.Message):
    ...
    tls_minimum_protocol_version: "TlsParametersTlsProtocol" = betterproto2.field(
        1,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: TlsParametersTlsProtocol.try_value(0),
    )
    """
...
class UpstreamTlsContext(betterproto2.Message):
    ...
    max_session_keys: "int | None | None" = betterproto2.field(
    ...
    enforce_rsa_key_usage: "bool | None | None" = betterproto2.field(
        5, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
