...
class OutlierDetectionEvent(betterproto2.Message):
    ...
    type: "OutlierEjectionType" = betterproto2.field(
        ...
        default_factory=lambda: OutlierEjectionType.try_value(0),
    )
    """
    ...
    secs_since_last_action: "int | None | None" = betterproto2.field(
        3, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT64, optional=True
    )
    """
    The time in seconds since the last action (either an ejection or unejection) took place.
    """

    cluster_name: "str" = betterproto2.field(4, betterproto2.TYPE_STRING)
    """
    The :ref:`cluster <envoy_api_msg_Cluster>` that owns the ejected host.
    """

    upstream_url: "str" = betterproto2.field(5, betterproto2.TYPE_STRING)
    """
    The URL of the ejected host. E.g., ``tcp://1.2.3.4:80``.
    """

    action: "Action" = betterproto2.field(
        6, betterproto2.TYPE_ENUM, default_factory=lambda: Action.try_value(0)
    )
    """
    The action that took place.
    """

    num_ejections: "int" = betterproto2.field(7, betterproto2.TYPE_UINT32)
    """
...
default_message_pool.register_message(
    "envoy.data.cluster.v2alpha", "OutlierDetectionEvent", OutlierDetectionEvent
)
...
default_message_pool.register_message(
    "envoy.data.cluster.v2alpha", "OutlierEjectConsecutive", OutlierEjectConsecutive
)


@dataclass(eq=False, repr=False)
class OutlierEjectFailurePercentage(betterproto2.Message):
    host_success_rate: "int" = betterproto2.field(1, betterproto2.TYPE_UINT32)
    """
...
class OutlierEjectSuccessRate(betterproto2.Message):
    ...
    cluster_average_success_rate: "int" = betterproto2.field(
    ...
    cluster_success_rate_ejection_threshold: "int" = betterproto2.field(
...
default_message_pool.register_message(
    "envoy.data.cluster.v2alpha", "OutlierEjectSuccessRate", OutlierEjectSuccessRate
)
