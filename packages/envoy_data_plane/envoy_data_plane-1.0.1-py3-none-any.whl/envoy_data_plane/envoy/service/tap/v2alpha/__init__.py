...
class OutputConfig(betterproto2.Message):
    ...
    max_buffered_rx_bytes: "int | None | None" = betterproto2.field(
    ...
    max_buffered_tx_bytes: "int | None | None" = betterproto2.field(
...
class OutputSink(betterproto2.Message):
    ...
    format: "OutputSinkFormat" = betterproto2.field(
        1, betterproto2.TYPE_ENUM, default_factory=lambda: OutputSinkFormat.try_value(0)
    )
    """
    Sink output format.
    """
