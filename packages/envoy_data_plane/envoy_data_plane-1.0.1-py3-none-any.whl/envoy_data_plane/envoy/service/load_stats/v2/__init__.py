...
class LoadStatsRequest(betterproto2.Message):
    ...
    cluster_stats: "list[___api__v2__endpoint__.ClusterStats]" = betterproto2.field(
...
default_message_pool.register_message(
    "envoy.service.load_stats.v2", "LoadStatsRequest", LoadStatsRequest
)
...
default_message_pool.register_message(
    "envoy.service.load_stats.v2", "LoadStatsResponse", LoadStatsResponse
)


class LoadReportingServiceStub(betterproto2.ServiceStub):
    """
