...
default_message_pool.register_message("envoy.type.tracing.v2", "CustomTag", CustomTag)
...
class CustomTagEnvironment(betterproto2.Message):
    ...
    default_value: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
...
default_message_pool.register_message(
    "envoy.type.tracing.v2", "CustomTag.Environment", CustomTagEnvironment
)
...
default_message_pool.register_message(
    "envoy.type.tracing.v2", "CustomTag.Header", CustomTagHeader
)
...
default_message_pool.register_message(
    "envoy.type.tracing.v2", "CustomTag.Literal", CustomTagLiteral
)
...
class CustomTagMetadata(betterproto2.Message):
    ...
    kind: "__metadata__v2__.MetadataKind | None" = betterproto2.field(
    ...
    metadata_key: "__metadata__v2__.MetadataKey | None" = betterproto2.field(
...
default_message_pool.register_message(
    "envoy.type.tracing.v2", "CustomTag.Metadata", CustomTagMetadata
)


from ...metadata import v2 as __metadata__v2__
