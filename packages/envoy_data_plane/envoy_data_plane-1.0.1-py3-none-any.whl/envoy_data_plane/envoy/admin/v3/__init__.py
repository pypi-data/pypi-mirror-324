...
class CertificateDetails(betterproto2.Message):
    ...
    serial_number: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
    ...
    days_until_expiration: "int" = betterproto2.field(4, betterproto2.TYPE_UINT64)
    """
...
class ClustersConfigDumpDynamicCluster(betterproto2.Message):
    ...
    client_status: "ClientResourceStatus" = betterproto2.field(
        ...
        default_factory=lambda: ClientResourceStatus.try_value(0),
    )
    """
...
class ClusterStatus(betterproto2.Message):
    ...
    observability_name: "str" = betterproto2.field(7, betterproto2.TYPE_STRING)
    """
    Observability name of the cluster.
    """

    eds_service_name: "str" = betterproto2.field(8, betterproto2.TYPE_STRING)
    """
...
class CommandLineOptions(betterproto2.Message):
    ...
    base_id: "int" = betterproto2.field(1, betterproto2.TYPE_UINT64)
    """
    ...
    base_id_path: "str" = betterproto2.field(32, betterproto2.TYPE_STRING)
    """
    See :option:`--base-id-path` for details.
    """

    concurrency: "int" = betterproto2.field(2, betterproto2.TYPE_UINT32)
    """
    See :option:`--concurrency` for details.
    """

    config_path: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)
    """
    See :option:`--config-path` for details.
    """

    config_yaml: "str" = betterproto2.field(4, betterproto2.TYPE_STRING)
    """
    ...
    admin_address_path: "str" = betterproto2.field(6, betterproto2.TYPE_STRING)
    """
    ...
    local_address_ip_version: "CommandLineOptionsIpVersion" = betterproto2.field(
        7,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: CommandLineOptionsIpVersion.try_value(0),
    )
    """
    See :option:`--local-address-ip-version` for details.
    """

    log_level: "str" = betterproto2.field(8, betterproto2.TYPE_STRING)
    """
    See :option:`--log-level` for details.
    """

    component_log_level: "str" = betterproto2.field(9, betterproto2.TYPE_STRING)
    """
    See :option:`--component-log-level` for details.
    """

    log_format: "str" = betterproto2.field(10, betterproto2.TYPE_STRING)
    """
    ...
    log_path: "str" = betterproto2.field(11, betterproto2.TYPE_STRING)
    """
    See :option:`--log-path` for details.
    """

    service_cluster: "str" = betterproto2.field(13, betterproto2.TYPE_STRING)
    """
    See :option:`--service-cluster` for details.
    """

    service_node: "str" = betterproto2.field(14, betterproto2.TYPE_STRING)
    """
    See :option:`--service-node` for details.
    """

    service_zone: "str" = betterproto2.field(15, betterproto2.TYPE_STRING)
    """
    ...
    drain_strategy: "CommandLineOptionsDrainStrategy" = betterproto2.field(
        33,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: CommandLineOptionsDrainStrategy.try_value(0),
    )
    """
    ...
    mode: "CommandLineOptionsMode" = betterproto2.field(
        19,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: CommandLineOptionsMode.try_value(0),
    )
    """
    ...
    restart_epoch: "int" = betterproto2.field(24, betterproto2.TYPE_UINT32)
    """
    ...
    disabled_extensions: "list[str]" = betterproto2.field(
    ...
    socket_path: "str" = betterproto2.field(35, betterproto2.TYPE_STRING)
    """
    See :option:`--socket-path` for details.
    """

    socket_mode: "int" = betterproto2.field(36, betterproto2.TYPE_UINT32)
    """
    ...
    stats_tag: "list[str]" = betterproto2.field(
...
class HostHealthStatus(betterproto2.Message):
    ...
    eds_health_status: "__config__core__v3__.HealthStatus" = betterproto2.field(
        3,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: __config__core__v3__.HealthStatus.try_value(0),
    )
    """
...
class HostStatus(betterproto2.Message):
    ...
    hostname: "str" = betterproto2.field(6, betterproto2.TYPE_STRING)
    """
    The hostname of the host, if applicable.
    """

    priority: "int" = betterproto2.field(7, betterproto2.TYPE_UINT32)
    """
...
class Memory(betterproto2.Message):
    ...
    allocated: "int" = betterproto2.field(1, betterproto2.TYPE_UINT64)
    """
    The number of bytes allocated by the heap for Envoy. This is an alias for
    ``generic.current_allocated_bytes``.
    """

    heap_size: "int" = betterproto2.field(2, betterproto2.TYPE_UINT64)
    """
    The number of bytes reserved by the heap but not necessarily allocated. This is an alias for
    ``generic.heap_size``.
    """

    pageheap_unmapped: "int" = betterproto2.field(3, betterproto2.TYPE_UINT64)
    """
    ...
    pageheap_free: "int" = betterproto2.field(4, betterproto2.TYPE_UINT64)
    """
    ...
    total_thread_cache: "int" = betterproto2.field(5, betterproto2.TYPE_UINT64)
    """
    The amount of memory used by the TCMalloc thread caches (for small objects). This is an alias
    for ``tcmalloc.current_total_thread_cache_bytes``.
    """

    total_physical_bytes: "int" = betterproto2.field(6, betterproto2.TYPE_UINT64)
    """
...
class MutexStats(betterproto2.Message):
    ...
    *NB*: The wait cycles below are measured by ``absl::base_internal::CycleClock``, and may not
    ...
    num_contentions: "int" = betterproto2.field(1, betterproto2.TYPE_UINT64)
    """
    The number of individual mutex contentions which have occurred since startup.
    """

    current_wait_cycles: "int" = betterproto2.field(2, betterproto2.TYPE_UINT64)
    """
    The length of the current contention wait cycle.
    """

    lifetime_wait_cycles: "int" = betterproto2.field(3, betterproto2.TYPE_UINT64)
    """
...
class ScopedRoutesConfigDumpDynamicScopedRouteConfigs(betterproto2.Message):
    ...
    version_info: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
    This is the per-resource version information. This version is currently taken from the
    :ref:`version_info <envoy_v3_api_field_service.discovery.v3.DiscoveryResponse.version_info>` field at the time that
...
class ServerInfo(betterproto2.Message):
    ...
    state: "ServerInfoState" = betterproto2.field(
        2, betterproto2.TYPE_ENUM, default_factory=lambda: ServerInfoState.try_value(0)
    )
    """
    State of the server.
    """
    ...
    hot_restart_version: "str" = betterproto2.field(5, betterproto2.TYPE_STRING)
    """
    Hot restart version.
    """
...
class SimpleMetric(betterproto2.Message):
    ...
    type: "SimpleMetricType" = betterproto2.field(
        1, betterproto2.TYPE_ENUM, default_factory=lambda: SimpleMetricType.try_value(0)
    )
    """
...
class UnreadyTargetsDumpsUnreadyTargetsDump(betterproto2.Message):
    ...
    target_names: "list[str]" = betterproto2.field(
...
class UpdateFailureState(betterproto2.Message):
    ...
    version_info: "str" = betterproto2.field(4, betterproto2.TYPE_STRING)
    """
