...
class ClusterLoadAssignmentPolicy(betterproto2.Message):
    ...
    overprovisioning_factor: "int | None | None" = betterproto2.field(
...
class Listener(betterproto2.Message):
    ...
    use_original_dst: "bool | None | None" = betterproto2.field(
    ...
    drain_type: "ListenerDrainType" = betterproto2.field(
        8,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ListenerDrainType.try_value(0),
    )
    """
    ...
    transparent: "bool | None | None" = betterproto2.field(
    ...
    *iptables* *TPROXY* target, in which case the original source and destination addresses and
    ...
    freebind: "bool | None | None" = betterproto2.field(
        11, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
    ...
    tcp_fast_open_queue_length: "int | None | None" = betterproto2.field(
        12, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    traffic_direction: "core.TrafficDirection" = betterproto2.field(
        16,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: core.TrafficDirection.try_value(0),
    )
    """
...
class ListenerDeprecatedV1(betterproto2.Message):
    ...
    bind_to_port: "bool | None | None" = betterproto2.field(
...
class EndpointDiscoveryServiceStub(betterproto2.ServiceStub):
    """
    [#protodoc-title: EDS]
    Endpoint discovery :ref:`architecture overview <arch_overview_service_discovery_types_eds>`
    """
...
class ListenerDiscoveryServiceStub(betterproto2.ServiceStub):
    """
