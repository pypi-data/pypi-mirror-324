...
class CorsPolicy(betterproto2.Message):
    ...
    allow_origin: "list[str]" = betterproto2.field(
    ...
    allow_origin_regex: "list[str]" = betterproto2.field(
...
class HeaderMatcher(betterproto2.Message):
    ...
    regex_match: "str | None" = betterproto2.field(
...
class QueryParameterMatcher(betterproto2.Message):
    ...
    *path*'s query string.
    ...
    regex: "bool | None | None" = betterproto2.field(
...
class RouteAction(betterproto2.Message):
    ...
    * The pattern ``(?i)/xxx/`` paired with a substitution string of ``/yyy/``
    ...
    host_rewrite: "str | None" = betterproto2.field(
    ...
    auto_host_rewrite_header: "str | None" = betterproto2.field(
...
class VirtualCluster(betterproto2.Message):
    ...
    * The regex ``/rides/\d+`` does not match the path */rides/123/456*
    ...
    method: "_core__.RequestMethod" = betterproto2.field(
        3,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: _core__.RequestMethod.try_value(0),
    )
    """
