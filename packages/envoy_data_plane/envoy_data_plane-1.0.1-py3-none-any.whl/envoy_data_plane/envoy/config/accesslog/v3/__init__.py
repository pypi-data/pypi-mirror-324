...
class ComparisonFilter(betterproto2.Message):
    ...
    op: "ComparisonFilterOp" = betterproto2.field(
        ...
        default_factory=lambda: ComparisonFilterOp.try_value(0),
    )
    """
    Comparison operator.
    """
...
class MetadataFilter(betterproto2.Message):
    ...
    match_if_key_not_found: "bool | None | None" = betterproto2.field(
...
class ResponseFlagFilter(betterproto2.Message):
    ...
    flags: "list[str]" = betterproto2.field(1, betterproto2.TYPE_STRING, repeated=True)
    """
...
class RuntimeFilter(betterproto2.Message):
    ...
    runtime_key: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
