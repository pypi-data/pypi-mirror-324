...
class RateLimit(betterproto2.Message):
    ...
    descriptors: "list[_____api__v2__ratelimit__.RateLimitDescriptor]" = (
...
default_message_pool.register_message(
    "envoy.config.filter.network.rate_limit.v2", "RateLimit", RateLimit
)


from ......api.v2 import ratelimit as _____api__v2__ratelimit__
