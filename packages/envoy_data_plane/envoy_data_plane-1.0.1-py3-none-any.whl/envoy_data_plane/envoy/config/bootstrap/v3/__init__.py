...
class Admin(betterproto2.Message):
    ...
    access_log_path: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
...
class Bootstrap(betterproto2.Message):
    ...
    node_context_params: "list[str]" = betterproto2.field(
    ...
    flags_path: "str" = betterproto2.field(5, betterproto2.TYPE_STRING)
    """
    ...
    header_prefix: "str" = betterproto2.field(18, betterproto2.TYPE_STRING)
    """
    ...
    stats_server_version_override: "int | None | None" = betterproto2.field(
        19, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT64, optional=True
    )
    """
    ...
    default_socket_interface: "str" = betterproto2.field(24, betterproto2.TYPE_STRING)
    """
    ...
    perf_tracing_file_path: "str" = betterproto2.field(33, betterproto2.TYPE_STRING)
    """
...
class BootstrapDynamicResources(betterproto2.Message):
    ...
    lds_resources_locator: "str" = betterproto2.field(5, betterproto2.TYPE_STRING)
    """
    ...
    cds_resources_locator: "str" = betterproto2.field(6, betterproto2.TYPE_STRING)
    """
...
class ClusterManager(betterproto2.Message):
    ...
    local_cluster_name: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
...
class CustomInlineHeader(betterproto2.Message):
    ...
    inline_header_name: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    ...
    inline_header_type: "CustomInlineHeaderInlineHeaderType" = betterproto2.field(
        ...
        default_factory=lambda: CustomInlineHeaderInlineHeaderType.try_value(0),
    )
    """
...
class MemoryAllocatorManager(betterproto2.Message):
    bytes_to_release: "int" = betterproto2.field(1, betterproto2.TYPE_UINT64)
    """
...
class Runtime(betterproto2.Message):
    ...
    symlink_root: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    ...
    subdirectory: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
    ...
    override_subdirectory: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)
    """
...
class RuntimeLayerDiskLayer(betterproto2.Message):
    ...
    subdirectory: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)
    """
    Specifies the subdirectory to load within the root directory. This is
    useful if multiple systems share the same delivery mechanism. Envoy
    configuration elements can be contained in a dedicated subdirectory.
...
class WatchdogWatchdogAction(betterproto2.Message):
    ...
    event: "WatchdogWatchdogActionWatchdogEvent" = betterproto2.field(
        2,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: WatchdogWatchdogActionWatchdogEvent.try_value(0),
    )
