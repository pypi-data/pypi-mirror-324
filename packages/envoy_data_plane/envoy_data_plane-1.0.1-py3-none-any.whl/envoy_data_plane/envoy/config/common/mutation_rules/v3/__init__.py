...
class HeaderMutationRules(betterproto2.Message):
    ...
    * ``:method``
    ...
    allow_all_routing: "bool | None | None" = betterproto2.field(
    ...
    allow_envoy: "bool | None | None" = betterproto2.field(
    ...
    disallow_system: "bool | None | None" = betterproto2.field(
    ...
    disallow_all: "bool | None | None" = betterproto2.field(
    ...
    disallow_is_error: "bool | None | None" = betterproto2.field(
