...
class LbEndpoint(betterproto2.Message):
    ...
    health_status: "__core__v3__.HealthStatus" = betterproto2.field(
        ...
        default_factory=lambda: __core__v3__.HealthStatus.try_value(0),
    )
    """
    ...
    load_balancing_weight: "int | None | None" = betterproto2.field(
...
class LocalityLbEndpoints(betterproto2.Message):
    ...
    Oneofs:
        - lb_config: [#not-implemented-hide:]
    """
    ...
    proximity: "int | None | None" = betterproto2.field(
