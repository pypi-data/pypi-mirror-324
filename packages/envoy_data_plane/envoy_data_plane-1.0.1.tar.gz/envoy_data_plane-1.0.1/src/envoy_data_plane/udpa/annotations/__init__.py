...
class FieldMigrateAnnotation(betterproto2.Message):
    rename: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    Rename the field in next version.
    """

    oneof_promotion: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
...
class FileMigrateAnnotation(betterproto2.Message):
    move_to_package: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
...
class StatusAnnotation(betterproto2.Message):
    ...
    package_version_status: "PackageVersionStatus" = betterproto2.field(
        ...
        default_factory=lambda: PackageVersionStatus.try_value(0),
    )
    """
...
class VersioningAnnotation(betterproto2.Message):
    previous_message_type: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
