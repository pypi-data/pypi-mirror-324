...
class ClientConfig(betterproto2.Message):
    ...
    max_cache_size: "int | None | None" = betterproto2.field(
...
class OpenCensusConfig(betterproto2.Message):
    ...
    stackdriver_grpc_service: "__core__v3__.GrpcService | None" = betterproto2.field(
    ...
    ocagent_grpc_service: "__core__v3__.GrpcService | None" = betterproto2.field(
...
default_message_pool.register_message(
    "envoy.config.trace.v3", "OpenCensusConfig", OpenCensusConfig
)
