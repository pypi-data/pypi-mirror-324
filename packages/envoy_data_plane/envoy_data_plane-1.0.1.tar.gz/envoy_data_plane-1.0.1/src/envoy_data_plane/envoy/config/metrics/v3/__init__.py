...
class DogStatsdSink(betterproto2.Message):
    ...
    max_bytes_per_datagram: "int | None | None" = betterproto2.field(
...
class MetricsServiceConfig(betterproto2.Message):
    ...
    transport_api_version: "__core__v3__.ApiVersion" = betterproto2.field(
        ...
        default_factory=lambda: __core__v3__.ApiVersion.try_value(0),
    )
    """
    ...
    report_counters_as_deltas: "bool | None | None" = betterproto2.field(
    ...
    histogram_emit_mode: "HistogramEmitMode" = betterproto2.field(
        5,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: HistogramEmitMode.try_value(0),
    )
    """
...
class StatsConfig(betterproto2.Message):
    ...
    use_all_default_tags: "bool | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
