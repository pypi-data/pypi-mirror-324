...
class CorsPolicy(betterproto2.Message):
    ...
    allow_credentials: "bool | None | None" = betterproto2.field(
        6, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
    ...
    allow_private_network_access: "bool | None | None" = betterproto2.field(
    ...
    forward_not_matching_preflights: "bool | None | None" = betterproto2.field(
        13, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
...
class Decorator(betterproto2.Message):
    ...
    propagate: "bool | None | None" = betterproto2.field(
...
class HedgePolicy(betterproto2.Message):
    ...
    initial_requests: "int | None | None" = betterproto2.field(
...
class InternalRedirectPolicy(betterproto2.Message):
    ...
    max_internal_redirects: "int | None | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
...
class RateLimit(betterproto2.Message):
    ...
    stage: "int | None | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
...
class RateLimitActionHeaderValueMatch(betterproto2.Message):
    ...
    expect_match: "bool | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
...
class RateLimitActionMaskedRemoteAddress(betterproto2.Message):
    ...
    v4_prefix_mask_len: "int | None | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    v6_prefix_mask_len: "int | None | None" = betterproto2.field(
...
class RateLimitActionMetaData(betterproto2.Message):
    ...
    source: "RateLimitActionMetaDataSource" = betterproto2.field(
        ...
        default_factory=lambda: RateLimitActionMetaDataSource.try_value(0),
    )
    """
    Source of metadata
    """
...
class RedirectAction(betterproto2.Message):
    ...
    * The pattern ``(?i)/xxx/`` paired with a substitution string of ``/yyy/``
    ...
    response_code: "RedirectActionRedirectResponseCode" = betterproto2.field(
        3,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: RedirectActionRedirectResponseCode.try_value(0),
    )
    """
...
class RetryPolicyResetHeader(betterproto2.Message):
    ...
    format: "RetryPolicyResetHeaderFormat" = betterproto2.field(
        2,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: RetryPolicyResetHeaderFormat.try_value(0),
    )
    """
...
class Route(betterproto2.Message):
    ...
    per_request_buffer_limit_bytes: "int | None | None" = betterproto2.field(
...
class RouteAction(betterproto2.Message):
    ...
    cluster_not_found_response_code: "RouteActionClusterNotFoundResponseCode" = (
        betterproto2.field(
            20,
            betterproto2.TYPE_ENUM,
            default_factory=lambda: RouteActionClusterNotFoundResponseCode.try_value(0),
        )
    )
    """
    ...
    * The pattern ``(?i)/xxx/`` paired with a substitution string of ``/yyy/``
    ...
    auto_host_rewrite: "bool | None | None" = betterproto2.field(
        7,
        betterproto2.TYPE_MESSAGE,
    ...
    include_vh_rate_limits: "bool | None | None" = betterproto2.field(
    ...
    internal_redirect_action: "RouteActionInternalRedirectAction" = betterproto2.field(
        26,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: RouteActionInternalRedirectAction.try_value(0),
    )

    max_internal_redirects: "int | None | None" = betterproto2.field(
        31, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
...
class RouteActionRequestMirrorPolicy(betterproto2.Message):
    ...
    trace_sampled: "bool | None | None" = betterproto2.field(
...
class RouteActionUpgradeConfig(betterproto2.Message):
    ...
    enabled: "bool | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
...
class RouteConfiguration(betterproto2.Message):
    ...
    * HTTP :ref:`router filter <config_http_filters_router>`
    ...
    validate_clusters: "bool | None | None" = betterproto2.field(
    ...
    max_direct_response_body_size_bytes: "int | None | None" = betterproto2.field(
...
class RouteMatch(betterproto2.Message):
    ...
    case_sensitive: "bool | None | None" = betterproto2.field(
        4, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
...
class RouteMatchTlsContextMatchOptions(betterproto2.Message):
    presented: "bool | None | None" = betterproto2.field(
    ...
    validated: "bool | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
...
class VirtualHost(betterproto2.Message):
    ...
    * HTTP :ref:`router filter <config_http_filters_router>`
    ...
    require_tls: "VirtualHostTlsRequirementType" = betterproto2.field(
        4,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: VirtualHostTlsRequirementType.try_value(0),
    )
    """
...
class WeightedCluster(betterproto2.Message):
    ...
    total_weight: "int | None | None" = betterproto2.field(
...
class WeightedClusterClusterWeight(betterproto2.Message):
    ...
    weight: "int | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
