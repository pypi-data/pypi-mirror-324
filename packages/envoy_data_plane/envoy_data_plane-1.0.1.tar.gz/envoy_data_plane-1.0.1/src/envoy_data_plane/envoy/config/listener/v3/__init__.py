...
__all__ = (
    ...
    "Filter",
    "FilterChain",
    "FilterChainOnDemandConfiguration",
    "FilterChainMatch",
    "Listener",
...
class FilterChain(betterproto2.Message):
    ...
    use_proxy_proto: "bool | None | None" = betterproto2.field(
    ...
    on_demand_configuration: "FilterChainOnDemandConfiguration | None" = (
...
@dataclass(eq=False, repr=False)
class FilterChainOnDemandConfiguration(betterproto2.Message):
    """
    ...
    rebuild_timeout: "datetime.timedelta | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, optional=True
    )
    """
...
class FilterChainMatch(betterproto2.Message):
    ...
    destination_port: "int | None | None" = betterproto2.field(
    ...
    suffix_len: "int | None | None" = betterproto2.field(
    ...
    source_type: "FilterChainMatchConnectionSourceType" = betterproto2.field(
        ...
        default_factory=lambda: FilterChainMatchConnectionSourceType.try_value(0),
    )
    """
...
class Listener(betterproto2.Message):
    ...
    traffic_direction: "__core__v3__.TrafficDirection" = betterproto2.field(
        16,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: __core__v3__.TrafficDirection.try_value(0),
    )
    """
    ...
    enable_reuse_port: "bool | None | None" = betterproto2.field(
        29, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
    ...
    * On Windows, reuse_port for TCP has undefined behavior. It is force disabled and the user
    ...
    tcp_backlog_size: "int | None | None" = betterproto2.field(
        24, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    max_connections_to_accept_per_socket_event: "int | None | None" = (
        betterproto2.field(
            34, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
        )
    )
    """
    ...
    bind_to_port: "bool | None | None" = betterproto2.field(
        26, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
...
class QuicProtocolOptions(betterproto2.Message):
    ...
    packets_to_read_to_connection_count_ratio: "int | None | None" = betterproto2.field(
        5, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    send_disable_active_migration: "bool | None | None" = betterproto2.field(
        10, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
