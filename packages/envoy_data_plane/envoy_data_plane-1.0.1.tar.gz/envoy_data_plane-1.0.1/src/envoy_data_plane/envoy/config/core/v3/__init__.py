...
class AlternateProtocolsCacheOptions(betterproto2.Message):
    ...
    max_entries: "int | None | None" = betterproto2.field(
    ...
    canonical_suffixes: "list[str]" = betterproto2.field(
...
class ApiConfigSource(betterproto2.Message):
    ...
    api_type: "ApiConfigSourceApiType" = betterproto2.field(
        ...
        default_factory=lambda: ApiConfigSourceApiType.try_value(0),
    )
    """
    ...
    transport_api_version: "ApiVersion" = betterproto2.field(
        8, betterproto2.TYPE_ENUM, default_factory=lambda: ApiVersion.try_value(0)
    )
    """
...
class BindConfig(betterproto2.Message):
    ...
    freebind: "bool | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
...
class CidrRange(betterproto2.Message):
    ...
    prefix_len: "int | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
...
class ConfigSource(betterproto2.Message):
    ...
    resource_api_version: "ApiVersion" = betterproto2.field(
        6, betterproto2.TYPE_ENUM, default_factory=lambda: ApiVersion.try_value(0)
    )
    """
...
class DataSource(betterproto2.Message):
    ...
    environment_variable: "str | None" = betterproto2.field(
...
class EnvoyInternalAddress(betterproto2.Message):
    ...
    server_listener_name: "str | None" = betterproto2.field(
    ...
    endpoint_id: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
...
class Extension(betterproto2.Message):
    ...
    type_urls: "list[str]" = betterproto2.field(
...
class GrpcServiceEnvoyGrpc(betterproto2.Message):
    ...
    max_receive_message_length: "int | None | None" = betterproto2.field(
        4, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
...
class GrpcServiceGoogleGrpc(betterproto2.Message):
    ...
    per_stream_buffer_limit_bytes: "int | None | None" = betterproto2.field(
        7, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
...
class HeaderValueOption(betterproto2.Message):
    ...
    append: "bool | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
    ...
    append_action: "HeaderValueOptionHeaderAppendAction" = betterproto2.field(
        3,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: HeaderValueOptionHeaderAppendAction.try_value(0),
    )
    """
...
class HealthCheck(betterproto2.Message):
    ...
    unhealthy_threshold: "int | None | None" = betterproto2.field(
        4, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    healthy_threshold: "int | None | None" = betterproto2.field(
    ...
    alt_port: "int | None | None" = betterproto2.field(
    ...
    reuse_connection: "bool | None | None" = betterproto2.field(
...
class HealthCheckHttpHealthCheck(betterproto2.Message):
    ...
    response_buffer_size: "int | None | None" = betterproto2.field(
        14, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT64, optional=True
    )
    """
    ...
    codec_client_type: "___type__v3__.CodecClientType" = betterproto2.field(
        10,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ___type__v3__.CodecClientType.try_value(0),
    )
    """
    ...
    method: "RequestMethod" = betterproto2.field(
        13, betterproto2.TYPE_ENUM, default_factory=lambda: RequestMethod.try_value(0)
    )
    """
...
class Http1ProtocolOptions(betterproto2.Message):
    ...
    allow_absolute_url: "bool | None | None" = betterproto2.field(
    ...
    override_stream_error_on_invalid_http_message: "bool | None | None" = (
        betterproto2.field(
            7, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
        )
    )
    ...
    use_balsa_parser: "bool | None | None" = betterproto2.field(
        9, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
...
class Http2ProtocolOptions(betterproto2.Message):
    ...
    hpack_table_size: "int | None | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    max_concurrent_streams: "int | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    initial_stream_window_size: "int | None | None" = betterproto2.field(
    ...
    initial_connection_window_size: "int | None | None" = betterproto2.field(
        4, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    max_outbound_frames: "int | None | None" = betterproto2.field(
        7, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    max_outbound_control_frames: "int | None | None" = betterproto2.field(
        8, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    max_consecutive_inbound_frames_with_empty_payload: "int | None | None" = (
        betterproto2.field(
            9, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
        )
    )
    """
    ...
    max_inbound_priority_frames_per_stream: "int | None | None" = betterproto2.field(
        10, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    max_inbound_window_update_frames_per_data_frame_sent: "int | None | None" = (
        betterproto2.field(
            11, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
        )
    )
    """
    ...
    override_stream_error_on_invalid_http_message: "bool | None | None" = (
        betterproto2.field(
            14, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
        )
    )
    """
    Allows invalid HTTP messaging and headers. When this option is disabled (default), then
    ...
    use_oghttp2_codec: "bool | None | None" = betterproto2.field(
        16, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
...
class Http2ProtocolOptionsSettingsParameter(betterproto2.Message):
    ...
    identifier: "int | None | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    value: "int | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
...
class HttpProtocolOptions(betterproto2.Message):
    ...
    max_headers_count: "int | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    max_response_headers_kb: "int | None | None" = betterproto2.field(
        7, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    headers_with_underscores_action: "HttpProtocolOptionsHeadersWithUnderscoresAction" = betterproto2.field(
        5,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: HttpProtocolOptionsHeadersWithUnderscoresAction.try_value(
            0
        ),
    )
    """
    ...
    max_requests_per_connection: "int | None | None" = betterproto2.field(
        6, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
...
class KeyValueAppend(betterproto2.Message):
    ...
    action: "KeyValueAppendKeyValueAppendAction" = betterproto2.field(
        2,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: KeyValueAppendKeyValueAppendAction.try_value(0),
    )
    """
...
class KeyValueMutation(betterproto2.Message):
    ...
    remove: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
...
class ProxyProtocolConfig(betterproto2.Message):
    version: "ProxyProtocolConfigVersion" = betterproto2.field(
        1,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ProxyProtocolConfigVersion.try_value(0),
    )
    """
...
class ProxyProtocolPassThroughTlVs(betterproto2.Message):
    ...
    match_type: "ProxyProtocolPassThroughTlVsPassTlVsMatchType" = betterproto2.field(
        1,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ProxyProtocolPassThroughTlVsPassTlVsMatchType.try_value(
            0
        ),
    )
    """
    ...
    tlv_type: "list[int]" = betterproto2.field(
...
class QuicProtocolOptions(betterproto2.Message):
    ...
    num_timeouts_to_trigger_port_migration: "int | None | None" = betterproto2.field(
        4, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    connection_options: "str" = betterproto2.field(6, betterproto2.TYPE_STRING)
    """
    ...
    client_connection_options: "str" = betterproto2.field(7, betterproto2.TYPE_STRING)
    """
    ...
    max_packet_length: "int | None | None" = betterproto2.field(
        9, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT64, optional=True
    )
    """
...
class RateLimitSettings(betterproto2.Message):
    ...
    max_tokens: "int | None | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    fill_rate: "float | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_DOUBLE, optional=True
    )
    """
...
class RetryPolicy(betterproto2.Message):
    ...
    num_retries: "int | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    retry_on: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)
    """
...
class RuntimeFeatureFlag(betterproto2.Message):
    ...
    default_value: "bool | None | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
    Default value if runtime value is not available.
...
class SchemeHeaderTransformation(betterproto2.Message):
    ...
    scheme_to_overwrite: "str | None" = betterproto2.field(
...
class SelfConfigSource(betterproto2.Message):
    ...
    transport_api_version: "ApiVersion" = betterproto2.field(
        1, betterproto2.TYPE_ENUM, default_factory=lambda: ApiVersion.try_value(0)
    )
    """
    API version for xDS transport protocol. This describes the xDS gRPC/REST
    endpoint and version of [Delta]DiscoveryRequest/Response used on the wire.
...
class SocketAddress(betterproto2.Message):
    ...
    protocol: "SocketAddressProtocol" = betterproto2.field(
        1,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: SocketAddressProtocol.try_value(0),
    )
...
class SocketCmsgHeaders(betterproto2.Message):
    ...
    level: "int | None | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    type: "int | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    expected_size: "int" = betterproto2.field(3, betterproto2.TYPE_UINT32)
    """
...
class SocketOption(betterproto2.Message):
    ...
    state: "SocketOptionSocketState" = betterproto2.field(
        6,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: SocketOptionSocketState.try_value(0),
    )
    """
...
class SubstitutionFormatString(betterproto2.Message):
    ...
    text_format: "str | None" = betterproto2.field(
...
class TcpKeepalive(betterproto2.Message):
    keepalive_probes: "int | None | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    keepalive_time: "int | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    keepalive_interval: "int | None | None" = betterproto2.field(
        3, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
...
class UdpSocketConfig(betterproto2.Message):
    ...
    max_rx_datagram_size: "int | None | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT64, optional=True
    )
    """
    ...
    prefer_gro: "bool | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
...
class UpstreamHttpProtocolOptions(betterproto2.Message):
    ...
    override_auto_sni_header: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)
    """
