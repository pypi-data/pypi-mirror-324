...
class Alts(betterproto2.Message):
    ...
    handshaker_service: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    The location of a handshaker service, this is usually 169.254.169.254:8080
    on GCE.
    """

    peer_service_accounts: "list[str]" = betterproto2.field(
...
default_message_pool.register_message(
    "envoy.config.transport_socket.alts.v2alpha", "Alts", Alts
)
