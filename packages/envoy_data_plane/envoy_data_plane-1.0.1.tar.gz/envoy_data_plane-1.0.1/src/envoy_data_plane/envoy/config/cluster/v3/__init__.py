...
class CircuitBreakersThresholds(betterproto2.Message):
    ...
    priority: "__core__v3__.RoutingPriority" = betterproto2.field(
        ...
        default_factory=lambda: __core__v3__.RoutingPriority.try_value(0),
    )
    """
    ...
    max_connections: "int | None | None" = betterproto2.field(
    ...
    max_pending_requests: "int | None | None" = betterproto2.field(
    ...
    max_requests: "int | None | None" = betterproto2.field(
    ...
    max_retries: "int | None | None" = betterproto2.field(
    ...
    max_connection_pools: "int | None | None" = betterproto2.field(
...
class CircuitBreakersThresholdsRetryBudget(betterproto2.Message):
    ...
    min_retry_concurrency: "int | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
...
class Cluster(betterproto2.Message):
    ...
    per_connection_buffer_limit_bytes: "int | None | None" = betterproto2.field(
        5, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    lb_policy: "ClusterLbPolicy" = betterproto2.field(
        6, betterproto2.TYPE_ENUM, default_factory=lambda: ClusterLbPolicy.try_value(0)
    )
    """
    ...
    dns_jitter: "datetime.timedelta | None" = betterproto2.field(
        58, betterproto2.TYPE_MESSAGE, optional=True
    )
    """
    ...
    dns_lookup_family: "ClusterDnsLookupFamily" = betterproto2.field(
        17,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ClusterDnsLookupFamily.try_value(0),
    )
    """
    ...
    wait_for_warm_on_init: "bool | None | None" = betterproto2.field(
        54, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
    ...
    protocol_selection: "ClusterClusterProtocolSelection" = betterproto2.field(
        26,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ClusterClusterProtocolSelection.try_value(0),
    )
    """
...
class ClusterCommonLbConfigConsistentHashingLbConfig(betterproto2.Message):
    ...
    hash_balance_factor: "int | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
...
class ClusterCommonLbConfigZoneAwareLbConfig(betterproto2.Message):
    ...
    * :ref:`Zone aware routing support <arch_overview_load_balancing_zone_aware_routing>`.
    ...
    min_cluster_size: "int | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT64, optional=True
    )
    """
...
class ClusterLbSubsetConfig(betterproto2.Message):
    ...
    fallback_policy: "ClusterLbSubsetConfigLbSubsetFallbackPolicy" = betterproto2.field(
        1,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ClusterLbSubsetConfigLbSubsetFallbackPolicy.try_value(
            0
        ),
    )
    """
    ...
    metadata_fallback_policy: "ClusterLbSubsetConfigLbSubsetMetadataFallbackPolicy" = betterproto2.field(
        8,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ClusterLbSubsetConfigLbSubsetMetadataFallbackPolicy.try_value(
            0
        ),
    )
    """
...
class ClusterLbSubsetConfigLbSubsetSelector(betterproto2.Message):
    ...
    fallback_policy: "ClusterLbSubsetConfigLbSubsetSelectorLbSubsetSelectorFallbackPolicy" = betterproto2.field(
        2,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ClusterLbSubsetConfigLbSubsetSelectorLbSubsetSelectorFallbackPolicy.try_value(
            0
        ),
    )
    """
...
class ClusterLeastRequestLbConfig(betterproto2.Message):
    ...
    choice_count: "int | None | None" = betterproto2.field(
...
class ClusterMaglevLbConfig(betterproto2.Message):
    ...
    table_size: "int | None | None" = betterproto2.field(
...
class ClusterOriginalDstLbConfig(betterproto2.Message):
    ...
    upstream_port_override: "int | None | None" = betterproto2.field(
        3, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
...
class ClusterPreconnectPolicy(betterproto2.Message):
    per_upstream_preconnect_ratio: "float | None | None" = betterproto2.field(
    ...
    predictive_preconnect_ratio: "float | None | None" = betterproto2.field(
...
class ClusterRingHashLbConfig(betterproto2.Message):
    ...
    minimum_ring_size: "int | None | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT64, optional=True
    )
    """
    ...
    hash_function: "ClusterRingHashLbConfigHashFunction" = betterproto2.field(
        3,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ClusterRingHashLbConfigHashFunction.try_value(0),
    )
    """
    ...
    maximum_ring_size: "int | None | None" = betterproto2.field(
...
class OutlierDetection(betterproto2.Message):
    ...
    consecutive_5xx: "int | None | None" = betterproto2.field(
        1, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    max_ejection_percent: "int | None | None" = betterproto2.field(
        4, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    enforcing_consecutive_5xx: "int | None | None" = betterproto2.field(
        5, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    enforcing_success_rate: "int | None | None" = betterproto2.field(
    ...
    success_rate_minimum_hosts: "int | None | None" = betterproto2.field(
        7, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    success_rate_request_volume: "int | None | None" = betterproto2.field(
    ...
    success_rate_stdev_factor: "int | None | None" = betterproto2.field(
        9, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    consecutive_gateway_failure: "int | None | None" = betterproto2.field(
    ...
    enforcing_consecutive_gateway_failure: "int | None | None" = betterproto2.field(
    ...
    consecutive_local_origin_failure: "int | None | None" = betterproto2.field(
    ...
    enforcing_consecutive_local_origin_failure: "int | None | None" = (
        betterproto2.field(
            14, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
        )
    )
    """
    The % chance that a host will be actually ejected when an outlier status
    ...
    enforcing_local_origin_success_rate: "int | None | None" = betterproto2.field(
        15, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    The % chance that a host will be actually ejected when an outlier status
    ...
    failure_percentage_threshold: "int | None | None" = betterproto2.field(
        16, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    enforcing_failure_percentage: "int | None | None" = betterproto2.field(
        17, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    enforcing_failure_percentage_local_origin: "int | None | None" = betterproto2.field(
        18, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    The % chance that a host will be actually ejected when an outlier status is detected through
    ...
    failure_percentage_minimum_hosts: "int | None | None" = betterproto2.field(
        19, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    failure_percentage_request_volume: "int | None | None" = betterproto2.field(
        20, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
    ...
    successful_active_health_check_uneject_host: "bool | None | None" = (
        betterproto2.field(
            23, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
        )
    )
    """
    ...
    always_eject_one_host: "bool | None | None" = betterproto2.field(
        25, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_BOOL, optional=True
    )
    """
...
class UpstreamConnectionOptionsHappyEyeballsConfig(betterproto2.Message):
    first_address_family_version: "UpstreamConnectionOptionsFirstAddressFamilyVersion" = betterproto2.field(
        1,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: UpstreamConnectionOptionsFirstAddressFamilyVersion.try_value(
            0
        ),
    )
    """
    ...
    first_address_family_count: "int | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_UINT32, optional=True
    )
    """
