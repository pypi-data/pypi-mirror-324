...
class AttributeContextHttpRequest(betterproto2.Message):
    ...
    path: "str" = betterproto2.field(4, betterproto2.TYPE_STRING)
    """
    The request target, as it appears in the first line of the HTTP request. This includes
    the URL path and query-string. No decoding is performed.
    """

    host: "str" = betterproto2.field(5, betterproto2.TYPE_STRING)
    """
    The HTTP request ``Host`` or ``:authority`` header value.
    """

    scheme: "str" = betterproto2.field(6, betterproto2.TYPE_STRING)
    """
    The HTTP URL scheme, such as ``http`` and ``https``.
    """

    query: "str" = betterproto2.field(7, betterproto2.TYPE_STRING)
    """
    This field is always empty, and exists for compatibility reasons. The HTTP URL query is
    included in ``path`` field.
    """

    fragment: "str" = betterproto2.field(8, betterproto2.TYPE_STRING)
    """
    This field is always empty, and exists for compatibility reasons. The URL fragment is
    not submitted as part of HTTP requests; it is unknowable.
    """

    size: "int" = betterproto2.field(9, betterproto2.TYPE_INT64)
    """
    The HTTP request size in bytes. If unknown, it must be -1.
    """

    protocol: "str" = betterproto2.field(10, betterproto2.TYPE_STRING)
    """
    ...
    body: "str" = betterproto2.field(11, betterproto2.TYPE_STRING)
    """
...
class AttributeContextPeer(betterproto2.Message):
    ...
    service: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
    ...
    principal: "str" = betterproto2.field(4, betterproto2.TYPE_STRING)
    """
    ...
    certificate: "str" = betterproto2.field(5, betterproto2.TYPE_STRING)
    """
...
class AttributeContextTlsSession(betterproto2.Message):
    ...
    sni: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
...
class DeniedHttpResponse(betterproto2.Message):
    ...
    body: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)
    """
...
class OkHttpResponse(betterproto2.Message):
    ...
    headers_to_remove: "list[str]" = betterproto2.field(
    ...
    query_parameters_to_remove: "list[str]" = betterproto2.field(
