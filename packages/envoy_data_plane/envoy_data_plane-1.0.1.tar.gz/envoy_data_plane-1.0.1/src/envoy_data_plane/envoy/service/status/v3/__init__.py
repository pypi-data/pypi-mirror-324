...
class ClientConfig(betterproto2.Message):
    ...
    client_scope: "str" = betterproto2.field(4, betterproto2.TYPE_STRING)
    """
...
class ClientConfigGenericXdsConfig(betterproto2.Message):
    ...
    version_info: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)
    """
    ...
    config_status: "ConfigStatus" = betterproto2.field(
        6, betterproto2.TYPE_ENUM, default_factory=lambda: ConfigStatus.try_value(0)
    )
    """
    ...
    client_status: "___admin__v3__.ClientResourceStatus" = betterproto2.field(
        ...
        default_factory=lambda: ___admin__v3__.ClientResourceStatus.try_value(0),
    )
    """
...
class PerXdsConfig(betterproto2.Message):
    ...
    client_status: "ClientConfigStatus" = betterproto2.field(
        7,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ClientConfigStatus.try_value(0),
    )
    """
