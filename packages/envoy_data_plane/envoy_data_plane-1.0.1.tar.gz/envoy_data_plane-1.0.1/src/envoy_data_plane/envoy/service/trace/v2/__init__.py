...
# sources: envoy/service/trace/v2/trace_service.proto
...
default_message_pool.register_message(
    "envoy.service.trace.v2", "StreamTracesMessage", StreamTracesMessage
)
...
default_message_pool.register_message(
    "envoy.service.trace.v2", "StreamTracesResponse", StreamTracesResponse
)
...
class TraceServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> "dict[str, grpclib.const.Handler":
        return {
            "/envoy.service.trace.v2.TraceService/StreamTraces": grpclib.const.Handler(
