...
class RingHashHashFunction(betterproto2.Enum):
    """
...
class RingHash(betterproto2.Message):
    """
    ...
    hash_function: "RingHashHashFunction" = betterproto2.field(
        1,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: RingHashHashFunction.try_value(0),
    )
    """
    ...
    use_hostname_for_hashing: "bool" = betterproto2.field(4, betterproto2.TYPE_BOOL)
    """
...
default_message_pool.register_message(
    "envoy.extensions.load_balancing_policies.ring_hash.v3", "RingHash", RingHash
)
