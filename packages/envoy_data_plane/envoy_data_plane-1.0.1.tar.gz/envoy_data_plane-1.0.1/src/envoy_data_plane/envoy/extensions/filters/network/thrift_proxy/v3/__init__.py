...
class ThriftProtocolOptions(betterproto2.Message):
    ...
    transport: "TransportType" = betterproto2.field(
        1, betterproto2.TYPE_ENUM, default_factory=lambda: TransportType.try_value(0)
    )
    """
    ...
    protocol: "ProtocolType" = betterproto2.field(
        2, betterproto2.TYPE_ENUM, default_factory=lambda: ProtocolType.try_value(0)
    )
    """
...
class ThriftProxy(betterproto2.Message):
    ...
    transport: "TransportType" = betterproto2.field(
        2, betterproto2.TYPE_ENUM, default_factory=lambda: TransportType.try_value(0)
    )
    """
    ...
    protocol: "ProtocolType" = betterproto2.field(
        3, betterproto2.TYPE_ENUM, default_factory=lambda: ProtocolType.try_value(0)
    )
    """
