...
class ConsistentHashing(betterproto2.Message):
    """
    ...
    modulo: "int" = betterproto2.field(2, betterproto2.TYPE_UINT32)
    """
    ...
    seed: "int" = betterproto2.field(3, betterproto2.TYPE_UINT64)
    """
...
default_message_pool.register_message(
    "envoy.extensions.matching.input_matchers.consistent_hashing.v3",
    "ConsistentHashing",
    ConsistentHashing,
)
