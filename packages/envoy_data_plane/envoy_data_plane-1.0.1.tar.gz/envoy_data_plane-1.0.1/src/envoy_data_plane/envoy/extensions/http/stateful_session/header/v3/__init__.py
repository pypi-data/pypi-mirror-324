...
# sources: envoy/extensions/http/stateful_session/header/v3/header.proto
# plugin: python-betterproto2
# This file has been @generated

__all__ = ("HeaderBasedSessionState",)
...
class HeaderBasedSessionState(betterproto2.Message):
    """
...
default_message_pool.register_message(
    "envoy.extensions.http.stateful_session.header.v3",
