...
class DnsCacheConfig(betterproto2.Message):
    ...
    dns_lookup_family: "____config__cluster__v3__.ClusterDnsLookupFamily" = betterproto2.field(
        2,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ____config__cluster__v3__.ClusterDnsLookupFamily.try_value(
            0
        ),
    )
    """
    ...
    max_hosts: "int | None | None" = betterproto2.field(
