...
class GrpcJsonTranscoder(betterproto2.Message):
    ...
    url_unescape_spec: "GrpcJsonTranscoderUrlUnescapeSpec" = betterproto2.field(
        ...
        default_factory=lambda: GrpcJsonTranscoderUrlUnescapeSpec.try_value(0),
    )
    """
    ...
    max_request_body_size: "int | None | None" = betterproto2.field(
    ...
    max_response_body_size: "int | None | None" = betterproto2.field(
