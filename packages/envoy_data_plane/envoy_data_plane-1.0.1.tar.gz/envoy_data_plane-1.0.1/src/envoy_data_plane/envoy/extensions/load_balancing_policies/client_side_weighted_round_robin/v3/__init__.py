...
class ClientSideWeightedRoundRobin(betterproto2.Message):
    ...
    enable_oob_load_report: "bool | None | None" = betterproto2.field(
    ...
    error_utilization_penalty: "float | None | None" = betterproto2.field(
        6, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_FLOAT, optional=True
    )
    """
