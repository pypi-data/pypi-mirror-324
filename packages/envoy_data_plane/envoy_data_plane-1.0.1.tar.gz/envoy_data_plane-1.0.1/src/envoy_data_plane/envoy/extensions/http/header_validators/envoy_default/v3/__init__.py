...
# sources: envoy/extensions/http/header_validators/envoy_default/v3/header_validator.proto
# plugin: python-betterproto2
# This file has been @generated

__all__ = (
    "HeaderValidatorConfigHeadersWithUnderscoresAction",
    "HeaderValidatorConfigUriPathNormalizationOptionsPathWithEscapedSlashesAction",
    "HeaderValidatorConfig",
    "HeaderValidatorConfigHttp1ProtocolOptions",
    "HeaderValidatorConfigUriPathNormalizationOptions",
)
...
class HeaderValidatorConfigHeadersWithUnderscoresAction(betterproto2.Enum):
    """
...
class HeaderValidatorConfigUriPathNormalizationOptionsPathWithEscapedSlashesAction(
    betterproto2.Enum
):
    """
...
class HeaderValidatorConfig(betterproto2.Message):
    """
    ...
    http1_protocol_options: "HeaderValidatorConfigHttp1ProtocolOptions | None" = (
        betterproto2.field(1, betterproto2.TYPE_MESSAGE, optional=True)
    )

    uri_path_normalization_options: "HeaderValidatorConfigUriPathNormalizationOptions | None" = betterproto2.field(
    ...
    restrict_http_methods: "bool" = betterproto2.field(3, betterproto2.TYPE_BOOL)
    """
    ...
    headers_with_underscores_action: "HeaderValidatorConfigHeadersWithUnderscoresAction" = betterproto2.field(
        4,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: HeaderValidatorConfigHeadersWithUnderscoresAction.try_value(
            0
        ),
    )
    """
    ...
    strip_fragment_from_path: "bool" = betterproto2.field(5, betterproto2.TYPE_BOOL)
    """
...
@dataclass(eq=False, repr=False)
class HeaderValidatorConfigHttp1ProtocolOptions(betterproto2.Message):
    allow_chunked_length: "bool" = betterproto2.field(1, betterproto2.TYPE_BOOL)
    """
...
@dataclass(eq=False, repr=False)
class HeaderValidatorConfigUriPathNormalizationOptions(betterproto2.Message):
    skip_path_normalization: "bool" = betterproto2.field(1, betterproto2.TYPE_BOOL)
    """
    ...
    skip_merging_slashes: "bool" = betterproto2.field(2, betterproto2.TYPE_BOOL)
    """
    ...
    path_with_escaped_slashes_action: "HeaderValidatorConfigUriPathNormalizationOptionsPathWithEscapedSlashesAction" = betterproto2.field(
        3,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: HeaderValidatorConfigUriPathNormalizationOptionsPathWithEscapedSlashesAction.try_value(
            0
        ),
    )
    """
