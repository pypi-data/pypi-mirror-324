...
# sources: envoy/extensions/filters/http/custom_response/v3/custom_response.proto
...
class CustomResponse(betterproto2.Message):
    """
    ...
    custom_response_matcher: "______xds__type__matcher__v3__.Matcher | None" = (
...
default_message_pool.register_message(
    "envoy.extensions.filters.http.custom_response.v3", "CustomResponse", CustomResponse
)
