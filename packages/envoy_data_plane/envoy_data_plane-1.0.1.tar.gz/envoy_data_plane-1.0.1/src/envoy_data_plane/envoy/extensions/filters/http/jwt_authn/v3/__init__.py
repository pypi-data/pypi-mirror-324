...
class JwtCacheConfig(betterproto2.Message):
    ...
    jwt_cache_size: "int" = betterproto2.field(1, betterproto2.TYPE_UINT32)
    """
...
class JwtClaimToHeader(betterproto2.Message):
    ...
    claim_name: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
...
class JwtProvider(betterproto2.Message):
    ...
    * Multiple ``JwtProviders`` should not have same value in this field.
    ...
    from_cookies: "list[str]" = betterproto2.field(
    ...
    header_in_metadata: "str" = betterproto2.field(14, betterproto2.TYPE_STRING)
    """
    ...
    failed_status_in_metadata: "str" = betterproto2.field(16, betterproto2.TYPE_STRING)
    """
    ...
    clock_skew_seconds: "int" = betterproto2.field(10, betterproto2.TYPE_UINT32)
    """
...
class JwtProviderNormalizePayload(betterproto2.Message):
    ...
    space_delimited_claims: "list[str]" = betterproto2.field(
...
class PerRouteConfig(betterproto2.Message):
    ...
    requirement_name: "str | None" = betterproto2.field(
