...
# sources: envoy/extensions/path/rewrite/uri_template/v3/uri_template_rewrite.proto
# plugin: python-betterproto2
# This file has been @generated

__all__ = ("UriTemplateRewriteConfig",)
...
class UriTemplateRewriteConfig(betterproto2.Message):
    """
    ...
    * The path pattern ``/content/{format}/{lang}/{id}/{file}.vtt`` paired with a substitution
    ...
    path_template_rewrite: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)


default_message_pool.register_message(
    "envoy.extensions.path.rewrite.uri_template.v3",
