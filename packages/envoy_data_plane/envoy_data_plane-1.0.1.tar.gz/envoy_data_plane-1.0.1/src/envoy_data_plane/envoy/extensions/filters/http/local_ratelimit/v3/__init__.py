...
class LocalRateLimit(betterproto2.Message):
    ...
    stage: "int" = betterproto2.field(9, betterproto2.TYPE_UINT32)
    """
    ...
    enable_x_ratelimit_headers: "____common__ratelimit__v3__.XRateLimitHeadersRfcVersion" = betterproto2.field(
        ...
        default_factory=lambda: ____common__ratelimit__v3__.XRateLimitHeadersRfcVersion.try_value(
            0
        ),
    )
    """
    ...
    vh_rate_limits: "____common__ratelimit__v3__.VhRateLimitsOptions" = betterproto2.field(
        13,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ____common__ratelimit__v3__.VhRateLimitsOptions.try_value(
            0
        ),
    )
    """
    ...
    always_consume_default_token_bucket: "bool | None | None" = betterproto2.field(
