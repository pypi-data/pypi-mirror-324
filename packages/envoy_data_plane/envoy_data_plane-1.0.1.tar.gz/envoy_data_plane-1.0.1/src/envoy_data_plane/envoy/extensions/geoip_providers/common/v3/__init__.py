...
class CommonGeoipProviderConfigGeolocationHeadersToAdd(betterproto2.Message):
    ...
    country: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    ...
    region: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)
    """
    ...
    asn: "str" = betterproto2.field(4, betterproto2.TYPE_STRING)
    """
    If set, the header will be used to populate the ASN associated with the IP address.
    """

    is_anon: "str" = betterproto2.field(5, betterproto2.TYPE_STRING)
    """
    ...
    anon_vpn: "str" = betterproto2.field(6, betterproto2.TYPE_STRING)
    """
    ...
    anon_hosting: "str" = betterproto2.field(7, betterproto2.TYPE_STRING)
    """
    ...
    anon_tor: "str" = betterproto2.field(8, betterproto2.TYPE_STRING)
    """
    ...
    anon_proxy: "str" = betterproto2.field(9, betterproto2.TYPE_STRING)
    """
