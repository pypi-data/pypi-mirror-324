...
class EnvironmentVariables(betterproto2.Message):
    host_env_keys: "list[str]" = betterproto2.field(
...
class PluginConfig(betterproto2.Message):
    ...
    root_id: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
...
class VmConfig(betterproto2.Message):
    ...
    vm_id: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    ...
    runtime: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
