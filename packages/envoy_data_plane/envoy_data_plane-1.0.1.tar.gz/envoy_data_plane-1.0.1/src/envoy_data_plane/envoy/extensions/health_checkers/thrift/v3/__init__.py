...
class Thrift(betterproto2.Message):
    ...
    transport: "___filters__network__thrift_proxy__v3__.TransportType" = betterproto2.field(
        ...
        default_factory=lambda: ___filters__network__thrift_proxy__v3__.TransportType.try_value(
            0
        ),
    )
    """
    ...
    protocol: "___filters__network__thrift_proxy__v3__.ProtocolType" = betterproto2.field(
        3,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ___filters__network__thrift_proxy__v3__.ProtocolType.try_value(
            0
        ),
    )
    """
