...
class FileSystemBufferFilterConfig(betterproto2.Message):
    ...
    storage_buffer_path: "str | None | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, wraps=betterproto2.TYPE_STRING, optional=True
    )
    """
...
class StreamConfig(betterproto2.Message):
    ...
    memory_buffer_bytes_limit: "int | None | None" = betterproto2.field(
    ...
    storage_buffer_bytes_limit: "int | None | None" = betterproto2.field(
    ...
    storage_buffer_queue_high_watermark_bytes: "int | None | None" = betterproto2.field(
