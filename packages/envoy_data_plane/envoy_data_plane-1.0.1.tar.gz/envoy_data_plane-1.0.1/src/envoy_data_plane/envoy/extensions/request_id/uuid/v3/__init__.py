...
class UuidRequestIdConfig(betterproto2.Message):
    """
    [#protodoc-title: UUID]
    ...
    pack_trace_reason: "bool | None | None" = betterproto2.field(
    ...
    use_request_id_for_trace_sampling: "bool | None | None" = betterproto2.field(
...
default_message_pool.register_message(
    "envoy.extensions.request_id.uuid.v3", "UuidRequestIdConfig", UuidRequestIdConfig
)
