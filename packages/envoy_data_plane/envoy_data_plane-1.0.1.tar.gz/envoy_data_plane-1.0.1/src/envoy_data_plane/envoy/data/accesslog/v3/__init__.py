...
class AccessLogCommon(betterproto2.Message):
    ...
    upstream_request_attempt_count: "int" = betterproto2.field(
    ...
    connection_termination_details: "str" = betterproto2.field(
    ...
    stream_id: "str" = betterproto2.field(26, betterproto2.TYPE_STRING)
    """
    ...
    downstream_transport_failure_reason: "str" = betterproto2.field(
    ...
    downstream_wire_bytes_sent: "int" = betterproto2.field(29, betterproto2.TYPE_UINT64)
    """
    ...
    downstream_wire_bytes_received: "int" = betterproto2.field(
    ...
    upstream_wire_bytes_sent: "int" = betterproto2.field(31, betterproto2.TYPE_UINT64)
    """
    ...
    upstream_wire_bytes_received: "int" = betterproto2.field(
    ...
    access_log_type: "AccessLogType" = betterproto2.field(
        33, betterproto2.TYPE_ENUM, default_factory=lambda: AccessLogType.try_value(0)
    )
    """
...
class HttpAccessLogEntry(betterproto2.Message):
    ...
    protocol_version: "HttpAccessLogEntryHttpVersion" = betterproto2.field(
        ...
        default_factory=lambda: HttpAccessLogEntryHttpVersion.try_value(0),
    )
...
class HttpRequestProperties(betterproto2.Message):
    ...
    request_method: "___config__core__v3__.RequestMethod" = betterproto2.field(
        1,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ___config__core__v3__.RequestMethod.try_value(0),
    )
    """
    ...
    port: "int | None | None" = betterproto2.field(
    ...
    upstream_header_bytes_sent: "int" = betterproto2.field(14, betterproto2.TYPE_UINT64)
    """
    ...
    downstream_header_bytes_received: "int" = betterproto2.field(
...
class HttpResponseProperties(betterproto2.Message):
    ...
    response_code: "int | None | None" = betterproto2.field(
    ...
    upstream_header_bytes_received: "int" = betterproto2.field(
    ...
    downstream_header_bytes_sent: "int" = betterproto2.field(
...
class ResponseFlagsUnauthorized(betterproto2.Message):
    reason: "ResponseFlagsUnauthorizedReason" = betterproto2.field(
        1,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: ResponseFlagsUnauthorizedReason.try_value(0),
    )
...
class TlsProperties(betterproto2.Message):
    ...
    tls_version: "TlsPropertiesTlsVersion" = betterproto2.field(
        1,
        betterproto2.TYPE_ENUM,
        default_factory=lambda: TlsPropertiesTlsVersion.try_value(0),
    )
    """
    Version of TLS that was negotiated.
    """

    tls_cipher_suite: "int | None | None" = betterproto2.field(
    ...
    ja3_fingerprint: "str" = betterproto2.field(7, betterproto2.TYPE_STRING)
    """
