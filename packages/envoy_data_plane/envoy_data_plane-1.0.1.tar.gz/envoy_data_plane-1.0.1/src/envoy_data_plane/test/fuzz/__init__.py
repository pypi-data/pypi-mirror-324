...
class HttpBody(betterproto2.Message):
    data: "list[str]" = betterproto2.field(1, betterproto2.TYPE_STRING, repeated=True)
    """
...
class ProtoBody(betterproto2.Message):
    ...
    chunk_size: "int" = betterproto2.field(2, betterproto2.TYPE_UINT64)
    """
...
class StreamInfo(betterproto2.Message):
    ...
    start_time: "int" = betterproto2.field(2, betterproto2.TYPE_UINT64)
    ...
    requested_server_name: "str" = betterproto2.field(5, betterproto2.TYPE_STRING)
