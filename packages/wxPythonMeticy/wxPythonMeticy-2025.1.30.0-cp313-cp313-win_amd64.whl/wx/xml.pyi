...
class XmlNode:
    """
    XmlNode(parent : XmlNode, type : XmlNodeType, name : str, content: str='', attrs: Optional[XmlAttribute]=None, next: Optional[XmlNode]=None, lineNo: int=-1) -> None
    XmlNode(type : XmlNodeType, name : str, content: str='', lineNo: int=-1) -> None
    ...
    def AddAttribute(self, name : str, value : str) -> None:
        """
        AddAttribute(name : str, value : str) -> None
        AddAttribute(attr : XmlAttribute) -> None
    ...
    def GetAttribute(self, attrName : str, defaultVal: str='') -> str:
        """
        GetAttribute(attrName : str, defaultVal: str='') -> str
    ...
    def GetDepth(self, grandparent: Optional[XmlNode]=None) -> int:
        """
        GetDepth(grandparent: Optional[XmlNode]=None) -> int
    ...
    def HasAttribute(self, attrName : str) -> bool:
        """
        HasAttribute(attrName : str) -> bool
    ...
    def InsertChild(self, child : XmlNode, followingNode : XmlNode) -> bool:
        """
        InsertChild(child : XmlNode, followingNode : XmlNode) -> bool
    ...
    def InsertChildAfter(self, child : XmlNode, precedingNode : XmlNode) -> bool:
        """
        InsertChildAfter(child : XmlNode, precedingNode : XmlNode) -> bool
    ...
    def RemoveChild(self, child : XmlNode) -> bool:
        """
        RemoveChild(child : XmlNode) -> bool
    ...
    def SetNoConversion(self, noconversion : bool) -> None:
        """
        SetNoConversion(noconversion : bool) -> None
    ...
    NoConversion = property(GetNoConversion, SetNoConversion)
    NodeContent = property(GetNodeContent)
...
class XmlAttribute:
    """
    XmlAttribute() -> None
    XmlAttribute(name : str, value : str, next: Optional[XmlAttribute]=None) -> None
    ...
    def SetNext(self, next : XmlAttribute) -> None:
        """
        SetNext(next : XmlAttribute) -> None
...
class XmlDocument(wx.wx.Object):
    """
    XmlDocument() -> None
    XmlDocument(doc : XmlDocument) -> None
    XmlDocument(filename : str, encoding: str="UTF-8") -> None
    XmlDocument(stream : InputStream, encoding: str="UTF-8") -> None
    ...
    def AppendToProlog(self, node : XmlNode) -> None:
        """
        AppendToProlog(node : XmlNode) -> None
    ...
    def Load(self, filename : str, encoding: str="UTF-8", flags: int=XMLDOC_NONE) -> bool:
        """
        Load(filename : str, encoding: str="UTF-8", flags: int=XMLDOC_NONE) -> bool
        Load(stream : InputStream, encoding: str="UTF-8", flags: int=XMLDOC_NONE) -> bool
    ...
    def Save(self, filename : str, indentstep: int=2) -> bool:
        """
        Save(filename : str, indentstep: int=2) -> bool
        Save(stream : OutputStream, indentstep: int=2) -> bool
    ...
    def SetDocumentNode(self, node : XmlNode) -> None:
        """
        SetDocumentNode(node : XmlNode) -> None
    ...
    def SetFileEncoding(self, encoding : str) -> None:
        """
        SetFileEncoding(encoding : str) -> None
    ...
    def SetDoctype(self, doctype : XmlDoctype) -> None:
        """
        SetDoctype(doctype : XmlDoctype) -> None
    ...
    def SetFileType(self, fileType : TextFileType) -> None:
        """
        SetFileType(fileType : TextFileType) -> None
    ...
    DocumentNode = property(GetDocumentNode, SetDocumentNode)
    EOL = property(GetEOL)
    FileEncoding = property(GetFileEncoding, SetFileEncoding)
...
class XmlDoctype:
    """
    XmlDoctype(rootName: str="", systemId: str="", publicId: str="") -> None
    ...
    def IsValid(self, ) -> bool:
        ...
        """
    FullString = property(GetFullString)
    PublicId = property(GetPublicId)
    RootName = property(GetRootName)
    SystemId = property(GetSystemId)
