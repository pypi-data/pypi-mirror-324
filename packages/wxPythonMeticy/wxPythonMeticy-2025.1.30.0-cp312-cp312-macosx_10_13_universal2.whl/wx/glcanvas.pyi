...
_GL_COMPAT_PROFILE = _enum_22._GL_COMPAT_PROFILE
...
class GLAttribsBase:
    ...
    def AddAttribute(self, attribute : int) -> None:
        """
        AddAttribute(attribute : int) -> None
    ...
    def AddAttribBits(self, searchVal : int, combineVal : int) -> None:
        """
        AddAttribBits(searchVal : int, combineVal : int) -> None
    ...
    def SetNeedsARB(self, needsARB: bool=True) -> None:
        """
        SetNeedsARB(needsARB: bool=True) -> None
...
class GLAttributes(GLAttribsBase):
    ...
    def BufferSize(self, val : int) -> GLAttributes:
        """
        BufferSize(val : int) -> GLAttributes
    ...
    def AuxBuffers(self, val : int) -> GLAttributes:
        """
        AuxBuffers(val : int) -> GLAttributes
    ...
    def MinRGBA(self, mRed : int, mGreen : int, mBlue : int, mAlpha : int) -> GLAttributes:
        """
        MinRGBA(mRed : int, mGreen : int, mBlue : int, mAlpha : int) -> GLAttributes
    ...
    def MinAcumRGBA(self, mRed : int, mGreen : int, mBlue : int, mAlpha : int) -> GLAttributes:
        """
        MinAcumRGBA(mRed : int, mGreen : int, mBlue : int, mAlpha : int) -> GLAttributes
    ...
    def SampleBuffers(self, val : int) -> GLAttributes:
        """
        SampleBuffers(val : int) -> GLAttributes
...
class GLContextAttrs(GLAttribsBase):
    ...
    def MajorVersion(self, val : int) -> GLContextAttrs:
        """
        MajorVersion(val : int) -> GLContextAttrs
    ...
    def MinorVersion(self, val : int) -> GLContextAttrs:
        """
        MinorVersion(val : int) -> GLContextAttrs
    ...
    def OGLVersion(self, vmayor : int, vminor : int) -> GLContextAttrs:
        """
        OGLVersion(vmayor : int, vminor : int) -> GLContextAttrs
    ...
    def ReleaseFlush(self, val: int=1) -> GLContextAttrs:
        """
        ReleaseFlush(val: int=1) -> GLContextAttrs
...
class GLContext(Object):
    """
    GLContext(win : GLCanvas, other: Optional[GLContext]=None, ctxAttrs: Optional[GLContextAttrs]=None) -> None
...
class GLCanvas(Window):
    """
    GLCanvas(parent : Window, dispAttrs : GLAttributes, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=GLCanvasName, palette: Palette=NullPalette) -> None
    ...
    def SetCurrent(self, context : GLContext) -> bool:
        """
        SetCurrent(context : GLContext) -> bool
    ...
    def IsDisplaySupported(dispAttrs : GLAttributes) -> bool:
        """
        IsDisplaySupported(dispAttrs : GLAttributes) -> bool
        IsDisplaySupported(attribList : List[int]) -> bool
    ...
    def IsExtensionSupported(extension : str) -> bool:
        """
        IsExtensionSupported(extension : str) -> bool
    ...
    def GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes:
        """
        GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes
        """
