...
class MediaCtrl(wx.Control):
    ...
    def Create(self, parent : wx.Window, id: int=-1, fileName: str='', pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=0, szBackend: str='', validator: wx.Validator=wx.DefaultValidator, name: str="mediaCtrl") -> bool:
        """
        Create(parent : wx.Window, id: int=-1, fileName: str='', pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=0, szBackend: str='', validator: wx.Validator=wx.DefaultValidator, name: str="mediaCtrl") -> bool
    ...
    def LoadURIWithProxy(self, uri : str, proxy : str) -> bool:
        """
        LoadURIWithProxy(uri : str, proxy : str) -> bool
    ...
    def Seek(self, where : FileOffset, mode: wx.SeekMode=wx.FromStart) -> FileOffset:
        """
        Seek(where : FileOffset, mode: wx.SeekMode=wx.FromStart) -> FileOffset
    ...
    def SetPlaybackRate(self, dRate : float) -> bool:
        """
        SetPlaybackRate(dRate : float) -> bool
    ...
    def ShowPlayerControls(self, flags: MediaCtrlPlayerControls=MEDIACTRLPLAYERCONTROLS_DEFAULT) -> bool:
        """
        ShowPlayerControls(flags: MediaCtrlPlayerControls=MEDIACTRLPLAYERCONTROLS_DEFAULT) -> bool
    ...
    PlaybackRate = property(GetPlaybackRate, SetPlaybackRate)
...
class MediaEvent(wx.NotifyEvent):
    """
    MediaEvent(commandType: EventType=wx.wxEVT_NULL, winid: int=0) -> None
