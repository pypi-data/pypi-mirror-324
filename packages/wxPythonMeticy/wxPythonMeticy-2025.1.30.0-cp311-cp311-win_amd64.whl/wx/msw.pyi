...
class PyAxBaseWindow(wx.Window):
    """
    PyAxBaseWindow(parent : wx.Window, id: int=-1, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=0, name: str=wx.PanelNameStr) -> None
    PyAxBaseWindow() -> None
    ...
    def MSWTranslateMessage(self, msg : WXMSG) -> bool:
        """
        MSWTranslateMessage(msg : WXMSG) -> bool
        """
