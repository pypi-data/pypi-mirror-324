...
PyDoc_STRVAR(doc_wxPGChoicesData_CopyDataFrom, "CopyDataFrom(data : PGChoicesData) -> None");
...
PyDoc_STRVAR(doc_wxPGChoicesData_Insert, "Insert(index : int, item : PGChoiceEntry) -> PGChoiceEntry");
...
PyDoc_STRVAR(doc_wxPGChoicesData_Item, "Item(i : int) -> PGChoiceEntry");
