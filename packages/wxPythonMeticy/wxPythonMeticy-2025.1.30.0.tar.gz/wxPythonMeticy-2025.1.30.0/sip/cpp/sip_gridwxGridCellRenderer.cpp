...
PyDoc_STRVAR(doc_wxGridCellRenderer_Draw, "Draw(grid : Grid, attr : GridCellAttr, dc : wx.DC, rect : wx.Rect, row : int, col : int, isSelected : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellRenderer_GetBestSize, "GetBestSize(grid : Grid, attr : GridCellAttr, dc : wx.DC, row : int, col : int) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellRenderer_GetBestHeight, "GetBestHeight(grid : Grid, attr : GridCellAttr, dc : wx.DC, row : int, col : int, width : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellRenderer_GetBestWidth, "GetBestWidth(grid : Grid, attr : GridCellAttr, dc : wx.DC, row : int, col : int, height : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellRenderer_GetMaxBestSize, "GetMaxBestSize(grid : Grid, attr : GridCellAttr, dc : wx.DC) -> wx.Size\n"
"\n"
