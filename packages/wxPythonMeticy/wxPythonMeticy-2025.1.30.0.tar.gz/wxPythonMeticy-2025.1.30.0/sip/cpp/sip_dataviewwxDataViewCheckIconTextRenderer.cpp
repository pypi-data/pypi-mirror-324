...
PyDoc_STRVAR(doc_wxDataViewCheckIconTextRenderer_Allow3rdStateForUser, "Allow3rdStateForUser(allow: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCheckIconTextRenderer, "DataViewCheckIconTextRenderer(mode: DataViewCellMode=DATAVIEW_CELL_ACTIVATABLE, align: int=DVR_DEFAULT_ALIGNMENT) -> None\n"
"\n"
