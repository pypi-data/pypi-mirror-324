...
PyDoc_STRVAR(doc_wxTextAttr_GetFontAttributes, "GetFontAttributes(font : Font, flags: int=TEXT_ATTR_FONT) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_HasFlag, "HasFlag(flag : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetAlignment, "SetAlignment(alignment : TextAttrAlignment) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetBackgroundColour, "SetBackgroundColour(colBack : Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetBulletFont, "SetBulletFont(font : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetBulletName, "SetBulletName(name : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetBulletNumber, "SetBulletNumber(n : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetBulletStyle, "SetBulletStyle(style : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetBulletText, "SetBulletText(text : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetCharacterStyleName, "SetCharacterStyleName(name : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetFlags, "SetFlags(flags : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetFontEncoding, "SetFontEncoding(encoding : FontEncoding) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetFontFaceName, "SetFontFaceName(faceName : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetFontFamily, "SetFontFamily(family : FontFamily) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetFontSize, "SetFontSize(pointSize : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetFontPointSize, "SetFontPointSize(pointSize : int) -> None\n"
"\n"
"Sets the font size in points.");
...
PyDoc_STRVAR(doc_wxTextAttr_SetFontPixelSize, "SetFontPixelSize(pixelSize : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetFontStyle, "SetFontStyle(fontStyle : FontStyle) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetFontUnderlined, "SetFontUnderlined(underlined : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetFontUnderlineType, "SetFontUnderlineType(type : TextAttrUnderlineType, colour: Colour=NullColour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetFontWeight, "SetFontWeight(fontWeight : FontWeight) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetLeftIndent, "SetLeftIndent(indent : int, subIndent: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetLineSpacing, "SetLineSpacing(spacing : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetListStyleName, "SetListStyleName(name : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetOutlineLevel, "SetOutlineLevel(level : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetPageBreak, "SetPageBreak(pageBreak: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetParagraphSpacingAfter, "SetParagraphSpacingAfter(spacing : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetParagraphSpacingBefore, "SetParagraphSpacingBefore(spacing : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetParagraphStyleName, "SetParagraphStyleName(name : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetRightIndent, "SetRightIndent(indent : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetTabs, "SetTabs(tabs : List[int]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetTextColour, "SetTextColour(colText : Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetTextEffectFlags, "SetTextEffectFlags(flags : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetTextEffects, "SetTextEffects(effects : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_SetURL, "SetURL(url : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_Apply, "Apply(style : TextAttr, compareWith: Optional[TextAttr]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_Merge, "Merge(overlay : TextAttr) -> None\n"
"Merge(base : TextAttr, overlay : TextAttr) -> TextAttr\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttr_EqPartial, "EqPartial(attr : TextAttr, weakTest: bool=True) -> bool\n"
"\n"
...
"TextAttr(colText : Colour, colBack: Colour=NullColour, font: Font=NullFont, alignment: TextAttrAlignment=TEXT_ALIGNMENT_DEFAULT) -> None\n"
