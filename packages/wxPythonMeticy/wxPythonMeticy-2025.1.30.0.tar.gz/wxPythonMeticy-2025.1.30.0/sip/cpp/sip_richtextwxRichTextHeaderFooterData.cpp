...
PyDoc_STRVAR(doc_wxRichTextHeaderFooterData_Copy, "Copy(data : RichTextHeaderFooterData) -> None\n"
"\n"
"Copies the data.");
...
PyDoc_STRVAR(doc_wxRichTextHeaderFooterData_GetFooterText, "GetFooterText(page: RichTextOddEvenPage=RICHTEXT_PAGE_EVEN, location: RichTextPageLocation=RICHTEXT_PAGE_CENTRE) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextHeaderFooterData_GetHeaderText, "GetHeaderText(page: RichTextOddEvenPage=RICHTEXT_PAGE_EVEN, location: RichTextPageLocation=RICHTEXT_PAGE_CENTRE) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextHeaderFooterData_GetText, "GetText(headerFooter : int, page : RichTextOddEvenPage, location : RichTextPageLocation) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextHeaderFooterData_SetFont, "SetFont(font : wx.Font) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextHeaderFooterData_SetFooterText, "SetFooterText(text : str, page: RichTextOddEvenPage=RICHTEXT_PAGE_ALL, location: RichTextPageLocation=RICHTEXT_PAGE_CENTRE) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextHeaderFooterData_SetHeaderText, "SetHeaderText(text : str, page: RichTextOddEvenPage=RICHTEXT_PAGE_ALL, location: RichTextPageLocation=RICHTEXT_PAGE_CENTRE) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextHeaderFooterData_SetMargins, "SetMargins(headerMargin : int, footerMargin : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextHeaderFooterData_SetShowOnFirstPage, "SetShowOnFirstPage(showOnFirstPage : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextHeaderFooterData_SetText, "SetText(text : str, headerFooter : int, page : RichTextOddEvenPage, location : RichTextPageLocation) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextHeaderFooterData_SetTextColour, "SetTextColour(col : wx.Colour) -> None\n"
"\n"
