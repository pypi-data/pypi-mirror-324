...
PyDoc_STRVAR(doc_wxAffineMatrix2D_IsEqual, "IsEqual(t : AffineMatrix2DBase) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2D_Set, "Set(mat2D : Matrix2D, tr : Point2DDouble) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2D_Concat, "Concat(t : AffineMatrix2DBase) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2D_Translate, "Translate(dx : float, dy : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2D_Scale, "Scale(xScale : float, yScale : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2D_Mirror, "Mirror(direction: int=HORIZONTAL) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2D_Rotate, "Rotate(cRadians : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2D_TransformPoint, "TransformPoint(p : Point2DDouble) -> Point2DDouble\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2D_TransformDistance, "TransformDistance(p : Point2DDouble) -> Point2DDouble\n"
