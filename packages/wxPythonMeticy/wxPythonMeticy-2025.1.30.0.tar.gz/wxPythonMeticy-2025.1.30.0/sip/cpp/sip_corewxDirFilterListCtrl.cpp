...
PyDoc_STRVAR(doc_wxDirFilterListCtrl_Create, "Create(parent : GenericDirCtrl, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0) -> bool");
...
PyDoc_STRVAR(doc_wxDirFilterListCtrl_FillFilterList, "FillFilterList(filter : str, defaultFilter : int) -> None");
...
"DirFilterListCtrl(parent : GenericDirCtrl, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0) -> None");
