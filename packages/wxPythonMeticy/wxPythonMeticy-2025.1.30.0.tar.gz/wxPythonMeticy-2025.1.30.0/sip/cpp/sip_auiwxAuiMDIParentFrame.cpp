...
PyDoc_STRVAR(doc_wxAuiMDIParentFrame_Create, "Create(parent : wx.Window, winid: int=wx.ID_ANY, title: str='', pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=wx.DEFAULT_FRAME_STYLE|wx.VSCROLL|wx.HSCROLL, name: str=wx.FrameNameStr) -> bool");
...
PyDoc_STRVAR(doc_wxAuiMDIParentFrame_SetArtProvider, "SetArtProvider(provider : AuiTabArt) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIParentFrame_SetWindowMenu, "SetWindowMenu(pMenu : wx.Menu) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIParentFrame_SetMenuBar, "SetMenuBar(menuBar : wx.MenuBar) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiMDIParentFrame_SetChildMenuBar, "SetChildMenuBar(pChild : AuiMDIChildFrame) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIParentFrame_SetActiveChild, "SetActiveChild(pChildFrame : AuiMDIChildFrame) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIParentFrame_Tile, "Tile(orient: wx.Orientation=wx.HORIZONTAL) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIParentFrame_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
