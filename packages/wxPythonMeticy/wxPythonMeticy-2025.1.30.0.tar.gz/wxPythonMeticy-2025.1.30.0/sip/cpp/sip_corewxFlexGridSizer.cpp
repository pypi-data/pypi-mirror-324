...
PyDoc_STRVAR(doc_wxFlexGridSizer_AddGrowableCol, "AddGrowableCol(idx : int, proportion: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFlexGridSizer_AddGrowableRow, "AddGrowableRow(idx : int, proportion: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFlexGridSizer_IsColGrowable, "IsColGrowable(idx : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFlexGridSizer_IsRowGrowable, "IsRowGrowable(idx : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFlexGridSizer_RemoveGrowableCol, "RemoveGrowableCol(idx : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFlexGridSizer_RemoveGrowableRow, "RemoveGrowableRow(idx : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFlexGridSizer_SetFlexibleDirection, "SetFlexibleDirection(direction : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFlexGridSizer_SetNonFlexibleGrowMode, "SetNonFlexibleGrowMode(mode : FlexSizerGrowMode) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFlexGridSizer_RepositionChildren, "RepositionChildren(minSize : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFlexGridSizer, "FlexGridSizer(cols : int, vgap : int, hgap : int) -> None\n"
"FlexGridSizer(cols : int, gap: Size=Size(0,0)) -> None\n"
"FlexGridSizer(rows : int, cols : int, vgap : int, hgap : int) -> None\n"
"FlexGridSizer(rows : int, cols : int, gap : Size) -> None\n"
"\n"
