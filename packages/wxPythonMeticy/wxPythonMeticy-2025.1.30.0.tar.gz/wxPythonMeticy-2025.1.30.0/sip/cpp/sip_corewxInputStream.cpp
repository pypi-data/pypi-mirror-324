...
PyDoc_STRVAR(doc_wxInputStream_Read, "Read(buffer : Any, size : int) -> InputStream\n"
"Read(stream_out : OutputStream) -> InputStream\n"
"\n"
...
PyDoc_STRVAR(doc_wxInputStream_ReadAll, "ReadAll(buffer : Any, size : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxInputStream_SeekI, "SeekI(pos : FileOffset, mode: SeekMode=FromStart) -> FileOffset\n"
"\n"
...
PyDoc_STRVAR(doc_wxInputStream_Ungetch, "Ungetch(buffer : Any, size : int) -> int\n"
"Ungetch(c : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxInputStream_seek, "seek(offset: FileOffset, whence: int=0) -> None");
