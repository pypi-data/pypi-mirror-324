...
PyDoc_STRVAR(doc_wxIntProperty_ValueToString, "ValueToString(value : PGVariant, argFlags: int=0) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxIntProperty_StringToValue, "StringToValue(text : str, argFlags: int=0) -> Tuple[bool, PGVariant]\n"
"\n"
...
PyDoc_STRVAR(doc_wxIntProperty_ValidateValue, "ValidateValue(value : PGVariant, validationInfo : PGValidationInfo) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxIntProperty_IntToValue, "IntToValue(number : int, argFlags: int=0) -> Tuple[bool, PGVariant]\n"
"\n"
...
PyDoc_STRVAR(doc_wxIntProperty_AddSpinStepValue, "AddSpinStepValue(stepScale : int) -> PGVariant\n"
"\n"
...
PyDoc_STRVAR(doc_wxIntProperty, "IntProperty(label: str=PG_LABEL, name: str=PG_LABEL, value: int=0) -> None\n"
"IntProperty(label : str, name : str, value : int) -> None\n"
"\n"
