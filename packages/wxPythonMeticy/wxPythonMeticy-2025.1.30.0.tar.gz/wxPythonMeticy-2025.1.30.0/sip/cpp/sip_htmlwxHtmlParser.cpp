...
PyDoc_STRVAR(doc_wxHtmlParser_AddTagHandler, "AddTagHandler(handler : HtmlTagHandler) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlParser_InitParser, "InitParser(source : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlParser_OpenURL, "OpenURL(type : HtmlURLType, url : str) -> wx.FSFile\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlParser_Parse, "Parse(source : str) -> wx.Object\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlParser_PushTagHandler, "PushTagHandler(handler : HtmlTagHandler, tags : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlParser_SetFS, "SetFS(fs : wx.FileSystem) -> None\n"
"\n"
