...
PyDoc_STRVAR(doc_wxNativePixelData_Accessor_Reset, "Reset(data : NativePixelData) -> None");
...
PyDoc_STRVAR(doc_wxNativePixelData_Accessor_Offset, "Offset(data : NativePixelData, x : int, y : int) -> None");
...
PyDoc_STRVAR(doc_wxNativePixelData_Accessor_OffsetX, "OffsetX(data : NativePixelData, x : int) -> None");
...
PyDoc_STRVAR(doc_wxNativePixelData_Accessor_OffsetY, "OffsetY(data : NativePixelData, y : int) -> None");
...
PyDoc_STRVAR(doc_wxNativePixelData_Accessor_MoveTo, "MoveTo(data : NativePixelData, x : int, y : int) -> None");
...
PyDoc_STRVAR(doc_wxNativePixelData_Accessor_Set, "Set(red: int, green: int, blue: int) -> None");
...
PyDoc_STRVAR(doc_wxNativePixelData_Accessor, "NativePixelData_Accessor(data : NativePixelData) -> None\n"
"NativePixelData_Accessor(bmp : Bitmap, data : NativePixelData) -> None\n"
