...
PyDoc_STRVAR(doc_wxListBox_Create, "Create(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, choices: List[str]=[], style: int=0, validator: Validator=DefaultValidator, name: str=ListBoxNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxListBox_Deselect, "Deselect(n : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxListBox_SetSelection, "SetSelection(n : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxListBox_SetStringSelection, "SetStringSelection(s : str, select : bool) -> bool\n"
"SetStringSelection(s : str) -> bool\n"
"");
...
PyDoc_STRVAR(doc_wxListBox_HitTest, "HitTest(point : Point) -> int\n"
...
PyDoc_STRVAR(doc_wxListBox_InsertItems, "InsertItems(items : List[str], pos : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxListBox_IsSelected, "IsSelected(n : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxListBox_SetFirstItem, "SetFirstItem(n : int) -> None\n"
"SetFirstItem(string : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxListBox_EnsureVisible, "EnsureVisible(n : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxListBox_MSWSetTabStops, "MSWSetTabStops(tabStops: List[int]) -> None");
...
PyDoc_STRVAR(doc_wxListBox_GetString, "GetString(n : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxListBox_SetString, "SetString(n : int, string : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxListBox_FindString, "FindString(string : str, caseSensitive: bool=False) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxListBox_SetItemForegroundColour, "SetItemForegroundColour(item: int, c: Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxListBox_SetItemBackgroundColour, "SetItemBackgroundColour(item: int, c: Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxListBox_SetItemFont, "SetItemFont(item: int, f: Font) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxListBox_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"ListBox(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, choices: List[str]=[], style: int=0, validator: Validator=DefaultValidator, name: str=ListBoxNameStr) -> None\n"
"\n"
