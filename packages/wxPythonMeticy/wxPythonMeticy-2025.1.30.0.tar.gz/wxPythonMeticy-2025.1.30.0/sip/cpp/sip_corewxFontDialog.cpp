...
PyDoc_STRVAR(doc_wxFontDialog_Create, "Create(parent : Window) -> bool\n"
"Create(parent : Window, data : FontData) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontDialog_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
