...
PyDoc_STRVAR(doc_wxGridCellBoolEditor_IsTrueValue, "IsTrueValue(value : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellBoolEditor_UseStringValues, "UseStringValues(valueTrue: str=\"1\", valueFalse: str='') -> None\n"
"\n"
