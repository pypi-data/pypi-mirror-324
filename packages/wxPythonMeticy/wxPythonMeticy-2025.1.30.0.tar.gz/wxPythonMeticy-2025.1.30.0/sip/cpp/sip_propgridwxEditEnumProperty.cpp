...
PyDoc_STRVAR(doc_wxEditEnumProperty, "EditEnumProperty(label: str=PG_LABEL, name: str=PG_LABEL, labels: List[str]=[], values: List[int]=[], value: str='') -> None\n"
"EditEnumProperty(label : str, name : str, choices : PGChoices, value: str='') -> None\n"
"\n"
