...
PyDoc_STRVAR(doc_wxSplitterEvent_SetSashPosition, "SetSashPosition(pos : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSplitterEvent_SetSize, "SetSize(oldSize : int, newSize : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSplitterEvent, "SplitterEvent(eventType: EventType=wxEVT_NULL, splitter: Optional[SplitterWindow]=None) -> None\n"
"\n"
