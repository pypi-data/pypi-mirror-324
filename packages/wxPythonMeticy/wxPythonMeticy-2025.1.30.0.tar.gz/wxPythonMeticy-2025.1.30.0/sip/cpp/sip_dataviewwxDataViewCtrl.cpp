...
PyDoc_STRVAR(doc_wxDataViewCtrl_AppendBitmapColumn, "AppendBitmapColumn(label : str, model_column : int, mode: DataViewCellMode=DATAVIEW_CELL_INERT, width: int=wx.COL_WIDTH_DEFAULT, align: wx.Alignment=wx.ALIGN_CENTER, flags: int=DATAVIEW_COL_RESIZABLE) -> DataViewColumn\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_PrependBitmapColumn, "PrependBitmapColumn(label : str, model_column : int, mode: DataViewCellMode=DATAVIEW_CELL_INERT, width: int=wx.COL_WIDTH_DEFAULT, align: wx.Alignment=wx.ALIGN_CENTER, flags: int=DATAVIEW_COL_RESIZABLE) -> DataViewColumn\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_AppendDateColumn, "AppendDateColumn(label : str, model_column : int, mode: DataViewCellMode=DATAVIEW_CELL_ACTIVATABLE, width: int=wx.COL_WIDTH_DEFAULT, align: wx.Alignment=wx.ALIGN_NOT, flags: int=DATAVIEW_COL_RESIZABLE) -> DataViewColumn\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_PrependDateColumn, "PrependDateColumn(label : str, model_column : int, mode: DataViewCellMode=DATAVIEW_CELL_ACTIVATABLE, width: int=wx.COL_WIDTH_DEFAULT, align: wx.Alignment=wx.ALIGN_NOT, flags: int=DATAVIEW_COL_RESIZABLE) -> DataViewColumn\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_AppendIconTextColumn, "AppendIconTextColumn(label : str, model_column : int, mode: DataViewCellMode=DATAVIEW_CELL_INERT, width: int=wx.COL_WIDTH_DEFAULT, align: wx.Alignment=wx.ALIGN_NOT, flags: int=DATAVIEW_COL_RESIZABLE) -> DataViewColumn\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_PrependIconTextColumn, "PrependIconTextColumn(label : str, model_column : int, mode: DataViewCellMode=DATAVIEW_CELL_INERT, width: int=wx.COL_WIDTH_DEFAULT, align: wx.Alignment=wx.ALIGN_NOT, flags: int=DATAVIEW_COL_RESIZABLE) -> DataViewColumn\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_AppendProgressColumn, "AppendProgressColumn(label : str, model_column : int, mode: DataViewCellMode=DATAVIEW_CELL_INERT, width: int=80, align: wx.Alignment=wx.ALIGN_CENTER, flags: int=DATAVIEW_COL_RESIZABLE) -> DataViewColumn\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_PrependProgressColumn, "PrependProgressColumn(label : str, model_column : int, mode: DataViewCellMode=DATAVIEW_CELL_INERT, width: int=80, align: wx.Alignment=wx.ALIGN_CENTER, flags: int=DATAVIEW_COL_RESIZABLE) -> DataViewColumn\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_AppendTextColumn, "AppendTextColumn(label : str, model_column : int, mode: DataViewCellMode=DATAVIEW_CELL_INERT, width: int=wx.COL_WIDTH_DEFAULT, align: wx.Alignment=wx.ALIGN_NOT, flags: int=DATAVIEW_COL_RESIZABLE) -> DataViewColumn\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_PrependTextColumn, "PrependTextColumn(label : str, model_column : int, mode: DataViewCellMode=DATAVIEW_CELL_INERT, width: int=wx.COL_WIDTH_DEFAULT, align: wx.Alignment=wx.ALIGN_NOT, flags: int=DATAVIEW_COL_RESIZABLE) -> DataViewColumn\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_AppendToggleColumn, "AppendToggleColumn(label : str, model_column : int, mode: DataViewCellMode=DATAVIEW_CELL_INERT, width: int=30, align: wx.Alignment=wx.ALIGN_CENTER, flags: int=DATAVIEW_COL_RESIZABLE) -> DataViewColumn\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_PrependToggleColumn, "PrependToggleColumn(label : str, model_column : int, mode: DataViewCellMode=DATAVIEW_CELL_INERT, width: int=30, align: wx.Alignment=wx.ALIGN_CENTER, flags: int=DATAVIEW_COL_RESIZABLE) -> DataViewColumn\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_AllowMultiColumnSort, "AllowMultiColumnSort(allow : bool) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_Create, "Create(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=0, validator: wx.Validator=wx.DefaultValidator, name: str=DataViewCtrlNameStr) -> bool\n"
"\n"
"Create the control.");
...
PyDoc_STRVAR(doc_wxDataViewCtrl_AppendColumn, "AppendColumn(col : DataViewColumn) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_PrependColumn, "PrependColumn(col : DataViewColumn) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_InsertColumn, "InsertColumn(pos : int, col : DataViewColumn) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl__AssociateModel, "_AssociateModel(model : DataViewModel) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_Collapse, "Collapse(item : DataViewItem) -> None\n"
"\n"
"Collapses the item.");
...
PyDoc_STRVAR(doc_wxDataViewCtrl_DeleteColumn, "DeleteColumn(column : DataViewColumn) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_EditItem, "EditItem(item : DataViewItem, column : DataViewColumn) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_EnableDragSource, "EnableDragSource(format : wx.DataFormat) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_EnableDropTargets, "EnableDropTargets(formats : VectorwxDataFormat) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_EnableDropTarget, "EnableDropTarget(format : wx.DataFormat) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_EnsureVisible, "EnsureVisible(item : DataViewItem, column: Optional[DataViewColumn]=None) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_Expand, "Expand(item : DataViewItem) -> None\n"
"\n"
"Expands the item.");
...
PyDoc_STRVAR(doc_wxDataViewCtrl_ExpandAncestors, "ExpandAncestors(item : DataViewItem) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_ExpandChildren, "ExpandChildren(item : DataViewItem) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_GetColumn, "GetColumn(pos : int) -> DataViewColumn\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_GetColumnPosition, "GetColumnPosition(column : DataViewColumn) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_GetItemRect, "GetItemRect(item : DataViewItem, col: Optional[DataViewColumn]=None) -> wx.Rect\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_HitTest, "HitTest(point: wx.Point) -> Any\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_IsExpanded, "IsExpanded(item : DataViewItem) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_IsSelected, "IsSelected(item : DataViewItem) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_Select, "Select(item : DataViewItem) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_SetAlternateRowColour, "SetAlternateRowColour(colour : wx.Colour) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_SetExpanderColumn, "SetExpanderColumn(col : DataViewColumn) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_SetCurrentItem, "SetCurrentItem(item : DataViewItem) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_SetHeaderAttr, "SetHeaderAttr(attr : wx.ItemAttr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_SetIndent, "SetIndent(indent : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_SetSelections, "SetSelections(sel : DataViewItemArray) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_Unselect, "Unselect(item : DataViewItem) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_SetRowHeight, "SetRowHeight(rowHeight : int) -> bool\n"
"\n"
"Sets the row height.");
...
PyDoc_STRVAR(doc_wxDataViewCtrl_ToggleSortByColumn, "ToggleSortByColumn(column : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCtrl_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
...
PyDoc_STRVAR(doc_wxDataViewCtrl_EnableSystemTheme, "EnableSystemTheme(enable: bool=True) -> None\n"
"\n"
