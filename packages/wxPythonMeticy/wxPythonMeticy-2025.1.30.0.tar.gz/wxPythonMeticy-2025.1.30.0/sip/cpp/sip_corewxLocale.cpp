...
PyDoc_STRVAR(doc_wxLocale_AddCatalog, "AddCatalog(domain : str) -> bool\n"
"AddCatalog(domain : str, msgIdLanguage : Language) -> bool\n"
"AddCatalog(domain : str, msgIdLanguage : Language, msgIdCharset : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxLocale_GetHeaderValue, "GetHeaderValue(header : str, domain: str='') -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxLocale_GetString, "GetString(origString : str, domain: str='') -> str\n"
"GetString(origString : str, origString2 : str, n : int, domain: str='') -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxLocale_Init, "Init(language: int=LANGUAGE_DEFAULT, flags: int=LOCALE_LOAD_DEFAULT) -> bool\n"
"Init(name : str, shortName: str='', locale: str='', bLoadDefault: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxLocale_IsLoaded, "IsLoaded(domain : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxLocale_AddCatalogLookupPathPrefix, "AddCatalogLookupPathPrefix(prefix : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxLocale_AddLanguage, "AddLanguage(info : LanguageInfo) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxLocale_FindLanguageInfo, "FindLanguageInfo(locale : str) -> LanguageInfo\n"
"\n"
...
PyDoc_STRVAR(doc_wxLocale_GetLanguageInfo, "GetLanguageInfo(lang : int) -> LanguageInfo\n"
"\n"
...
PyDoc_STRVAR(doc_wxLocale_GetLanguageName, "GetLanguageName(lang : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxLocale_GetLanguageCanonicalName, "GetLanguageCanonicalName(lang : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxLocale_GetInfo, "GetInfo(index : LocaleInfo, cat: LocaleCategory=LOCALE_CAT_DEFAULT) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxLocale_GetOSInfo, "GetOSInfo(index : LocaleInfo, cat: LocaleCategory=LOCALE_CAT_DEFAULT) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxLocale_IsAvailable, "IsAvailable(lang : int) -> bool\n"
"\n"
...
"Locale(language : int, flags: int=LOCALE_LOAD_DEFAULT) -> None\n"
"Locale(name : str, shortName: str='', locale: str='', bLoadDefault: bool=True) -> None\n"
"\n"
