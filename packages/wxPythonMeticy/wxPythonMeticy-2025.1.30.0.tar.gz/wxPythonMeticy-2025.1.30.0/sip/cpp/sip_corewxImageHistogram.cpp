...
PyDoc_STRVAR(doc_wxImageHistogram_FindFirstUnusedColour, "FindFirstUnusedColour(startR: int=1, startG: int=0, startB: int=0) -> Tuple[int, int, int]");
...
PyDoc_STRVAR(doc_wxImageHistogram_MakeKey, "MakeKey(r : int, g : int, b : int) -> int");
