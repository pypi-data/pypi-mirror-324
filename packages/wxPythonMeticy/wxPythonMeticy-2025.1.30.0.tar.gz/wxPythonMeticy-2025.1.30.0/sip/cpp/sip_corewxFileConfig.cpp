...
PyDoc_STRVAR(doc_wxFileConfig_Save, "Save(os: OutputStream) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileConfig_SetUmask, "SetUmask(mode : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileConfig_SetPath, "SetPath(strPath : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileConfig_GetNumberOfEntries, "GetNumberOfEntries(bRecursive: bool=False) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileConfig_GetNumberOfGroups, "GetNumberOfGroups(bRecursive: bool=False) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileConfig_HasGroup, "HasGroup(strName : str) -> bool");
...
PyDoc_STRVAR(doc_wxFileConfig_HasEntry, "HasEntry(strName : str) -> bool");
...
PyDoc_STRVAR(doc_wxFileConfig_Flush, "Flush(bCurrentOnly: bool=False) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileConfig_RenameEntry, "RenameEntry(oldName : str, newName : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileConfig_RenameGroup, "RenameGroup(oldName : str, newName : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileConfig_DeleteEntry, "DeleteEntry(key : str, bDeleteGroupIfEmpty: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileConfig_DeleteGroup, "DeleteGroup(key : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileConfig_GetGlobalFileName, "GetGlobalFileName(szFile : str) -> str");
...
PyDoc_STRVAR(doc_wxFileConfig_GetLocalFileName, "GetLocalFileName(szFile : str, style: int=0) -> str");
...
PyDoc_STRVAR(doc_wxFileConfig, "FileConfig(appName: str='', vendorName: str='', localFilename: str='', globalFilename: str='', style: int=CONFIG_USE_LOCAL_FILE|CONFIG_USE_GLOBAL_FILE) -> None\n"
"FileConfig(_is : InputStream) -> None\n"
"\n"
