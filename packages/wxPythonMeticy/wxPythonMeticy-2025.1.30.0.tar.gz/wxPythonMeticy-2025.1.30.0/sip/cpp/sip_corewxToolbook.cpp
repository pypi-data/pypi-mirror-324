...
PyDoc_STRVAR(doc_wxToolbook_Create, "Create(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str='') -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolbook_EnablePage, "EnablePage(page : int, enable : bool) -> bool\n"
"EnablePage(page : Window, enable : bool) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolbook_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"Toolbook(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str='') -> None\n"
"\n"
