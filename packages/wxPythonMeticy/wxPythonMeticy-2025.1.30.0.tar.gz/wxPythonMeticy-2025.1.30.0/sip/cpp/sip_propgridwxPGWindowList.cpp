...
PyDoc_STRVAR(doc_wxPGWindowList_SetSecondary, "SetSecondary(secondary : wx.Window) -> None");
...
PyDoc_STRVAR(doc_wxPGWindowList, "PGWindowList(primary : wx.Window, secondary: Optional[wx.Window]=None) -> None\n"
"\n"
