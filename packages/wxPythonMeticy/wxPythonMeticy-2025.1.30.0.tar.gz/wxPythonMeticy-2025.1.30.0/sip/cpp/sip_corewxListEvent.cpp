...
PyDoc_STRVAR(doc_wxListEvent_SetKeyCode, "SetKeyCode(code : int) -> None");
...
PyDoc_STRVAR(doc_wxListEvent_SetIndex, "SetIndex(index : int) -> None");
...
PyDoc_STRVAR(doc_wxListEvent_SetColumn, "SetColumn(col : int) -> None");
...
PyDoc_STRVAR(doc_wxListEvent_SetPoint, "SetPoint(point : Point) -> None");
...
PyDoc_STRVAR(doc_wxListEvent_SetItem, "SetItem(item : ListItem) -> None");
...
PyDoc_STRVAR(doc_wxListEvent_SetCacheFrom, "SetCacheFrom(cacheFrom : int) -> None");
...
PyDoc_STRVAR(doc_wxListEvent_SetCacheTo, "SetCacheTo(cacheTo : int) -> None");
...
PyDoc_STRVAR(doc_wxListEvent, "ListEvent(commandType: EventType=wxEVT_NULL, id: int=0) -> None\n"
"\n"
