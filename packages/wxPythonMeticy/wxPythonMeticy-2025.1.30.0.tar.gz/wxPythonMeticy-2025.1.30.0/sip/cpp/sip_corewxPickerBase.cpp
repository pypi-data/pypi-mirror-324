...
PyDoc_STRVAR(doc_wxPickerBase_CreateBase, "CreateBase(parent : Window, id: int=ID_ANY, text: str='', pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, validator: Validator=DefaultValidator, name: str=ButtonNameStr) -> bool");
...
PyDoc_STRVAR(doc_wxPickerBase_SetInternalMargin, "SetInternalMargin(margin : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPickerBase_SetPickerCtrlGrowable, "SetPickerCtrlGrowable(grow: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPickerBase_SetPickerCtrlProportion, "SetPickerCtrlProportion(prop : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPickerBase_SetTextCtrlGrowable, "SetTextCtrlGrowable(grow: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPickerBase_SetTextCtrlProportion, "SetTextCtrlProportion(prop : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPickerBase_SetTextCtrl, "SetTextCtrl(text : TextCtrl) -> None");
...
PyDoc_STRVAR(doc_wxPickerBase_SetPickerCtrl, "SetPickerCtrl(picker : Control) -> None");
...
PyDoc_STRVAR(doc_wxPickerBase_GetTextCtrlStyle, "GetTextCtrlStyle(style : int) -> int");
...
PyDoc_STRVAR(doc_wxPickerBase_GetPickerStyle, "GetPickerStyle(style : int) -> int");
