...
PyDoc_STRVAR(doc_wxSizerItem_AssignSpacer, "AssignSpacer(size : Size) -> None\n"
"AssignSpacer(w : int, h : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerItem_SetRatio, "SetRatio(width : int, height : int) -> None\n"
"SetRatio(size : Size) -> None\n"
...
PyDoc_STRVAR(doc_wxSizerItem_AssignWindow, "AssignWindow(window : Window) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerItem_AssignSizer, "AssignSizer(sizer : Sizer) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerItem_SetMinSize, "SetMinSize(size : Size) -> None\n"
"SetMinSize(x : int, y : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerItem_SetBorder, "SetBorder(border : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerItem_SetDimension, "SetDimension(pos : Point, size : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerItem_SetFlag, "SetFlag(flag : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerItem_SetId, "SetId(id : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerItem_SetInitSize, "SetInitSize(x : int, y : int) -> None\n"
"\n"
"Sets the minimum size to be allocated for this item.");
...
PyDoc_STRVAR(doc_wxSizerItem_SetProportion, "SetProportion(proportion : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerItem_SetUserData, "SetUserData(userData : PyUserData) -> None");
...
PyDoc_STRVAR(doc_wxSizerItem_Show, "Show(show : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerItem, "SizerItem(window : Window, flags : SizerFlags) -> None\n"
"SizerItem(window : Window, proportion: int=0, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> None\n"
"SizerItem(sizer : Sizer, flags : SizerFlags) -> None\n"
"SizerItem(sizer : Sizer, proportion: int=0, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> None\n"
"SizerItem(width : int, height : int, proportion: int=0, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> None\n"
"\n"
