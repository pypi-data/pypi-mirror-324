...
PyDoc_STRVAR(doc_wxPCXHandler_DoGetImageCount, "DoGetImageCount(stream : InputStream) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPCXHandler_LoadFile, "LoadFile(image : Image, stream : InputStream, verbose: bool=True, index: int=-1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPCXHandler_SaveFile, "SaveFile(image : Image, stream : OutputStream, verbose: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPCXHandler_DoCanRead, "DoCanRead(stream : InputStream) -> bool\n"
"\n"
