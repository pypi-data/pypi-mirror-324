...
PyDoc_STRVAR(doc_wxGridStringTable_GetValue, "GetValue(row : int, col : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridStringTable_SetValue, "SetValue(row : int, col : int, value : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridStringTable_InsertRows, "InsertRows(pos: int=0, numRows: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridStringTable_AppendRows, "AppendRows(numRows: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridStringTable_DeleteRows, "DeleteRows(pos: int=0, numRows: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridStringTable_InsertCols, "InsertCols(pos: int=0, numCols: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridStringTable_AppendCols, "AppendCols(numCols: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridStringTable_DeleteCols, "DeleteCols(pos: int=0, numCols: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridStringTable_SetRowLabelValue, "SetRowLabelValue(row : int, label : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridStringTable_SetColLabelValue, "SetColLabelValue(col : int, label : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridStringTable_SetCornerLabelValue, "SetCornerLabelValue( : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridStringTable_GetRowLabelValue, "GetRowLabelValue(row : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridStringTable_GetColLabelValue, "GetColLabelValue(col : int) -> str\n"
"\n"
