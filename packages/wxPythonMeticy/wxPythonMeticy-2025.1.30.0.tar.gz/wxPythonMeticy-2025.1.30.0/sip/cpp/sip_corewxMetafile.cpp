...
PyDoc_STRVAR(doc_wxMetafile_Play, "Play(dc : DC) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxMetafile_SetClipboard, "SetClipboard(width: int=0, height: int=0) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxMetafile, "Metafile(filename: str='') -> None\n"
"\n"
