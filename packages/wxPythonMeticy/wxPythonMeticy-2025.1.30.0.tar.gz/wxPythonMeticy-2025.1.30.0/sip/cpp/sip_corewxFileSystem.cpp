...
PyDoc_STRVAR(doc_wxFileSystem_ChangePathTo, "ChangePathTo(location : str, is_dir: bool=False) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystem_FindFileInPath, "FindFileInPath(pStr : str, path : str, file : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystem_FindFirst, "FindFirst(wildcard : str, flags: int=0) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystem_OpenFile, "OpenFile(location : str, flags: int=FS_READ) -> FSFile\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystem_AddHandler, "AddHandler(handler : FileSystemHandler) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystem_RemoveHandler, "RemoveHandler(handler : FileSystemHandler) -> FileSystemHandler\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystem_FileNameToURL, "FileNameToURL(filename : str) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystem_HasHandlerForPath, "HasHandlerForPath(location : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystem_URLToFileName, "URLToFileName(url : str) -> str\n"
"\n"
