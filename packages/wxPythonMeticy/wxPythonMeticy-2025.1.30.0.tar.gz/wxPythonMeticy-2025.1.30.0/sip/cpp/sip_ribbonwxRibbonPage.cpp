...
PyDoc_STRVAR(doc_wxRibbonPage_DoGetNextSmallerSize, "DoGetNextSmallerSize(direction : wx.Orientation, relative_to : wx.Size) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonPage_DoGetNextLargerSize, "DoGetNextLargerSize(direction : wx.Orientation, relative_to : wx.Size) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonPage_Create, "Create(parent : RibbonBar, id: int=wx.ID_ANY, label: str='', icon: wx.Bitmap=wx.NullBitmap, style: int=0) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonPage_SetArtProvider, "SetArtProvider(art : RibbonArtProvider) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonPage_SetSizeWithScrollButtonAdjustment, "SetSizeWithScrollButtonAdjustment(x : int, y : int, width : int, height : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonPage_AdjustRectToIncludeScrollButtons, "AdjustRectToIncludeScrollButtons(rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonPage_ScrollLines, "ScrollLines(lines : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonPage_ScrollPixels, "ScrollPixels(pixels : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonPage_ScrollSections, "ScrollSections(sections : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonPage_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
