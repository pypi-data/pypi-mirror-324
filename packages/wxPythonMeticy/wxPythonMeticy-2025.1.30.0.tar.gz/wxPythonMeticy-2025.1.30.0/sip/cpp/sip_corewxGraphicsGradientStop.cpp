...
PyDoc_STRVAR(doc_wxGraphicsGradientStop_SetColour, "SetColour(col : Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsGradientStop_SetPosition, "SetPosition(pos : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsGradientStop, "GraphicsGradientStop(col: Colour=TransparentColour, pos: float=0.) -> None\n"
"\n"
