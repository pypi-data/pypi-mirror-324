...
PyDoc_STRVAR(doc_wxGBSpan_SetColspan, "SetColspan(colspan : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGBSpan_SetRowspan, "SetRowspan(rowspan : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGBSpan_Set, "Set(rowspan: int=0, colspan: int=0) -> None\n"
"\n"
