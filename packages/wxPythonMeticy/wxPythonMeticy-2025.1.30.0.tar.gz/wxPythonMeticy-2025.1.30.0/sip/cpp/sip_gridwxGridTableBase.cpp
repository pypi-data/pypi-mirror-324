...
PyDoc_STRVAR(doc_wxGridTableBase_IsEmptyCell, "IsEmptyCell(row : int, col : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_IsEmpty, "IsEmpty(coords : GridCellCoords) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_GetValue, "GetValue(row : int, col : int) -> Any\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_SetValue, "SetValue(row : int, col : int, value : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_GetTypeName, "GetTypeName(row : int, col : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_CanGetValueAs, "CanGetValueAs(row : int, col : int, typeName : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_CanSetValueAs, "CanSetValueAs(row : int, col : int, typeName : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_GetValueAsLong, "GetValueAsLong(row : int, col : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_GetValueAsDouble, "GetValueAsDouble(row : int, col : int) -> float\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_GetValueAsBool, "GetValueAsBool(row : int, col : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_SetValueAsLong, "SetValueAsLong(row : int, col : int, value : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_SetValueAsDouble, "SetValueAsDouble(row : int, col : int, value : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_SetValueAsBool, "SetValueAsBool(row : int, col : int, value : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_InsertRows, "InsertRows(pos: int=0, numRows: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_AppendRows, "AppendRows(numRows: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_DeleteRows, "DeleteRows(pos: int=0, numRows: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_InsertCols, "InsertCols(pos: int=0, numCols: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_AppendCols, "AppendCols(numCols: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_DeleteCols, "DeleteCols(pos: int=0, numCols: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_GetRowLabelValue, "GetRowLabelValue(row : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_GetColLabelValue, "GetColLabelValue(col : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_SetRowLabelValue, "SetRowLabelValue(row : int, label : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_SetColLabelValue, "SetColLabelValue(col : int, label : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_SetCornerLabelValue, "SetCornerLabelValue( : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_SetAttrProvider, "SetAttrProvider(attrProvider : GridCellAttrProvider) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_GetAttr, "GetAttr(row : int, col : int, kind : GridCellAttr.wxAttrKind) -> GridCellAttr\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_GetAttrPtr, "GetAttrPtr(row : int, col : int, kind : GridCellAttr.wxAttrKind) -> GridCellAttrPtr\n"
"\n"
"Return the attribute for the given cell.");
...
PyDoc_STRVAR(doc_wxGridTableBase_SetAttr, "SetAttr(attr : GridCellAttr, row : int, col : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_SetRowAttr, "SetRowAttr(attr : GridCellAttr, row : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_SetColAttr, "SetColAttr(attr : GridCellAttr, col : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_SetView, "SetView(grid : Grid) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridTableBase_CanMeasureColUsingSameAttr, "CanMeasureColUsingSameAttr(col : int) -> bool\n"
"\n"
