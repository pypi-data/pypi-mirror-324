...
PyDoc_STRVAR(doc_wxImage_Create, "Create(width : int, height : int, clear: bool=True) -> bool\n"
"Create(sz : Size, clear: bool=True) -> bool\n"
"Create(width: int, height: int, data: PyBuffer) -> bool\n"
"Create(width: int, height: int, data: PyBuffer, alpha: PyBuffer) -> bool\n"
"Create(size: Size, data: PyBuffer) -> bool\n"
"Create(size: Size, data: PyBuffer, alpha: PyBuffer) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_Clear, "Clear(value: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_Blur, "Blur(blurRadius : int) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_BlurHorizontal, "BlurHorizontal(blurRadius : int) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_BlurVertical, "BlurVertical(blurRadius : int) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_Mirror, "Mirror(horizontally: bool=True) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_Paste, "Paste(image : Image, x : int, y : int, alphaBlend: ImageAlphaBlendMode=IMAGE_ALPHA_BLEND_OVER) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_Replace, "Replace(r1 : int, g1 : int, b1 : int, r2 : int, g2 : int, b2 : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_Rescale, "Rescale(width : int, height : int, quality: ImageResizeQuality=IMAGE_QUALITY_NORMAL) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_Resize, "Resize(size : Size, pos : Point, red: int=-1, green: int=-1, blue: int=-1) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_Rotate, "Rotate(angle : float, rotationCentre : Point, interpolating: bool=True, offsetAfterRotation: Optional[Point]=None) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_Rotate90, "Rotate90(clockwise: bool=True) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_RotateHue, "RotateHue(angle : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_ChangeSaturation, "ChangeSaturation(factor : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_ChangeBrightness, "ChangeBrightness(factor : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_ChangeHSV, "ChangeHSV(angleH : float, factorS : float, factorV : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_Scale, "Scale(width : int, height : int, quality: ImageResizeQuality=IMAGE_QUALITY_NORMAL) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_Size, "Size(size : Size, pos : Point, red: int=-1, green: int=-1, blue: int=-1) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_ConvertAlphaToMask, "ConvertAlphaToMask(threshold: int=IMAGE_ALPHA_THRESHOLD) -> bool\n"
"ConvertAlphaToMask(mr : int, mg : int, mb : int, threshold: int=IMAGE_ALPHA_THRESHOLD) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_ConvertToGreyscale, "ConvertToGreyscale(weight_r : float, weight_g : float, weight_b : float) -> Image\n"
...
PyDoc_STRVAR(doc_wxImage_ConvertToMono, "ConvertToMono(r : int, g : int, b : int) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_ConvertToDisabled, "ConvertToDisabled(brightness: int=255) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_ChangeLightness, "ChangeLightness(alpha : int) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_ComputeHistogram, "ComputeHistogram(histogram : ImageHistogram) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_FindFirstUnusedColour, "FindFirstUnusedColour(startR: int=1, startG: int=0, startB: int=0) -> Tuple[int, int, int]\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_GetAlpha, "GetAlpha(x : int, y : int) -> int\n"
"GetAlpha() -> Any\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_GetRed, "GetRed(x : int, y : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_GetGreen, "GetGreen(x : int, y : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_GetBlue, "GetBlue(x : int, y : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_GetOption, "GetOption(name : str) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_GetOptionInt, "GetOptionInt(name : str) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_GetSubImage, "GetSubImage(rect : Rect) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_HasOption, "HasOption(name : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_IsTransparent, "IsTransparent(x : int, y : int, threshold: int=IMAGE_ALPHA_THRESHOLD) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_LoadFile, "LoadFile(stream : InputStream, type: BitmapType=BITMAP_TYPE_ANY, index: int=-1) -> bool\n"
"LoadFile(name : str, type: BitmapType=BITMAP_TYPE_ANY, index: int=-1) -> bool\n"
"LoadFile(name : str, mimetype : str, index: int=-1) -> bool\n"
"LoadFile(stream : InputStream, mimetype : str, index: int=-1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_SaveFile, "SaveFile(stream : OutputStream, mimetype : str) -> bool\n"
"SaveFile(name : str, type : BitmapType) -> bool\n"
"SaveFile(name : str, mimetype : str) -> bool\n"
"SaveFile(name : str) -> bool\n"
"SaveFile(stream : OutputStream, type : BitmapType) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_SetAlpha, "SetAlpha(x : int, y : int, alpha : int) -> None\n"
"SetAlpha(alpha: PyBuffer) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_SetData, "SetData(data: PyBuffer) -> None\n"
"SetData(data: PyBuffer, new_width: int, new_height: int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_SetLoadFlags, "SetLoadFlags(flags : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_SetMask, "SetMask(hasMask: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_SetMaskColour, "SetMaskColour(red : int, green : int, blue : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_SetMaskFromImage, "SetMaskFromImage(mask : Image, mr : int, mg : int, mb : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_SetOption, "SetOption(name : str, value : str) -> None\n"
"SetOption(name : str, value : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_SetPalette, "SetPalette(palette : Palette) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_SetRGB, "SetRGB(x : int, y : int, r : int, g : int, b : int) -> None\n"
"SetRGB(rect : Rect, red : int, green : int, blue : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_SetType, "SetType(type : BitmapType) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_SetDefaultLoadFlags, "SetDefaultLoadFlags(flags : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_AddHandler, "AddHandler(handler : ImageHandler) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_FindHandler, "FindHandler(name : str) -> ImageHandler\n"
"FindHandler(extension : str, imageType : BitmapType) -> ImageHandler\n"
"FindHandler(imageType : BitmapType) -> ImageHandler\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_FindHandlerMime, "FindHandlerMime(mimetype : str) -> ImageHandler\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_InsertHandler, "InsertHandler(handler : ImageHandler) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_RemoveHandler, "RemoveHandler(name : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_GetImageCount, "GetImageCount(filename : str, type: BitmapType=BITMAP_TYPE_ANY) -> int\n"
"GetImageCount(stream : InputStream, type: BitmapType=BITMAP_TYPE_ANY) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_CanRead, "CanRead(filename : str) -> bool\n"
"CanRead(stream : InputStream) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_RGBtoHSV, "RGBtoHSV(rgb : Image.RGBValue) -> Image.HSVValue\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_HSVtoRGB, "HSVtoRGB(hsv : Image.HSVValue) -> Image.RGBValue\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_SetDataBuffer, "SetDataBuffer(data: PyBuffer) -> None\n"
"SetDataBuffer(data: PyBuffer, new_width: int, new_height: int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_SetAlphaBuffer, "SetAlphaBuffer(alpha: PyBuffer) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_AdjustChannels, "AdjustChannels(factor_red: float, factor_green: float, factor_blue: float, factor_alpha: float=1.0) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxImage_ConvertToRegion, "ConvertToRegion(R: int=-1, G: int=-1, B: int=-1, tolerance: int=0) -> Region\n"
"\n"
...
"Image(width : int, height : int, clear: bool=True) -> None\n"
"Image(sz : Size, clear: bool=True) -> None\n"
"Image(name : str, type: BitmapType=BITMAP_TYPE_ANY, index: int=-1) -> None\n"
"Image(name : str, mimetype : str, index: int=-1) -> None\n"
"Image(stream : InputStream, type: BitmapType=BITMAP_TYPE_ANY, index: int=-1) -> None\n"
"Image(stream : InputStream, mimetype : str, index: int=-1) -> None\n"
"Image(width: int, height: int, data: PyBuffer) -> None\n"
"Image(width: int, height: int, data: PyBuffer, alpha: PyBuffer) -> None\n"
"Image(size: Size, data: PyBuffer) -> None\n"
"Image(size: Size, data: PyBuffer, alpha: PyBuffer) -> None\n"
"\n"
