...
PyDoc_STRVAR(doc_wxHtmlContainerCell_Detach, "Detach(cell : HtmlCell) -> None\n"
"\n"
"Detach a child cell.");
...
PyDoc_STRVAR(doc_wxHtmlContainerCell_GetIndent, "GetIndent(ind : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlContainerCell_GetIndentUnits, "GetIndentUnits(ind : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlContainerCell_InsertCell, "InsertCell(cell : HtmlCell) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlContainerCell_SetAlign, "SetAlign(tag : HtmlTag) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlContainerCell_SetAlignHor, "SetAlignHor(al : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlContainerCell_SetAlignVer, "SetAlignVer(al : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlContainerCell_SetBackgroundColour, "SetBackgroundColour(clr : wx.Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlContainerCell_SetBorder, "SetBorder(clr1 : wx.Colour, clr2 : wx.Colour, border: int=1) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlContainerCell_SetIndent, "SetIndent(i : int, what : int, units: int=HTML_UNITS_PIXELS) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlContainerCell_SetMinHeight, "SetMinHeight(h : int, align: int=HTML_ALIGN_TOP) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlContainerCell_SetWidthFloat, "SetWidthFloat(w : int, units : int) -> None\n"
...
PyDoc_STRVAR(doc_wxHtmlContainerCell, "HtmlContainerCell(parent : HtmlContainerCell) -> None\n"
"\n"
