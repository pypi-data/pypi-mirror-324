...
PyDoc_STRVAR(doc_wxRichToolTip_SetIcon, "SetIcon(icon: int=wx.ICON_INFORMATION) -> None\n"
...
PyDoc_STRVAR(doc_wxRichToolTip_SetBackgroundColour, "SetBackgroundColour(col : wx.Colour, colEnd: wx.Colour=wx.Colour()) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichToolTip_SetTimeout, "SetTimeout(millisecondsTimeout : int, millisecondsDelay: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichToolTip_SetTipKind, "SetTipKind(tipKind : TipKind) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichToolTip_SetTitleFont, "SetTitleFont(font : wx.Font) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichToolTip_ShowFor, "ShowFor(win : wx.Window, rect: Optional[wx.Rect]=None) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichToolTip, "RichToolTip(title : str, message : str) -> None\n"
"\n"
