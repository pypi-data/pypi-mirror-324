...
PyDoc_STRVAR(doc_wxPen_SetColour, "SetColour(colour : Colour) -> None\n"
"SetColour(red : int, green : int, blue : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPen_SetCap, "SetCap(capStyle : PenCap) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPen_SetQuality, "SetQuality(quality : PenQuality) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPen_SetDashes, "SetDashes(dashes : List[int]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPen_SetJoin, "SetJoin(join_style : PenJoin) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPen_SetStipple, "SetStipple(stipple : Bitmap) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPen_SetStyle, "SetStyle(style : PenStyle) -> None\n"
"\n"
"Set the pen style.");
...
PyDoc_STRVAR(doc_wxPen_SetWidth, "SetWidth(width : int) -> None\n"
"\n"
"Sets the pen width.");
...
PyDoc_STRVAR(doc_wxPen__copyFrom, "_copyFrom(other: Pen) -> None\n"
"\n"
...
"Pen(info : PenInfo) -> None\n"
"Pen(colour : Colour, width: int=1, style: PenStyle=PENSTYLE_SOLID) -> None\n"
"Pen(pen : Pen) -> None\n"
"\n"
