...
PyDoc_STRVAR(doc_wxBitmap_ConvertToDisabled, "ConvertToDisabled(brightness: int=255) -> Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_CopyFromIcon, "CopyFromIcon(icon : Icon) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_Create, "Create(width : int, height : int, depth: int=BITMAP_SCREEN_DEPTH) -> bool\n"
"Create(sz : Size, depth: int=BITMAP_SCREEN_DEPTH) -> bool\n"
"Create(width : int, height : int, dc : DC) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_CreateWithDIPSize, "CreateWithDIPSize(size : Size, scale : float, depth: int=BITMAP_SCREEN_DEPTH) -> bool\n"
"CreateWithDIPSize(width : int, height : int, scale : float, depth: int=BITMAP_SCREEN_DEPTH) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_CreateScaled, "CreateScaled(width : int, height : int, depth : int, logicalScale : float) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_GetSubBitmap, "GetSubBitmap(rect : Rect) -> Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_LoadFile, "LoadFile(name : str, type: BitmapType=BITMAP_TYPE_ANY) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_SaveFile, "SaveFile(name : str, type : BitmapType, palette: Optional[Palette]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_SetDepth, "SetDepth(depth : int) -> None");
...
PyDoc_STRVAR(doc_wxBitmap_SetHeight, "SetHeight(height : int) -> None");
...
PyDoc_STRVAR(doc_wxBitmap_SetScaleFactor, "SetScaleFactor(scale : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_SetMask, "SetMask(mask : Mask) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_SetPalette, "SetPalette(palette : Palette) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_SetWidth, "SetWidth(width : int) -> None");
...
PyDoc_STRVAR(doc_wxBitmap_UseAlpha, "UseAlpha(use: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_NewFromPNGData, "NewFromPNGData(data : Any, size : int) -> Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_Rescale, "Rescale(bmp : Bitmap, sizeNeeded : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_SetMaskColour, "SetMaskColour(colour: Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_SetHandle, "SetHandle(handle: int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_SetSize, "SetSize(size: Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_CopyFromBuffer, "CopyFromBuffer(data: PyBuffer, format: BitmapBufferFormat=BitmapBufferFormat_RGB, stride: int=-1) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_CopyToBuffer, "CopyToBuffer(data: PyBuffer, format: BitmapBufferFormat=BitmapBufferFormat_RGB, stride: int=-1) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_FromBufferAndAlpha, "FromBufferAndAlpha(width: int, height: int, data: PyBuffer, alpha: PyBuffer) -> Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_FromBuffer, "FromBuffer(width: int, height: int, data: PyBuffer) -> Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_FromBufferRGBA, "FromBufferRGBA(width: int, height: int, data: PyBuffer) -> Bitmap\n"
"\n"
"Creates a :class:`wx.Bitmap` from in-memory data.  The data parameter\n"
"must be a Python object that implements the buffer interface, such\n"
"as a string, bytearray, etc.  The data object is expected to contain\n"
...
PyDoc_STRVAR(doc_wxBitmap_FromRGBA, "FromRGBA(width: int, height: int, red: int=0, green: int=0, blue: int=0, alpha: int=0) -> Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmap_FromPNGData, "FromPNGData(data: PyBuffer) -> Bitmap\n"
"\n"
...
"Bitmap(bits : str, width : int, height : int, depth: int=1) -> None\n"
"Bitmap(width : int, height : int, depth: int=BITMAP_SCREEN_DEPTH) -> None\n"
"Bitmap(sz : Size, depth: int=BITMAP_SCREEN_DEPTH) -> None\n"
"Bitmap(width : int, height : int, dc : DC) -> None\n"
"Bitmap(name : str, type: BitmapType=BITMAP_TYPE_ANY) -> None\n"
"Bitmap(img : Image, depth: int=BITMAP_SCREEN_DEPTH) -> None\n"
"Bitmap(img : Image, dc : DC) -> None\n"
"Bitmap(listOfBytes: Any) -> None\n"
"\n"
