...
PyDoc_STRVAR(doc_wxGLContextAttrs_MajorVersion, "MajorVersion(val : int) -> GLContextAttrs\n"
"\n"
...
PyDoc_STRVAR(doc_wxGLContextAttrs_MinorVersion, "MinorVersion(val : int) -> GLContextAttrs\n"
"\n"
...
PyDoc_STRVAR(doc_wxGLContextAttrs_OGLVersion, "OGLVersion(vmayor : int, vminor : int) -> GLContextAttrs\n"
"\n"
...
PyDoc_STRVAR(doc_wxGLContextAttrs_ReleaseFlush, "ReleaseFlush(val: int=1) -> GLContextAttrs\n"
"\n"
