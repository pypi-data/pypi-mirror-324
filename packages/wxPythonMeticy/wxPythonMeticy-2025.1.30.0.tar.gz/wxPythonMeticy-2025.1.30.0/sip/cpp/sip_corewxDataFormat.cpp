...
PyDoc_STRVAR(doc_wxDataFormat_SetId, "SetId(format : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataFormat_SetType, "SetType(type : DataFormatId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataFormat, "DataFormat(format: DataFormatId=DF_INVALID) -> None\n"
"DataFormat(format : str) -> None\n"
"\n"
