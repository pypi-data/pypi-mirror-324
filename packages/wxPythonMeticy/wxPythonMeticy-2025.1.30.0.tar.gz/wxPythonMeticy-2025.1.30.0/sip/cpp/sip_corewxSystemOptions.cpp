...
PyDoc_STRVAR(doc_wxSystemOptions_SetOption, "SetOption(name : str, value : str) -> None\n"
...
PyDoc_STRVAR(doc_wxSystemOptions_GetOption, "GetOption(name : str) -> str\n"
"\n"
"Gets an option.");
...
PyDoc_STRVAR(doc_wxSystemOptions_GetOptionInt, "GetOptionInt(name : str) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxSystemOptions_HasOption, "HasOption(name : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSystemOptions_IsFalse, "IsFalse(name : str) -> bool\n"
"\n"
