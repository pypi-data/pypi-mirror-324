...
PyDoc_STRVAR(doc_wxPrinter_CreateAbortWindow, "CreateAbortWindow(parent : Window, printout : Printout) -> PrintAbortDialog\n"
"\n"
...
PyDoc_STRVAR(doc_wxPrinter_Print, "Print(parent : Window, printout : Printout, prompt: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPrinter_PrintDialog, "PrintDialog(parent : Window) -> DC\n"
"\n"
...
PyDoc_STRVAR(doc_wxPrinter_ReportError, "ReportError(parent : Window, printout : Printout, message : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPrinter_Setup, "Setup(parent : Window) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPrinter, "Printer(data: Optional[PrintDialogData]=None) -> None\n"
"\n"
