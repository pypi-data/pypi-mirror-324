...
PyDoc_STRVAR(doc_wxGenericDragImage_BeginDrag, "BeginDrag(hotspot : Point, window : Window, fullScreen: bool=False, rect: Optional[Rect]=None) -> bool\n"
"BeginDrag(hotspot : Point, window : Window, boundingWindow : Window) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericDragImage_DoDrawImage, "DoDrawImage(dc : DC, pos : Point) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericDragImage_GetImageRect, "GetImageRect(pos : Point) -> Rect\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericDragImage_Move, "Move(pt : Point) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericDragImage_UpdateBackingFromWindow, "UpdateBackingFromWindow(windowDC : DC, destDC : MemoryDC, sourceRect : Rect, destRect : Rect) -> bool\n"
"\n"
...
"GenericDragImage(image : Bitmap, cursor: Cursor=NullCursor) -> None\n"
"GenericDragImage(image : Icon, cursor: Cursor=NullCursor) -> None\n"
"GenericDragImage(text : str, cursor: Cursor=NullCursor) -> None\n"
"GenericDragImage(treeCtrl : TreeCtrl, id : TreeItemId) -> None\n"
"GenericDragImage(listCtrl : ListCtrl, id : int) -> None\n"
"\n"
