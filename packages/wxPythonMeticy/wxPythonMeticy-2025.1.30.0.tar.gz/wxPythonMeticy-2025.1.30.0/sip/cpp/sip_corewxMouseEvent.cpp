...
PyDoc_STRVAR(doc_wxMouseEvent_Button, "Button(but : MouseButton) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxMouseEvent_ButtonDClick, "ButtonDClick(but: MouseButton=MOUSE_BTN_ANY) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxMouseEvent_ButtonDown, "ButtonDown(but: MouseButton=MOUSE_BTN_ANY) -> bool\n"
"\n"
"If the argument is omitted, this returns true if the event was a mouse\n"
"button down event.");
...
PyDoc_STRVAR(doc_wxMouseEvent_ButtonUp, "ButtonUp(but: MouseButton=MOUSE_BTN_ANY) -> bool\n"
"\n"
"If the argument is omitted, this returns true if the event was a mouse\n"
"button up event.");
...
PyDoc_STRVAR(doc_wxMouseEvent_GetLogicalPosition, "GetLogicalPosition(dc : DC) -> Point\n"
"\n"
...
PyDoc_STRVAR(doc_wxMouseEvent_SetWheelAxis, "SetWheelAxis(wheelAxis: MouseWheelAxis) -> None");
...
PyDoc_STRVAR(doc_wxMouseEvent_SetWheelRotation, "SetWheelRotation(wheelRotation: int) -> None");
...
PyDoc_STRVAR(doc_wxMouseEvent_SetWheelDelta, "SetWheelDelta(wheelDelta: int) -> None");
...
PyDoc_STRVAR(doc_wxMouseEvent_SetLinesPerAction, "SetLinesPerAction(linesPerAction: int) -> None");
...
PyDoc_STRVAR(doc_wxMouseEvent_SetColumnsPerAction, "SetColumnsPerAction(columnsPerAction: int) -> None");
...
PyDoc_STRVAR(doc_wxMouseEvent, "MouseEvent(mouseEventType: EventType=wxEVT_NULL) -> None\n"
"\n"
