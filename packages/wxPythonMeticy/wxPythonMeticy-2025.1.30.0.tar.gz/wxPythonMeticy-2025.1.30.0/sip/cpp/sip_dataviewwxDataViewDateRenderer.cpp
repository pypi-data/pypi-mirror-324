...
PyDoc_STRVAR(doc_wxDataViewDateRenderer, "DataViewDateRenderer(varianttype: str=DataViewDateRenderer.GetDefaultType(), mode: DataViewCellMode=DATAVIEW_CELL_ACTIVATABLE, align: int=DVR_DEFAULT_ALIGNMENT) -> None\n"
"\n"
