...
PyDoc_STRVAR(doc_wxZoomGestureEvent_SetZoomFactor, "SetZoomFactor(zoomFactor : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxZoomGestureEvent, "ZoomGestureEvent(windid: int=0) -> None\n"
"\n"
