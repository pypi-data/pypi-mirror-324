...
PyDoc_STRVAR(doc_wxFrame_Centre, "Centre(direction: int=BOTH) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFrame_Create, "Create(parent : Window, id: int=ID_ANY, title: str='', pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=DEFAULT_FRAME_STYLE, name: str=FrameNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFrame_CreateStatusBar, "CreateStatusBar(number: int=1, style: int=STB_DEFAULT_STYLE, id: int=0, name: str=StatusBarNameStr) -> StatusBar\n"
"\n"
...
PyDoc_STRVAR(doc_wxFrame_CreateToolBar, "CreateToolBar(style: int=TB_DEFAULT_STYLE, id: int=ID_ANY, name: str=ToolBarNameStr) -> ToolBar\n"
"\n"
...
PyDoc_STRVAR(doc_wxFrame_DoGiveHelp, "DoGiveHelp(text : str, show : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFrame_OnCreateStatusBar, "OnCreateStatusBar(number : int, style : int, id : int, name : str) -> StatusBar\n"
"\n"
...
PyDoc_STRVAR(doc_wxFrame_OnCreateToolBar, "OnCreateToolBar(style : int, id : int, name : str) -> ToolBar\n"
"\n"
...
PyDoc_STRVAR(doc_wxFrame_ProcessCommand, "ProcessCommand(id : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFrame_SetMenuBar, "SetMenuBar(menuBar : MenuBar) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFrame_SetStatusBar, "SetStatusBar(statusBar : StatusBar) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFrame_SetStatusBarPane, "SetStatusBarPane(n : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFrame_SetStatusText, "SetStatusText(text : str, number: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFrame_SetStatusWidths, "SetStatusWidths(widths : List[int]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFrame_SetToolBar, "SetToolBar(toolBar : ToolBar) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFrame_PushStatusText, "PushStatusText(text : str, number: int=0) -> None");
...
PyDoc_STRVAR(doc_wxFrame_PopStatusText, "PopStatusText(number: int=0) -> None");
...
PyDoc_STRVAR(doc_wxFrame_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
