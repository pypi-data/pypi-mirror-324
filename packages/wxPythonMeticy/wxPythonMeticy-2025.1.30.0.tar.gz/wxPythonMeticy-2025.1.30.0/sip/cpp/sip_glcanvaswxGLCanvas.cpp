...
PyDoc_STRVAR(doc_wxGLCanvas_SetColour, "SetColour(colour : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGLCanvas_SetCurrent, "SetCurrent(context : GLContext) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGLCanvas_IsDisplaySupported, "IsDisplaySupported(dispAttrs : GLAttributes) -> bool\n"
...
PyDoc_STRVAR(doc_wxGLCanvas_IsExtensionSupported, "IsExtensionSupported(extension : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGLCanvas_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
PyDoc_STRVAR(doc_wxGLCanvas, "GLCanvas(parent : Window, dispAttrs : GLAttributes, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=GLCanvasName, palette: Palette=NullPalette) -> None\n"
