...
PyDoc_STRVAR(doc_wxGridCellAttrProvider_SetAttr, "SetAttr(attr : GridCellAttr, row : int, col : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellAttrProvider_SetRowAttr, "SetRowAttr(attr : GridCellAttr, row : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellAttrProvider_SetColAttr, "SetColAttr(attr : GridCellAttr, col : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellAttrProvider_GetColumnHeaderRenderer, "GetColumnHeaderRenderer(col : int) -> GridColumnHeaderRenderer\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellAttrProvider_GetRowHeaderRenderer, "GetRowHeaderRenderer(row : int) -> GridRowHeaderRenderer\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellAttrProvider_GetAttr, "GetAttr(row : int, col : int, kind : GridCellAttr.wxAttrKind) -> GridCellAttr\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellAttrProvider_GetAttrPtr, "GetAttrPtr(row : int, col : int, kind : GridCellAttr.wxAttrKind) -> GridCellAttrPtr\n"
"\n"
"Get the attribute to use for the specified cell.");
