...
PyDoc_STRVAR(doc_wxRichTextStyleOrganiserDialog_ApplyStyle, "ApplyStyle(ctrl: Optional[RichTextCtrl]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextStyleOrganiserDialog_Create, "Create(flags : int, sheet : RichTextStyleSheet, ctrl : RichTextCtrl, parent : wx.Window, id: int=wx.ID_ANY, caption: str=wx.GetTranslation(\"StyleOrganiser\"), pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.Size(400,300), style: int=wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.SYSTEM_MENU|wx.CLOSE_BOX) -> bool\n"
"\n"
"Creates the dialog.");
...
PyDoc_STRVAR(doc_wxRichTextStyleOrganiserDialog_SetFlags, "SetFlags(flags : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextStyleOrganiserDialog_SetRestartNumbering, "SetRestartNumbering(restartNumbering : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextStyleOrganiserDialog_SetRichTextCtrl, "SetRichTextCtrl(ctrl : RichTextCtrl) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextStyleOrganiserDialog_SetStyleSheet, "SetStyleSheet(sheet : RichTextStyleSheet) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextStyleOrganiserDialog_SetShowToolTips, "SetShowToolTips(show : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextStyleOrganiserDialog_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
...
"RichTextStyleOrganiserDialog(flags : int, sheet : RichTextStyleSheet, ctrl : RichTextCtrl, parent : wx.Window, id: int=wx.ID_ANY, caption: str=_(\"StyleOrganiser\"), pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.SYSTEM_MENU|wx.CLOSE_BOX) -> None\n"
"\n"
