...
PyDoc_STRVAR(doc_wxBufferedPaintDC, "BufferedPaintDC(window : Window, buffer : Bitmap, style: int=BUFFER_CLIENT_AREA) -> None\n"
"BufferedPaintDC(window : Window, style: int=BUFFER_CLIENT_AREA) -> None\n"
"\n"
