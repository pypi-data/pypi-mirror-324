...
"PropertyGridIterator(state : PropertyGridPageState, flags: int=PG_ITERATE_DEFAULT, property: Optional[PGProperty]=None, dir: int=1) -> None\n"
"PropertyGridIterator(state : PropertyGridPageState, flags : int, startPos : int, dir: int=0) -> None\n"
