...
PyDoc_STRVAR(doc_wxGridCellFloatRenderer_SetFormat, "SetFormat(format : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellFloatRenderer_SetParameters, "SetParameters(params : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellFloatRenderer_SetPrecision, "SetPrecision(precision : int) -> None\n"
"\n"
"Sets the precision.");
...
PyDoc_STRVAR(doc_wxGridCellFloatRenderer_SetWidth, "SetWidth(width : int) -> None\n"
"\n"
"Sets the width.");
...
PyDoc_STRVAR(doc_wxGridCellFloatRenderer, "GridCellFloatRenderer(width: int=-1, precision: int=-1, format: int=GRID_FLOAT_FORMAT_DEFAULT) -> None\n"
"\n"
