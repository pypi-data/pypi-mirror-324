...
PyDoc_STRVAR(doc_wxPropertyGridPopulator_SetState, "SetState(state : PropertyGridPageState) -> None");
...
PyDoc_STRVAR(doc_wxPropertyGridPopulator_SetGrid, "SetGrid(pg : PropertyGrid) -> None");
...
PyDoc_STRVAR(doc_wxPropertyGridPopulator_Add, "Add(propClass : str, propLabel : str, propName : str, propValue : str, pChoices: Optional[PGChoices]=None) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridPopulator_AddChildren, "AddChildren(property : PGProperty) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridPopulator_AddAttribute, "AddAttribute(name : str, type : str, value : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridPopulator_ParseChoices, "ParseChoices(choicesString : str, idString : str) -> PGChoices\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridPopulator_ProcessError, "ProcessError(msg : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridPopulator_ToLongPCT, "ToLongPCT(s : str, pval : int, max : int) -> bool\n"
"\n"
