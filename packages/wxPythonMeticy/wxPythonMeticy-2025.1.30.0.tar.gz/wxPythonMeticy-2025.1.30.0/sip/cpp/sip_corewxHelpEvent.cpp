...
PyDoc_STRVAR(doc_wxHelpEvent_SetOrigin, "SetOrigin(origin : HelpEvent.Origin) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHelpEvent_SetPosition, "SetPosition(pt : Point) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHelpEvent, "HelpEvent(type: EventType=wxEVT_NULL, winid: int=0, pt: Point=DefaultPosition, origin: HelpEvent.Origin=Origin_Unknown) -> None\n"
"\n"
