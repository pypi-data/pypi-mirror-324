...
PyDoc_STRVAR(doc_wxHtmlRenderingInfo_SetSelection, "SetSelection(s : HtmlSelection) -> None\n"
"\n"
"Accessors.");
...
PyDoc_STRVAR(doc_wxHtmlRenderingInfo_SetStyle, "SetStyle(style : HtmlRenderingStyle) -> None\n"
"\n"
"Accessors.");
