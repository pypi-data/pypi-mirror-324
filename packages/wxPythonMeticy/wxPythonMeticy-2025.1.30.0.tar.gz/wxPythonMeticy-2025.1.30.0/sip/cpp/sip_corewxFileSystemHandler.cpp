...
PyDoc_STRVAR(doc_wxFileSystemHandler_CanOpen, "CanOpen(location : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystemHandler_FindFirst, "FindFirst(wildcard : str, flags: int=0) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystemHandler_OpenFile, "OpenFile(fs : FileSystem, location : str) -> FSFile\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystemHandler_GetMimeTypeFromExt, "GetMimeTypeFromExt(location : str) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystemHandler_GetAnchor, "GetAnchor(location : str) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystemHandler_GetLeftLocation, "GetLeftLocation(location : str) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystemHandler_GetProtocol, "GetProtocol(location : str) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystemHandler_GetRightLocation, "GetRightLocation(location : str) -> str\n"
"\n"
