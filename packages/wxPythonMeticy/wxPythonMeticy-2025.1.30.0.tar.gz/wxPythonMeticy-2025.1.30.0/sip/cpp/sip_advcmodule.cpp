...
PyDoc_STRVAR(doc_ShowTip, "ShowTip(parent : wx.Window, tipProvider : TipProvider, showAtStartup: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_CreateFileTipProvider, "CreateFileTipProvider(filename : str, currentTip : int) -> TipProvider\n"
"\n"
...
PyDoc_STRVAR(doc_GenericAboutBox, "GenericAboutBox(info : AboutDialogInfo, parent: Optional[wx.Window]=None) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_AboutBox, "AboutBox(info : AboutDialogInfo, parent: Optional[wx.Window]=None) -> None\n"
"\n"
...
#endif
{
    ...
    if (sipExportModule(&sipModuleAPI__adv, 12, 9, 0) < 0)
    {
        Py_DECREF(sipModule);
        return SIP_NULLPTR;
    }
