...
PyDoc_STRVAR(doc_wxImageFileProperty_DisplayEditorDialog, "DisplayEditorDialog(pg : PropertyGrid, value : PGVariant) -> Tuple[bool, PGVariant]\n"
"\n"
"Shows editor dialog.");
...
PyDoc_STRVAR(doc_wxImageFileProperty_OnMeasureImage, "OnMeasureImage(item : int) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageFileProperty_OnCustomPaint, "OnCustomPaint(dc : wx.DC, rect : wx.Rect, paintdata : PGPaintData) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageFileProperty, "ImageFileProperty(label: str=PG_LABEL, name: str=PG_LABEL, value: str='') -> None\n"
"\n"
