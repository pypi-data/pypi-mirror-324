...
PyDoc_STRVAR(doc_wxSashWindow_GetSashVisible, "GetSashVisible(edge : SashEdgePosition) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSashWindow_SetMaximumSizeX, "SetMaximumSizeX(min : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSashWindow_SetMaximumSizeY, "SetMaximumSizeY(min : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSashWindow_SetMinimumSizeX, "SetMinimumSizeX(min : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSashWindow_SetMinimumSizeY, "SetMinimumSizeY(min : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSashWindow_SetSashVisible, "SetSashVisible(edge : SashEdgePosition, visible : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSashWindow_GetEdgeMargin, "GetEdgeMargin(edge : SashEdgePosition) -> int\n"
"\n"
"Get border size.");
...
PyDoc_STRVAR(doc_wxSashWindow_SetDefaultBorderSize, "SetDefaultBorderSize(width : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSashWindow_SetExtraBorderSize, "SetExtraBorderSize(width : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSashWindow_SashHitTest, "SashHitTest(x : int, y : int, tolerance: int=2) -> SashEdgePosition\n"
"\n"
...
PyDoc_STRVAR(doc_wxSashWindow_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
