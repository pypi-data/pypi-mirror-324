...
PyDoc_STRVAR(doc_wxVarHVScrollHelper_OnGetColumnsWidthHint, "OnGetColumnsWidthHint(columnMin : int, columnMax : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHVScrollHelper_OnGetColumnWidth, "OnGetColumnWidth(column : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHVScrollHelper_OnGetRowsHeightHint, "OnGetRowsHeightHint(rowMin : int, rowMax : int) -> None\n"
"\n"
"This function doesn't have to be overridden but it may be useful to do\n"
...
PyDoc_STRVAR(doc_wxVarHVScrollHelper_OnGetRowHeight, "OnGetRowHeight(row : int) -> int\n"
"\n"
"This function must be overridden in the derived class, and should\n"
...
PyDoc_STRVAR(doc_wxVarHVScrollHelper_IsVisible, "IsVisible(row : int, column : int) -> bool\n"
...
PyDoc_STRVAR(doc_wxVarHVScrollHelper_RefreshRowColumn, "RefreshRowColumn(row : int, column : int) -> None\n"
"RefreshRowColumn(pos : Position) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHVScrollHelper_RefreshRowsColumns, "RefreshRowsColumns(fromRow : int, toRow : int, fromColumn : int, toColumn : int) -> None\n"
"RefreshRowsColumns(_from : Position, to : Position) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHVScrollHelper_ScrollToRowColumn, "ScrollToRowColumn(row : int, column : int) -> bool\n"
"ScrollToRowColumn(pos : Position) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHVScrollHelper_VirtualHitTest, "VirtualHitTest(x : int, y : int) -> Position\n"
"VirtualHitTest(pos : Point) -> Position\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHVScrollHelper_EnablePhysicalScrolling, "EnablePhysicalScrolling(vscrolling: bool=True, hscrolling: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHVScrollHelper_SetRowColumnCount, "SetRowColumnCount(rowCount : int, columnCount : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHVScrollHelper, "VarHVScrollHelper(winToScroll : Window) -> None\n"
"\n"
