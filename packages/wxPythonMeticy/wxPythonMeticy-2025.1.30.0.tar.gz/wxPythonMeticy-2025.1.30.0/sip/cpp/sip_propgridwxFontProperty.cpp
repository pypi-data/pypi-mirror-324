...
PyDoc_STRVAR(doc_wxFontProperty_ValueToString, "ValueToString(value : PGVariant, argFlags: int=0) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontProperty_ChildChanged, "ChildChanged(thisValue : PGVariant, childIndex : int, childValue : PGVariant) -> PGVariant\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontProperty_DisplayEditorDialog, "DisplayEditorDialog(pg : PropertyGrid, value : PGVariant) -> Tuple[bool, PGVariant]\n"
"\n"
"Shows editor dialog.");
...
PyDoc_STRVAR(doc_wxFontProperty, "FontProperty(label: str=PG_LABEL, name: str=PG_LABEL, value: wx.Font=wx.Font()) -> None\n"
"\n"
