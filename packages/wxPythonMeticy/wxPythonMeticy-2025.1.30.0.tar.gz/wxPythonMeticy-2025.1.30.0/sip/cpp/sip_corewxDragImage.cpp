...
PyDoc_STRVAR(doc_wxDragImage_BeginDrag, "BeginDrag(hotspot : Point, window : Window, fullScreen: bool=False, rect: Optional[Rect]=None) -> bool\n"
...
PyDoc_STRVAR(doc_wxDragImage_Move, "Move(pt : Point) -> bool\n"
"\n"
...
"DragImage(image : Bitmap, cursor: Cursor=NullCursor) -> None\n"
"DragImage(image : Icon, cursor: Cursor=NullCursor) -> None\n"
"DragImage(text : str, cursor: Cursor=NullCursor) -> None\n"
"DragImage(treeCtrl : TreeCtrl, id : TreeItemId) -> None\n"
"DragImage(listCtrl : ListCtrl, id : int) -> None\n"
"\n"
