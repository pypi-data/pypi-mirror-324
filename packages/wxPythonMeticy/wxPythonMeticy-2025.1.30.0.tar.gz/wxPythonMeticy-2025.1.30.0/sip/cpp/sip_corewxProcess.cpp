...
PyDoc_STRVAR(doc_wxProcess_TryBefore, "TryBefore(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxProcess_TryAfter, "TryAfter(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxProcess_OnTerminate, "OnTerminate(pid : int, status : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxProcess_SetPriority, "SetPriority(priority : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxProcess_Exists, "Exists(pid : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxProcess_Kill, "Kill(pid : int, sig: Signal=SIGTERM, flags: int=KILL_NOCHILDREN) -> KillError\n"
"\n"
...
PyDoc_STRVAR(doc_wxProcess_Open, "Open(cmd : str, flags: int=EXEC_ASYNC) -> Process\n"
"\n"
...
PyDoc_STRVAR(doc_wxProcess, "Process(parent: Optional[EvtHandler]=None, id: int=-1) -> None\n"
"Process(flags : int) -> None\n"
"\n"
