...
PyDoc_STRVAR(doc_wxPyAxBaseWindow_ProcessEvent, "ProcessEvent(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPyAxBaseWindow_MSWTranslateMessage, "MSWTranslateMessage(msg : WXMSG) -> bool");
...
PyDoc_STRVAR(doc_wxPyAxBaseWindow, "PyAxBaseWindow(parent : wx.Window, id: int=-1, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=0, name: str=wx.PanelNameStr) -> None\n"
"PyAxBaseWindow() -> None\n"
"\n"
