...
PyDoc_STRVAR(doc_wxGridCellActivatableEditor_TryActivate, "TryActivate(row : int, col : int, grid : Grid, actSource : GridActivationSource) -> GridActivationResult\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellActivatableEditor_DoActivate, "DoActivate(row : int, col : int, grid : Grid) -> None\n"
"\n"
"Same method as in wxGridCellEditor, but pure virtual.");
