...
PyDoc_STRVAR(doc_wxDataViewIndexListModel_GetItem, "GetItem(row : int) -> DataViewItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewIndexListModel_Reset, "Reset(new_size : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewIndexListModel_RowChanged, "RowChanged(row : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewIndexListModel_RowDeleted, "RowDeleted(row : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewIndexListModel_RowInserted, "RowInserted(before : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewIndexListModel_RowValueChanged, "RowValueChanged(row : int, col : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewIndexListModel_RowsDeleted, "RowsDeleted(rows : List[int]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewIndexListModel, "DataViewIndexListModel(initial_size: int=0) -> None\n"
"\n"
