...
PyDoc_STRVAR(doc_wxHVScrolledWindow_OnGetColumnsWidthHint, "OnGetColumnsWidthHint(columnMin : int, columnMax : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHVScrolledWindow_OnGetColumnWidth, "OnGetColumnWidth(column : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxHVScrolledWindow_OnGetRowsHeightHint, "OnGetRowsHeightHint(rowMin : int, rowMax : int) -> None\n"
"\n"
"This function doesn't have to be overridden but it may be useful to do\n"
...
PyDoc_STRVAR(doc_wxHVScrolledWindow_OnGetRowHeight, "OnGetRowHeight(row : int) -> int\n"
"\n"
"This function must be overridden in the derived class, and should\n"
...
PyDoc_STRVAR(doc_wxHVScrolledWindow_Create, "Create(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=PanelNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxHVScrolledWindow_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"HVScrolledWindow(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=PanelNameStr) -> None\n"
"\n"
