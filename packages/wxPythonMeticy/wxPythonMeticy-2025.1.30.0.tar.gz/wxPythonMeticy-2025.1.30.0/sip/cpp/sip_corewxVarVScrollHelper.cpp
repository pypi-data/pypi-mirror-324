...
PyDoc_STRVAR(doc_wxVarVScrollHelper_IsRowVisible, "IsRowVisible(row : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarVScrollHelper_RefreshRow, "RefreshRow(row : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarVScrollHelper_RefreshRows, "RefreshRows(from_ : int, to_ : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarVScrollHelper_ScrollRowPages, "ScrollRowPages(pages : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarVScrollHelper_ScrollRows, "ScrollRows(rows : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarVScrollHelper_ScrollToRow, "ScrollToRow(row : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarVScrollHelper_SetRowCount, "SetRowCount(rowCount : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarVScrollHelper_OnGetRowsHeightHint, "OnGetRowsHeightHint(rowMin : int, rowMax : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarVScrollHelper_OnGetRowHeight, "OnGetRowHeight(row : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarVScrollHelper, "VarVScrollHelper(winToScroll : Window) -> None\n"
"\n"
