...
PyDoc_STRVAR(doc_wxEvent_ResumePropagation, "ResumePropagation(propagationLevel : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxEvent_SetEventObject, "SetEventObject(object : Object) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxEvent_SetEventType, "SetEventType(type : EventType) -> None\n"
"\n"
"Sets the event type.");
...
PyDoc_STRVAR(doc_wxEvent_SetId, "SetId(id : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxEvent_SetTimestamp, "SetTimestamp(timeStamp: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxEvent_Skip, "Skip(skip: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxEvent, "Event(id: int=0, eventType: EventType=wxEVT_NULL) -> None\n"
"\n"
