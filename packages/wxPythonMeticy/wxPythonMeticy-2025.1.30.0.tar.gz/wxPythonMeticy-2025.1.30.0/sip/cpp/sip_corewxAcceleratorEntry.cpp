...
PyDoc_STRVAR(doc_wxAcceleratorEntry_Set, "Set(flags : int, keyCode : int, cmd : int, item: Optional[MenuItem]=None) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAcceleratorEntry_FromString, "FromString(str : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAcceleratorEntry, "AcceleratorEntry(flags: int=0, keyCode: int=0, cmd: int=0, item: Optional[MenuItem]=None) -> None\n"
"AcceleratorEntry(entry : AcceleratorEntry) -> None\n"
"\n"
