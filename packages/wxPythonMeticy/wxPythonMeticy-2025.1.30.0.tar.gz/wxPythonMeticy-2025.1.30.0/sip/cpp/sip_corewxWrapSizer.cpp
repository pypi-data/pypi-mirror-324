...
PyDoc_STRVAR(doc_wxWrapSizer_InformFirstDirection, "InformFirstDirection(direction : int, size : int, availableOtherDir : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWrapSizer_RepositionChildren, "RepositionChildren(minSize : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWrapSizer_IsSpaceItem, "IsSpaceItem(item : SizerItem) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWrapSizer, "WrapSizer(orient: int=HORIZONTAL, flags: int=WRAPSIZER_DEFAULT_FLAGS) -> None\n"
"\n"
