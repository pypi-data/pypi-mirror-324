...
PyDoc_STRVAR(doc_wxPGAttributeStorage_Set, "Set(name : str, value : PGVariant) -> None");
...
PyDoc_STRVAR(doc_wxPGAttributeStorage_FindValue, "FindValue(name : str) -> PGVariant");
