...
PyDoc_STRVAR(doc_wxRichTextFieldType_Copy, "Copy(fieldType : RichTextFieldType) -> None");
...
PyDoc_STRVAR(doc_wxRichTextFieldType_Draw, "Draw(obj : RichTextField, dc : wx.DC, context : RichTextDrawingContext, range : RichTextRange, selection : RichTextSelection, rect : wx.Rect, descent : int, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldType_Layout, "Layout(obj : RichTextField, dc : wx.DC, context : RichTextDrawingContext, rect : wx.Rect, parentRect : wx.Rect, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldType_GetRangeSize, "GetRangeSize(obj : RichTextField, range : RichTextRange, size : wx.Size, descent : int, dc : wx.DC, context : RichTextDrawingContext, flags : int, position: wx.Point=wx.Point(0,0), parentSize: wx.Size=wx.DefaultSize, partialExtents: Optional[List[int]]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldType_CanEditProperties, "CanEditProperties(obj : RichTextField) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldType_EditProperties, "EditProperties(obj : RichTextField, parent : wx.Window, buffer : RichTextBuffer) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldType_GetPropertiesMenuLabel, "GetPropertiesMenuLabel(obj : RichTextField) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldType_UpdateField, "UpdateField(buffer : RichTextBuffer, obj : RichTextField) -> bool\n"
"\n"
"Update the field.");
...
PyDoc_STRVAR(doc_wxRichTextFieldType_IsTopLevel, "IsTopLevel(obj : RichTextField) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldType_SetName, "SetName(name : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldType, "RichTextFieldType(name: str='') -> None\n"
