...
PyDoc_STRVAR(doc_wxAuiMDIClientWindow_CreateClient, "CreateClient(parent : AuiMDIParentFrame, style: int=wx.VSCROLL|wx.HSCROLL) -> bool");
...
PyDoc_STRVAR(doc_wxAuiMDIClientWindow_SetSelection, "SetSelection(new_page : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiMDIClientWindow_SetActiveChild, "SetActiveChild(pChildFrame : AuiMDIChildFrame) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIClientWindow_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
