...
PyDoc_STRVAR(doc_wxSymbolPickerDialog_Create, "Create(symbol : str, initialFont : str, normalTextFont : str, parent : wx.Window, id: int=wx.ID_ANY, caption: str=wx.GetTranslation(\"Symbols\"), pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.Size(400,300), style: int=wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.CLOSE_BOX) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSymbolPickerDialog_SetFontName, "SetFontName(value : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSymbolPickerDialog_SetFromUnicode, "SetFromUnicode(value : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSymbolPickerDialog_SetNormalTextFontName, "SetNormalTextFontName(value : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSymbolPickerDialog_SetSymbol, "SetSymbol(value : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSymbolPickerDialog_SetUnicodeMode, "SetUnicodeMode(unicodeMode : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSymbolPickerDialog_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
...
"SymbolPickerDialog(symbol : str, initialFont : str, normalTextFont : str, parent : wx.Window, id: int=wx.ID_ANY, title: str=_(\"Symbols\"), pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.CLOSE_BOX) -> None\n"
"\n"
