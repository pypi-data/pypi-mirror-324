...
PyDoc_STRVAR(doc_wxGridCellDateTimeRenderer, "GridCellDateTimeRenderer(outformat: str=wx.DefaultDateTimeFormat, informat: str=wx.DefaultDateTimeFormat) -> None\n"
"\n"
