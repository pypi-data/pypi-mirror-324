...
PyDoc_STRVAR(doc_wxHtmlRenderingState_SetSelectionState, "SetSelectionState(s : HtmlSelectionState) -> None");
...
PyDoc_STRVAR(doc_wxHtmlRenderingState_SetFgColour, "SetFgColour(c : wx.Colour) -> None");
...
PyDoc_STRVAR(doc_wxHtmlRenderingState_SetBgColour, "SetBgColour(c : wx.Colour) -> None");
...
PyDoc_STRVAR(doc_wxHtmlRenderingState_SetBgMode, "SetBgMode(m : int) -> None");
