...
PyDoc_STRVAR(doc_wxMimeTypesManager_AddFallbacks, "AddFallbacks(fallbacks : FileTypeInfo) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxMimeTypesManager_GetFileTypeFromExtension, "GetFileTypeFromExtension(extension : str) -> FileType\n"
"\n"
...
PyDoc_STRVAR(doc_wxMimeTypesManager_GetFileTypeFromMimeType, "GetFileTypeFromMimeType(mimeType : str) -> FileType\n"
"\n"
...
PyDoc_STRVAR(doc_wxMimeTypesManager_Associate, "Associate(ftInfo : FileTypeInfo) -> FileType\n"
"\n"
...
PyDoc_STRVAR(doc_wxMimeTypesManager_Unassociate, "Unassociate(ft : FileType) -> bool\n"
"\n"
"Undo Associate().");
...
PyDoc_STRVAR(doc_wxMimeTypesManager_IsOfType, "IsOfType(mimeType : str, wildcard : str) -> bool\n"
"\n"
