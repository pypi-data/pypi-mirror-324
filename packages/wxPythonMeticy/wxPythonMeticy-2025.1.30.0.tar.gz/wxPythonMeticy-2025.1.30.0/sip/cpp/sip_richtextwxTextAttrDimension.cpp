...
PyDoc_STRVAR(doc_wxTextAttrDimension_EqPartial, "EqPartial(dim : TextAttrDimension, weakTest: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrDimension_Apply, "Apply(dim : TextAttrDimension, compareWith: Optional[TextAttrDimension]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrDimension_CollectCommonAttributes, "CollectCommonAttributes(attr : TextAttrDimension, clashingAttr : TextAttrDimension, absentAttr : TextAttrDimension) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrDimension_SetValueMM, "SetValueMM(value : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrDimension_SetValue, "SetValue(value : int) -> None\n"
"SetValue(value : int, flags : TextAttrDimensionFlags) -> None\n"
"SetValue(dim : TextAttrDimension) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrDimension_SetUnits, "SetUnits(units : TextAttrUnits) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrDimension_SetPosition, "SetPosition(pos : TextBoxAttrPosition) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrDimension_SetValid, "SetValid(b : bool) -> None\n"
"\n"
"Sets the valid flag.");
...
PyDoc_STRVAR(doc_wxTextAttrDimension_SetFlags, "SetFlags(flags : TextAttrDimensionFlags) -> None\n"
"\n"
...
"TextAttrDimension(value : int, units: TextAttrUnits=TEXT_ATTR_UNITS_TENTHS_MM) -> None\n"
"\n"
