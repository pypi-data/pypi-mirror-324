...
PyDoc_STRVAR(doc_wxRichTextLine_SetRange, "SetRange(range : RichTextRange) -> None\n"
"SetRange(from_ : int, to_ : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextLine_SetSize, "SetSize(sz : wx.Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextLine_SetPosition, "SetPosition(pos : wx.Point) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextLine_SetDescent, "SetDescent(descent : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextLine_Init, "Init(parent : RichTextParagraph) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextLine_Copy, "Copy(obj : RichTextLine) -> None\n"
"\n"
"Copies from obj.");
...
PyDoc_STRVAR(doc_wxRichTextLine, "RichTextLine(parent : RichTextParagraph) -> None\n"
