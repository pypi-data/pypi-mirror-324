...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetIterator, "GetIterator(flags: int=PG_ITERATE_DEFAULT, firstProp: Optional[PGProperty]=None) -> PropertyGridIterator\n"
"GetIterator(flags : int, startPos : int) -> PropertyGridIterator\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetFirst, "GetFirst(flags: int=PG_ITERATE_ALL) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_Append, "Append(property : PGProperty) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_AppendIn, "AppendIn(id : PGPropArgCls, newProperty : PGProperty) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_BeginAddChildren, "BeginAddChildren(id : PGPropArgCls) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_ClearSelection, "ClearSelection(validation: bool=False) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_Collapse, "Collapse(id : PGPropArgCls) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_ChangePropertyValue, "ChangePropertyValue(id : PGPropArgCls, newValue : PGVariant) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_DeleteProperty, "DeleteProperty(id : PGPropArgCls) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_DisableProperty, "DisableProperty(id : PGPropArgCls) -> bool\n"
"\n"
"Disables a property.");
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_EnableProperty, "EnableProperty(id : PGPropArgCls, enable: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_EndAddChildren, "EndAddChildren(id : PGPropArgCls) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_Expand, "Expand(id : PGPropArgCls) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_ExpandAll, "ExpandAll(expand: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetColumnProportion, "GetColumnProportion(column : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetFirstChild, "GetFirstChild(id : PGPropArgCls) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetProperty, "GetProperty(name : str) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertiesWithFlag, "GetPropertiesWithFlag(targetArr : List[PGProperty], flags : PGProperty.FlagType, inverse: bool=False, iterFlags: int=PG_ITERATE_PROPERTIES|PG_ITERATE_HIDDEN|PG_ITERATE_CATEGORIES) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyAttribute, "GetPropertyAttribute(id : PGPropArgCls, attrName : str) -> PGVariant\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyAttributes, "GetPropertyAttributes(id : PGPropArgCls) -> PGAttributeStorage\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyBackgroundColour, "GetPropertyBackgroundColour(id : PGPropArgCls) -> wx.Colour\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyCategory, "GetPropertyCategory(id : PGPropArgCls) -> PropertyCategory\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyByLabel, "GetPropertyByLabel(label : str) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyByName, "GetPropertyByName(name : str) -> PGProperty\n"
"GetPropertyByName(name : str, subname : str) -> PGProperty\n"
"\n"
"Returns pointer to a property with given name (case-sensitive).\n"
"");
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyEditor, "GetPropertyEditor(id : PGPropArgCls) -> PGEditor\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyHelpString, "GetPropertyHelpString(id : PGPropArgCls) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyImage, "GetPropertyImage(id : PGPropArgCls) -> wx.Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyLabel, "GetPropertyLabel(id : PGPropArgCls) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyName, "GetPropertyName(property : PGProperty) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyParent, "GetPropertyParent(id : PGPropArgCls) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyTextColour, "GetPropertyTextColour(id : PGPropArgCls) -> wx.Colour\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyValidator, "GetPropertyValidator(id : PGPropArgCls) -> wx.Validator\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyValue, "GetPropertyValue(id : PGPropArgCls) -> PGVariant\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyValueAsArrayInt, "GetPropertyValueAsArrayInt(id : PGPropArgCls) -> List[int]\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyValueAsArrayString, "GetPropertyValueAsArrayString(id : PGPropArgCls) -> List[str]\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyValueAsBool, "GetPropertyValueAsBool(id : PGPropArgCls) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyValueAsDateTime, "GetPropertyValueAsDateTime(id : PGPropArgCls) -> wx.DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyValueAsDouble, "GetPropertyValueAsDouble(id : PGPropArgCls) -> float\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyValueAsInt, "GetPropertyValueAsInt(id : PGPropArgCls) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyValueAsLong, "GetPropertyValueAsLong(id : PGPropArgCls) -> int\n"
"\n"
"Returns property's value as integer.");
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyValueAsLongLong, "GetPropertyValueAsLongLong(id : PGPropArgCls) -> LongLong_t\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyValueAsString, "GetPropertyValueAsString(id : PGPropArgCls) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyValueAsULong, "GetPropertyValueAsULong(id : PGPropArgCls) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyValueAsULongLong, "GetPropertyValueAsULongLong(id : PGPropArgCls) -> ULongLong_t\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetVIterator, "GetVIterator(flags : int) -> PGVIterator\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_HideProperty, "HideProperty(id : PGPropArgCls, hide: bool=True, flags: int=PG_RECURSE) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_Insert, "Insert(priorThis : PGPropArgCls, newProperty : PGProperty) -> PGProperty\n"
"Insert(parent : PGPropArgCls, index : int, newProperty : PGProperty) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_IsPropertyCategory, "IsPropertyCategory(id : PGPropArgCls) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_IsPropertyEnabled, "IsPropertyEnabled(id : PGPropArgCls) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_IsPropertyExpanded, "IsPropertyExpanded(id : PGPropArgCls) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_IsPropertyModified, "IsPropertyModified(id : PGPropArgCls) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_IsPropertySelected, "IsPropertySelected(id : PGPropArgCls) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_IsPropertyShown, "IsPropertyShown(id : PGPropArgCls) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_IsPropertyValueUnspecified, "IsPropertyValueUnspecified(id : PGPropArgCls) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_LimitPropertyEditing, "LimitPropertyEditing(id : PGPropArgCls, limit: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_RefreshGrid, "RefreshGrid(state: Optional[PropertyGridPageState]=None) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_RemoveProperty, "RemoveProperty(id : PGPropArgCls) -> PGProperty\n"
"\n"
"Removes a property.");
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_ReplaceProperty, "ReplaceProperty(id : PGPropArgCls, property : PGProperty) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_RestoreEditableState, "RestoreEditableState(src : str, restoreStates: int=AllStates) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SaveEditableState, "SaveEditableState(includedStates: int=AllStates) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetColumnProportion, "SetColumnProportion(column : int, proportion : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyAttribute, "SetPropertyAttribute(id : PGPropArgCls, attrName : str, value : PGVariant, argFlags: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyAttributeAll, "SetPropertyAttributeAll(attrName : str, value : PGVariant) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyBackgroundColour, "SetPropertyBackgroundColour(id : PGPropArgCls, colour : wx.Colour, flags: int=PG_RECURSE) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyCell, "SetPropertyCell(id : PGPropArgCls, column : int, text: str='', bitmap: wx.BitmapBundle=wx.BitmapBundle(), fgCol: wx.Colour=wx.NullColour, bgCol: wx.Colour=wx.NullColour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyColoursToDefault, "SetPropertyColoursToDefault(id : PGPropArgCls, flags: int=PG_DONT_RECURSE) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyEditor, "SetPropertyEditor(id : PGPropArgCls, editor : PGEditor) -> None\n"
"SetPropertyEditor(id : PGPropArgCls, editorName : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyLabel, "SetPropertyLabel(id : PGPropArgCls, newproplabel : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyName, "SetPropertyName(id : PGPropArgCls, newName : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyReadOnly, "SetPropertyReadOnly(id : PGPropArgCls, set: bool=True, flags: int=PG_RECURSE) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyValueUnspecified, "SetPropertyValueUnspecified(id : PGPropArgCls) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyHelpString, "SetPropertyHelpString(id : PGPropArgCls, helpString : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyImage, "SetPropertyImage(id : PGPropArgCls, bmp : wx.BitmapBundle) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyMaxLength, "SetPropertyMaxLength(id : PGPropArgCls, maxLen : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyTextColour, "SetPropertyTextColour(id : PGPropArgCls, colour : wx.Colour, flags: int=PG_RECURSE) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyValidator, "SetPropertyValidator(id : PGPropArgCls, validator : wx.Validator) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyValue, "SetPropertyValue(id : PGPropArgCls, value : float) -> None\n"
"SetPropertyValue(id : PGPropArgCls, value : bool) -> None\n"
"SetPropertyValue(id : PGPropArgCls, value : str) -> None\n"
"SetPropertyValue(id : PGPropArgCls, value : List[str]) -> None\n"
"SetPropertyValue(id : PGPropArgCls, value : wx.DateTime) -> None\n"
"SetPropertyValue(id : PGPropArgCls, value : wx.Object) -> None\n"
"SetPropertyValue(id : PGPropArgCls, value : List[int]) -> None\n"
"SetPropertyValue(id : PGPropArgCls, value : PGVariant) -> None\n"
"SetPropertyValue(id : PGPropArgCls, value : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropertyValueString, "SetPropertyValueString(id : PGPropArgCls, value : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetPropVal, "SetPropVal(id : PGPropArgCls, value : PGVariant) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetValidationFailureBehavior, "SetValidationFailureBehavior(vfbFlags : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_Sort, "Sort(flags: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SortChildren, "SortChildren(id : PGPropArgCls, flags: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetPropertyByNameA, "GetPropertyByNameA(name : str) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_RefreshProperty, "RefreshProperty(p : PGProperty) -> None");
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_SetBoolChoices, "SetBoolChoices(trueChoice : str, falseChoice : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridInterface_GetEditorByName, "GetEditorByName(editorName : str) -> PGEditor\n"
"\n"
