...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_Create, "Create(parent : AuiMDIParentFrame, winid: int=wx.ID_ANY, title: str='', pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=wx.DEFAULT_FRAME_STYLE, name: str=wx.FrameNameStr) -> bool");
...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_SetMenuBar, "SetMenuBar(menuBar : wx.MenuBar) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_SetTitle, "SetTitle(title : str) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_SetIcons, "SetIcons(icons : wx.IconBundle) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_SetIcon, "SetIcon(icon : wx.Icon) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_Show, "Show(show: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_CreateStatusBar, "CreateStatusBar(number: int=1, style: int=1, winid: int=1, name: str='') -> wx.StatusBar");
...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_SetStatusText, "SetStatusText(text : str, number: int=0) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_SetStatusWidths, "SetStatusWidths(widths : List[int]) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_CreateToolBar, "CreateToolBar(style : int, winid : int, name : str) -> wx.ToolBar");
...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_Maximize, "Maximize(maximize: bool=True) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_Iconize, "Iconize(iconize: bool=True) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_ShowFullScreen, "ShowFullScreen(show : bool, style : int) -> bool");
...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_SetMDIParentFrame, "SetMDIParentFrame(parent : AuiMDIParentFrame) -> None");
...
PyDoc_STRVAR(doc_wxAuiMDIChildFrame_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
