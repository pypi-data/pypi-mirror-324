...
PyDoc_STRVAR(doc_wxRichTextCell_Draw, "Draw(dc : wx.DC, context : RichTextDrawingContext, range : RichTextRange, selection : RichTextSelection, rect : wx.Rect, descent : int, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextCell_HitTest, "HitTest(dc : wx.DC, context : RichTextDrawingContext, pt : wx.Point, flags: int=0) -> Tuple[int, int, RichTextObject, RichTextObject]\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextCell_EditProperties, "EditProperties(parent : wx.Window, buffer : RichTextBuffer) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextCell_SetColSpan, "SetColSpan(span : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextCell_SetRowSpan, "SetRowSpan(span : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextCell_Copy, "Copy(obj : RichTextCell) -> None");
...
PyDoc_STRVAR(doc_wxRichTextCell, "RichTextCell(parent: Optional[RichTextObject]=None) -> None\n"
