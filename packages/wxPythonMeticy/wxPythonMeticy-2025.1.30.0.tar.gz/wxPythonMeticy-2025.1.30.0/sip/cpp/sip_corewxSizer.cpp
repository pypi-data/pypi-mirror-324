...
PyDoc_STRVAR(doc_wxSizer_SetItemMinSize, "SetItemMinSize(window : Window, width : int, height : int) -> bool\n"
"SetItemMinSize(window : Window, size : Size) -> bool\n"
"SetItemMinSize(sizer : Sizer, width : int, height : int) -> bool\n"
"SetItemMinSize(sizer : Sizer, size : Size) -> bool\n"
"SetItemMinSize(index : int, width : int, height : int) -> bool\n"
"SetItemMinSize(index : int, size : Size) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_Add, "Add(window : Window, flags : SizerFlags) -> SizerItem\n"
...
PyDoc_STRVAR(doc_wxSizer_AddSpacer, "AddSpacer(size : int) -> SizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_AddStretchSpacer, "AddStretchSpacer(prop: int=1) -> SizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_Clear, "Clear(delete_windows: bool=False) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_ComputeFittingClientSize, "ComputeFittingClientSize(window : Window) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_ComputeFittingWindowSize, "ComputeFittingWindowSize(window : Window) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_Detach, "Detach(window : Window) -> bool\n"
"Detach(sizer : Sizer) -> bool\n"
...
PyDoc_STRVAR(doc_wxSizer_Fit, "Fit(window : Window) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_FitInside, "FitInside(window : Window) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_InformFirstDirection, "InformFirstDirection(direction : int, size : int, availableOtherDir : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_SetContainingWindow, "SetContainingWindow(window : Window) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_GetItem, "GetItem(window : Window, recursive: bool=False) -> SizerItem\n"
"GetItem(sizer : Sizer, recursive: bool=False) -> SizerItem\n"
"GetItem(index : int) -> SizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_GetItemById, "GetItemById(id : int, recursive: bool=False) -> SizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_Hide, "Hide(window : Window, recursive: bool=False) -> bool\n"
"Hide(sizer : Sizer, recursive: bool=False) -> bool\n"
"Hide(index : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_Insert, "Insert(index : int, window : Window, flags : SizerFlags) -> SizerItem\n"
"Insert(index : int, window : Window, proportion: int=0, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> SizerItem\n"
"Insert(index : int, sizer : Sizer, flags : SizerFlags) -> SizerItem\n"
"Insert(index : int, sizer : Sizer, proportion: int=0, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> SizerItem\n"
"Insert(index : int, width : int, height : int, proportion: int=0, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> SizerItem\n"
"Insert(index : int, width : int, height : int, flags : SizerFlags) -> SizerItem\n"
"Insert(index : int, item : SizerItem) -> SizerItem\n"
"Insert(index: int, size: Size, proportion: int=0, flag: int=0, border: int=0, Transfer: Optional[PyUserDatauserData]=None) -> SizerItem\n"
"Insert(index: int, size: Size, flags: SizerFlags) -> SizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_InsertSpacer, "InsertSpacer(index : int, size : int) -> SizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_InsertStretchSpacer, "InsertStretchSpacer(index : int, prop: int=1) -> SizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_IsShown, "IsShown(window : Window) -> bool\n"
"IsShown(sizer : Sizer) -> bool\n"
"IsShown(index : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_Prepend, "Prepend(window : Window, flags : SizerFlags) -> SizerItem\n"
"Prepend(window : Window, proportion: int=0, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> SizerItem\n"
"Prepend(sizer : Sizer, flags : SizerFlags) -> SizerItem\n"
"Prepend(sizer : Sizer, proportion: int=0, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> SizerItem\n"
"Prepend(width : int, height : int, proportion: int=0, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> SizerItem\n"
"Prepend(width : int, height : int, flags : SizerFlags) -> SizerItem\n"
"Prepend(item : SizerItem) -> SizerItem\n"
"Prepend(size: Size, proportion: int=0, flag: int=0, border: int=0, Transfer: Optional[PyUserDatauserData]=None) -> SizerItem\n"
"Prepend(size: Size, flags: SizerFlags) -> SizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_PrependSpacer, "PrependSpacer(size : int) -> SizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_PrependStretchSpacer, "PrependStretchSpacer(prop: int=1) -> SizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_RepositionChildren, "RepositionChildren(minSize : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_Remove, "Remove(sizer : Sizer) -> bool\n"
...
PyDoc_STRVAR(doc_wxSizer_Replace, "Replace(oldwin : Window, newwin : Window, recursive: bool=False) -> bool\n"
"Replace(oldsz : Sizer, newsz : Sizer, recursive: bool=False) -> bool\n"
...
PyDoc_STRVAR(doc_wxSizer_SetDimension, "SetDimension(x : int, y : int, width : int, height : int) -> None\n"
"SetDimension(pos : Point, size : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_SetMinSize, "SetMinSize(size : Size) -> None\n"
"SetMinSize(width : int, height : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_SetSizeHints, "SetSizeHints(window : Window) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_Show, "Show(window : Window, show: bool=True, recursive: bool=False) -> bool\n"
"Show(sizer : Sizer, show: bool=True, recursive: bool=False) -> bool\n"
"Show(index : int, show: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizer_ShowItems, "ShowItems(show : bool) -> None\n"
"\n"
