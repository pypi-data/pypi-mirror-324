...
PyDoc_STRVAR(doc_wxPGChoiceAndButtonEditor_CreateControls, "CreateControls(propgrid : PropertyGrid, property : PGProperty, pos : wx.Point, size : wx.Size) -> PGWindowList\n"
"\n"
