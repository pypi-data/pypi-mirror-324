...
PyDoc_STRVAR(doc_wxRichTextField_Draw, "Draw(dc : wx.DC, context : RichTextDrawingContext, range : RichTextRange, selection : RichTextSelection, rect : wx.Rect, descent : int, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextField_Layout, "Layout(dc : wx.DC, context : RichTextDrawingContext, rect : wx.Rect, parentRect : wx.Rect, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextField_GetRangeSize, "GetRangeSize(range : RichTextRange, size : wx.Size, descent : int, dc : wx.DC, context : RichTextDrawingContext, flags : int, position: wx.Point=wx.Point(0,0), parentSize: wx.Size=wx.DefaultSize, partialExtents: Optional[List[int]]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextField_EditProperties, "EditProperties(parent : wx.Window, buffer : RichTextBuffer) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextField_CalculateRange, "CalculateRange(start : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextField_SetFieldType, "SetFieldType(fieldType : str) -> None");
...
PyDoc_STRVAR(doc_wxRichTextField_UpdateField, "UpdateField(buffer : RichTextBuffer) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextField_Copy, "Copy(obj : RichTextField) -> None");
...
PyDoc_STRVAR(doc_wxRichTextField, "RichTextField(fieldType: str='', parent: Optional[RichTextObject]=None) -> None\n"
