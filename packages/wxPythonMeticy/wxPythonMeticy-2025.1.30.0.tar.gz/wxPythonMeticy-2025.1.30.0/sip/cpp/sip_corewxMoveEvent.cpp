...
PyDoc_STRVAR(doc_wxMoveEvent_SetRect, "SetRect(rect : Rect) -> None");
...
PyDoc_STRVAR(doc_wxMoveEvent_SetPosition, "SetPosition(pos : Point) -> None");
...
PyDoc_STRVAR(doc_wxMoveEvent, "MoveEvent(pt : Point, id: int=0) -> None\n"
"\n"
