...
PyDoc_STRVAR(doc_wxAffineMatrix2DBase_IsEqual, "IsEqual(t : AffineMatrix2DBase) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2DBase_Set, "Set(mat2D : Matrix2D, tr : Point2DDouble) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2DBase_Concat, "Concat(t : AffineMatrix2DBase) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2DBase_Translate, "Translate(dx : float, dy : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2DBase_Scale, "Scale(xScale : float, yScale : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2DBase_Rotate, "Rotate(cRadians : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2DBase_Mirror, "Mirror(direction: int=HORIZONTAL) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2DBase_TransformPoint, "TransformPoint(p : Point2DDouble) -> Point2DDouble\n"
"TransformPoint(x : float, y : float) -> Tuple[float, float]\n"
"\n"
...
PyDoc_STRVAR(doc_wxAffineMatrix2DBase_TransformDistance, "TransformDistance(p : Point2DDouble) -> Point2DDouble\n"
"TransformDistance(dx : float, dy : float) -> Tuple[float, float]\n"
"\n"
