...
PyDoc_STRVAR(doc_wxWebViewArchiveHandler_GetFile, "GetFile(uri : str) -> wx.FSFile");
...
PyDoc_STRVAR(doc_wxWebViewArchiveHandler, "WebViewArchiveHandler(scheme : str) -> None\n"
"\n"
