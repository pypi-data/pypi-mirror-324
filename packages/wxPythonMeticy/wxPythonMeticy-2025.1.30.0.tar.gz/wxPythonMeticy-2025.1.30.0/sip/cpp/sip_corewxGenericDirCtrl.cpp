...
PyDoc_STRVAR(doc_wxGenericDirCtrl_CollapsePath, "CollapsePath(path : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericDirCtrl_Create, "Create(parent : Window, id: int=ID_ANY, dir: str=DirDialogDefaultFolderStr, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=DIRCTRL_DEFAULT_STYLE, filter: str='', defaultFilter: int=0, name: str=TreeCtrlNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericDirCtrl_ExpandPath, "ExpandPath(path : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericDirCtrl_GetFilePaths, "GetFilePaths(paths : List[str]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericDirCtrl_SetDefaultPath, "SetDefaultPath(path : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericDirCtrl_SetFilter, "SetFilter(filter : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericDirCtrl_SetFilterIndex, "SetFilterIndex(n : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericDirCtrl_SetPath, "SetPath(path : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericDirCtrl_ShowHidden, "ShowHidden(show : bool) -> None");
...
PyDoc_STRVAR(doc_wxGenericDirCtrl_SelectPath, "SelectPath(path : str, select: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericDirCtrl_SelectPaths, "SelectPaths(paths : List[str]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericDirCtrl_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"GenericDirCtrl(parent : Window, id: int=ID_ANY, dir: str=DirDialogDefaultFolderStr, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=DIRCTRL_DEFAULT_STYLE, filter: str='', defaultFilter: int=0, name: str=TreeCtrlNameStr) -> None\n"
"\n"
