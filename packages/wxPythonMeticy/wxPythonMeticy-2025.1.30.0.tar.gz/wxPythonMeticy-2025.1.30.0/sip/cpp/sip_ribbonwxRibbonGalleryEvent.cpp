...
PyDoc_STRVAR(doc_wxRibbonGalleryEvent_SetGallery, "SetGallery(gallery : RibbonGallery) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonGalleryEvent_SetGalleryItem, "SetGalleryItem(item : RibbonGalleryItem) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonGalleryEvent, "RibbonGalleryEvent(command_type: EventType=wx.wxEVT_NULL, win_id: int=0, gallery: Optional[RibbonGallery]=None, item: Optional[RibbonGalleryItem]=None) -> None");
