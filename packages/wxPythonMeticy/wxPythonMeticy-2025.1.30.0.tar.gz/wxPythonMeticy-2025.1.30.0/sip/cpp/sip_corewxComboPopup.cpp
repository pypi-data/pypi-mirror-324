...
PyDoc_STRVAR(doc_wxComboPopup_Create, "Create(parent : Window) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboPopup_FindItem, "FindItem(item : str, trueItem: Optional[str]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboPopup_GetAdjustedSize, "GetAdjustedSize(minWidth : int, prefHeight : int, maxHeight : int) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboPopup_OnComboKeyEvent, "OnComboKeyEvent(event : KeyEvent) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboPopup_PaintComboControl, "PaintComboControl(dc : DC, rect : Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboPopup_SetStringValue, "SetStringValue(value : str) -> None\n"
"\n"
