...
PyDoc_STRVAR(doc_wxNativeFontInfo_InitFromFont, "InitFromFont(font : Font) -> None");
...
PyDoc_STRVAR(doc_wxNativeFontInfo_SetPointSize, "SetPointSize(pointsize : int) -> None");
...
PyDoc_STRVAR(doc_wxNativeFontInfo_SetFractionalPointSize, "SetFractionalPointSize(pointsize : float) -> None");
...
PyDoc_STRVAR(doc_wxNativeFontInfo_SetStyle, "SetStyle(style : FontStyle) -> None");
...
PyDoc_STRVAR(doc_wxNativeFontInfo_SetNumericWeight, "SetNumericWeight(weight : int) -> None");
...
PyDoc_STRVAR(doc_wxNativeFontInfo_SetWeight, "SetWeight(weight : FontWeight) -> None");
...
PyDoc_STRVAR(doc_wxNativeFontInfo_SetUnderlined, "SetUnderlined(underlined : bool) -> None");
...
PyDoc_STRVAR(doc_wxNativeFontInfo_SetFaceName, "SetFaceName(facename : str) -> bool\n"
"SetFaceName(facenames : List[str]) -> None\n"
"");
...
PyDoc_STRVAR(doc_wxNativeFontInfo_SetFamily, "SetFamily(family : FontFamily) -> None");
...
PyDoc_STRVAR(doc_wxNativeFontInfo_SetEncoding, "SetEncoding(encoding : FontEncoding) -> None");
...
PyDoc_STRVAR(doc_wxNativeFontInfo_FromString, "FromString(s : str) -> bool");
...
PyDoc_STRVAR(doc_wxNativeFontInfo_FromUserString, "FromUserString(s : str) -> bool");
