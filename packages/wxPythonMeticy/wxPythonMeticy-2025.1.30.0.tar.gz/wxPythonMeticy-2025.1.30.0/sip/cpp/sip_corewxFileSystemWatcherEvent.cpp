...
PyDoc_STRVAR(doc_wxFileSystemWatcherEvent, "FileSystemWatcherEvent(changeType: int=0, watchid: int=ID_ANY) -> None\n"
"FileSystemWatcherEvent(changeType : int, warningType : FSWWarningType, errorMsg : str, watchid: int=ID_ANY) -> None\n"
"FileSystemWatcherEvent(changeType : int, path : str, newPath : str, watchid: int=ID_ANY) -> None\n"
"\n"
