...
PyDoc_STRVAR(doc_wxVScrolledWindow_OnGetRowsHeightHint, "OnGetRowsHeightHint(rowMin : int, rowMax : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVScrolledWindow_OnGetRowHeight, "OnGetRowHeight(row : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxVScrolledWindow_Create, "Create(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=PanelNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVScrolledWindow_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
PyDoc_STRVAR(doc_wxVScrolledWindow_SetLineCount, "SetLineCount(count: int) -> None\n"
"\n"
"Deprecated compatibility helper.");
...
PyDoc_STRVAR(doc_wxVScrolledWindow_RefreshLine, "RefreshLine(line: int) -> None\n"
"\n"
"Deprecated compatibility helper.");
...
PyDoc_STRVAR(doc_wxVScrolledWindow_RefreshLines, "RefreshLines(from_: int, to_: int) -> None\n"
"\n"
"Deprecated compatibility helper.");
...
PyDoc_STRVAR(doc_wxVScrolledWindow_ScrollToLine, "ScrollToLine(line: int) -> bool\n"
"\n"
"Deprecated compatibility helper.");
...
PyDoc_STRVAR(doc_wxVScrolledWindow_ScrollLines, "ScrollLines(lines: int) -> bool\n"
"\n"
"Deprecated compatibility helper.");
...
PyDoc_STRVAR(doc_wxVScrolledWindow_ScrollPages, "ScrollPages(pages: int) -> bool\n"
"\n"
"Deprecated compatibility helper.");
...
"VScrolledWindow(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=PanelNameStr) -> None\n"
"\n"
