...
PyDoc_STRVAR(doc_wxFileDialog_AddShortcut, "AddShortcut(directory : str, flags: int=0) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileDialog_SetCustomizeHook, "SetCustomizeHook(customizeHook : FileDialogCustomizeHook) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileDialog_SetDirectory, "SetDirectory(directory : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileDialog_SetFilename, "SetFilename(setfilename : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileDialog_SetFilterIndex, "SetFilterIndex(filterIndex : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileDialog_SetMessage, "SetMessage(message : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileDialog_SetPath, "SetPath(path : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileDialog_SetWildcard, "SetWildcard(wildCard : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileDialog_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
PyDoc_STRVAR(doc_wxFileDialog, "FileDialog(parent : Window, message: str=FileSelectorPromptStr, defaultDir: str='', defaultFile: str='', wildcard: str=FileSelectorDefaultWildcardStr, style: int=FD_DEFAULT_STYLE, pos: Point=DefaultPosition, size: Size=DefaultSize, name: str=FileDialogNameStr) -> None\n"
"\n"
