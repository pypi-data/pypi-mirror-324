...
"DeleteTemporaryImages(flags : int, imageLocations : List[str]) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextHTMLHandler_SetFontSizeMapping, "SetFontSizeMapping(fontSizeMapping : List[int]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextHTMLHandler_SetTempDir, "SetTempDir(tempDir : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextHTMLHandler_SetTemporaryImageLocations, "SetTemporaryImageLocations(locations : List[str]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextHTMLHandler_SetFileCounter, "SetFileCounter(counter : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextHTMLHandler, "RichTextHTMLHandler(name: str=\"HTML\", ext: str=\"html\", type: int=RICHTEXT_TYPE_HTML) -> None\n"
"\n"
