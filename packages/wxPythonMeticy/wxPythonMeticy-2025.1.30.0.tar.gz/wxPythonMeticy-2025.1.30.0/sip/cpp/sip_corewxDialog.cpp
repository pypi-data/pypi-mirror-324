...
PyDoc_STRVAR(doc_wxDialog_AddMainButtonId, "AddMainButtonId(id : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_Centre, "Centre(direction: int=BOTH) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_Create, "Create(parent : Window, id: int=ID_ANY, title: str='', pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=DEFAULT_DIALOG_STYLE, name: str=DialogNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_CreateButtonSizer, "CreateButtonSizer(flags : int) -> Sizer\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_CreateSeparatedButtonSizer, "CreateSeparatedButtonSizer(flags : int) -> Sizer\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_CreateSeparatedSizer, "CreateSeparatedSizer(sizer : Sizer) -> Sizer\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_CreateStdDialogButtonSizer, "CreateStdDialogButtonSizer(flags : int) -> StdDialogButtonSizer\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_CreateTextSizer, "CreateTextSizer(message : str, widthMax: int=-1) -> Sizer\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_EndModal, "EndModal(retCode : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_Iconize, "Iconize(iconize: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_IsMainButtonId, "IsMainButtonId(id : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_SetAffirmativeId, "SetAffirmativeId(id : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_SetEscapeId, "SetEscapeId(id : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_SetIcon, "SetIcon(icon : Icon) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_SetIcons, "SetIcons(icons : IconBundle) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_SetLayoutAdaptationDone, "SetLayoutAdaptationDone(done : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_SetLayoutAdaptationLevel, "SetLayoutAdaptationLevel(level : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_SetLayoutAdaptationMode, "SetLayoutAdaptationMode(mode : DialogLayoutAdaptationMode) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_SetReturnCode, "SetReturnCode(retCode : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_Show, "Show(show: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_EnableLayoutAdaptation, "EnableLayoutAdaptation(enable : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_SetLayoutAdapter, "SetLayoutAdapter(adapter : DialogLayoutAdapter) -> DialogLayoutAdapter\n"
"\n"
...
PyDoc_STRVAR(doc_wxDialog_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
