...
PyDoc_STRVAR(doc_wxFont_AddPrivateFont, "AddPrivateFont(filename : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_Scale, "Scale(x : float) -> Font\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_Scaled, "Scaled(x : float) -> Font\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_SetEncoding, "SetEncoding(encoding : FontEncoding) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_SetFaceName, "SetFaceName(faceName : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_SetFamily, "SetFamily(family : FontFamily) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_SetNativeFontInfo, "SetNativeFontInfo(info : str) -> bool\n"
"SetNativeFontInfo(info : NativeFontInfo) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_SetNativeFontInfoUserDesc, "SetNativeFontInfoUserDesc(info : str) -> bool\n"
"\n"
"Creates the font corresponding to the given native font description\n"
...
PyDoc_STRVAR(doc_wxFont_SetPointSize, "SetPointSize(pointSize : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_SetFractionalPointSize, "SetFractionalPointSize(pointSize : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_SetPixelSize, "SetPixelSize(pixelSize : Size) -> None\n"
"\n"
"Sets the pixel size.");
...
PyDoc_STRVAR(doc_wxFont_SetStyle, "SetStyle(style : FontStyle) -> None\n"
"\n"
"Sets the font style.");
...
PyDoc_STRVAR(doc_wxFont_SetSymbolicSize, "SetSymbolicSize(size : FontSymbolicSize) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_SetSymbolicSizeRelativeTo, "SetSymbolicSizeRelativeTo(size : FontSymbolicSize, base : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_SetUnderlined, "SetUnderlined(underlined : bool) -> None\n"
"\n"
"Sets underlining.");
...
PyDoc_STRVAR(doc_wxFont_SetStrikethrough, "SetStrikethrough(strikethrough : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_SetWeight, "SetWeight(weight : FontWeight) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_SetNumericWeight, "SetNumericWeight(weight : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_New, "New(pointSize : int, family : FontFamily, style : FontStyle, weight : FontWeight, underline: bool=False, faceName: str='', encoding: FontEncoding=FONTENCODING_DEFAULT) -> Font\n"
"New(pointSize : int, family : FontFamily, flags: int=FONTFLAG_DEFAULT, faceName: str='', encoding: FontEncoding=FONTENCODING_DEFAULT) -> Font\n"
"New(pixelSize : Size, family : FontFamily, style : FontStyle, weight : FontWeight, underline: bool=False, faceName: str='', encoding: FontEncoding=FONTENCODING_DEFAULT) -> Font\n"
"New(pixelSize : Size, family : FontFamily, flags: int=FONTFLAG_DEFAULT, faceName: str='', encoding: FontEncoding=FONTENCODING_DEFAULT) -> Font\n"
"New(nativeInfo : NativeFontInfo) -> Font\n"
"New(nativeInfoString : str) -> Font\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_SetDefaultEncoding, "SetDefaultEncoding(encoding : FontEncoding) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont_GetNumericWeightOf, "GetNumericWeightOf(weight : FontWeight) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxFont__copyFrom, "_copyFrom(other: Font) -> None\n"
"\n"
...
"Font(font : Font) -> None\n"
"Font(fontInfo : FontInfo) -> None\n"
"Font(pointSize : int, family : FontFamily, style : FontStyle, weight : FontWeight, underline: bool=False, faceName: str='', encoding: FontEncoding=FONTENCODING_DEFAULT) -> None\n"
"Font(pixelSize : Size, family : FontFamily, style : FontStyle, weight : FontWeight, underline: bool=False, faceName: str='', encoding: FontEncoding=FONTENCODING_DEFAULT) -> None\n"
"Font(nativeInfoString : str) -> None\n"
"Font(nativeInfo : NativeFontInfo) -> None\n"
"\n"
