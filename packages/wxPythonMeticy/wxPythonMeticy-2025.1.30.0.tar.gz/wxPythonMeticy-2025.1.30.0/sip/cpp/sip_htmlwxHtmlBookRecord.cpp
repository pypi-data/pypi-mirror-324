...
PyDoc_STRVAR(doc_wxHtmlBookRecord_SetContentsRange, "SetContentsRange(start : int, end : int) -> None");
...
PyDoc_STRVAR(doc_wxHtmlBookRecord_SetTitle, "SetTitle(title : str) -> None");
...
PyDoc_STRVAR(doc_wxHtmlBookRecord_SetBasePath, "SetBasePath(path : str) -> None");
...
PyDoc_STRVAR(doc_wxHtmlBookRecord_SetStart, "SetStart(start : str) -> None");
...
PyDoc_STRVAR(doc_wxHtmlBookRecord_GetFullPath, "GetFullPath(page : str) -> str");
...
PyDoc_STRVAR(doc_wxHtmlBookRecord, "HtmlBookRecord(bookfile : str, basepath : str, title : str, start : str) -> None\n"
"\n"
