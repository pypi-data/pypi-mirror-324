...
PyDoc_STRVAR(doc_wxScrollEvent_SetOrientation, "SetOrientation(orient : int) -> None");
...
PyDoc_STRVAR(doc_wxScrollEvent_SetPosition, "SetPosition(pos : int) -> None");
...
PyDoc_STRVAR(doc_wxScrollEvent, "ScrollEvent(commandType: EventType=wxEVT_NULL, id: int=0, pos: int=0, orientation: int=0) -> None\n"
"\n"
