...
PyDoc_STRVAR(doc_wxArtProvider_Delete, "Delete(provider : ArtProvider) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_GetBitmap, "GetBitmap(id : ArtID, client: ArtClient=ART_OTHER, size: Size=DefaultSize) -> Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_GetBitmapBundle, "GetBitmapBundle(id : ArtID, client: ArtClient=ART_OTHER, size: Size=DefaultSize) -> BitmapBundle\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_GetIcon, "GetIcon(id : ArtID, client: ArtClient=ART_OTHER, size: Size=DefaultSize) -> Icon\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_GetNativeDIPSizeHint, "GetNativeDIPSizeHint(client : ArtClient) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_GetNativeSizeHint, "GetNativeSizeHint(client : ArtClient, win: Optional[Window]=None) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_GetDIPSizeHint, "GetDIPSizeHint(client : ArtClient) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_GetSizeHint, "GetSizeHint(client : ArtClient, win: Optional[Window]=None) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_GetIconBundle, "GetIconBundle(id : ArtID, client: ArtClient=ART_OTHER) -> IconBundle\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_Push, "Push(provider : ArtProvider) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_PushBack, "PushBack(provider : ArtProvider) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_Remove, "Remove(provider : ArtProvider) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_GetMessageBoxIconId, "GetMessageBoxIconId(flags : int) -> ArtID\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_GetMessageBoxIcon, "GetMessageBoxIcon(flags : int) -> Icon\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_CreateBitmap, "CreateBitmap(id : ArtID, client : ArtClient, size : Size) -> Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_CreateBitmapBundle, "CreateBitmapBundle(id : ArtID, client : ArtClient, size : Size) -> BitmapBundle\n"
"\n"
...
PyDoc_STRVAR(doc_wxArtProvider_CreateIconBundle, "CreateIconBundle(id : ArtID, client : ArtClient) -> IconBundle\n"
"\n"
