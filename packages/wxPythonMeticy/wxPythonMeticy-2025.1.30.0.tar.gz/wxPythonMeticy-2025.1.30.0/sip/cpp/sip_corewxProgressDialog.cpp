...
PyDoc_STRVAR(doc_wxProgressDialog_Pulse, "Pulse(newmsg: str='') -> Tuple[bool, bool]\n"
"\n"
...
PyDoc_STRVAR(doc_wxProgressDialog_SetRange, "SetRange(maximum : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxProgressDialog_Update, "Update(value : int, newmsg: str='') -> Tuple[bool, bool]\n"
"\n"
...
PyDoc_STRVAR(doc_wxProgressDialog_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
PyDoc_STRVAR(doc_wxProgressDialog, "ProgressDialog(title : str, message : str, maximum: int=100, parent: Optional[Window]=None, style: int=PD_APP_MODAL|PD_AUTO_HIDE) -> None\n"
"\n"
