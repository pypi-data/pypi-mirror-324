...
PyDoc_STRVAR(doc_wxSharedClientDataContainer_SetClientData, "SetClientData(data : Any) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSharedClientDataContainer_SetClientObject, "SetClientObject(data : ClientData) -> None\n"
"\n"
