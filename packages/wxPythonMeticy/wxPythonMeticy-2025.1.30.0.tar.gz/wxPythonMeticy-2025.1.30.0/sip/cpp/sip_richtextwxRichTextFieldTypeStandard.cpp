...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_Copy, "Copy(field : RichTextFieldTypeStandard) -> None\n"
"\n"
"Copies the object.");
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_Draw, "Draw(obj : RichTextField, dc : wx.DC, context : RichTextDrawingContext, range : RichTextRange, selection : RichTextSelection, rect : wx.Rect, descent : int, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_Layout, "Layout(obj : RichTextField, dc : wx.DC, context : RichTextDrawingContext, rect : wx.Rect, parentRect : wx.Rect, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_GetRangeSize, "GetRangeSize(obj : RichTextField, range : RichTextRange, size : wx.Size, descent : int, dc : wx.DC, context : RichTextDrawingContext, flags : int, position: wx.Point=wx.Point(0,0), parentSize: wx.Size=wx.DefaultSize, partialExtents: Optional[List[int]]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_GetSize, "GetSize(obj : RichTextField, dc : wx.DC, context : RichTextDrawingContext, style : int) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_IsTopLevel, "IsTopLevel(obj : RichTextField) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_SetLabel, "SetLabel(label : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_SetBitmap, "SetBitmap(bitmap : wx.Bitmap) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_SetDisplayStyle, "SetDisplayStyle(displayStyle : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_SetFont, "SetFont(font : wx.Font) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_SetTextColour, "SetTextColour(colour : wx.Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_SetBorderColour, "SetBorderColour(colour : wx.Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_SetBackgroundColour, "SetBackgroundColour(colour : wx.Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_SetVerticalPadding, "SetVerticalPadding(padding : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_SetHorizontalPadding, "SetHorizontalPadding(padding : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_SetHorizontalMargin, "SetHorizontalMargin(margin : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard_SetVerticalMargin, "SetVerticalMargin(margin : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFieldTypeStandard, "RichTextFieldTypeStandard(name : str, label : str, displayStyle: int=RICHTEXT_FIELD_STYLE_RECTANGLE) -> None\n"
"RichTextFieldTypeStandard(name : str, bitmap : wx.Bitmap, displayStyle: int=RICHTEXT_FIELD_STYLE_NO_BORDER) -> None\n"
