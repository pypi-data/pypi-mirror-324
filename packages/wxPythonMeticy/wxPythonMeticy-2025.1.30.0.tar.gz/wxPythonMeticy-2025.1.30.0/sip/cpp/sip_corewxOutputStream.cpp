...
PyDoc_STRVAR(doc_wxOutputStream_PutC, "PutC(c : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxOutputStream_SeekO, "SeekO(pos : FileOffset, mode: SeekMode=FromStart) -> FileOffset\n"
"\n"
...
PyDoc_STRVAR(doc_wxOutputStream_Write, "Write(buffer : Any, size : int) -> OutputStream\n"
"Write(stream_in : InputStream) -> OutputStream\n"
"\n"
...
PyDoc_STRVAR(doc_wxOutputStream_WriteAll, "WriteAll(buffer : Any, size : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxOutputStream_seek, "seek(offset: FileOffset, whence: int=0) -> None");
...
PyDoc_STRVAR(doc_wxOutputStream_write, "write(data: Any) -> Any");
