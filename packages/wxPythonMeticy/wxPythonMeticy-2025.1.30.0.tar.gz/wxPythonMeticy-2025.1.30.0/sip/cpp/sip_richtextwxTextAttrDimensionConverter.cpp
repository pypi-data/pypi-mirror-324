...
PyDoc_STRVAR(doc_wxTextAttrDimensionConverter_GetPixels, "GetPixels(dim : TextAttrDimension, direction: int=wx.HORIZONTAL) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrDimensionConverter_GetTenthsMM, "GetTenthsMM(dim : TextAttrDimension) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrDimensionConverter_ConvertTenthsMMToPixels, "ConvertTenthsMMToPixels(units : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrDimensionConverter_ConvertPixelsToTenthsMM, "ConvertPixelsToTenthsMM(pixels : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrDimensionConverter, "TextAttrDimensionConverter(dc : wx.DC, scale: float=1.0, parentSize: wx.Size=wx.DefaultSize) -> None\n"
"TextAttrDimensionConverter(ppi : int, scale: float=1.0, parentSize: wx.Size=wx.DefaultSize) -> None\n"
"\n"
