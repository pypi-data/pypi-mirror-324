...
PyDoc_STRVAR(doc_wxFileCtrl_Create, "Create(parent : Window, id: int=ID_ANY, defaultDirectory: str='', defaultFilename: str='', wildCard: str=FileSelectorDefaultWildcardStr, style: int=FC_DEFAULT_STYLE, pos: Point=DefaultPosition, size: Size=DefaultSize, name: str=FileCtrlNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileCtrl_SetDirectory, "SetDirectory(directory : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileCtrl_SetFilename, "SetFilename(filename : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileCtrl_SetPath, "SetPath(path : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileCtrl_SetFilterIndex, "SetFilterIndex(filterIndex : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileCtrl_SetWildcard, "SetWildcard(wildCard : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileCtrl_ShowHidden, "ShowHidden(show : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileCtrl_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"FileCtrl(parent : Window, id: int=ID_ANY, defaultDirectory: str='', defaultFilename: str='', wildCard: str=FileSelectorDefaultWildcardStr, style: int=FC_DEFAULT_STYLE, pos: Point=DefaultPosition, size: Size=DefaultSize, name: str=FileCtrlNameStr) -> None\n"
"\n"
