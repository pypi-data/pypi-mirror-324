...
PyDoc_STRVAR(doc_wxBusyInfo_UpdateText, "UpdateText(str : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBusyInfo_UpdateLabel, "UpdateLabel(str : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBusyInfo, "BusyInfo(flags : BusyInfoFlags) -> None\n"
"BusyInfo(msg : str, parent: Optional[Window]=None) -> None\n"
"\n"
