...
PyDoc_STRVAR(doc_wxGraphicsContext_Create, "Create(window : Window) -> GraphicsContext\n"
"Create(windowDC : WindowDC) -> GraphicsContext\n"
"Create(memoryDC : MemoryDC) -> GraphicsContext\n"
"Create(printerDC : PrinterDC) -> GraphicsContext\n"
"Create(metaFileDC : MetafileDC) -> GraphicsContext\n"
"Create(image : Image) -> GraphicsContext\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_CreateFromUnknownDC, "CreateFromUnknownDC(dc : DC) -> GraphicsContext\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_CreateFromNative, "CreateFromNative(context : Any) -> GraphicsContext\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_CreateFromNativeWindow, "CreateFromNativeWindow(window : Any) -> GraphicsContext\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_Clip, "Clip(region : Region) -> None\n"
"Clip(x : float, y : float, w : float, h : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_GetClipBox, "GetClipBox(x : float, y : float, w : float, h : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_CreateMatrix, "CreateMatrix(a: float=1.0, b: float=0.0, c: float=0.0, d: float=1.0, tx: float=0.0, ty: float=0.0) -> GraphicsMatrix\n"
"CreateMatrix(mat : AffineMatrix2DBase) -> GraphicsMatrix\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_ConcatTransform, "ConcatTransform(matrix : GraphicsMatrix) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_Rotate, "Rotate(angle : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_Scale, "Scale(xScale : float, yScale : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_SetTransform, "SetTransform(matrix : GraphicsMatrix) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_Translate, "Translate(dx : float, dy : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_CreateBrush, "CreateBrush(brush : Brush) -> GraphicsBrush\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_CreateLinearGradientBrush, "CreateLinearGradientBrush(x1 : float, y1 : float, x2 : float, y2 : float, c1 : Colour, c2 : Colour, matrix: GraphicsMatrix=NullGraphicsMatrix) -> GraphicsBrush\n"
"CreateLinearGradientBrush(x1 : float, y1 : float, x2 : float, y2 : float, stops : GraphicsGradientStops, matrix: GraphicsMatrix=NullGraphicsMatrix) -> GraphicsBrush\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_CreateRadialGradientBrush, "CreateRadialGradientBrush(startX : float, startY : float, endX : float, endY : float, radius : float, oColor : Colour, cColor : Colour, matrix: GraphicsMatrix=NullGraphicsMatrix) -> GraphicsBrush\n"
"CreateRadialGradientBrush(startX : float, startY : float, endX : float, endY : float, radius : float, stops : GraphicsGradientStops, matrix: GraphicsMatrix=NullGraphicsMatrix) -> GraphicsBrush\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_SetBrush, "SetBrush(brush : Brush) -> None\n"
"SetBrush(brush : GraphicsBrush) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_CreatePen, "CreatePen(pen : Pen) -> GraphicsPen\n"
"CreatePen(info : GraphicsPenInfo) -> GraphicsPen\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_SetPen, "SetPen(pen : Pen) -> None\n"
"SetPen(pen : GraphicsPen) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_DrawBitmap, "DrawBitmap(bmp : GraphicsBitmap, x : float, y : float, w : float, h : float) -> None\n"
"DrawBitmap(bmp : Bitmap, x : float, y : float, w : float, h : float) -> None\n"
"\n"
"Draws the bitmap.\n"
"");
...
PyDoc_STRVAR(doc_wxGraphicsContext_DrawEllipse, "DrawEllipse(x : float, y : float, w : float, h : float) -> None\n"
"\n"
"Draws an ellipse.");
...
PyDoc_STRVAR(doc_wxGraphicsContext_DrawIcon, "DrawIcon(icon : Icon, x : float, y : float, w : float, h : float) -> None\n"
"\n"
"Draws the icon.");
...
PyDoc_STRVAR(doc_wxGraphicsContext_DrawPath, "DrawPath(path : GraphicsPath, fillStyle: PolygonFillMode=ODDEVEN_RULE) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_DrawRectangle, "DrawRectangle(x : float, y : float, w : float, h : float) -> None\n"
"\n"
"Draws a rectangle.");
...
PyDoc_STRVAR(doc_wxGraphicsContext_DrawRoundedRectangle, "DrawRoundedRectangle(x : float, y : float, w : float, h : float, radius : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_DrawText, "DrawText(str : str, x : float, y : float) -> None\n"
"DrawText(str : str, x : float, y : float, angle : float) -> None\n"
"DrawText(str : str, x : float, y : float, backgroundBrush : GraphicsBrush) -> None\n"
"DrawText(str : str, x : float, y : float, angle : float, backgroundBrush : GraphicsBrush) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_FillPath, "FillPath(path : GraphicsPath, fillStyle: PolygonFillMode=ODDEVEN_RULE) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_StrokeLine, "StrokeLine(x1 : float, y1 : float, x2 : float, y2 : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_StrokePath, "StrokePath(path : GraphicsPath) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_CreateFont, "CreateFont(font : Font, col: Colour=BLACK) -> GraphicsFont\n"
"CreateFont(sizeInPixels : float, facename : str, flags: int=FONTFLAG_DEFAULT, col: Colour=BLACK) -> GraphicsFont\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_SetFont, "SetFont(font : Font, colour : Colour) -> None\n"
"SetFont(font : GraphicsFont) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_GetPartialTextExtents, "GetPartialTextExtents(text : str) -> List[float]\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_GetFullTextExtent, "GetFullTextExtent(text : str) -> Tuple[float, float, float, float]\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_StartDoc, "StartDoc(message : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_StartPage, "StartPage(width: float=0, height: float=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_CreateBitmap, "CreateBitmap(bitmap : Bitmap) -> GraphicsBitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_CreateBitmapFromImage, "CreateBitmapFromImage(image : Image) -> GraphicsBitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_CreateSubBitmap, "CreateSubBitmap(bitmap : GraphicsBitmap, x : float, y : float, w : float, h : float) -> GraphicsBitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_BeginLayer, "BeginLayer(opacity : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_SetAntialiasMode, "SetAntialiasMode(antialias : AntialiasMode) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_SetInterpolationQuality, "SetInterpolationQuality(interpolation : InterpolationQuality) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_SetCompositionMode, "SetCompositionMode(op : CompositionMode) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_EnableOffset, "EnableOffset(enable: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_FromDIP, "FromDIP(sz : Size) -> Size\n"
"FromDIP(pt : Point) -> Point\n"
"FromDIP(d : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsContext_ToDIP, "ToDIP(sz : Size) -> Size\n"
"ToDIP(pt : Point) -> Point\n"
"ToDIP(d : int) -> int\n"
"\n"
