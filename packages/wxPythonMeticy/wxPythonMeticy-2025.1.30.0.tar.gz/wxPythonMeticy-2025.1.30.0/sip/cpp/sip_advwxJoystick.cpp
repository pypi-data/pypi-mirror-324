...
PyDoc_STRVAR(doc_wxJoystick_SetCapture, "SetCapture(win : wx.Window, pollingFreq: int=0) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxJoystick_SetMovementThreshold, "SetMovementThreshold(threshold : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxJoystick, "Joystick(joystick: int=wx.JOYSTICK1) -> None\n"
"\n"
