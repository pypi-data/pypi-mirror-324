...
PyDoc_STRVAR(doc_wxNumericProperty_DoSetAttribute, "DoSetAttribute(name : str, value : PGVariant) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxNumericProperty_AddSpinStepValue, "AddSpinStepValue(stepScale : int) -> PGVariant\n"
"\n"
...
PyDoc_STRVAR(doc_wxNumericProperty, "NumericProperty(label : str, name : str) -> None\n"
"\n"
