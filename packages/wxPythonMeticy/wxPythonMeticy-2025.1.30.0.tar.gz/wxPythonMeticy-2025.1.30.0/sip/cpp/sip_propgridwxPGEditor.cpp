...
PyDoc_STRVAR(doc_wxPGEditor_CreateControls, "CreateControls(propgrid : PropertyGrid, property : PGProperty, pos : wx.Point, size : wx.Size) -> PGWindowList\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGEditor_UpdateControl, "UpdateControl(property : PGProperty, ctrl : wx.Window) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGEditor_DrawValue, "DrawValue(dc : wx.DC, rect : wx.Rect, property : PGProperty, text : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGEditor_OnEvent, "OnEvent(propgrid : PropertyGrid, property : PGProperty, wnd_primary : wx.Window, event : wx.Event) -> bool\n"
"\n"
"Handles events.");
...
PyDoc_STRVAR(doc_wxPGEditor_GetValueFromControl, "GetValueFromControl(property : PGProperty, ctrl : wx.Window) -> Tuple[bool, PGVariant]\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGEditor_SetValueToUnspecified, "SetValueToUnspecified(property : PGProperty, ctrl : wx.Window) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGEditor_SetControlAppearance, "SetControlAppearance(pg : PropertyGrid, property : PGProperty, ctrl : wx.Window, appearance : PGCell, oldAppearance : PGCell, unspecified : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGEditor_SetControlStringValue, "SetControlStringValue(property : PGProperty, ctrl : wx.Window, txt : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGEditor_SetControlIntValue, "SetControlIntValue(property : PGProperty, ctrl : wx.Window, value : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGEditor_InsertItem, "InsertItem(ctrl : wx.Window, label : str, index : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGEditor_DeleteItem, "DeleteItem(ctrl : wx.Window, index : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGEditor_OnFocus, "OnFocus(property : PGProperty, wnd : wx.Window) -> None\n"
"\n"
