...
PyDoc_STRVAR(doc_wxTreeEvent_SetToolTip, "SetToolTip(tooltip : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeEvent, "TreeEvent(commandType : EventType, tree : TreeCtrl, item: TreeItemId=TreeItemId()) -> None\n"
"\n"
