...
PyDoc_STRVAR(doc_wxRibbonButtonBarEvent_SetBar, "SetBar(bar : RibbonButtonBar) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonButtonBarEvent_SetButton, "SetButton(bar : RibbonButtonBarButtonBase) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonButtonBarEvent_PopupMenu, "PopupMenu(menu : wx.Menu) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonButtonBarEvent, "RibbonButtonBarEvent(command_type: EventType=wx.wxEVT_NULL, win_id: int=0, bar: Optional[RibbonButtonBar]=None, button: Optional[RibbonButtonBarButtonBase]=None) -> None\n"
"\n"
