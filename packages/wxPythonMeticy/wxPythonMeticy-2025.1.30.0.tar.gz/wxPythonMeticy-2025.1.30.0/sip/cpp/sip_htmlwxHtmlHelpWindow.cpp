...
PyDoc_STRVAR(doc_wxHtmlHelpWindow_Create, "Create(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=wx.TAB_TRAVERSAL|wx.BORDER_NONE, helpStyle: int=HF_DEFAULT_STYLE) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlHelpWindow_Display, "Display(x : str) -> bool\n"
"Display(id : int) -> bool\n"
"\n"
"Displays page x.\n"
"");
...
PyDoc_STRVAR(doc_wxHtmlHelpWindow_KeywordSearch, "KeywordSearch(keyword : str, mode: wx.HelpSearchMode=wx.HELP_SEARCH_ALL) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlHelpWindow_ReadCustomization, "ReadCustomization(cfg : wx.ConfigBase, path: str='') -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlHelpWindow_UseConfig, "UseConfig(config : wx.ConfigBase, rootpath: str='') -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlHelpWindow_WriteCustomization, "WriteCustomization(cfg : wx.ConfigBase, path: str='') -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlHelpWindow_SetController, "SetController(controller : HtmlHelpController) -> None");
...
PyDoc_STRVAR(doc_wxHtmlHelpWindow_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
...
PyDoc_STRVAR(doc_wxHtmlHelpWindow_AddToolbarButtons, "AddToolbarButtons(toolBar : wx.ToolBar, style : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlHelpWindow, "HtmlHelpWindow(data: Optional[HtmlHelpData]=None) -> None\n"
