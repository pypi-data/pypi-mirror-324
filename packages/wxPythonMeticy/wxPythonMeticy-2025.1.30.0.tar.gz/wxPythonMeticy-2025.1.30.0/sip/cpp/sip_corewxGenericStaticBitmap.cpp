...
PyDoc_STRVAR(doc_wxGenericStaticBitmap_Create, "Create(parent : Window, id: int=ID_ANY, bitmap: BitmapBundle=NullBitmap, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=StaticBitmapNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericStaticBitmap_SetBitmap, "SetBitmap(label : BitmapBundle) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericStaticBitmap_SetIcon, "SetIcon(label : Icon) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGenericStaticBitmap_SetScaleMode, "SetScaleMode(scaleMode : ScaleMode) -> None\n"
"\n"
"Sets the scale mode.");
...
PyDoc_STRVAR(doc_wxGenericStaticBitmap_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"GenericStaticBitmap(parent : Window, id: int=ID_ANY, bitmap: BitmapBundle=NullBitmap, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=StaticBitmapNameStr) -> None\n"
"\n"
