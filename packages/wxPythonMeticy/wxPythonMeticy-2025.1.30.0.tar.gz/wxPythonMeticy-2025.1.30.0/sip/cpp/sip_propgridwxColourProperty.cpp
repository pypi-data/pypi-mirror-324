...
PyDoc_STRVAR(doc_wxColourProperty_ValueToString, "ValueToString(value : PGVariant, argFlags: int=0) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxColourProperty_GetColour, "GetColour(index : int) -> wx.Colour\n"
"\n"
...
PyDoc_STRVAR(doc_wxColourProperty, "ColourProperty(label: str=PG_LABEL, name: str=PG_LABEL, value: wx.Colour=wx.WHITE) -> None\n"
"\n"
