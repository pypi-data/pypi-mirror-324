...
PyDoc_STRVAR(doc_wxRichTextCommand_AddAction, "AddAction(action : RichTextAction) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextCommand, "RichTextCommand(name : str, id : RichTextCommandId, buffer : RichTextBuffer, container : RichTextParagraphLayoutBox, ctrl : RichTextCtrl, ignoreFirstTime: bool=False) -> None\n"
