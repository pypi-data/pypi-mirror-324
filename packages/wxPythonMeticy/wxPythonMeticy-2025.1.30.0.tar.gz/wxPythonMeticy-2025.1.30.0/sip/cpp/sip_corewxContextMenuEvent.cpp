...
PyDoc_STRVAR(doc_wxContextMenuEvent_SetPosition, "SetPosition(point : Point) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxContextMenuEvent, "ContextMenuEvent(type: EventType=wxEVT_NULL, id: int=0, pos: Point=DefaultPosition) -> None\n"
"\n"
