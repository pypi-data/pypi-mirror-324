...
PyDoc_STRVAR(doc_wxIconLocation_SetFileName, "SetFileName(filename : str) -> None");
...
PyDoc_STRVAR(doc_wxIconLocation_SetIndex, "SetIndex(num: int) -> None");
...
"IconLocation(filename: str, num: int=0) -> None\n"
"\n"
