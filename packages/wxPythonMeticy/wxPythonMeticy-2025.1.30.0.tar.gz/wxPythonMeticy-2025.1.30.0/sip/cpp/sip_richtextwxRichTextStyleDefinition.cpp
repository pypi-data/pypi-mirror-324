...
PyDoc_STRVAR(doc_wxRichTextStyleDefinition_GetStyleMergedWithBase, "GetStyleMergedWithBase(sheet : RichTextStyleSheet) -> RichTextAttr\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextStyleDefinition_SetBaseStyle, "SetBaseStyle(name : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextStyleDefinition_SetDescription, "SetDescription(descr : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextStyleDefinition_SetName, "SetName(name : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextStyleDefinition_SetStyle, "SetStyle(style : RichTextAttr) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextStyleDefinition_SetProperties, "SetProperties(props : RichTextProperties) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextStyleDefinition, "RichTextStyleDefinition(name: str='') -> None\n"
"\n"
