...
PyDoc_STRVAR(doc_wxPGCell_MergeFrom, "MergeFrom(srcCell : PGCell) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGCell_SetText, "SetText(text : str) -> None");
...
PyDoc_STRVAR(doc_wxPGCell_SetBitmap, "SetBitmap(bitmap : wx.BitmapBundle) -> None");
...
PyDoc_STRVAR(doc_wxPGCell_SetFgCol, "SetFgCol(col : wx.Colour) -> None");
...
PyDoc_STRVAR(doc_wxPGCell_SetFont, "SetFont(font : wx.Font) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGCell_SetBgCol, "SetBgCol(col : wx.Colour) -> None");
...
"PGCell(text : str, bitmap: wx.BitmapBundle=wx.BitmapBundle(), fgCol: wx.Colour=wx.NullColour, bgCol: wx.Colour=wx.NullColour) -> None\n"
"\n"
