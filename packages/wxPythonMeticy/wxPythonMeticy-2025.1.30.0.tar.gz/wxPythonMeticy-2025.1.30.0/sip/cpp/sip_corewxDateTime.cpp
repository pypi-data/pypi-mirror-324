...
PyDoc_STRVAR(doc_wxDateTime_Set, "Set(day : int, month : DateTime.Month, year: int=Inv_Year, hour: int=0, minute: int=0, second: int=0, millisec: int=0) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetHMS, "SetHMS(hour : int, minute: int=0, second: int=0, millisec: int=0) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetJDN, "SetJDN(jdn : float) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetTimeT, "SetTimeT(timet : int) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetTm, "SetTm(tm : Tm) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetDay, "SetDay(day : int) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetFromDOS, "SetFromDOS(ddt : int) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetHour, "SetHour(hour : int) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetMillisecond, "SetMillisecond(millisecond : int) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetMinute, "SetMinute(minute : int) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetMonth, "SetMonth(month : DateTime.Month) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetSecond, "SetSecond(second : int) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetYear, "SetYear(year : int) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetCentury, "GetCentury(tz: TimeZone=Local) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetDay, "GetDay(tz: TimeZone=Local) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetDayOfYear, "GetDayOfYear(tz: TimeZone=Local) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetHour, "GetHour(tz: TimeZone=Local) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetMillisecond, "GetMillisecond(tz: TimeZone=Local) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetMinute, "GetMinute(tz: TimeZone=Local) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetMonth, "GetMonth(tz: TimeZone=Local) -> DateTime.Month\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetSecond, "GetSecond(tz: TimeZone=Local) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetTm, "GetTm(tz: TimeZone=Local) -> DateTime.Tm\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetWeekDay, "GetWeekDay(tz: TimeZone=Local) -> DateTime.WeekDay\n"
"GetWeekDay(weekday : DateTime.WeekDay, n: int=1, month: DateTime.Month=Inv_Month, year: int=Inv_Year) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetWeekBasedYear, "GetWeekBasedYear(tz : TimeZone) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetWeekOfMonth, "GetWeekOfMonth(flags: WeekFlags=Monday_First, tz: TimeZone=Local) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetWeekOfYear, "GetWeekOfYear(flags: WeekFlags=Monday_First, tz: TimeZone=Local) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetYear, "GetYear(tz: TimeZone=Local) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_IsWorkDay, "IsWorkDay(country: Country=Country_Default) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_IsEarlierThan, "IsEarlierThan(datetime : DateTime) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_IsEqualTo, "IsEqualTo(datetime : DateTime) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_IsEqualUpTo, "IsEqualUpTo(dt : DateTime, ts : TimeSpan) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_IsLaterThan, "IsLaterThan(datetime : DateTime) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_IsSameDate, "IsSameDate(dt : DateTime) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_IsSameTime, "IsSameTime(dt : DateTime) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_IsStrictlyBetween, "IsStrictlyBetween(t1 : DateTime, t2 : DateTime) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_IsBetween, "IsBetween(t1 : DateTime, t2 : DateTime) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_Add, "Add(diff : DateSpan) -> DateTime\n"
"Add(diff : TimeSpan) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_Subtract, "Subtract(diff : TimeSpan) -> DateTime\n"
"Subtract(diff : DateSpan) -> DateTime\n"
"Subtract(dt : DateTime) -> TimeSpan\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_DiffAsDateSpan, "DiffAsDateSpan(dt : DateTime) -> DateSpan\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_Format, "Format(format: str=DefaultDateTimeFormat, tz: TimeZone=Local) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_FormatISOCombined, "FormatISOCombined(sep: str='T') -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_ParseDate, "ParseDate(date : str) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_ParseDateTime, "ParseDateTime(datetime : str) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_ParseFormat, "ParseFormat(date : str, format : str, dateDef : DateTime) -> int\n"
"ParseFormat(date : str, format : str) -> int\n"
"ParseFormat(date : str) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_ParseISOCombined, "ParseISOCombined(date : str, sep: str='T') -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_ParseISODate, "ParseISODate(date : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_ParseISOTime, "ParseISOTime(date : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_ParseRfc822Date, "ParseRfc822Date(date : str) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_ParseTime, "ParseTime(time : str) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetLastMonthDay, "GetLastMonthDay(month: DateTime.Month=Inv_Month, year: int=Inv_Year) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetLastWeekDay, "GetLastWeekDay(weekday : DateTime.WeekDay, month: DateTime.Month=Inv_Month, year: int=Inv_Year) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetNextWeekDay, "GetNextWeekDay(weekday : DateTime.WeekDay) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetPrevWeekDay, "GetPrevWeekDay(weekday : DateTime.WeekDay) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetWeekDayInSameWeek, "GetWeekDayInSameWeek(weekday : DateTime.WeekDay, flags: WeekFlags=Monday_First) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetYearDay, "GetYearDay(yday : int) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetToLastMonthDay, "SetToLastMonthDay(month: DateTime.Month=Inv_Month, year: int=Inv_Year) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetToLastWeekDay, "SetToLastWeekDay(weekday : DateTime.WeekDay, month: DateTime.Month=Inv_Month, year: int=Inv_Year) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetToNextWeekDay, "SetToNextWeekDay(weekday : DateTime.WeekDay) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetToPrevWeekDay, "SetToPrevWeekDay(weekday : DateTime.WeekDay) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetToWeekDay, "SetToWeekDay(weekday : DateTime.WeekDay, n: int=1, month: DateTime.Month=Inv_Month, year: int=Inv_Year) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetToWeekDayInSameWeek, "SetToWeekDayInSameWeek(weekday : DateTime.WeekDay, flags: WeekFlags=Monday_First) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetToYearDay, "SetToYearDay(yday : int) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_FromTimezone, "FromTimezone(tz : TimeZone, noDST: bool=False) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_IsDST, "IsDST(country: Country=Country_Default) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_MakeFromTimezone, "MakeFromTimezone(tz : TimeZone, noDST: bool=False) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_MakeTimezone, "MakeTimezone(tz : TimeZone, noDST: bool=False) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_MakeUTC, "MakeUTC(noDST: bool=False) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_ToTimezone, "ToTimezone(tz : TimeZone, noDST: bool=False) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_ToUTC, "ToUTC(noDST: bool=False) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_ConvertYearToBC, "ConvertYearToBC(year : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetBeginDST, "GetBeginDST(year: int=Inv_Year, country: Country=Country_Default) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetEndDST, "GetEndDST(year: int=Inv_Year, country: Country=Country_Default) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetCurrentMonth, "GetCurrentMonth(cal: Calendar=Gregorian) -> DateTime.Month\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetCurrentYear, "GetCurrentYear(cal: Calendar=Gregorian) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetEnglishMonthName, "GetEnglishMonthName(month : DateTime.Month, flags: NameFlags=Name_Full) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetEnglishWeekDayName, "GetEnglishWeekDayName(weekday : DateTime.WeekDay, flags: NameFlags=Name_Full) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetMonthName, "GetMonthName(month : DateTime.Month, flags: NameFlags=Name_Full) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetNumberOfDays, "GetNumberOfDays(month : DateTime.Month, year: int=Inv_Year, cal: Calendar=Gregorian) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetWeekDayName, "GetWeekDayName(weekday : DateTime.WeekDay, flags: NameFlags=Name_Full) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_IsDSTApplicable, "IsDSTApplicable(year: int=Inv_Year, country: Country=Country_Default) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_GetFirstWeekDay, "GetFirstWeekDay(firstDay : WeekDay) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_IsLeapYear, "IsLeapYear(year: int=Inv_Year, cal: Calendar=Gregorian) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_IsWestEuropeanCountry, "IsWestEuropeanCountry(country: Country=Country_Default) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetCountry, "SetCountry(country : Country) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_SetToWeekOfYear, "SetToWeekOfYear(year : int, numWeek : int, weekday: DateTime.WeekDay=Mon) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_FromTimeT, "FromTimeT(timet: int) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_FromJDN, "FromJDN(jdn: float) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_FromHMS, "FromHMS(hour: int, minute: int=0, second: int=0, millisecond: int=0) -> DateTime\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateTime_FromDMY, "FromDMY(day: int, month: DateTime.Month, year: int=Inv_Year, hour: int=0, minute: int=0, second: int=0, millisecond: int=0) -> DateTime\n"
"\n"
...
"DateTime(day : int, month : DateTime.Month, year: int=Inv_Year, hour: int=0, minute: int=0, second: int=0, millisec: int=0) -> None\n"
"\n"
