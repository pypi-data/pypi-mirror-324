...
PyDoc_STRVAR(doc_wxNumericPropertyValidator_TryBefore, "TryBefore(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxNumericPropertyValidator_TryAfter, "TryAfter(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxNumericPropertyValidator_Validate, "Validate(parent : wx.Window) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxNumericPropertyValidator, "NumericPropertyValidator(numericType : NumericType, base: int=10) -> None\n"
"\n"
