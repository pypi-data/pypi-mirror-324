...
PyDoc_STRVAR(doc_wxDataViewColumn, "DataViewColumn(title : str, renderer : DataViewRenderer, model_column : int, width: int=DVC_DEFAULT_WIDTH, align: wx.Alignment=wx.ALIGN_CENTER, flags: int=DATAVIEW_COL_RESIZABLE) -> None\n"
