...
PyDoc_STRVAR(doc_wxComboCtrl_SetMargins, "SetMargins(pt : Point) -> bool\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_Create, "Create(parent : Window, id: int=ID_ANY, value: str='', pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, validator: Validator=DefaultValidator, name: str=ComboBoxNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_EnablePopupAnimation, "EnablePopupAnimation(enable: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_IsKeyPopupToggle, "IsKeyPopupToggle(event : KeyEvent) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_PrepareBackground, "PrepareBackground(dc : DC, rect : Rect, flags : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_HidePopup, "HidePopup(generateEvent: bool=False) -> None\n"
"\n"
"Dismisses the popup window.");
...
PyDoc_STRVAR(doc_wxComboCtrl_IsPopupWindowState, "IsPopupWindowState(state : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_Remove, "Remove(frm : int, to : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_Replace, "Replace(frm : int, to : int, text : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetButtonBitmaps, "SetButtonBitmaps(bmpNormal : BitmapBundle, pushButtonBg: bool=False, bmpPressed: BitmapBundle=BitmapBundle(), bmpHover: BitmapBundle=BitmapBundle(), bmpDisabled: BitmapBundle=BitmapBundle()) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetButtonPosition, "SetButtonPosition(width: int=-1, height: int=-1, side: int=RIGHT, spacingX: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetCustomPaintWidth, "SetCustomPaintWidth(width : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetHint, "SetHint(hint : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetInsertionPoint, "SetInsertionPoint(pos : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetMainControl, "SetMainControl(win : Window) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetPopupAnchor, "SetPopupAnchor(anchorSide : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetPopupControl, "SetPopupControl(popup : ComboPopup) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetPopupExtents, "SetPopupExtents(extLeft : int, extRight : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetPopupMaxHeight, "SetPopupMaxHeight(height : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetPopupMinWidth, "SetPopupMinWidth(width : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetSelection, "SetSelection(frm : int, to : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetText, "SetText(value : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetTextCtrlStyle, "SetTextCtrlStyle(style : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetValue, "SetValue(value : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetValueByUser, "SetValueByUser(value : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_UseAltPopupWindow, "UseAltPopupWindow(enable: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
PyDoc_STRVAR(doc_wxComboCtrl_AnimateShow, "AnimateShow(rect : Rect, flags : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_DoSetPopupControl, "DoSetPopupControl(popup : ComboPopup) -> None\n"
"\n"
"This member function is not normally called in application code.");
...
PyDoc_STRVAR(doc_wxComboCtrl_DoShowPopup, "DoShowPopup(rect : Rect, flags : int) -> None\n"
"\n"
"This member function is not normally called in application code.");
...
"ComboCtrl(parent : Window, id: int=ID_ANY, value: str='', pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, validator: Validator=DefaultValidator, name: str=ComboBoxNameStr) -> None\n"
"\n"
