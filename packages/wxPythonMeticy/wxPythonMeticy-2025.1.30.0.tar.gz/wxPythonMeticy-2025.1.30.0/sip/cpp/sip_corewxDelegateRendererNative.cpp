...
PyDoc_STRVAR(doc_wxDelegateRendererNative_DrawHeaderButton, "DrawHeaderButton(win : Window, dc : DC, rect : Rect, flags: int=0, sortArrow: HeaderSortIconType=HDR_SORT_ICON_NONE, params: Optional[HeaderButtonParams]=None) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_DrawHeaderButtonContents, "DrawHeaderButtonContents(win : Window, dc : DC, rect : Rect, flags: int=0, sortArrow: HeaderSortIconType=HDR_SORT_ICON_NONE, params: Optional[HeaderButtonParams]=None) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_GetHeaderButtonHeight, "GetHeaderButtonHeight(win : Window) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_GetHeaderButtonMargin, "GetHeaderButtonMargin(win : Window) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_DrawTreeItemButton, "DrawTreeItemButton(win : Window, dc : DC, rect : Rect, flags: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_DrawSplitterBorder, "DrawSplitterBorder(win : Window, dc : DC, rect : Rect, flags: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_DrawSplitterSash, "DrawSplitterSash(win : Window, dc : DC, size : Size, position : int, orient : Orientation, flags: int=0) -> None\n"
"\n"
"Draw a sash.");
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_DrawComboBoxDropButton, "DrawComboBoxDropButton(win : Window, dc : DC, rect : Rect, flags: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_DrawDropArrow, "DrawDropArrow(win : Window, dc : DC, rect : Rect, flags: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_DrawCheckBox, "DrawCheckBox(win : Window, dc : DC, rect : Rect, flags: int=0) -> None\n"
"\n"
"Draw a check box.");
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_DrawCheckMark, "DrawCheckMark(win : Window, dc : DC, rect : Rect, flags: int=0) -> None\n"
"\n"
"Draw a check mark.");
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_GetCheckBoxSize, "GetCheckBoxSize(win : Window, flags: int=0) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_GetCheckMarkSize, "GetCheckMarkSize(win : Window) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_GetExpanderSize, "GetExpanderSize(win : Window) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_DrawPushButton, "DrawPushButton(win : Window, dc : DC, rect : Rect, flags: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_DrawItemSelectionRect, "DrawItemSelectionRect(win : Window, dc : DC, rect : Rect, flags: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_DrawFocusRect, "DrawFocusRect(win : Window, dc : DC, rect : Rect, flags: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDelegateRendererNative_GetSplitterParams, "GetSplitterParams(win : Window) -> SplitterRenderParams\n"
"\n"
...
"DelegateRendererNative(rendererNative : RendererNative) -> None\n"
"\n"
