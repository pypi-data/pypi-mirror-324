...
PyDoc_STRVAR(doc_wxBitmapToggleButton_Create, "Create(parent : Window, id: int=ID_ANY, label: BitmapBundle=NullBitmap, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, val: Validator=DefaultValidator, name: str=CheckBoxNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapToggleButton_SetValue, "SetValue(state : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapToggleButton_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"BitmapToggleButton(parent : Window, id: int=ID_ANY, label: BitmapBundle=NullBitmap, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, val: Validator=DefaultValidator, name: str=CheckBoxNameStr) -> None\n"
"\n"
