...
PyDoc_STRVAR(doc_wxTaskBarIcon_TryBefore, "TryBefore(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTaskBarIcon_TryAfter, "TryAfter(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTaskBarIcon_PopupMenu, "PopupMenu(menu : wx.Menu) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTaskBarIcon_SetIcon, "SetIcon(icon : wx.BitmapBundle, tooltip: str='') -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTaskBarIcon_ShowBalloon, "ShowBalloon(title: str, text: str, msec: int=0, flags: int=0) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTaskBarIcon, "TaskBarIcon(iconType: TaskBarIconType=TBI_DEFAULT_TYPE) -> None\n"
"\n"
