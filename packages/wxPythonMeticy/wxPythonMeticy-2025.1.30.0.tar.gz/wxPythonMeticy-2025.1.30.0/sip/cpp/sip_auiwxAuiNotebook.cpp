...
PyDoc_STRVAR(doc_wxAuiNotebook_AddPage, "AddPage(page : wx.Window, caption : str, select: bool=False, bitmap: wx.BitmapBundle=wx.BitmapBundle()) -> bool\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_AdvanceSelection, "AdvanceSelection(forward: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_ChangeSelection, "ChangeSelection(n : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_Create, "Create(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=0) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_DeletePage, "DeletePage(page : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_GetHeightForPageHeight, "GetHeightForPageHeight(pageHeight : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_GetPage, "GetPage(page_idx : int) -> wx.Window\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_GetPageBitmap, "GetPageBitmap(page : int) -> wx.Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_GetPageIndex, "GetPageIndex(page_wnd : wx.Window) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_GetPageText, "GetPageText(page : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_GetPageToolTip, "GetPageToolTip(pageIdx : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_InsertPage, "InsertPage(page_idx : int, page : wx.Window, caption : str, select: bool=False, bitmap: wx.BitmapBundle=wx.BitmapBundle()) -> bool\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_RemovePage, "RemovePage(page : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_SetArtProvider, "SetArtProvider(art : AuiTabArt) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_SetFont, "SetFont(font : wx.Font) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_SetMeasuringFont, "SetMeasuringFont(font : wx.Font) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_SetNormalFont, "SetNormalFont(font : wx.Font) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_SetPageBitmap, "SetPageBitmap(page : int, bitmap : wx.BitmapBundle) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_SetPageImage, "SetPageImage(n : int, imageId : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_SetPageText, "SetPageText(page : int, text : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_SetPageToolTip, "SetPageToolTip(page : int, text : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_SetSelectedFont, "SetSelectedFont(font : wx.Font) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_SetSelection, "SetSelection(new_page : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_SetTabCtrlHeight, "SetTabCtrlHeight(height : int) -> None\n"
"\n"
"Sets the tab height.");
...
PyDoc_STRVAR(doc_wxAuiNotebook_SetUniformBitmapSize, "SetUniformBitmapSize(size : wx.Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_Split, "Split(page : int, direction : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_GetPageImage, "GetPageImage(nPage : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_GetTabCtrlFromPoint, "GetTabCtrlFromPoint(pt : wx.Point) -> AuiTabCtrl\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_FindTab, "FindTab(page : wx.Window, ctrl : AuiTabCtrl, idx : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiNotebook_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
