...
PyDoc_STRVAR(doc_wxPropertyGridPage_TryBefore, "TryBefore(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridPage_TryAfter, "TryAfter(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridPage_GetSplitterPosition, "GetSplitterPosition(col: int=0) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridPage_RefreshProperty, "RefreshProperty(p : PGProperty) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridPage_SetSplitterPosition, "SetSplitterPosition(splitterPos : int, col: int=0) -> None\n"
"\n"
