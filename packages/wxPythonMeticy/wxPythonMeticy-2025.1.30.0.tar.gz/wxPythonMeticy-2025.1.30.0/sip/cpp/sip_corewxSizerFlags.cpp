...
PyDoc_STRVAR(doc_wxSizerFlags_Align, "Align(alignment : int) -> SizerFlags\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerFlags_Border, "Border(direction : int, borderinpixels : int) -> SizerFlags\n"
"Border(direction: int=ALL) -> SizerFlags\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerFlags_DoubleBorder, "DoubleBorder(direction: int=ALL) -> SizerFlags\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerFlags_Proportion, "Proportion(proportion : int) -> SizerFlags\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerFlags_TripleBorder, "TripleBorder(direction: int=ALL) -> SizerFlags\n"
"\n"
...
PyDoc_STRVAR(doc_wxSizerFlags, "SizerFlags(proportion: int=0) -> None\n"
"\n"
