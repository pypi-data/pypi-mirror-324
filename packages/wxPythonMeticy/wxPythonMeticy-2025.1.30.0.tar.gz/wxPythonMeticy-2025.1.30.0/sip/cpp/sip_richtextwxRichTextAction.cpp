...
PyDoc_STRVAR(doc_wxRichTextAction_UpdateAppearance, "UpdateAppearance(caretPosition : int, sendUpdateEvent: bool=False, oldFloatRect: wx.Rect=wx.Rect(), optimizationLineCharPositions: Optional[List[int]]=None, optimizationLineYPositions: Optional[List[int]]=None, isDoCmd: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextAction_ApplyParagraphs, "ApplyParagraphs(fragment : RichTextParagraphLayoutBox) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextAction_StoreObject, "StoreObject(obj : RichTextObject) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextAction_SetObject, "SetObject(obj : RichTextObject) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextAction_MakeObject, "MakeObject(obj : RichTextObject) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextAction_SetOldAndNewObjects, "SetOldAndNewObjects(oldObj : RichTextObject, newObj : RichTextObject) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextAction_CalculateRefreshOptimizations, "CalculateRefreshOptimizations(optimizationLineCharPositions : List[int], optimizationLineYPositions : List[int], oldFloatRect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextAction_SetPosition, "SetPosition(pos : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextAction_SetRange, "SetRange(range : RichTextRange) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextAction_SetContainerAddress, "SetContainerAddress(address : RichTextObjectAddress) -> None\n"
"SetContainerAddress(container : RichTextParagraphLayoutBox, obj : RichTextObject) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextAction_SetIgnoreFirstTime, "SetIgnoreFirstTime(b : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextAction, "RichTextAction(cmd : RichTextCommand, name : str, id : RichTextCommandId, buffer : RichTextBuffer, container : RichTextParagraphLayoutBox, ctrl : RichTextCtrl, ignoreFirstTime: bool=False) -> None\n"
"\n"
