...
PyDoc_STRVAR(doc_wxXmlResourceHandler_CreateResource, "CreateResource(node : XmlNode, parent : Object, instance : Object) -> Object\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_CanHandle, "CanHandle(node : XmlNode) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_SetParentResource, "SetParentResource(res : XmlResource) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_AddStyle, "AddStyle(name : str, value : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_CreateChildren, "CreateChildren(parent : Object, this_hnd_only: bool=False) -> None\n"
"\n"
"Creates children.");
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_CreateChildrenPrivately, "CreateChildrenPrivately(parent : Object, rootnode: Optional[XmlNode]=None) -> None\n"
"\n"
"Helper function.");
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_CreateResFromNode, "CreateResFromNode(node : XmlNode, parent : Object, instance: Optional[Object]=None) -> Object\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetAnimation, "GetAnimation(param: str=\"animation\", ctrl: Optional[AnimationCtrl]=None) -> Animation\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetBitmap, "GetBitmap(param: str=\"bitmap\", defaultArtClient: ArtClient=ART_OTHER, size: Size=DefaultSize) -> Bitmap\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetBitmapBundle, "GetBitmapBundle(param: str=\"bitmap\", defaultArtClient: ArtClient=ART_OTHER, size: Size=DefaultSize) -> BitmapBundle\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetBool, "GetBool(param : str, defaultv: bool=False) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetColour, "GetColour(param : str, defaultColour: Colour=NullColour) -> Colour\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetDimension, "GetDimension(param : str, defaultv: int=0, windowToUse: Window=0) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetDirection, "GetDirection(param : str, dirDefault: Direction=LEFT) -> Direction\n"
"\n"
"Gets a direction.");
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetFont, "GetFont(param: str=\"font\") -> Font\n"
"\n"
"Gets a font.");
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetIcon, "GetIcon(param: str=\"icon\", defaultArtClient: ArtClient=ART_OTHER, size: Size=DefaultSize) -> Icon\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetIconBundle, "GetIconBundle(param : str, defaultArtClient: ArtClient=ART_OTHER) -> IconBundle\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetImageList, "GetImageList(param: str=\"imagelist\") -> ImageList\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetLong, "GetLong(param : str, defaultv: int=0) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetFloat, "GetFloat(param : str, defaultv: float=0) -> float\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_IsObjectNode, "IsObjectNode(node : XmlNode) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetNodeContent, "GetNodeContent(node : XmlNode) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetNodeParent, "GetNodeParent(node : XmlNode) -> XmlNode\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetNodeNext, "GetNodeNext(node : XmlNode) -> XmlNode\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetNodeChildren, "GetNodeChildren(node : XmlNode) -> XmlNode\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetParamNode, "GetParamNode(param : str) -> XmlNode\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetParamValue, "GetParamValue(param : str) -> str\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetPosition, "GetPosition(param: str=\"pos\") -> Point\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetSize, "GetSize(param: str=\"size\", windowToUse: Window=0) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetStyle, "GetStyle(param: str=\"style\", defaults: int=0) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_GetText, "GetText(param : str, translate: bool=True) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_HasParam, "HasParam(param : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_IsOfClass, "IsOfClass(node : XmlNode, classname : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_SetupWindow, "SetupWindow(wnd : Window) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_ReportError, "ReportError(context : XmlNode, message : str) -> None\n"
...
PyDoc_STRVAR(doc_wxXmlResourceHandler_ReportParamError, "ReportParamError(param : str, message : str) -> None\n"
"\n"
