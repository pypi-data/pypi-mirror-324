...
PyDoc_STRVAR(doc_wxDataViewBitmapRenderer, "DataViewBitmapRenderer(varianttype: str=DataViewBitmapRenderer.GetDefaultType(), mode: DataViewCellMode=DATAVIEW_CELL_INERT, align: int=DVR_DEFAULT_ALIGNMENT) -> None\n"
"\n"
