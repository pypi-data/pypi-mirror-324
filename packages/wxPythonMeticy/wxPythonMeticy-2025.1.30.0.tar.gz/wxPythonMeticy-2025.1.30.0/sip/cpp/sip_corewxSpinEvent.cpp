...
PyDoc_STRVAR(doc_wxSpinEvent_SetPosition, "SetPosition(pos : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSpinEvent, "SpinEvent(commandType: EventType=wxEVT_NULL, id: int=0) -> None\n"
"\n"
