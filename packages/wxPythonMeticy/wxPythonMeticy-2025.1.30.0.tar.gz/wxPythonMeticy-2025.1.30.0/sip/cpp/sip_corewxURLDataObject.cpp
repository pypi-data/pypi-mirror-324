...
PyDoc_STRVAR(doc_wxURLDataObject_SetURL, "SetURL(url : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxURLDataObject_SetData, "SetData(format: DataFormat, buf: PyBuffer) -> bool");
...
PyDoc_STRVAR(doc_wxURLDataObject, "URLDataObject(url: str='') -> None\n"
"\n"
