...
PyDoc_STRVAR(doc_wxGridCellEnumRenderer_SetParameters, "SetParameters(params : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellEnumRenderer, "GridCellEnumRenderer(choices: str='') -> None\n"
"\n"
