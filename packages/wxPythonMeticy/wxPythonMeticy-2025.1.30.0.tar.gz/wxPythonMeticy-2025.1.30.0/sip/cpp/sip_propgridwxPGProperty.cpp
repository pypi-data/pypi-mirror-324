...
PyDoc_STRVAR(doc_wxPGProperty_ValidateValue, "ValidateValue(value : PGVariant, validationInfo : PGValidationInfo) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_StringToValue, "StringToValue(text : str, argFlags: int=0) -> Tuple[bool, PGVariant]\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_IntToValue, "IntToValue(number : int, argFlags: int=0) -> Tuple[bool, PGVariant]\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_ValueToString, "ValueToString(value : PGVariant, argFlags: int=0) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetValueFromString, "SetValueFromString(text : str, flags: int=PG_PROGRAMMATIC_VALUE) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetValueFromInt, "SetValueFromInt(value : int, flags: int=0) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_OnMeasureImage, "OnMeasureImage(item: int=-1) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_OnEvent, "OnEvent(propgrid : PropertyGrid, wnd_primary : wx.Window, event : wx.Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_ChildChanged, "ChildChanged(thisValue : PGVariant, childIndex : int, childValue : PGVariant) -> PGVariant\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_OnCustomPaint, "OnCustomPaint(dc : wx.DC, rect : wx.Rect, paintdata : PGPaintData) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_GetCellRenderer, "GetCellRenderer(column : int) -> PGCellRenderer\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_DoSetAttribute, "DoSetAttribute(name : str, value : PGVariant) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_DoGetAttribute, "DoGetAttribute(name : str) -> PGVariant\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_OnValidationFailure, "OnValidationFailure(pendingValue : PGVariant) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_AddChoice, "AddChoice(label : str, value: int=PG_INVALID_VALUE) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_AddPrivateChild, "AddPrivateChild(prop : PGProperty) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_AdaptListToValue, "AdaptListToValue(list : PGVariant, value : PGVariant) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_AppendChild, "AppendChild(childProperty : PGProperty) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_AreAllChildrenSpecified, "AreAllChildrenSpecified(pendingList: Optional[PGVariant]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_ChangeFlag, "ChangeFlag(flag : PGPropertyFlags, set : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_DeleteChoice, "DeleteChoice(index : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_Enable, "Enable(enable: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_EnableCommonValue, "EnableCommonValue(enable: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_GetAttribute, "GetAttribute(name : str) -> PGVariant\n"
"GetAttribute(name : str, defVal : str) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_GetAttributeAsLong, "GetAttributeAsLong(name : str, defVal : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_GetAttributeAsDouble, "GetAttributeAsDouble(name : str, defVal : float) -> float\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_GetColumnEditor, "GetColumnEditor(column : int) -> PGEditor\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_GetCell, "GetCell(column : int) -> PGCell\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_GetOrCreateCell, "GetOrCreateCell(column : int) -> PGCell\n"
"\n"
"Returns wxPGCell of given column, creating one if necessary.");
...
PyDoc_STRVAR(doc_wxPGProperty_GetChildrenHeight, "GetChildrenHeight(lh : int, iMax: int=-1) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_GetFlagsAsString, "GetFlagsAsString(flagsMask : FlagType) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_GetPropertyByName, "GetPropertyByName(name : str) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_GetValueAsString, "GetValueAsString(argFlags: int=0) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_GetImageOffset, "GetImageOffset(imageWidth : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_GetItemAtY, "GetItemAtY(y : int) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_HasFlag, "HasFlag(flag : PGPropertyFlags) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_HasFlagsExact, "HasFlagsExact(flags : FlagType) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_Hide, "Hide(hide : bool, flags: int=PG_RECURSE) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_Index, "Index(p : PGProperty) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_InsertChild, "InsertChild(index : int, childProperty : PGProperty) -> PGProperty\n"
"\n"
"Use this member function to add independent (i.e.");
...
PyDoc_STRVAR(doc_wxPGProperty_InsertChoice, "InsertChoice(label : str, index : int, value: int=PG_INVALID_VALUE) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_IsSomeParent, "IsSomeParent(candidateParent : PGProperty) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_Item, "Item(i : int) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetAttribute, "SetAttribute(name : str, value : PGVariant) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetAutoUnspecified, "SetAutoUnspecified(enable: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetBackgroundColour, "SetBackgroundColour(colour : wx.Colour, flags: int=PG_RECURSE) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetEditor, "SetEditor(editor : PGEditor) -> None\n"
"SetEditor(editorName : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetCell, "SetCell(column : int, cell : PGCell) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetCommonValue, "SetCommonValue(commonValue : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetChoices, "SetChoices(choices : PGChoices) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetClientData, "SetClientData(data : ClientData) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetChoiceSelection, "SetChoiceSelection(newValue : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetDefaultValue, "SetDefaultValue(value : PGVariant) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetExpanded, "SetExpanded(expanded : bool) -> None");
...
PyDoc_STRVAR(doc_wxPGProperty_SetFlagsFromString, "SetFlagsFromString(str : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetFlagRecursively, "SetFlagRecursively(flag : PGPropertyFlags, set : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetHelpString, "SetHelpString(helpString : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetLabel, "SetLabel(label : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetMaxLength, "SetMaxLength(maxLen : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetModifiedStatus, "SetModifiedStatus(modified : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetName, "SetName(newName : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetParentalType, "SetParentalType(flag : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetTextColour, "SetTextColour(colour : wx.Colour, flags: int=PG_RECURSE) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetDefaultColours, "SetDefaultColours(flags: int=PG_RECURSE) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetValidator, "SetValidator(validator : wx.Validator) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetValue, "SetValue(value : PGVariant, pList: Optional[PGVariant]=None, flags: int=PG_SETVAL_REFRESH_EDITOR) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetValueImage, "SetValueImage(bmp : wx.BitmapBundle) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetValueInEvent, "SetValueInEvent(value : PGVariant) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGProperty_SetWasModified, "SetWasModified(set: bool=True) -> None\n"
"\n"
