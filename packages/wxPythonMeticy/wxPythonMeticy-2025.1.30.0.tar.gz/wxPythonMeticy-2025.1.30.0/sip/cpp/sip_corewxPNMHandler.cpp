...
PyDoc_STRVAR(doc_wxPNMHandler_DoGetImageCount, "DoGetImageCount(stream : InputStream) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPNMHandler_LoadFile, "LoadFile(image : Image, stream : InputStream, verbose: bool=True, index: int=-1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPNMHandler_SaveFile, "SaveFile(image : Image, stream : OutputStream, verbose: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPNMHandler_DoCanRead, "DoCanRead(stream : InputStream) -> bool\n"
"\n"
