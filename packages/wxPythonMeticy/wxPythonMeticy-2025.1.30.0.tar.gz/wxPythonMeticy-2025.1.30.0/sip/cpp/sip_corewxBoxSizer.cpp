...
PyDoc_STRVAR(doc_wxBoxSizer_AddSpacer, "AddSpacer(size : int) -> SizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxBoxSizer_SetOrientation, "SetOrientation(orient : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBoxSizer_RepositionChildren, "RepositionChildren(minSize : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBoxSizer, "BoxSizer(orient: int=HORIZONTAL) -> None\n"
"\n"
