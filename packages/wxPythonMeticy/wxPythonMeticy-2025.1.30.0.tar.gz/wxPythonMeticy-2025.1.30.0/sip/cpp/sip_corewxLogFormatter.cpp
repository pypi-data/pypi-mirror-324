...
PyDoc_STRVAR(doc_wxLogFormatter_Format, "Format(level : LogLevel, msg : str, info : LogRecordInfo) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxLogFormatter_FormatTime, "FormatTime(time : int) -> str\n"
"\n"
