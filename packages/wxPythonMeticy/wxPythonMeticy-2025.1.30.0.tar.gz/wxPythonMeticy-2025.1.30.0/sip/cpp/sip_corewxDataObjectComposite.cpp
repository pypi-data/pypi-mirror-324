...
PyDoc_STRVAR(doc_wxDataObjectComposite_Add, "Add(dataObject : DataObjectSimple, preferred: bool=False) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataObjectComposite_GetObject, "GetObject(format : DataFormat, dir: DataObject.Direction=DataObject.Get) -> DataObjectSimple\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataObjectComposite_SetData, "SetData(format: DataFormat, buf: PyBuffer) -> bool");
