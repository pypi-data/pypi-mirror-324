...
PyDoc_STRVAR(doc_wxPropertyCategory_GetTextExtent, "GetTextExtent(wnd : wx.Window, font : wx.Font) -> int");
...
PyDoc_STRVAR(doc_wxPropertyCategory_ValueToString, "ValueToString(value : PGVariant, argFlags : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyCategory_GetValueAsString, "GetValueAsString(argFlags: int=0) -> str\n"
"\n"
