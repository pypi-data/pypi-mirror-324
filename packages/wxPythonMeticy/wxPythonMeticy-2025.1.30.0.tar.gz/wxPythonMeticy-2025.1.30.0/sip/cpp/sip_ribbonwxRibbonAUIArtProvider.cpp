...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_GetColour, "GetColour(id : int) -> wx.Colour\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_SetColour, "SetColour(id : int, colour : wx.Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_SetColourScheme, "SetColourScheme(primary : wx.Colour, secondary : wx.Colour, tertiary : wx.Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_SetFont, "SetFont(id : int, font : wx.Font) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_GetScrollButtonMinimumSize, "GetScrollButtonMinimumSize(dc : wx.DC, wnd : wx.Window, style : int) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_DrawScrollButton, "DrawScrollButton(dc : wx.DC, wnd : wx.Window, rect : wx.Rect, style : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_GetPanelSize, "GetPanelSize(dc : wx.DC, wnd : RibbonPanel, client_size : wx.Size, client_offset : wx.Point) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_GetPanelClientSize, "GetPanelClientSize(dc : wx.DC, wnd : RibbonPanel, size : wx.Size, client_offset : wx.Point) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_GetPanelExtButtonArea, "GetPanelExtButtonArea(dc : wx.DC, wnd : RibbonPanel, rect : wx.Rect) -> wx.Rect\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_DrawTabCtrlBackground, "DrawTabCtrlBackground(dc : wx.DC, wnd : wx.Window, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_GetTabCtrlHeight, "GetTabCtrlHeight(dc : wx.DC, wnd : wx.Window, pages : RibbonPageTabInfoArray) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_GetBarTabWidth, "GetBarTabWidth(dc : wx.DC, wnd : wx.Window, label : str, bitmap : wx.Bitmap, ideal : int, small_begin_need_separator : int, small_must_have_separator : int, minimum : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_DrawTab, "DrawTab(dc : wx.DC, wnd : wx.Window, tab : RibbonPageTabInfo) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_DrawTabSeparator, "DrawTabSeparator(dc : wx.DC, wnd : wx.Window, rect : wx.Rect, visibility : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_DrawPageBackground, "DrawPageBackground(dc : wx.DC, wnd : wx.Window, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_DrawPanelBackground, "DrawPanelBackground(dc : wx.DC, wnd : RibbonPanel, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_DrawMinimisedPanel, "DrawMinimisedPanel(dc : wx.DC, wnd : RibbonPanel, rect : wx.Rect, bitmap : wx.Bitmap) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_DrawGalleryBackground, "DrawGalleryBackground(dc : wx.DC, wnd : RibbonGallery, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_DrawGalleryItemBackground, "DrawGalleryItemBackground(dc : wx.DC, wnd : RibbonGallery, rect : wx.Rect, item : RibbonGalleryItem) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_DrawButtonBarBackground, "DrawButtonBarBackground(dc : wx.DC, wnd : wx.Window, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_DrawButtonBarButton, "DrawButtonBarButton(dc : wx.DC, wnd : wx.Window, rect : wx.Rect, kind : RibbonButtonKind, state : int, label : str, bitmap_large : wx.Bitmap, bitmap_small : wx.Bitmap) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_DrawToolBarBackground, "DrawToolBarBackground(dc : wx.DC, wnd : wx.Window, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_DrawToolGroupBackground, "DrawToolGroupBackground(dc : wx.DC, wnd : wx.Window, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonAUIArtProvider_DrawTool, "DrawTool(dc : wx.DC, wnd : wx.Window, rect : wx.Rect, bitmap : wx.Bitmap, kind : RibbonButtonKind, state : int) -> None\n"
"\n"
