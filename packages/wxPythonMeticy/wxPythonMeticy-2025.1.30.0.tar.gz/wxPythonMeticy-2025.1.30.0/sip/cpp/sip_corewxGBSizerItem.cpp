...
PyDoc_STRVAR(doc_wxGBSizerItem_Intersects, "Intersects(other : GBSizerItem) -> bool\n"
"Intersects(pos : GBPosition, span : GBSpan) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGBSizerItem_SetPos, "SetPos(pos : GBPosition) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGBSizerItem_SetSpan, "SetSpan(span : GBSpan) -> bool\n"
"\n"
"If the item is already a member of a sizer then first ensure that\n"
...
PyDoc_STRVAR(doc_wxGBSizerItem_SetGBSizer, "SetGBSizer(sizer : GridBagSizer) -> None");
...
PyDoc_STRVAR(doc_wxGBSizerItem, "GBSizerItem(width : int, height : int, pos : GBPosition, span: GBSpan=DefaultSpan, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> None\n"
"GBSizerItem(window : Window, pos : GBPosition, span: GBSpan=DefaultSpan, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> None\n"
"GBSizerItem(sizer : Sizer, pos : GBPosition, span: GBSpan=DefaultSpan, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> None\n"
"\n"
