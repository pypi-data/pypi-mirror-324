...
PyDoc_STRVAR(doc_wxAppTraits_ShowAssertDialog, "ShowAssertDialog(msg : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAppTraits_SafeMessageBox, "SafeMessageBox(text : str, title : str) -> bool\n"
"\n"
