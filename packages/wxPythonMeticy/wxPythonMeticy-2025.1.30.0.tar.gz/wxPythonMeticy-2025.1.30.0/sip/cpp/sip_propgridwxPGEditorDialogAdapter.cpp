...
PyDoc_STRVAR(doc_wxPGEditorDialogAdapter_ShowDialog, "ShowDialog(propGrid : PropertyGrid, property : PGProperty) -> bool");
...
PyDoc_STRVAR(doc_wxPGEditorDialogAdapter_DoShowDialog, "DoShowDialog(propGrid : PropertyGrid, property : PGProperty) -> bool");
...
PyDoc_STRVAR(doc_wxPGEditorDialogAdapter_SetValue, "SetValue(value : PGVariant) -> None");
