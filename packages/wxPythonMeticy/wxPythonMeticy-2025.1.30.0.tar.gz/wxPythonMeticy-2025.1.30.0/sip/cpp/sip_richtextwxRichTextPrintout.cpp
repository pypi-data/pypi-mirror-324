...
PyDoc_STRVAR(doc_wxRichTextPrintout_CalculateScaling, "CalculateScaling(dc : wx.DC, textRect : wx.Rect, headerRect : wx.Rect, footerRect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPrintout_HasPage, "HasPage(page : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPrintout_OnPrintPage, "OnPrintPage(page : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPrintout_SetHeaderFooterData, "SetHeaderFooterData(data : RichTextHeaderFooterData) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPrintout_SetMargins, "SetMargins(top: int=254, bottom: int=254, left: int=254, right: int=254) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPrintout_SetRichTextBuffer, "SetRichTextBuffer(buffer : RichTextBuffer) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPrintout, "RichTextPrintout(title: str=\"Printout\") -> None\n"
"\n"
