...
PyDoc_STRVAR(doc_wxGraphicsPath_AddArc, "AddArc(x : float, y : float, r : float, startAngle : float, endAngle : float, clockwise : bool) -> None\n"
"AddArc(c : Point2D, r : float, startAngle : float, endAngle : float, clockwise : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsPath_AddArcToPoint, "AddArcToPoint(x1 : float, y1 : float, x2 : float, y2 : float, r : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsPath_AddCircle, "AddCircle(x : float, y : float, r : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsPath_AddCurveToPoint, "AddCurveToPoint(cx1 : float, cy1 : float, cx2 : float, cy2 : float, x : float, y : float) -> None\n"
"AddCurveToPoint(c1 : Point2D, c2 : Point2D, e : Point2D) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsPath_AddEllipse, "AddEllipse(x : float, y : float, w : float, h : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsPath_AddLineToPoint, "AddLineToPoint(x : float, y : float) -> None\n"
"AddLineToPoint(p : Point2D) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsPath_AddPath, "AddPath(path : GraphicsPath) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsPath_AddQuadCurveToPoint, "AddQuadCurveToPoint(cx : float, cy : float, x : float, y : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsPath_AddRectangle, "AddRectangle(x : float, y : float, w : float, h : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsPath_AddRoundedRectangle, "AddRoundedRectangle(x : float, y : float, w : float, h : float, radius : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsPath_Contains, "Contains(c : Point2D, fillStyle: PolygonFillMode=ODDEVEN_RULE) -> bool\n"
"Contains(x : float, y : float, fillStyle: PolygonFillMode=ODDEVEN_RULE) -> bool\n"
"");
...
PyDoc_STRVAR(doc_wxGraphicsPath_MoveToPoint, "MoveToPoint(x : float, y : float) -> None\n"
"MoveToPoint(p : Point2D) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsPath_Transform, "Transform(matrix : GraphicsMatrix) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsPath_UnGetNativePath, "UnGetNativePath(p : Any) -> None\n"
"\n"
