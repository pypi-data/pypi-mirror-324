...
PyDoc_STRVAR(doc_wxListView_OnGetItemAttr, "OnGetItemAttr(item : int) -> ItemAttr\n"
"\n"
...
PyDoc_STRVAR(doc_wxListView_OnGetItemColumnImage, "OnGetItemColumnImage(item : int, column : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxListView_OnGetItemImage, "OnGetItemImage(item : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxListView_OnGetItemText, "OnGetItemText(item : int, column : int) -> str\n"
"\n"
"This function must be overridden in the derived class for a control\n"
"with wxLC_VIRTUAL style.");
...
PyDoc_STRVAR(doc_wxListView_OnGetItemIsChecked, "OnGetItemIsChecked(item : int) -> bool\n"
"\n"
"This function must be overridden in the derived class for a control\n"
...
PyDoc_STRVAR(doc_wxListView_ClearColumnImage, "ClearColumnImage(col : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxListView_Focus, "Focus(index : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxListView_GetNextSelected, "GetNextSelected(item : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxListView_IsSelected, "IsSelected(index : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxListView_Select, "Select(n : int, on: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxListView_SetColumnImage, "SetColumnImage(col : int, image : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxListView_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"ListView(parent : Window, winid: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=LC_REPORT, validator: Validator=DefaultValidator, name: str=ListCtrlNameStr) -> None\n"
"\n"
