...
PyDoc_STRVAR(doc_wxThreadEvent_SetExtraLong, "SetExtraLong(extraLong : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxThreadEvent_SetInt, "SetInt(intCommand : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxThreadEvent_SetString, "SetString(string : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxThreadEvent, "ThreadEvent(eventType: EventType=wxEVT_THREAD, id: int=ID_ANY) -> None\n"
"\n"
