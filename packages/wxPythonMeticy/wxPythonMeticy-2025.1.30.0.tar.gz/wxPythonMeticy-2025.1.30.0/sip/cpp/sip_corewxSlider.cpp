...
PyDoc_STRVAR(doc_wxSlider_Create, "Create(parent : Window, id: int=ID_ANY, value: int=0, minValue: int=0, maxValue: int=100, point: Point=DefaultPosition, size: Size=DefaultSize, style: int=SL_HORIZONTAL, validator: Validator=DefaultValidator, name: str=SliderNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSlider_SetLineSize, "SetLineSize(lineSize : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSlider_SetMin, "SetMin(minValue : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSlider_SetMax, "SetMax(maxValue : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSlider_SetPageSize, "SetPageSize(pageSize : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSlider_SetRange, "SetRange(minValue : int, maxValue : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSlider_SetSelection, "SetSelection(startPos : int, endPos : int) -> None\n"
"\n"
"Sets the selection.");
...
PyDoc_STRVAR(doc_wxSlider_SetThumbLength, "SetThumbLength(len : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSlider_SetTick, "SetTick(tickPos : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSlider_SetTickFreq, "SetTickFreq(freq : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSlider_SetValue, "SetValue(value : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSlider_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"Slider(parent : Window, id: int=ID_ANY, value: int=0, minValue: int=0, maxValue: int=100, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=SL_HORIZONTAL, validator: Validator=DefaultValidator, name: str=SliderNameStr) -> None\n"
"\n"
