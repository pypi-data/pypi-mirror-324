...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateBitmap, "CreateBitmap(bitmap : Bitmap) -> GraphicsBitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateBitmapFromImage, "CreateBitmapFromImage(image : Image) -> GraphicsBitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateImageFromBitmap, "CreateImageFromBitmap(bmp : GraphicsBitmap) -> Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateBitmapFromNativeBitmap, "CreateBitmapFromNativeBitmap(bitmap : Any) -> GraphicsBitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateContext, "CreateContext(window : Window) -> GraphicsContext\n"
"CreateContext(windowDC : WindowDC) -> GraphicsContext\n"
"CreateContext(memoryDC : MemoryDC) -> GraphicsContext\n"
"CreateContext(printerDC : PrinterDC) -> GraphicsContext\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateContextFromUnknownDC, "CreateContextFromUnknownDC(dc : DC) -> GraphicsContext\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateContextFromImage, "CreateContextFromImage(image : Image) -> GraphicsContext\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateBrush, "CreateBrush(brush : Brush) -> GraphicsBrush\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateContextFromNativeContext, "CreateContextFromNativeContext(context : Any) -> GraphicsContext\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateContextFromNativeWindow, "CreateContextFromNativeWindow(window : Any) -> GraphicsContext\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateFont, "CreateFont(font : Font, col: Colour=BLACK) -> GraphicsFont\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateFontAtDPI, "CreateFontAtDPI(font : Font, dpi : RealPoint, col: Colour=BLACK) -> GraphicsFont\n"
"\n"
"Creates a native graphics font from a wxFont and a text colour.");
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateLinearGradientBrush, "CreateLinearGradientBrush(x1 : float, y1 : float, x2 : float, y2 : float, stops : GraphicsGradientStops, matrix: GraphicsMatrix=NullGraphicsMatrix) -> GraphicsBrush\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateMatrix, "CreateMatrix(a: float=1.0, b: float=0.0, c: float=0.0, d: float=1.0, tx: float=0.0, ty: float=0.0) -> GraphicsMatrix\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreatePen, "CreatePen(info : GraphicsPenInfo) -> GraphicsPen\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateRadialGradientBrush, "CreateRadialGradientBrush(startX : float, startY : float, endX : float, endY : float, radius : float, stops : GraphicsGradientStops, matrix: GraphicsMatrix=NullGraphicsMatrix) -> GraphicsBrush\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_CreateSubBitmap, "CreateSubBitmap(bitmap : GraphicsBitmap, x : float, y : float, w : float, h : float) -> GraphicsBitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsRenderer_GetVersion, "GetVersion(major : int, minor: Optional[int]=None, micro: Optional[int]=None) -> None\n"
"\n"
