...
PyDoc_STRVAR(doc_wxIconBundle_AddIcon, "AddIcon(file : str, type: BitmapType=BITMAP_TYPE_ANY) -> None\n"
"AddIcon(stream : InputStream, type: BitmapType=BITMAP_TYPE_ANY) -> None\n"
"AddIcon(icon : Icon) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxIconBundle_GetIcon, "GetIcon(size : Size, flags: int=FALLBACK_SYSTEM) -> Icon\n"
"GetIcon(size: int=DefaultCoord, flags: int=FALLBACK_SYSTEM) -> Icon\n"
"\n"
...
PyDoc_STRVAR(doc_wxIconBundle_GetIconOfExactSize, "GetIconOfExactSize(size : Size) -> Icon\n"
"\n"
...
PyDoc_STRVAR(doc_wxIconBundle_GetIconByIndex, "GetIconByIndex(n : int) -> Icon\n"
"\n"
...
"IconBundle(stream : InputStream, type: BitmapType=BITMAP_TYPE_ANY) -> None\n"
