...
PyDoc_STRVAR(doc_wxDateProperty_ValueToString, "ValueToString(value : PGVariant, argFlags: int=0) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateProperty_StringToValue, "StringToValue(text : str, argFlags: int=0) -> Tuple[bool, PGVariant]\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateProperty_DoSetAttribute, "DoSetAttribute(name : str, value : PGVariant) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDateProperty_SetFormat, "SetFormat(format : str) -> None");
...
PyDoc_STRVAR(doc_wxDateProperty_SetDateValue, "SetDateValue(dt : wx.DateTime) -> None");
...
PyDoc_STRVAR(doc_wxDateProperty, "DateProperty(label: str=PG_LABEL, name: str=PG_LABEL, value: wx.DateTime=wx.DateTime()) -> None\n"
"\n"
