...
PyDoc_STRVAR(doc_wxGridBagSizer_Add, "Add(window : Window, pos : GBPosition, span: GBSpan=DefaultSpan, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> SizerItem\n"
"Add(sizer : Sizer, pos : GBPosition, span: GBSpan=DefaultSpan, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> SizerItem\n"
"Add(item : GBSizerItem) -> SizerItem\n"
"Add(width : int, height : int, pos : GBPosition, span: GBSpan=DefaultSpan, flag: int=0, border: int=0, userData: Optional[PyUserData]=None) -> SizerItem\n"
"Add(size: Size, pos: GBPosition, span: GBSpan=DefaultSpan, flag: int=0, border: int=0, Transfer: Optional[ObjectuserData]=None) -> SizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBagSizer_CheckForIntersection, "CheckForIntersection(item : GBSizerItem, excludeItem: Optional[GBSizerItem]=None) -> bool\n"
"CheckForIntersection(pos : GBPosition, span : GBSpan, excludeItem: Optional[GBSizerItem]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBagSizer_FindItem, "FindItem(window : Window) -> GBSizerItem\n"
...
PyDoc_STRVAR(doc_wxGridBagSizer_GetItemPosition, "GetItemPosition(window : Window) -> GBPosition\n"
"GetItemPosition(sizer : Sizer) -> GBPosition\n"
"GetItemPosition(index : int) -> GBPosition\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBagSizer_GetItemSpan, "GetItemSpan(window : Window) -> GBSpan\n"
"GetItemSpan(sizer : Sizer) -> GBSpan\n"
"GetItemSpan(index : int) -> GBSpan\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBagSizer_SetItemPosition, "SetItemPosition(window : Window, pos : GBPosition) -> bool\n"
"SetItemPosition(sizer : Sizer, pos : GBPosition) -> bool\n"
"SetItemPosition(index : int, pos : GBPosition) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBagSizer_SetItemSpan, "SetItemSpan(window : Window, span : GBSpan) -> bool\n"
"SetItemSpan(sizer : Sizer, span : GBSpan) -> bool\n"
"SetItemSpan(index : int, span : GBSpan) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBagSizer_FindItemAtPoint, "FindItemAtPoint(pt : Point) -> GBSizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBagSizer_FindItemAtPosition, "FindItemAtPosition(pos : GBPosition) -> GBSizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBagSizer_FindItemWithData, "FindItemWithData(userData : Object) -> GBSizerItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBagSizer_GetCellSize, "GetCellSize(row : int, col : int) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBagSizer_RepositionChildren, "RepositionChildren(minSize : Size) -> None\n"
"\n"
"Called when the managed size of the sizer is needed or when layout\n"
"needs done.");
...
PyDoc_STRVAR(doc_wxGridBagSizer_SetEmptyCellSize, "SetEmptyCellSize(sz : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBagSizer, "GridBagSizer(vgap: int=0, hgap: int=0) -> None\n"
"\n"
