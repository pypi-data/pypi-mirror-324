...
PyDoc_STRVAR(doc_wxHtmlHelpData_AddBook, "AddBook(book_url : str) -> bool\n"
"\n"
"Adds new book.");
...
PyDoc_STRVAR(doc_wxHtmlHelpData_FindPageById, "FindPageById(id : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlHelpData_FindPageByName, "FindPageByName(page : str) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlHelpData_SetTempDir, "SetTempDir(path : str) -> None\n"
"\n"
