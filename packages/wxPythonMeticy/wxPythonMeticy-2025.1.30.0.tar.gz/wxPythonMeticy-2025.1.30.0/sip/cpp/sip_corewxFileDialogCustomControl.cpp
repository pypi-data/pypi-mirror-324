...
PyDoc_STRVAR(doc_wxFileDialogCustomControl_Show, "Show(show: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileDialogCustomControl_Enable, "Enable(enable: bool=True) -> None\n"
"\n"
