...
PyDoc_STRVAR(doc_wxWizard_Create, "Create(parent : wx.Window, id: int=wx.ID_ANY, title: str='', bitmap: wx.BitmapBundle=wx.BitmapBundle(), pos: wx.Point=wx.DefaultPosition, style: int=wx.DEFAULT_DIALOG_STYLE) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWizard_FitToPage, "FitToPage(firstPage : WizardPage) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWizard_HasNextPage, "HasNextPage(page : WizardPage) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWizard_HasPrevPage, "HasPrevPage(page : WizardPage) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWizard_RunWizard, "RunWizard(firstPage : WizardPage) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWizard_SetBitmap, "SetBitmap(bitmap : wx.BitmapBundle) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWizard_SetBitmapBackgroundColour, "SetBitmapBackgroundColour(colour : wx.Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWizard_SetBitmapPlacement, "SetBitmapPlacement(placement : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWizard_SetBorder, "SetBorder(border : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWizard_SetMinimumBitmapWidth, "SetMinimumBitmapWidth(width : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWizard_SetPageSize, "SetPageSize(sizePage : wx.Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWizard_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
...
PyDoc_STRVAR(doc_wxWizard_ShowPage, "ShowPage(page : WizardPage, goingForward: bool=True) -> bool\n"
"\n"
