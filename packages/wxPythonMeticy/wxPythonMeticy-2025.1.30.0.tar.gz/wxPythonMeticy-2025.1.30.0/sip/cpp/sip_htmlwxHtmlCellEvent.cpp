...
PyDoc_STRVAR(doc_wxHtmlCellEvent_SetLinkClicked, "SetLinkClicked(linkclicked : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlCellEvent, "HtmlCellEvent(commandType : EventType, id : int, cell : HtmlCell, point : wx.Point, ev : wx.MouseEvent) -> None\n"
"\n"
