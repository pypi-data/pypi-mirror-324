...
PyDoc_STRVAR(doc_wxGraphicsMatrix_Concat, "Concat(t : GraphicsMatrix) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsMatrix_IsEqual, "IsEqual(t : GraphicsMatrix) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsMatrix_Rotate, "Rotate(angle : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsMatrix_Scale, "Scale(xScale : float, yScale : float) -> None\n"
"\n"
"Scales this matrix.");
...
PyDoc_STRVAR(doc_wxGraphicsMatrix_Set, "Set(a: float=1.0, b: float=0.0, c: float=0.0, d: float=1.0, tx: float=0.0, ty: float=0.0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsMatrix_TransformDistance, "TransformDistance(dx : float, dy : float) -> Tuple[float, float]\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsMatrix_TransformPoint, "TransformPoint(x : float, y : float) -> Tuple[float, float]\n"
"\n"
...
PyDoc_STRVAR(doc_wxGraphicsMatrix_Translate, "Translate(dx : float, dy : float) -> None\n"
"\n"
