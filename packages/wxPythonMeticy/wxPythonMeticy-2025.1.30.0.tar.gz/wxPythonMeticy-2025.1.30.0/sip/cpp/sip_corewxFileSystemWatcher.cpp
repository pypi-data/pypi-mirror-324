...
PyDoc_STRVAR(doc_wxFileSystemWatcher_TryBefore, "TryBefore(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystemWatcher_TryAfter, "TryAfter(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystemWatcher_Add, "Add(path : str, events: int=FSW_EVENT_ALL) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystemWatcher_AddTree, "AddTree(path : str, events: int=FSW_EVENT_ALL, filter: str='') -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystemWatcher_Remove, "Remove(path : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystemWatcher_RemoveTree, "RemoveTree(path : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystemWatcher_GetWatchedPaths, "GetWatchedPaths(paths : List[str]) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileSystemWatcher_SetOwner, "SetOwner(handler : EvtHandler) -> None\n"
"\n"
