...
PyDoc_STRVAR(doc_wxFileHistory_AddFileToHistory, "AddFileToHistory(filename : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileHistory_GetHistoryFile, "GetHistoryFile(index : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileHistory_Load, "Load(config : ConfigBase) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileHistory_RemoveFileFromHistory, "RemoveFileFromHistory(i : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileHistory_RemoveMenu, "RemoveMenu(menu : Menu) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileHistory_Save, "Save(config : ConfigBase) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileHistory_SetBaseId, "SetBaseId(baseId : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileHistory_UseMenu, "UseMenu(menu : Menu) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileHistory_SetMenuPathStyle, "SetMenuPathStyle(style : FileHistoryMenuPathStyle) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileHistory, "FileHistory(maxFiles: int=9, idBase: int=ID_FILE1) -> None\n"
"\n"
