...
PyDoc_STRVAR(doc_wxGridCellChoiceEditor_SetParameters, "SetParameters(params : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellChoiceEditor, "GridCellChoiceEditor(choices : List[str], allowOthers: bool=False) -> None\n"
"\n"
