...
PyDoc_STRVAR(doc_wxRichTextImageBlock_MakeImageBlock, "MakeImageBlock(filename : str, imageType : wx.BitmapType, image : wx.Image, convertToJPEG: bool=True) -> bool\n"
"MakeImageBlock(image : wx.Image, imageType : wx.BitmapType, quality: int=80) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImageBlock_MakeImageBlockDefaultQuality, "MakeImageBlockDefaultQuality(image : wx.Image, imageType : wx.BitmapType) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImageBlock_DoMakeImageBlock, "DoMakeImageBlock(image : wx.Image, imageType : wx.BitmapType) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImageBlock_Write, "Write(filename : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImageBlock_WriteHex, "WriteHex(stream : wx.OutputStream) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImageBlock_ReadHex, "ReadHex(stream : wx.InputStream, length : int, imageType : wx.BitmapType) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImageBlock_Copy, "Copy(block : RichTextImageBlock) -> None\n"
"\n"
"Copy from block.");
...
PyDoc_STRVAR(doc_wxRichTextImageBlock_Load, "Load(image : wx.Image) -> bool");
...
PyDoc_STRVAR(doc_wxRichTextImageBlock_SetData, "SetData(image : int) -> None");
...
PyDoc_STRVAR(doc_wxRichTextImageBlock_SetDataSize, "SetDataSize(size : int) -> None\n"
"\n"
"Sets the data size.");
...
PyDoc_STRVAR(doc_wxRichTextImageBlock_SetImageType, "SetImageType(imageType : wx.BitmapType) -> None\n"
"\n"
"Sets the image type.");
...
PyDoc_STRVAR(doc_wxRichTextImageBlock_ReadBlock, "ReadBlock(stream : wx.InputStream, size : int) -> int\n"
"ReadBlock(filename : str, size : int) -> int\n"
"\n"
"Implementation.\n"
"");
...
PyDoc_STRVAR(doc_wxRichTextImageBlock_WriteBlock, "WriteBlock(stream : wx.OutputStream, block : int, size : int) -> bool\n"
"WriteBlock(filename : str, block : int, size : int) -> bool\n"
"\n"
