...
PyDoc_STRVAR(doc_wxBitmapBundle_GetPreferredBitmapSizeAtScale, "GetPreferredBitmapSizeAtScale(scale : float) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_GetPreferredBitmapSizeFor, "GetPreferredBitmapSizeFor(window : Window) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_GetPreferredLogicalSizeFor, "GetPreferredLogicalSizeFor(window : Window) -> Size\n"
"\n"
"Get the size that would be best to use for this bundle at the DPI\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_GetBitmap, "GetBitmap(size : Size) -> Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_GetBitmapFor, "GetBitmapFor(window : Window) -> Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_GetIcon, "GetIcon(size : Size) -> Icon\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_GetIconFor, "GetIconFor(window : Window) -> Icon\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_IsSameAs, "IsSameAs(other : BitmapBundle) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_FromBitmaps, "FromBitmaps(bitmaps : VectorwxBitmap) -> BitmapBundle\n"
"FromBitmaps(bitmap1 : Bitmap, bitmap2 : Bitmap) -> BitmapBundle\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_FromBitmap, "FromBitmap(bitmap : Bitmap) -> BitmapBundle\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_FromIconBundle, "FromIconBundle(iconBundle : IconBundle) -> BitmapBundle\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_FromImage, "FromImage(image : Image) -> BitmapBundle\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_FromImpl, "FromImpl(impl : BitmapBundleImpl) -> BitmapBundle\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_FromResources, "FromResources(name : str) -> BitmapBundle\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_FromFiles, "FromFiles(path : str, filename : str, extension: str=\"png\") -> BitmapBundle\n"
"FromFiles(fullpathname : str) -> BitmapBundle\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_FromSVG, "FromSVG(data : str, sizeDef : Size) -> BitmapBundle\n"
"FromSVG(data : Byte, len : int, sizeDef : Size) -> BitmapBundle\n"
"");
...
PyDoc_STRVAR(doc_wxBitmapBundle_FromSVGFile, "FromSVGFile(path : str, sizeDef : Size) -> BitmapBundle\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundle_FromSVGResource, "FromSVGResource(name : str, sizeDef : Size) -> BitmapBundle\n"
"\n"
...
"BitmapBundle(bitmap : Bitmap) -> None\n"
"BitmapBundle(icon : Icon) -> None\n"
"BitmapBundle(image : Image) -> None\n"
"BitmapBundle(other : BitmapBundle) -> None\n"
"\n"
