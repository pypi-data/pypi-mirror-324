...
PyDoc_STRVAR(doc_wxUIActionSimulator_MouseMove, "MouseMove(x : int, y : int) -> bool\n"
"MouseMove(point : Point) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxUIActionSimulator_MouseDown, "MouseDown(button: int=MOUSE_BTN_LEFT) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxUIActionSimulator_MouseUp, "MouseUp(button: int=MOUSE_BTN_LEFT) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxUIActionSimulator_MouseClick, "MouseClick(button: int=MOUSE_BTN_LEFT) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxUIActionSimulator_MouseDblClick, "MouseDblClick(button: int=MOUSE_BTN_LEFT) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxUIActionSimulator_MouseDragDrop, "MouseDragDrop(x1 : int, y1 : int, x2 : int, y2 : int, button: int=MOUSE_BTN_LEFT) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxUIActionSimulator_KeyDown, "KeyDown(keycode : int, modifiers: int=MOD_NONE) -> bool\n"
"\n"
"Press a key.");
...
PyDoc_STRVAR(doc_wxUIActionSimulator_KeyUp, "KeyUp(keycode : int, modifiers: int=MOD_NONE) -> bool\n"
"\n"
"Release a key.");
...
PyDoc_STRVAR(doc_wxUIActionSimulator_Char, "Char(keycode : int, modifiers: int=MOD_NONE) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxUIActionSimulator_Select, "Select(text : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxUIActionSimulator_Text, "Text(text : str) -> bool\n"
"\n"
