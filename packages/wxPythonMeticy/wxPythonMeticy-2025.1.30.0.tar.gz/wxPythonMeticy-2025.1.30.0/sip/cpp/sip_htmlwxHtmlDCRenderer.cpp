...
PyDoc_STRVAR(doc_wxHtmlDCRenderer_FindNextPageBreak, "FindNextPageBreak(pos : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlDCRenderer_Render, "Render(x : int, y : int, from_: int=0, to_: int=INT_MAX) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlDCRenderer_SetDC, "SetDC(dc : wx.DC, pixel_scale: float=1.0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlDCRenderer_SetFonts, "SetFonts(normal_face : str, fixed_face : str, sizes : List[int]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlDCRenderer_SetStandardFonts, "SetStandardFonts(size: int=-1, normal_face: str='', fixed_face: str='') -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlDCRenderer_SetHtmlText, "SetHtmlText(html : str, basepath: str='', isdir: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlDCRenderer_SetHtmlCell, "SetHtmlCell(cell : HtmlContainerCell) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlDCRenderer_SetSize, "SetSize(width : int, height : int) -> None\n"
"\n"
