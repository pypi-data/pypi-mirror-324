...
PyDoc_STRVAR(doc_wxPGDefaultRenderer_Render, "Render(dc : wx.DC, rect : wx.Rect, propertyGrid : PropertyGrid, property : PGProperty, column : int, item : int, flags : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGDefaultRenderer_GetImageSize, "GetImageSize(property : PGProperty, column : int, item : int) -> wx.Size\n"
"\n"
