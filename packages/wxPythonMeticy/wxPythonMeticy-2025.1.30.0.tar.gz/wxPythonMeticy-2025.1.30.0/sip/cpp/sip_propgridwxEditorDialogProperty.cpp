...
PyDoc_STRVAR(doc_wxEditorDialogProperty_DoSetAttribute, "DoSetAttribute(name : str, value : PGVariant) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxEditorDialogProperty_DisplayEditorDialog, "DisplayEditorDialog(pg : PropertyGrid, value : PGVariant) -> bool\n"
"\n"
"Shows editor dialog.");
...
PyDoc_STRVAR(doc_wxEditorDialogProperty, "EditorDialogProperty(label : str, name : str) -> None\n"
"\n"
