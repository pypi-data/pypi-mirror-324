...
PyDoc_STRVAR(doc_wxPlatformInfo_GetArch, "GetArch(arch : str) -> Architecture");
...
PyDoc_STRVAR(doc_wxPlatformInfo_GetBitnessName, "GetBitnessName(bitness : Bitness) -> str\n"
"GetBitnessName() -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxPlatformInfo_SetArchitecture, "SetArchitecture(n : Architecture) -> None");
...
PyDoc_STRVAR(doc_wxPlatformInfo_SetBitness, "SetBitness(n : Bitness) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPlatformInfo_SetEndianness, "SetEndianness(n : Endianness) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPlatformInfo_SetOSVersion, "SetOSVersion(major : int, minor : int, micro: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPlatformInfo_SetOperatingSystemId, "SetOperatingSystemId(n : OperatingSystemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPlatformInfo_SetPortId, "SetPortId(n : PortId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPlatformInfo_SetToolkitVersion, "SetToolkitVersion(major : int, minor : int, micro: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPlatformInfo_SetOperatingSystemDescription, "SetOperatingSystemDescription(desc : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPlatformInfo_SetDesktopEnvironment, "SetDesktopEnvironment(de : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPlatformInfo_SetLinuxDistributionInfo, "SetLinuxDistributionInfo(di : LinuxDistributionInfo) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPlatformInfo_CheckOSVersion, "CheckOSVersion(major : int, minor : int, micro: int=0) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPlatformInfo_CheckToolkitVersion, "CheckToolkitVersion(major : int, minor : int, micro: int=0) -> bool\n"
"\n"
...
"PlatformInfo(pid : PortId, tkMajor: int=-1, tkMinor: int=-1, id: OperatingSystemId=OS_UNKNOWN, osMajor: int=-1, osMinor: int=-1, bitness: Bitness=BITNESS_INVALID, endian: Endianness=ENDIAN_INVALID) -> None\n"
"\n"
