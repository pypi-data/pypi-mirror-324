...
PyDoc_STRVAR(doc_wxHScrolledWindow_OnGetColumnsWidthHint, "OnGetColumnsWidthHint(columnMin : int, columnMax : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHScrolledWindow_OnGetColumnWidth, "OnGetColumnWidth(column : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxHScrolledWindow_Create, "Create(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=PanelNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxHScrolledWindow_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"HScrolledWindow(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=PanelNameStr) -> None\n"
"\n"
