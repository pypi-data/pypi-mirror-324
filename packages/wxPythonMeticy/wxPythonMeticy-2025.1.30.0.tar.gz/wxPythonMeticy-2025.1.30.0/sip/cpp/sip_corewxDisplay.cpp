...
PyDoc_STRVAR(doc_wxDisplay_ChangeMode, "ChangeMode(mode: VideoMode=DefaultVideoMode) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDisplay_GetModes, "GetModes(mode: VideoMode=DefaultVideoMode) -> List[VideoModes]\n"
"\n"
...
PyDoc_STRVAR(doc_wxDisplay_GetFromPoint, "GetFromPoint(pt : Point) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDisplay_GetFromWindow, "GetFromWindow(win : Window) -> int\n"
"\n"
...
"Display(index : int) -> None\n"
"Display(window : Window) -> None\n"
"\n"
