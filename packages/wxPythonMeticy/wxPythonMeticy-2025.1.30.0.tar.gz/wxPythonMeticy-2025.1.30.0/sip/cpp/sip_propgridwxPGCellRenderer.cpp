...
PyDoc_STRVAR(doc_wxPGCellRenderer_Render, "Render(dc : wx.DC, rect : wx.Rect, propertyGrid : PropertyGrid, property : PGProperty, column : int, item : int, flags : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGCellRenderer_GetImageSize, "GetImageSize(property : PGProperty, column : int, item : int) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGCellRenderer_DrawCaptionSelectionRect, "DrawCaptionSelectionRect(dc : wx.DC, x : int, y : int, w : int, h : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGCellRenderer_DrawText, "DrawText(dc : wx.DC, rect : wx.Rect, imageWidth : int, text : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGCellRenderer_DrawEditorValue, "DrawEditorValue(dc : wx.DC, rect : wx.Rect, xOffset : int, text : str, property : PGProperty, editor : PGEditor) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGCellRenderer_PreDrawCell, "PreDrawCell(dc : wx.DC, rect : wx.Rect, propGrid : PropertyGrid, cell : PGCell, flags : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGCellRenderer_PostDrawCell, "PostDrawCell(dc : wx.DC, propGrid : PropertyGrid, cell : PGCell, flags : int) -> None\n"
"\n"
