...
PyDoc_STRVAR(doc_wxDropSource_DoDragDrop, "DoDragDrop(flags: int=Drag_CopyOnly) -> DragResult\n"
"\n"
...
PyDoc_STRVAR(doc_wxDropSource_GiveFeedback, "GiveFeedback(effect : DragResult) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDropSource_SetCursor, "SetCursor(res : DragResult, cursor : Cursor) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDropSource_SetIcon, "SetIcon(res : DragResult, icon : Icon) -> None\n"
"\n"
"Set the icon to use for a certain drag result.");
...
PyDoc_STRVAR(doc_wxDropSource_SetData, "SetData(data : DataObject) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDropSource, "DropSource(win: Optional[Window]=None) -> None\n"
"DropSource(data : DataObject, win: Optional[Window]=None) -> None\n"
"\n"
