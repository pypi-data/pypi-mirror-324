...
PyDoc_STRVAR(doc_wxMemoryDC_SelectObject, "SelectObject(bitmap : Bitmap) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxMemoryDC_SelectObjectAsSource, "SelectObjectAsSource(bitmap : Bitmap) -> None\n"
"\n"
