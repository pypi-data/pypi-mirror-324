...
PyDoc_STRVAR(doc_wxJoystickEvent_ButtonDown, "ButtonDown(button: int=JOY_BUTTON_ANY) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxJoystickEvent_ButtonIsDown, "ButtonIsDown(button: int=JOY_BUTTON_ANY) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxJoystickEvent_ButtonUp, "ButtonUp(button: int=JOY_BUTTON_ANY) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxJoystickEvent, "JoystickEvent(eventType: EventType=wxEVT_NULL, state: int=0, joystick: int=JOYSTICK1, change: int=0) -> None\n"
"\n"
