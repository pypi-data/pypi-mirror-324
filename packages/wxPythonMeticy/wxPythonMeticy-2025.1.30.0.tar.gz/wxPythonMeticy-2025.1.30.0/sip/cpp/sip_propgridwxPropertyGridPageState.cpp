...
PyDoc_STRVAR(doc_wxPropertyGridPageState_CheckColumnWidths, "CheckColumnWidths(widthChange: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridPageState_DoDelete, "DoDelete(item : PGProperty, doDelete: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridPageState_DoInsert, "DoInsert(parent : PGProperty, index : int, property : PGProperty) -> PGProperty\n"
"\n"
"Override this member function to add custom behaviour on property\n"
"insertion.");
...
PyDoc_STRVAR(doc_wxPropertyGridPageState_DoSetSplitterPosition, "DoSetSplitterPosition(pos : int, splitterColumn: int=0, flags: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridPageState_EnableCategories, "EnableCategories(enable : bool) -> bool");
...
PyDoc_STRVAR(doc_wxPropertyGridPageState_GetColumnMinWidth, "GetColumnMinWidth(column : int) -> int");
...
PyDoc_STRVAR(doc_wxPropertyGridPageState_GetColumnWidth, "GetColumnWidth(column : int) -> int");
...
PyDoc_STRVAR(doc_wxPropertyGridPageState_GetLastItem, "GetLastItem(flags: int=PG_ITERATE_DEFAULT) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridPageState_GetPropertyCategory, "GetPropertyCategory(p : PGProperty) -> PropertyCategory");
...
PyDoc_STRVAR(doc_wxPropertyGridPageState_GetColumnFullWidth, "GetColumnFullWidth(p : PGProperty, col : int) -> int");
...
PyDoc_STRVAR(doc_wxPropertyGridPageState_HitTest, "HitTest(pt : wx.Point) -> PropertyGridHitTestResult\n"
"\n"
