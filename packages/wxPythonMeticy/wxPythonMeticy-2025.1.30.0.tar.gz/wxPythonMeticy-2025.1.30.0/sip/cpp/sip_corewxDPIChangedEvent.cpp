...
PyDoc_STRVAR(doc_wxDPIChangedEvent_Scale, "Scale(sz : Size) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxDPIChangedEvent_ScaleX, "ScaleX(x : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxDPIChangedEvent_ScaleY, "ScaleY(y : int) -> int\n"
"\n"
