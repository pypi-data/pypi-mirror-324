...
PyDoc_STRVAR(doc_wxSearchCtrl_Create, "Create(parent : Window, id: int=ID_ANY, value: str='', pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, validator: Validator=DefaultValidator, name: str=SearchCtrlNameStr) -> bool");
...
PyDoc_STRVAR(doc_wxSearchCtrl_SetMenu, "SetMenu(menu : Menu) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_ShowCancelButton, "ShowCancelButton(show : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_ShowSearchButton, "ShowSearchButton(show : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_SetDescriptiveText, "SetDescriptiveText(text : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_SetSearchBitmap, "SetSearchBitmap(bmp: Bitmap) -> None");
...
PyDoc_STRVAR(doc_wxSearchCtrl_SetSearchMenuBitmap, "SetSearchMenuBitmap(bmp: Bitmap) -> None");
...
PyDoc_STRVAR(doc_wxSearchCtrl_SetCancelBitmap, "SetCancelBitmap(bmp: Bitmap) -> None");
...
PyDoc_STRVAR(doc_wxSearchCtrl_SetMargins, "SetMargins(pt : Point) -> bool\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_AppendText, "AppendText(text : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_AutoComplete, "AutoComplete(choices : List[str]) -> bool\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_ChangeValue, "ChangeValue(value : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_GetRange, "GetRange(from_ : int, to_ : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_Remove, "Remove(from_ : int, to_ : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_Replace, "Replace(from_ : int, to_ : int, value : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_SetEditable, "SetEditable(editable : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_SetInsertionPoint, "SetInsertionPoint(pos : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_SetMaxLength, "SetMaxLength(len : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_SetSelection, "SetSelection(from_ : int, to_ : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_SetHint, "SetHint(hint : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_SetValue, "SetValue(value : str) -> None\n"
"\n"
"Sets the new text control value.");
...
PyDoc_STRVAR(doc_wxSearchCtrl_WriteText, "WriteText(text : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSearchCtrl_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"SearchCtrl(parent : Window, id: int=ID_ANY, value: str='', pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, validator: Validator=DefaultValidator, name: str=SearchCtrlNameStr) -> None\n"
"\n"
