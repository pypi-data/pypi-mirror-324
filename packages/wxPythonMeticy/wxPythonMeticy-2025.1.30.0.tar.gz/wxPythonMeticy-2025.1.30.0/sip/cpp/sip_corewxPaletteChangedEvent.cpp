...
PyDoc_STRVAR(doc_wxPaletteChangedEvent_SetChangedWindow, "SetChangedWindow(win : Window) -> None");
...
PyDoc_STRVAR(doc_wxPaletteChangedEvent, "PaletteChangedEvent(winid: int=0) -> None");
