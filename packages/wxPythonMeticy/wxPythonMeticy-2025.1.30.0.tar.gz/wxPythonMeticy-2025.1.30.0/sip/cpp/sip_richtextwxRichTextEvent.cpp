...
PyDoc_STRVAR(doc_wxRichTextEvent_SetPosition, "SetPosition(pos : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextEvent_SetFlags, "SetFlags(flags : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextEvent_SetOldStyleSheet, "SetOldStyleSheet(sheet : RichTextStyleSheet) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextEvent_SetNewStyleSheet, "SetNewStyleSheet(sheet : RichTextStyleSheet) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextEvent_SetRange, "SetRange(range : RichTextRange) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextEvent_SetCharacter, "SetCharacter(ch : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextEvent_SetContainer, "SetContainer(container : RichTextParagraphLayoutBox) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextEvent_SetOldContainer, "SetOldContainer(container : RichTextParagraphLayoutBox) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextEvent, "RichTextEvent(commandType: EventType=wx.wxEVT_NULL, winid: int=0) -> None\n"
