...
PyDoc_STRVAR(doc_wxAlphaPixelData_Accessor_Reset, "Reset(data : AlphaPixelData) -> None");
...
PyDoc_STRVAR(doc_wxAlphaPixelData_Accessor_Offset, "Offset(data : AlphaPixelData, x : int, y : int) -> None");
...
PyDoc_STRVAR(doc_wxAlphaPixelData_Accessor_OffsetX, "OffsetX(data : AlphaPixelData, x : int) -> None");
...
PyDoc_STRVAR(doc_wxAlphaPixelData_Accessor_OffsetY, "OffsetY(data : AlphaPixelData, y : int) -> None");
...
PyDoc_STRVAR(doc_wxAlphaPixelData_Accessor_MoveTo, "MoveTo(data : AlphaPixelData, x : int, y : int) -> None");
...
PyDoc_STRVAR(doc_wxAlphaPixelData_Accessor_Set, "Set(red: int, green: int, blue: int, alpha: int) -> None");
...
PyDoc_STRVAR(doc_wxAlphaPixelData_Accessor, "AlphaPixelData_Accessor(data : AlphaPixelData) -> None\n"
