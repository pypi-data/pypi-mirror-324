...
PyDoc_STRVAR(doc_wxPGArrayStringEditorDialog_SetDialogValue, "SetDialogValue(value : PGVariant) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGArrayStringEditorDialog_SetCustomButton, "SetCustomButton(custBtText : str, pcc : List[StringProperty]) -> None");
...
PyDoc_STRVAR(doc_wxPGArrayStringEditorDialog_OnCustomNewAction, "OnCustomNewAction(resString : str) -> bool");
...
PyDoc_STRVAR(doc_wxPGArrayStringEditorDialog_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
...
PyDoc_STRVAR(doc_wxPGArrayStringEditorDialog_ArrayGet, "ArrayGet(index : int) -> str");
...
PyDoc_STRVAR(doc_wxPGArrayStringEditorDialog_ArrayInsert, "ArrayInsert(str : str, index : int) -> bool");
...
PyDoc_STRVAR(doc_wxPGArrayStringEditorDialog_ArraySet, "ArraySet(index : int, str : str) -> bool");
...
PyDoc_STRVAR(doc_wxPGArrayStringEditorDialog_ArrayRemoveAt, "ArrayRemoveAt(index : int) -> None");
...
PyDoc_STRVAR(doc_wxPGArrayStringEditorDialog_ArraySwap, "ArraySwap(first : int, second : int) -> None");
