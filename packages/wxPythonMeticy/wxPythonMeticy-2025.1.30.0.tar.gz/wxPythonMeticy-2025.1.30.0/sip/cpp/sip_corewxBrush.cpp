...
PyDoc_STRVAR(doc_wxBrush_SetColour, "SetColour(colour : Colour) -> None\n"
...
PyDoc_STRVAR(doc_wxBrush_SetStipple, "SetStipple(bitmap : Bitmap) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBrush_SetStyle, "SetStyle(style : BrushStyle) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBrush_MacSetTheme, "MacSetTheme(macThemeBrushID: int) -> None");
...
PyDoc_STRVAR(doc_wxBrush__copyFrom, "_copyFrom(other: Brush) -> None\n"
"\n"
...
"Brush(colour : Colour, style: BrushStyle=BRUSHSTYLE_SOLID) -> None\n"
"Brush(stippleBitmap : Bitmap) -> None\n"
"Brush(brush : Brush) -> None\n"
"\n"
