...
PyDoc_STRVAR(doc_wxFontList_FindOrCreateFont, "FindOrCreateFont(point_size : int, family : FontFamily, style : FontStyle, weight : FontWeight, underline: bool=False, facename: str='', encoding: FontEncoding=FONTENCODING_DEFAULT) -> Font\n"
"FindOrCreateFont(fontInfo : FontInfo) -> Font\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontList, "FontList() -> None\n"
"\n"
