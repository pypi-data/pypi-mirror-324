...
PyDoc_STRVAR(doc_wxConfigBase_SetPath, "SetPath(strPath : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_GetNextEntry, "GetNextEntry(index: int) -> Any\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_GetNextGroup, "GetNextGroup(index: int) -> Any\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_GetNumberOfEntries, "GetNumberOfEntries(bRecursive: bool=False) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_GetNumberOfGroups, "GetNumberOfGroups(bRecursive: bool=False) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_Exists, "Exists(strName : str) -> bool");
...
PyDoc_STRVAR(doc_wxConfigBase_GetEntryType, "GetEntryType(name : str) -> ConfigBase.EntryType\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_HasEntry, "HasEntry(strName : str) -> bool");
...
PyDoc_STRVAR(doc_wxConfigBase_HasGroup, "HasGroup(strName : str) -> bool");
...
PyDoc_STRVAR(doc_wxConfigBase_Flush, "Flush(bCurrentOnly: bool=False) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_Read, "Read(key : str, defaultVal: str='') -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_ReadBool, "ReadBool(key: str, defaultVal: bool=False) -> bool");
...
PyDoc_STRVAR(doc_wxConfigBase_ReadDouble, "ReadDouble(key : str, defaultVal : float) -> float\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_ReadLong, "ReadLong(key : str, defaultVal : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_ReadLongLong, "ReadLongLong(key : str, defaultVal : LongLong_t) -> LongLong_t\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_Write, "Write(key : str, value : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_RenameEntry, "RenameEntry(oldName : str, newName : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_RenameGroup, "RenameGroup(oldName : str, newName : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_DeleteEntry, "DeleteEntry(key : str, bDeleteGroupIfEmpty: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_DeleteGroup, "DeleteGroup(key : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_SetExpandEnvVars, "SetExpandEnvVars(bDoIt: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_SetRecordDefaults, "SetRecordDefaults(bDoIt: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_Get, "Get(CreateOnDemand: bool=True) -> ConfigBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase_Set, "Set(pConfig : ConfigBase) -> ConfigBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxConfigBase__cpp_ReadInt, "_cpp_ReadInt(key: str, defaultVal: int=0) -> int");
...
PyDoc_STRVAR(doc_wxConfigBase_ReadFloat, "ReadFloat(key: str, defaultVal: float=0.0) -> float");
...
PyDoc_STRVAR(doc_wxConfigBase_WriteInt, "WriteInt(key: str, value: int) -> bool");
...
PyDoc_STRVAR(doc_wxConfigBase_WriteFloat, "WriteFloat(key: str, value: float) -> bool");
...
PyDoc_STRVAR(doc_wxConfigBase_WriteBool, "WriteBool(key: str, value: bool) -> bool");
...
PyDoc_STRVAR(doc_wxConfigBase, "ConfigBase(appName: str='', vendorName: str='', localFilename: str='', globalFilename: str='', style: int=0) -> None\n"
"\n"
