...
PyDoc_STRVAR(doc_wxGridCellRendererPtr_reset, "reset(ptr : T) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellRendererPtr, "ObjectDataPtr(tocopy : ObjectDataPtrT) -> None\n"
"ObjectDataPtr(ptr: Optional[T]=None) -> None\n"
"\n"
