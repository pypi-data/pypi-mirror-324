...
PyDoc_STRVAR(doc_wxAuiDefaultDockArt_GetMetric, "GetMetric(id : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiDefaultDockArt_SetMetric, "SetMetric(id : int, new_val : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiDefaultDockArt_GetColour, "GetColour(id : int) -> wx.Colour\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiDefaultDockArt_SetColour, "SetColour(id : int, colour : wx.Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiDefaultDockArt_SetFont, "SetFont(id : int, font : wx.Font) -> None\n"
"\n"
"Set a font setting.");
...
PyDoc_STRVAR(doc_wxAuiDefaultDockArt_GetFont, "GetFont(id : int) -> wx.Font\n"
"\n"
"Get a font setting.");
...
PyDoc_STRVAR(doc_wxAuiDefaultDockArt_DrawSash, "DrawSash(dc : wx.DC, window : wx.Window, orientation : int, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiDefaultDockArt_DrawBackground, "DrawBackground(dc : wx.DC, window : wx.Window, orientation : int, rect : wx.Rect) -> None\n"
"\n"
"Draws a background.");
...
PyDoc_STRVAR(doc_wxAuiDefaultDockArt_DrawCaption, "DrawCaption(dc : wx.DC, window : wx.Window, text : str, rect : wx.Rect, pane : AuiPaneInfo) -> None\n"
"\n"
"Draws a caption.");
...
PyDoc_STRVAR(doc_wxAuiDefaultDockArt_DrawGripper, "DrawGripper(dc : wx.DC, window : wx.Window, rect : wx.Rect, pane : AuiPaneInfo) -> None\n"
"\n"
"Draws a gripper.");
...
PyDoc_STRVAR(doc_wxAuiDefaultDockArt_DrawBorder, "DrawBorder(dc : wx.DC, window : wx.Window, rect : wx.Rect, pane : AuiPaneInfo) -> None\n"
"\n"
"Draws a border.");
...
PyDoc_STRVAR(doc_wxAuiDefaultDockArt_DrawPaneButton, "DrawPaneButton(dc : wx.DC, window : wx.Window, button : int, button_state : int, rect : wx.Rect, pane : AuiPaneInfo) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAuiDefaultDockArt_DrawIcon, "DrawIcon(dc : wx.DC, rect : wx.Rect, pane : AuiPaneInfo) -> None");
