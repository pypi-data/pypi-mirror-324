...
PyDoc_STRVAR(doc_wxPrintAbortDialog_SetProgress, "SetProgress(currentPage : int, totalPages : int, currentCopy : int, totalCopies : int) -> None");
...
PyDoc_STRVAR(doc_wxPrintAbortDialog_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
PyDoc_STRVAR(doc_wxPrintAbortDialog, "PrintAbortDialog(parent : Window, documentTitle : str, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=DEFAULT_DIALOG_STYLE, name: str=\"dialog\") -> None\n"
"\n"
