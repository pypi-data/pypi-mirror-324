...
PyDoc_STRVAR(doc_wxRichTextPlainText_Draw, "Draw(dc : wx.DC, context : RichTextDrawingContext, range : RichTextRange, selection : RichTextSelection, rect : wx.Rect, descent : int, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainText_Layout, "Layout(dc : wx.DC, context : RichTextDrawingContext, rect : wx.Rect, parentRect : wx.Rect, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainText_GetRangeSize, "GetRangeSize(range : RichTextRange, size : wx.Size, descent : int, dc : wx.DC, context : RichTextDrawingContext, flags : int, position: wx.Point=wx.Point(0,0), parentSize: wx.Size=wx.DefaultSize, partialExtents: Optional[List[int]]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainText_GetTextForRange, "GetTextForRange(range : RichTextRange) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainText_DoSplit, "DoSplit(pos : int) -> RichTextObject\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainText_CalculateRange, "CalculateRange(start : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainText_DeleteRange, "DeleteRange(range : RichTextRange) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainText_CanMerge, "CanMerge(object : RichTextObject, context : RichTextDrawingContext) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainText_Merge, "Merge(object : RichTextObject, context : RichTextDrawingContext) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainText_CanSplit, "CanSplit(context : RichTextDrawingContext) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainText_Split, "Split(context : RichTextDrawingContext) -> RichTextObject\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainText_GetFirstLineBreakPosition, "GetFirstLineBreakPosition(pos : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainText_ImportFromXML, "ImportFromXML(buffer : RichTextBuffer, node : XmlNode, handler : RichTextXMLHandler, recurse : bool) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainText_SetText, "SetText(text : str) -> None\n"
"\n"
"Sets the text.");
...
PyDoc_STRVAR(doc_wxRichTextPlainText_Copy, "Copy(obj : RichTextPlainText) -> None");
...
PyDoc_STRVAR(doc_wxRichTextPlainText, "RichTextPlainText(text: str='', parent: Optional[RichTextObject]=None, style: Optional[RichTextAttr]=None) -> None\n"
