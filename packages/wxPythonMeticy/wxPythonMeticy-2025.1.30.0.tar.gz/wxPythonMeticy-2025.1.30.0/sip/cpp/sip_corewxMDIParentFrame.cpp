...
PyDoc_STRVAR(doc_wxMDIParentFrame_Create, "Create(parent : Window, id: int=ID_ANY, title: str='', pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=DEFAULT_FRAME_STYLE|VSCROLL|HSCROLL, name: str=FrameNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxMDIParentFrame_SetWindowMenu, "SetWindowMenu(menu : Menu) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxMDIParentFrame_Tile, "Tile(orient: Orientation=HORIZONTAL) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxMDIParentFrame_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"MDIParentFrame(parent : Window, id: int=ID_ANY, title: str='', pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=DEFAULT_FRAME_STYLE|VSCROLL|HSCROLL, name: str=FrameNameStr) -> None\n"
"\n"
