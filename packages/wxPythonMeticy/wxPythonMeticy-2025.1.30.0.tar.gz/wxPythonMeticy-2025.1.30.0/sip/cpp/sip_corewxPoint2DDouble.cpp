...
PyDoc_STRVAR(doc_wxPoint2DDouble_SetVectorLength, "SetVectorLength(length : float) -> None");
...
PyDoc_STRVAR(doc_wxPoint2DDouble_SetVectorAngle, "SetVectorAngle(degrees : float) -> None");
...
PyDoc_STRVAR(doc_wxPoint2DDouble_GetDistance, "GetDistance(pt : Point2DDouble) -> float");
...
PyDoc_STRVAR(doc_wxPoint2DDouble_GetDistanceSquare, "GetDistanceSquare(pt : Point2DDouble) -> float");
...
PyDoc_STRVAR(doc_wxPoint2DDouble_GetDotProduct, "GetDotProduct(vec : Point2DDouble) -> float");
...
PyDoc_STRVAR(doc_wxPoint2DDouble_GetCrossProduct, "GetCrossProduct(vec : Point2DDouble) -> float");
