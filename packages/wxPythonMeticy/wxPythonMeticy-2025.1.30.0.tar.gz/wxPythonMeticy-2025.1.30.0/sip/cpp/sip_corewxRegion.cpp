...
PyDoc_STRVAR(doc_wxRegion_Offset, "Offset(x : int, y : int) -> bool\n"
"Offset(pt : Point) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRegion_Contains, "Contains(x : int, y : int) -> RegionContain\n"
"Contains(pt : Point) -> RegionContain\n"
"Contains(x : int, y : int, width : int, height : int) -> RegionContain\n"
"Contains(rect : Rect) -> RegionContain\n"
"\n"
...
PyDoc_STRVAR(doc_wxRegion_Intersect, "Intersect(x : int, y : int, width : int, height : int) -> bool\n"
"Intersect(rect : Rect) -> bool\n"
"Intersect(region : Region) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRegion_IsEqual, "IsEqual(region : Region) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRegion_Subtract, "Subtract(rect : Rect) -> bool\n"
"Subtract(region : Region) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRegion_Union, "Union(x : int, y : int, width : int, height : int) -> bool\n"
"Union(rect : Rect) -> bool\n"
"Union(region : Region) -> bool\n"
"Union(bmp : Bitmap) -> bool\n"
"Union(bmp : Bitmap, transColour : Colour, tolerance: int=0) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRegion_Xor, "Xor(x : int, y : int, width : int, height : int) -> bool\n"
"Xor(rect : Rect) -> bool\n"
"Xor(region : Region) -> bool\n"
"\n"
...
"Region(x : int, y : int, width : int, height : int) -> None\n"
"Region(topLeft : Point, bottomRight : Point) -> None\n"
"Region(rect : Rect) -> None\n"
"Region(region : Region) -> None\n"
"Region(bmp : Bitmap) -> None\n"
"Region(bmp : Bitmap, transColour : Colour, tolerance: int=0) -> None\n"
"Region(points: Any, fillStyle: PolygonFillMode=ODDEVEN_RULE) -> None\n"
"\n"
