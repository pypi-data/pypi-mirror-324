...
PyDoc_STRVAR(doc_wxSashEvent_SetEdge, "SetEdge(edge : SashEdgePosition) -> None");
...
PyDoc_STRVAR(doc_wxSashEvent_SetDragRect, "SetDragRect(rect : wx.Rect) -> None");
...
PyDoc_STRVAR(doc_wxSashEvent_SetDragStatus, "SetDragStatus(status : SashDragStatus) -> None");
...
PyDoc_STRVAR(doc_wxSashEvent, "SashEvent(id: int=0, edge: SashEdgePosition=SASH_NONE) -> None\n"
"\n"
