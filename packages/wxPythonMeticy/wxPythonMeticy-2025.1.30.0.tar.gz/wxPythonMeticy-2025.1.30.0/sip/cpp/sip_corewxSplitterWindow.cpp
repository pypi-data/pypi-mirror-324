...
PyDoc_STRVAR(doc_wxSplitterWindow_Create, "Create(parent : Window, id: int=ID_ANY, point: Point=DefaultPosition, size: Size=DefaultSize, style: int=SP_3D, name: str=\"splitter\") -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSplitterWindow_Initialize, "Initialize(window : Window) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSplitterWindow_ReplaceWindow, "ReplaceWindow(winOld : Window, winNew : Window) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSplitterWindow_SetMinimumPaneSize, "SetMinimumPaneSize(paneSize : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSplitterWindow_SetSashGravity, "SetSashGravity(gravity : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSplitterWindow_SetSashPosition, "SetSashPosition(position : int, redraw: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSplitterWindow_SetSplitMode, "SetSplitMode(mode : int) -> None\n"
"\n"
"Sets the split mode.");
...
PyDoc_STRVAR(doc_wxSplitterWindow_SetSashInvisible, "SetSashInvisible(invisible: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSplitterWindow_SplitHorizontally, "SplitHorizontally(window1 : Window, window2 : Window, sashPosition: int=0) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSplitterWindow_SplitVertically, "SplitVertically(window1 : Window, window2 : Window, sashPosition: int=0) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSplitterWindow_Unsplit, "Unsplit(toRemove: Optional[Window]=None) -> bool\n"
"\n"
"Unsplits the window.");
...
PyDoc_STRVAR(doc_wxSplitterWindow_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"SplitterWindow(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=SP_3D, name: str=\"splitterWindow\") -> None\n"
"\n"
