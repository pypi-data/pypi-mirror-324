...
PyDoc_STRVAR(doc_wxRadioBox_Create, "Create(parent : Window, id: int=ID_ANY, label: str='', pos: Point=DefaultPosition, size: Size=DefaultSize, choices: List[str]=[], majorDimension: int=0, style: int=RA_SPECIFY_COLS, validator: Validator=DefaultValidator, name: str=RadioBoxNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRadioBox_EnableItem, "EnableItem(n : int, enable: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRadioBox_FindString, "FindString(string : str, bCase: bool=False) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRadioBox_GetItemFromPoint, "GetItemFromPoint(pt : Point) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRadioBox_GetItemHelpText, "GetItemHelpText(item : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxRadioBox_GetItemToolTip, "GetItemToolTip(item : int) -> ToolTip\n"
"\n"
...
PyDoc_STRVAR(doc_wxRadioBox_IsItemEnabled, "IsItemEnabled(n : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRadioBox_IsItemShown, "IsItemShown(n : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRadioBox_SetItemHelpText, "SetItemHelpText(item : int, helptext : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRadioBox_SetItemToolTip, "SetItemToolTip(item : int, text : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRadioBox_SetSelection, "SetSelection(n : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRadioBox_ShowItem, "ShowItem(item : int, show: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRadioBox_GetString, "GetString(n : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxRadioBox_SetString, "SetString(n : int, string : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRadioBox_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"RadioBox(parent : Window, id: int=ID_ANY, label: str='', pos: Point=DefaultPosition, size: Size=DefaultSize, choices: List[str]=[], majorDimension: int=0, style: int=RA_SPECIFY_COLS, validator: Validator=DefaultValidator, name: str=RadioBoxNameStr) -> None\n"
"\n"
