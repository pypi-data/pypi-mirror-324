...
PyDoc_STRVAR(doc_wxCaret_Create, "Create(window : Window, width : int, height : int) -> bool\n"
"Create(window : Window, size : Size) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxCaret_Move, "Move(x : int, y : int) -> None\n"
"Move(pt : Point) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxCaret_SetSize, "SetSize(width : int, height : int) -> None\n"
...
PyDoc_STRVAR(doc_wxCaret_Show, "Show(show: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxCaret_SetBlinkTime, "SetBlinkTime(milliseconds : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxCaret, "Caret(window : Window, width : int, height : int) -> None\n"
