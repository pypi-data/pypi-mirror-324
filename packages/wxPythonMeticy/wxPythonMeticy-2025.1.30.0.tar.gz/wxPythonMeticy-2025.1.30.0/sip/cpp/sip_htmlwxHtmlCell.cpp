...
PyDoc_STRVAR(doc_wxHtmlCell_AdjustPagebreak, "AdjustPagebreak(pagebreak : int, pageHeight : int) -> Tuple[bool, int]\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlCell_Draw, "Draw(dc : wx.DC, x : int, y : int, view_y1 : int, view_y2 : int, info : HtmlRenderingInfo) -> None\n"
"\n"
"Renders the cell.");
...
PyDoc_STRVAR(doc_wxHtmlCell_DrawInvisible, "DrawInvisible(dc : wx.DC, x : int, y : int, info : HtmlRenderingInfo) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlCell_Find, "Find(condition : int, param : str) -> HtmlCell\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlCell_FindCellByPos, "FindCellByPos(x : int, y : int, flags: int=HTML_FIND_EXACT) -> HtmlCell\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlCell_GetLink, "GetLink(x: int=0, y: int=0) -> HtmlLinkInfo\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlCell_GetMouseCursor, "GetMouseCursor(window : HtmlWindowInterface) -> wx.Cursor\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlCell_GetMouseCursorAt, "GetMouseCursorAt(window : HtmlWindowInterface, rePos : wx.Point) -> wx.Cursor\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlCell_Layout, "Layout(w : int) -> None\n"
"\n"
"Layouts the cell.");
...
PyDoc_STRVAR(doc_wxHtmlCell_ProcessMouseClick, "ProcessMouseClick(window : HtmlWindowInterface, pos : wx.Point, event : wx.MouseEvent) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlCell_SetId, "SetId(id : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlCell_SetLink, "SetLink(link : HtmlLinkInfo) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlCell_SetNext, "SetNext(cell : HtmlCell) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlCell_SetParent, "SetParent(p : HtmlContainerCell) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlCell_SetPos, "SetPos(x : int, y : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlCell_ConvertToText, "ConvertToText(sel : HtmlSelection) -> str\n"
"\n"
