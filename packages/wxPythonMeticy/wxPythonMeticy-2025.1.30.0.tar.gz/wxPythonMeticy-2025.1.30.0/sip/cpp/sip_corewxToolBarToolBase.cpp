...
PyDoc_STRVAR(doc_wxToolBarToolBase_Enable, "Enable(enable : bool) -> bool");
...
PyDoc_STRVAR(doc_wxToolBarToolBase_Toggle, "Toggle(toggle : bool) -> bool\n"
"Toggle() -> None\n"
"");
...
PyDoc_STRVAR(doc_wxToolBarToolBase_SetToggle, "SetToggle(toggle : bool) -> bool");
...
PyDoc_STRVAR(doc_wxToolBarToolBase_SetShortHelp, "SetShortHelp(help : str) -> bool");
...
PyDoc_STRVAR(doc_wxToolBarToolBase_SetLongHelp, "SetLongHelp(help : str) -> bool");
...
PyDoc_STRVAR(doc_wxToolBarToolBase_SetNormalBitmap, "SetNormalBitmap(bmp : BitmapBundle) -> None");
...
PyDoc_STRVAR(doc_wxToolBarToolBase_SetDisabledBitmap, "SetDisabledBitmap(bmp : BitmapBundle) -> None");
...
PyDoc_STRVAR(doc_wxToolBarToolBase_SetLabel, "SetLabel(label : str) -> None");
...
PyDoc_STRVAR(doc_wxToolBarToolBase_SetClientData, "SetClientData(clientData : PyUserData) -> None");
...
PyDoc_STRVAR(doc_wxToolBarToolBase_Attach, "Attach(tbar : ToolBar) -> None");
...
PyDoc_STRVAR(doc_wxToolBarToolBase_SetDropdownMenu, "SetDropdownMenu(menu : Menu) -> None");
...
PyDoc_STRVAR(doc_wxToolBarToolBase, "ToolBarToolBase(tbar: Optional[ToolBar]=None, toolid: int=ID_SEPARATOR, label: str='', bmpNormal: BitmapBundle=NullBitmap, bmpDisabled: BitmapBundle=NullBitmap, kind: ItemKind=ITEM_NORMAL, clientData: Optional[PyUserData]=None, shortHelpString: str='', longHelpString: str='') -> None\n"
