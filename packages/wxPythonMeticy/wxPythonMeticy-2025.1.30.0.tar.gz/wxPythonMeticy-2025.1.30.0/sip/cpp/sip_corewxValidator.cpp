...
PyDoc_STRVAR(doc_wxValidator_TryBefore, "TryBefore(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxValidator_TryAfter, "TryAfter(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxValidator_SetWindow, "SetWindow(window : Window) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxValidator_Validate, "Validate(parent : Window) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxValidator_SuppressBellOnError, "SuppressBellOnError(suppress: bool=True) -> None\n"
"\n"
