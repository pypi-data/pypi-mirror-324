...
PyDoc_STRVAR(doc_wxPropertyGridIteratorBase_Assign, "Assign(it : PropertyGridIteratorBase) -> None");
...
PyDoc_STRVAR(doc_wxPropertyGridIteratorBase_Init, "Init(state : PropertyGridPageState, flags : int, property : PGProperty, dir: int=1) -> None\n"
"Init(state : PropertyGridPageState, flags : int, startPos: int=wx.TOP, dir: int=0) -> None\n"
"");
...
PyDoc_STRVAR(doc_wxPropertyGridIteratorBase_Next, "Next(iterateChildren: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridIteratorBase_SetBaseParent, "SetBaseParent(baseParent : PGProperty) -> None\n"
"\n"
"Set base parent, i.e.");
