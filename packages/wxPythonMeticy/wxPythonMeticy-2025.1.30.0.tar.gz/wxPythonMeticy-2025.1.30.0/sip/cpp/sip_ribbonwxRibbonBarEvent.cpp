...
PyDoc_STRVAR(doc_wxRibbonBarEvent_SetPage, "SetPage(page : RibbonPage) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonBarEvent, "RibbonBarEvent(command_type: EventType=wx.wxEVT_NULL, win_id: int=0, page: Optional[RibbonPage]=None) -> None\n"
"\n"
