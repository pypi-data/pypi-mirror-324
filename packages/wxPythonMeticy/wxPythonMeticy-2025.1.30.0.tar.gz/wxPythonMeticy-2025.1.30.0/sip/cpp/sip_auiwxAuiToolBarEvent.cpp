...
PyDoc_STRVAR(doc_wxAuiToolBarEvent_SetDropDownClicked, "SetDropDownClicked(c : bool) -> None");
...
PyDoc_STRVAR(doc_wxAuiToolBarEvent_SetClickPoint, "SetClickPoint(p : wx.Point) -> None");
...
PyDoc_STRVAR(doc_wxAuiToolBarEvent_SetItemRect, "SetItemRect(r : wx.Rect) -> None");
...
PyDoc_STRVAR(doc_wxAuiToolBarEvent_SetToolId, "SetToolId(toolId : int) -> None");
...
PyDoc_STRVAR(doc_wxAuiToolBarEvent, "AuiToolBarEvent(commandType: EventType=wx.wxEVT_NULL, winId: int=0) -> None\n"
