...
PyDoc_STRVAR(doc_wxUniChar_GetAsChar, "GetAsChar(c : str) -> bool\n"
"\n"
...
"IsSupplementary(value : Uint32) -> bool\n"
"\n"
...
"HighSurrogate(value : Uint32) -> Uint16\n"
"\n"
...
"LowSurrogate(value : Uint32) -> Uint16\n"
"\n"
...
PyDoc_STRVAR(doc_wxUniChar, "UniChar(c : int) -> None\n"
"UniChar(c : int) -> None\n"
"\n"
