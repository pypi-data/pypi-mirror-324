...
PyDoc_STRVAR(doc_wxCursor_SetHandle, "SetHandle(handle: int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxCursor__copyFrom, "_copyFrom(other: Cursor) -> None\n"
"\n"
...
"Cursor(cursorName : str, type: BitmapType=BITMAP_TYPE_ANY, hotSpotX: int=0, hotSpotY: int=0) -> None\n"
"Cursor(cursorId : StockCursor) -> None\n"
"Cursor(image : Image) -> None\n"
