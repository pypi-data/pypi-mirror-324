...
PyDoc_STRVAR(doc_wxPowerResource_Acquire, "Acquire(kind : PowerResourceKind, reason: str=\"\") -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPowerResource_Release, "Release(kind : PowerResourceKind) -> None\n"
"\n"
