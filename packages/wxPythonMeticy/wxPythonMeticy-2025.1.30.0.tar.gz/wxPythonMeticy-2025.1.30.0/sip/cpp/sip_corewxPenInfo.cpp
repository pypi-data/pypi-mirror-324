...
PyDoc_STRVAR(doc_wxPenInfo_Colour, "Colour(col : Colour) -> PenInfo");
...
PyDoc_STRVAR(doc_wxPenInfo_Width, "Width(width : int) -> PenInfo");
...
PyDoc_STRVAR(doc_wxPenInfo_Style, "Style(style : PenStyle) -> PenInfo");
...
PyDoc_STRVAR(doc_wxPenInfo_Stipple, "Stipple(stipple : Bitmap) -> PenInfo");
...
PyDoc_STRVAR(doc_wxPenInfo_Join, "Join(join : PenJoin) -> PenInfo");
...
PyDoc_STRVAR(doc_wxPenInfo_Cap, "Cap(cap : PenCap) -> PenInfo");
...
PyDoc_STRVAR(doc_wxPenInfo_Quality, "Quality(quality : PenQuality) -> PenInfo\n"
"\n"
"Set the pen quality.");
...
PyDoc_STRVAR(doc_wxPenInfo, "PenInfo(colour: Colour=Colour(), width: int=1, style: PenStyle=PENSTYLE_SOLID) -> None\n"
"\n"
