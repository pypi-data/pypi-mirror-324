...
PyDoc_STRVAR(doc_wxTextAttrBorder_EqPartial, "EqPartial(border : TextAttrBorder, weakTest: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrBorder_Apply, "Apply(border : TextAttrBorder, compareWith: Optional[TextAttrBorder]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrBorder_RemoveStyle, "RemoveStyle(attr : TextAttrBorder) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrBorder_CollectCommonAttributes, "CollectCommonAttributes(attr : TextAttrBorder, clashingAttr : TextAttrBorder, absentAttr : TextAttrBorder) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrBorder_SetStyle, "SetStyle(style : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrBorder_SetColour, "SetColour(colour : int) -> None\n"
...
PyDoc_STRVAR(doc_wxTextAttrBorder_SetWidth, "SetWidth(width : TextAttrDimension) -> None\n"
"SetWidth(value : int, units: TextAttrUnits=TEXT_ATTR_UNITS_TENTHS_MM) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrBorder_SetFlags, "SetFlags(flags : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextAttrBorder_AddFlag, "AddFlag(flag : int) -> None\n"
"\n"
"Adds a border flag.");
...
PyDoc_STRVAR(doc_wxTextAttrBorder_RemoveFlag, "RemoveFlag(flag : int) -> None\n"
"\n"
