...
PyDoc_STRVAR(doc_wxTimer_TryBefore, "TryBefore(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTimer_TryAfter, "TryAfter(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTimer_SetOwner, "SetOwner(owner : EvtHandler, id: int=-1) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTimer_Start, "Start(milliseconds: int=-1, oneShot: bool=TIMER_CONTINUOUS) -> bool\n"
"\n"
"(Re)starts the timer.");
...
PyDoc_STRVAR(doc_wxTimer_StartOnce, "StartOnce(milliseconds: int=-1) -> bool\n"
"\n"
...
"Timer(owner : EvtHandler, id: int=-1) -> None\n"
"\n"
