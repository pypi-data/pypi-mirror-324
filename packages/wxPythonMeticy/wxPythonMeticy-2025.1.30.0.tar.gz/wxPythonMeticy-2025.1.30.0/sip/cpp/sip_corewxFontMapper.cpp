...
PyDoc_STRVAR(doc_wxFontMapper_GetAltForEncoding, "GetAltForEncoding(encoding : FontEncoding, facename: str='', interactive: bool=True) -> Tuple[bool, FontEncoding]\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontMapper_CharsetToEncoding, "CharsetToEncoding(charset : str, interactive: bool=True) -> FontEncoding\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontMapper_IsEncodingAvailable, "IsEncodingAvailable(encoding : FontEncoding, facename: str='') -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontMapper_SetConfigPath, "SetConfigPath(prefix : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontMapper_SetDialogParent, "SetDialogParent(parent : Window) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontMapper_SetDialogTitle, "SetDialogTitle(title : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontMapper_GetAllEncodingNames, "GetAllEncodingNames(encoding: FontEncoding) -> List[str]\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontMapper_GetEncoding, "GetEncoding(n : int) -> FontEncoding\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontMapper_GetEncodingDescription, "GetEncodingDescription(encoding : FontEncoding) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontMapper_GetEncodingFromName, "GetEncodingFromName(encoding : str) -> FontEncoding\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontMapper_GetEncodingName, "GetEncodingName(encoding : FontEncoding) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFontMapper_Set, "Set(mapper : FontMapper) -> FontMapper\n"
"\n"
