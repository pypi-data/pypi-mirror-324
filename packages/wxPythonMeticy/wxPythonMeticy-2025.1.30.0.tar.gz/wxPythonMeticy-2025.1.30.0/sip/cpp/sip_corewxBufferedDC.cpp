...
PyDoc_STRVAR(doc_wxBufferedDC_Init, "Init(dc : DC, area : Size, style: int=BUFFER_CLIENT_AREA) -> None\n"
"Init(dc : DC, buffer: Bitmap=NullBitmap, style: int=BUFFER_CLIENT_AREA) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBufferedDC_SetStyle, "SetStyle(style : int) -> None\n"
"\n"
"Set the style.");
...
"BufferedDC(dc : DC, area : Size, style: int=BUFFER_CLIENT_AREA) -> None\n"
"BufferedDC(dc : DC, buffer: Bitmap=NullBitmap, style: int=BUFFER_CLIENT_AREA) -> None\n"
"\n"
