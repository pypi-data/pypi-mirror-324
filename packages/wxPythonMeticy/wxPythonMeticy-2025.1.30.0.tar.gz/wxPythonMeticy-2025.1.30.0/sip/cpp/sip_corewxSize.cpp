...
PyDoc_STRVAR(doc_wxSize_DecBy, "DecBy(pt : Point) -> None\n"
"DecBy(size : Size) -> None\n"
"DecBy(dx : int, dy : int) -> None\n"
"DecBy(d : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSize_IncBy, "IncBy(pt : Point) -> None\n"
"IncBy(size : Size) -> None\n"
"IncBy(dx : int, dy : int) -> None\n"
"IncBy(d : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSize_DecTo, "DecTo(size : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSize_DecToIfSpecified, "DecToIfSpecified(size : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSize_IncTo, "IncTo(size : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSize_Scale, "Scale(xscale : float, yscale : float) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxSize_Set, "Set(width : int, height : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSize_SetDefaults, "SetDefaults(sizeDefault : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSize_SetHeight, "SetHeight(height : int) -> None\n"
"\n"
"Sets the height.");
...
PyDoc_STRVAR(doc_wxSize_SetWidth, "SetWidth(width : int) -> None\n"
"\n"
"Sets the width.");
