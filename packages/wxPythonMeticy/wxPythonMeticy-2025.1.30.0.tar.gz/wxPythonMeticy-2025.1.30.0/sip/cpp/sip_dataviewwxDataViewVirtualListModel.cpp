...
PyDoc_STRVAR(doc_wxDataViewVirtualListModel_GetItem, "GetItem(row : int) -> DataViewItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewVirtualListModel_Reset, "Reset(new_size : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewVirtualListModel_RowChanged, "RowChanged(row : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewVirtualListModel_RowDeleted, "RowDeleted(row : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewVirtualListModel_RowInserted, "RowInserted(before : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewVirtualListModel_RowValueChanged, "RowValueChanged(row : int, col : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewVirtualListModel_RowsDeleted, "RowsDeleted(rows : List[int]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewVirtualListModel, "DataViewVirtualListModel(initial_size: int=0) -> None\n"
"\n"
