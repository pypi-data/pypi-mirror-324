...
PyDoc_STRVAR(doc_wxVideoMode_Matches, "Matches(other : VideoMode) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVideoMode, "VideoMode(width: int=0, height: int=0, depth: int=0, freq: int=0) -> None\n"
"\n"
