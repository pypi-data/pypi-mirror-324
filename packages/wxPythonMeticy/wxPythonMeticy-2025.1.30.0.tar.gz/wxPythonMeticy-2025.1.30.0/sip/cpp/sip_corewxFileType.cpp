...
PyDoc_STRVAR(doc_wxFileType_GetOpenCommand, "GetOpenCommand(params: FileType.MessageParameters) -> str\n"
"GetOpenCommand(filename: str) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileType_GetPrintCommand, "GetPrintCommand(params: FileType.MessageParameters) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileType_GetExpandedCommand, "GetExpandedCommand(verb : str, params : FileType.MessageParameters) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileType_GetAllCommands, "GetAllCommands(params : FileType.MessageParameters) -> Tuple[List[str], List[str]]\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileType_ExpandCommand, "ExpandCommand(command : str, params : MessageParameters) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileType, "FileType(ftInfo : FileTypeInfo) -> None\n"
"\n"
