...
PyDoc_STRVAR(doc_wxAnimation_IsCompatibleWith, "IsCompatibleWith(ci : wx.ClassInfo) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAnimation_GetDelay, "GetDelay(frame : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxAnimation_GetFrame, "GetFrame(frame : int) -> wx.Image\n"
"\n"
...
PyDoc_STRVAR(doc_wxAnimation_LoadFile, "LoadFile(name : str, type: AnimationType=ANIMATION_TYPE_ANY) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAnimation_Load, "Load(stream : wx.InputStream, type: AnimationType=ANIMATION_TYPE_ANY) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxAnimation_AddHandler, "AddHandler(handler : AnimationDecoder) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAnimation_InsertHandler, "InsertHandler(handler : AnimationDecoder) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxAnimation_FindHandler, "FindHandler(animType : AnimationType) -> AnimationDecoder\n"
"\n"
