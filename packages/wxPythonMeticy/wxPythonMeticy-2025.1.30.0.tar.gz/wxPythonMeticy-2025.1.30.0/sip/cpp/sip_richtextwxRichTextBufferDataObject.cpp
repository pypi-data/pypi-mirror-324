...
PyDoc_STRVAR(doc_wxRichTextBufferDataObject_GetPreferredFormat, "GetPreferredFormat(dir : wx.Direction) -> wx.DataFormat\n"
"\n"
...
"GetDataSize(format : wx.DataFormat) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextBufferDataObject_GetDataHere, "GetDataHere(buf : Any) -> bool\n"
"GetDataHere(format : wx.DataFormat, buf : Any) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextBufferDataObject_SetData, "SetData(len : int, buf : Any) -> bool\n"
"SetData(format : wx.DataFormat, len : int, buf : Any) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextBufferDataObject, "RichTextBufferDataObject(richTextBuffer: Optional[RichTextBuffer]=None) -> None\n"
"\n"
