...
PyDoc_STRVAR(doc_wxDataViewCustomRenderer_ActivateCell, "ActivateCell(cell : wx.Rect, model : DataViewModel, item : DataViewItem, col : int, mouseEvent : wx.MouseEvent) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCustomRenderer_CreateEditorCtrl, "CreateEditorCtrl(parent : wx.Window, labelRect : wx.Rect, value : DVCVariant) -> wx.Window\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCustomRenderer_GetValueFromEditorCtrl, "GetValueFromEditorCtrl(editor : wx.Window) -> DVCVariant\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCustomRenderer_LeftClick, "LeftClick(cursor : wx.Point, cell : wx.Rect, model : DataViewModel, item : DataViewItem, col : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCustomRenderer_Activate, "Activate(cell : wx.Rect, model : DataViewModel, item : DataViewItem, col : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCustomRenderer_Render, "Render(cell : wx.Rect, dc : wx.DC, state : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCustomRenderer_RenderText, "RenderText(text : str, xoffset : int, cell : wx.Rect, dc : wx.DC, state : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCustomRenderer_StartDrag, "StartDrag(cursor : wx.Point, cell : wx.Rect, model : DataViewModel, item : DataViewItem, col : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCustomRenderer_GetTextExtent, "GetTextExtent(str : str) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCustomRenderer, "DataViewCustomRenderer(varianttype: str=DataViewCustomRenderer.GetDefaultType(), mode: DataViewCellMode=DATAVIEW_CELL_INERT, align: int=DVR_DEFAULT_ALIGNMENT) -> None\n"
"\n"
