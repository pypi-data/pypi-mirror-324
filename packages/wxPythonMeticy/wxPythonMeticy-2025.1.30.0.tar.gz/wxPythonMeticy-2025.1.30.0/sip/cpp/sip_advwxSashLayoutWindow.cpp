...
PyDoc_STRVAR(doc_wxSashLayoutWindow_Create, "Create(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=wx.CLIP_CHILDREN|SW_3D, name: str=\"layoutWindow\") -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSashLayoutWindow_OnCalculateLayout, "OnCalculateLayout(event : CalculateLayoutEvent) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSashLayoutWindow_OnQueryLayoutInfo, "OnQueryLayoutInfo(event : QueryLayoutInfoEvent) -> None\n"
"\n"
"The default handler for the event that is generated by\n"
...
PyDoc_STRVAR(doc_wxSashLayoutWindow_SetAlignment, "SetAlignment(alignment : LayoutAlignment) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSashLayoutWindow_SetDefaultSize, "SetDefaultSize(size : wx.Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSashLayoutWindow_SetOrientation, "SetOrientation(orientation : LayoutOrientation) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSashLayoutWindow_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
