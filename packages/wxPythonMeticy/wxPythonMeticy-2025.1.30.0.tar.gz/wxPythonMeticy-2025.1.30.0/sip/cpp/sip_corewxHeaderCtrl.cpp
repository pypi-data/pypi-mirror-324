...
PyDoc_STRVAR(doc_wxHeaderCtrl_Create, "Create(parent : Window, winid: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=HD_DEFAULT_STYLE, name: str=HeaderCtrlNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrl_SetColumnCount, "SetColumnCount(count : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrl_UpdateColumn, "UpdateColumn(idx : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrl_SetColumnsOrder, "SetColumnsOrder(order : List[int]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrl_GetColumnAt, "GetColumnAt(pos : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrl_GetColumnPos, "GetColumnPos(idx : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrl_ShowColumnsMenu, "ShowColumnsMenu(pt : Point, title: str=\"\") -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrl_AddColumnsItems, "AddColumnsItems(menu : Menu, idColumnsBase: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrl_GetColumnTitleWidth, "GetColumnTitleWidth(col : HeaderColumn) -> int\n"
"GetColumnTitleWidth(idx : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrl_MoveColumnInOrderArray, "MoveColumnInOrderArray(order : List[int], idx : int, pos : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrl_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
PyDoc_STRVAR(doc_wxHeaderCtrl_GetColumn, "GetColumn(idx : int) -> HeaderColumn\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrl_UpdateColumnVisibility, "UpdateColumnVisibility(idx : int, show : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrl_UpdateColumnsOrder, "UpdateColumnsOrder(order : List[int]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrl_UpdateColumnWidthToFit, "UpdateColumnWidthToFit(idx : int, widthTitle : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrl_OnColumnCountChanging, "OnColumnCountChanging(count : int) -> None\n"
"\n"
...
"HeaderCtrl(parent : Window, winid: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=HD_DEFAULT_STYLE, name: str=HeaderCtrlNameStr) -> None\n"
"\n"
