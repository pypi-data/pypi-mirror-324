...
PyDoc_STRVAR(doc_wxRichTextTable_Draw, "Draw(dc : wx.DC, context : RichTextDrawingContext, range : RichTextRange, selection : RichTextSelection, rect : wx.Rect, descent : int, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_HitTest, "HitTest(dc : wx.DC, context : RichTextDrawingContext, pt : wx.Point, flags: int=0) -> Tuple[int, int, RichTextObject, RichTextObject]\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_Layout, "Layout(dc : wx.DC, context : RichTextDrawingContext, rect : wx.Rect, parentRect : wx.Rect, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_GetRangeSize, "GetRangeSize(range : RichTextRange, size : wx.Size, descent : int, dc : wx.DC, context : RichTextDrawingContext, flags : int, position: wx.Point=wx.Point(0,0), parentSize: wx.Size=wx.DefaultSize, partialExtents: Optional[List[int]]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_DeleteRange, "DeleteRange(range : RichTextRange) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_GetTextForRange, "GetTextForRange(range : RichTextRange) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_ImportFromXML, "ImportFromXML(buffer : RichTextBuffer, node : XmlNode, handler : RichTextXMLHandler, recurse : bool) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_FindPosition, "FindPosition(dc : wx.DC, context : RichTextDrawingContext, index : int, forceLineStart : bool) -> Tuple[bool, wx.Point, int]\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_CalculateRange, "CalculateRange(start : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_GetSelection, "GetSelection(start : int, end : int) -> RichTextSelection\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_EditProperties, "EditProperties(parent : wx.Window, buffer : RichTextBuffer) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_GetCell, "GetCell(row : int, col : int) -> RichTextCell\n"
"GetCell(pos : int) -> RichTextCell\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_GetCellRowColumnPosition, "GetCellRowColumnPosition(pos : int, row : int, col : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_CreateTable, "CreateTable(rows : int, cols : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_SetCellStyle, "SetCellStyle(selection : RichTextSelection, style : RichTextAttr, flags: int=RICHTEXT_SETSTYLE_WITH_UNDO) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_DeleteRows, "DeleteRows(startRow : int, noRows: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_DeleteColumns, "DeleteColumns(startCol : int, noCols: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_AddRows, "AddRows(startRow : int, noRows: int=1, attr: RichTextAttr=RichTextAttr()) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_AddColumns, "AddColumns(startCol : int, noCols: int=1, attr: RichTextAttr=RichTextAttr()) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextTable_Copy, "Copy(obj : RichTextTable) -> None");
...
PyDoc_STRVAR(doc_wxRichTextTable, "RichTextTable(parent: Optional[RichTextObject]=None) -> None\n"
