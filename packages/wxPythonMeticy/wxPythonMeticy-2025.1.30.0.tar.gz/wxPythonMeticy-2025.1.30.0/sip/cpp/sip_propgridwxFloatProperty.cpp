...
PyDoc_STRVAR(doc_wxFloatProperty_ValueToString, "ValueToString(value : PGVariant, argFlags: int=0) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxFloatProperty_StringToValue, "StringToValue(text : str, argFlags: int=0) -> Tuple[bool, PGVariant]\n"
"\n"
...
PyDoc_STRVAR(doc_wxFloatProperty_DoSetAttribute, "DoSetAttribute(name : str, value : PGVariant) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFloatProperty_ValidateValue, "ValidateValue(value : PGVariant, validationInfo : PGValidationInfo) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxFloatProperty_AddSpinStepValue, "AddSpinStepValue(stepScale : int) -> PGVariant\n"
"\n"
...
PyDoc_STRVAR(doc_wxFloatProperty, "FloatProperty(label: str=PG_LABEL, name: str=PG_LABEL, value: float=0.0) -> None\n"
"\n"
