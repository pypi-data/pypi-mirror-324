...
PyDoc_STRVAR(doc_wxGridSizer_SetCols, "SetCols(cols : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridSizer_SetHGap, "SetHGap(gap : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridSizer_SetRows, "SetRows(rows : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridSizer_SetVGap, "SetVGap(gap : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridSizer_RepositionChildren, "RepositionChildren(minSize : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridSizer, "GridSizer(cols : int, vgap : int, hgap : int) -> None\n"
"GridSizer(cols : int, gap: Size=Size(0,0)) -> None\n"
"GridSizer(rows : int, cols : int, vgap : int, hgap : int) -> None\n"
"GridSizer(rows : int, cols : int, gap : Size) -> None\n"
"\n"
