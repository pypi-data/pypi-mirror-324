...
PyDoc_STRVAR(doc__ScrolledWindowBase_CalcScrolledPosition, "CalcScrolledPosition(x : int, y : int) -> Tuple[int, int]\n"
"CalcScrolledPosition(pt : Point) -> Point\n"
"\n"
...
PyDoc_STRVAR(doc__ScrolledWindowBase_CalcUnscrolledPosition, "CalcUnscrolledPosition(x : int, y : int) -> Tuple[int, int]\n"
"CalcUnscrolledPosition(pt : Point) -> Point\n"
"\n"
...
PyDoc_STRVAR(doc__ScrolledWindowBase_Create, "Create(parent : Window, id: int=-1, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=HSCROLL|VSCROLL, name: str=\"scrolledWindow\") -> bool\n"
"\n"
...
PyDoc_STRVAR(doc__ScrolledWindowBase_DoPrepareDC, "DoPrepareDC(dc : DC) -> None\n"
"\n"
...
PyDoc_STRVAR(doc__ScrolledWindowBase_EnableScrolling, "EnableScrolling(xScrolling : bool, yScrolling : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc__ScrolledWindowBase_ShowScrollbars, "ShowScrollbars(horz : ScrollbarVisibility, vert : ScrollbarVisibility) -> None\n"
"\n"
...
PyDoc_STRVAR(doc__ScrolledWindowBase_OnDraw, "OnDraw(dc : DC) -> None\n"
"\n"
...
PyDoc_STRVAR(doc__ScrolledWindowBase_PrepareDC, "PrepareDC(dc : DC) -> None\n"
"\n"
...
PyDoc_STRVAR(doc__ScrolledWindowBase_Scroll, "Scroll(x : int, y : int) -> None\n"
"Scroll(pt : Point) -> None\n"
"\n"
...
PyDoc_STRVAR(doc__ScrolledWindowBase_SetScrollRate, "SetScrollRate(xstep : int, ystep : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc__ScrolledWindowBase_SetScrollbars, "SetScrollbars(pixelsPerUnitX : int, pixelsPerUnitY : int, noUnitsX : int, noUnitsY : int, xPos: int=0, yPos: int=0, noRefresh: bool=False) -> None\n"
"\n"
...
PyDoc_STRVAR(doc__ScrolledWindowBase_SetTargetWindow, "SetTargetWindow(window : Window) -> None\n"
"\n"
...
PyDoc_STRVAR(doc__ScrolledWindowBase_SetTargetRect, "SetTargetRect(rect : Rect) -> None");
...
PyDoc_STRVAR(doc__ScrolledWindowBase_GetScrollPageSize, "GetScrollPageSize(orient : int) -> int");
...
PyDoc_STRVAR(doc__ScrolledWindowBase_SetScrollPageSize, "SetScrollPageSize(orient : int, pageSize : int) -> None");
...
PyDoc_STRVAR(doc__ScrolledWindowBase_GetScrollLines, "GetScrollLines(orient : int) -> int");
...
PyDoc_STRVAR(doc__ScrolledWindowBase_SetScale, "SetScale(xs : float, ys : float) -> None");
...
PyDoc_STRVAR(doc__ScrolledWindowBase_SendAutoScrollEvents, "SendAutoScrollEvents(event : ScrollWinEvent) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc__ScrolledWindowBase_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
PyDoc_STRVAR(doc__ScrolledWindowBase_ShouldScrollToChildOnFocus, "ShouldScrollToChildOnFocus(child : Window) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc__ScrolledWindowBase_GetSizeAvailableForScrollTarget, "GetSizeAvailableForScrollTarget(size : Size) -> Size\n"
"\n"
...
"Scrolled(parent : Window, id: int=-1, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=HSCROLL|VSCROLL, name: str=\"scrolledWindow\") -> None\n"
"\n"
