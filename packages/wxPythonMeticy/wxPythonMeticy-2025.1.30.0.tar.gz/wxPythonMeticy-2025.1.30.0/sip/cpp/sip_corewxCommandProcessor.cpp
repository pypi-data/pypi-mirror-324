...
PyDoc_STRVAR(doc_wxCommandProcessor_SetEditMenu, "SetEditMenu(menu : Menu) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxCommandProcessor_SetRedoAccelerator, "SetRedoAccelerator(accel : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxCommandProcessor_SetUndoAccelerator, "SetUndoAccelerator(accel : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxCommandProcessor_Submit, "Submit(command : Command, storeIt: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxCommandProcessor_Store, "Store(command : Command) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxCommandProcessor, "CommandProcessor(maxCommands: int=-1) -> None\n"
"\n"
