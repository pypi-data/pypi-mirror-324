...
PyDoc_STRVAR(doc_wxPGCellData_SetText, "SetText(text : str) -> None");
...
PyDoc_STRVAR(doc_wxPGCellData_SetBitmap, "SetBitmap(bitmap : wx.BitmapBundle) -> None");
...
PyDoc_STRVAR(doc_wxPGCellData_SetFgCol, "SetFgCol(col : wx.Colour) -> None");
...
PyDoc_STRVAR(doc_wxPGCellData_SetBgCol, "SetBgCol(col : wx.Colour) -> None");
...
PyDoc_STRVAR(doc_wxPGCellData_SetFont, "SetFont(font : wx.Font) -> None");
