...
PyDoc_STRVAR(doc_wxRichTextObject_Draw, "Draw(dc : wx.DC, context : RichTextDrawingContext, range : RichTextRange, selection : RichTextSelection, rect : wx.Rect, descent : int, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_Layout, "Layout(dc : wx.DC, context : RichTextDrawingContext, rect : wx.Rect, parentRect : wx.Rect, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_HitTest, "HitTest(dc : wx.DC, context : RichTextDrawingContext, pt : wx.Point, flags: int=0) -> Tuple[int, int, RichTextObject, RichTextObject]\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_FindPosition, "FindPosition(dc : wx.DC, context : RichTextDrawingContext, index : int, forceLineStart : bool) -> Tuple[bool, wx.Point, int]\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_GetRangeSize, "GetRangeSize(range : RichTextRange, size : wx.Size, descent : int, dc : wx.DC, context : RichTextDrawingContext, flags : int, position: wx.Point=wx.Point(0,0), parentSize: wx.Size=wx.DefaultSize, partialExtents: Optional[List[int]]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_DoSplit, "DoSplit(pos : int) -> RichTextObject\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_CalculateRange, "CalculateRange(start : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_DeleteRange, "DeleteRange(range : RichTextRange) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_GetTextForRange, "GetTextForRange(range : RichTextRange) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_CanMerge, "CanMerge(object : RichTextObject, context : RichTextDrawingContext) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_Merge, "Merge(object : RichTextObject, context : RichTextDrawingContext) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_CanSplit, "CanSplit(context : RichTextDrawingContext) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_Split, "Split(context : RichTextDrawingContext) -> RichTextObject\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_EditProperties, "EditProperties(parent : wx.Window, buffer : RichTextBuffer) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_ImportFromXML, "ImportFromXML(buffer : RichTextBuffer, node : XmlNode, handler : RichTextXMLHandler, recurse : bool) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_Invalidate, "Invalidate(invalidRange: RichTextRange=RICHTEXT_ALL) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_GetSelection, "GetSelection(start : int, end : int) -> RichTextSelection\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_SetCachedSize, "SetCachedSize(sz : wx.Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_SetMaxSize, "SetMaxSize(sz : wx.Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_SetMinSize, "SetMinSize(sz : wx.Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_SetPosition, "SetPosition(pos : wx.Point) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_SetRange, "SetRange(range : RichTextRange) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_SetOwnRange, "SetOwnRange(range : RichTextRange) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_SetParent, "SetParent(parent : RichTextObject) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_SetMargins, "SetMargins(margin : int) -> None\n"
"SetMargins(leftMargin : int, rightMargin : int, topMargin : int, bottomMargin : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_GetAvailableContentArea, "GetAvailableContentArea(dc : wx.DC, context : RichTextDrawingContext, outerRect : wx.Rect) -> wx.Rect\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_LayoutToBestSize, "LayoutToBestSize(dc : wx.DC, context : RichTextDrawingContext, buffer : RichTextBuffer, parentAttr : RichTextAttr, attr : RichTextAttr, availableParentSpace : wx.Rect, availableContainerSpace : wx.Rect, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_AdjustAttributes, "AdjustAttributes(attr : RichTextAttr, context : RichTextDrawingContext) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_SetAttributes, "SetAttributes(attr : RichTextAttr) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_SetProperties, "SetProperties(props : RichTextProperties) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_SetDescent, "SetDescent(descent : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_SetName, "SetName(name : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_Show, "Show(show : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_Copy, "Copy(obj : RichTextObject) -> None\n"
"\n"
"Copies the object.");
...
PyDoc_STRVAR(doc_wxRichTextObject_Move, "Move(pt : wx.Point) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_ConvertTenthsMMToPixels, "ConvertTenthsMMToPixels(dc : wx.DC, units : int) -> int\n"
"ConvertTenthsMMToPixels(ppi : int, units : int, scale: float=1.0) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_ConvertPixelsToTenthsMM, "ConvertPixelsToTenthsMM(dc : wx.DC, pixels : int) -> int\n"
"ConvertPixelsToTenthsMM(ppi : int, pixels : int, scale: float=1.0) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_DrawBoxAttributes, "DrawBoxAttributes(dc : wx.DC, buffer : RichTextBuffer, attr : RichTextAttr, boxRect : wx.Rect, flags: int=0, obj: Optional[RichTextObject]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_DrawBorder, "DrawBorder(dc : wx.DC, buffer : RichTextBuffer, attr : RichTextAttr, borders : TextAttrBorders, rect : wx.Rect, flags: int=0) -> bool\n"
"\n"
"Draws a border.");
...
PyDoc_STRVAR(doc_wxRichTextObject_GetBoxRects, "GetBoxRects(dc : wx.DC, buffer : RichTextBuffer, attr : RichTextAttr) -> Tuple[bool, wx.Rect, wx.Rect, wx.Rect, wx.Rect, wx.Rect]\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_GetTotalMargin, "GetTotalMargin(dc : wx.DC, buffer : RichTextBuffer, attr : RichTextAttr) -> Tuple[bool, int, int, int, int]\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject_AdjustAvailableSpace, "AdjustAvailableSpace(dc : wx.DC, buffer : RichTextBuffer, parentAttr : RichTextAttr, childAttr : RichTextAttr, availableParentSpace : wx.Rect, availableContainerSpace : wx.Rect) -> wx.Rect\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObject, "RichTextObject(parent: Optional[RichTextObject]=None) -> None\n"
"\n"
