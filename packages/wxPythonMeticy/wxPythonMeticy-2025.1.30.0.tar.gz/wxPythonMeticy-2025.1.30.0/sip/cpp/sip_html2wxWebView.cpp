...
PyDoc_STRVAR(doc_wxWebView_RunScript, "RunScript(javascript : str) -> Tuple[bool, str]\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_RunScriptAsync, "RunScriptAsync(javascript : str, clientData: Optional[Any]=None) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_AddScriptMessageHandler, "AddScriptMessageHandler(name : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_RemoveScriptMessageHandler, "RemoveScriptMessageHandler(name : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_AddUserScript, "AddUserScript(javascript : str, injectionTime: WebViewUserScriptInjectionTime=WEBVIEW_INJECT_AT_DOCUMENT_START) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_EnableContextMenu, "EnableContextMenu(enable: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_EnableAccessToDevTools, "EnableAccessToDevTools(enable: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_SetUserAgent, "SetUserAgent(userAgent : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_EnableHistory, "EnableHistory(enable: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_Find, "Find(text : str, flags: WebViewFindFlags=WEBVIEW_FIND_DEFAULT) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_CanSetZoomType, "CanSetZoomType(type : WebViewZoomType) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_SetZoom, "SetZoom(zoom : WebViewZoom) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_SetZoomFactor, "SetZoomFactor(zoom : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_SetZoomType, "SetZoomType(zoomType : WebViewZoomType) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_Create, "Create(parent : wx.Window, id: int=wx.ID_ANY, url: str=WebViewDefaultURLStr, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=0, name: str=WebViewNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_LoadURL, "LoadURL(url : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_RegisterHandler, "RegisterHandler(handler : WebViewHandler) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_Reload, "Reload(flags: WebViewReloadFlags=WEBVIEW_RELOAD_DEFAULT) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_SetEditable, "SetEditable(enable: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_SetPage, "SetPage(html : str, baseUrl : str) -> None\n"
"SetPage(html : wx.InputStream, baseUrl : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_New, "New(backend: str=WebViewBackendDefault) -> WebView\n"
"New(parent : wx.Window, id: int=wx.ID_ANY, url: str=WebViewDefaultURLStr, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, backend: str=WebViewBackendDefault, style: int=0, name: str=WebViewNameStr) -> WebView\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_RegisterFactory, "RegisterFactory(backend : str, factory : WebViewFactory) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_IsBackendAvailable, "IsBackendAvailable(backend : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_GetBackendVersionInfo, "GetBackendVersionInfo(backend: str=WebViewBackendDefault) -> wx.VersionInfo\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
...
PyDoc_STRVAR(doc_wxWebView_MSWSetEmulationLevel, "MSWSetEmulationLevel(level: WebViewIE_EmulationLevel=WEBVIEWIE_EMU_IE11) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebView_MSWSetModernEmulationLevel, "MSWSetModernEmulationLevel(modernLevel: bool=True) -> bool");
