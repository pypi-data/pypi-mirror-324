...
PyDoc_STRVAR(doc_wxMouseState_SetX, "SetX(x : int) -> None");
...
PyDoc_STRVAR(doc_wxMouseState_SetY, "SetY(y : int) -> None");
...
PyDoc_STRVAR(doc_wxMouseState_SetPosition, "SetPosition(pos : Point) -> None");
...
PyDoc_STRVAR(doc_wxMouseState_SetLeftDown, "SetLeftDown(down : bool) -> None");
...
PyDoc_STRVAR(doc_wxMouseState_SetMiddleDown, "SetMiddleDown(down : bool) -> None");
...
PyDoc_STRVAR(doc_wxMouseState_SetRightDown, "SetRightDown(down : bool) -> None");
...
PyDoc_STRVAR(doc_wxMouseState_SetAux1Down, "SetAux1Down(down : bool) -> None");
...
PyDoc_STRVAR(doc_wxMouseState_SetAux2Down, "SetAux2Down(down : bool) -> None");
...
PyDoc_STRVAR(doc_wxMouseState_SetState, "SetState(state : MouseState) -> None");
