...
PyDoc_STRVAR(doc_wxGridBlockCoords_SetTopRow, "SetTopRow(row : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBlockCoords_SetLeftCol, "SetLeftCol(col : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBlockCoords_SetBottomRow, "SetBottomRow(row : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBlockCoords_SetRightCol, "SetRightCol(col : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBlockCoords_Intersects, "Intersects(other : GridBlockCoords) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBlockCoords_Contains, "Contains(cell : GridCellCoords) -> bool\n"
...
PyDoc_STRVAR(doc_wxGridBlockCoords_Difference, "Difference(other : GridBlockCoords, splitOrientation : int) -> GridBlockDiffResult\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridBlockCoords_SymDifference, "SymDifference(other : GridBlockCoords) -> GridBlockDiffResult\n"
"\n"
