...
PyDoc_STRVAR(doc_wxTextCompleterSimple_GetCompletions, "GetCompletions(prefix : str) -> List[str]\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextCompleterSimple_Start, "Start(prefix : str) -> bool\n"
"\n"
