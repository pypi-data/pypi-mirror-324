...
PyDoc_STRVAR(doc_wxBitmapDataObject_SetBitmap, "SetBitmap(bitmap : Bitmap) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapDataObject_SetData, "SetData(format: DataFormat, buf: PyBuffer) -> bool\n"
"");
...
PyDoc_STRVAR(doc_wxBitmapDataObject, "BitmapDataObject(bitmap: Bitmap=NullBitmap) -> None\n"
"\n"
