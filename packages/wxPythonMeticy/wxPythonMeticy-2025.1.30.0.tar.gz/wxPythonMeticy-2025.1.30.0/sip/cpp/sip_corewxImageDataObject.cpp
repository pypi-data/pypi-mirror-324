...
PyDoc_STRVAR(doc_wxImageDataObject_SetImage, "SetImage(image : Image) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageDataObject_SetData, "SetData(format: DataFormat, buf: PyBuffer) -> bool");
...
PyDoc_STRVAR(doc_wxImageDataObject, "ImageDataObject(image: Image=NullImage) -> None\n"
"\n"
