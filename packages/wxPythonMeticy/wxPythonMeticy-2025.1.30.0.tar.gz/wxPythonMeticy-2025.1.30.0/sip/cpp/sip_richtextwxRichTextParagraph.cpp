...
PyDoc_STRVAR(doc_wxRichTextParagraph_Draw, "Draw(dc : wx.DC, context : RichTextDrawingContext, range : RichTextRange, selection : RichTextSelection, rect : wx.Rect, descent : int, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_Layout, "Layout(dc : wx.DC, context : RichTextDrawingContext, rect : wx.Rect, parentRect : wx.Rect, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_GetRangeSize, "GetRangeSize(range : RichTextRange, size : wx.Size, descent : int, dc : wx.DC, context : RichTextDrawingContext, flags : int, position: wx.Point=wx.Point(0,0), parentSize: wx.Size=wx.DefaultSize, partialExtents: Optional[List[int]]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_FindPosition, "FindPosition(dc : wx.DC, context : RichTextDrawingContext, index : int, forceLineStart : bool) -> Tuple[bool, wx.Point, int]\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_HitTest, "HitTest(dc : wx.DC, context : RichTextDrawingContext, pt : wx.Point, flags: int=0) -> Tuple[int, int, RichTextObject, RichTextObject]\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_CalculateRange, "CalculateRange(start : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_Copy, "Copy(obj : RichTextParagraph) -> None\n"
"\n"
"Copies the object.");
...
PyDoc_STRVAR(doc_wxRichTextParagraph_ApplyParagraphStyle, "ApplyParagraphStyle(line : RichTextLine, attr : RichTextAttr, rect : wx.Rect, dc : wx.DC) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_InsertText, "InsertText(pos : int, text : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_SplitAt, "SplitAt(pos : int, previousObject: Optional[RichTextObject]=None) -> RichTextObject\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_MoveToList, "MoveToList(obj : RichTextObject, list : RichTextObjectList_) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_MoveFromList, "MoveFromList(list : RichTextObjectList_) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_GetContiguousPlainText, "GetContiguousPlainText(text : str, range : RichTextRange, fromStart: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_FindWrapPosition, "FindWrapPosition(range : RichTextRange, dc : wx.DC, context : RichTextDrawingContext, availableSpace : int, wrapPosition : int, partialExtents : List[int]) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_FindObjectAtPosition, "FindObjectAtPosition(position : int) -> RichTextObject\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_AllocateLine, "AllocateLine(pos : int) -> RichTextLine\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_ClearUnusedLines, "ClearUnusedLines(lineCount : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_GetCombinedAttributes, "GetCombinedAttributes(contentStyle : RichTextAttr, includingBoxAttr: bool=False) -> RichTextAttr\n"
"GetCombinedAttributes(includingBoxAttr: bool=False) -> RichTextAttr\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_GetFirstLineBreakPosition, "GetFirstLineBreakPosition(pos : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_LayoutFloat, "LayoutFloat(dc : wx.DC, context : RichTextDrawingContext, rect : wx.Rect, parentRect : wx.Rect, style : int, floatCollector : RichTextFloatCollector) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph_SetImpactedByFloatingObjects, "SetImpactedByFloatingObjects(i : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextParagraph, "RichTextParagraph(parent: Optional[RichTextObject]=None, style: Optional[RichTextAttr]=None) -> None\n"
"RichTextParagraph(text : str, parent: Optional[RichTextObject]=None, paraStyle: Optional[RichTextAttr]=None, charStyle: Optional[RichTextAttr]=None) -> None\n"
