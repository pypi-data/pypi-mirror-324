...
PyDoc_STRVAR(doc_wxRichTextContextMenuPropertiesInfo_AddItem, "AddItem(label : str, obj : RichTextObject) -> bool\n"
"\n"
"Adds an item.");
...
PyDoc_STRVAR(doc_wxRichTextContextMenuPropertiesInfo_AddMenuItems, "AddMenuItems(menu : wx.Menu, startCmd: int=ID_RICHTEXT_PROPERTIES1) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextContextMenuPropertiesInfo_AddItems, "AddItems(ctrl : RichTextCtrl, container : RichTextObject, obj : RichTextObject) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextContextMenuPropertiesInfo_GetLabel, "GetLabel(n : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextContextMenuPropertiesInfo_GetObject, "GetObject(n : int) -> RichTextObject\n"
"\n"
