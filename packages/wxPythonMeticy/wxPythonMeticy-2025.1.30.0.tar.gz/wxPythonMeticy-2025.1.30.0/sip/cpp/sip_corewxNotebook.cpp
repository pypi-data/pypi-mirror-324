...
PyDoc_STRVAR(doc_wxNotebook_Create, "Create(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=NotebookNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotebook_SetPadding, "SetPadding(padding : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotebook_GetPageImage, "GetPageImage(nPage : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotebook_SetPageImage, "SetPageImage(page : int, image : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotebook_GetPageText, "GetPageText(nPage : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotebook_SetPageText, "SetPageText(page : int, text : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotebook_SetSelection, "SetSelection(page : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotebook_ChangeSelection, "ChangeSelection(page : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotebook_InsertPage, "InsertPage(index : int, page : Window, text : str, select: bool=False, imageId: int=NO_IMAGE) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotebook_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"Notebook(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=NotebookNameStr) -> None\n"
"\n"
