...
PyDoc_STRVAR(doc_wxRibbonArtProvider_SetFlags, "SetFlags(flags : int) -> None\n"
"\n"
"Set the style flags.");
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetMetric, "GetMetric(id : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_SetMetric, "SetMetric(id : int, new_val : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_SetFont, "SetFont(id : int, font : wx.Font) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetFont, "GetFont(id : int) -> wx.Font\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetColour, "GetColour(id : int) -> wx.Colour\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_SetColour, "SetColour(id : int, colour : wx.Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetColor, "GetColor(id : int) -> wx.Colour");
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_SetColor, "SetColor(id : int, color : wx.Colour) -> None");
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_SetColourScheme, "SetColourScheme(primary : wx.Colour, secondary : wx.Colour, tertiary : wx.Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawTabCtrlBackground, "DrawTabCtrlBackground(dc : wx.DC, wnd : wx.Window, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawTab, "DrawTab(dc : wx.DC, wnd : wx.Window, tab : RibbonPageTabInfo) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawTabSeparator, "DrawTabSeparator(dc : wx.DC, wnd : wx.Window, rect : wx.Rect, visibility : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawPageBackground, "DrawPageBackground(dc : wx.DC, wnd : wx.Window, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawScrollButton, "DrawScrollButton(dc : wx.DC, wnd : wx.Window, rect : wx.Rect, style : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawPanelBackground, "DrawPanelBackground(dc : wx.DC, wnd : RibbonPanel, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawGalleryBackground, "DrawGalleryBackground(dc : wx.DC, wnd : RibbonGallery, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawGalleryItemBackground, "DrawGalleryItemBackground(dc : wx.DC, wnd : RibbonGallery, rect : wx.Rect, item : RibbonGalleryItem) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawMinimisedPanel, "DrawMinimisedPanel(dc : wx.DC, wnd : RibbonPanel, rect : wx.Rect, bitmap : wx.Bitmap) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawButtonBarBackground, "DrawButtonBarBackground(dc : wx.DC, wnd : wx.Window, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawButtonBarButton, "DrawButtonBarButton(dc : wx.DC, wnd : wx.Window, rect : wx.Rect, kind : RibbonButtonKind, state : int, label : str, bitmap_large : wx.Bitmap, bitmap_small : wx.Bitmap) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawToolBarBackground, "DrawToolBarBackground(dc : wx.DC, wnd : wx.Window, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawToolGroupBackground, "DrawToolGroupBackground(dc : wx.DC, wnd : wx.Window, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawTool, "DrawTool(dc : wx.DC, wnd : wx.Window, rect : wx.Rect, bitmap : wx.Bitmap, kind : RibbonButtonKind, state : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawToggleButton, "DrawToggleButton(dc : wx.DC, wnd : RibbonBar, rect : wx.Rect, mode : RibbonDisplayMode) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_DrawHelpButton, "DrawHelpButton(dc : wx.DC, wnd : RibbonBar, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetBarTabWidth, "GetBarTabWidth(dc : wx.DC, wnd : wx.Window, label : str, bitmap : wx.Bitmap, ideal : int, small_begin_need_separator : int, small_must_have_separator : int, minimum : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetTabCtrlHeight, "GetTabCtrlHeight(dc : wx.DC, wnd : wx.Window, pages : RibbonPageTabInfoArray) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetScrollButtonMinimumSize, "GetScrollButtonMinimumSize(dc : wx.DC, wnd : wx.Window, style : int) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetPanelSize, "GetPanelSize(dc : wx.DC, wnd : RibbonPanel, client_size : wx.Size, client_offset : wx.Point) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetPanelClientSize, "GetPanelClientSize(dc : wx.DC, wnd : RibbonPanel, size : wx.Size, client_offset : wx.Point) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetPanelExtButtonArea, "GetPanelExtButtonArea(dc : wx.DC, wnd : RibbonPanel, rect : wx.Rect) -> wx.Rect\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetGallerySize, "GetGallerySize(dc : wx.DC, wnd : RibbonGallery, client_size : wx.Size) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetGalleryClientSize, "GetGalleryClientSize(dc : wx.DC, wnd : RibbonGallery, size : wx.Size, client_offset : wx.Point, scroll_up_button : wx.Rect, scroll_down_button : wx.Rect, extension_button : wx.Rect) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetPageBackgroundRedrawArea, "GetPageBackgroundRedrawArea(dc : wx.DC, wnd : RibbonPage, page_old_size : wx.Size, page_new_size : wx.Size) -> wx.Rect\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetButtonBarButtonSize, "GetButtonBarButtonSize(dc : wx.DC, wnd : wx.Window, kind : RibbonButtonKind, size : RibbonButtonBarButtonState, label : str, text_min_width : int, bitmap_size_large : wx.Size, bitmap_size_small : wx.Size, button_size : wx.Size, normal_region : wx.Rect, dropdown_region : wx.Rect) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetButtonBarButtonTextWidth, "GetButtonBarButtonTextWidth(dc : wx.DC, label : str, kind : RibbonButtonKind, size : RibbonButtonBarButtonState) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetMinimisedPanelMinimumSize, "GetMinimisedPanelMinimumSize(dc : wx.DC, wnd : RibbonPanel, desired_bitmap_size : wx.Size, expanded_panel_direction : wx.Direction) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetToolSize, "GetToolSize(dc : wx.DC, wnd : wx.Window, bitmap_size : wx.Size, kind : RibbonButtonKind, is_first : bool, is_last : bool, dropdown_region : wx.Rect) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetBarToggleButtonArea, "GetBarToggleButtonArea(rect : wx.Rect) -> wx.Rect\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonArtProvider_GetRibbonHelpButtonArea, "GetRibbonHelpButtonArea(rect : wx.Rect) -> wx.Rect\n"
"\n"
