...
PyDoc_STRVAR(doc_wxRibbonBar_DoGetNextSmallerSize, "DoGetNextSmallerSize(direction : wx.Orientation, relative_to : wx.Size) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_DoGetNextLargerSize, "DoGetNextLargerSize(direction : wx.Orientation, relative_to : wx.Size) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_Create, "Create(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=RIBBON_BAR_DEFAULT_STYLE) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_SetTabCtrlMargins, "SetTabCtrlMargins(left : int, right : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_SetArtProvider, "SetArtProvider(art : RibbonArtProvider) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_SetActivePage, "SetActivePage(page : int) -> bool\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_GetPage, "GetPage(n : int) -> RibbonPage\n"
"\n"
"Get a page by index.");
...
PyDoc_STRVAR(doc_wxRibbonBar_GetPageNumber, "GetPageNumber(page : RibbonPage) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_DeletePage, "DeletePage(n : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_IsPageShown, "IsPageShown(page : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_ShowPage, "ShowPage(page : int, show_tab: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_HidePage, "HidePage(page : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_IsPageHighlighted, "IsPageHighlighted(page : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_AddPageHighlight, "AddPageHighlight(page : int, highlight: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_RemovePageHighlight, "RemovePageHighlight(page : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_ShowPanels, "ShowPanels(mode : RibbonDisplayMode) -> None\n"
...
PyDoc_STRVAR(doc_wxRibbonBar_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
