...
PyDoc_STRVAR(doc_wxRibbonToolBar_DoGetNextSmallerSize, "DoGetNextSmallerSize(direction : wx.Orientation, relative_to : wx.Size) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_DoGetNextLargerSize, "DoGetNextLargerSize(direction : wx.Orientation, relative_to : wx.Size) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_Create, "Create(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=0) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_AddTool, "AddTool(tool_id : int, bitmap : wx.Bitmap, help_string : str, kind: RibbonButtonKind=RIBBON_BUTTON_NORMAL) -> RibbonToolBarToolBase\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_AddDropdownTool, "AddDropdownTool(tool_id : int, bitmap : wx.Bitmap, help_string: str='') -> RibbonToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_AddHybridTool, "AddHybridTool(tool_id : int, bitmap : wx.Bitmap, help_string: str='') -> RibbonToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_AddToggleTool, "AddToggleTool(tool_id : int, bitmap : wx.Bitmap, help_string : str) -> RibbonToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_InsertTool, "InsertTool(pos : int, tool_id : int, bitmap : wx.Bitmap, help_string : str, kind: RibbonButtonKind=RIBBON_BUTTON_NORMAL) -> RibbonToolBarToolBase\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_InsertDropdownTool, "InsertDropdownTool(pos : int, tool_id : int, bitmap : wx.Bitmap, help_string: str='') -> RibbonToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_InsertHybridTool, "InsertHybridTool(pos : int, tool_id : int, bitmap : wx.Bitmap, help_string: str='') -> RibbonToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_InsertToggleTool, "InsertToggleTool(pos : int, tool_id : int, bitmap : wx.Bitmap, help_string: str='') -> RibbonToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_InsertSeparator, "InsertSeparator(pos : int) -> RibbonToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_DeleteTool, "DeleteTool(tool_id : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_DeleteToolByPos, "DeleteToolByPos(pos : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_FindById, "FindById(tool_id : int) -> RibbonToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_GetToolByPos, "GetToolByPos(pos : int) -> RibbonToolBarToolBase\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_GetToolId, "GetToolId(tool : RibbonToolBarToolBase) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_GetToolClientData, "GetToolClientData(tool_id : int) -> PyUserData\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_GetToolEnabled, "GetToolEnabled(tool_id : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_GetToolHelpString, "GetToolHelpString(tool_id : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_GetToolKind, "GetToolKind(tool_id : int) -> RibbonButtonKind\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_GetToolPos, "GetToolPos(tool_id : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_GetToolRect, "GetToolRect(tool_id : int) -> wx.Rect\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_GetToolState, "GetToolState(tool_id : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_SetRows, "SetRows(nMin : int, nMax: int=-1) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_SetToolClientData, "SetToolClientData(tool_id : int, clientData : PyUserData) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_SetToolDisabledBitmap, "SetToolDisabledBitmap(tool_id : int, bitmap : wx.Bitmap) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_SetToolHelpString, "SetToolHelpString(tool_id : int, helpString : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_SetToolNormalBitmap, "SetToolNormalBitmap(tool_id : int, bitmap : wx.Bitmap) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_EnableTool, "EnableTool(tool_id : int, enable: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_ToggleTool, "ToggleTool(tool_id : int, checked : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRibbonToolBar_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
