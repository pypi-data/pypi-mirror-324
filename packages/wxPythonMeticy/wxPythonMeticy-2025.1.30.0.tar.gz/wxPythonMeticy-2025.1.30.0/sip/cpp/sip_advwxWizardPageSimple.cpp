...
PyDoc_STRVAR(doc_wxWizardPageSimple_Create, "Create(parent: Optional[Wizard]=None, prev: Optional[WizardPage]=None, next: Optional[WizardPage]=None, bitmap: wx.BitmapBundle=wx.BitmapBundle()) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxWizardPageSimple_Chain, "Chain(next : WizardPageSimple) -> WizardPageSimple\n"
...
PyDoc_STRVAR(doc_wxWizardPageSimple_SetNext, "SetNext(next : WizardPage) -> None\n"
"\n"
"Sets the next page.");
...
PyDoc_STRVAR(doc_wxWizardPageSimple_SetPrev, "SetPrev(prev : WizardPage) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWizardPageSimple_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
