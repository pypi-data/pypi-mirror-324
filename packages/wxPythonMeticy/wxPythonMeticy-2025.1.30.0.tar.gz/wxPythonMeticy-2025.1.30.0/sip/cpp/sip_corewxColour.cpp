...
PyDoc_STRVAR(doc_wxColour_SetRGB, "SetRGB(colRGB : Uint32) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxColour_SetRGBA, "SetRGBA(colRGBA : Uint32) -> None\n"
"\n"
"Sets the RGB or RGBA colour values from a single 32 bit value.");
...
PyDoc_STRVAR(doc_wxColour_Set, "Set(red : int, green : int, blue : int, alpha: int=ALPHA_OPAQUE) -> None\n"
"Set(RGB : int) -> None\n"
"Set(str : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxColour_GetAsString, "GetAsString(flags: int=C2S_NAME|C2S_CSS_SYNTAX) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxColour_MakeDisabled, "MakeDisabled(brightness: int=255) -> Colour\n"
"MakeDisabled(r : int, g : int, b : int, brightness: int=255) -> Tuple[int, int, int]\n"
"\n"
...
PyDoc_STRVAR(doc_wxColour_ChangeLightness, "ChangeLightness(ialpha : int) -> Colour\n"
"ChangeLightness(r : int, g : int, b : int, ialpha : int) -> Tuple[int, int, int]\n"
"\n"
...
PyDoc_STRVAR(doc_wxColour_MakeMono, "MakeMono(on : bool) -> Tuple[int, int, int]\n"
"\n"
...
PyDoc_STRVAR(doc_wxColour_MakeGrey, "MakeGrey(r : int, g : int, b : int) -> Tuple[int, int, int]\n"
"MakeGrey(r : int, g : int, b : int, weight_r : float, weight_g : float, weight_b : float) -> Tuple[int, int, int]\n"
"\n"
...
PyDoc_STRVAR(doc_wxColour_AlphaBlend, "AlphaBlend(fg : int, bg : int, alpha : float) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxColour__copyFrom, "_copyFrom(other: Colour) -> None\n"
"\n"
...
"Colour(red : int, green : int, blue : int, alpha: int=ALPHA_OPAQUE) -> None\n"
