...
PyDoc_STRVAR(doc_wxHtmlPrintout_SetFonts, "SetFonts(normal_face : str, fixed_face : str, sizes : List[int]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlPrintout_SetFooter, "SetFooter(footer : str, pg: int=PAGE_ALL) -> None\n"
"\n"
"Set page footer.");
...
PyDoc_STRVAR(doc_wxHtmlPrintout_SetHeader, "SetHeader(header : str, pg: int=PAGE_ALL) -> None\n"
"\n"
"Set page header.");
...
PyDoc_STRVAR(doc_wxHtmlPrintout_SetHtmlFile, "SetHtmlFile(htmlfile : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlPrintout_SetHtmlText, "SetHtmlText(html : str, basepath: str='', isdir: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlPrintout_SetMargins, "SetMargins(top: float=25.2, bottom: float=25.2, left: float=25.2, right: float=25.2, spaces: float=5) -> None\n"
...
PyDoc_STRVAR(doc_wxHtmlPrintout_AddFilter, "AddFilter(filter : HtmlFilter) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlPrintout, "HtmlPrintout(title: str=\"Printout\") -> None\n"
"\n"
