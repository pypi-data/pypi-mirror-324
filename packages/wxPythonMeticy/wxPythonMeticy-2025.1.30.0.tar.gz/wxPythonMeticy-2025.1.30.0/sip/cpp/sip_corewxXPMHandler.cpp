...
PyDoc_STRVAR(doc_wxXPMHandler_DoGetImageCount, "DoGetImageCount(stream : InputStream) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxXPMHandler_LoadFile, "LoadFile(image : Image, stream : InputStream, verbose: bool=True, index: int=-1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXPMHandler_SaveFile, "SaveFile(image : Image, stream : OutputStream, verbose: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXPMHandler_DoCanRead, "DoCanRead(stream : InputStream) -> bool\n"
"\n"
