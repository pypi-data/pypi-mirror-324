...
PyDoc_STRVAR(doc_wxDataViewCheckIconText_SetCheckedState, "SetCheckedState(state : wx.CheckBoxState) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCheckIconText, "DataViewCheckIconText(text: str='', icon: wx.BitmapBundle=wx.BitmapBundle(), checkedState: wx.CheckBoxState=wx.CHK_UNDETERMINED) -> None\n"
