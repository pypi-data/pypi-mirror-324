...
PyDoc_STRVAR(doc_wxSystemColourProperty_IntToValue, "IntToValue(number : int, argFlags: int=0) -> Tuple[bool, PGVariant]\n"
"\n"
...
PyDoc_STRVAR(doc_wxSystemColourProperty_ColourToString, "ColourToString(col : wx.Colour, index : int, argFlags: int=0) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxSystemColourProperty_ValueToString, "ValueToString(value : PGVariant, argFlags: int=0) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxSystemColourProperty_StringToValue, "StringToValue(text : str, argFlags: int=0) -> Tuple[bool, PGVariant]\n"
"\n"
...
PyDoc_STRVAR(doc_wxSystemColourProperty_OnEvent, "OnEvent(propgrid : PropertyGrid, wnd_primary : wx.Window, event : wx.Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSystemColourProperty_DoSetAttribute, "DoSetAttribute(name : str, value : PGVariant) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSystemColourProperty_OnMeasureImage, "OnMeasureImage(item : int) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxSystemColourProperty_OnCustomPaint, "OnCustomPaint(dc : wx.DC, rect : wx.Rect, paintdata : PGPaintData) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSystemColourProperty_QueryColourFromUser, "QueryColourFromUser(variant : PGVariant) -> bool");
...
PyDoc_STRVAR(doc_wxSystemColourProperty_GetColour, "GetColour(index : int) -> wx.Colour\n"
"\n"
...
PyDoc_STRVAR(doc_wxSystemColourProperty_GetVal, "GetVal(pVariant: Optional[PGVariant]=None) -> ColourPropertyValue");
...
PyDoc_STRVAR(doc_wxSystemColourProperty, "SystemColourProperty(label: str=PG_LABEL, name: str=PG_LABEL, value: ColourPropertyValue=ColourPropertyValue()) -> None\n"
"\n"
