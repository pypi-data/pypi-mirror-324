...
PyDoc_STRVAR(doc_wxQueryNewPaletteEvent_SetPaletteRealized, "SetPaletteRealized(realized : bool) -> None");
...
PyDoc_STRVAR(doc_wxQueryNewPaletteEvent, "QueryNewPaletteEvent(winid: int=0) -> None");
