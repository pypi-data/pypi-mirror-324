...
PyDoc_STRVAR(doc_wxBookCtrlEvent_SetOldSelection, "SetOldSelection(page : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlEvent_SetSelection, "SetSelection(page : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlEvent, "BookCtrlEvent(eventType: EventType=wxEVT_NULL, id: int=0, sel: int=NOT_FOUND, oldSel: int=NOT_FOUND) -> None\n"
"\n"
