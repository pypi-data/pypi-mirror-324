...
PyDoc_STRVAR(doc_wxGridCellFloatEditor_SetParameters, "SetParameters(params : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGridCellFloatEditor, "GridCellFloatEditor(width: int=-1, precision: int=-1, format: int=GRID_FLOAT_FORMAT_DEFAULT) -> None\n"
"\n"
