...
PyDoc_STRVAR(doc_wxIcon_CreateFromHICON, "CreateFromHICON(hicon: int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxIcon_CopyFromBitmap, "CopyFromBitmap(bmp : Bitmap) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxIcon_LoadFile, "LoadFile(name : str, type: BitmapType=BITMAP_TYPE_ANY, desiredWidth: int=-1, desiredHeight: int=-1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxIcon_SetDepth, "SetDepth(depth : int) -> None");
...
PyDoc_STRVAR(doc_wxIcon_SetHeight, "SetHeight(height : int) -> None");
...
PyDoc_STRVAR(doc_wxIcon_SetWidth, "SetWidth(width : int) -> None");
...
PyDoc_STRVAR(doc_wxIcon_SetHandle, "SetHandle(handle: int) -> None");
...
"Icon(icon : Icon) -> None\n"
"Icon(name : str, type: BitmapType=BITMAP_TYPE_ANY, desiredWidth: int=-1, desiredHeight: int=-1) -> None\n"
"Icon(loc : IconLocation) -> None\n"
"Icon(bmp: Bitmap) -> None\n"
"\n"
