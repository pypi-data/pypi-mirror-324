...
PyDoc_STRVAR(doc_wxHelpControllerHelpProvider_SetHelpController, "SetHelpController(hc : HelpControllerBase) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHelpControllerHelpProvider, "HelpControllerHelpProvider(hc: Optional[HelpControllerBase]=None) -> None\n"
"\n"
