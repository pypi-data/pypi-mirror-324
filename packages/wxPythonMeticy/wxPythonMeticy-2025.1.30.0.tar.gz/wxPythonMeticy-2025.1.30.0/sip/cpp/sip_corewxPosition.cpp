...
PyDoc_STRVAR(doc_wxPosition_SetCol, "SetCol(column : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPosition_SetColumn, "SetColumn(column : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPosition_SetRow, "SetRow(row : int) -> None\n"
"\n"
"Set a new row value.");
