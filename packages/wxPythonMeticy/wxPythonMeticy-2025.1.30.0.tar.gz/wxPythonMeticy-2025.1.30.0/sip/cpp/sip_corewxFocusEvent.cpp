...
PyDoc_STRVAR(doc_wxFocusEvent_SetWindow, "SetWindow(win : Window) -> None");
...
PyDoc_STRVAR(doc_wxFocusEvent, "FocusEvent(eventType: EventType=wxEVT_NULL, id: int=0) -> None\n"
"\n"
