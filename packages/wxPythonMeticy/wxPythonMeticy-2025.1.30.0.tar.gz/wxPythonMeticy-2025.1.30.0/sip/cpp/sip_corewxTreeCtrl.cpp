...
PyDoc_STRVAR(doc_wxTreeCtrl_AddRoot, "AddRoot(text : str, image: int=-1, selImage: int=-1, data: Optional[TreeItemData]=None) -> TreeItemId\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_AppendItem, "AppendItem(parent : TreeItemId, text : str, image: int=-1, selImage: int=-1, data: Optional[TreeItemData]=None) -> TreeItemId\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_AssignStateImageList, "AssignStateImageList(imageList : ImageList) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_Collapse, "Collapse(item : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_CollapseAllChildren, "CollapseAllChildren(item : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_CollapseAndReset, "CollapseAndReset(item : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_Create, "Create(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=TR_DEFAULT_STYLE, validator: Validator=DefaultValidator, name: str=TreeCtrlNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_Delete, "Delete(item : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_DeleteChildren, "DeleteChildren(item : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_EditLabel, "EditLabel(item : TreeItemId) -> TextCtrl\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_EnableBellOnNoMatch, "EnableBellOnNoMatch(on: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_EndEditLabel, "EndEditLabel(item : TreeItemId, discardChanges: bool=False) -> None\n"
"\n"
"Ends label editing.");
...
PyDoc_STRVAR(doc_wxTreeCtrl_EnsureVisible, "EnsureVisible(item : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_Expand, "Expand(item : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_ExpandAllChildren, "ExpandAllChildren(item : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetBoundingRect, "GetBoundingRect(item: TreeItemId, textOnly: bool=False) -> Any\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetChildrenCount, "GetChildrenCount(item : TreeItemId, recursively: bool=True) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetFirstChild, "GetFirstChild(item : TreeItemId) -> Tuple[TreeItemId, TreeItemIdValue]\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetFocusedItem, "SetFocusedItem(item : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetItemBackgroundColour, "GetItemBackgroundColour(item : TreeItemId) -> Colour\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetItemData, "GetItemData(item : TreeItemId) -> TreeItemData\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetItemFont, "GetItemFont(item : TreeItemId) -> Font\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetItemImage, "GetItemImage(item : TreeItemId, which: TreeItemIcon=TreeItemIcon_Normal) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetItemParent, "GetItemParent(item : TreeItemId) -> TreeItemId\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetItemState, "GetItemState(item : TreeItemId) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetItemText, "GetItemText(item : TreeItemId) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetItemTextColour, "GetItemTextColour(item : TreeItemId) -> Colour\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetLastChild, "GetLastChild(item : TreeItemId) -> TreeItemId\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetNextChild, "GetNextChild(item : TreeItemId, cookie : TreeItemIdValue) -> Tuple[TreeItemId, TreeItemIdValue]\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetNextSibling, "GetNextSibling(item : TreeItemId) -> TreeItemId\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetNextVisible, "GetNextVisible(item : TreeItemId) -> TreeItemId\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetPrevSibling, "GetPrevSibling(item : TreeItemId) -> TreeItemId\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetPrevVisible, "GetPrevVisible(item : TreeItemId) -> TreeItemId\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_HitTest, "HitTest(point : Point, flags : int) -> TreeItemId\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_InsertItem, "InsertItem(parent : TreeItemId, previous : TreeItemId, text : str, image: int=-1, selImage: int=-1, data: Optional[TreeItemData]=None) -> TreeItemId\n"
"InsertItem(parent : TreeItemId, pos : int, text : str, image: int=-1, selImage: int=-1, data: Optional[TreeItemData]=None) -> TreeItemId\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_IsBold, "IsBold(item : TreeItemId) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_IsExpanded, "IsExpanded(item : TreeItemId) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_IsSelected, "IsSelected(item : TreeItemId) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_IsVisible, "IsVisible(item : TreeItemId) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_ItemHasChildren, "ItemHasChildren(item : TreeItemId) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_OnCompareItems, "OnCompareItems(item1 : TreeItemId, item2 : TreeItemId) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_PrependItem, "PrependItem(parent : TreeItemId, text : str, image: int=-1, selImage: int=-1, data: Optional[TreeItemData]=None) -> TreeItemId\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_ScrollTo, "ScrollTo(item : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SelectItem, "SelectItem(item : TreeItemId, select: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetIndent, "SetIndent(indent : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetSpacing, "SetSpacing(spacing : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetItemBackgroundColour, "SetItemBackgroundColour(item : TreeItemId, col : Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetItemBold, "SetItemBold(item : TreeItemId, bold: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetItemData, "SetItemData(item : TreeItemId, data : TreeItemData) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetItemDropHighlight, "SetItemDropHighlight(item : TreeItemId, highlight: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetItemFont, "SetItemFont(item : TreeItemId, font : Font) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetItemHasChildren, "SetItemHasChildren(item : TreeItemId, hasChildren: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetItemImage, "SetItemImage(item : TreeItemId, image : int, which: TreeItemIcon=TreeItemIcon_Normal) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetItemState, "SetItemState(item : TreeItemId, state : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetItemText, "SetItemText(item : TreeItemId, text : str) -> None\n"
"\n"
"Sets the item label.");
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetItemTextColour, "SetItemTextColour(item : TreeItemId, col : Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetQuickBestSize, "SetQuickBestSize(quickBestSize : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetStateImageList, "SetStateImageList(imageList : ImageList) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SetWindowStyle, "SetWindowStyle(styles : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SortChildren, "SortChildren(item : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_Toggle, "Toggle(item : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_ToggleItemSelection, "ToggleItemSelection(item : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_UnselectItem, "UnselectItem(item : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_SelectChildren, "SelectChildren(parent : TreeItemId) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTreeCtrl_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
PyDoc_STRVAR(doc_wxTreeCtrl_EnableSystemTheme, "EnableSystemTheme(enable: bool=True) -> None\n"
"\n"
...
"TreeCtrl(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=TR_DEFAULT_STYLE, validator: Validator=DefaultValidator, name: str=TreeCtrlNameStr) -> None\n"
"\n"
