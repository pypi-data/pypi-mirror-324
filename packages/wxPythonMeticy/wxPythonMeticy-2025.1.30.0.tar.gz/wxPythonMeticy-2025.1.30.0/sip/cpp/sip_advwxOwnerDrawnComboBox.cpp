...
PyDoc_STRVAR(doc_wxOwnerDrawnComboBox_AnimateShow, "AnimateShow(rect : Rect, flags : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxOwnerDrawnComboBox_Create, "Create(parent : wx.Window, id: int=wx.ID_ANY, value: str='', pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, choices: List[str]=[], style: int=0, validator: wx.Validator=wx.DefaultValidator, name: str=wx.ComboBoxNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxOwnerDrawnComboBox_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
...
PyDoc_STRVAR(doc_wxOwnerDrawnComboBox_OnDrawBackground, "OnDrawBackground(dc : wx.DC, rect : wx.Rect, item : int, flags : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxOwnerDrawnComboBox_OnDrawItem, "OnDrawItem(dc : wx.DC, rect : wx.Rect, item : int, flags : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxOwnerDrawnComboBox_OnMeasureItem, "OnMeasureItem(item : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxOwnerDrawnComboBox_OnMeasureItemWidth, "OnMeasureItemWidth(item : int) -> int\n"
"\n"
