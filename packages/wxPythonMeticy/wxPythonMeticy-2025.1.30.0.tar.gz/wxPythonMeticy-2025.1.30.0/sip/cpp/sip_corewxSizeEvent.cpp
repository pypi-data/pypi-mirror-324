...
PyDoc_STRVAR(doc_wxSizeEvent_SetSize, "SetSize(size : Size) -> None");
...
PyDoc_STRVAR(doc_wxSizeEvent_SetRect, "SetRect(rect : Rect) -> None");
...
PyDoc_STRVAR(doc_wxSizeEvent, "SizeEvent(sz : Size, id: int=0) -> None\n"
"\n"
