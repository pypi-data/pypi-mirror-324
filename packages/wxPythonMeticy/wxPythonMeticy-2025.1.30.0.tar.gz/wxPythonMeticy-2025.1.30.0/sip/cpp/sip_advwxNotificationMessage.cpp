...
PyDoc_STRVAR(doc_wxNotificationMessage_TryBefore, "TryBefore(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotificationMessage_TryAfter, "TryAfter(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotificationMessage_AddAction, "AddAction(actionid : int, label: str=\"\") -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotificationMessage_SetFlags, "SetFlags(flags : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotificationMessage_SetIcon, "SetIcon(icon : wx.Icon) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotificationMessage_SetMessage, "SetMessage(message : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotificationMessage_SetParent, "SetParent(parent : wx.Window) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotificationMessage_SetTitle, "SetTitle(title : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotificationMessage_Show, "Show(timeout: int=Timeout_Auto) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotificationMessage_UseTaskBarIcon, "UseTaskBarIcon(icon : TaskBarIcon) -> TaskBarIcon\n"
"\n"
...
PyDoc_STRVAR(doc_wxNotificationMessage_MSWUseToasts, "MSWUseToasts(shortcutPath: str=\"\", appId: str=\"\") -> bool\n"
"\n"
