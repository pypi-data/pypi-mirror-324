...
PyDoc_STRVAR(doc_wxXmlResource_LoadMenuBar, "LoadMenuBar(parent : Window, name : str) -> MenuBar\n"
...
PyDoc_STRVAR(doc_wxXmlResource_LoadObject, "LoadObject(parent : Window, name : str, classname : str) -> Object\n"
...
PyDoc_STRVAR(doc_wxXmlResource_LoadObjectRecursively, "LoadObjectRecursively(parent : Window, name : str, classname : str) -> Object\n"
...
PyDoc_STRVAR(doc_wxXmlResource_AddHandler, "AddHandler(handler : XmlResourceHandler) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_InsertHandler, "InsertHandler(handler : XmlResourceHandler) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_AttachUnknownControl, "AttachUnknownControl(name : str, control : Window, parent: Optional[Window]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_CompareVersion, "CompareVersion(major : int, minor : int, release : int, revision : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_GetResourceNode, "GetResourceNode(name : str) -> XmlNode\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_Load, "Load(filemask : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_LoadDocument, "LoadDocument(doc : XmlDocument, name: str=\"\") -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_LoadFile, "LoadFile(file : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_LoadAllFiles, "LoadAllFiles(dirname : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_LoadBitmap, "LoadBitmap(name : str) -> Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_LoadDialog, "LoadDialog(parent : Window, name : str) -> Dialog\n"
...
PyDoc_STRVAR(doc_wxXmlResource_LoadFrame, "LoadFrame(parent : Window, name : str) -> Frame\n"
...
PyDoc_STRVAR(doc_wxXmlResource_LoadIcon, "LoadIcon(name : str) -> Icon\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_LoadMenu, "LoadMenu(name : str) -> Menu\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_LoadPanel, "LoadPanel(parent : Window, name : str) -> Panel\n"
...
PyDoc_STRVAR(doc_wxXmlResource_LoadToolBar, "LoadToolBar(parent : Window, name : str) -> ToolBar\n"
"\n"
"Loads a toolbar.");
...
PyDoc_STRVAR(doc_wxXmlResource_SetDomain, "SetDomain(domain : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_SetFlags, "SetFlags(flags : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_Unload, "Unload(filename : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_AddSubclassFactory, "AddSubclassFactory(factory : XmlSubclassFactory) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_FindXRCIDById, "FindXRCIDById(numId : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_GetXRCID, "GetXRCID(str_id : str, value_if_not_found: int=ID_NONE) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_Set, "Set(res : XmlResource) -> XmlResource\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource_LoadFromBuffer, "LoadFromBuffer(data: PyBuffer) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlResource, "XmlResource(filemask : str, flags: int=XRC_USE_LOCALE, domain: str='') -> None\n"
