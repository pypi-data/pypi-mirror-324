...
PyDoc_STRVAR(doc_wxDropTarget_OnData, "OnData(x : int, y : int, defResult : DragResult) -> DragResult\n"
"\n"
...
PyDoc_STRVAR(doc_wxDropTarget_OnDragOver, "OnDragOver(x : int, y : int, defResult : DragResult) -> DragResult\n"
"\n"
...
PyDoc_STRVAR(doc_wxDropTarget_OnDrop, "OnDrop(x : int, y : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDropTarget_OnEnter, "OnEnter(x : int, y : int, defResult : DragResult) -> DragResult\n"
"\n"
...
PyDoc_STRVAR(doc_wxDropTarget_SetDataObject, "SetDataObject(data : DataObject) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDropTarget_SetDefaultAction, "SetDefaultAction(action : DragResult) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxDropTarget, "DropTarget(data: Optional[DataObject]=None) -> None\n"
"\n"
