...
PyDoc_STRVAR(doc_wxRichTextFontTable_FindFont, "FindFont(fontSpec : RichTextAttr) -> wx.Font\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextFontTable_SetFontScale, "SetFontScale(fontScale : float) -> None\n"
"\n"
