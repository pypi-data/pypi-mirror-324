...
PyDoc_STRVAR(doc_wxPyApp_GTKSuppressDiagnostics, "GTKSuppressDiagnostics(flags: int=-1) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPyApp_MacOpenFiles, "MacOpenFiles(fileNames : List[str]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPyApp_MacOpenFile, "MacOpenFile(fileName : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPyApp_MacOpenURL, "MacOpenURL(url : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPyApp_MacPrintFile, "MacPrintFile(fileName : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPyApp_OSXEnableAutomaticTabbing, "OSXEnableAutomaticTabbing(enable : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPyApp_SafeYield, "SafeYield(win : Window, onlyIfNeeded : bool) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPyApp_SafeYieldFor, "SafeYieldFor(win : Window, eventsToProcess : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPyApp_SetDisplayMode, "SetDisplayMode(info : VideoMode) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPyApp_SetExitOnFrameDelete, "SetExitOnFrameDelete(flag : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPyApp_SetNativeTheme, "SetNativeTheme(theme : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPyApp_SetTopWindow, "SetTopWindow(window : Window) -> None\n"
"\n"
"Sets the 'top' window.");
...
PyDoc_STRVAR(doc_wxPyApp_SetUseBestVisual, "SetUseBestVisual(flag : bool, forceTrueColour: bool=False) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPyApp_SetAssertMode, "SetAssertMode(AppAssertMode : AppAssertMode) -> None\n"
"\n"
