...
PyDoc_STRVAR(doc_wxGBPosition_SetCol, "SetCol(col : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxGBPosition_SetRow, "SetRow(row : int) -> None\n"
"\n"
"Set a new row value.");
...
PyDoc_STRVAR(doc_wxGBPosition_Set, "Set(row: int=0, col: int=0) -> None\n"
"\n"
...
"GBPosition(row : int, col : int) -> None\n"
"\n"
