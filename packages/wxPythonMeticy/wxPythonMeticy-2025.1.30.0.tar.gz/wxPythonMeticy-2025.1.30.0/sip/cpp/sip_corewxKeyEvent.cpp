...
PyDoc_STRVAR(doc_wxKeyEvent_IsKeyInCategory, "IsKeyInCategory(category : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxKeyEvent_SetKeyCode, "SetKeyCode(keyCode: int) -> None");
...
PyDoc_STRVAR(doc_wxKeyEvent_SetRawKeyCode, "SetRawKeyCode(rawKeyCode: int) -> None");
...
PyDoc_STRVAR(doc_wxKeyEvent_SetRawKeyFlags, "SetRawKeyFlags(rawFlags: int) -> None");
...
PyDoc_STRVAR(doc_wxKeyEvent_SetUnicodeKey, "SetUnicodeKey(uniChar: int) -> None");
...
PyDoc_STRVAR(doc_wxKeyEvent, "KeyEvent(keyEventType: EventType=wxEVT_NULL) -> None\n"
"\n"
