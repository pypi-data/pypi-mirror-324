...
PyDoc_STRVAR(doc_wxPseudoDC_SetId, "SetId(id : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_ClearId, "ClearId(id : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_RemoveId, "RemoveId(id : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_TranslateId, "TranslateId(id : int, dx : int, dy : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_SetIdGreyedOut, "SetIdGreyedOut(id : int, greyout : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_GetIdGreyedOut, "GetIdGreyedOut(id : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_FindObjects, "FindObjects(x : int, y : int, radius: int=1, bg: wx.Colour=wx.WHITE) -> Any\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_FindObjectsByBBox, "FindObjectsByBBox(x : int, y : int) -> Any\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawIdToDC, "DrawIdToDC(id : int, dc : wx.DC) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_SetIdBounds, "SetIdBounds(id : int, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_GetIdBounds, "GetIdBounds(id : int) -> wx.Rect\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawToDCClipped, "DrawToDCClipped(dc : wx.DC, rect : wx.Rect) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawToDCClippedRgn, "DrawToDCClippedRgn(dc : wx.DC, region : wx.Region) -> None\n"
"\n"
"Draws the recorded operations to dc,\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawToDC, "DrawToDC(dc : wx.DC) -> None\n"
"\n"
"Draws the recorded operations to dc.");
...
PyDoc_STRVAR(doc_wxPseudoDC_FloodFill, "FloodFill(x : int, y : int, col : wx.Colour, style: wx.FloodFillStyle=wx.FLOOD_SURFACE) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawLine, "DrawLine(x1 : int, y1 : int, x2 : int, y2 : int) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_CrossHair, "CrossHair(x : int, y : int) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawArc, "DrawArc(x1 : int, y1 : int, x2 : int, y2 : int, xc : int, yc : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawCheckMark, "DrawCheckMark(x : int, y : int, width : int, height : int) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawEllipticArc, "DrawEllipticArc(x : int, y : int, w : int, h : int, start : float, end : float) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawPoint, "DrawPoint(x : int, y : int) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawRectangle, "DrawRectangle(x : int, y : int, width : int, height : int) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawRoundedRectangle, "DrawRoundedRectangle(x : int, y : int, width : int, height : int, radius : float) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawCircle, "DrawCircle(x : int, y : int, radius : int) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawEllipse, "DrawEllipse(x : int, y : int, width : int, height : int) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawIcon, "DrawIcon(icon : wx.Icon, x : int, y : int) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawBitmap, "DrawBitmap(bmp : wx.Bitmap, x : int, y : int, useMask: bool=False) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawText, "DrawText(text : str, x : int, y : int) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawRotatedText, "DrawRotatedText(text : str, x : int, y : int, angle : float) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawLabel, "DrawLabel(text : str, rect : wx.Rect, alignment: int=wx.ALIGN_LEFT|wx.ALIGN_TOP, indexAccel: int=-1) -> None\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_SetFont, "SetFont(font : wx.Font) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_SetPen, "SetPen(pen : wx.Pen) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_SetBrush, "SetBrush(brush : wx.Brush) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_SetBackground, "SetBackground(brush : wx.Brush) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_SetBackgroundMode, "SetBackgroundMode(mode : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_SetTextForeground, "SetTextForeground(colour : wx.Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_SetTextBackground, "SetTextBackground(colour : wx.Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_SetLogicalFunction, "SetLogicalFunction(function : wx.RasterOperationMode) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawLines, "DrawLines(points : PointList, xoffset: int=0, yoffset: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawPolygon, "DrawPolygon(points : PointList, xoffset: int=0, yoffset: int=0, fillStyle: wx.PolygonFillMode=wx.ODDEVEN_RULE) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPseudoDC_DrawSpline, "DrawSpline(points : PointList) -> None\n"
"\n"
