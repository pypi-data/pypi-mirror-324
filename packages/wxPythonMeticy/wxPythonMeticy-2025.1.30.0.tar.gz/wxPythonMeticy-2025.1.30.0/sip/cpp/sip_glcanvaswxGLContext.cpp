...
PyDoc_STRVAR(doc_wxGLContext_SetCurrent, "SetCurrent(win : GLCanvas) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxGLContext, "GLContext(win : GLCanvas, other: Optional[GLContext]=None, ctxAttrs: Optional[GLContextAttrs]=None) -> None\n"
"\n"
