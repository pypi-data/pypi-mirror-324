...
PyDoc_STRVAR(doc_wxNonOwnedWindow_ProcessEvent, "ProcessEvent(event : Event) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxNonOwnedWindow_SetShape, "SetShape(region : Region) -> bool\n"
"SetShape(path : GraphicsPath) -> bool\n"
"\n"
