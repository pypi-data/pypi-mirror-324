...
PyDoc_STRVAR(doc_wxWebViewHandler_GetFile, "GetFile(uri : str) -> wx.FSFile");
...
PyDoc_STRVAR(doc_wxWebViewHandler_SetSecurityURL, "SetSecurityURL(url : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxWebViewHandler, "WebViewHandler(scheme : str) -> None\n"
"\n"
