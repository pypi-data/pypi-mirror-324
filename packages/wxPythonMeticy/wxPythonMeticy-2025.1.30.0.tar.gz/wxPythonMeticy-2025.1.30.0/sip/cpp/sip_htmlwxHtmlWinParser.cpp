...
PyDoc_STRVAR(doc_wxHtmlWinParser_AddTag, "AddTag(tag : HtmlTag) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlWinParser_SetActualColor, "SetActualColor(clr : wx.Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlWinParser_SetAlign, "SetAlign(a : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlWinParser_SetContainer, "SetContainer(c : HtmlContainerCell) -> HtmlContainerCell\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlWinParser_SetDC, "SetDC(dc : wx.DC, pixel_scale: float=1.0e+0) -> None\n"
"\n"
"Sets the DC.");
...
PyDoc_STRVAR(doc_wxHtmlWinParser_SetFontBold, "SetFontBold(x : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlWinParser_SetFontFace, "SetFontFace(face : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlWinParser_SetFontFixed, "SetFontFixed(x : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlWinParser_SetFontItalic, "SetFontItalic(x : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlWinParser_SetFontSize, "SetFontSize(s : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlWinParser_SetFontUnderlined, "SetFontUnderlined(x : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlWinParser_SetFonts, "SetFonts(normal_face : str, fixed_face : str, sizes : List[int]) -> None\n"
"\n"
"Sets fonts.");
...
PyDoc_STRVAR(doc_wxHtmlWinParser_SetLink, "SetLink(link : HtmlLinkInfo) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlWinParser_SetLinkColor, "SetLinkColor(clr : wx.Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHtmlWinParser, "HtmlWinParser(wndIface: Optional[HtmlWindowInterface]=None) -> None\n"
"\n"
