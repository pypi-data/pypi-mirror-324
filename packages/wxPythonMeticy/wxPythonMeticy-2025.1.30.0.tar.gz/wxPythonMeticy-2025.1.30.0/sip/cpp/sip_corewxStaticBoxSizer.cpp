...
PyDoc_STRVAR(doc_wxStaticBoxSizer_RepositionChildren, "RepositionChildren(minSize : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxStaticBoxSizer, "StaticBoxSizer(box : StaticBox, orient: int=HORIZONTAL) -> None\n"
"StaticBoxSizer(orient : int, parent : Window, label: str='') -> None\n"
"\n"
