...
PyDoc_STRVAR(doc_wxStaticText_Create, "Create(parent : Window, id: int=ID_ANY, label: str='', pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=StaticTextNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxStaticText_SetLabel, "SetLabel(label : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxStaticText_Wrap, "Wrap(width : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxStaticText_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"StaticText(parent : Window, id: int=ID_ANY, label: str='', pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=StaticTextNameStr) -> None\n"
"\n"
