...
PyDoc_STRVAR(doc_wxSVGBitmapFileHandler_ProcessBitmap, "ProcessBitmap(bitmap : Bitmap, x : int, y : int, stream : OutputStream) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxSVGBitmapFileHandler, "SVGBitmapFileHandler(path : str) -> None\n"
"\n"
