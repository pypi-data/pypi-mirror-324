...
PyDoc_STRVAR(doc_wxGraphicsPenInfo_Colour, "Colour(col : Colour) -> GraphicsPenInfo");
...
PyDoc_STRVAR(doc_wxGraphicsPenInfo_Width, "Width(width : float) -> GraphicsPenInfo");
...
PyDoc_STRVAR(doc_wxGraphicsPenInfo_Style, "Style(style : PenStyle) -> GraphicsPenInfo");
...
PyDoc_STRVAR(doc_wxGraphicsPenInfo_Stipple, "Stipple(stipple : Bitmap) -> GraphicsPenInfo");
...
PyDoc_STRVAR(doc_wxGraphicsPenInfo_Join, "Join(join : PenJoin) -> GraphicsPenInfo");
...
PyDoc_STRVAR(doc_wxGraphicsPenInfo_Cap, "Cap(cap : PenCap) -> GraphicsPenInfo");
...
PyDoc_STRVAR(doc_wxGraphicsPenInfo_LinearGradient, "LinearGradient(x1 : float, y1 : float, x2 : float, y2 : float, c1 : Colour, c2 : Colour, matrix: GraphicsMatrix=NullGraphicsMatrix) -> GraphicsPenInfo\n"
"LinearGradient(x1 : float, y1 : float, x2 : float, y2 : float, stops : GraphicsGradientStops, matrix: GraphicsMatrix=NullGraphicsMatrix) -> GraphicsPenInfo\n"
"");
...
PyDoc_STRVAR(doc_wxGraphicsPenInfo_RadialGradient, "RadialGradient(startX : float, startY : float, endX : float, endY : float, radius : float, oColor : Colour, cColor : Colour, matrix: GraphicsMatrix=NullGraphicsMatrix) -> GraphicsPenInfo\n"
"RadialGradient(startX : float, startY : float, endX : float, endY : float, radius : float, stops : GraphicsGradientStops, matrix: GraphicsMatrix=NullGraphicsMatrix) -> GraphicsPenInfo\n"
"");
...
PyDoc_STRVAR(doc_wxGraphicsPenInfo, "GraphicsPenInfo(colour: Colour=Colour(), width: float=1.0, style: PenStyle=PENSTYLE_SOLID) -> None\n"
"\n"
