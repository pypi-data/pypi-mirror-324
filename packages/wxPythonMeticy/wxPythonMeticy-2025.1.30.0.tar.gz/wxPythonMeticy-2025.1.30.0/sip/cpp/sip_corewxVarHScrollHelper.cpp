...
PyDoc_STRVAR(doc_wxVarHScrollHelper_IsColumnVisible, "IsColumnVisible(column : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHScrollHelper_RefreshColumn, "RefreshColumn(column : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHScrollHelper_RefreshColumns, "RefreshColumns(from_ : int, to_ : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHScrollHelper_ScrollColumnPages, "ScrollColumnPages(pages : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHScrollHelper_ScrollColumns, "ScrollColumns(columns : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHScrollHelper_ScrollToColumn, "ScrollToColumn(column : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHScrollHelper_SetColumnCount, "SetColumnCount(columnCount : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHScrollHelper_OnGetColumnsWidthHint, "OnGetColumnsWidthHint(columnMin : int, columnMax : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHScrollHelper_OnGetColumnWidth, "OnGetColumnWidth(column : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxVarHScrollHelper, "VarHScrollHelper(winToScroll : Window) -> None\n"
"\n"
