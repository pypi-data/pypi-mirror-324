...
PyDoc_STRVAR(doc_wxXmlNode_AddAttribute, "AddAttribute(name : str, value : str) -> None\n"
...
PyDoc_STRVAR(doc_wxXmlNode_AddChild, "AddChild(child : XmlNode) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlNode_DeleteAttribute, "DeleteAttribute(name : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlNode_GetAttribute, "GetAttribute(attrName : str, defaultVal: str='') -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlNode_GetDepth, "GetDepth(grandparent: Optional[XmlNode]=None) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlNode_HasAttribute, "HasAttribute(attrName : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlNode_InsertChild, "InsertChild(child : XmlNode, followingNode : XmlNode) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlNode_InsertChildAfter, "InsertChildAfter(child : XmlNode, precedingNode : XmlNode) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlNode_RemoveChild, "RemoveChild(child : XmlNode) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlNode_SetContent, "SetContent(con : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlNode_SetName, "SetName(name : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlNode_SetNext, "SetNext(next : XmlNode) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlNode_SetNoConversion, "SetNoConversion(noconversion : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlNode_SetParent, "SetParent(parent : XmlNode) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlNode_SetType, "SetType(type : XmlNodeType) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlNode, "XmlNode(parent : XmlNode, type : XmlNodeType, name : str, content: str='', attrs: Optional[XmlAttribute]=None, next: Optional[XmlNode]=None, lineNo: int=-1) -> None\n"
