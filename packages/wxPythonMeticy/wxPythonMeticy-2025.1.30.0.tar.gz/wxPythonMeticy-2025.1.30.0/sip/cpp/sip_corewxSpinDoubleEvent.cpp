...
PyDoc_STRVAR(doc_wxSpinDoubleEvent_SetValue, "SetValue(value : float) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxSpinDoubleEvent, "SpinDoubleEvent(commandType: EventType=wxEVT_NULL, winid: int=0, value: float=0) -> None\n"
