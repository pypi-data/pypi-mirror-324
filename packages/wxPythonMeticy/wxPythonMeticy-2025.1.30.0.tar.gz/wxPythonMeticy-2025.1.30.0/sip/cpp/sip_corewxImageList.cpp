...
PyDoc_STRVAR(doc_wxImageList_Add, "Add(bitmap : Bitmap, mask: Bitmap=NullBitmap) -> int\n"
"Add(bitmap : Bitmap, maskColour : Colour) -> int\n"
"Add(icon : Icon) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageList_Create, "Create(width : int, height : int, mask: bool=True, initialCount: int=1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageList_Draw, "Draw(index : int, dc : DC, x : int, y : int, flags: int=IMAGELIST_DRAW_NORMAL, solidBackground: bool=False) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageList_GetBitmap, "GetBitmap(index : int) -> Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageList_GetIcon, "GetIcon(index : int) -> Icon\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageList_GetSize, "GetSize(index : int) -> Tuple[int, int]\n"
"GetSize() -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageList_Remove, "Remove(index : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageList_Replace, "Replace(index : int, bitmap : Bitmap, mask: Bitmap=NullBitmap) -> bool\n"
"Replace(index : int, icon : Icon) -> bool\n"
"\n"
...
"ImageList(width : int, height : int, mask: bool=True, initialCount: int=1) -> None\n"
"\n"
