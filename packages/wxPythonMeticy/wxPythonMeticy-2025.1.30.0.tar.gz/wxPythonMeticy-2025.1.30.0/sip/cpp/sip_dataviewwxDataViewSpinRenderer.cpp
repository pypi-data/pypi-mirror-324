...
PyDoc_STRVAR(doc_wxDataViewSpinRenderer_GetTextExtent, "GetTextExtent(str : str) -> wx.Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewSpinRenderer, "DataViewSpinRenderer(min : int, max : int, mode: DataViewCellMode=DATAVIEW_CELL_EDITABLE, align: int=DVR_DEFAULT_ALIGNMENT) -> None\n"
"\n"
