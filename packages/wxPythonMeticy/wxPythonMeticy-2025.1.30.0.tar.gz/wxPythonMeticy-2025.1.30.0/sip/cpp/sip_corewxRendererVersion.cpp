...
PyDoc_STRVAR(doc_wxRendererVersion_IsCompatible, "IsCompatible(ver : RendererVersion) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRendererVersion, "RendererVersion(version_ : int, age_ : int) -> None\n"
"\n"
