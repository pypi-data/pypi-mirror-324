...
PyDoc_STRVAR(doc_wxTextDataObject_GetFormatCount, "GetFormatCount(dir: DataObject.Direction=DataObject.Get) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextDataObject_SetText, "SetText(strText : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxTextDataObject_SetData, "SetData(format: DataFormat, buf: PyBuffer) -> bool\n"
"");
...
PyDoc_STRVAR(doc_wxTextDataObject, "TextDataObject(text: str='') -> None\n"
"\n"
