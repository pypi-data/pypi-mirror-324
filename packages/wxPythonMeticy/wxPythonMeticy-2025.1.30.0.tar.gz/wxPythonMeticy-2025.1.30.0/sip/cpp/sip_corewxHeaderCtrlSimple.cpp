...
PyDoc_STRVAR(doc_wxHeaderCtrlSimple_InsertColumn, "InsertColumn(col : HeaderColumnSimple, idx : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrlSimple_AppendColumn, "AppendColumn(col : HeaderColumnSimple) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrlSimple_DeleteColumn, "DeleteColumn(idx : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrlSimple_ShowColumn, "ShowColumn(idx : int, show: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrlSimple_HideColumn, "HideColumn(idx : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrlSimple_ShowSortIndicator, "ShowSortIndicator(idx : int, sortOrder: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxHeaderCtrlSimple_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
PyDoc_STRVAR(doc_wxHeaderCtrlSimple_GetBestFittingWidth, "GetBestFittingWidth(idx : int) -> int\n"
"\n"
...
"HeaderCtrlSimple(parent : Window, winid: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=HD_DEFAULT_STYLE, name: str=HeaderCtrlNameStr) -> None\n"
"\n"
