...
PyDoc_STRVAR(doc_wxScrollWinEvent_SetOrientation, "SetOrientation(orient : int) -> None");
...
PyDoc_STRVAR(doc_wxScrollWinEvent_SetPosition, "SetPosition(pos : int) -> None");
...
PyDoc_STRVAR(doc_wxScrollWinEvent, "ScrollWinEvent(commandType: EventType=wxEVT_NULL, pos: int=0, orientation: int=0) -> None\n"
"\n"
