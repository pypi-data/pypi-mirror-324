...
PyDoc_STRVAR(doc_wxBookCtrlBase_GetPageImage, "GetPageImage(nPage : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlBase_SetPageImage, "SetPageImage(page : int, image : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlBase_GetPageText, "GetPageText(nPage : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlBase_SetPageText, "SetPageText(page : int, text : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlBase_SetSelection, "SetSelection(page : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlBase_AdvanceSelection, "AdvanceSelection(forward: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlBase_ChangeSelection, "ChangeSelection(page : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlBase_FindPage, "FindPage(page : Window) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlBase_AddPage, "AddPage(page : Window, text : str, select: bool=False, imageId: int=NO_IMAGE) -> bool\n"
"\n"
"Adds a new page.");
...
PyDoc_STRVAR(doc_wxBookCtrlBase_DeletePage, "DeletePage(page : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlBase_InsertPage, "InsertPage(index : int, page : Window, text : str, select: bool=False, imageId: int=NO_IMAGE) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlBase_RemovePage, "RemovePage(page : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlBase_GetPage, "GetPage(page : int) -> Window\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlBase_Create, "Create(parent : Window, winid : int, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str='') -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlBase_SetPageSize, "SetPageSize(size : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBookCtrlBase_HitTest, "HitTest(pt : Point) -> Tuple[int, int]\n"
"\n"
...
"BookCtrlBase(parent : Window, winid : int, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str='') -> None\n"
"\n"
