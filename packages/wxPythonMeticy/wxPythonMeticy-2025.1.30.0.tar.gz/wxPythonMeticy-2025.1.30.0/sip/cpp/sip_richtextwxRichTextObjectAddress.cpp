...
PyDoc_STRVAR(doc_wxRichTextObjectAddress_Copy, "Copy(address : RichTextObjectAddress) -> None\n"
"\n"
"Copies the address.");
...
PyDoc_STRVAR(doc_wxRichTextObjectAddress_GetObject, "GetObject(topLevelContainer : RichTextParagraphLayoutBox) -> RichTextObject\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObjectAddress_Create, "Create(topLevelContainer : RichTextParagraphLayoutBox, obj : RichTextObject) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObjectAddress_SetAddress, "SetAddress(address : List[int]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextObjectAddress, "RichTextObjectAddress(topLevelContainer : RichTextParagraphLayoutBox, obj : RichTextObject) -> None\n"
