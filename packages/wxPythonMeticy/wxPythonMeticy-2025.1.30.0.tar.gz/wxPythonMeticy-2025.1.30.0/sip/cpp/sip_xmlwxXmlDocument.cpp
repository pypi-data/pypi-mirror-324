...
PyDoc_STRVAR(doc_wxXmlDocument_AppendToProlog, "AppendToProlog(node : XmlNode) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlDocument_Load, "Load(filename : str, encoding: str=\"UTF-8\", flags: int=XMLDOC_NONE) -> bool\n"
...
PyDoc_STRVAR(doc_wxXmlDocument_Save, "Save(filename : str, indentstep: int=2) -> bool\n"
...
PyDoc_STRVAR(doc_wxXmlDocument_SetDocumentNode, "SetDocumentNode(node : XmlNode) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlDocument_SetFileEncoding, "SetFileEncoding(encoding : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlDocument_SetDoctype, "SetDoctype(doctype : XmlDoctype) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlDocument_SetFileType, "SetFileType(fileType : TextFileType) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlDocument_SetRoot, "SetRoot(node : XmlNode) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxXmlDocument_SetVersion, "SetVersion(version : str) -> None\n"
"\n"
