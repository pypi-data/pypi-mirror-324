...
PyDoc_STRVAR(doc_wxArrayStringProperty_ValueToString, "ValueToString(value : PGVariant, argFlags: int=0) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxArrayStringProperty_StringToValue, "StringToValue(text : str, argFlags: int=0) -> Tuple[bool, PGVariant]\n"
"\n"
...
PyDoc_STRVAR(doc_wxArrayStringProperty_DoSetAttribute, "DoSetAttribute(name : str, value : PGVariant) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxArrayStringProperty_ConvertArrayToString, "ConvertArrayToString(arr : List[str], delimiter : wx.UniChar) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxArrayStringProperty_OnCustomStringEdit, "OnCustomStringEdit(parent : wx.Window, value : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxArrayStringProperty_ArrayStringToString, "ArrayStringToString(src : List[str], delimiter : wx.UniChar, flags : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxArrayStringProperty_DisplayEditorDialog, "DisplayEditorDialog(pg : PropertyGrid, value : PGVariant) -> Tuple[bool, PGVariant]\n"
"\n"
"Shows editor dialog.");
...
PyDoc_STRVAR(doc_wxArrayStringProperty, "ArrayStringProperty(label: str=PG_LABEL, name: str=PG_LABEL, value: List[str]=[]) -> None\n"
"\n"
