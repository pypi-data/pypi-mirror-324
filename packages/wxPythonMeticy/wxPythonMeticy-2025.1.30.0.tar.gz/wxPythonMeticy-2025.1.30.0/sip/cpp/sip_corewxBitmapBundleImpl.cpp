...
PyDoc_STRVAR(doc_wxBitmapBundleImpl_GetPreferredBitmapSizeAtScale, "GetPreferredBitmapSizeAtScale(scale : float) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundleImpl_GetBitmap, "GetBitmap(size : Size) -> Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundleImpl_DoGetPreferredSize, "DoGetPreferredSize(scale : float) -> Size\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundleImpl_GetIndexToUpscale, "GetIndexToUpscale(size : Size) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapBundleImpl_GetNextAvailableScale, "GetNextAvailableScale(idx : int) -> Tuple[float, int]\n"
"\n"
