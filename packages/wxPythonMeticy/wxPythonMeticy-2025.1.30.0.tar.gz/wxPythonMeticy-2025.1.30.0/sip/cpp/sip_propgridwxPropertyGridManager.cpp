...
PyDoc_STRVAR(doc_wxPropertyGridManager_AddPage, "AddPage(label: str='', bmp: wx.BitmapBundle=wx.BitmapBundle(), pageObj: Optional[PropertyGridPage]=None) -> PropertyGridPage\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_ClearPage, "ClearPage(page : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_CommitChangesFromEditor, "CommitChangesFromEditor(flags: Uint32=0) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_Create, "Create(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=PGMAN_DEFAULT_STYLE, name: str=PropertyGridManagerNameStr) -> bool\n"
"\n"
"Two step creation.");
...
PyDoc_STRVAR(doc_wxPropertyGridManager_EnableCategories, "EnableCategories(enable : bool) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_EnsureVisible, "EnsureVisible(id : PGPropArgCls) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_GetColumnCount, "GetColumnCount(page: int=-1) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_GetVIterator, "GetVIterator(flags : int) -> PGVIterator\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_GetPage, "GetPage(ind : int) -> PropertyGridPage\n"
"GetPage(name : str) -> PropertyGridPage\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_GetPageByName, "GetPageByName(name : str) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_GetPageByState, "GetPageByState(pstate : PropertyGridPageState) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_GetPageName, "GetPageName(index : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_GetPageRoot, "GetPageRoot(index : int) -> PGProperty\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_InsertPage, "InsertPage(index : int, label : str, bmp: wx.BitmapBundle=wx.BitmapBundle(), pageObj: Optional[PropertyGridPage]=None) -> PropertyGridPage\n"
"\n"
"Creates new property page.");
...
PyDoc_STRVAR(doc_wxPropertyGridManager_IsPageModified, "IsPageModified(index : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_IsPropertySelected, "IsPropertySelected(id : PGPropArgCls) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_RemovePage, "RemovePage(page : int) -> bool\n"
"\n"
"Removes a page.");
...
PyDoc_STRVAR(doc_wxPropertyGridManager_SelectPage, "SelectPage(index : int) -> None\n"
"SelectPage(label : str) -> None\n"
"SelectPage(page : PropertyGridPage) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_SelectProperty, "SelectProperty(id : PGPropArgCls, focus: bool=False) -> bool\n"
"\n"
"Select a property.");
...
PyDoc_STRVAR(doc_wxPropertyGridManager_SetColumnCount, "SetColumnCount(colCount : int, page: int=-1) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_SetColumnTitle, "SetColumnTitle(idx : int, title : str) -> None\n"
"\n"
"Sets a column title.");
...
PyDoc_STRVAR(doc_wxPropertyGridManager_SetDescription, "SetDescription(label : str, content : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_SetDescBoxHeight, "SetDescBoxHeight(ht : int, refresh: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_SetSplitterLeft, "SetSplitterLeft(subProps: bool=False, allPages: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_SetPageSplitterLeft, "SetPageSplitterLeft(page : int, subProps: bool=False) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_SetPageSplitterPosition, "SetPageSplitterPosition(page : int, pos : int, column: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_SetSplitterPosition, "SetSplitterPosition(pos : int, column: int=0) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_ShowHeader, "ShowHeader(show: bool=True) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPropertyGridManager_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
...
"PropertyGridManager(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=PGMAN_DEFAULT_STYLE, name: str=PropertyGridManagerNameStr) -> None\n"
"\n"
