...
PyDoc_STRVAR(doc_wxContextHelp_BeginContextHelp, "BeginContextHelp(window : Window) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxContextHelp, "ContextHelp(window: Optional[Window]=None, doNow: bool=True) -> None\n"
"\n"
