...
PyDoc_STRVAR(doc_wxPGChoices_Add, "Add(arr : List[str], arrint : List[int]) -> None\n"
"Add(label : str, value: int=PG_INVALID_VALUE) -> PGChoiceEntry\n"
"Add(label : str, bitmap : wx.Bitmap, value: int=PG_INVALID_VALUE) -> PGChoiceEntry\n"
"Add(entry : PGChoiceEntry) -> PGChoiceEntry\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGChoices_AddAsSorted, "AddAsSorted(label : str, value: int=PG_INVALID_VALUE) -> PGChoiceEntry\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGChoices_Assign, "Assign(a : PGChoices) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGChoices_AssignData, "AssignData(data : PGChoicesData) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGChoices_GetLabel, "GetLabel(ind : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGChoices_GetValue, "GetValue(ind : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGChoices_GetValuesForStrings, "GetValuesForStrings(strings : List[str]) -> List[int]\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGChoices_GetIndicesForStrings, "GetIndicesForStrings(strings : List[str], unmatched: Optional[List[str]]=None) -> List[int]\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGChoices_Index, "Index(label : str) -> int\n"
"Index(val : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGChoices_Insert, "Insert(label : str, index : int, value: int=PG_INVALID_VALUE) -> PGChoiceEntry\n"
"Insert(entry : PGChoiceEntry, index : int) -> PGChoiceEntry\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGChoices_Item, "Item(i : int) -> PGChoiceEntry\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGChoices_RemoveAt, "RemoveAt(nIndex : int, count: int=1) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxPGChoices_Set, "Set(labels : List[str], values: List[int]=[]) -> None\n"
"\n"
"This is an overloaded member function, provided for convenience. It\n"
"differs from the above function only in what argument(s) it accepts.");
