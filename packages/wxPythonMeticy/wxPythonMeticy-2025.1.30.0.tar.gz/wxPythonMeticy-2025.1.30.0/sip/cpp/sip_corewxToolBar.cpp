...
PyDoc_STRVAR(doc_wxToolBar_AddTool, "AddTool(tool : ToolBarToolBase) -> ToolBarToolBase\n"
"AddTool(toolId : int, label : str, bitmap : BitmapBundle, shortHelp: str='', kind: ItemKind=ITEM_NORMAL) -> ToolBarToolBase\n"
"AddTool(toolId : int, label : str, bitmap : BitmapBundle, bmpDisabled : BitmapBundle, kind: ItemKind=ITEM_NORMAL, shortHelp: str='', longHelp: str='', clientData: Optional[PyUserData]=None) -> ToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_InsertTool, "InsertTool(pos : int, toolId : int, label : str, bitmap : BitmapBundle, bmpDisabled: BitmapBundle=NullBitmap, kind: ItemKind=ITEM_NORMAL, shortHelp: str='', longHelp: str='', clientData: Optional[PyUserData]=None) -> ToolBarToolBase\n"
"InsertTool(pos : int, tool : ToolBarToolBase) -> ToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_SetMargins, "SetMargins(x : int, y : int) -> None\n"
"SetMargins(size : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_AddCheckTool, "AddCheckTool(toolId : int, label : str, bitmap1 : BitmapBundle, bmpDisabled: BitmapBundle=NullBitmap, shortHelp: str='', longHelp: str='', clientData: Optional[PyUserData]=None) -> ToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_AddControl, "AddControl(control : Control, label: str='') -> ToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_AddRadioTool, "AddRadioTool(toolId : int, label : str, bitmap1 : BitmapBundle, bmpDisabled: BitmapBundle=NullBitmap, shortHelp: str='', longHelp: str='', clientData: Optional[PyUserData]=None) -> ToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_DeleteTool, "DeleteTool(toolId : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_DeleteToolByPos, "DeleteToolByPos(pos : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_EnableTool, "EnableTool(toolId : int, enable : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_FindById, "FindById(id : int) -> ToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_FindControl, "FindControl(id : int) -> Control\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_FindToolForPosition, "FindToolForPosition(x : int, y : int) -> ToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_GetToolByPos, "GetToolByPos(pos : int) -> ToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_GetToolClientData, "GetToolClientData(toolId : int) -> PyUserData\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_GetToolEnabled, "GetToolEnabled(toolId : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_GetToolLongHelp, "GetToolLongHelp(toolId : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_GetToolPos, "GetToolPos(toolId : int) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_GetToolShortHelp, "GetToolShortHelp(toolId : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_GetToolState, "GetToolState(toolId : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_InsertControl, "InsertControl(pos : int, control : Control, label: str='') -> ToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_InsertSeparator, "InsertSeparator(pos : int) -> ToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_InsertStretchableSpace, "InsertStretchableSpace(pos : int) -> ToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_RemoveTool, "RemoveTool(id : int) -> ToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_SetDropdownMenu, "SetDropdownMenu(id : int, menu : Menu) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_SetToolBitmapSize, "SetToolBitmapSize(size : Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_SetToolClientData, "SetToolClientData(id : int, clientData : PyUserData) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_SetToolDisabledBitmap, "SetToolDisabledBitmap(id : int, bitmap : BitmapBundle) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_SetToolLongHelp, "SetToolLongHelp(toolId : int, helpString : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_SetToolNormalBitmap, "SetToolNormalBitmap(id : int, bitmap : BitmapBundle) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_SetToolPacking, "SetToolPacking(packing : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_SetToolSeparation, "SetToolSeparation(separation : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_SetToolShortHelp, "SetToolShortHelp(toolId : int, helpString : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_ToggleTool, "ToggleTool(toolId : int, toggle : bool) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_CreateTool, "CreateTool(toolId : int, label : str, bmpNormal : BitmapBundle, bmpDisabled: BitmapBundle=NullBitmap, kind: ItemKind=ITEM_NORMAL, clientData: Optional[PyUserData]=None, shortHelp: str='', longHelp: str='') -> ToolBarToolBase\n"
"CreateTool(control : Control, label : str) -> ToolBarToolBase\n"
"\n"
...
PyDoc_STRVAR(doc_wxToolBar_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
"ToolBar(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=TB_HORIZONTAL, name: str=ToolBarNameStr) -> None\n"
"\n"
