...
PyDoc_STRVAR(doc_wxVListBox_OnGetRowsHeightHint, "OnGetRowsHeightHint(rowMin : int, rowMax : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVListBox_SetMargins, "SetMargins(pt : Point) -> None\n"
...
PyDoc_STRVAR(doc_wxVListBox_Create, "Create(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=VListBoxNameStr) -> bool\n"
"\n"
"Creates the control.");
...
PyDoc_STRVAR(doc_wxVListBox_GetItemRect, "GetItemRect(item : int) -> Rect\n"
"\n"
...
PyDoc_STRVAR(doc_wxVListBox_GetNextSelected, "GetNextSelected(cookie : int) -> Tuple[int, int]\n"
"\n"
...
PyDoc_STRVAR(doc_wxVListBox_IsCurrent, "IsCurrent(item : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVListBox_IsSelected, "IsSelected(item : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVListBox_Select, "Select(item : int, select: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVListBox_SelectRange, "SelectRange(from_ : int, to_ : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxVListBox_SetItemCount, "SetItemCount(count : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVListBox_SetSelection, "SetSelection(selection : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVListBox_SetSelectionBackground, "SetSelectionBackground(col : Colour) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVListBox_Toggle, "Toggle(item : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVListBox_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant=WINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
PyDoc_STRVAR(doc_wxVListBox_OnDrawItem, "OnDrawItem(dc : DC, rect : Rect, n : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVListBox_OnDrawBackground, "OnDrawBackground(dc : DC, rect : Rect, n : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVListBox_OnDrawSeparator, "OnDrawSeparator(dc : DC, rect : Rect, n : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxVListBox_OnMeasureItem, "OnMeasureItem(n : int) -> int\n"
"\n"
...
"VListBox(parent : Window, id: int=ID_ANY, pos: Point=DefaultPosition, size: Size=DefaultSize, style: int=0, name: str=VListBoxNameStr) -> None\n"
"\n"
