...
PyDoc_STRVAR(doc_wxBitmapComboBox_Append, "Append(item : str, bitmap: wx.Bitmap=wx.NullBitmap) -> int\n"
...
PyDoc_STRVAR(doc_wxBitmapComboBox_Create, "Create(parent : wx.Window, id: int=wx.ID_ANY, value: str='', pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, choices: List[str]=[], style: int=0, validator: wx.Validator=wx.DefaultValidator, name: str=BitmapComboBoxNameStr) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapComboBox_GetItemBitmap, "GetItemBitmap(n : int) -> wx.Bitmap\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapComboBox_Insert, "Insert(item : str, bitmap : wx.Bitmap, pos : int) -> int\n"
...
PyDoc_STRVAR(doc_wxBitmapComboBox_SetItemBitmap, "SetItemBitmap(n : int, bitmap : wx.BitmapBundle) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapComboBox_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
...
PyDoc_STRVAR(doc_wxBitmapComboBox_SetSelection, "SetSelection(from_ : int, to_ : int) -> None\n"
...
PyDoc_STRVAR(doc_wxBitmapComboBox_SetTextSelection, "SetTextSelection(from_: int, to_: int) -> None\n"
"\n"
"Same as wxTextEntry::SetSelection().");
...
PyDoc_STRVAR(doc_wxBitmapComboBox_SetValue, "SetValue(text : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapComboBox_FindString, "FindString(string : str, caseSensitive: bool=False) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapComboBox_GetString, "GetString(n : int) -> str\n"
"\n"
...
PyDoc_STRVAR(doc_wxBitmapComboBox_SetString, "SetString(n : int, text : str) -> None\n"
"\n"
