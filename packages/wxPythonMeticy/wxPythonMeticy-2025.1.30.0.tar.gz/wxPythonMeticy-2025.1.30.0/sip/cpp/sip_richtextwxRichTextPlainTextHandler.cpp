...
PyDoc_STRVAR(doc_wxRichTextPlainTextHandler_DoLoadFile, "DoLoadFile(buffer : RichTextBuffer, stream : wx.InputStream) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainTextHandler_DoSaveFile, "DoSaveFile(buffer : RichTextBuffer, stream : wx.OutputStream) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextPlainTextHandler, "RichTextPlainTextHandler(name: str=\"Text\", ext: str=\"txt\", type: RichTextFileType=RICHTEXT_TYPE_TEXT) -> None\n"
"\n"
