...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_AppendContainer, "AppendContainer(parent : DataViewItem, text : str, icon: int=-1, expanded: int=-1, data: Optional[ClientData]=None) -> DataViewItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_AppendItem, "AppendItem(parent : DataViewItem, text : str, icon: int=-1, data: Optional[ClientData]=None) -> DataViewItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_Create, "Create(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=DV_NO_HEADER|DV_ROW_LINES, validator: wx.Validator=wx.DefaultValidator) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_DeleteChildren, "DeleteChildren(item : DataViewItem) -> None\n"
"\n"
"Calls the identical method from wxDataViewTreeStore.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_DeleteItem, "DeleteItem(item : DataViewItem) -> None\n"
"\n"
"Calls the identical method from wxDataViewTreeStore.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_GetChildCount, "GetChildCount(parent : DataViewItem) -> int\n"
"\n"
"Calls the identical method from wxDataViewTreeStore.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_GetItemData, "GetItemData(item : DataViewItem) -> ClientData\n"
"\n"
"Calls the identical method from wxDataViewTreeStore.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_GetItemExpandedIcon, "GetItemExpandedIcon(item : DataViewItem) -> wx.Icon\n"
"\n"
"Calls the identical method from wxDataViewTreeStore.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_GetItemIcon, "GetItemIcon(item : DataViewItem) -> wx.Icon\n"
"\n"
"Calls the identical method from wxDataViewTreeStore.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_GetItemParent, "GetItemParent(item : DataViewItem) -> DataViewItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_GetItemText, "GetItemText(item : DataViewItem) -> str\n"
"\n"
"Calls the identical method from wxDataViewTreeStore.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_GetNthChild, "GetNthChild(parent : DataViewItem, pos : int) -> DataViewItem\n"
"\n"
"Calls the identical method from wxDataViewTreeStore.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_InsertContainer, "InsertContainer(parent : DataViewItem, previous : DataViewItem, text : str, icon: int=-1, expanded: int=-1, data: Optional[ClientData]=None) -> DataViewItem\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_InsertItem, "InsertItem(parent : DataViewItem, previous : DataViewItem, text : str, icon: int=-1, data: Optional[ClientData]=None) -> DataViewItem\n"
"\n"
"Calls the same method from wxDataViewTreeStore but uses an index\n"
"position in the image list instead of a wxIcon.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_IsContainer, "IsContainer(item : DataViewItem) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_PrependContainer, "PrependContainer(parent : DataViewItem, text : str, icon: int=-1, expanded: int=-1, data: Optional[ClientData]=None) -> DataViewItem\n"
"\n"
"Calls the same method from wxDataViewTreeStore but uses an index\n"
"position in the image list instead of a wxIcon.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_PrependItem, "PrependItem(parent : DataViewItem, text : str, icon: int=-1, data: Optional[ClientData]=None) -> DataViewItem\n"
"\n"
"Calls the same method from wxDataViewTreeStore but uses an index\n"
"position in the image list instead of a wxIcon.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_SetImageList, "SetImageList(imagelist : wx.ImageList) -> None\n"
"\n"
"Sets the image list.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_SetItemData, "SetItemData(item : DataViewItem, data : ClientData) -> None\n"
"\n"
"Calls the identical method from wxDataViewTreeStore.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_SetItemExpandedIcon, "SetItemExpandedIcon(item : DataViewItem, icon : wx.BitmapBundle) -> None\n"
"\n"
"Calls the identical method from wxDataViewTreeStore.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_SetItemIcon, "SetItemIcon(item : DataViewItem, icon : wx.BitmapBundle) -> None\n"
"\n"
"Calls the identical method from wxDataViewTreeStore.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_SetItemText, "SetItemText(item : DataViewItem, text : str) -> None\n"
"\n"
"Calls the identical method from wxDataViewTreeStore.");
...
PyDoc_STRVAR(doc_wxDataViewTreeCtrl_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes");
