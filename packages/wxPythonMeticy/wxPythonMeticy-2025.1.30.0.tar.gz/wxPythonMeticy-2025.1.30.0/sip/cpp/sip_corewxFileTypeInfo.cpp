...
PyDoc_STRVAR(doc_wxFileTypeInfo_AddExtension, "AddExtension(ext : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileTypeInfo_SetDescription, "SetDescription(description : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileTypeInfo_SetOpenCommand, "SetOpenCommand(command : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileTypeInfo_SetPrintCommand, "SetPrintCommand(command : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileTypeInfo_SetShortDesc, "SetShortDesc(shortDesc : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxFileTypeInfo_SetIcon, "SetIcon(iconFile : str, iconIndex: int=0) -> None\n"
"\n"
...
"FileTypeInfo(mimeType : str, openCmd : str, printCmd : str, description : str, extension : str) -> None\n"
