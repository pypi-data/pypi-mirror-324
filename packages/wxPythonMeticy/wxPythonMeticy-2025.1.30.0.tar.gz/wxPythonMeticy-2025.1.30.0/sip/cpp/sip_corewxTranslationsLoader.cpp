...
PyDoc_STRVAR(doc_wxTranslationsLoader_LoadCatalog, "LoadCatalog(domain : str, lang : str) -> MsgCatalog\n"
"\n"
...
PyDoc_STRVAR(doc_wxTranslationsLoader_GetAvailableTranslations, "GetAvailableTranslations(domain : str) -> List[str]\n"
"\n"
