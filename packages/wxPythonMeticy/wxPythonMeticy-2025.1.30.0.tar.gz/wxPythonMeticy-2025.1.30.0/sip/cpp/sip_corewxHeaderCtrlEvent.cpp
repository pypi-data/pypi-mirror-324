...
PyDoc_STRVAR(doc_wxHeaderCtrlEvent_SetColumn, "SetColumn(col : int) -> None");
...
PyDoc_STRVAR(doc_wxHeaderCtrlEvent_SetWidth, "SetWidth(width : int) -> None");
...
PyDoc_STRVAR(doc_wxHeaderCtrlEvent_SetNewOrder, "SetNewOrder(order : int) -> None");
...
PyDoc_STRVAR(doc_wxHeaderCtrlEvent, "HeaderCtrlEvent(commandType: EventType=wxEVT_NULL, winid: int=0) -> None\n"
"HeaderCtrlEvent(event : HeaderCtrlEvent) -> None\n"
"\n"
