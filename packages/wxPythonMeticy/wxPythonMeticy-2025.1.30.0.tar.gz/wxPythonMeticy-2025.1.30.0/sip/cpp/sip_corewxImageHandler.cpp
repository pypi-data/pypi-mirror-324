...
PyDoc_STRVAR(doc_wxImageHandler_CanRead, "CanRead(stream : InputStream) -> bool\n"
"CanRead(filename : str) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageHandler_GetImageCount, "GetImageCount(stream : InputStream) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageHandler_LoadFile, "LoadFile(image : Image, stream : InputStream, verbose: bool=True, index: int=-1) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageHandler_SaveFile, "SaveFile(image : Image, stream : OutputStream, verbose: bool=True) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageHandler_SetExtension, "SetExtension(extension : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageHandler_SetAltExtensions, "SetAltExtensions(extensions : List[str]) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageHandler_SetMimeType, "SetMimeType(mimetype : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageHandler_SetName, "SetName(name : str) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageHandler_SetType, "SetType(type : BitmapType) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageHandler_DoGetImageCount, "DoGetImageCount(stream : InputStream) -> int\n"
"\n"
...
PyDoc_STRVAR(doc_wxImageHandler_DoCanRead, "DoCanRead(stream : InputStream) -> bool\n"
"\n"
