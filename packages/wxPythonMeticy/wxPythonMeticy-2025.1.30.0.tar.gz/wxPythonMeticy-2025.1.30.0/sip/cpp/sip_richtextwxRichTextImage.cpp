...
PyDoc_STRVAR(doc_wxRichTextImage_Draw, "Draw(dc : wx.DC, context : RichTextDrawingContext, range : RichTextRange, selection : RichTextSelection, rect : wx.Rect, descent : int, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImage_Layout, "Layout(dc : wx.DC, context : RichTextDrawingContext, rect : wx.Rect, parentRect : wx.Rect, style : int) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImage_GetRangeSize, "GetRangeSize(range : RichTextRange, size : wx.Size, descent : int, dc : wx.DC, context : RichTextDrawingContext, flags : int, position: wx.Point=wx.Point(0,0), parentSize: wx.Size=wx.DefaultSize, partialExtents: Optional[List[int]]=None) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImage_EditProperties, "EditProperties(parent : wx.Window, buffer : RichTextBuffer) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImage_ImportFromXML, "ImportFromXML(buffer : RichTextBuffer, node : XmlNode, handler : RichTextXMLHandler, recurse : bool) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImage_SetImageCache, "SetImageCache(bitmap : wx.Bitmap) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImage_SetOriginalImageSize, "SetOriginalImageSize(sz : wx.Size) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImage_Copy, "Copy(obj : RichTextImage) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImage_LoadImageCache, "LoadImageCache(dc : wx.DC, context : RichTextDrawingContext, retImageSize : wx.Size, resetCache: bool=False, parentSize: wx.Size=wx.DefaultSize) -> bool\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImage_LoadAndScaleImageCache, "LoadAndScaleImageCache(image : wx.Image, sz : wx.Size, context : RichTextDrawingContext, changed : bool) -> Tuple[bool, bool]\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImage_SetImageState, "SetImageState(state : int) -> None\n"
"\n"
...
PyDoc_STRVAR(doc_wxRichTextImage, "RichTextImage(parent: Optional[RichTextObject]=None) -> None\n"
"RichTextImage(image : wx.Image, parent: Optional[RichTextObject]=None, charStyle: Optional[RichTextAttr]=None) -> None\n"
"RichTextImage(imageBlock : RichTextImageBlock, parent: Optional[RichTextObject]=None, charStyle: Optional[RichTextAttr]=None) -> None\n"
