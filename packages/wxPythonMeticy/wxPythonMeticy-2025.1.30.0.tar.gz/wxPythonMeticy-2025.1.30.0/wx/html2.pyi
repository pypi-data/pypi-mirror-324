...
class WebViewHandler:
    ...
    SecurityURL = property(GetSecurityURL, SetSecurityURL)
...
class WebView(wx.Control):
    ...
    def RunScript(self, javascript : str) -> Tuple[bool, str]:
        """
        RunScript(javascript : str) -> Tuple[bool, str]
    ...
    def RunScriptAsync(self, javascript : str, clientData: Optional[Any]=None) -> None:
        """
        RunScriptAsync(javascript : str, clientData: Optional[Any]=None) -> None
    ...
    def AddScriptMessageHandler(self, name : str) -> bool:
        """
        AddScriptMessageHandler(name : str) -> bool
    ...
    def RemoveScriptMessageHandler(self, name : str) -> bool:
        """
        RemoveScriptMessageHandler(name : str) -> bool
    ...
    def AddUserScript(self, javascript : str, injectionTime: WebViewUserScriptInjectionTime=WEBVIEW_INJECT_AT_DOCUMENT_START) -> bool:
        """
        AddUserScript(javascript : str, injectionTime: WebViewUserScriptInjectionTime=WEBVIEW_INJECT_AT_DOCUMENT_START) -> bool
    ...
    def EnableContextMenu(self, enable: bool=True) -> None:
        """
        EnableContextMenu(enable: bool=True) -> None
    ...
    def EnableAccessToDevTools(self, enable: bool=True) -> None:
        """
        EnableAccessToDevTools(enable: bool=True) -> None
    ...
    def SetUserAgent(self, userAgent : str) -> bool:
        """
        SetUserAgent(userAgent : str) -> bool
    ...
    def EnableHistory(self, enable: bool=True) -> None:
        """
        EnableHistory(enable: bool=True) -> None
    ...
    def Find(self, text : str, flags: WebViewFindFlags=WEBVIEW_FIND_DEFAULT) -> int:
        """
        Find(text : str, flags: WebViewFindFlags=WEBVIEW_FIND_DEFAULT) -> int
    ...
    def CanSetZoomType(self, type : WebViewZoomType) -> bool:
        """
        CanSetZoomType(type : WebViewZoomType) -> bool
    ...
    def SetZoomType(self, zoomType : WebViewZoomType) -> None:
        """
        SetZoomType(zoomType : WebViewZoomType) -> None
    ...
    def Create(self, parent : wx.Window, id: int=wx.ID_ANY, url: str=WebViewDefaultURLStr, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=0, name: str=WebViewNameStr) -> bool:
        """
        Create(parent : wx.Window, id: int=wx.ID_ANY, url: str=WebViewDefaultURLStr, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=0, name: str=WebViewNameStr) -> bool
    ...
    def RegisterHandler(self, handler : WebViewHandler) -> None:
        """
        RegisterHandler(handler : WebViewHandler) -> None
    ...
    def Reload(self, flags: WebViewReloadFlags=WEBVIEW_RELOAD_DEFAULT) -> None:
        """
        Reload(flags: WebViewReloadFlags=WEBVIEW_RELOAD_DEFAULT) -> None
    ...
    def SetEditable(self, enable: bool=True) -> None:
        """
        SetEditable(enable: bool=True) -> None
    ...
    def SetPage(self, html : str, baseUrl : str) -> None:
        """
        SetPage(html : str, baseUrl : str) -> None
    ...
    def New(backend: str=WebViewBackendDefault) -> WebView:
        """
        New(backend: str=WebViewBackendDefault) -> WebView
    ...
    def RegisterFactory(backend : str, factory : WebViewFactory) -> None:
        """
        RegisterFactory(backend : str, factory : WebViewFactory) -> None
    ...
    def IsBackendAvailable(backend : str) -> bool:
        """
        IsBackendAvailable(backend : str) -> bool
    ...
    def GetBackendVersionInfo(backend: str=WebViewBackendDefault) -> wx.VersionInfo:
        """
        GetBackendVersionInfo(backend: str=WebViewBackendDefault) -> wx.VersionInfo
    ...
    def MSWSetEmulationLevel(level: WebViewIE_EmulationLevel=WEBVIEWIE_EMU_IE11) -> bool:
        """
        MSWSetEmulationLevel(level: WebViewIE_EmulationLevel=WEBVIEWIE_EMU_IE11) -> bool
    ...
    def MSWSetModernEmulationLevel(modernLevel: bool=True) -> bool:
        """
        MSWSetModernEmulationLevel(modernLevel: bool=True) -> bool
        """
    BackwardHistory = property(GetBackwardHistory)
    CurrentTitle = property(GetCurrentTitle)
    CurrentURL = property(GetCurrentURL)
    ForwardHistory = property(GetForwardHistory)
    NativeBackend = property(GetNativeBackend)
    PageSource = property(GetPageSource)
    PageText = property(GetPageText)
    SelectedSource = property(GetSelectedSource)
    SelectedText = property(GetSelectedText)
    UserAgent = property(GetUserAgent, SetUserAgent)
    Zoom = property(GetZoom, SetZoom)
    ZoomFactor = property(GetZoomFactor, SetZoomFactor)
    ZoomType = property(GetZoomType, SetZoomType)
...
class WebViewEvent(wx.NotifyEvent):
    """
    WebViewEvent() -> None
    WebViewEvent(type : EventType, id : int, href : str, target : str, flags: WebViewNavigationActionFlags=WEBVIEW_NAV_ACTION_NONE, messageHandler: str="") -> None
    ...
    def IsError(self, ) -> bool:
        ...
        """
    MessageHandler = property(GetMessageHandler)
    NavigationAction = property(GetNavigationAction)
...
class WebViewFactory(wx.Object):
    ...
    def Create(self, ) -> WebView:
        """
        Create() -> WebView
        Create(parent : wx.Window, id : int, url: str=WebViewDefaultURLStr, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=0, name: str=WebViewNameStr) -> WebView
    ...
    def GetVersionInfo(self, ) -> wx.VersionInfo:
        ...
        """
    VersionInfo = property(GetVersionInfo)
