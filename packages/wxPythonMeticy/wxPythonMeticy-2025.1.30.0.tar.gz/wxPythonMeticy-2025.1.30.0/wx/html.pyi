...
class HtmlSelection:
    ...
    def Set(self, fromPos : wx.Point, fromCell : HtmlCell, toPos : wx.Point, toCell : HtmlCell) -> None:
        """
        Set(fromPos : wx.Point, fromCell : HtmlCell, toPos : wx.Point, toCell : HtmlCell) -> None
        Set(fromCell : HtmlCell, toCell : HtmlCell) -> None
        """
    ...
    def SetFromCharacterPos(self, pos : int) -> None:
        """
        SetFromCharacterPos(pos : int) -> None
        """

    def SetToCharacterPos(self, pos : int) -> None:
        """
        SetToCharacterPos(pos : int) -> None
        """
    ...
    def IsEmpty(self, ) -> bool:
        ...
        IsEmpty() -> bool
        """
    FromCell = property(GetFromCell)
    FromCharacterPos = property(GetFromCharacterPos, SetFromCharacterPos)
    FromPos = property(GetFromPos)
    ToCell = property(GetToCell)
    ToCharacterPos = property(GetToCharacterPos, SetToCharacterPos)
    ToPos = property(GetToPos)
...
class HtmlRenderingState:
    ...
    def SetSelectionState(self, s : HtmlSelectionState) -> None:
        """
        SetSelectionState(s : HtmlSelectionState) -> None
        """
    ...
    def GetBgMode(self, ) -> int:
        ...
        GetBgMode() -> int
        """
    BgColour = property(GetBgColour, SetBgColour)
    BgMode = property(GetBgMode, SetBgMode)
    FgColour = property(GetFgColour, SetFgColour)
    SelectionState = property(GetSelectionState, SetSelectionState)
...
class HtmlRenderingStyle:
    ...
    def GetSelectedTextColour(self, clr : wx.Colour) -> wx.Colour:
        """
        GetSelectedTextColour(clr : wx.Colour) -> wx.Colour
    ...
    def GetSelectedTextBgColour(self, clr : wx.Colour) -> wx.Colour:
        """
        GetSelectedTextBgColour(clr : wx.Colour) -> wx.Colour
...
class HtmlRenderingInfo:
    ...
    def SetSelection(self, s : HtmlSelection) -> None:
        """
        SetSelection(s : HtmlSelection) -> None
    ...
    def SetStyle(self, style : HtmlRenderingStyle) -> None:
        """
        SetStyle(style : HtmlRenderingStyle) -> None
...
class HtmlCell(wx.Object):
    ...
    def AdjustPagebreak(self, pagebreak : int, pageHeight : int) -> Tuple[bool, int]:
        """
        AdjustPagebreak(pagebreak : int, pageHeight : int) -> Tuple[bool, int]
    ...
    def Draw(self, dc : wx.DC, x : int, y : int, view_y1 : int, view_y2 : int, info : HtmlRenderingInfo) -> None:
        """
        Draw(dc : wx.DC, x : int, y : int, view_y1 : int, view_y2 : int, info : HtmlRenderingInfo) -> None
    ...
    def DrawInvisible(self, dc : wx.DC, x : int, y : int, info : HtmlRenderingInfo) -> None:
        """
        DrawInvisible(dc : wx.DC, x : int, y : int, info : HtmlRenderingInfo) -> None
    ...
    def Find(self, condition : int, param : str) -> HtmlCell:
        """
        Find(condition : int, param : str) -> HtmlCell
    ...
    def FindCellByPos(self, x : int, y : int, flags: int=HTML_FIND_EXACT) -> HtmlCell:
        """
        FindCellByPos(x : int, y : int, flags: int=HTML_FIND_EXACT) -> HtmlCell
    ...
    def GetLink(self, x: int=0, y: int=0) -> HtmlLinkInfo:
        """
        GetLink(x: int=0, y: int=0) -> HtmlLinkInfo
    ...
    def GetMouseCursor(self, window : HtmlWindowInterface) -> wx.Cursor:
        """
        GetMouseCursor(window : HtmlWindowInterface) -> wx.Cursor
    ...
    def GetMouseCursorAt(self, window : HtmlWindowInterface, rePos : wx.Point) -> wx.Cursor:
        """
        GetMouseCursorAt(window : HtmlWindowInterface, rePos : wx.Point) -> wx.Cursor
    ...
    def ProcessMouseClick(self, window : HtmlWindowInterface, pos : wx.Point, event : wx.MouseEvent) -> bool:
        """
        ProcessMouseClick(window : HtmlWindowInterface, pos : wx.Point, event : wx.MouseEvent) -> bool
    ...
    def SetLink(self, link : HtmlLinkInfo) -> None:
        """
        SetLink(link : HtmlLinkInfo) -> None
    ...
    def SetParent(self, p : HtmlContainerCell) -> None:
        """
        SetParent(p : HtmlContainerCell) -> None
    ...
    def ConvertToText(self, sel : HtmlSelection) -> str:
        """
        ConvertToText(sel : HtmlSelection) -> str
    ...
    def GetAbsPos(self, rootCell: Optional[HtmlCell]=None) -> wx.Point:
        """
        GetAbsPos(rootCell: Optional[HtmlCell]=None) -> wx.Point
        """
    ...
    def GetRootCell(self, ) -> HtmlCell:
        ...
        """
    AbsPos = property(GetAbsPos)
    Descent = property(GetDescent)
...
class HtmlContainerCell(HtmlCell):
    """
    HtmlContainerCell(parent : HtmlContainerCell) -> None
    ...
    def SetBackgroundColour(self, clr : wx.Colour) -> None:
        """
        SetBackgroundColour(clr : wx.Colour) -> None
    ...
    def SetBorder(self, clr1 : wx.Colour, clr2 : wx.Colour, border: int=1) -> None:
        """
        SetBorder(clr1 : wx.Colour, clr2 : wx.Colour, border: int=1) -> None
    ...
    def SetIndent(self, i : int, what : int, units: int=HTML_UNITS_PIXELS) -> None:
        """
        SetIndent(i : int, what : int, units: int=HTML_UNITS_PIXELS) -> None
    ...
    def SetMinHeight(self, h : int, align: int=HTML_ALIGN_TOP) -> None:
        """
        SetMinHeight(h : int, align: int=HTML_ALIGN_TOP) -> None
    ...
    def SetWidthFloat(self, w : int, units : int) -> None:
        """
        SetWidthFloat(w : int, units : int) -> None
        SetWidthFloat(tag : HtmlTag, pixel_scale: float=1.0) -> None
        
        Sets floating width adjustment.
        """
    AlignHor = property(GetAlignHor, SetAlignHor)
    AlignVer = property(GetAlignVer, SetAlignVer)
...
class HtmlColourCell(HtmlCell):
    """
    HtmlColourCell(clr : wx.Colour, flags: int=HTML_CLR_FOREGROUND) -> None
...
class HtmlWidgetCell(HtmlCell):
    """
    HtmlWidgetCell(wnd : wx.Window, w: int=0) -> None
...
class HtmlWordCell(HtmlCell):
    """
    HtmlWordCell(word : str, dc : wx.DC) -> None
...
class HtmlWordWithTabsCell(HtmlWordCell):
    """
    HtmlWordWithTabsCell(word : str, wordOrig : str, linepos : int, dc : wx.DC) -> None
...
class HtmlFontCell(HtmlCell):
    """
    HtmlFontCell(font : wx.Font) -> None
...
class HtmlTag:
    ...
    def GetParam(self, par : str, with_quotes: bool=False) -> str:
        """
        GetParam(par : str, with_quotes: bool=False) -> str
    ...
    def GetParamAsColour(self, par : str) -> Tuple[bool, wx.Colour]:
        """
        GetParamAsColour(par : str) -> Tuple[bool, wx.Colour]
    ...
    def GetParamAsInt(self, par : str) -> Tuple[bool, int]:
        """
        GetParamAsInt(par : str) -> Tuple[bool, int]
    ...
    def GetParamAsString(self, par : str, value : str) -> bool:
        """
        GetParamAsString(par : str, value : str) -> bool
    ...
    def ParseAsColour(str : str) -> Tuple[bool, wx.Colour]:
        """
        ParseAsColour(str : str) -> Tuple[bool, wx.Colour]
        
        Parses the given string as an HTML colour.
        """
    AllParams = property(GetAllParams)
...
class HtmlTagHandler(wx.Object):
    ...
    def SetParser(self, parser : HtmlParser) -> None:
        """
        SetParser(parser : HtmlParser) -> None
    ...
    def GetParser(self, ) -> HtmlParser:
        ...
        """
    Parser = property(GetParser, SetParser)
    SupportedTags = property(GetSupportedTags)

    def ParseInner(self, tag : HtmlTag) -> None:
        """
        ParseInner(tag : HtmlTag) -> None
    ...
    def ParseInnerSource(self, source : str) -> None:
        """
        ParseInnerSource(source : str) -> None
...
class HtmlParser:
    ...
    def AddTagHandler(self, handler : HtmlTagHandler) -> None:
        """
        AddTagHandler(handler : HtmlTagHandler) -> None
    ...
    def OpenURL(self, type : HtmlURLType, url : str) -> wx.FSFile:
        """
        OpenURL(type : HtmlURLType, url : str) -> wx.FSFile
    ...
    def PushTagHandler(self, handler : HtmlTagHandler, tags : str) -> None:
        """
        PushTagHandler(handler : HtmlTagHandler, tags : str) -> None
...
class HtmlWindowInterface:
    ...
    def SetHTMLWindowTitle(self, title : str) -> None:
        """
        SetHTMLWindowTitle(title : str) -> None
    ...
    def OnHTMLLinkClicked(self, link : HtmlLinkInfo) -> None:
        """
        OnHTMLLinkClicked(link : HtmlLinkInfo) -> None
    ...
    def OnHTMLOpeningURL(self, type : HtmlURLType, url : str) -> Tuple[HtmlOpeningStatus, str]:
        """
        OnHTMLOpeningURL(type : HtmlURLType, url : str) -> Tuple[HtmlOpeningStatus, str]
    ...
    def HTMLCoordsToWindow(self, cell : HtmlCell, pos : wx.Point) -> wx.Point:
        """
        HTMLCoordsToWindow(cell : HtmlCell, pos : wx.Point) -> wx.Point
    ...
    def SetHTMLBackgroundColour(self, clr : wx.Colour) -> None:
        """
        SetHTMLBackgroundColour(clr : wx.Colour) -> None
    ...
    def SetHTMLBackgroundImage(self, bmpBg : wx.BitmapBundle) -> None:
        """
        SetHTMLBackgroundImage(bmpBg : wx.BitmapBundle) -> None
    ...
    def SetHTMLStatusText(self, text : str) -> None:
        """
        SetHTMLStatusText(text : str) -> None
    ...
    def GetHTMLCursor(self, type : HtmlWindowInterface.HTMLCursor) -> wx.Cursor:
        """
        GetHTMLCursor(type : HtmlWindowInterface.HTMLCursor) -> wx.Cursor
        
        Returns mouse cursor of given type.
        """
    HTMLBackgroundColour = property(GetHTMLBackgroundColour, SetHTMLBackgroundColour)
...
class HtmlWindow(wx.ScrolledWindow, HtmlWindowInterface):
    """
    HtmlWindow() -> None
    HtmlWindow(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=HW_DEFAULT_STYLE, name: str="htmlWindow") -> None
    ...
    def OnOpeningURL(self, type : HtmlURLType, url : str) -> Tuple[HtmlOpeningStatus, str]:
        """
        OnOpeningURL(type : HtmlURLType, url : str) -> Tuple[HtmlOpeningStatus, str]
    ...
    def ReadCustomization(self, cfg : wx.ConfigBase, path: str='') -> None:
        """
        ReadCustomization(cfg : wx.ConfigBase, path: str='') -> None
    ...
    def SetFonts(self, normal_face : str, fixed_face : str, sizes : List[int]) -> None:
        """
        SetFonts(normal_face : str, fixed_face : str, sizes : List[int]) -> None
    ...
    def SetStandardFonts(self, size: int=-1, normal_face: str='', fixed_face: str='') -> None:
        """
        SetStandardFonts(size: int=-1, normal_face: str='', fixed_face: str='') -> None
    ...
    def SetRelatedFrame(self, frame : wx.Frame, format : str) -> None:
        """
        SetRelatedFrame(frame : wx.Frame, format : str) -> None
    ...
    def SetRelatedStatusBar(self, index : int) -> None:
        """
        SetRelatedStatusBar(index : int) -> None
        SetRelatedStatusBar(statusbar : wx.StatusBar, index: int=0) -> None
    ...
    def WriteCustomization(self, cfg : wx.ConfigBase, path: str='') -> None:
        """
        WriteCustomization(cfg : wx.ConfigBase, path: str='') -> None
    ...
    def AddFilter(filter : HtmlFilter) -> None:
        """
        AddFilter(filter : HtmlFilter) -> None
    ...
    def GetDefaultHTMLCursor(type : HTMLCursor) -> wx.Cursor:
        """
        GetDefaultHTMLCursor(type : HTMLCursor) -> wx.Cursor
    ...
    def SetDefaultHTMLCursor(type : HTMLCursor, cursor : wx.Cursor) -> None:
        """
        SetDefaultHTMLCursor(type : HTMLCursor, cursor : wx.Cursor) -> None
    ...
    def GetClassDefaultAttributes(variant: wx.WindowVariant=wx.WINDOW_VARIANT_NORMAL) -> wx.VisualAttributes:
        ...
        """
    InternalRepresentation = property(GetInternalRepresentation)
    OpenedAnchor = property(GetOpenedAnchor)
    OpenedPage = property(GetOpenedPage)
    OpenedPageTitle = property(GetOpenedPageTitle)
    Parser = property(GetParser)
    RelatedFrame = property(GetRelatedFrame, SetRelatedFrame)

    def OnCellClicked(self, cell : HtmlCell, x : int, y : int, event : wx.MouseEvent) -> bool:
        """
        OnCellClicked(cell : HtmlCell, x : int, y : int, event : wx.MouseEvent) -> bool
    ...
    def OnCellMouseHover(self, cell : HtmlCell, x : int, y : int) -> None:
        """
        OnCellMouseHover(cell : HtmlCell, x : int, y : int) -> None
    ...
    def ScrollToAnchor(self, anchor : str) -> bool:
        """
        ScrollToAnchor(anchor : str) -> bool
        """
...
class HtmlLinkEvent(wx.CommandEvent):
    ...
    def GetLinkInfo(self, ) -> HtmlLinkInfo:
        ...
        """
    LinkInfo = property(GetLinkInfo)
# end of class HtmlLinkEvent


class HtmlCellEvent(wx.CommandEvent):
    """
    HtmlCellEvent(commandType : EventType, id : int, cell : HtmlCell, point : wx.Point, ev : wx.MouseEvent) -> None
    ...
    def SetLinkClicked(self, linkclicked : bool) -> None:
        """
        SetLinkClicked(linkclicked : bool) -> None
        ...
        default).
        """
    Cell = property(GetCell)
    LinkClicked = property(GetLinkClicked, SetLinkClicked)
...
class HtmlDCRenderer(wx.Object):
    ...
    def Render(self, x : int, y : int, from_: int=0, to_: int=INT_MAX) -> None:
        """
        Render(x : int, y : int, from_: int=0, to_: int=INT_MAX) -> None
    ...
    def SetDC(self, dc : wx.DC, pixel_scale: float=1.0) -> None:
        """
        SetDC(dc : wx.DC, pixel_scale: float=1.0) -> None
    ...
    def SetHtmlText(self, html : str, basepath: str='', isdir: bool=True) -> None:
        """
        SetHtmlText(html : str, basepath: str='', isdir: bool=True) -> None
    ...
    def SetHtmlCell(self, cell : HtmlContainerCell) -> None:
        """
        SetHtmlCell(cell : HtmlContainerCell) -> None
    ...
    def SetSize(self, width : int, height : int) -> None:
        ...
        """
    TotalHeight = property(GetTotalHeight)
    TotalWidth = property(GetTotalWidth)
# end of class HtmlDCRenderer


class HtmlEasyPrinting(wx.Object):
    """
    HtmlEasyPrinting(name: str="Printing", parentWindow: Optional[wx.Window]=None) -> None
    ...
    def PreviewText(self, htmltext : str, basepath: str='') -> bool:
        """
        PreviewText(htmltext : str, basepath: str='') -> bool
    ...
    def PrintText(self, htmltext : str, basepath: str='') -> bool:
        """
        PrintText(htmltext : str, basepath: str='') -> bool
    ...
    def SetFooter(self, footer : str, pg: int=PAGE_ALL) -> None:
        """
        SetFooter(footer : str, pg: int=PAGE_ALL) -> None
    ...
    def SetHeader(self, header : str, pg: int=PAGE_ALL) -> None:
        """
        SetHeader(header : str, pg: int=PAGE_ALL) -> None
    ...
    def SetParentWindow(self, window : wx.Window) -> None:
        """
        SetParentWindow(window : wx.Window) -> None
    ...
    def SetPromptMode(self, promptMode : PromptMode) -> None:
        """
        SetPromptMode(promptMode : PromptMode) -> None
        
        Enable or disable showing the dialog before printing.
        """
    Name = property(GetName, SetName)
    PageSetupData = property(GetPageSetupData)
...
class HtmlPrintout(wx.Printout):
    ...
    def SetMargins(self, top: float=25.2, bottom: float=25.2, left: float=25.2, right: float=25.2, spaces: float=5) -> None:
        """
        SetMargins(top: float=25.2, bottom: float=25.2, left: float=25.2, right: float=25.2, spaces: float=5) -> None
        SetMargins(pageSetupData : wx.PageSetupDialogData) -> None
...
class HtmlWinParser(HtmlParser):
    ...
    def SetActualColor(self, clr : wx.Colour) -> None:
        """
        SetActualColor(clr : wx.Colour) -> None
    ...
    def SetContainer(self, c : HtmlContainerCell) -> HtmlContainerCell:
        """
        SetContainer(c : HtmlContainerCell) -> HtmlContainerCell
    ...
    def SetDC(self, dc : wx.DC, pixel_scale: float=1.0e+0) -> None:
        """
        SetDC(dc : wx.DC, pixel_scale: float=1.0e+0) -> None
    ...
    def SetLinkColor(self, clr : wx.Colour) -> None:
        """
        SetLinkColor(clr : wx.Colour) -> None
        
        Sets colour of hypertext link.
        """
    ActualColor = property(GetActualColor, SetActualColor)
    ...
    FontBold = property(GetFontBold, SetFontBold)
    FontFace = property(GetFontFace, SetFontFace)
    FontFixed = property(GetFontFixed, SetFontFixed)
    FontItalic = property(GetFontItalic, SetFontItalic)
    FontSize = property(GetFontSize, SetFontSize)
    FontUnderlined = property(GetFontUnderlined, SetFontUnderlined)
    Link = property(GetLink, SetLink)
    LinkColor = property(GetLinkColor, SetLinkColor)
    WindowInterface = property(GetWindowInterface)
# end of class HtmlWinParser


def HtmlWinParser_AddTagHandler(self, tagHandlerClass: Any) -> None:
    """
    HtmlWinParser_AddTagHandler(tagHandlerClass: Any) -> None
    """
#-- end-htmlwinpars --#
#-- begin-helpdata --#
...
class HtmlBookRecord:
    """
    HtmlBookRecord(bookfile : str, basepath : str, title : str, start : str) -> None
    ...
    def SetContentsRange(self, start : int, end : int) -> None:
        """
        SetContentsRange(start : int, end : int) -> None
        """
    ...
    def SetBasePath(self, path : str) -> None:
        """
        SetBasePath(path : str) -> None
        """

    def SetStart(self, start : str) -> None:
        """
        SetStart(start : str) -> None
        """

    def GetFullPath(self, page : str) -> str:
        """
        GetFullPath(page : str) -> str
        """
    BasePath = property(GetBasePath, SetBasePath)
    BookFile = property(GetBookFile)
    ContentsEnd = property(GetContentsEnd)
    ContentsStart = property(GetContentsStart)
...
class HtmlHelpDataItem:
    ...
    def GetIndentedName(self, ) -> str:
        ...
        GetIndentedName() -> str
        """
    FullPath = property(GetFullPath)
    IndentedName = property(GetIndentedName)
...
class HtmlHelpData(wx.Object):
    ...
    def SetTempDir(self, path : str) -> None:
        """
        SetTempDir(path : str) -> None
        
        Sets the temporary directory where binary cached versions of MS HTML
        Workshop files will be stored.
        """
    BookRecArray = property(GetBookRecArray)
    ContentsArray = property(GetContentsArray)
    IndexArray = property(GetIndexArray)
...
class HtmlHelpFrame(wx.Frame):
    ...
    HtmlHelpFrame(parent : wx.Window, id: int=wx.ID_ANY, title: str='', style: int=HF_DEFAULT_STYLE, data: Optional[HtmlHelpData]=None, config: Optional[wx.ConfigBase]=None, rootpath: str='') -> None
    
    This class is used by wxHtmlHelpController to display help.
    """

    @overload
    def __init__(self, parent : wx.Window, id: int=wx.ID_ANY, title: str='', style: int=HF_DEFAULT_STYLE, data: Optional[HtmlHelpData]=None, config: Optional[wx.ConfigBase]=None, rootpath: str='') -> None:
        ...
    ...
    def AddToolbarButtons(self, toolBar : wx.ToolBar, style : int) -> None:
        """
        AddToolbarButtons(toolBar : wx.ToolBar, style : int) -> None
    ...
    def Create(self, parent : wx.Window, id: int=wx.ID_ANY, title: str='', style: int=HF_DEFAULT_STYLE, config: Optional[wx.ConfigBase]=None, rootpath: str='') -> bool:
        """
        Create(parent : wx.Window, id: int=wx.ID_ANY, title: str='', style: int=HF_DEFAULT_STYLE, config: Optional[wx.ConfigBase]=None, rootpath: str='') -> bool
    ...
    def SetController(self, controller : HtmlHelpController) -> None:
        """
        SetController(controller : HtmlHelpController) -> None
    ...
    def SetTitleFormat(self, format : str) -> None:
        """
        SetTitleFormat(format : str) -> None
...
class HtmlHelpDialog(wx.Dialog):
    ...
    HtmlHelpDialog(parent : wx.Window, id: int=wx.ID_ANY, title: str='', style: int=HF_DEFAULT_STYLE, data: Optional[HtmlHelpData]=None) -> None
    
    This class is used by wxHtmlHelpController to display help.
    """

    @overload
    def __init__(self, parent : wx.Window, id: int=wx.ID_ANY, title: str='', style: int=HF_DEFAULT_STYLE, data: Optional[HtmlHelpData]=None) -> None:
        ...
    ...
    def Create(self, parent : wx.Window, id: int=wx.ID_ANY, title: str='', style: int=HF_DEFAULT_STYLE) -> bool:
        """
        Create(parent : wx.Window, id: int=wx.ID_ANY, title: str='', style: int=HF_DEFAULT_STYLE) -> bool
...
class HtmlHelpWindow(wx.Window):
    ...
    HtmlHelpWindow(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=wx.TAB_TRAVERSAL|wx.BORDER_NONE, helpStyle: int=HF_DEFAULT_STYLE, data: Optional[HtmlHelpData]=None) -> None
    ...
    def Create(self, parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=wx.TAB_TRAVERSAL|wx.BORDER_NONE, helpStyle: int=HF_DEFAULT_STYLE) -> bool:
        """
        Create(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=wx.TAB_TRAVERSAL|wx.BORDER_NONE, helpStyle: int=HF_DEFAULT_STYLE) -> bool
    ...
    def KeywordSearch(self, keyword : str, mode: wx.HelpSearchMode=wx.HELP_SEARCH_ALL) -> bool:
        """
        KeywordSearch(keyword : str, mode: wx.HelpSearchMode=wx.HELP_SEARCH_ALL) -> bool
    ...
    def UseConfig(self, config : wx.ConfigBase, rootpath: str='') -> None:
        """
        UseConfig(config : wx.ConfigBase, rootpath: str='') -> None
...
class HtmlHelpController(wx.HelpControllerBase):
    """
    HtmlHelpController(style: int=HF_DEFAULT_STYLE, parentWindow: Optional[wx.Window]=None) -> None
    HtmlHelpController(parentWindow : wx.Window, style: int=HF_DEFAULT_STYLE) -> None
    ...
    def AddBook(self, bookFile : str, showWaitMsg: bool=False) -> bool:
        """
        AddBook(bookFile : str, showWaitMsg: bool=False) -> bool
        AddBook(bookUrl : str, showWaitMsg: bool=False) -> bool
    ...
    def SetShouldPreventAppExit(self, enable : bool) -> None:
        """
        SetShouldPreventAppExit(enable : bool) -> None
    ...
    def SetHelpWindow(self, helpWindow : HtmlHelpWindow) -> None:
        """
        SetHelpWindow(helpWindow : HtmlHelpWindow) -> None
    ...
    HelpWindow = property(GetHelpWindow, SetHelpWindow)

    def CreateHelpDialog(self, data : HtmlHelpData) -> HtmlHelpDialog:
        """
        CreateHelpDialog(data : HtmlHelpData) -> HtmlHelpDialog
    ...
    def CreateHelpFrame(self, data : HtmlHelpData) -> HtmlHelpFrame:
        """
        CreateHelpFrame(data : HtmlHelpData) -> HtmlHelpFrame
...
class HtmlModalHelp:
    """
    HtmlModalHelp(parent : wx.Window, helpFile : str, topic: str='', style: int=HF_DEFAULT_STYLE|HF_DIALOG|HF_MODAL) -> None
...
class HtmlListBox(wx.VListBox):
    """
    HtmlListBox(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=0, name: str=HtmlListBoxNameStr) -> None
    HtmlListBox() -> None
    ...
    def Create(self, parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=0, name: str=HtmlListBoxNameStr) -> bool:
        """
        Create(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, style: int=0, name: str=HtmlListBoxNameStr) -> bool
    ...
    def OnLinkClicked(self, n : int, link : HtmlLinkInfo) -> None:
        """
        OnLinkClicked(n : int, link : HtmlLinkInfo) -> None
    ...
    def GetSelectedTextBgColour(self, colBg : wx.Colour) -> wx.Colour:
        """
        GetSelectedTextBgColour(colBg : wx.Colour) -> wx.Colour
    ...
    def GetSelectedTextColour(self, colFg : wx.Colour) -> wx.Colour:
        """
        GetSelectedTextColour(colFg : wx.Colour) -> wx.Colour
...
class SimpleHtmlListBox(HtmlListBox, wx.ItemContainer):
    """
    SimpleHtmlListBox(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, choices: List[str]=[], style: int=HLB_DEFAULT_STYLE, validator: wx.Validator=wx.DefaultValidator, name: str=SimpleHtmlListBoxNameStr) -> None
    ...
    def Create(self, parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, choices: List[str]=[], style: int=HLB_DEFAULT_STYLE, validator: wx.Validator=wx.DefaultValidator, name: str=SimpleHtmlListBoxNameStr) -> bool:
        """
        Create(parent : wx.Window, id: int=wx.ID_ANY, pos: wx.Point=wx.DefaultPosition, size: wx.Size=wx.DefaultSize, choices: List[str]=[], style: int=HLB_DEFAULT_STYLE, validator: wx.Validator=wx.DefaultValidator, name: str=SimpleHtmlListBoxNameStr) -> bool
