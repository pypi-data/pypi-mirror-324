...
class CoopVec:
    ...
    class MatrixDesc:
        ...
        @overload
        def __init__(self, rows: int, cols: int, element_type: DataType, layout: CoopVec.MatrixLayout, size: int, offset: int) -> None: ...
        ...
        @property
        def layout(self) -> CoopVec.MatrixLayout:
            """N/A"""

        @layout.setter
        def layout(self, arg: CoopVec.MatrixLayout, /) -> None: ...
    ...
    def query_matrix_size(self, arg0: int, arg1: int, arg2: CoopVec.MatrixLayout, arg3: DataType, /) -> int: ...

    def create_matrix_desc(self, rows: int, cols: int, layout: CoopVec.MatrixLayout, element_type: DataType, offset: int = 0) -> CoopVec.MatrixDesc: ...

    def convert_matrix_host(self, src: Annotated[ArrayLike, dict(device='cpu')], dst: Annotated[ArrayLike, dict(device='cpu')], src_layout: Optional[CoopVec.MatrixLayout] = None, dst_layout: Optional[CoopVec.MatrixLayout] = None) -> int: ...

    @overload
    def convert_matrix_device(self, src: Buffer, src_desc: CoopVec.MatrixDesc, dst: Buffer, dst_desc: CoopVec.MatrixDesc, cmd: Optional[CommandBuffer] = None) -> None: ...

    @overload
    def convert_matrix_device(self, src: Buffer, src_desc: Sequence[CoopVec.MatrixDesc], dst: Buffer, dst_desc: Sequence[CoopVec.MatrixDesc], cmd: Optional[CommandBuffer] = None) -> None: ...

    def align_matrix_offset(self, offset: int) -> int: ...

    def align_vector_offset(self, offset: int) -> int: ...

    matrix_alignment: int = ...
    """(arg: object, /) -> int"""

    vector_alignment: int = ...
    """(arg: object, /) -> int"""
...
class DeviceType(enum.Enum):
    _member_names_: list = ['automatic', 'd3d12', 'vulkan', 'cpu', 'cuda']
...
SGL_GIT_VERSION: str = 'commit: 2395d11 / branch: main (local changes)'

SGL_VERSION: str = '0.11.0'

SGL_VERSION_MAJOR: int = 0

SGL_VERSION_MINOR: int = 11
