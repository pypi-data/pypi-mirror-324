...
class Device(Object):
    ...
    @overload
    def coopvec_convert_matrix_device(self, src: Buffer, src_desc: CoopVecMatrixDesc, dst: Buffer, dst_desc: CoopVecMatrixDesc, cmd: Optional[CommandBuffer] = None) -> None:
        """N/A"""

    @overload
    def coopvec_convert_matrix_device(self, src: Buffer, src_desc: Sequence[CoopVecMatrixDesc], dst: Buffer, dst_desc: Sequence[CoopVecMatrixDesc], cmd: Optional[CommandBuffer] = None) -> None: ...
...
SGL_GIT_VERSION: str = 'commit: 20f2528 / branch: main (local changes)'

SGL_VERSION: str = '0.12.0'

SGL_VERSION_MAJOR: int = 0

SGL_VERSION_MINOR: int = 12
