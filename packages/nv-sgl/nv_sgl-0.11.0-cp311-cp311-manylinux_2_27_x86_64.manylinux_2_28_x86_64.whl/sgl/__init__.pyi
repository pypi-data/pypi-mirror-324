...
class CoopVec:
    ...
    def convert_matrix_host(self, src: Annotated[ArrayLike, dict(device='cpu')], dst: Annotated[ArrayLike, dict(device='cpu')], src_layout: CoopVec.MatrixLayout | None = None, dst_layout: CoopVec.MatrixLayout | None = None) -> int: ...

    @overload
    def convert_matrix_device(self, src: Buffer, src_desc: CoopVec.MatrixDesc, dst: Buffer, dst_desc: CoopVec.MatrixDesc, cmd: CommandBuffer | None = None) -> None: ...

    @overload
    def convert_matrix_device(self, src: Buffer, src_desc: Sequence[CoopVec.MatrixDesc], dst: Buffer, dst_desc: Sequence[CoopVec.MatrixDesc], cmd: CommandBuffer | None = None) -> None: ...
