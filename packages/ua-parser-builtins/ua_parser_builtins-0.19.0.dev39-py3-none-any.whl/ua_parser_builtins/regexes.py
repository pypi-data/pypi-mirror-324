...
USER_AGENT_PARSERS = [
    ...
    UserAgentParser('\\b(Boto3?|JetS3t|aws-(?:cli|sdk-(?:cpp|go|go-v\\d|java|nodejs|ruby2?|dotnet-(?:\\d{1,2}|core)))|s3fs)/(\\d+)\\.(\\d+)(?:\\.(\\d+)|)'),
    ...
    UserAgentParser('(RecipeRadar)/(\\d+)\\.(\\d+)(?:\\.(\\d+)|)'),
    ...
    UserAgentParser('(musical_ly) app_version\\/(\\d+)\\.(\\d+)\\.(\\d+)', 'TikTok'),
    UserAgentParser('(musical_ly_)(\\d+)\\.(\\d+)\\.(\\d+)', 'TikTok'),
    UserAgentParser('(BytedanceWebview)\\/[a-z0-9]+', 'TikTok'),
    UserAgentParser('Mozilla.{1,200}Mobile.{1,100}(Phantom\\/ios|Phantom\\/android).(\\d+)\\.(\\d+)\\.(\\d+)', 'Phantom'),
    ...
    UserAgentParser('(HuaweiBrowser)/(\\d+)\\.(\\d+)\\.(\\d+)\\.\\d+', 'Huawei Browser'),
    UserAgentParser('(AVG)/(\\d+)\\.(\\d+)\\.(\\d+)\\.\\d+', 'AVG'),
    UserAgentParser('(AvastSecureBrowser|Avast)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Avast Secure Browser'),
    UserAgentParser('(Instabridge)/(\\d+)(?:\\.(\\d+)|)(?:\\.(\\d+)|)'),
    UserAgentParser('(AlohaBrowser)/(\\d+)\\.(\\d+)\\.(\\d+)(?:\\.(\\d+)|)', 'Aloha Browser'),
    UserAgentParser('((?:B|b)rave(?:\\sChrome)?)/(\\d+)(?:\\.(\\d+)|)(?:\\.(\\d+)|)(?:\\.(\\d+)|)', 'Brave'),
    ...
    UserAgentParser('Mozilla.{1,200}Mobile.{1,100}(DuckDuckGo)/(\\d+)', 'DuckDuckGo Mobile'),
    UserAgentParser('Mozilla.{1,200}(DuckDuckGo)/(\\d+)', 'DuckDuckGo'),
    UserAgentParser('Mozilla.{1,200}Mobile.{1,100}(Ddg)/(\\d+)(?:\\.(\\d+)|)', 'DuckDuckGo Mobile'),
    UserAgentParser('Mozilla.{1,200}(Ddg)/(\\d+)(?:\\.(\\d+)|)', 'DuckDuckGo'),
    UserAgentParser('(Tenta/)(\\d+)\\.(\\d+)\\.(\\d+)', 'Tenta Browser'),
    UserAgentParser('(Ecosia) ios@(\\d+)(?:\\.(\\d+)|)(?:\\.(\\d+)|)(?:\\.(\\d+)|)', 'Ecosia iOS'),
    UserAgentParser('(Ecosia) android@(\\d+)(?:\\.(\\d+)|)(?:\\.(\\d+)|)(?:\\.(\\d+)|)', 'Ecosia Android'),
    UserAgentParser('(VivoBrowser)\\/(\\d+)\\.(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentParser('(HiBrowser)\\/v(\\d+)\\.(\\d+)\\.(\\d+)\\.(\\d+)'),
    ...
    UserAgentParser('(YaSearchBrowser)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Yandex Browser'),
    ...
    UserAgentParser('(Ladybird)\\/(\\d+)\\.(\\d+)'),
    UserAgentParser('(MullvadBrowser)/(\\d+)(?:\\.(\\d+)|)(?:\\.(\\d+)|)'),
]
...
OS_PARSERS = [
    ...
    OSParser('(Android) (\\d+)(?:\\.(\\d+)).*CrKey', 'Chromecast Android'),
    OSParser('Fuchsia.*(CrKey)(?:[/](\\d+)\\.(\\d+)(?:\\.(\\d+)|)|)', 'Chromecast Fuchsia'),
    OSParser('Linux.*(CrKey)(?:[/](\\d+)\\.(\\d+)(?:\\.(\\d+)|)|).*DeviceType/SmartSpeaker', 'Chromecast SmartSpeaker'),
    OSParser('Linux.*(CrKey)(?:[/](\\d+)\\.(\\d+)(?:\\.(\\d+)|)|)', 'Chromecast Linux'),
    ...
    OSParser('(Tizen)[/ ](\\d+)\\.(\\d+)'),
    OSParser('Intel Mac OS X.+(CriOS|EdgiOS)/\\d+', 'iOS'),
    ...
    OSParser('darwin; arm64', 'Mac OS X'),
    ...
    OSParser('CFNetwork/.{0,100} Darwin/22\\.([0-5])\\.\\d+', 'iOS', '16', '$1'),
    OSParser('CFNetwork/.{0,100} Darwin/(22)\\.\\d+', 'iOS', '16'),
    OSParser('CFNetwork/.{0,100} Darwin/23\\.([0-5])\\.\\d+', 'iOS', '17', '$1'),
    OSParser('CFNetwork/.{0,100} Darwin/(23)\\.\\d+', 'iOS', '17'),
    OSParser('CFNetwork/.{0,100} Darwin/24\\.([0-5])\\.\\d+', 'iOS', '18', '$1'),
    OSParser('CFNetwork/.{0,100} Darwin/(24)\\.\\d+', 'iOS', '18'),
    ...
    OSParser('os\\/macos[#]?(\\d*)[.]?(\\d*)[.]?(\\d*)', 'Mac OS X', '$1', '$2', '$3'),
    OSParser('(HarmonyOS)[\\s;]+(\\d+|)\\.?(\\d+|)\\.?(\\d+|)'),
]
...
DEVICE_PARSERS = [
    ...
    DeviceParser('CrKey.*DeviceType/([^/]*)', None, 'Chromecast', 'Google', '$1'),
    DeviceParser('Fuchsia.*CrKey', None, 'Chromecast', 'Google', 'Nest Hub'),
    DeviceParser('Linux.*CrKey/1.36', None, 'Chromecast', 'Google', 'First Generation'),
    DeviceParser('CrKey/', None, 'Chromecast', 'Google', 'Chromecast'),
    ...
    DeviceParser('Quest 3', None, 'Quest', 'Meta', 'Quest 3'),
    ...
    DeviceParser('Nintendo (Switch|DS|3DS|DSi|Wii);', None, 'Nintendo $1', 'Nintendo', '$1'),
