...
from quantfe.utils import calendar, helpers, day_count, frequency, qmath
...
class IborIborSwap:
    ...
    def __init__(self,
                 ...
                 payFreqType: frequency.FrequencyTypes = frequency.FrequencyTypes.QUARTERLY,
                 payDayCountType: day_count.DayCountTypes = day_count.DayCountTypes.THIRTY_E_360,
                 recFreqType: frequency.FrequencyTypes = frequency.FrequencyTypes.QUARTERLY,
                 recDayCountType: day_count.DayCountTypes = day_count.DayCountTypes.THIRTY_E_360,
        ...
        cal = calendar.CalendarTypes(cal_type)
        self.maturity_dt = cal.adjust(self._termination_dt,
                                            bd_type)
        ...
        self._payFloatDates = self._generate_pay_float_leg_payment_dts(self._payFreqType)
        self._recFloatDates = self._generate_pay_float_leg_payment_dts(self._recFreqType)
    ...
    def _generate_pay_float_leg_payment_dts(self, freq_type):
        ...
        floatDates = Schedule(self.effective_dt, 
