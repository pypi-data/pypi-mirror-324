...
from quantfe.utils import frequency, day_count, calendar
...
def get_bond_market_conventions(country):
    ...
    annual = frequency.FrequencyTypes.ANNUAL
    semi_annual = frequency.FrequencyTypes.SEMI_ANNUAL
    act_act = day_count.DayCountTypes.ACT_ACT_ICMA
    thirtye360 = day_count.DayCountTypes.THIRTY_E_360
    thirty360 = day_count.DayCountTypes.THIRTY_360_BOND
    ...
    if country == BondMarkets.AUSTRALIA:
        return (act_act, annual, 2, 7, calendar.CalendarTypes.NONE)
    ...
    if country == BondMarkets.SOUTH_AFRICA:
        return (act_act, annual, 2, 10, calendar.CalendarTypes.NONE)  # CHECK
    ...
    if country == BondMarkets.UNITED_KINGDOM:
        # OR 7 DAYS ?
        return (act_act, semi_annual, 1, 6, calendar.CalendarTypes.UNITED_KINGDOM)
