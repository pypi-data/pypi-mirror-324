...
from quantfe.utils import frequency
from quantfe.utils import global_vars
from quantfe.utils.date import Date, is_leap_year
    ...
    def year_frac(self,
        ...
        if self._type == DayCountTypes.THIRTY_360_BOND:
            ...
            if y1 == y2:
                ...
                day_years_1 = dt1.datediff(Date(y1 + 1, 1, 1))
                day_years_2 = Date(y2, 1, 1).datediff(dt2)
            ...
            freq = frequency.annual_frequency(freq_type)
