...
from quantfe.products.bonds.bond import YTMCalcType
from quantfe.utils.schedule import Schedule
from quantfe.utils import global_vars, helpers, day_count, frequency, qmath, calendar
...
class BondZero:
    ...
    def __init__(self,
        ...
        self.dc_type = day_count.DayCountTypes.ZERO
    ...
    def dirty_price_from_discount_curve(self,
        ...
        px = 0.0
        df = 1.0
        df_settle = discount_curve.cal_df(settle_dt, )
    ...
    def asset_swap_spread(
            ...
            clean_price: float,
            discount_curve: DiscountCurve,
            swapFloatDayCountConventionType=day_count.DayCountTypes.ACT_360,
            swap_float_freq_type=frequency.FrequencyTypes.SEMI_ANNUAL,
            swap_float_cal_type=calendar.CalendarTypes.WEEKEND,
            swap_float_bus_day_adjust_rule_type=calendar.BusDayAdjustTypes.FOLLOWING,
            swapFloatDateGenRuleType=calendar.DateGenRuleTypes.BACKWARD):
        ...
        day_count = day_count.DayCount(swapFloatDayCountConventionType)
    ...
    def __repr__(self):
        ...
        s += helpers.label_to_string("cpn (%)", 0)
        s += helpers.label_to_string("ISSUE PRICE", self.issue_price)
