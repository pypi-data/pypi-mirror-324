...
from quantfe.utils import global_vars, global_types, helpers, day_count, frequency, qmath, calendar


class FixedIborXCcySwap:
    ...
    def __init__(self,
                 ...
                 fixed_dc_type: calendar.DayCountTypes,
