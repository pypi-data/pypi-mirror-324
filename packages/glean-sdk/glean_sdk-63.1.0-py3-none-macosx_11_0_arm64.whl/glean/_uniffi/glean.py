...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_glean_core_checksum_method_objectmetric_test_get_num_recorded_errors() != 38963:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_method_objectmetric_test_get_value() != 63290:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_glean_core_checksum_method_uuidmetric_test_get_value() != 13986:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_booleanmetric_new() != 26795:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_countermetric_new() != 55865:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_customdistributionmetric_new() != 8341:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_datetimemetric_new() != 20900:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_denominatormetric_new() != 41706:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_eventmetric_new() != 45197:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_labeledboolean_new() != 51974:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_labeledcounter_new() != 2958:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_labeledstring_new() != 28323:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_memorydistributionmetric_new() != 49498:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_numeratormetric_new() != 57995:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_objectmetric_new() != 21012:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_pingtype_new() != 9196:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_quantitymetric_new() != 56928:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_ratemetric_new() != 65223:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_stringlistmetric_new() != 44940:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_stringmetric_new() != 41909:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_textmetric_new() != 23694:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_timespanmetric_new() != 4611:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_timingdistributionmetric_new() != 60359:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_urlmetric_new() != 138:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_glean_core_checksum_constructor_uuidmetric_new() != 61588:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class PingType:
    _pointer: ctypes.c_void_p
    def __init__(self, name: "str",include_client_id: "bool",send_if_empty: "bool",precise_timestamps: "bool",include_info_sections: "bool",enabled: "bool",schedules_pings: "typing.List[str]",reason_codes: "typing.List[str]",follows_collection_enabled: "bool"):
...
class PingRequest:
    ...
    ping_name: "str"
    def __init__(self, *, document_id: "str", path: "str", body: "typing.List[int]", headers: "dict[str, str]", body_has_info_sections: "bool", ping_name: "str"):
...
class _UniffiTraitImplGleanEventListener:
    ...
    def on_event_recorded(
        ...
        uniffi_obj = _UniffiConverterCallbackInterfaceGleanEventListener._handle_map.get(uniffi_handle)
        def make_call():
    ...
    def _uniffi_free(uniffi_handle):
        _UniffiConverterCallbackInterfaceGleanEventListener._handle_map.remove(uniffi_handle)
...
_UniffiConverterCallbackInterfaceGleanEventListener = _UniffiCallbackInterfaceFfiConverter()
...
class _UniffiTraitImplOnGleanEvents:
    ...
    def initialize_finished(
        ...
        uniffi_obj = _UniffiConverterCallbackInterfaceOnGleanEvents._handle_map.get(uniffi_handle)
        def make_call():
            args = ()
    ...
    @_UNIFFI_CALLBACK_INTERFACE_FREE
    def _uniffi_free(uniffi_handle):
        _UniffiConverterCallbackInterfaceOnGleanEvents._handle_map.remove(uniffi_handle)
...
# The _UniffiConverter which transforms the Callbacks in to Handles to pass to Rust.
_UniffiConverterCallbackInterfaceOnGleanEvents = _UniffiCallbackInterfaceFfiConverter()
...
def glean_initialize(cfg: "InternalConfiguration",client_info: "ClientInfoMetrics",callbacks: "OnGleanEvents") -> None:
    ...
    _UniffiConverterCallbackInterfaceOnGleanEvents.check_lower(callbacks)
...
def glean_register_event_listener(tag: "str",listener: "GleanEventListener") -> None:
    ...
    _UniffiConverterCallbackInterfaceGleanEventListener.check_lower(listener)
