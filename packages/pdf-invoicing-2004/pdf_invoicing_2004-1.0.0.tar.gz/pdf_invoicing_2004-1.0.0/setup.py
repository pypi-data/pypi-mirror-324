...
setup(
  name = 'pdf-invoicing-2004',         #* Your package will have this name
  ...
  author = 'Sampreeth S M',                   # Your name
  author_email = 'sampreeth.xyz@gmail.com',  # Your email
  url = 'https://github.com/sam-sampreeth',              # Homepage of your library (e.g. github or your website)
