...
T = TypeVar("T", bound="GetReleasePagesItemOut")


@_attrs_define
class GetReleasePagesItemOut:
    """
    Attributes:
        pk (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_release_pages_item_out = cls(
            pk=pk,
            name=name,
            release_type=release_type,
            status=status,
        ...
        get_release_pages_item_out.additional_properties = d
        return get_release_pages_item_out
