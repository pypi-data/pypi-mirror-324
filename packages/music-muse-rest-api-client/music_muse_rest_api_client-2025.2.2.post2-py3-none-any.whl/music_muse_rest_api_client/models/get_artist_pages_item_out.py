...
T = TypeVar("T", bound="GetArtistPagesItemOut")


@_attrs_define
class GetArtistPagesItemOut:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_artist_pages_item_out.additional_properties = d
        return get_artist_pages_item_out
