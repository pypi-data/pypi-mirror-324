...
if TYPE_CHECKING:
    from ..models.add_new_release_in_release_type import AddNewReleaseInReleaseType
    from ..models.add_new_release_in_status import AddNewReleaseInStatus


T = TypeVar("T", bound="AddNewReleaseIn")


@_attrs_define
class AddNewReleaseIn:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_release_type, Unset):
            ...
            release_type = AddNewReleaseInReleaseType.from_dict(_release_type)
        ...
        if isinstance(_status, Unset):
            ...
            status = AddNewReleaseInStatus.from_dict(_status)

        add_new_release_in = cls(
            name=name,
        ...
        add_new_release_in.additional_properties = d
        return add_new_release_in
