...
T = TypeVar("T", bound="GetFilteredTrackOut")


@_attrs_define
class GetFilteredTrackOut:
    """
    Attributes:
        pk (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_filtered_track_out.additional_properties = d
        return get_filtered_track_out
