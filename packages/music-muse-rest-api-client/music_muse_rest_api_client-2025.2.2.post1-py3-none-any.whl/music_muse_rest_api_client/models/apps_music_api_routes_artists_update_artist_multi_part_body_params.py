...
from ..models.apps_music_api_routes_artists_update_artist_multi_part_body_params_artist_gender import (
    AppsMusicApiRoutesArtistsUpdateArtistMultiPartBodyParamsArtistGender,
)
from ..types import UNSET, File, FileJsonType, Unset

T = TypeVar("T", bound="AppsMusicApiRoutesArtistsUpdateArtistMultiPartBodyParams")


@_attrs_define
class AppsMusicApiRoutesArtistsUpdateArtistMultiPartBodyParams:
    """
    Attributes:
        name (str):
        gender (AppsMusicApiRoutesArtistsUpdateArtistMultiPartBodyParamsArtistGender):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        gender = AppsMusicApiRoutesArtistsUpdateArtistMultiPartBodyParamsArtistGender(d.pop("gender"))
        ...
        apps_music_api_routes_artists_update_artist_multi_part_body_params = cls(
            name=name,
            gender=gender,
        ...
        apps_music_api_routes_artists_update_artist_multi_part_body_params.additional_properties = d
        return apps_music_api_routes_artists_update_artist_multi_part_body_params
