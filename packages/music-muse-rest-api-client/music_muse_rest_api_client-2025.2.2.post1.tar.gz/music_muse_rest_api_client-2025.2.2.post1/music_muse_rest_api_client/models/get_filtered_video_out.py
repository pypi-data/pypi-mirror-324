...
T = TypeVar("T", bound="GetFilteredVideoOut")


@_attrs_define
class GetFilteredVideoOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_filtered_video_out.additional_properties = d
        return get_filtered_video_out
