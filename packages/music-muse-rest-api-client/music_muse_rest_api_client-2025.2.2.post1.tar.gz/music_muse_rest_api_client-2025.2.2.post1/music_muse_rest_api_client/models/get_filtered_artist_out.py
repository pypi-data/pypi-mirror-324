...
T = TypeVar("T", bound="GetFilteredArtistOut")


@_attrs_define
class GetFilteredArtistOut:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_filtered_artist_out.additional_properties = d
        return get_filtered_artist_out
