...
if TYPE_CHECKING:
    from ..models.apps_music_api_routes_releases_update_release_multi_part_body_params_release_type import (
        AppsMusicApiRoutesReleasesUpdateReleaseMultiPartBodyParamsReleaseType,
    )
    from ..models.apps_music_api_routes_releases_update_release_multi_part_body_params_status import (
        AppsMusicApiRoutesReleasesUpdateReleaseMultiPartBodyParamsStatus,
    )


T = TypeVar("T", bound="AppsMusicApiRoutesReleasesUpdateReleaseMultiPartBodyParams")


@_attrs_define
class AppsMusicApiRoutesReleasesUpdateReleaseMultiPartBodyParams:
    """
    Attributes:
        ...
        release_type (Union[Unset, AppsMusicApiRoutesReleasesUpdateReleaseMultiPartBodyParamsReleaseType]):
        release_date (Union[None, Unset, datetime.date]):
        publication_time (Union[None, Unset, datetime.datetime]):
        status (Union[Unset, AppsMusicApiRoutesReleasesUpdateReleaseMultiPartBodyParamsStatus]):
    ...
    release_type: Union[Unset, "AppsMusicApiRoutesReleasesUpdateReleaseMultiPartBodyParamsReleaseType"] = UNSET
    release_date: Union[None, Unset, datetime.date] = UNSET
    publication_time: Union[None, Unset, datetime.datetime] = UNSET
    status: Union[Unset, "AppsMusicApiRoutesReleasesUpdateReleaseMultiPartBodyParamsStatus"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_release_type, Unset):
            ...
            release_type = AppsMusicApiRoutesReleasesUpdateReleaseMultiPartBodyParamsReleaseType.from_dict(
                _release_type
            )
        ...
        if isinstance(_status, Unset):
            ...
            status = AppsMusicApiRoutesReleasesUpdateReleaseMultiPartBodyParamsStatus.from_dict(_status)
        ...
        apps_music_api_routes_releases_update_release_multi_part_body_params = cls(
            name=name,
        ...
        apps_music_api_routes_releases_update_release_multi_part_body_params.additional_properties = d
        return apps_music_api_routes_releases_update_release_multi_part_body_params
