...
if TYPE_CHECKING:
    from ..models.apps_music_api_routes_tracks_update_track_multi_part_body_params_status import (
        AppsMusicApiRoutesTracksUpdateTrackMultiPartBodyParamsStatus,
    )


T = TypeVar("T", bound="AppsMusicApiRoutesTracksUpdateTrackMultiPartBodyParams")


@_attrs_define
class AppsMusicApiRoutesTracksUpdateTrackMultiPartBodyParams:
    """
    Attributes:
        name (str):
        release_id (int):
        ...
        status (Union[Unset, AppsMusicApiRoutesTracksUpdateTrackMultiPartBodyParamsStatus]):
    ...
    status: Union[Unset, "AppsMusicApiRoutesTracksUpdateTrackMultiPartBodyParamsStatus"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = AppsMusicApiRoutesTracksUpdateTrackMultiPartBodyParamsStatus.from_dict(_status)
        ...
        apps_music_api_routes_tracks_update_track_multi_part_body_params = cls(
            name=name,
            release_id=release_id,
        ...
        apps_music_api_routes_tracks_update_track_multi_part_body_params.additional_properties = d
        return apps_music_api_routes_tracks_update_track_multi_part_body_params
