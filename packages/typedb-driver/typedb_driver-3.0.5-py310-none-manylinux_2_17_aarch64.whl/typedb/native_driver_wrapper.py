...
def driver_open_core(address, credentials, driver_options, driver_lang):
    return native_driver_python.driver_open_core(address, credentials, driver_options, driver_lang)

def driver_open_cloud(addresses, credentials, driver_options, driver_lang):
    return native_driver_python.driver_open_cloud(addresses, credentials, driver_options, driver_lang)

def driver_open_cloud_translated(public_addresses, private_addresses, credentials, driver_options, driver_lang):
    return native_driver_python.driver_open_cloud_translated(public_addresses, private_addresses, credentials, driver_options, driver_lang)
