...
@jsii.data_type(
    ...
    jsii_struct_bases=[DatadogLambdaProps],
    name_mapping={
        "add_layers": "addLayers",
        "api_key": "apiKey",
        "api_key_secret": "apiKeySecret",
...
class DatadogProps(DatadogLambdaProps):
    def __init__(
        self,
        *,
        add_layers: typing.Optional[builtins.bool] = None,
...
@jsii.data_type(
    ...
    jsii_struct_bases=[DatadogLambdaStrictProps],
    name_mapping={
        "add_layers": "addLayers",
        "capture_lambda_payload": "captureLambdaPayload",
        "enable_datadog_asm": "enableDatadogASM",
...
class DatadogStrictProps(DatadogLambdaStrictProps):
    def __init__(
        self,
        *,
        add_layers: builtins.bool,
