...
class FILEBROWSER_MT_context_menu(bpy.types.Menu):
    bl_label: typing.Any
    bl_rna: typing.Any
    id_data: typing.Any
...
class FILEBROWSER_MT_editor_menus(bpy.types.Menu):
...
class FILEBROWSER_PT_bookmarks_favorites(bpy.types.Panel):
    bl_category: typing.Any
    bl_label: typing.Any
    bl_region_type: typing.Any
    bl_rna: typing.Any
