...
setup(
    ...
    author='samy khelifi',
    author_email='samy.khelifi@gmail.com',
    description='a light framework for machine learning project',
    long_description=long_description,
    long_description_content_type='text/markdown',
    url='https://github.com/samysung/concerto',
    project_urls={
        'Bug Tracker': 'https://github.com/samysung/concerto/issues'
    },
    classifiers=[
