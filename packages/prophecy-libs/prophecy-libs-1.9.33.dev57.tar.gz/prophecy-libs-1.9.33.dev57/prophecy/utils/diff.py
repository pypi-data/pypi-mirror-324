...
class DataFrameDiff:
    ...
    def get_diff_summary_dict(cls, diff_key):
        ...
        summary_df, value_columns = diff_entry["summary"], diff_entry["valueCols"]
        key_columns = diff_entry["keyCols"]
        expected_df = diff_entry["expected"]
        generated_df = diff_entry["generated"]
    ...
    def create_diff(cls, expected_df, generated_df, key_columns, diff_key):
        ...
        joined_df = cls.create_joined_df(
            # pass unique df
            df1=cls.split_df_by_pk_uniqueness(expected_df, key_columns=key_columns)[0],
            df2=cls.split_df_by_pk_uniqueness(generated_df, key_columns=key_columns)[0],
