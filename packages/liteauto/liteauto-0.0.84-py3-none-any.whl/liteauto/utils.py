...
def get_query_relevant_chunks_list(query, text, num_variations=3, debug=False,
    ...
    prompt = f"Generate {num_variations} variations of the following query: {query}"
...
def get_relevant_chunk(query, context, num_variations=3, debug=False,
