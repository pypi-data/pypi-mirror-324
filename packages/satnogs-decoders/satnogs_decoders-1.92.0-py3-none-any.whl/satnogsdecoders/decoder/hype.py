...
class Hype(KaitaiStruct):
    ...
    def _read(self):
        ...
        self.balance_raw = self._io.read_u2be()
        self.charge_raw = self._io.read_u2be()
        self.sat_temp = self._io.read_u2be()
        self.sw_ver = self._io.read_u2be()
        self.restart_counter = self._io.read_u4be()
        self.uptime = self._io.read_u4be()
        self.x_rate_raw = self._io.read_u2be()
        self.y_rate_raw = self._io.read_u2be()
        self.z_rate_raw = self._io.read_u2be()
