...
def initialize_driver(extension_path: Optional[str] = None, captcha_name: Optional[str] = None,
    extension_id: Optional[str] = None, captcha_api_key: Optional[str] = None) -> WebElement:
    ...
    if driver is None:
        driver = get_driver.backcode__dont_use__launch_browser(dir_kit, extension_path,
            captcha_name, captcha_api_key, extension_id)
