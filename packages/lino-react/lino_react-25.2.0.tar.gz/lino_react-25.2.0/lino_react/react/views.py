    ...
    def get(self, request, app_label=None, actor=None):
        ...
        if fmt == constants.URL_FORMAT_JSON:
            ...
            if display_mode == constants.DISPLAY_MODE_STORY:
                ...
                html_text = ar.actor.get_table_summary(ar.master_instance, ar)
            ...
            kw = dict(count=total_count,
                      ...
                      html_text=html_text,
                      success=True,
                      overridden_column_headers=ar.actor.override_column_headers(ar),
...
class DelayedValue(View):
    def get(self, request, app_label=None, actor=None, pk=None, field=None, **kw):
        ...
        try:
            ...
            if sf is None:
                v = "Oops, get_atomizer({!r}, {!r}, {!r}) returned None".format(rpt, de, field)
    ...
    def get(self, request):
        ...
        def getit():
            ...
            user_settings = dict(
                ...
                dashboard_items=len((su or u).get_preferences().dashboard_items),
                email=u.email,
                ...
                user_menu=settings.SITE.get_site_menu((su or u).user_type, request),
                site_name=settings.SITE.project_dir.name,
                logged_in=not_anon,
                ...
                my_setting_text=dd.get_plugin_setting('users', 'my_setting_text', _("My settings")),
                user_id=u.pk,
            )
