...
class Renderer(JsCacheRenderer):
    ...
    def actor2json(self, v):
        ...
        if v.default_display_modes is not None:
            result['default_display_modes'] = self.display_mode2json(v.default_display_modes)
...
""")
        return site.kernel.make_cache_file(fn, write, force, verbosity)
