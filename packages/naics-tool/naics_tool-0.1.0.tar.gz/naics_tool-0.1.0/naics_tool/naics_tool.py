...
class NAICSLookupResults(BaseTool):
    """Tool that queries the NAICS Lookup API and returns back json."""
    ...
    description: str = (
        ...
        "Input should be a six-digit NAICS code."
    )
...
class NAICSSearchResults(BaseTool):
    """Tool that queries the NAICS Search API and returns back json."""
