...
class AccessRule(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessGroupUid", "createdDate", "destinationDynamicObject", "destinationNetwork", "destinationPort", "entityUid", "index", "isActiveRule", "issue", "logSettings", "protocol", "remark", "ruleAction", "ruleTimeRange", "ruleType", "sharedAccessGroupUid", "sourceDynamicObject", "sourceNetwork", "sourcePort", "uid", "updatedDate"]
