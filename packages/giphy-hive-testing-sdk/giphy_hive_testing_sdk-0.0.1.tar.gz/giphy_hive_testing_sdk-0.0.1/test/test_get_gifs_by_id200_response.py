    ...
    def make_instance(self, include_optional) -> GetGifsById200Response:
        ...
        if include_optional:
            return GetGifsById200Response(
                data = [
                    giphy_hive_testing_sdk.models.gif.Gif(
                        ...
                        id = 'YsTs5ltWtEhnq', 
                        images = giphy_hive_testing_sdk.models.gif_images.Gif_images(
                            downsized = null, 
                        ...
                        user = giphy_hive_testing_sdk.models.user.User(
                ...
                meta = giphy_hive_testing_sdk.models.meta.Meta(
                    msg = 'OK', 
                    response_id = '57eea03c72381f86e05c35d2', 
                    status = 200, ),
                pagination = giphy_hive_testing_sdk.models.pagination.Pagination(
                    count = 25, 
                    offset = 75, 
                    total_count = 250, )
            )
