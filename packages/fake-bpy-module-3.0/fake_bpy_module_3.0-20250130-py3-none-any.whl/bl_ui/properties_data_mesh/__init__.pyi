...
class DATA_PT_face_maps(MeshButtonsPanel, bpy.types.Panel):
    COMPAT_ENGINES: typing.Any
    bl_context: typing.Any
    bl_label: typing.Any
    bl_options: typing.Any
...
class DATA_PT_sculpt_vertex_colors(MeshButtonsPanel, bpy.types.Panel):
    COMPAT_ENGINES: typing.Any
    bl_context: typing.Any
    bl_label: typing.Any
    bl_options: typing.Any
...
class MESH_UL_fmaps(bpy.types.UIList):
    bl_rna: typing.Any
    id_data: typing.Any
...
class MESH_UL_vcols(bpy.types.UIList):
    bl_rna: typing.Any
    id_data: typing.Any
