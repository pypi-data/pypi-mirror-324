...
def transform(
    ...
    *,
    ...
    orient_axis: typing.Literal["X", "Y", "Z"] | None = "Z",
    orient_type: typing.Literal["GLOBAL", "LOCAL", "NORMAL", "GIMBAL", "VIEW", "CURSOR"]
    | None = "GLOBAL",
    orient_matrix: list[list[float]]
    | tuple[
        tuple[float, float, float],
    ...
    Cursor -- Align the transformation axes to the 3D cursor.
        :type orient_type: typing.Literal['GLOBAL','LOCAL','NORMAL','GIMBAL','VIEW','CURSOR'] | None
        :param orient_matrix: Matrix
        :type orient_matrix: list[list[float]] | tuple[tuple[float, float, float], tuple[float, float, float], tuple[float, float, float]] | None
        :param orient_matrix_type: Matrix Orientation
    ...
    CURSOR
    Cursor -- Align the transformation axes to the 3D cursor.
        :type orient_matrix_type: typing.Literal['GLOBAL','LOCAL','NORMAL','GIMBAL','VIEW','CURSOR'] | None
        :param constraint_axis: Constraint Axis
        :type constraint_axis: collections.abc.Iterable[bool] | None
        :param mirror: Mirror Editing
        :type mirror: bool | None
