...
XLSX_URL = "https://www.globalmacrodata.com/GMD.xlsx"

def get_data(start_year=None, end_year=None, country=None, ISO3=None, format='csv'):
    """
    ...
    if format == 'csv':
        ...
        raise ValueError("Invalid format. Please choose 'csv' or 'xlsx'.")
