...
def manipulator(
    ...
    *,
    ...
    use_planar_constraint: bool | None = False,
):
    ...
    :type use_planar_constraint: bool | None
    """
...
def viewnumpad(
    ...
    /,
    *,
    type: typing.Literal["LEFT", "RIGHT", "BOTTOM", "TOP", "FRONT", "BACK", "CAMERA"]
    | None = "LEFT",
    ...
    CAMERA Camera, View From the Active Camera.
        :type type: typing.Literal['LEFT','RIGHT','BOTTOM','TOP','FRONT','BACK','CAMERA'] | None
