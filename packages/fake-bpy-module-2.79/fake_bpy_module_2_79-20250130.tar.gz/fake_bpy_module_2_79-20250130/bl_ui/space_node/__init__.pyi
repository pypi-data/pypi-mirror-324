...
class NODE_MT_node_color_presets(bpy.types.Menu):
...
class NODE_MT_node_color_specials(bpy.types.Menu):
    bl_label: typing.Any
    bl_rna: typing.Any
    id_data: typing.Any
...
class NODE_PT_grease_pencil_tools(
    bl_ui.properties_grease_pencil_common.GreasePencilToolsPanel, bpy.types.Panel
):
    bl_label: typing.Any
    bl_options: typing.Any
    bl_region_type: typing.Any
