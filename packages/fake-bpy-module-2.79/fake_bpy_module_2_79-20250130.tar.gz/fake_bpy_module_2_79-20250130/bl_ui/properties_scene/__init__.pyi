...
class SCENE_MT_units_length_presets(bpy.types.Menu):
...
class SCENE_PT_color_management(SceneButtonsPanel, bpy.types.Panel):
    COMPAT_ENGINES: typing.Any
    bl_context: typing.Any
    bl_label: typing.Any
    bl_options: typing.Any
...
class SCENE_PT_rigid_body_cache(SceneButtonsPanel, bpy.types.Panel):
    COMPAT_ENGINES: typing.Any
    bl_context: typing.Any
    bl_label: typing.Any
    bl_options: typing.Any
...
class SCENE_PT_rigid_body_field_weights(SceneButtonsPanel, bpy.types.Panel):
    COMPAT_ENGINES: typing.Any
    bl_context: typing.Any
    bl_label: typing.Any
    bl_options: typing.Any
