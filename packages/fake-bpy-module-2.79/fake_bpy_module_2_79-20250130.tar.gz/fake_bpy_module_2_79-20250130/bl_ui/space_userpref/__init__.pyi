...
class USERPREF_MT_app_templates(bpy.types.Menu):
    bl_label: typing.Any
    bl_rna: typing.Any
    id_data: typing.Any
    ...
    def draw_ex(
        self, context, *, use_splash=False, use_default=False, use_install=False
    ):
        """
...
class USERPREF_MT_templates_splash(bpy.types.Menu):
    bl_label: typing.Any
    bl_rna: typing.Any
    id_data: typing.Any
    preset_subdir: typing.Any
