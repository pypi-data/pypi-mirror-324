...
class GPENCIL_PIE_sculpt(bpy.types.Menu):
...
class GPENCIL_PIE_settings_palette(bpy.types.Menu):
...
class GPENCIL_PIE_tool_palette(bpy.types.Menu):
...
class GPENCIL_PIE_tools_more(bpy.types.Menu):
