...
from letschatty.models.messages.message_templates.filled_data_from_frontend import FilledTemplateData, FilledRecipientParameter
...
class TemplateCampaignService:
    ...
    def _instantiate_recipient(recipient_dict : dict, whatsapp_template : WhatsappTemplate) -> RecipientOfTemplateCampaign:
        ...
        return RecipientOfTemplateCampaign(phone_number=recipient_dict.get("phone_number"), parameters=recipient_parameters)
    
    @staticmethod
    def validate_and_instantiate_recipients_in_campaign(whatsapp_template : WhatsappTemplate,template_campaign : TemplateCampaign,recipients_dict : List[dict]) -> List[FilledTemplateData]:
        ...
        template_campaign.recipients = recipients
    ...
    def build_template_data_for_recipient(recipient : RecipientOfTemplateCampaign, template_campaign : TemplateCampaign) -> FilledTemplateData:
        return FilledTemplateData(
            ...
            agent_email=template_campaign.agent_email,
