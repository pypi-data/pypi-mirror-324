...
class AccessEvaluationsApi:
    ...
    @overload
    async def get_access_evaluation_log(self, id : Annotated[constr(strict=True, max_length=70, min_length=1), Field(..., description="The identifier of the access evaluation to obtain the log for.")], **kwargs) -> AccessEvaluationLog:  # noqa: E501
        ...

    @overload
    def get_access_evaluation_log(self, id : Annotated[constr(strict=True, max_length=70, min_length=1), Field(..., description="The identifier of the access evaluation to obtain the log for.")], async_req: Optional[bool]=True, **kwargs) -> AccessEvaluationLog:  # noqa: E501
        ...

    @validate_arguments
    def get_access_evaluation_log(self, id : Annotated[constr(strict=True, max_length=70, min_length=1), Field(..., description="The identifier of the access evaluation to obtain the log for.")], async_req: Optional[bool]=None, **kwargs) -> Union[AccessEvaluationLog, Awaitable[AccessEvaluationLog]]:  # noqa: E501
    ...
    @validate_arguments
    def get_access_evaluation_log_with_http_info(self, id : Annotated[constr(strict=True, max_length=70, min_length=1), Field(..., description="The identifier of the access evaluation to obtain the log for.")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EARLY ACCESS] GetAccessEvaluationLog: Get the log for a specific access evaluation.  This endpoint will be deprecated in the near future.  # noqa: E501
    ...
    @overload
    async def list_access_evaluation_logs(self, start_at : Annotated[Optional[datetime], Field(description="Start date from which point to fetch logs.")] = None, end_at : Annotated[Optional[datetime], Field(description="End date to which point to fetch logs.")] = None, filter : Annotated[Optional[constr(strict=True, max_length=16384, min_length=0)], Field(description="Expression to filter the result set. Read more about <see href=\"https://support.lusid.com/filtering-results-from-lusid\"> filtering results from LUSID</see>.")] = None, sort_by : Annotated[Optional[constr(strict=True, max_length=16384, min_length=1)], Field(description="Order the results by these fields. Use the '-' sign to denote descending order e.g. -MyFieldName. Multiple fields can be denoted by a comma e.g. -MyFieldName,AnotherFieldName,-AFurtherFieldName")] = None, limit : Annotated[Optional[conint(strict=True, le=10000, ge=1)], Field(description="When paginating, only return this number of records. The minimum value is 0 and the maximum is 10000.")] = None, page : Annotated[Optional[constr(strict=True, max_length=2500, min_length=1)], Field(description="Encoded page string returned from a previous search result that will retrieve the next page of data. When this field is supplied, filter and sortby fields should not be supplied.")] = None, histogram_interval : Annotated[Optional[StrictStr], Field(description="The interval for an included histogram of the logs")] = None, **kwargs) -> ResourceListWithHistogramOfAccessEvaluationLog:  # noqa: E501
        ...
