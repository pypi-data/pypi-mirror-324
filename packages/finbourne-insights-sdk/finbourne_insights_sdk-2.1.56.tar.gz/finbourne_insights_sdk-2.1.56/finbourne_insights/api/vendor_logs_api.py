...
class VendorLogsApi:
    ...
    @overload
    async def get_vendor_log(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the log for.")], **kwargs) -> VendorLog:  # noqa: E501
        ...

    @overload
    def get_vendor_log(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the log for.")], async_req: Optional[bool]=True, **kwargs) -> VendorLog:  # noqa: E501
        ...

    @validate_arguments
    def get_vendor_log(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the log for.")], async_req: Optional[bool]=None, **kwargs) -> Union[VendorLog, Awaitable[VendorLog]]:  # noqa: E501
    ...
    @validate_arguments
    def get_vendor_log_with_http_info(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the log for.")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] GetVendorLog: Get the log for a specific vendor request.  # noqa: E501
    ...
    @overload
    async def get_vendor_request(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the content for.")], **kwargs) -> VendorRequest:  # noqa: E501
        ...

    @overload
    def get_vendor_request(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the content for.")], async_req: Optional[bool]=True, **kwargs) -> VendorRequest:  # noqa: E501
        ...

    @validate_arguments
    def get_vendor_request(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the content for.")], async_req: Optional[bool]=None, **kwargs) -> Union[VendorRequest, Awaitable[VendorRequest]]:  # noqa: E501
    ...
    @validate_arguments
    def get_vendor_request_with_http_info(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the content for.")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] GetVendorRequest: Get the request body for a vendor request.  # noqa: E501
    ...
    @overload
    async def get_vendor_response(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the response for.")], **kwargs) -> VendorResponse:  # noqa: E501
        ...

    @overload
    def get_vendor_response(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the response for.")], async_req: Optional[bool]=True, **kwargs) -> VendorResponse:  # noqa: E501
        ...

    @validate_arguments
    def get_vendor_response(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the response for.")], async_req: Optional[bool]=None, **kwargs) -> Union[VendorResponse, Awaitable[VendorResponse]]:  # noqa: E501
    ...
    @validate_arguments
    def get_vendor_response_with_http_info(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the response for.")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] GetVendorResponse: Get the response from a vendor request.  # noqa: E501
    ...
    @validate_arguments
    def list_vendor_logs_with_http_info(self, filter : Annotated[Optional[constr(strict=True, max_length=16384, min_length=0)], Field(description="Expression to filter the result set. Read more about <see href=\"https://support.lusid.com/filtering-results-from-lusid\"> filtering results from LUSID</see>.")] = None, sort_by : Annotated[Optional[constr(strict=True, max_length=16384, min_length=1)], Field(description="Order the results by these fields. Use the '-' sign to denote descending order e.g. -MyFieldName. Multiple fields can be denoted by a comma e.g. -MyFieldName,AnotherFieldName,-AFurtherFieldName")] = None, limit : Annotated[Optional[conint(strict=True, le=10000, ge=0)], Field(description="When paginating, only return this number of records. The minimum value is 0 and the maximum is 10000.")] = None, page : Annotated[Optional[constr(strict=True, max_length=500, min_length=1)], Field(description="Encoded page string returned from a previous search result that will retrieve the next page of data. When this field is supplied, filter and sortby fields should not be supplied.")] = None, histogram_interval : Annotated[Optional[StrictStr], Field(description="Optional interval to use in a histogram of the returned values. If not provided, no histogram will be generated.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] ListVendorLogs: List the logs for vendor requests.  # noqa: E501
