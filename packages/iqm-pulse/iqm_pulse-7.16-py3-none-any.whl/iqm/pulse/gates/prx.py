...
from iqm.pulse.playlist.waveforms import TruncatedGaussian
...
class PRX_CustomWaveformsSX(PRX_SinglePulse_GateImplementation, CustomIQWaveforms):
    ...
    def _call(self, angle: float, phase: float = 0) -> TimeBox:  # type: ignore[override]
        ...
        There are exceptions while using pi/2 and pi rotation in angle, for calibration reason. The duration of the
