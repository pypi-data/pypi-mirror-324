    ...
    def time_trace(
        ...
        if args not in self._time_traces:
            ...
            for probe_channel, segment in probe_timebox.atom.items():
                ...
                probe_name = self.builder._channel_to_component[probe_channel]  # pylint: disable=protected-access
                ...
                segment._instructions[0] = trigger_with_trace  # pylint: disable=protected-access
