...
class ImageParser:
    ...
    @classmethod
    def to_pillow(cls, image: Union[str, Image.Image, np.ndarray], mode: str = 'RGB') -> Image.Image:
        """
        ...
        if (
            ...
            not PythonValidator.is_instance(Image.Image)
        ):
    ...
    @classmethod
    def to_numpy(cls, image: Union[str, Image.Image, np.ndarray], mode: str = 'RGB') -> np.ndarray:
        """
    ...
    @classmethod
    def to_opencv(cls, image: Union[str, Image.Image, np.ndarray], mode: str = 'RGB') -> np.ndarray:
        """
        ...
        """
        return cls.to_numpy(image, mode)[:, :, ::-1]