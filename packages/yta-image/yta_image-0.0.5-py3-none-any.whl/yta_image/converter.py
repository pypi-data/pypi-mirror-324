...
class ImageConverter:
    ...
    # TODO: Move these validation methods to other place
    @staticmethod
    def numpy_image_to_pil(image: np.ndarray):
        """
    ...
    @staticmethod
    def numpy_image_to_base64(image: np.ndarray):
        """
    ...
    @staticmethod
    def numpy_image_to_opencv(image: np.ndarray):
        validate_numpy_image(image)
    ...
    @staticmethod
    def pil_image_to_opencv(image: Image.Image):
        """
    ...
    @staticmethod
    def base64_image_to_numpy(image):
        """
    ...
    @staticmethod
    def base64_image_to_opencv(image):
        """
    ...
    @staticmethod
    def opencv_image_to_numpy(image: np.ndarray):
        """
        Turns the 'image' to an opencv image by turning it
        into a numpy array first.
        """
    ...
    @staticmethod
    def opencv_image_to_pillow(image: np.ndarray):
        """
    ...
    @staticmethod
    def opencv_image_to_base64(image: np.ndarray):
        """
