...
class PixelFilterFunction:
    ...
    """
    @staticmethod
    def is_green(pixel: list[int, int, int]):
        """
    ...
    @staticmethod
    def is_blue(pixel: list[int, int, int]):
        """
        Check if the provided 'pixel' is a blue pixel,
        which means that color is in the [100, 255] range
        while the others are in the [0, 100] range.
        ...
        return (r >= 0 and r <= 100) and (g >= 0 and g <= 100) and (b >= 100 and b <= 255)
    
    @staticmethod
    def is_red(pixel: list[int, int, int]):
        """
        Check if the provided 'pixel' is a blue pixel,
        which means that color is in the [100, 255] range
        while the others are in the [0, 100] range.
        ...
        return (r >= 100 and r <= 255) and (g >= 0 and g <= 100) and (b >= 0 and b <= 100)
    
    @staticmethod
    def is_transparent(pixel: list[int, int, int, int]):
        """
