...
from yta_image.color.picker import PixelFilterFunction
...
class ImageRegionFinder:
    ...
    @staticmethod
    def _dfs(image: np.ndarray, visited, x, y, region, filter_func: callable):
        """
    ...
    @staticmethod
    def find_green_regions(image: Union[str, Image.Image, np.ndarray]) -> list[Region]:
        """
    ...
    @staticmethod
    def find_transparent_regions(image: Union[str, Image.Image, np.ndarray]) -> list[Region]:
        """
