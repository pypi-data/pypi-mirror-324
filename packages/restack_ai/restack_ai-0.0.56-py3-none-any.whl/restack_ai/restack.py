                ...
                if not schedule:
                    if event:
                        ...
                        try:
                            ...
                            log_with_context("INFO", "Workflow started with event", handle=handle)
                            return handle.first_execution_run_id
                        except Exception as e:
                            log_with_context("ERROR", "Failed to start workflow with event", error=str(e))
                            raise e
                    else:
