...
from qimchi.state import _state, PLOT_WIDTH_OPTS_DICT, SQUARIFY_SIZE
...
def update_plot_width(width: str) -> str:
    """
...
def update_plot_list(
    ...
    *_,
    ...
    Updates the container under certain conditions:
        ...
        5. If the user deletes a specific plot, it removes the plot from the container.
        6. If the user uploads new data, it updates the plots based on the new data. Filters, ranges, and appearance settings are retained.
...
def squarify_plots(squarify: bool) -> dict:
    """
