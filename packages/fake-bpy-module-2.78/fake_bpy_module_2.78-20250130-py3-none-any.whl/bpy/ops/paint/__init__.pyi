...
def brush_select(
    ...
    *,
    ...
    DARKEN Darken, Use darken blending mode while painting.
        :type vertex_paint_tool: typing.Literal['MIX','ADD','SUB','MUL','BLUR','LIGHTEN','DARKEN'] | None
    ...
    DARKEN Darken, Use darken blending mode while painting.
        :type weight_paint_tool: typing.Literal['MIX','ADD','SUB','MUL','BLUR','LIGHTEN','DARKEN'] | None
