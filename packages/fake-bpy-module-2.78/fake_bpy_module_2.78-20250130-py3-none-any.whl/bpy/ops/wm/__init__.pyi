...
def collada_export(
    ...
    *,
    ...
    include_shapekeys: bool | None = True,
    deform_bones_only: bool | None = False,
    active_uv_only: bool | None = False,
    include_uv_textures: bool | None = False,
    include_material_textures: bool | None = False,
    ...
    export_transformation_type_selection: typing.Literal[
        "matrix", "transrotloc", "both"
    ]
    | None = "matrix",
    ...
    both Both, Use <matrix> AND <translate>, <rotate>, <scale> to specify transformations.
        :type export_transformation_type_selection: typing.Literal['matrix','transrotloc','both'] | None
