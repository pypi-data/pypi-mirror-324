...
class TestDoorLockKeyCreateRequestSchema(unittest.TestCase):
    """DoorLockKeyCreateRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DoorLockKeyCreateRequestSchema:
        """Test DoorLockKeyCreateRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DoorLockKeyCreateRequestSchema`
        """
        model = DoorLockKeyCreateRequestSchema()
        if include_optional:
            return DoorLockKeyCreateRequestSchema(
                property_id = '',
                reservation_id = '',
                sub_reservation_id = '',
                issuer_id = '',
    ...
    def testDoorLockKeyCreateRequestSchema(self):
        """Test DoorLockKeyCreateRequestSchema"""
