...
def singular_ambiguous_gender_head(df):
    ...
    singular_ambiguous_head = ['enfant', 'reporter', 'autre', 'docteur', 'détective', 'capitaine', 'médecin', 'commissaire', 'notaire', 'juge', 'artiste', 'domestique', 'malade', 'maire', 'concierge', 'ministre', 'professeur', 'auteur', 'esclave', 'troisième', 'coupable', 'misérable', 'pensionnaire', 'élève', 'somnambule', 'garde-malade', 'garde', 'secrétaire', 'modiste', 'camarade', 'chèvre', 'gosse', 'aveugle', 'aristocrate', 'gendarme', 'poète', 'commissionnaire', 'traître', 'lâche', 'guide', 'flic', 'témoin', 'philosophe', 'imbécile', 'sauvage', 'bandit', 'ivrogne', 'journaliste', 'militaire', 'pauvre', 'novice', 'russe', 'collègue', 'fleuriste', 'aubergiste', 'adversaire', 'propriétaire', 'môme', 'architecte', 'pilote', 'ermite', 'pote', 'interne', 'suisse', 'procureur', 'infirme', 'jeune', 'prophète', 'brave', 'drôle', 'monarque', 'mousquetaire', 'vétérinaire', 'poëte', 'photographe', 'apothicaire', 'matamore', 'apôtre', 'séminariste', 'commis', 'noble', 'drapier', 'fat', 'diable', 'diplomate', 'droguiste', 'paralytique', 'journalier', 'aide-de-camp', 'partenaire', 'dentiste', 'confrère', 'copiste', 'centenaire', 'timide', 'vaguemestre', 'patriote', 'convive', 'ex-jésuite', 'gnangnan', 'anatomiste', 'dr', 'fidèle', 'myope', 'proviseur'
                               ]
    ...
    male_consonant_prefix = ['le ', 'du ', 'au ', 'un ', 'ce ', 'cet ', 'mon ', 'messire', 'ton ', 'son ', 'cher ', "l' ancien ", 'm. ', 'monsieur',  'quel ', 'cher ', 'petit ', 'premier ', 'second ', 'dernier ', 'bel ', 'ancien ', 'malheureux', 'grand ', 'intéressant ', 'nouveau', 'seul ', 'excellent ', 'bon ', 'audacieux ', 'heureux ', 'infortuné ', 'vieux ']
...
def gender_proper_mentions_from_knowledge_base(df, insee_names_df):
    ...
    return df
#%%
def assign_gender_to_PER_entities(PER_entities_df, insee_path='/home/antoine/Documents/bookBLP_modular_development/insee_names_fr_1900_2023.csv'):
