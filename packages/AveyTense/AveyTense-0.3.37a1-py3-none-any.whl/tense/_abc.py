...
module tense._abc
```
Abstract base classes (ABC) located in `tense.types_collection` module. This module \\
...
from . import _types_first as _types
...
class Buffer(_pro):
    ...
    """
    def __buffer__(self, flags: _types.BufferFlags) -> memoryview: ...
...
if False:
    ...
    AnySequence = Sequence # since 0.3.32
    AnyMutableSequence = MutableSequence # since 0.3.32
    AnyMapping = Mapping # since 0.3.32
    AnyMutableMapping = MutableMapping # since 0.3.32
    AnyUniqual = Uniqual # since 0.3.32
    AnyMutableUniqual = MutableUniqual # since 0.3.32
