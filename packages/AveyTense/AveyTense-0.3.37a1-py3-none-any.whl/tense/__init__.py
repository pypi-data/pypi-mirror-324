...
class Tense( # 0.3.24
    ...
    if VERSION_INFO < (0, 3, 34) and False:
    ...
    @classmethod
    @_tc.overload
    def isBytes(self, v: _Any, /, *_: _Any, mode: _Mode = MODE_AND) -> bool: ...
        
    @classmethod
    def isBytes(self, v: _Any, /, *_, mode = MODE_AND):
        """
        \\@since 0.3.35
    ...
    @classmethod
    @_tc.overload
    def isByteArray(self, v: _Any, /, *_: _Any, mode: _Mode = MODE_AND) -> bool: ...
    
    @classmethod
    def isByteArray(self, v, /, *_, mode = MODE_AND): # not generic
        """
        \\@since 0.3.35
    ...
    @classmethod
    @_tc.overload
    def isMemoryView(self, v: _Any, /, *_: _Any, mode: _Mode = MODE_AND) -> bool: ...
        
    @classmethod
    def isMemoryView(self, v, /, *_, mode = MODE_AND):
        """
        \\@since 0.3.35
    ...
    if VERSION_INFO < (0, 3, 34) and False: # due to use of -abroad()
        @classmethod
...
if VERSION_INFO < (0, 3, 36) and False:
