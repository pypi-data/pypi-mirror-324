...
# import re as _re # pyright: ignore[reportUnusedImport]
...
if hasattr(_typing, "Optional"):
    ...
    from typing_extensions import Optional as _Optional
...
if hasattr(_typing, "Callable"):
    ...
    from typing_extensions import Callable as _Callable

if hasattr(_typing, "Generic"):
    from typing import Generic as _Generic
    
else:
    from typing_extensions import Generic as _Generic
...
if _sys.version_info >= (3, 6, 2):
    ...
    from typing_extensions import NoReturn as _NoReturn

# since Python 3.7.4
if _sys.version_info >= (3, 7, 4):
    from typing import ForwardRef as _ForwardRef
else:
    from typing_extensions import ForwardRef as _ForwardRef
...
if _sys.version_info >= (3, 10):
    ...
    if hasattr(_std_types, "EllipsisType"):
        ellipsis = _std_types.EllipsisType
        _Ellipsis = _std_types.EllipsisType
...
from types import GenericAlias as GenericAlias # not really a class
...
ModuleType = _std_types.ModuleType
...
from types import (
    ...
    CodeType as CodeType # "\\@since 0.3.26rc3. See [`types.CodeType`](https://docs.python.org/3/library/types.html#types.CodeType)"
) # 0.3.34
