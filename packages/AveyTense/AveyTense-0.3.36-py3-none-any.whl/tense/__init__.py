...
import tkinter as _tkinter # (< 0.3.36)
...
# local type aliases
_Bits = _lit[3, 4, 8, 24]
_ProbabilityType = _tc.Union[_tc.Sequence[_T], _tc.Uniqual[_T], _tc.Mapping[_T, _tc.Union[int, _tc.Ellipsis, None]]] # change 0.3.36
...
_HaveCodeType = _uni[ # satisfy dis.dis() first argument requirement
    str, bytes, bytearray, _types.MethodType, _types.FunctionType, _tc.CodeType, type, _tc.AnyCallable, None
]
_Mode = _tc.Union[_constants.ModeSelection, _tc.Literal["and", "or"]] # 0.3.36
_Statement = _tc.Union[_tc.Callable[[], object], str]
_Timer = _tc.Callable[[], float]
_GroupMode = _lit["and-or", "or-and", "and-nor", "nor-and", "nand-or", "or-nand", "nand-nor", "nor-nand", "and-and", "or-or", "nand-nand", "nor-nor"] # 0.3.34
_ProbabilityLengthType = _uni[int, _lit[PROBABILITY_COMPUTE]]
...
# public type aliases
NULL = _tc.NULL
"""\\@since 0.3.34; from `tense.types_collection`"""
...
def _is_hexadecimal(target: str, /):
    ...
    for c in target:
        ...
        if c not in STRING_HEXADECIMAL:
            return False
...
def _is_sequence_helper(v, /, type: type[_T] = _Any): # 0.3.36; returns bool
...
def _inspect_many(*v, type = _Any, mode = MODE_AND): # 0.3.36
    ...
    if reckon(v) == 0:
        ...
        for e in v:
            ...
            try:
                ...
                if mode in (MODE_AND, "and"):
                    _placeholder = _placeholder and isinstance(e, type)
                    
                elif mode in (MODE_OR, "or"):
...
class TenseOptions(_util.AbstractFinal):
    """
    \\@since 0.3.27a5
    ```ts
    in module tense
...
class FencordOptions(_util.AbstractFinal):
    """
    \\@since 0.3.27b1
    ```py
...
class Tense(
    ...
    TIMEIT_NUMBER_DEFAULT = MATH_MILLION
    "\\@since 0.3.26rc3"
    ...
    ABROAD_HEX_INCLUDE = ABROAD_HEX_INCLUDE
    "\\@since 0.3.26rc2"
    
    ABROAD_HEX_HASH = ABROAD_HEX_HASH
    "\\@since 0.3.26rc2"
    
    ABROAD_HEX_EXCLUDE = ABROAD_HEX_EXCLUDE
    "\\@since 0.3.26rc2"
    ...
    @classmethod
    @_tc.overload
    def isNone(self, v: _Any, /, *_: _Any, mode: _Mode = MODE_AND) -> bool: ...
    
    @classmethod
    def isNone(self, v, /, *_, mode = MODE_AND):
        """
        \\@since 0.3.26b3
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    @_tc.overload
    def isEllipsis(self, v: _Any, /) -> _tc.TypeIs[_tc.Ellipsis]: ...
    
    @classmethod
    @_tc.overload
    def isEllipsis(self, v: _Any, /, *_: _Any, mode: _Mode = MODE_AND) -> bool: ...
    
    @classmethod
    def isEllipsis(self, v, /, *_, mode = MODE_AND):
        """
        \\@since 0.3.26
        ```ts
        "class method" in class Tense
        ...
        """
        _many = (v,) + _
        return _inspect_many(*_many, type = _tc.Ellipsis, mode = mode)
    ...
    @classmethod
    @_tc.overload
    def isBool(self, v: _Any, /, *_: _Any, mode: _Mode = MODE_AND) -> bool: ...
    
    @classmethod
    def isBool(self, v, /, *_, mode = MODE_AND):
        """
        \\@since 0.3.26b3
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    @_tc.overload
    def isBoolean(self, v: _Any, /, *_: _Any, mode: _Mode = MODE_AND) -> bool: ...
    
    @classmethod
    def isBoolean(self, v, /, *_, mode = MODE_AND):
        """
        \\@since 0.3.26rc1
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    @_tc.overload
    def isInt(self, v: _Any, /, *_: _Any, mode: _Mode = MODE_AND) -> bool: ...
    
    @classmethod
    def isInt(self, v, /, *_, mode = MODE_AND):
        """
        \\@since 0.3.26b3
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    @_tc.overload
    def isInteger(self, v: _Any, /, *_: _Any, mode: _Mode = MODE_AND) -> bool: ...
    
    @classmethod
    def isInteger(self, v, /, *_, mode = MODE_AND):
        """
        \\@since 0.3.26rc1
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    @_tc.overload
    def isFloat(self, v: _Any, /, *_: _Any, mode: _Mode = MODE_AND) -> bool: ...
    
    @classmethod
    def isFloat(self, v, /, *_, mode = MODE_AND):
        """
        \\@since 0.3.26b3
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    @_tc.overload
    def isComplex(self, v: _Any, /, *_: _Any, mode: _Mode = MODE_AND) -> bool: ...
    
    @classmethod
    def isComplex(self, v, /, *_, mode = MODE_AND):
        """
        \\@since 0.3.26b3
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    @_tc.overload
    def isStr(self, v: _Any, /, *_: _Any, mode: _Mode = MODE_AND) -> bool: ...
    
    @classmethod
    def isStr(self, v, /, *_, mode = MODE_AND):
        """
        \\@since 0.3.26b3
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    @_tc.overload
    def isString(self, v: _Any, /, *_: _Any, mode: _Mode = MODE_AND) -> bool: ...
    
    @classmethod
    def isString(self, v, /, *_, mode = MODE_AND):
        """
        \\@since 0.3.26rc1
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    def isBytes(self, v: _Any, /) -> _tc.TypeIs[bytes]: # not generic
        """
        \\@since 0.3.35
        ...
        """
        if type(v) is bytes:
            return self.isList(list(v), type = int)
    ...
    @classmethod
    def isByteArray(self, v: _Any, /) -> _tc.TypeIs[bytearray]: # not generic
        """
        \\@since 0.3.35
    ...
    @classmethod
    def isMemoryView(self, v: _Any, /) -> _tc.TypeIs[memoryview]: # generic, with default value 'int'
        """
        \\@since 0.3.35
        
        Determine whether a value is a memoryview built-in.
        """
        return type(v) is memoryview
    ...
    @classmethod
    @_tc.overload
    def hasattr(self, o: object, attr: tuple[str, ...], /, mode: _Mode = MODE_OR) -> bool: ...
            
    @classmethod
    def hasattr(self, o, attr, /, mode = MODE_OR):
        """
        \\@since 0.3.34
    ...
    if False: # removed 0.3.34 due to use of -abroad()
        @classmethod
    ...
    def abroadHex(self, value1: _AbroadValue1[_T1], /, value2: _AbroadValue2[_T2] = None, modifier: _AbroadModifier[_T3] = None, mode = ABROAD_HEX_INCLUDE):
        ...
        for i in ab:
            ...
            if not isinstance(mode, _constants.AbroadHexMode):
    ...
    @classmethod
    def clear(self, *v: _tc.Union[_tc.MutableSequence[_T], _tc.MutableUniqual[_T], str]):
        """
        \\@since 0.3.27a4
        ```ts
        "class method" in class Tense
        ...
        Since 0.3.27b1 strings are also passable. Since 0.3.36 - sets.
        """
        for seq in v:
            ...
            elif isinstance(seq, (_tc.MutableSequence, _tc.MutableUniqual)):
                seq.clear()
                
            else:
                error = ValueError("expected a sequence or string")
                raise error
    ...
    @classmethod
    @_tc.overload
    def bisect(self, a: _tc.SizeableItemGetter[_T_richComparable], x: _T_richComparable, /, l: int = 0, h: _opt[int] = None, dir: _constants.BisectMode = BISECT_RIGHT, *, key: None = None) -> int:
        """\\@since 0.3.26rc2"""
        ...
    
    @classmethod
    @_tc.overload
    def bisect(self, a: _tc.SizeableItemGetter[_T], x: _T_richComparable, /, l: int = 0, h: _opt[int] = None, dir: _constants.BisectMode = BISECT_RIGHT, *, key: _cal[[_T], _T_richComparable]) -> int:
        """\\@since 0.3.26rc2"""
        ...
    ...
    def bisect(self, a, x, /, l = 0, h = None, dir = BISECT_RIGHT, *, key = None):
        ...
        if (
            ...
            isinstance(dir, _constants.BisectMode)
        ):
    ...
    if False:
        @classmethod
        def insort(self, seq: _tc.MutableSequence[_T], item: _T, low: int = 0, high: _opt[int] = None, mode: _constants.InsortMode = INSORT_RIGHT, key: _opt[_cal[[_T], _T_richComparable]] = None):
        ...
        @classmethod
        @_tc.overload
        def insort(self, a: _tc.MutableSequence[_T_richComparable], x: _T_richComparable, /, l: int = 0, h: _opt[int] = None, dir: _constants.InsortMode = INSORT_RIGHT, *, key: None = None) -> None:
            """\\@since 0.3.26rc2"""
            ...
            
        @classmethod
        @_tc.overload
        def insort(self, a: _tc.MutableSequence[_T], x: _T_richComparable, /, l: int = 0, h: _opt[int] = None, dir: _constants.InsortMode = INSORT_RIGHT, *, key: _cal[[_T], _T_richComparable]) -> None:
            """\\@since 0.3.26rc2"""
            ...
        ...
        def insort(self, a, x, /, l = 0, h = None, dir = INSORT_RIGHT, *, key = None):
            ...
            if (
                self.isInteger(l) and
                (self.isInteger(h) or self.isNone(h)) and
                isinstance(dir, _constants.InsortMode)
            ):
    ...
    def randstr(self, lower = True, upper = True, digits = True, special = True, length = 10):
        ...
        if lower:
            conv.extend([e for e in STRING_LOWER])
                
        if upper:
            conv.extend([e for e in STRING_UPPER])
                
        if digits:
            conv.extend([e for e in STRING_DIGITS])
                
        if special:
            conv.extend([e for e in STRING_SPECIAL])
    ...
    if VERSION_INFO < (0, 3, 31) and False: # deprecated since 0.3.25, removed 0.3.31
    ...
    if VERSION_INFO >= (0, 3, 37) and False:
...
class RGB(_util.Final):
    ...
    def fromValue(n: _uni[int, str], /):
        ...
        if Tense.isInteger(n) and n in abroad(2 ** 24):
            ...
            if Tense.isString(n) and ((
                _is_hexadecimal(n) or
                _is_decimal(n) or
                _is_octal(n) or
                _is_binary(n)
            ) and _int_conversion(n) in abroad(2 ** 24)):
                
                _n = str(_int_conversion(n))
                
                return RGB(int(_n[:2], 16), int(_n[2:4], 16), int(_n[4:], 16))
...
_Color = _tc.Union[_tc.ColorType, RGB]
    ...
    if True: # since 0.3.27
        ...
        def __init__(self, text: str, /, bits: _Bits = 8, foregroundColor: _Color = None, backgroundColor: _Color = None): # slash since 0.3.26rc2
            ...
            for e in (foregroundColor, backgroundColor):
                ...
                if not Tense.isInteger(e) and not Tense.isString(e) and not isinstance(e, RGB) and not Tense.isNone(e):
