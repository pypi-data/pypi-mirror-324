...
class CheckpointTrackerImpl(CheckpointTracker):
    ...
    def init_shadow_git(self) -> str:
        ...
        try:
            ...
            temp_dir = Path(tempfile.gettempdir()) / "cline_checkpoints"
            ...
            with self._repo.config_writer() as git_config:
                git_config.set_value("user", "name", "Cline Checkpoint")
                git_config.set_value("user", "email", "checkpoint@cline.dev")
