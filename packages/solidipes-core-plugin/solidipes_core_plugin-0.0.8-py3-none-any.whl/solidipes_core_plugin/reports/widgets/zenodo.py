...
import yaml
from solidipes.scanners.scanner import ExportScanner, list_files
...
from solidipes_core_plugin.reports.widgets.custom_widgets import EditProgBox, EditTextBox
...
class ZenodoPublish:
    def __init__(self, layout, global_message):
        self.layout = layout
        self.layout = layout.container()
    ...
    def zenodo_upload(self, access_token, existing_identifier, sandbox=True, new_deposition=False):
        ...
        import solidipes_core_plugin.uploaders.zenodo as upload
