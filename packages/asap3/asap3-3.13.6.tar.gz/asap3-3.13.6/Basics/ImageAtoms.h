...
public:
  ...
  virtual unsigned int GetNumberOfGhostAtoms() const {return nGhosts + nImages;}
  ...
  virtual unsigned int GetNumberOfAtoms() const {return realatoms->GetNumberOfAtoms();}
  ...
  virtual unsigned long GetTotalNumberOfAtoms() const {return realatoms->GetTotalNumberOfAtoms();}
