      ...
      for url in urls:
          ...
          if not args.no_trim:
            ...
            for sound in board_data_inline["sounds"]:
                ...
                sound_id = str(sound["id"])
                trimmed_sound_export_name = os.path.abspath(f"{trimmed_sounds_dir}/{sound_id}.{format}")
                try:
            ...
            print(f"\r\033[KExported {current_sound} {format.upper()} file{sounds_tense} to \"{trimmed_sounds_dir}\"")
