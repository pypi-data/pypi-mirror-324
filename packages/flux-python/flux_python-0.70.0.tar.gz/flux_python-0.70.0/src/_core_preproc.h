...
# 98 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
int flux_match_asprintf (struct flux_match *m,
                         ...
                         ...);
# 170 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 279 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 380 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 467 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef struct {
    int request_tx;
    int request_rx;
    int response_tx;
...
# 522 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 573 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 607 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 631 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 667 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 721 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef void (*flux_watcher_f)(flux_reactor_t *r,
                               flux_watcher_t *w,
                               int revents,
                               void *arg);
# 733 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_stat_watcher_get_rstat (flux_watcher_t *w,
                                 struct stat *stat,
                                 struct stat *prev);
# 866 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 946 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1009 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1030 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_msglist_pollevents (struct flux_msglist *l);
int flux_msglist_pollfd (struct flux_msglist *l);
# 1065 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_msg_t *flux_request_encode_raw (const char *topic,
                                     const void *data,
                                     size_t len);
# 1136 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_response_decode (const flux_msg_t *msg,
                          const char **topic,
                          const char **s);
# 1148 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1347 "/__w/flux-python/flux-python/src/_core_clean.h"
enum event_flags {
...
# 1467 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1539 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1591 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1632 "/__w/flux-python/flux-python/src/_core_clean.h"
...
void flux_llog (void *arg,
                ...
                const char *fmt,
                va_list ap);
# 1711 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_conf_unpack (const flux_conf_t *conf,
                      ...
                      const char *fmt,
                      ...);
# 1795 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1877 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_future_fulfill_next (flux_future_t *prev,
                              void *result,
                              flux_free_f free_fn);
# 1938 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_barrier (flux_t *h, const char *name, int nprocs);
# 1980 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_register (flux_t *h, const char *name);
# 1992 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_unregister (flux_t *h, const char *name);
# 2044 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2081 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 2168 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_plugin_arg_vunpack (flux_plugin_arg_t *args,
                             ...
                             const char *fmt,
                             va_list ap);
# 2244 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_plugin_call (flux_plugin_t *p,
                      const char *name,
                      flux_plugin_arg_t *args);
# 2255 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_plugin_load_dso (flux_plugin_t *p, const char *path);
# 2287 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_sync_create (flux_t *h, double minimum);
# 2318 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_msglist_cancel (flux_t *h,
                         ...
                         const flux_msg_t *msg);
# 2386 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2469 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef struct flux_kvsdir flux_kvsdir_t;
typedef struct flux_kvsitr flux_kvsitr_t;
# 2484 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2559 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2613 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_getroot (flux_t *h, const char *ns, int flags);
# 2622 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2654 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2753 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2814 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_copy (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2831 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_move (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2854 "/__w/flux-python/flux-python/src/_core_clean.h"
enum kvs_op {
    FLUX_KVS_READDIR = 1,
    FLUX_KVS_READLINK = 2,
    FLUX_KVS_WATCH = 4,
...
# 2876 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2927 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3013 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_id_encode (flux_jobid_t id, const char *type,
                        char *buf, size_t bufsz);
# 3024 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3169 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_timeleft (flux_t *h, flux_error_t *errp, double *timeleft);
# 3185 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3220 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_jobspec1_t *flux_jobspec1_decode (const char *s,
                                       flux_jobspec1_error_t *error);
# 3331 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3387 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3614 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef struct {
...
typedef void (*subprocess_log_f)(void *arg,
                                 ...
                                 const char *fmt,
                                 va_list args);
# 3670 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3714 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3742 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_subprocess_read (flux_subprocess_t *p,
                          const char *stream,
                          const char **bufp);
# 3768 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_subprocess_read_trimmed_line (flux_subprocess_t *p,
                                       const char *stream,
                                       const char **bufp);
# 3787 "/__w/flux-python/flux-python/src/_core_clean.h"
bool flux_subprocess_read_stream_closed (flux_subprocess_t *p,
                                         const char *stream);
# 3805 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3913 "/__w/flux-python/flux-python/src/_core_clean.h"
