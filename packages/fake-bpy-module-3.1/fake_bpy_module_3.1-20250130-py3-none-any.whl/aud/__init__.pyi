...
class Sound:
    ...
    @classmethod
    def ADSR(
        cls, attack: float, decay: float, sustain: float, release: float
    ...
    @classmethod
    def accumulate(cls, additive=False) -> typing_extensions.Self:
    ...
    @classmethod
    def addSound(cls, sound: typing_extensions.Self):
    ...
    @classmethod
    def cache(cls) -> typing_extensions.Self:
    ...
    @classmethod
    def delay(cls, time: float) -> typing_extensions.Self:
    ...
    @classmethod
    def fadein(cls, start: float, length: float) -> typing_extensions.Self:
    ...
    @classmethod
    def fadeout(cls, start: float, length: float) -> typing_extensions.Self:
    ...
    @classmethod
    def filter(cls, b: list[float], a: list[float] = 1) -> typing_extensions.Self:
    ...
    @classmethod
    def highpass(cls, frequency: float, Q: float = 0.5) -> typing_extensions.Self:
    ...
    @classmethod
    def join(cls, sound: typing_extensions.Self) -> typing_extensions.Self:
    ...
    @classmethod
    def limit(cls, start: float, end: float) -> typing_extensions.Self:
    ...
    @classmethod
    def loop(cls, count: int) -> typing_extensions.Self:
        """Loops a sound.
    ...
    @classmethod
    def lowpass(cls, frequency: float, Q: float = 0.5) -> typing_extensions.Self:
    ...
    @classmethod
    def mix(cls, sound: typing_extensions.Self) -> typing_extensions.Self:
        """Mixes two factories.
    ...
    @classmethod
    def modulate(cls, sound: typing_extensions.Self) -> typing_extensions.Self:
    ...
    @classmethod
    def mutable(cls) -> typing_extensions.Self:
    ...
    @classmethod
    def pingpong(cls) -> typing_extensions.Self:
    ...
    @classmethod
    def pitch(cls, factor: float) -> typing_extensions.Self:
    ...
    @classmethod
    def rechannel(cls, channels: int) -> typing_extensions.Self:
    ...
    @classmethod
    def resample(cls, rate: float, high_quality: bool) -> typing_extensions.Self:
        """Resamples the sound.
    ...
    @classmethod
    def reverse(cls) -> typing_extensions.Self:
    ...
    @classmethod
    def sum(cls) -> typing_extensions.Self:
    ...
    @classmethod
    def threshold(cls, threshold: float = 0) -> typing_extensions.Self:
    ...
    @classmethod
    def volume(cls, volume: float) -> typing_extensions.Self:
