...
def captcha_decorator(loginFunc: Callable[[Chrome, str, str, EnumProcesso], tuple[bool, str, str, EnumBanco]]):
    @wraps(loginFunc)
    def wrapper(driver: Chrome, usuario: str, senha: str, enumProcesso: EnumProcesso) -> tuple[bool, str, str]:
        while True:
            logou, imgPath, captcha, enumBanco = loginFunc(driver, usuario, senha, enumProcesso)
...
def loginIBConsig(driver: Chrome, usuario: str, senha: str, enumProcesso: EnumProcesso) -> tuple[bool, str, str, EnumBanco]:
    ...
    return logou, imgPath, captcha, enumBanco
