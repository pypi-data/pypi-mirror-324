...
class ValidationManager:
    ...
    def validate_environment(self) -> None:
        ...
        """
        try:
            logger.start_operation("Validating environment and project files...")
            ...
            if self.config.github.auto_create and self.config.github.token_env_var not in os.environ:
                raise ReleaseError(
                    ...
                    context={
                        "env_var": self.config.github.token_env_var,
                        "auto_create": self.config.github.auto_create
                    },
                    fix_instructions=[
                        f"Set the {self.config.github.token_env_var} environment variable",
                        "Or disable GitHub auto-creation in your configuration"
                    ]
                )
            ...
            if missing_files:
                raise ReleaseError(
                    ...
                    message=f"One or more version files not found",
                    context={
                        "missing_files": missing_files,
                        "configured_files": self.config.version.files
                    },
                    fix_instructions=[
                        ...
                        *[f"- {file}" for file in missing_files],
                        ...
                        "2. Or update version.files in your configuration to match your project structure"
                    ]
                )
            
            logger.success("Environment and file validation passed")
