...
def analyze_changes_for_version_bump(model: str = "gpt-4-1106-preview", temperature: float = 0.7) -> str:
    ...
    analysis = VersionBumpAnalysis(**response)
    console.print(f"[yellow]Version bump analysis: {analysis.reason}[/yellow]")
    return analysis.bump_type


def generate_release_title(version: str, changelog: str, model: str = "gpt-4-1106-preview", temperature: float = 0.7) -> str:
...
def generate_changelog_with_ai(model: str = "gpt-4-1106-preview", temperature: float = 0.7, sections: List[str] = None) -> str:
