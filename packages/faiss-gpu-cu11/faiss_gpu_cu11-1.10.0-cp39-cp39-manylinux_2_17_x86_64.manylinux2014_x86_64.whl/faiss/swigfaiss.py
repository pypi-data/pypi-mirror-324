...
class IndexIVFFastScan(IndexIVF):
    ...
    def init_fastscan(self, fine_quantizer, M, nbits, nlist, metric, bbs):
        ...
        return _swigfaiss.IndexIVFFastScan_init_fastscan(self, fine_quantizer, M, nbits, nlist, metric, bbs)
...
class GpuIndexIVFScalarQuantizerConfig(GpuIndexIVFConfig):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    interleavedLayout = property(_swigfaiss.GpuIndexIVFScalarQuantizerConfig_interleavedLayout_get, _swigfaiss.GpuIndexIVFScalarQuantizerConfig_interleavedLayout_set, doc=r"""
    Use the alternative memory layout for the IVF lists
    (currently the default)
    """)

    def __init__(self):
        _swigfaiss.GpuIndexIVFScalarQuantizerConfig_swiginit(self, _swigfaiss.new_GpuIndexIVFScalarQuantizerConfig())
    __swig_destroy__ = _swigfaiss.delete_GpuIndexIVFScalarQuantizerConfig

# Register GpuIndexIVFScalarQuantizerConfig in _swigfaiss:
_swigfaiss.GpuIndexIVFScalarQuantizerConfig_swigregister(GpuIndexIVFScalarQuantizerConfig)
class GpuIndexIVFScalarQuantizer(GpuIndexIVF):
    ...
    def __init__(self, *args):
        ...
        *Overload 9:*
        ...
        the user provides the number of IVF lists desired.
        """
        _swigfaiss.GpuIndexIVFScalarQuantizer_swiginit(self, _swigfaiss.new_GpuIndexIVFScalarQuantizer(*args))
    ...
    def updateQuantizer(self):
        ...
        in the coarse quantizer outside the scope of training)
        """
        return _swigfaiss.GpuIndexIVFScalarQuantizer_updateQuantizer(self)

    def train(self, n, x):
        r"""Trains the coarse and scalar quantizer based on the given vector data"""
        return _swigfaiss.GpuIndexIVFScalarQuantizer_train(self, n, x)
    sq = property(_swigfaiss.GpuIndexIVFScalarQuantizer_sq_get, _swigfaiss.GpuIndexIVFScalarQuantizer_sq_set, doc=r"""Exposed like the CPU version""")
    by_residual = property(_swigfaiss.GpuIndexIVFScalarQuantizer_by_residual_get, _swigfaiss.GpuIndexIVFScalarQuantizer_by_residual_set, doc=r"""Exposed like the CPU version""")

# Register GpuIndexIVFScalarQuantizer in _swigfaiss:
_swigfaiss.GpuIndexIVFScalarQuantizer_swigregister(GpuIndexIVFScalarQuantizer)
...
class GpuIcmEncoder(IcmEncoder):
    r"""
    ...
    def __init__(self, lsq, provs, devices):
        _swigfaiss.GpuIcmEncoder_swiginit(self, _swigfaiss.new_GpuIcmEncoder(lsq, provs, devices))
    __swig_destroy__ = _swigfaiss.delete_GpuIcmEncoder

    def set_binary_term(self):
        return _swigfaiss.GpuIcmEncoder_set_binary_term(self)

    def encode(self, codes, x, gen, n, ils_iters):
        return _swigfaiss.GpuIcmEncoder_encode(self, codes, x, gen, n, ils_iters)

# Register GpuIcmEncoder in _swigfaiss:
_swigfaiss.GpuIcmEncoder_swigregister(GpuIcmEncoder)
class GpuIcmEncoderFactory(IcmEncoderFactory):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, ngpus=1):
        _swigfaiss.GpuIcmEncoderFactory_swiginit(self, _swigfaiss.new_GpuIcmEncoderFactory(ngpus))

    def get(self, lsq):
        return _swigfaiss.GpuIcmEncoderFactory_get(self, lsq)
    provs = property(_swigfaiss.GpuIcmEncoderFactory_provs_get, _swigfaiss.GpuIcmEncoderFactory_provs_set)
    devices = property(_swigfaiss.GpuIcmEncoderFactory_devices_get, _swigfaiss.GpuIcmEncoderFactory_devices_set)
    __swig_destroy__ = _swigfaiss.delete_GpuIcmEncoderFactory

# Register GpuIcmEncoderFactory in _swigfaiss:
_swigfaiss.GpuIcmEncoderFactory_swigregister(GpuIcmEncoderFactory)
...
class GpuParameterSpace(ParameterSpace):
    r"""parameter space and setters for GPU indexes"""
    ...
    def set_index_parameter(self, index, name, val):
        r"""set a combination of parameters on an index"""
        return _swigfaiss.GpuParameterSpace_set_index_parameter(self, index, name, val)

    def __init__(self):
        _swigfaiss.GpuParameterSpace_swiginit(self, _swigfaiss.new_GpuParameterSpace())
    __swig_destroy__ = _swigfaiss.delete_GpuParameterSpace

# Register GpuParameterSpace in _swigfaiss:
_swigfaiss.GpuParameterSpace_swigregister(GpuParameterSpace)
class ToCPUCloner(Cloner):
    r"""Cloner specialized for GPU -> CPU"""
    ...
    def __init__(self):
        _swigfaiss.ToCPUCloner_swiginit(self, _swigfaiss.new_ToCPUCloner())
    __swig_destroy__ = _swigfaiss.delete_ToCPUCloner

# Register ToCPUCloner in _swigfaiss:
_swigfaiss.ToCPUCloner_swigregister(ToCPUCloner)
class ToGpuCloner(Cloner, GpuClonerOptions):
    r"""Cloner specialized for CPU -> 1 GPU"""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    provider = property(_swigfaiss.ToGpuCloner_provider_get, _swigfaiss.ToGpuCloner_provider_set)
    device = property(_swigfaiss.ToGpuCloner_device_get, _swigfaiss.ToGpuCloner_device_set)

    def __init__(self, prov, device, options):
        _swigfaiss.ToGpuCloner_swiginit(self, _swigfaiss.new_ToGpuCloner(prov, device, options))

    def clone_Index(self, index):
        return _swigfaiss.ToGpuCloner_clone_Index(self, index)
    __swig_destroy__ = _swigfaiss.delete_ToGpuCloner

# Register ToGpuCloner in _swigfaiss:
_swigfaiss.ToGpuCloner_swigregister(ToGpuCloner)
class ToGpuClonerMultiple(Cloner, GpuMultipleClonerOptions):
    r"""Cloner specialized for CPU -> multiple GPUs"""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    sub_cloners = property(_swigfaiss.ToGpuClonerMultiple_sub_cloners_get, _swigfaiss.ToGpuClonerMultiple_sub_cloners_set)

    def __init__(self, *args):
        _swigfaiss.ToGpuClonerMultiple_swiginit(self, _swigfaiss.new_ToGpuClonerMultiple(*args))
...
# Register ToGpuClonerMultiple in _swigfaiss:
_swigfaiss.ToGpuClonerMultiple_swigregister(ToGpuClonerMultiple)

def index_gpu_to_cpu(gpu_index):
    r"""converts any GPU index inside gpu_index to a CPU index"""
    return _swigfaiss.index_gpu_to_cpu(gpu_index)

def index_cpu_to_gpu(provider, device, index, options=None):
    r"""converts any CPU index that can be converted to GPU"""
...
class GpuProgressiveDimIndexFactory(ProgressiveDimIndexFactory):
    r"""index factory for the ProgressiveDimClustering object"""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    options = property(_swigfaiss.GpuProgressiveDimIndexFactory_options_get, _swigfaiss.GpuProgressiveDimIndexFactory_options_set)
    vres = property(_swigfaiss.GpuProgressiveDimIndexFactory_vres_get, _swigfaiss.GpuProgressiveDimIndexFactory_vres_set)
    devices = property(_swigfaiss.GpuProgressiveDimIndexFactory_devices_get, _swigfaiss.GpuProgressiveDimIndexFactory_devices_set)
    ncall = property(_swigfaiss.GpuProgressiveDimIndexFactory_ncall_get, _swigfaiss.GpuProgressiveDimIndexFactory_ncall_set)

    def __init__(self, ngpu):
        _swigfaiss.GpuProgressiveDimIndexFactory_swiginit(self, _swigfaiss.new_GpuProgressiveDimIndexFactory(ngpu))

    def __call__(self, dim):
        return _swigfaiss.GpuProgressiveDimIndexFactory___call__(self, dim)
    __swig_destroy__ = _swigfaiss.delete_GpuProgressiveDimIndexFactory

# Register GpuProgressiveDimIndexFactory in _swigfaiss:
_swigfaiss.GpuProgressiveDimIndexFactory_swigregister(GpuProgressiveDimIndexFactory)

def index_binary_gpu_to_cpu(gpu_index):
    return _swigfaiss.index_binary_gpu_to_cpu(gpu_index)

def index_binary_cpu_to_gpu(provider, device, index, options=None):
    r"""converts any CPU index that can be converted to GPU"""
    return _swigfaiss.index_binary_cpu_to_gpu(provider, device, index, options)

def index_binary_cpu_to_gpu_multiple(provider, devices, index, options=None):
    return _swigfaiss.index_binary_cpu_to_gpu_multiple(provider, devices, index, options)
