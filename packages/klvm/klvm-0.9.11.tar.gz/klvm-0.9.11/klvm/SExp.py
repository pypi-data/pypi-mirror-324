...
from .KLVMObject import KLVMObject, KLVMStorage
...
def looks_like_klvm_object(o: typing.Any) -> typing_extensions.TypeGuard[KLVMStorage]:
    d = dir(o)
...
class SExp:
    ...
    pair: typing.Optional[typing.Tuple[KLVMStorage, KLVMStorage]]

    def __init__(self, obj: KLVMStorage) -> None:
        self.atom = obj.atom
        self.pair = obj.pair
