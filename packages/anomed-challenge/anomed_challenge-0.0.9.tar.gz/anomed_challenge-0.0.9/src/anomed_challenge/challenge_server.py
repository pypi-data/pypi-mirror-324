...
def _demo_anonymizer_submitter(req, evaluation) -> None:
    url = "http://anomed-app/submissions/anonymizer-evaluation-results"
    demo_evaluation = {
        "secret": "",
        "anonymizer": "demo-anonymizer",
        "mae": 0.5,
        "rmse": 0.5,
        "coeff_determ": 0.5,
        "accuracy": 0.5,
...
def _demo_deanonymizer_submitter(req, evaluation) -> None:
    url = "http://anomed-app/submissions/deanonymizer-evaluation-results"
    demo_evaluation = {
        "secret": "",
        "deanonymizer": "demo-deanonymizer",
        "fpr": 0.5,
        "tpr": 0.5,
    }
    requests.post(url=url, json=demo_evaluation)
