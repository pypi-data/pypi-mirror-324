...
class RandomProjection(numcodecs.abc.Codec):
    ...
    projection : ...
         ...
         - "sparse": The random projection matrix is sparse where only `density`% of entries
            ...
            - `+sqrt(1 / (k * density))` with probability `density/2`
    reduction : ...
         - "johnson-lindenstrauss": The reduced dimensionality `K` is derived from `epsilon`, as defined by
            the Johnson-Lindenstrauss lemma.
        
         - "explicit": The reduced dimensionality `K`, to which the data is projected, is given
            explicitly.
    seed : ...
    ...
    **kwargs
    ...
    def __init__(self, projection, reduction, seed, density=None, epsilon=None, k=None, **kwargs): ...

    codec_id = 'random-projection'
