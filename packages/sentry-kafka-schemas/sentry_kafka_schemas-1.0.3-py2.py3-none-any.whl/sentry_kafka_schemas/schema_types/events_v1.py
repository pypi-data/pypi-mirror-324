from typing import Required, Dict, Any, Literal, TypedDict, Tuple, Union, List
...
_ContextsFlags = Union["_FlagContext", None]
""" Aggregation type: anyOf """
...
class _FlagContext(TypedDict, total=False):
    version: Union[int, float]
    values: Required[List["_FlagContextItem"]]
    """ Required property """



class _FlagContextItem(TypedDict, total=False):
    flag: str
    result: Union[str, Union[int, float], Dict[str, Any], List[Any], bool, None]
