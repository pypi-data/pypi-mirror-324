...
class IMAGE_PT_udim_grid(bpy.types.Panel):
    bl_category: typing.Any
    bl_label: typing.Any
    bl_region_type: typing.Any
    bl_rna: typing.Any
...
class IMAGE_PT_uv_sculpt_brush_settings(
    ImagePaintPanel, bpy.types.Panel, UVSculptPanel
):
    bl_category: typing.Any
    bl_context: typing.Any
    bl_label: typing.Any
...
class IMAGE_PT_uv_sculpt_options(ImagePaintPanel, bpy.types.Panel, UVSculptPanel):
    bl_category: typing.Any
    bl_context: typing.Any
    bl_label: typing.Any
    bl_region_type: typing.Any
