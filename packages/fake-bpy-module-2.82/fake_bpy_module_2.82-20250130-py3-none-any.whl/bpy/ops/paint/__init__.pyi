...
def brush_select(
    ...
    *,
    ...
    | None = "DRAW",
    gpencil_tool: typing.Literal["DRAW", "FILL", "ERASE"] | None = "DRAW",
    ...
    """Select a paint mode's brush by tool type
        ...
        :type sculpt_tool: typing.Literal['DRAW','DRAW_SHARP','CLAY','CLAY_STRIPS','LAYER','INFLATE','BLOB','CREASE','SMOOTH','FLATTEN','FILL','SCRAPE','MULTIPLANE_SCRAPE','PINCH','GRAB','ELASTIC_DEFORM','SNAKE_HOOK','THUMB','POSE','NUDGE','ROTATE','TOPOLOGY','SIMPLIFY','MASK'] | None
    ...
    ERASE Erase, The brush is used for erasing strokes.
        :type gpencil_tool: typing.Literal['DRAW','FILL','ERASE'] | None
