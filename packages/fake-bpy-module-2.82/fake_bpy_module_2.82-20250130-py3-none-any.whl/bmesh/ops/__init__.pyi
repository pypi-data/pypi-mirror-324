...
def beautify_fill(
    ...
    method: typing.Literal["AREA", "ANGLE"],
) -> dict[str, typing.Any]:
...
def bevel(
    ...
    miter_outer: typing.Literal["SHARP", "PATCH", "ARC"],
    miter_inner: typing.Literal["SHARP", "PATCH", "ARC"],
    spread: float,
    smoothresh: float,
    ...
    """Bevel.Bevels edges and vertices
        ...
        :type offset_type: typing.Literal['OFFSET','WIDTH','DEPTH','PERCENT']
...
def poke(
    ...
    faces: list[bmesh.types.BMFace],
    offset: float,
    center_mode: typing.Literal["MEAN_WEIGHTED", "MEAN", "BOUNDS"],
    use_relative_offset: bool,
) -> dict[str, typing.Any]:
...
def subdivide_edgering(
    bm: bmesh.types.BMesh,
    edges: list[bmesh.types.BMEdge],
    interp_mode: typing.Literal["LINEAR", "PATH", "SURFACE"],
    smooth: float,
    cuts: int,
...
def subdivide_edges(
    ...
    custom_patterns,
    edge_percents,
    quad_corner_type: typing.Literal["STRAIGHT_CUT", "INNER_VERT", "PATH", "FAN"],
    use_grid_fill: bool,
...
def symmetrize(
    ...
    | list[bmesh.types.BMFace]
    | list[bmesh.types.BMVert],
    direction: typing.Literal["-X", "-Y", "-Z", "X", "Y", "Z"],
    dist: float,
) -> dict[str, typing.Any]:
...
def triangulate(
    bm: bmesh.types.BMesh,
    faces: list[bmesh.types.BMFace],
    quad_method: typing.Literal["BEAUTY", "FIXED", "ALTERNATE", "SHORT_EDGE"],
    ngon_method: typing.Literal["BEAUTY", "EAR_CLIP"],
) -> dict[str, typing.Any]:
    """Triangulate.
        ...
        :type quad_method: typing.Literal['BEAUTY','FIXED','ALTERNATE','SHORT_EDGE']
