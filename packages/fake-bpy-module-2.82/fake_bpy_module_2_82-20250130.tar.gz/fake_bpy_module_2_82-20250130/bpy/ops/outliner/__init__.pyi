...
def id_operation(
    ...
    *,
    ...
    SELECT_LINKED Select Linked.
        :type type: typing.Literal['UNLINK','LOCAL','OVERRIDE_LIBRARY','SINGLE','DELETE','REMAP','COPY','PASTE','ADD_FAKE','CLEAR_FAKE','RENAME','SELECT_LINKED'] | None
    """
...
def object_operation(
    ...
    *,
    ...
    OBJECT_MODE_EXIT Exit Mode.
        :type type: typing.Literal['SELECT','DESELECT','SELECT_HIERARCHY','DELETE','DELETE_HIERARCHY','REMAP','RENAME','OBJECT_MODE_ENTER','OBJECT_MODE_EXIT'] | None
    """
