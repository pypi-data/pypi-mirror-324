...
class KISDomesticStock:
    ...
    def order_rvsecncl(self, cano: str, acnt_prdt_cd: str, orgn_odno: str, ord_dvsn: str, rvse_cncl_dvsn_cd: str, ord_qty: int, ord_unpr: int, qty_all_ord_yn: str):
        """
    ...
    def inquire_psbl_rvsecncl(
        ...
        params = {"CANO": cano, "ACNT_PRDT_CD": acnt_prdt_cd, "INQR_DVSN_1": inqr_dvsn_1, "INQR_DVSN_2": inqr_dvsn_2, "CTX_AREA_FK100": ctx_area_fk100, "CTX_AREA_NK100": ctx_area_nk100}
            ...
            if tr_id in tr_ids:
                if iv and key:
                    ...
                    for i, k in enumerate(keys):
                        if k in ["cntg_unpr", "order_prc", "cntg_qty", "oder_qty"] and len(values[i]) > 0:
