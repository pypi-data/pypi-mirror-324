...
USE_SITES = getattr(settings, "FORMS_BUILDER_USE_SITES", hasattr(settings, "SITE_ID"))
...
EMAIL_FAIL_SILENTLY = getattr(settings, "FORMS_BUILDER_EMAIL_FAIL_SILENTLY", settings.DEBUG)
