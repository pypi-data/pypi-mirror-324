...
def brush_select(
    ...
    *,
    ...
    """Select a paint mode's brush by tool type
        ...
        :type sculpt_tool: typing.Literal['DRAW','DRAW_SHARP','CLAY','CLAY_STRIPS','CLAY_THUMB','LAYER','INFLATE','BLOB','CREASE','SMOOTH','FLATTEN','FILL','SCRAPE','MULTIPLANE_SCRAPE','PINCH','GRAB','ELASTIC_DEFORM','SNAKE_HOOK','THUMB','POSE','NUDGE','ROTATE','TOPOLOGY','CLOTH','SIMPLIFY','MASK','PAINT','SMEAR','DRAW_FACE_SETS'] | None
