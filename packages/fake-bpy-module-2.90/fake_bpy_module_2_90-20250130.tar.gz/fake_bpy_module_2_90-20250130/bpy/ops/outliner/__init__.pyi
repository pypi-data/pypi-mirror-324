...
def id_operation(
    ...
    *,
    ...
    SELECT_LINKED
    Select Linked.
        :type type: typing.Literal['UNLINK','LOCAL','SINGLE','DELETE','REMAP','OVERRIDE_LIBRARY_CREATE','OVERRIDE_LIBRARY_CREATE_HIERARCHY','OVERRIDE_LIBRARY_RESET','OVERRIDE_LIBRARY_RESET_HIERARCHY','COPY','PASTE','ADD_FAKE','CLEAR_FAKE','RENAME','SELECT_LINKED'] | None
    """
...
def object_operation(
    ...
    *,
    ...
    OBJECT_MODE_EXIT
    Exit Mode.
        :type type: typing.Literal['SELECT','DESELECT','SELECT_HIERARCHY','REMAP','RENAME','OBJECT_MODE_ENTER','OBJECT_MODE_EXIT'] | None
    """
