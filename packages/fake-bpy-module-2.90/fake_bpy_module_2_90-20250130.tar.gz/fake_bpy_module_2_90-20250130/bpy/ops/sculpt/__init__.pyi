...
def cloth_filter(
    ...
    /,
    *,
    type: typing.Literal["GRAVITY", "INFLATE", "EXPAND", "PINCH"] | None = "GRAVITY",
    ...
    Pinch, Pinches the cloth to the point where the cursor was when the filter started.
        :type type: typing.Literal['GRAVITY','INFLATE','EXPAND','PINCH'] | None
...
def color_filter(
    ...
    *,
    ...
    | None = "HUE",
    strength: float | None = 1.0,
    fill_color: collections.abc.Iterable[float] | None = (0.0, 0.0, 0.0),
):
    ...
    Blue, Change blue channel.
        :type type: typing.Literal['FILL','HUE','SATURATION','VALUE','BRIGTHNESS','CONTRAST','SMOOTH','RED','GREEN','BLUE'] | None
        :param strength: Strength, Filter Strength
        :type strength: float | None
        :param fill_color: Fill Color
        :type fill_color: collections.abc.Iterable[float] | None
    """
...
def face_set_edit(
    ...
    /,
    *,
    mode: typing.Literal["GROW", "SHRINK"] | None = "GROW",
):
    ...
    Shrink Face Set, Shrinks the Face Sets boundary by one face based on mesh topology.
        :type mode: typing.Literal['GROW','SHRINK'] | None
    """
