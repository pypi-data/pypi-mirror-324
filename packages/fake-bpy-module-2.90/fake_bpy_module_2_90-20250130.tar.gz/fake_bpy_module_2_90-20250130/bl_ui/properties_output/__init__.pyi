...
class RENDER_PT_dimensions(RenderOutputButtonsPanel, bpy.types.Panel):
...
class RENDER_PT_frame_remapping(RenderOutputButtonsPanel, bpy.types.Panel):
    COMPAT_ENGINES: typing.Any
    bl_context: typing.Any
    bl_label: typing.Any
    bl_options: typing.Any
...
class RENDER_PT_presets(bl_ui.utils.PresetPanel, bpy.types.Panel):
    bl_label: typing.Any
    bl_region_type: typing.Any
    bl_rna: typing.Any
    bl_space_type: typing.Any
