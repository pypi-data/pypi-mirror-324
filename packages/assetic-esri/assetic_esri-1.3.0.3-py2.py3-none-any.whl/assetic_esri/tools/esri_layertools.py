...
class LayerTools(LayerToolsBase):
    ...
    def create_assets(self, lyr, query=None, two_step_transform_mappings: dict = None):
        """
    ...
    def create_asset(self, lyr, query=None, two_step_transform_mappings: dict = None):
    ...
    def update_assets(self, lyr, query=None, two_step_transform_mappings: dict = None):
        """
    ...
    def bulk_update_spatial(self, rows, lyr, lyr_config, two_step_transform_mappings=None):
        ...
        for row in rows:
            if "SHAPE@" in row:
                ...
                # check if two-step transform is required
    ...
    def get_geom_geojson(self, outsrid, geometry, centroid=None, two_step_transform_mappings=None):
        ...
        # check if step transform specified by user, need to transform geometry to a middle crs before assetic
        # should be the WKID which is an integer value, the user mapping dict should be int too to make it easier
        geometry_sr = geometry.spatialReference
        geometry_sr_factorycode = geometry_sr.factoryCode
