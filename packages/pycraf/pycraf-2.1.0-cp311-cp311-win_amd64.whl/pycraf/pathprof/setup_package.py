...
def get_extensions():
    ...
    add_openmp_flags_if_available(ext_module_pathprof_cyimt)
    ...
    add_openmp_flags_if_available(ext_module_pathprof_cyprop)
    ...
    add_openmp_flags_if_available(ext_module_pathprof_geodesics)
