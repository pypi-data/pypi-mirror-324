...
#     ext_module_pathprof_cygeometry = Extension(
#         name='pycraf.geometry.cygeometry',
#         sources=[os.path.join(PYXDIR, 'cygeometry.pyx')],
#         **comp_args
#         )

#     return [ext_module_pathprof_cygeometry]
...
def get_extensions():
    ...
    add_openmp_flags_if_available(ext_module_pathprof_cygeometry)
