...
#     ext_module_pathprof_cyantenna = Extension(
#         name='pycraf.antenna.cyantenna',
#         sources=[os.path.join(PYXDIR, 'cyantenna.pyx')],
#         **comp_args
#         )

#     return [ext_module_pathprof_cyantenna]
...
def get_extensions():
    ...
    add_openmp_flags_if_available(ext_module_pathprof_cyantenna)
    return [ext_module_pathprof_cyantenna]
