...
from flyteidl.core.tasks_pb2 import Container, ContainerPort, ExtendedResources
...
class App:
    ...
    def _to_union_idl(self, settings: AppSerializationSettings) -> AppIDL:
        ...
        if self.secrets:
            security_context = SecurityContext(secrets=[s.to_flyte_idl() for s in self.secrets])
