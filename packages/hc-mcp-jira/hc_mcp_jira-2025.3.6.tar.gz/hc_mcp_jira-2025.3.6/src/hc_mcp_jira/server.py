...
async def handle_list_tools() -> list[types.Tool]:
    ...
    return [
        ...
        types.Tool(
            name="create_issue",
            description="Create a new Jira issue with specified details. Returns a JSON response containing the created issue's key, ID, and self URL. Supports creating subtasks by providing a parent issue key. Note: Project templates may override the description after creation - you may need to update the description in a separate step after creation.",
            inputSchema={
                "type": "object",
                "properties": {
