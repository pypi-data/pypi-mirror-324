...
class Instruct(Node):
    ...
    class InitSchema(Node.InitSchema):
        ...
        examples: str = Field("", description="Examples in JSON format (list of dicts)", json_schema_extra={"uiSchema": {"ui:widget": "textarea", "ui:options": {"rows": 10}}})
        general_info: str = Field("", description="General information in JSON format (list of strings)", json_schema_extra={"uiSchema": {"ui:widget": "textarea", "ui:options": {"rows": 10}}})
    ...
    def format_general_info(self, general_info: list = None) -> str:
        ...
        general_info.extend([
            ...
            f"The timezone is: {os.environ.get('TZ', 'europe/paris')}",
        ])
