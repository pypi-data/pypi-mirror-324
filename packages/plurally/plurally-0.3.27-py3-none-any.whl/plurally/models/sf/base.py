...
SALESFORCE_TYPE_MAPPING = {
    "id": {"_type": str},
    "date": {"_type": date | str},
    "datetime": {"_type": datetime | str, "description": "Use following format: YYYY-MM-DDThh:mm:ss+hh:mm or YYYY-MM-DDThh:mm:ss-hh:mm specifying the timezone provided."},
    "string": {"_type": str},
            ...
            if field_type == "picklist":
                if enforce_enums:
                    ...
                    enum_kls = enum.Enum(
                        ...
                        # {v["value"]: v["value"] for v in picklist_vals},
                    )
                    pytype = enum_kls
                else:
                    pytype = str
