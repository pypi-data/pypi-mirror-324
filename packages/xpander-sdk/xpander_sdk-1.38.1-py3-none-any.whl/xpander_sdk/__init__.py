...
class Execution(Base, metaclass=jsii.JSIIMeta, jsii_type="xpander-sdk.Execution"):
    ...
    def create(
        ...
        return typing.cast(typing.Any, jsii.sinvoke(cls, "create", [agent, input, files, worker_id, thread_id]))
...
class Memory(Base, metaclass=jsii.JSIIMeta, jsii_type="xpander-sdk.Memory"):
    ...
    def init_messages(
        ...
        return typing.cast(None, jsii.invoke(self, "initMessages", [input, instructions, llm_provider]))
