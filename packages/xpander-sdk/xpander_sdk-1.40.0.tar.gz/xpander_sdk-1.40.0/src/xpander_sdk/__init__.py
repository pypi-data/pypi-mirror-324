...
class Graph(Base, metaclass=jsii.JSIIMeta, jsii_type="xpander-sdk.Graph"):
    ...
    def add_node(self, node: typing.Union["GraphItem", "Agent"]) -> "GraphItem":
        '''
        :param node: -
        '''
        if __debug__:
    ...
    def last_node(self) -> "GraphItem":
        return typing.cast("GraphItem", jsii.get(self, "lastNode"))
...
class GraphItem(Base, metaclass=jsii.JSIIMeta, jsii_type="xpander-sdk.GraphItem"):
    def __init__(
        ...
        settings: typing.Optional["IAgentGraphItemSettings"] = None,
    ) -> None:
        '''
        :param agent: -
        :param id: -
...
class Agent(Base, metaclass=jsii.JSIIMeta, jsii_type="xpander-sdk.Agent"):
    ...
    def __init__(
        ...
        jsii.create(self.__class__, self, [configuration, id, name, organization_id, status, memory_type, memory_strategy, instructions, access_scope, source_nodes, prompts, tools, _graph, knowledge_bases])
...
def _typecheckingstub__fa425681e3f5e5317e5e11364c4e8fd5e072b73205f40342eb460fdc7c769fa5(
    node: typing.Union[GraphItem, Agent],
) -> None:
    """Type checking stubs"""
    pass
