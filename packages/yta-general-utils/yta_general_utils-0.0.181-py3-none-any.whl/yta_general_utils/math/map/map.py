...
class Map:
    ...
    def add_coordinate(self, position: Union[tuple[float, float], list[float]]):
        """
    ...
    def get_xy_from_normalized_global_d(self, d: float):
        """
    ...
    def _get_pair_of_coordinates_index_from_normalized_global_d(self, d: float):
        """
    ...
    def _get_pair_of_coordinates_from_normalized_global_d(self, d: float):
        """
    ...
    def _get_normalized_local_d_from_normalized_global_d(self, d: float):
        """
