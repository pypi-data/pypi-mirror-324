...
class ChromeScrapper:
    ...
    options = None
    # TODO: Maybe make 'driver' private attribute in ChromeScrapper to
    # avoid exposing it
    driver = None
    ...
    def go_to_web_and_wait_util_loaded(self, url: str):
        """
        ...
        ChromeScrapper object was created.
