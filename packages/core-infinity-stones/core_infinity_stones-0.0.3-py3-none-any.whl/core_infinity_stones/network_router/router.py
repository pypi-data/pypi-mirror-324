            ...
            try:
                print(
                    f'''
                        ...
                        Query Params: {http_request.query_params}
                ...
                print('HTTPX Response:', httpx_response)
                print('HTTPX Response Status Code:', httpx_response.status_code)
                print('HTTPX Response Body:', httpx_response.content)
            except httpx.HTTPStatusError as e:
                print('HTTPX Error:', e)
                print('HTTPX Error Response Status Code:', e.response.status_code)
                print('HTTPX Error Response:', e.response)
