...
class Pco(numcodecs.abc.Codec):
    ...
    def __init__(self, delta, level, mode, paging, delta_encoding_order=None, equal_pages_up_to=262144, float_mult_base=None, float_quant_bits=None, int_mult_base=None): ...
