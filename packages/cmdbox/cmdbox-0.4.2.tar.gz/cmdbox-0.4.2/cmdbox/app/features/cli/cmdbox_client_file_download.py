            ...
            choice=[
                ...
                dict(opt="scope", type="str", default="client", required=True, multi=False, hide=False, choice=["client", "current", "server"],
                     ...
                     test_true={"server":"server",
                                "client":"client",
                                "current":"current"}),
                dict(opt="rpath", type="str", default="", required=False, multi=False, hide=False, choice=None,
                ...
                dict(opt="download_file", type="file", default="", required=False, multi=False, hide=False, choice=None, fileio="out",
                ...
                dict(opt="client_data", type="str", default=None, required=False, multi=False, hide=False, choice=None,
                     ...
                     test_true={"server":None,
                                ...
                                "current":None}),
                dict(opt="img_thumbnail", type="float", default=None, required=False, multi=False, hide=True, choice=None,
