    ...
    def get_option(self):
        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="from_path", type="str", default=None, required=True, multi=False, hide=False, choice=None,
                ...
                dict(opt="to_path", type="str", default=None, required=True, multi=False, hide=False, choice=None,
