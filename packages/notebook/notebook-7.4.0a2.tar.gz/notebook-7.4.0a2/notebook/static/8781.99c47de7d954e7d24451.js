...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(34686);
...
async function main() {
  const mimeExtensionsMods = [
    ...
    __webpack_require__(54942),
    __webpack_require__(7422),
    __webpack_require__(89625),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(78690),
  __webpack_require__(7047),
  __webpack_require__(82835),
  __webpack_require__(43782),
  __webpack_require__(75600),
  __webpack_require__(98773),
  __webpack_require__(83563),
  
      (__webpack_require__(58289)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(30549)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(24410),
  
      (__webpack_require__(24214)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(70495)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(46749),
  
      (__webpack_require__(37667)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(52717)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(27359)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(16075)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(1169)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(6650),
  __webpack_require__(81925),
  __webpack_require__(65455),
  
      (__webpack_require__(40446)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(26840),
  __webpack_require__(91389),
  __webpack_require__(1538),
  
      (__webpack_require__(29254)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(48267),
  __webpack_require__(25564),
  __webpack_require__(48717),
  __webpack_require__(8456),
  __webpack_require__(67595),
  __webpack_require__(47573),
  __webpack_require__(56561),
  __webpack_require__(98954),
  __webpack_require__(36861),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(10025),
  
      (__webpack_require__(57187)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(27492),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(36432),
  __webpack_require__(5901),
  
      (__webpack_require__(99487)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(61859)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(35878)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(46343).NotebookApp);
...
//# sourceMappingURL=8781.99c47de7d954e7d24451.js.map?v=99c47de7d954e7d24451