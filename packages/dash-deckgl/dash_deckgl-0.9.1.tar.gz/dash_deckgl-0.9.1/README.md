...
The main difference between this component and the [dash-deck](https://github.com/plotly/dash-deck) is the ability to inject custom deck.gl layers within the Dash app code without rebuilding the component.
