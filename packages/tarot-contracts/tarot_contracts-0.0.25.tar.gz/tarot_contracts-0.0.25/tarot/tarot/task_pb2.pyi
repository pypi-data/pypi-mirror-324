...
class MessageActionPayload(_message.Message):
    __slots__ = ["title", "url"]
...
class SendMessagePayload(_message.Message):
    __slots__ = ["message", "recipient_id", "action"]
    ...
    def __init__(self, message: _Optional[str] = ..., recipient_id: _Optional[int] = ..., action: _Optional[_Union[MessageActionPayload, _Mapping]] = ...) -> None: ...

class SendMessageBatchPayload(_message.Message):
    __slots__ = ["message", "recipient_ids", "action"]
    MESSAGE_FIELD_NUMBER: _ClassVar[int]
    ...
    action: MessageActionPayload
    def __init__(self, message: _Optional[str] = ..., recipient_ids: _Optional[_Iterable[int]] = ..., action: _Optional[_Union[MessageActionPayload, _Mapping]] = ...) -> None: ...

class ScheduleTaskRequest(_message.Message):
    __slots__ = ["name", "due_date", "type", "status", "send_message_payload", "send_batch_message_payload"]
    ...
    def __init__(self, name: _Optional[str] = ..., due_date: _Optional[str] = ..., type: _Optional[_Union[TaskType, str]] = ..., status: _Optional[_Union[TaskStatus, str]] = ..., send_message_payload: _Optional[_Union[SendMessagePayload, _Mapping]] = ..., send_batch_message_payload: _Optional[_Union[SendMessageBatchPayload, _Mapping]] = ...) -> None: ...
