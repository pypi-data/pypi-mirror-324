...
class ScheduleTaskRequest(_message.Message):
    __slots__ = ["name", "due_date", "type", "send_message_payload", "send_batch_message_payload"]
    ...
    def __init__(self, name: _Optional[str] = ..., due_date: _Optional[str] = ..., type: _Optional[_Union[TaskType, str]] = ..., send_message_payload: _Optional[_Union[SendMessagePayload, _Mapping]] = ..., send_batch_message_payload: _Optional[_Union[SendMessageBatchPayload, _Mapping]] = ...) -> None: ...
