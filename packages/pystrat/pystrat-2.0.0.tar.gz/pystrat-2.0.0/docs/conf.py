...
module_dir = os.path.join(__location__, "../src/pystrat")
try:
...
try:
    from pystrat import __version__ as version
except ImportError:
    version = ""
...
latex_documents = [
    ("index", "user_guide.tex", "pystrat Documentation", "Adrian Tasistro-Hart", "manual")
]
