...
class MatPlotLibChart(wx.Panel):
    ...
    # @classmethod
    # def create(cls, parent_control, name):
    #
    #     if not name in old_panels:
    #         panel = MatPlotLibChart(parent_control, name)
    #         old_panels[name] = panel
    #
    #     return old_panels[name]
