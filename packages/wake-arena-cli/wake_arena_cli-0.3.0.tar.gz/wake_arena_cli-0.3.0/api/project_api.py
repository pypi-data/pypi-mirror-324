...
class ProjectApi:
    __CLIENT_CREDENTIALS = {
        ...
        "client_secret": "dd78e3d1c4b7b01b49c1be7d05b112fefcdb2da1906b934ee46a5d79eadbaf40",
    }

    def __init__(self, logger: Logger, server_url: str, token: str = None, oauth_client_id: str = None, oauth_client_secret: str = None):
        self.logger = logger
        self.token = token
        self.server_url = server_url
        self.oauth_client_id = oauth_client_id if oauth_client_id else self.__CLIENT_CREDENTIALS["client_id"]
        self.oauth_client_secret = oauth_client_secret if oauth_client_secret else self.__CLIENT_CREDENTIALS["client_secret"]
        self.headers = {}
