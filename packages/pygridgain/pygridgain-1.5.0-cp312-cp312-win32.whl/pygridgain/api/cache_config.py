...
GridGain `cache` can be viewed as a named entity designed to store key-value
pairs. Each cache is split transparently between different GridGain
partitions.

The choice of `cache` term is due to historical reasons. (GridGain initially
had only non-persistent storage tier.)
"""

from typing import Union

from pygridgain.connection import Connection, AioConnection
from pygridgain.datatypes.cache_config import get_cache_config_struct
from pygridgain.datatypes.cache_properties import prop_map
from pygridgain.datatypes import Int, prop_codes, Short, String, StringArray
from pygridgain.queries import Query, ConfigQuery, query_perform
