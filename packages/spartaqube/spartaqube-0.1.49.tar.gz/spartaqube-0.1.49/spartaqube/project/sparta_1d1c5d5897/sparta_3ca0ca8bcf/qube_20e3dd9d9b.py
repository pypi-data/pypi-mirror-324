...
def sparta_a38aef0096(user_obj):
	B=user_obj
	...
	return A
def sparta_f39b881f1f(json_data,user_obj):
...
def sparta_bb3478c54c(json_data,user_obj):
...
def sparta_32014b4c96(json_data,user_obj):
	...
	return{_C:1}
def sparta_4a26d84bca(json_data,user_obj):
