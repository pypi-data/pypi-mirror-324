...
class ApiWebserviceWS(WebsocketConsumer):
	def create_kernel_in_global_kernel_manager(A,kernel_manager_uuid):from project.sparta_1d1c5d5897.sparta_fad3ec945b import qube_1a6dfd0324 as B;C=2;D='';E=A.user;F=B.SqKernelManager(kernel_manager_uuid,C,D,E);F.create_kernel()
	def sparta_f9652966ca(B,kernel_manager_uuid):
	...
	async def create_kernel(A):B=sparta_4841534c3e(A.user);return await IPythonKernel(api_key=B,django_settings_module='app.settings')
