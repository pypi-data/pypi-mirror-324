...
from htmldocs import Htmldocs, AsyncHtmldocs, APIResponseValidationError
from htmldocs._types import Omit
from htmldocs._models import BaseModel, FinalRequestOptions
from htmldocs._constants import RAW_RESPONSE_HEADER
from htmldocs._exceptions import HtmldocsError, APIStatusError, APITimeoutError, APIResponseValidationError
from htmldocs._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Htmldocs | AsyncHtmldocs) -> int:
...
class TestHtmldocs:
    client = Htmldocs(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "htmldocs/_legacy_response.py",
                        "htmldocs/_response.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(HtmldocsError):
            with update_env(**{"BEARER_TOKEN": Omit()}):
                client2 = Htmldocs(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Htmldocs) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(HTMLDOCS_BASE_URL="http://localhost:5000/from/env"):
            client = Htmldocs(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Htmldocs) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Htmldocs) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Htmldocs) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Htmldocs(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Htmldocs(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("htmldocs._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/api/generate").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/api/generate").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/api/generate").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: Htmldocs, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.documents.with_raw_response.generate_html(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.documents.with_raw_response.generate_html(extra_headers={"x-stainless-retry-count": "42"})

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncHtmldocs:
    client = AsyncHtmldocs(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(HtmldocsError):
            with update_env(**{"BEARER_TOKEN": Omit()}):
                client2 = AsyncHtmldocs(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncHtmldocs) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(HTMLDOCS_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncHtmldocs(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncHtmldocs) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncHtmldocs) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncHtmldocs) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncHtmldocs(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncHtmldocs(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.documents.with_raw_response.generate_html()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncHtmldocs, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from htmldocs._utils import asyncify
        from htmldocs._base_client import get_platform 
