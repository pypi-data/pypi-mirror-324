...
class CardPlayer(
    ...
    def __init__(self, my_hand: CardHand) -> None:
        '''
        :param my_hand: -
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6ed655a58e0b7fe623a83b5ecee5c5ec87663a6a7ec10c0f5ae6c951f2d2a090)
            check_type(argname="argument my_hand", value=my_hand, expected_type=type_hints["my_hand"])
        jsii.create(self.__class__, self, [my_hand])
    ...
    @builtins.property
    @jsii.member(jsii_name="myHand")
    def _my_hand(self) -> CardHand:
        return typing.cast(CardHand, jsii.get(self, "myHand"))

    @_my_hand.setter
    def _my_hand(self, value: CardHand) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6d3e442e584eb5edcc4d72e2827635be508afb986cd6912801e6245db4896db6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "myHand", value) # pyright: ignore[reportArgumentType]

    @builtins.property
    @jsii.member(jsii_name="myScore")
    def _my_score(self) -> jsii.Number:
        return typing.cast(jsii.Number, jsii.get(self, "myScore"))

    @_my_score.setter
    def _my_score(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__48bdeee7ff17775b96d3affafe6e943f263678e29d6884c00f5206966d3c4452)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "myScore", value) # pyright: ignore[reportArgumentType]
...
def _typecheckingstub__6d3e442e584eb5edcc4d72e2827635be508afb986cd6912801e6245db4896db6(
    value: CardHand,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__48bdeee7ff17775b96d3affafe6e943f263678e29d6884c00f5206966d3c4452(
    value: jsii.Number,
) -> None:
    """Type checking stubs"""
    pass
