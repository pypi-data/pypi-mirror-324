...
with gaurav_test0_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gaurav_test0_sdk.PetApi(api_client)
    pet = gaurav_test0_sdk.Pet() # Pet | Create a new pet in the store
