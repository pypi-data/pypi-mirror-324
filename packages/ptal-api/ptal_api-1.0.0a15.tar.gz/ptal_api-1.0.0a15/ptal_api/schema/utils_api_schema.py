...
class ConceptMentionCountBatchInput(sgqlc.types.Input):
    __schema__ = utils_api_schema
    __field_names__ = ('extend_results', 'inputs', 'limit')
...
class ConceptMentionCountInput(sgqlc.types.Input):
    __schema__ = utils_api_schema
    __field_names__ = ('concept_types', 'term')
...
class DocumentDoubleCreationInput(sgqlc.types.Input):
    __schema__ = utils_api_schema
    __field_names__ = ('concept_id', 'double_uuid', 'job_id', 'parent_uuid', 'periodic_job_id', 'periodic_task_id', 'task_id', 'uuid')
    concept_id = sgqlc.types.Field(ID, graphql_name='conceptId')
...
class DocumentsTextWithMarkerByDateInput(sgqlc.types.Input):
    __schema__ = utils_api_schema
    __field_names__ = ('end_date', 'marker', 'start_date')
...
class DocumentsWithConceptByDateInput(sgqlc.types.Input):
    __schema__ = utils_api_schema
    __field_names__ = ('concept_type_id', 'end_date', 'start_date')
    concept_type_id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='conceptTypeId')
...
class ConceptPaginationResult(sgqlc.types.Type):
    __schema__ = utils_api_schema
    __field_names__ = ('list_concept', 'show_total', 'total')
    list_concept = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('Concept'))), graphql_name='listConcept')
    show_total = sgqlc.types.Field(sgqlc.types.non_null(Long), graphql_name='showTotal')
    total = sgqlc.types.Field(sgqlc.types.non_null(Long), graphql_name='total')
...
class Mutation(sgqlc.types.Type):
    __schema__ = utils_api_schema
    __field_names__ = ('add_alias_to_concept_internal', 'add_document_double_internal', 'get_or_add_account_internal', 'get_or_add_concept_internal', 'get_or_add_concept_new_internal', 'get_or_add_platform_internal', 'reserve_concept_uuidv7', 'update_document_facts_internal')
...
class Query(sgqlc.types.Type):
    __schema__ = utils_api_schema
    __field_names__ = ('batch_mention_search_internal', 'child_ids_internal', 'concept_ids_internal', 'document_uuid_internal', 'domain_update_info_internal', 'list_document_for_time_period_internal', 'list_text_from_document_with_marker_internal', 'mention_search_internal', 'pagination_access_level_internal', 'pagination_account_internal', 'pagination_composite_property_value_template_internal', 'pagination_concept_internal', 'pagination_concept_link_property_type_internal', 'pagination_concept_link_type_internal', 'pagination_concept_property_internal', 'pagination_concept_property_type_internal', 'pagination_concept_property_value_type_internal', 'pagination_concept_type_internal', 'pagination_concept_without_elastic_internal', 'pagination_document_type_internal', 'pagination_platform_internal', 'tdm_internal', 'tdm_new_internal')
