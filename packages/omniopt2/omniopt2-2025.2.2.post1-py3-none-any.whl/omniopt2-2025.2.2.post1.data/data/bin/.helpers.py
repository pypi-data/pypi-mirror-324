...
def warn_versions() -> None:
    ...
    supported_versions = {
        ...
        "psutil": ["5.8.0", "5.9.4", "5.9.8", "6.0.0", "6.1.0", "6.1.1"],
        "numpy": ["1.24.4", "1.26.4", "2.1.1", "2.1.2", "2.1.3", "2.2.1", "2.2.2"],
        "matplotlib": ["3.6.3", "3.7.5", "3.9.0", "3.9.1", "3.9.1.post1", "3.9.2", "3.9.3", "3.10.0"],
        ...
        "mpmath": ["1.3.0"],
        "sympy": ["1.13.3", "1.13.1"],
        "setuptools": ["66.1.1", "75.2.0", "58.1.0", "59.6.0", "75.3.0", "75.5.0", "75.6.0", "75.8.0", "70.2.0"],
