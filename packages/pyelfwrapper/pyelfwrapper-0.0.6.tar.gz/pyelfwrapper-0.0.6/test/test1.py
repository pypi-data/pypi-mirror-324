...
elflists = [r"..\example\test.elf", r"..\example\armgcctest.elf"]
...
for e in elflists:
    ...
    vars = [
        'TestStructArrayVar1.level1_2.level2_1.levle3_2.level4_2.Filed1',
        'TestEnumTest11[2]',
        'TestStruct5Var[1].TestUnionArrayLevel1TypeMem[3].level1_1.level2_2.levle3_1.level4_1.level5_1',
