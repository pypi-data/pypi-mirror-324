...
def summarize_baseline_v2_from_v1_config(
    ...
    return summarize_baseline_v2_from_v1_args(
        ...
        start=v1_config.baseline.static["start"],  # type: ignore[attr-defined]
        end=v1_config.baseline.static["end"],  # type: ignore[attr-defined]
...
def summarize_baseline_v2_from_v1_args(
    ...
    body = PreviewBaselineBinningBody(
        baseline=MLOpsStaticBaseline(static=[start, end]),  # type: ignore[arg-type]
