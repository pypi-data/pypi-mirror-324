...
class ScoreBody:
    """
    Attributes:
        baseline (Union['BaselineType0', 'BaselineType1', 'BaselineType2']): The types of Baselines allowed
    ...
    baseline: Union["BaselineType0", "BaselineType1", "BaselineType2"]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_baseline(
            data: object,
        ) -> Union["BaselineType0", "BaselineType1", "BaselineType2"]:
            try:
        ...
        def _parse_window(data: object) -> Union["Raw", "Stored"]:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_static_window_type_0 = Raw.from_dict(data)

                return componentsschemas_static_window_type_0
            except:  # noqa: E722
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_static_window_type_1 = Stored.from_dict(data)

            return componentsschemas_static_window_type_1
        ...
        score_body.additional_properties = d
        return score_body
