...
T = TypeVar("T", bound="PreviewBaselineBinningBody")


@_attrs_define
class PreviewBaselineBinningBody:
    """
    Attributes:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        targeting: Union[Dict[str, Any], None, Unset]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        preview_baseline_binning_body = cls(
            baseline=baseline,
            summarizer=summarizer,
            targeting=targeting,
        )

        preview_baseline_binning_body.additional_properties = d
        return preview_baseline_binning_body
