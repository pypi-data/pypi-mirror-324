...
def Em(*c:FT|str, # Contents of Em tag (emphasis)
    ...
    return fh.Em(*c, cls=(TextT.sm, TextT.medium, stringify(cls)), **kwargs)
...
def Caption(*c:FT|str, # Contents of Caption tag
    ...
    "Styled caption text"
    return fh.Caption(*c, cls=(TextT.muted, TextT.sm, stringify(cls)), **kwargs)
...
def Cite(*c:FT|str, # Contents of Cite tag
    ...
    return fh.Cite(*c, cls=(TextT.italic, stringify(cls)), **kwargs)
...
def Time(*c:FT|str, # Contents of Time tag
    ...
    return fh.Time(*c, cls=(TextT.meta, stringify(cls)), **kwargs)
...
def S(*c:FT|str, # Contents of S tag (strikethrough)
    ...
    return fh.S(*c, cls=('line-through text-gray-400 dark:text-gray-500', stringify(cls)), **kwargs)
...
def Meta(*c:FT|str, # Contents of meta text (timestamps, authors, etc)
            cls:Enum|str|tuple=(), # Additional classes
            **kwargs # Additional args
            )->FT:
    "Styled meta information text"
    return fh.Span(*c, cls=(TextT.meta, TextT.sm, stringify(cls)), **kwargs)
