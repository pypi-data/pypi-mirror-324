        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="device", type="str", default="cpu", required=False, multi=False, hide=False, choice=["auto", "cpu", "cuda"],
                     discription_ja="計算ディバイスを指定します。",
                     discription_en="Specifies the calculation device."),
                ...
                dict(opt="cpu_threads", type="int", default=0, required=False, multi=False, hide=True, choice=None,
                     discription_ja="CPU上で実行する際に使用するスレッドの数を指定します。",
                     discription_en="Specifies the number of threads to be used when executing on the CPU."),
                dict(opt="num_workers", type="int", default=1, required=False, multi=False, hide=True, choice=None,
                     discription_ja="テキスト抽出を行うワーカー数を指定します。",
                     discription_en="Specify the number of workers to perform text extraction."),
                dict(opt="overwrite", type="bool", default=True, required=False, multi=False, hide=True, choice=[True, False],
