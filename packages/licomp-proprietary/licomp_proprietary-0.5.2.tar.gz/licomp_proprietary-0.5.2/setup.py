...
setuptools.setup(
    name='licomp_proprietary',
    version=licomp_proprietary_version,
    ...
    url="https://github.com/hesa/licomp-proprietary",
    packages=['licomp_proprietary'],
    entry_points={
        "console_scripts": [
            "licomp-proprietary = licomp_proprietary.__main__:main",
        ],
    },
    package_data={
