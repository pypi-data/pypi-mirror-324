...
from hiero-sdk-python.consensus.topic_delete_transaction import TopicDeleteTransaction
...
from hiero-sdk-python.hapi.services import transaction_receipt_pb2
