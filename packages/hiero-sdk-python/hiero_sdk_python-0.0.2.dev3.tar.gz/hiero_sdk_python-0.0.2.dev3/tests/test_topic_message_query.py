...
from hiero-sdk-python.query.topic_message_query import TopicMessageQuery
...
from hiero-sdk-python.hapi.services import timestamp_pb2 as hapi_timestamp_pb2
...
def test_topic_message_query_subscription(mock_client, mock_topic_id, mock_subscription_response):
    ...
    with patch("hiero-sdk-python.query.topic_message_query.TopicMessageQuery.subscribe") as mock_subscribe:
