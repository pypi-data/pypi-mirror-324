...
class LoadSBMLOptions(BasicDictionary):
    ...
    @staticmethod
    def getAllLLVMBackendValues():
        return _roadrunner.LoadSBMLOptions_getAllLLVMBackendValues()

    @staticmethod
    def getAllLLJitOptimizationValues():
...
class ExecutableModel(object):
    ...
    def getFloatingSpeciesId(self, index):
    ...
    def getBoundarySpeciesInitConcentrations(self, len, values):
        r"""
    ...
    def setBoundarySpeciesInitAmounts(self, len, values):
        r"""
    ...
    def getBoundarySpeciesInitAmounts(self, len, values):
        r"""
    ...
    def getGlobalParameterId(self, index):
    ...
    def getCompartmentIndexForBoundarySpecies(self, index):
    ...
    def setStoichiometries(self, *args):
    ...
    def getConservedMoietyId(self, index):
    ...
    def getStoichiometryIndex(self, *args):
        r"""
        *Overload 1:*
    ...
    def getStateVectorId(self, index):
    ...
    def getPiecewiseTriggerRoots(self, time, y, gdot):
        return _roadrunner.ExecutableModel_getPiecewiseTriggerRoots(self, time, y, gdot)

    def getNumPiecewiseTriggers(self):
    ...
    def getEventListener(self, index):
    ...
    def setIntegrationStartTime(self, time):
...
class ExecutableModelFactory(object):
    ...
    @staticmethod
    def regenerateModel(oldModel, doc, options):
...
class Logger(object):
    ...
    @staticmethod
    def enableFileLogging(*args, **kwargs):
        r"""
    ...
    @staticmethod
    def enablePythonLogging():
        return _roadrunner.Logger_enablePythonLogging()

    @staticmethod
    def disablePythonLogging():
...
class RoadRunner(object):
    ...
    def getSteadyStateSolverByName(self, name):
    ...
    def getSensitivitySolverByName(self, name):
    ...
    def getExistingSteadyStateSolverNames(self):
        r"""Return a list of the names of all existing integrators."""
        return _roadrunner.RoadRunner_getExistingSteadyStateSolverNames(self)

    def getExistingSensitivitySolverNames(self):
    ...
    @staticmethod
    def getRegisteredIntegratorNames():
    ...
    @staticmethod
    def getRegisteredSteadyStateSolverNames():
    ...
    @staticmethod
    def getRegisteredSensitivitySolverNames():
    ...
    def setSensitivitySolver(self, name):
        r"""
    ...
    def sensitivitySolverExists(self, name):
        r"""
    ...
    def timeSeriesSensitivities(self, *args, **kwargs):
        r"""
    ...
    def saveStateS(self, *args, **kwargs):
        r"""
    ...
    def getIndependentFloatingSpeciesAmountsV(self):
        r"""
        Author: Claire
    ...
    def getDependentFloatingSpeciesAmountsV(self):
        r"""
        Author: Claire
    ...
    def getIndependentFloatingSpeciesConcentrationsV(self):
        r"""
        Author: Claire
    ...
    def getDependentFloatingSpeciesConcentrationsV(self):
        r"""
        Author: Claire
    ...
    def getIndependentFloatingSpeciesAmountsNamedArray(self):
        r"""
        Author: Claire
    ...
    def getDependentFloatingSpeciesAmountsNamedArray(self):
        r"""
        Author: Claire
    ...
    def getIndependentFloatingSpeciesConcentrationsNamedArray(self):
        r"""
        Author: Claire
    ...
    def getDependentFloatingSpeciesConcentrationsNamedArray(self):
        r"""
        Author: Claire
    ...
    def getFullEigenValuesNamedArray(self):
        r"""
    ...
    def getReducedEigenValuesNamedArray(self):
        r"""
    ...
    def _addSpeciesConcentration(self, *args, **kwargs):
        r"""
    ...
    def _addSpeciesAmount(self, *args, **kwargs):
        r"""
    ...
    def getHasOnlySubstanceUnits(self, sid):
        r"""
    ...
    def addReaction(self, sbmlRep, forceRegenerate=True):
    ...
    def removeReaction(self, rid, deleteUnusedParameters=False, forceRegenerate=True):
        r"""
    ...
    def removeInitialAssignment(self, vid, forceRegenerate=True, errIfNotExist=True):
        r"""
    ...
    def regenerateModel(self, forceRegenerate=True, reset=False):
        r"""
    ...
    def getGlobalParameterByName(self, param):
        r"""
        Author: ciaran welsh
    ...
    def setSeed(self, seed, resetModel=True):
        r"""Set the value of Config::RANDOM_SEED"""
        return _roadrunner.RoadRunner_setSeed(self, seed, resetModel)

    def getSeed(self, *args, **kwargs):
        r"""Returns the value of Config::RANDOM_SEED"""
        return _roadrunner.RoadRunner_getSeed(self, *args, **kwargs)
    ...
    def resetSeed(self):
        ...
        """
        return _roadrunner.RoadRunner_resetSeed(self)
    ...
    def _getIds(self, types):
        return _roadrunner.RoadRunner__getIds(self, types)

    def _setSimulateOptionsTimes(self, opt, list):
...
class Solver(Registrable):
    ...
    def updateSettings(self, inputSettings):
        r"""
...
class Integrator(Solver):
    ...
    def getAbsoluteToleranceVector(self):
        r"""
...
class SensitivitySolver(Solver):
    ...
    def getSensitivityMatrix(self, k=0):
        r"""
...
class TimeSeriesSensitivitySolver(SensitivitySolver):
    ...
    def solveSensitivities(self, start, stop, num, params, species, k):
        r"""
        simulate a timeseries with sensitivities from start to step with num
        data points.
        Matrix3D indexed by time. Each element of the 3D matrix is a
...
class SteadyStateSensitivitySolver(SensitivitySolver):
    ...
    def solveSensitivities(self, *args, **kwargs):
        r"""
...
def fixMissingStoichAndMath(sbml):
    r"""
...
class KinsolSteadyStateSolver(SteadyStateSolver):
    ...
    def solveForSteadyState(self, solverInstance, kinsolStrategy):
        r"""
...
class NewtonIteration(KinsolSteadyStateSolver):
    ...
    def getSolverStatsFromKinsol(self):
...
class BasicNewtonIteration(NewtonIteration):
    ...
    def __init__(self, executableModel):
...
class NLEQ1Solver(NLEQSolver):
    ...
    def construct(self, executableModel):
        r"""
...
class ForwardSensitivitySolver(TimeSeriesSensitivitySolver):
    ...
    def integrate(self, tStart, hstep):
    ...
    def syncWithModel(self, executableModel):
    ...
    def getGlobalParameterNames(self):
        r"""
    ...
    def getModelParametersAsMap(self):
        r"""
    ...
    def getModelParametersAsVector(self):
        r"""
    ...
    def getSensitivityNVectorPtr(self):
        r"""
        retuns pointer to the state vector
...
class CVODEIntegrator(Integrator):
    ...
    def checkVectorSize(self, expected, real):
        r"""
        Author: FY
    ...
    def checkIndex(self, index, size):
        r"""
        Author: FY
...
class EulerIntegrator(Integrator):
    ...
    def applyEvents(self, timeEnd, previousEventStatus):
