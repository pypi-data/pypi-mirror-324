...
class FrameworkStub(BaseAPIModelStub):
    ...
    default_data = {
        ...
        "communicationCategoriesWithEmails": [],
        "communicationsOpen": False,
        "communicationsCloseAtUTC": "1970-01-01T00:00:00.000000Z",
    }
    optional_keys = [
        ...
        ("communicationCategoriesWithEmails", "communication_categories_with_emails"),
    ]
    datestamp_keys = [
        ...
        ("communicationsCloseAtUTC", "communications_close_at_utc"),
    ]
    ...
    def __init__(self, **kwargs):
        ...
        if "with_communication_categories_with_emails" in kwargs:
            self.response_data["communicationCategoriesWithEmails"] = [
                {"category": "Compliance", "email": "test+1@email.com"},
                {"category": "Clarification question", "email": "test+1@email.com"},
            ]
            self.response_data["communicationsOpen"] = True

            del kwargs["with_communication_categories_with_emails"]

        self.response_data["hasCommunications"] = len(self.response_data["communicationCategoriesWithEmails"]) > 0
