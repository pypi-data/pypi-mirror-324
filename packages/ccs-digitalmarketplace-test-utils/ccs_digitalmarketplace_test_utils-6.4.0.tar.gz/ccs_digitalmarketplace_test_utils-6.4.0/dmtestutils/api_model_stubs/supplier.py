...
class SupplierStub(BaseAPIModelStub):
    ...
    def __init__(self, **kwargs):
        ...
        if kwargs.get('with_cdp_data'):
            self.response_data["centralDigitalPlatformOrganisationId"] = \
                CENTRAL_DIGITAL_PLATFORM_DATA["id"]
            self.response_data["centralDigitalPlatformShareCode"] = \
                CENTRAL_DIGITAL_PLATFORM_DATA["supplierInformationData"]["form"]["shareCode"]
            ...
            self.response_data['registrationCountryName'] = \
                CENTRAL_DIGITAL_PLATFORM_DATA['address']['countryName']
            self.response_data['contactInformation'][0]['url'] = \
                CENTRAL_DIGITAL_PLATFORM_DATA['contactPoint']['url']
