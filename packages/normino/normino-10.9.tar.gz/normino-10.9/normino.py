...
def main():
    ...
    args.exclude.extend([
        'minilibx', 'mlx', 'minilibx_linux', 'mlx_linux', 'minilibx_macos',
        'mlx_mac', 'mlx_win', 'mlx_x11', 'mlx_opengl', 'mlx_glfw',
        'minilibx-linux', 'mlx-linux', 'minilibx-macos', 'mlx-mac', 'mlx-win',
        'mlx-x11', 'mlx-opengl', 'mlx-glfw'
    ])
