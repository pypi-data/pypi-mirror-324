...
class ToolManifestDto(BaseModel):
    ...
    version: StrictStr = Field(description="Indicates the version of the tool this definition represents.  Any versioning strategy is supported.")
    ...
    inputs: List[Dict[str, Any]] = Field(description="Describes all the inputs, parameters and files, needed for this tool.")
    outputs: List[Dict[str, Any]] = Field(description="Describes all the expected outputs from this tool.")
    __properties: ClassVar[List[str]] = ["key", "version", "name", "description", "executors", "inputs", "outputs"]
