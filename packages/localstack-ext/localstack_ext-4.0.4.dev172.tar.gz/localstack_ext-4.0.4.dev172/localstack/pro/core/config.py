...
# whether we enable the new implementation of WebSockets making use of Rolo with APIGW NextGen
# Beware! This needs to be used in conjunction of `PROVIDER_OVERRIDE_APIGATEWAY=next_gen`, otherwise it does not do
# anything
ENABLE_NEXT_GEN_WEBSOCKETS = localstack_config.is_env_true("ENABLE_NEXT_GEN_WEBSOCKETS")
...
# whether to activate the replicator tool API
ENABLE_REPLICATOR = localstack_config.is_env_true("ENABLE_REPLICATOR")
...
DEFAULT_BEDROCK_MODEL = os.environ.get("DEFAULT_BEDROCK_MODEL", "smollm2:360m")
