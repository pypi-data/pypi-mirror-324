...
# parse a string with the form of nan:str to its value and unit
# This is only being used for initializing the parameter tabble when
# users usually define all parameters as nan
def parse_unitted_nan(string: str) -> tuple[str | None]:
    return UnittedNanParsers.unitted_nan.parse(string)
