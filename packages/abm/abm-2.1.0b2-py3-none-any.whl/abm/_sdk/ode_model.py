__all__ = ["OdeModel", "OdeModelFromBytes", "OdeModelFromText", "OdeModelTypes", "Schedule"]
...
class OdeModel:
    ...
    ) -> Job["OdeModel", None, OdeModelTypes]:
        from . import client
...
@serializable
@dataclass(frozen=True)
class OdeModelFromBytes:
    base64_content: str
    format: Literal["qsp_designer"]
