...
from .ode_model import OdeModel, OdeModelFromBytes, OdeModelFromText, OdeModelTypes
...
class Client:
    def __init__(self, host: str | None = None, root: str = "/api/v1"):
        ...
        self.job_descriptors: dict[str, JobDescriptor[JobDefinition, JobOutput, JobTypes]] = {
            "assess-parameter-scan-1d": JobDescriptor[AssessParameterScan1D, AssessParameterScan1DResult, None](
                definition=AssessParameterScan1D,
                output=AssessParameterScan1DResult,
            ),
            "assess-parameter-scan-2d": JobDescriptor[AssessParameterScan2D, AssessParameterScan2DResult, None](
                definition=AssessParameterScan2D,
                output=AssessParameterScan2DResult,
            ),
            "assess-simulation": JobDescriptor[AssessSimulation, AssessSimulationResult, None](
            ...
            "ode-model-from-bytes": JobDescriptor[OdeModelFromBytes, OdeModel, None](
                definition=OdeModelFromBytes,
                output=OdeModel,
            ),
        ...
        *,
        ...
        def create(definitions: list[JobDefinition]) -> list[Job]:
            ...
            for definition in definitions:
                ...
                params = {"include_definition": include_definition, "include_types": include_types}
