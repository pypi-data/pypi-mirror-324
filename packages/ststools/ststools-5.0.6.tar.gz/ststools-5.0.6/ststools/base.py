...
def Map():
    ...
    def update_heatmap(*args):
                ...
                if type(STM[0])!=np.ndarray:
                    if STM[0] == None:
                        ...
                        if len(xarray) ==1:
                            ...
                            axs[1].set_xlabel('Sample bias (V)')
                        fig.colorbar(cax2, ax=axs[1], label=f'Derivative Map')
        ...
        with output_derivative:
            ...
            axs[0].plot(x1,y1, label=f'IxV at ({selected_x}, {selected_y})')
            axs[0].set_xlabel("Sample Bias (V)")
            axs[0].set_ylabel("I (nA)")
            axs[0].legend()
    ...
    widgets_top_row1 = HBox([
        V_slider, V_min_slider, V_max_slider, delta_slider,smoothing_slider,
    ])
    widgets_top_row2 = HBox([
        color_min_slider, color_max_slider, map_selector, cmap_selector, interpolate_checkbox, save_button,auto_color
    ])
