...
def solar_task_with_full_corr(
    ...
    with SolarCalibration(
        ...
        task.write(
            ...
            tags=[DlnirspTag.intermediate(), DlnirspTag.frame(), DlnirspTag.task("SC_FULL_CORR")],
...
def test_compute_average_gain(
    ...
    dark_only_list = list(
        task.read(
            tags=[DlnirspTag.intermediate(), DlnirspTag.frame(), DlnirspTag.task("SC_DARK_ONLY")]
        )
    )
...
def test_solar_task_completes(
    ...
    solar_cal_list = list(
        task.read(
            tags=[DlnirspTag.intermediate(), DlnirspTag.frame(), DlnirspTag.task_solar_gain()],
        )
    )
