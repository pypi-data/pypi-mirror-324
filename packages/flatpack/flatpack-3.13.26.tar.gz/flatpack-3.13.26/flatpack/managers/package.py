...
class PackageManager:
    ...
    def pack(self, input_path, overwrite=False, prebuild=False, metadata=None):
        try:
            ...
            if prebuild:
                output_path = abs_input_path + '-prebuilt.fpk'
            else:
            ...
            if os.path.isfile(abs_input_path):
                ...
                try:
                    ...
                    print(
                        f"Compressing file ({filesize / 1024:.1f} KB)..."
                    )
                    ...
                    print(
                        ...
                        f"({compressed_size / filesize * 100:.1f}%)"
                    )
    ...
    def unpack(self, input_path, output_path=None):
        ...
        if metadata and metadata.get('prebuilt'):
            print("Unpacking pre-built package...")
        else:
        ...
        try:
            ...
            with tqdm(
                ...
                with decompressor.stream_reader(
                        io.BytesIO(compressed_data)) as reader:
    ...
    def get_metadata(input_path):
        try:
            ...
            with tempfile.NamedTemporaryFile() as tmp_file:
                ...
                with tarfile.open(fileobj=tmp_file, mode='r:') as tar:
                    try:
                        metadata_member = tar.getmember('fpk-metadata.json')
