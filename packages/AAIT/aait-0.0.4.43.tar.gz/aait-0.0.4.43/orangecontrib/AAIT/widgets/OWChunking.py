...
class OWChunker(widget.OWWidget):
    ...
    priority = 1050
    chunk_size: int = Setting(default=500)
    ...
    def run(self):
        ...
        self.thread = thread_management.Thread(chunking.create_chunks, self.data, self.model, int(self.chunk_size))
