...
def gltf(
    ...
    *,
    ...
    | None = "SPEC",
    gltf_export_id: str = "",
    export_format: typing.Literal["GLB", "GLTF_SEPARATE"] | None = "GLB",
    ...
    export_animation_mode: typing.Literal[
        "ACTIONS", "ACTIVE_ACTIONS", "NLA_TRACKS", "SCENE"
    ]
    | None = "ACTIONS",
    ...
    glTF Separate (.gltf + .bin + textures) -- Exports multiple files, with separate JSON, binary and texture data. Easiest to edit later.
        :type export_format: typing.Literal['GLB','GLTF_SEPARATE'] | None
    ...
    Scene -- Export baked scene as a single animation.
        :type export_animation_mode: typing.Literal['ACTIONS','ACTIVE_ACTIONS','NLA_TRACKS','SCENE'] | None
