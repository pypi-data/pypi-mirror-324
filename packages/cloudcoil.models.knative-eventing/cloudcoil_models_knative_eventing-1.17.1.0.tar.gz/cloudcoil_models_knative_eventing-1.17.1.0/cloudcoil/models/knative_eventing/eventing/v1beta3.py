...
class Attribute(BaseModel):
    ...
    class BuilderContext(BuilderContextBase["Attribute.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = Attribute.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for Attribute."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["Attribute", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use Attribute.list_builder() instead."
            )
...
class EventTypeSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def attributes(self, value_or_callback: List[Attribute], /) -> "EventTypeSpec.Builder": ...

        @overload
        def attributes(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[Attribute, Attribute.Builder]],
                GenericListBuilder[Attribute, Attribute.Builder] | List[Attribute],
            ],
            /,
        ) -> "EventTypeSpec.Builder": ...
        ...
        ) -> ListBuilderContext[Attribute.Builder]: ...
        ...
        def attributes(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[Attribute.Builder]()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(Attribute.list_builder())
...
class EventType(Resource):
    class Builder(BaseModelBuilder):
        ...
        def api_version(self, value: Optional[Literal["eventing.knative.dev/v1beta3"]], /) -> Self:
            return self._set("api_version", value)
    ...
    api_version: Annotated[
        Optional[Literal["eventing.knative.dev/v1beta3"]], Field(alias="apiVersion")
