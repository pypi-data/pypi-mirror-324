...
def run_on_vastai(include_files=None, additional_reqs=None, **vastai_requirements):
    """
    Decorator that:
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            # Make the output dir always pruned codebase
            output_dir = f"pruned_codebase"
...
def _run_on_vastai_sync(func, module_file, output_dir, vastai_requirements: Union[Requirements, dict], args, kwargs, include_files):
    ...
    instance.run_command("rm -f pruned_codebase/**/*.py", shell=True)
