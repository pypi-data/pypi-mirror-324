...
class TopHat(Jester):
	...
	def __init__(self, username=None, password=None, hostname=None, database=None):
		super().__init__(username=username, password=password, hostname=hostname, database=database)
