...
class AdditionalData(typing_extensions.TypedDict):
    """
    Additional information received from the payment network.
    """

    acquirer_name: typing_extensions.NotRequired[str]
    """
    ...
    acquirer_reference_number: typing_extensions.NotRequired[str]
    """
    Contains identifier generated by the acquirer.  For Visa, this is the ARN.  For Mastercard, this is the ARD.
    """

    authorization_date: typing_extensions.NotRequired[str]
    """
    The local date on which the authorization occurred (MMDD).
    """

    authorization_response_category: typing_extensions.NotRequired[str]
    """
    ...
    downgrade_reason_code: typing_extensions.NotRequired[str]
    """
    ...
    electronic_commerce_security_level_code: typing_extensions.NotRequired[str]
    """
    ...
    market_specific_data: typing_extensions.NotRequired[str]
    """
    Indicates Visa's classification of the merchant's industry.
    """

    merchant_advice_code: typing_extensions.NotRequired[str]
    """
    ...
    original_electronic_commerce_indicator: typing_extensions.NotRequired[str]
    """
    ...
    original_electronic_commerce_security_level_code: typing_extensions.NotRequired[str]
    """
    ...
    pos_condition_code: typing_extensions.NotRequired[str]
    """
    ...
    product_id: typing_extensions.NotRequired[str]
    """
    ...
    response_reason_code: typing_extensions.NotRequired[str]
    """
    Indicates whether authorization request is approved or declined by the issuer.
    """

    retrieval_reference_number: typing_extensions.NotRequired[str]
    """
    A unique number assigned to each payment by the payment network.
    """

    return_aci: typing_extensions.NotRequired[str]
    """
    Authorization Characteristics Indicator (ACI) provided by the payment networks.
    """

    system_trace_audit_number: typing_extensions.NotRequired[str]
    """
    ...
    validation_code: typing_extensions.NotRequired[str]
    """
    Result code when CAVV is sent in payment request.
    """


class _SerializerAdditionalData(pydantic.BaseModel):
    """
    Serializer for AdditionalData handling case conversions
