...
class Sofort(typing_extensions.TypedDict):
    """
    ...
    bank_name: typing_extensions.NotRequired[str]
    """
    ...
    branch_number: typing_extensions.NotRequired[str]
    """
    ...
    consumer_address_country: typing_extensions.NotRequired[str]
    """
...
class _SerializerSofort(pydantic.BaseModel):
    """
    Serializer for Sofort handling case conversions
