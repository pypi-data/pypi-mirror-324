...
class DefaultBinaryReader(aspose.cad.fileformats.cgm.IBinaryReader):
...
class ICommandFactory:
    ...
    def create_command(self, element_id : int, element_class : int, container : aspose.cad.fileformats.cgm.CgmFile) -> aspose.cad.fileformats.cgm.commands.Command:
        '''Create a new command instance
        
        :param element_id: The command Id
        :param element_class: The command class
