...
class CadAcDbAssocPersSubentManager(CadAcDbPersSubentManager):
    ...
    @property
    def attribute_90_list(self) -> List[int]:
        ...
    
    @attribute_90_list.setter
    def attribute_90_list(self, value : List[int]):
        ...
    
    @property
    def attribute290(self) -> Optional[bool]:
        '''Gets the attribute290.'''
        ...
    
    @attribute290.setter
    def attribute290(self, value : Optional[bool]):
        '''Sets the attribute290.'''
        ...
    
    ...

class CadAcDbPersSubentManager(aspose.cad.fileformats.cad.cadobjects.CadBaseObject):
