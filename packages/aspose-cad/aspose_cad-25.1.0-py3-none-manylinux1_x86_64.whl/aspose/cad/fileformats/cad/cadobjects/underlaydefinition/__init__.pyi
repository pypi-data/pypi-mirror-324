...
class CadDgnDefinition(CadUnderlayDefinition):
    ...
    @property
    def underlay_path_and_file_name(self) -> str:
        ...
    
    @underlay_path_and_file_name.setter
    def underlay_path_and_file_name(self, value : str):
        ...
    ...
    def underlay_name(self, value : str):
        ...
    
    ...

class CadDwfDefinition(CadUnderlayDefinition):
...
class CadPdfDefinition(CadUnderlayDefinition):
...
class CadUnderlayDefinition(aspose.cad.fileformats.cad.cadobjects.CadBaseObject):
