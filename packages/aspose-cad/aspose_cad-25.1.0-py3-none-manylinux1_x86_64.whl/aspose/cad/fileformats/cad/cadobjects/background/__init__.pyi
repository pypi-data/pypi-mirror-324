...
class CadGradientBackground(aspose.cad.fileformats.cad.cadobjects.CadBaseObject):
    ...
    @property
    def color_top_value(self) -> int:
        ...
    
    @color_top_value.setter
    def color_top_value(self, value : int):
        ...
    
    @property
    def color_middle_value(self) -> int:
        ...
    
    @color_middle_value.setter
    def color_middle_value(self, value : int):
        ...
    
    @property
    def color_bottom_value(self) -> int:
        ...
    
    @color_bottom_value.setter
    def color_bottom_value(self, value : int):
        ...
    
    @property
    def horizon(self) -> float:
        '''Gets the horizon value indicating the percentage of unrotated height.'''
        ...
    
    @horizon.setter
    def horizon(self, value : float):
        '''Sets the horizon value indicating the percentage of unrotated height.'''
        ...
    ...
    def rotation(self) -> float:
        '''Gets the angle by which the gradient background will be rotated.'''
        ...
    
    @rotation.setter
    def rotation(self, value : float):
        '''Sets the angle by which the gradient background will be rotated.'''
        ...
    
    ...

class CadSolidBackground(aspose.cad.fileformats.cad.cadobjects.CadBaseObject):
