...
class Cad2DVertex(CadVertexBase):
    '''The Cad 2 d vertex.'''
    ...
    @property
    def location_point(self) -> aspose.cad.fileformats.cad.cadobjects.Cad3DPoint:
        ...
    
    @location_point.setter
    def location_point(self, value : aspose.cad.fileformats.cad.cadobjects.Cad3DPoint):
        ...
    
    @property
    def bugle(self) -> float:
        '''Gets the bugle.'''
        ...
    
    @bugle.setter
    def bugle(self, value : float):
        '''Sets the bugle.'''
        ...
    
    @property
    def curve_fit_tangent_direction(self) -> Optional[float]:
        ...
    
    @curve_fit_tangent_direction.setter
    def curve_fit_tangent_direction(self, value : Optional[float]):
        ...
    
    @property
    def ending_width(self) -> float:
        ...
    
    @ending_width.setter
    def ending_width(self, value : float):
        ...
    
    @property
    def starting_width(self) -> float:
        ...
    
    @starting_width.setter
    def starting_width(self, value : float):
        ...
    ...
    @property
    def mesh_vertex_index1(self) -> Optional[int]:
        ...
    
    @mesh_vertex_index1.setter
    def mesh_vertex_index1(self, value : Optional[int]):
        ...
    
    @property
    def mesh_vertex_index2(self) -> Optional[int]:
        ...
    
    @mesh_vertex_index2.setter
    def mesh_vertex_index2(self, value : Optional[int]):
        ...
    
    @property
    def mesh_vertex_index3(self) -> Optional[int]:
        ...
    
    @mesh_vertex_index3.setter
    def mesh_vertex_index3(self, value : Optional[int]):
        ...
    
    @property
    def mesh_vertex_index4(self) -> Optional[int]:
        ...
    
    @mesh_vertex_index4.setter
    def mesh_vertex_index4(self, value : Optional[int]):
        ...
    
    @property
    def vertex_id(self) -> Optional[int]:
        ...
    
    @vertex_id.setter
    def vertex_id(self, value : Optional[int]):
        ...
    
    ...

class Cad3DVertex(CadVertexBase):
    '''The Cad 3 d vertex.'''
...
class CadFaceRecord(CadVertexBase):
    '''The Cad face record.'''
...
class CadPolygonMeshVertex(CadVertexBase):
...
class CadVertexBase(aspose.cad.fileformats.cad.cadobjects.CadEntityBase):
...
class CadVertexPolyFaceMesh(CadVertexBase):
