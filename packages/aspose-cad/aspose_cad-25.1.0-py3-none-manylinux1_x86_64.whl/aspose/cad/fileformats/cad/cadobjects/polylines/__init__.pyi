...
class CadPolyFaceMesh(CadPolylineBase):
    ...
    @property
    def vertices_follow_flag(self) -> int:
        ...
    
    @vertices_follow_flag.setter
    def vertices_follow_flag(self, value : int):
        ...
    ...
    @end_width.setter
    def end_width(self, value : float):
        ...
    
    @property
    def flag(self) -> aspose.cad.fileformats.cad.cadconsts.CadPolylineFlag:
        '''Gets the flag.'''
        ...
    
    @flag.setter
    def flag(self, value : aspose.cad.fileformats.cad.cadconsts.CadPolylineFlag):
        '''Sets the flag.'''
        ...
    
    @property
    def mesh_m_vertex_count(self) -> int:
        ...
    
    @mesh_m_vertex_count.setter
    def mesh_m_vertex_count(self, value : int):
        ...
    
    @property
    def mesh_n_vertex_count(self) -> int:
        ...
    
    @mesh_n_vertex_count.setter
    def mesh_n_vertex_count(self, value : int):
        ...
    ...
    @start_width.setter
    def start_width(self, value : float):
        ...
    
    @property
    def surface_m_density(self) -> int:
        ...
    
    @surface_m_density.setter
    def surface_m_density(self, value : int):
        ...
    
    @property
    def surface_n_density(self) -> int:
        ...
    
    @surface_n_density.setter
    def surface_n_density(self, value : int):
        ...
...
class CadPolygonMesh(CadPolylineBase):
...
class CadPolyline(CadPolylineBase):
...
class CadPolyline3D(CadPolylineBase):
...
class CadPolylineBase(aspose.cad.fileformats.cad.cadobjects.CadExtrudedEntityBase):
    '''Class describing Cad POLYLINE'''
