...
class CadDictionary(CadDictionaryBase):
    ...
    def try_get_value(self, key : str, value : Any) -> bool:
        ...
        :returns: true if dictionary contains the key otherwise false'''
        ...
    
    @overload
    def try_get_value(self, key : str, attr : Any, value : Any) -> bool:
        '''Gets the entry soft owner by key.
    ...
    def remove_by_value(self, value : str) -> None:
    ...
    @property
    def hard_owner_flag(self) -> int:
        ...
    
    @hard_owner_flag.setter
    def hard_owner_flag(self, value : int):
        ...
    
    @property
    def cloning_flag(self) -> int:
        ...
    
    @cloning_flag.setter
    def cloning_flag(self, value : int):
        ...
    ...
    @entry_names.setter
    def entry_names(self, value : List[str]):
        ...
    
    @classmethod
    @property
    def ACAD_IMAGE_DIC(cls) -> str:
        ...
    
    ...

class CadDictionaryBase(aspose.cad.fileformats.cad.cadobjects.CadBaseObject):
...
class CadDictionaryWithDefault(CadDictionaryBase):
    ...
    @property
    def hard_pointer(self) -> str:
        ...
    
    @hard_pointer.setter
    def hard_pointer(self, value : str):
        ...
