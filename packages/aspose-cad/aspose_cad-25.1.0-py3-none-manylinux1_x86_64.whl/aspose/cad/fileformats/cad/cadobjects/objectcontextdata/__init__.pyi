...
class CadAcDbAlDimObjectContextData(CadAcDbObjectContextData):
...
class CadAcDbMLeaderObjectContextData(CadAcDbObjectContextData):
    ...
    @property
    def annotate_scale_parameter_list(self) -> List[aspose.cad.fileformats.cad.cadparameters.CadParameter]:
        ...
    
    @annotate_scale_parameter_list.setter
    def annotate_scale_parameter_list(self, value : List[aspose.cad.fileformats.cad.cadparameters.CadParameter]):
        ...
    
    ...

class CadAcDbMTextObjectContextData(CadAcDbObjectContextData):
...
class CadAcDbObjectContextData(aspose.cad.fileformats.cad.cadobjects.CadBaseObject):
