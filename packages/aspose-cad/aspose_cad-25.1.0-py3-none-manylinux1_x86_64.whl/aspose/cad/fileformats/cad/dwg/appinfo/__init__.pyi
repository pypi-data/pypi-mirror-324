...
class AppInfoData:
    ...
    def app_info_name(self, value : str):
        ...
    ...
    def app_info_version(self, value : str):
        ...
    
    ...

class AppInfoData18(AppInfoData):
    ...
    @property
    def unknown2(self) -> str:
        '''The unknown2 - ODA writes "4001"'''
        ...
    
    @unknown2.setter
    def unknown2(self, value : str):
        '''The unknown2 - ODA writes "4001"'''
        ...
    ...
    @product_xml.setter
    def product_xml(self, value : str):
        ...
    
    ...

class AppInfoData21(AppInfoData):
    ...
    @property
    def version_data(self) -> bytes:
        ...
    
    @version_data.setter
    def version_data(self, value : bytes):
        ...
    ...
    @property
    def comment_data(self) -> bytes:
        ...
    
    @comment_data.setter
    def comment_data(self, value : bytes):
        ...
    ...
    @property
    def product_data(self) -> bytes:
        ...
    
    @product_data.setter
    def product_data(self, value : bytes):
        ...
