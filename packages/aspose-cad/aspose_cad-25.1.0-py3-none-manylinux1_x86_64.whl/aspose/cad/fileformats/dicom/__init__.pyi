...
class Compression:
    ...
    @property
    def type(self) -> aspose.cad.fileformats.cgm.enums.CompressionType:
        '''Gets the compression type.'''
        ...
    
    @type.setter
    def type(self, value : aspose.cad.fileformats.cgm.enums.CompressionType):
...
class ColorType:
    ...
    @classmethod
    @property
    def GRAYSCALE_8_BIT(cls) -> ColorType:
        '''Represents the grayscale 8-bit color type.'''
        ...
    
    @classmethod
    @property
    def GRAYSCALE_16_BIT(cls) -> ColorType:
        '''Represents the grayscale 16-bit color type.'''
        ...
    
    @classmethod
    @property
    def RGB_24_BIT(cls) -> ColorType:
...
class CompressionType:
    ...
    @classmethod
    @property
    def NONE(cls) -> CompressionType:
        '''The none compression.'''
        ...
    
    @classmethod
    @property
    def JPEG(cls) -> CompressionType:
        '''The JPEG compression.'''
        ...
    
    @classmethod
    @property
    def JPEG2000(cls) -> CompressionType:
        '''The JPEG 2000 compression.'''
        ...
    
    @classmethod
    @property
    def RLE(cls) -> CompressionType:
        '''The RLE compression.'''
        ...
