...
class FbxImage(aspose.cad.Image):
    '''Fbx Image class'''
    ...
    def try_remove_entity(self, entity_to_remove : aspose.cad.DrawingEntity3D) -> None:
        ...
    ...
    @property
    def entities(self) -> Iterable[aspose.cad.DrawingEntity3D]:
        ...
    
    @property
    def version(self) -> aspose.cad.fileformats.fbx.FbxVersion:
        '''Gets the image height.'''
        ...
    
    ...

class FbxImageException(aspose.cad.cadexceptions.ImageException):
    '''Ifc image exception'''
...
class FbxVersion:
    ...
    @classmethod
    @property
    def UNKNOWN(cls) -> FbxVersion:
        '''Uknown version'''
        ...
    
    @classmethod
    @property
    def V_6_0(cls) -> FbxVersion:
        '''FBX version 6.0'''
        ...
    
    @classmethod
    @property
    def V_6_1(cls) -> FbxVersion:
        '''FBX version 6.1'''
        ...
    
    @classmethod
    @property
    def V_7_0(cls) -> FbxVersion:
        '''FBX version 7.0'''
        ...
    
    @classmethod
    @property
    def V_7_1(cls) -> FbxVersion:
        '''FBX 2011 version'''
        ...
    
    @classmethod
    @property
    def V_7_2(cls) -> FbxVersion:
        '''FBX 2012 version'''
        ...
    
    @classmethod
    @property
    def V_7_3(cls) -> FbxVersion:
        '''FBX 2013 version'''
        ...
    
    @classmethod
    @property
    def V_7_4(cls) -> FbxVersion:
        '''FBX 2014-15 version'''
        ...
    
    @classmethod
    @property
    def V_7_5(cls) -> FbxVersion:
        '''FBX 2016-19 version'''
        ...
    
    @classmethod
    @property
    def V_7_7(cls) -> FbxVersion:
        '''FBX 2019-2020 version'''
        ...
