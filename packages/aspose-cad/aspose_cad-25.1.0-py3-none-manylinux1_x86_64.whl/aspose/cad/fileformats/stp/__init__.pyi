...
class StpImage(aspose.cad.Image):
    '''STP image class.'''
    ...
    def copy_header_values(self, source_image : aspose.cad.fileformats.stp.StpImage) -> None:
        ...
    
    def append(self, image_to_append : aspose.cad.fileformats.stp.StpImage) -> None:
        ...
        :param image_to_append: The image to append.'''
        ...
    
    def get_top_level_items(self) -> List[aspose.cad.fileformats.stp.items.StepRepresentationItem]:
    ...
    @property
    def schemas(self) -> List[aspose.cad.fileformats.stp.reader.StepSchemaTypes]:
        ...
    ...
    @property
    def collections(self) -> aspose.cad.fileformats.stp.helpers.StepCollections:
