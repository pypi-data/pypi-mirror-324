...
class ColorModes:
    ...
    @classmethod
    @property
    def BITMAP(cls) -> ColorModes:
        '''The bitmap color mode.'''
        ...
    
    @classmethod
    @property
    def GRAYSCALE(cls) -> ColorModes:
        '''The grayscale mode.'''
        ...
    
    @classmethod
    @property
    def INDEXED(cls) -> ColorModes:
        '''Indexed color mode.'''
        ...
    
    @classmethod
    @property
    def RGB(cls) -> ColorModes:
        '''RGB color mode.'''
        ...
    
    @classmethod
    @property
    def CMYK(cls) -> ColorModes:
        '''CMYK color mode.'''
        ...
    
    @classmethod
    @property
    def MULTICHANNEL(cls) -> ColorModes:
        '''Multichannel color mode.'''
        ...
    
    @classmethod
    @property
    def DUOTONE(cls) -> ColorModes:
        '''Duotone color mode.'''
        ...
    
    @classmethod
    @property
    def LAB(cls) -> ColorModes:
        '''Lab color mode.'''
        ...
...
class CompressionMethod:
    ...
    @classmethod
    @property
    def ZIP_WITHOUT_PREDICTION(cls) -> CompressionMethod:
        '''ZIP without prediction.'''
        ...
    
    @classmethod
    @property
    def ZIP_WITH_PREDICTION(cls) -> CompressionMethod:
        '''ZIP with prediction.'''
        ...
