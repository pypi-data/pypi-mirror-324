...
class IIfcEntity(aspose.cad.IDrawingEntity):
...
class IfcCollection:
    ...
    def try_add_item_as_object(self, item : any) -> bool:
...
class IfcEntityBase(IIfcEntity):
...
class IfcImage(aspose.cad.Image):
    ...
    def try_remove_entity(self, entity_to_remove : aspose.cad.fileformats.ifc.IIfcEntity) -> None:
        ...
    
    def add(self, entity : aspose.cad.fileformats.ifc.IIfcEntity) -> None:
        ...
    ...
    @property
    def header(self) -> aspose.cad.fileformats.ifc.header.IfcHeader:
        '''Gets the header.'''
        ...
    
    @property
    def entities(self) -> Iterable[aspose.cad.fileformats.ifc.IIfcEntity]:
...
class IfcVersion:
    ...
    @classmethod
    @property
    def IFC2X3(cls) -> IfcVersion:
        ...
    
    @classmethod
    @property
    def IFC4(cls) -> IfcVersion:
        ...
    
    @classmethod
    @property
    def IFC4X3(cls) -> IfcVersion:
        ...
