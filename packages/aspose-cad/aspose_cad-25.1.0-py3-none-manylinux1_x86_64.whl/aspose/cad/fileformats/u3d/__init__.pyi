...
class U3dImage(aspose.cad.Image):
    '''U3D image'''
    ...
    def update_image(self, base_mesh : aspose.cad.fileformats.u3d.elements.U3dBaseMesh, author_mesh : aspose.cad.fileformats.u3d.elements.U3dAuthorMesh, author_line_set : aspose.cad.fileformats.u3d.elements.U3dAuthorLineSet) -> None:
        ...
    ...
    @property
    def base_mesh(self) -> aspose.cad.fileformats.u3d.elements.U3dBaseMesh:
        ...
    
    @property
    def author_mesh(self) -> aspose.cad.fileformats.u3d.elements.U3dAuthorMesh:
        ...
    
    @property
    def author_line_set(self) -> aspose.cad.fileformats.u3d.elements.U3dAuthorLineSet:
        ...
