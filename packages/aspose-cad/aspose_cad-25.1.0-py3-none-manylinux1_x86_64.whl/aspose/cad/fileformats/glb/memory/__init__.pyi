...
class MemoryAccessor:
    ...
    @overload
    @staticmethod
    def have_overlapping_buffers(a : aspose.cad.fileformats.glb.memory.MemoryAccessor, b : aspose.cad.fileformats.glb.memory.MemoryAccessor) -> bool:
        ...
    
    @overload
    @staticmethod
    def have_overlapping_buffers(abc : Iterable[aspose.cad.fileformats.glb.memory.MemoryAccessor]) -> bool:
        ...
    ...
    @staticmethod
    def sanitize_vertex_attributes(vertex_accessors : List[aspose.cad.fileformats.glb.memory.MemoryAccessor]) -> None:
        ...
