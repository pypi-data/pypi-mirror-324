...
class StlImage(aspose.cad.Image):
    '''STL image class.'''
    ...
    def try_remove_entity(self, entity_to_remove : aspose.cad.fileformats.stl.stlobjects.TriangularFacet) -> None:
        ...
    ...
    @property
    def entities(self) -> Iterable[aspose.cad.fileformats.stl.stlobjects.TriangularFacet]:
        '''Gets the image facet objects.'''
        ...
