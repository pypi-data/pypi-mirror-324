...
class ObjImage(aspose.cad.Image):
    ...
    def get_shapes(self) -> Iterable[aspose.cad.fileformats.obj.elements.ObjShape]:
    ...
    @property
    def obj_root(self) -> aspose.cad.fileformats.obj.elements.ObjRoot:
        ...
    
    @obj_root.setter
    def obj_root(self, value : aspose.cad.fileformats.obj.elements.ObjRoot):
        ...
