...
class IgesImage(aspose.cad.Image):
    '''IGES Image class'''
    ...
    def try_remove_entity(self, entity_to_remove : aspose.cad.fileformats.iges.drawables.IgesDrawableBase) -> None:
        ...
    ...
    @property
    def entities(self) -> Iterable[aspose.cad.fileformats.iges.drawables.IgesDrawableBase]:
        ...
