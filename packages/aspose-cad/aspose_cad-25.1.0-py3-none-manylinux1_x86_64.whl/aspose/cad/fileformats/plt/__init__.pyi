...
class PltImage(aspose.cad.Image):
    '''PLT image class.'''
    ...
    def get_unit_translation_coefficient(self, new_unit_type : aspose.cad.imageoptions.UnitType) -> float:
        '''Gets unit type convert coefficient
        
        :param new_unit_type: new unit type
    ...
    @property
    def min_point(self) -> aspose.cad.PointF:
        ...
    
    @property
    def max_point(self) -> aspose.cad.PointF:
        ...
