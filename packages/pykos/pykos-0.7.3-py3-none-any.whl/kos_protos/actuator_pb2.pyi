...
class ConfigureActuatorRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_kd", b"_kd", "_ki", b"_ki", "_kp", b"_kp", "_max_torque", b"_max_torque", "_new_actuator_id", b"_new_actuator_id", "_protection_time", b"_protection_time", "_protective_torque", b"_protective_torque", "_torque_enabled", b"_torque_enabled", "_zero_position", b"_zero_position", "kd", b"kd", "ki", b"ki", "kp", b"kp", "max_torque", b"max_torque", "new_actuator_id", b"new_actuator_id", "protection_time", b"protection_time", "protective_torque", b"protective_torque", "torque_enabled", b"torque_enabled", "zero_position", b"zero_position"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_kd", b"_kd", "_ki", b"_ki", "_kp", b"_kp", "_max_torque", b"_max_torque", "_new_actuator_id", b"_new_actuator_id", "_protection_time", b"_protection_time", "_protective_torque", b"_protective_torque", "_torque_enabled", b"_torque_enabled", "_zero_position", b"_zero_position", "actuator_id", b"actuator_id", "kd", b"kd", "ki", b"ki", "kp", b"kp", "max_torque", b"max_torque", "new_actuator_id", b"new_actuator_id", "protection_time", b"protection_time", "protective_torque", b"protective_torque", "torque_enabled", b"torque_enabled", "zero_position", b"zero_position"]) -> None: ...
    @typing.overload
...
class ActuatorStateResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_current", b"_current", "_position", b"_position", "_temperature", b"_temperature", "_torque", b"_torque", "_velocity", b"_velocity", "_voltage", b"_voltage", "current", b"current", "position", b"position", "temperature", b"temperature", "torque", b"torque", "velocity", b"velocity", "voltage", b"voltage"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_current", b"_current", "_position", b"_position", "_temperature", b"_temperature", "_torque", b"_torque", "_velocity", b"_velocity", "_voltage", b"_voltage", "actuator_id", b"actuator_id", "current", b"current", "faults", b"faults", "online", b"online", "position", b"position", "temperature", b"temperature", "torque", b"torque", "velocity", b"velocity", "voltage", b"voltage"]) -> None: ...
    @typing.overload
