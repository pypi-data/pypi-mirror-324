...
from buz.event.infrastructure.buz_kafka.kafka_event_sync_subscriber_executor import KafkaEventSyncSubscriberExecutor
...
class BuzAIOKafkaMultiThreadedConsumer(BaseBuzAIOKafkaAsyncConsumer):
    def __init__(
        self,
        *,
