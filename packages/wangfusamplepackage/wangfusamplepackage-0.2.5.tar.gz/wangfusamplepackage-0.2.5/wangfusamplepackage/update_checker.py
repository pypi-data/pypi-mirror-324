...
# Absolute path to the JSON file that will store the last updated timestamp
LAST_UPDATED_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'last_updated.json')
