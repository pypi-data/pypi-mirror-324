...
class QryRunner:
    ...
    def EvalMetFea(self, context:VAL, args:LST, scope:VAL, history:History) -> VAL:
        self.logger.Warn('DEPRECATED: @%s is deprecated, please use /%s/[%s,%s,%s] instead.'%(MET_MODES.FEA,M1OBJECT.M2CLASS,M2CLASS.MYATTRIBUTES,M2CLASS.MYSRCASSOCIATIONS,M2CLASS.MYPARENTCOMPOSITIONS))
    ...
    def EvalMetFev(self, context:VAL, args:LST, scope:VAL, history:History) -> VAL:
        self.logger.Warn('DEPRECATED: @%s is deprecated, please use /%s/[%s,%s,%s] instead.'%(MET_MODES.FEV,M1OBJECT.M2CLASS,M2CLASS.MYATTRIBUTES,M2CLASS.MYSRCASSOCIATIONS,M2CLASS.PARENTCOMPOSITIONS))
    ...
    def EvalMetCnn(self, context:VAL, args:LST, scope:VAL, history:History) -> VAL:
        self.logger.Warn('DEPRECATED: @%s is deprecated, please use %s/%s instead.'%(MET_MODES.CNN,M2CLASS.MYPARENTCOMPOSITIONS,M2COMPOSITION.NAME))
    ...
    def EvalMetCnv(self, context:VAL, args:LST, scope:VAL, history:History) -> VAL:
        self.logger.Warn('DEPRECATED: @%s is deprecated, please use /%s/%s instead.'%(MET_MODES.CNV,M1OBJECT.M2CLASS,M2CLASS.MYPARENTCOMPOSITIONS))
