...
echo -e "${GREEN}🚀 Starting PyPI publication process for Bhumi...${NC}"
...
then
    ...
    then
        ...
        echo -e "${YELLOW}🔍 You can check your package at: https://test.pypi.org/project/bhumi/${NC}"
    ...
    echo -e "${YELLOW}🔍 You can check your package at: https://pypi.org/project/bhumi/${NC}"
else
